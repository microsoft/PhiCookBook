# 在 Microsoft Foundry 評估微調後的 Phi-3 / Phi-3.5 模型，聚焦於微軟的負責任 AI 原則
...
### 如何在 Microsoft Foundry 評估微調後的 Phi-3 / Phi-3.5 模型的安全性與效能？
...
![教學架構。](../../../../../../translated_images/zh-HK/architecture.10bec55250f5d6a4.webp)
...
1. [**情境 2：在 Microsoft Foundry 評估 Phi-3 / Phi-3.5 模型**](../../../../../../md/02.Application/01.TextAndChat/Phi3)
...
為確保您的 AI 模型符合倫理且安全，評估其是否符合微軟的負責任 AI 原則至關重要。在 Microsoft Foundry 中，安全性評估可讓您檢視模型對越獄攻擊的脆弱性及產生有害內容的可能性，這與這些原則直接對應。

![安全性評估。](../../../../../../translated_images/zh-HK/safety-evaluation.083586ec88dfa950.webp)
...
> [!NOTE]  
> 如果你是按照「[Fine-Tune and Integrate Custom Phi-3 Models with Prompt Flow in Microsoft Foundry](https://techcommunity.microsoft.com/t5/educator-developer-blog/fine-tune-and-integrate-custom-phi-3-models-with-prompt-flow-in/ba-p/4191726?wt.mc_id=studentamb_279723)」中描述的低代碼方法進行，可以跳過這個練習，直接進入下一個。  
...
您已在 Microsoft Foundry 新增自訂連線。接著，按照以下步驟建立 Prompt flow，然後將此 Prompt flow 連接到自訂連線，以便在 Prompt flow 中使用微調模型。
