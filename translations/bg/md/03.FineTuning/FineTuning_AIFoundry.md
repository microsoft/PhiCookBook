...
Нека разгледаме как да направим финна настройка на езиковия модел Phi-3 Mini на Microsoft с помощта на Microsoft Foundry. Финната настройка ви позволява да адаптирате Phi-3 Mini към конкретни задачи, правейки го още по-мощен и контекстно осъзнат.
...
- За достъп до операциите в Microsoft Foundry се използват ролеви базирани контроли за достъп (Azure RBAC). За да изпълните стъпките в тази статия, вашият потребителски акаунт трябва да има назначена __роля Azure AI Developer__ върху ресурсната група.
...
1. Изпълнете следните задачи:
    ...
    - Изберете **Training data**, която искате да използвате. Можете да я качите чрез данните на Microsoft Foundry или от локалната си среда.
...
> [!NOTE]
> За по-подробна информация относно финната настройка на Phi-3, посетете [Fine-tune Phi-3 models in Microsoft Foundry](https://learn.microsoft.com/azure/ai-studio/how-to/fine-tune-phi-3?tabs=phi-3-mini).

## Почистване на финно настроените модели

Можете да изтриете финно настроен модел от списъка с модели за финна настройка в [Microsoft Foundry](https://ai.azure.com) или от страницата с детайли на модела. Изберете модела, който искате да изтриете от страницата за финна настройка, и след това натиснете бутона Delete, за да го премахнете.
...
Phi моделите, финно настроени като услуга, се предлагат от Microsoft и са интегрирани с Microsoft Foundry за използване. Цените можете да намерите при [разполагане](https://learn.microsoft.com/azure/ai-studio/how-to/deploy-models-phi-3?tabs=phi-3-5&pivots=programming-language-python) или финна настройка на моделите в раздела Pricing and terms в съветника за разполагане.
