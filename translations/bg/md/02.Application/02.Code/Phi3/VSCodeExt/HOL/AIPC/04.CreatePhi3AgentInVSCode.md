...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-17T04:15:03+00:00",
...
В последната лаборатория комбинирахме NPU и облака, за да завършим разширение за Visual Studio Code за Phi3 Agent.

![agent](../../../../../../../../../translated_images/bg/vscode_agent.746efdf2e81957c2.webp)
...
***NOTE:*** Моля, стартирайте го във Visual Studio Code Insiders версия 1.90+
...
export function activate(extcontext: vscode.ExtensionContext) {
	...
	const phi3handler: vscode.ChatRequestHandler = async (request: vscode.ChatRequest, context: vscode.ChatContext, stream: vscode.ChatResponseStream, token: vscode.CancellationToken): Promise<IPHI3ChatResult> => {
		...
		if (request.command == 'img') {
			...
			{
				var result = "```txt"+"\n\n"+"Моля, задавайте въпроси по следния начин: Вашият въпрос (IMG_URL:https://example.com/image.jpg)"+"\n\n"++"```";
...
![code](../../../../../../../../../translated_images/bg/result_code.ae0d053b45202798.webp)

Можете да опитате ***@PHI3 /img***

![img](../../../../../../../../../translated_images/bg/result_img.436817a2bb3a34cf.webp)
