...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-09T20:09:30+00:00",
...
Извикването на функции се появи първо в семейството Phi Family, а сега можете да го използвате и в Phi-4-mini.

Този пример показва симулация на резултати от Висшата лига. Целта е Phi-4-mini да предоставя информация за мачовете в реално време. По-долу е примерният код:
