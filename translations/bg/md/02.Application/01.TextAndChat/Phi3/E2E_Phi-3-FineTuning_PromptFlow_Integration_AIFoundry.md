...
![Phi-3-FineTuning_PromptFlow_Integration Overview.](../../../../../../translated_images/bg/00-01-architecture.198ba0f1ae6d841a.png)
...
1. Въведете *azure machine learning* в **лентата за търсене** в горната част на портала и изберете **Azure Machine Learning** от появилите се опции.
    ...
    ![Type azure machine learning.](../../../../../../translated_images/bg/01-01-type-azml.acae6c5455e67b4b.png)

2. Изберете **+ Create** от навигационното меню.

3. Изберете **New workspace** от навигационното меню.

    ![Select new workspace.](../../../../../../translated_images/bg/01-02-select-new-workspace.cd09cd0ec4a60ef2.png)
...
4. Изпълнете следните действия:
    ...
    ![Fill azure machine learning.](../../../../../../translated_images/bg/01-03-fill-AZML.a1b6fd944be0090f.png)
...
1. Изпълнете следните действия, за да заявите квота за *Standard NCADSA100v4 Family*:
    ...
    - Изберете **Request quota** от навигационното меню.
        ...
        ![Request quota.](../../../../../../translated_images/bg/02-02-request-quota.c0428239a63ffdd5.png)
...
1. Въведете *managed identities* в **лентата за търсене** в горната част на портала и изберете **Managed Identities** от появилите се опции.
    ...
    ![Type managed identities.](../../../../../../translated_images/bg/03-01-type-managed-identities.24de763e0f1f37e5.png)

1. Изберете **+ Create**.

    ![Select create.](../../../../../../translated_images/bg/03-02-select-create.92bf8989a5cd98f2.png)
...
1. Изпълнете следните действия:
    ...
    ![Select create.](../../../../../../translated_images/bg/03-03-fill-managed-identities-1.ef1d6a2261b449e0.png)
...
1. В страницата за добавяне на роля изпълнете следните действия:
    ...
    ![Fill contributor role.](../../../../../../translated_images/bg/03-04-fill-contributor-role.73990bc6a32e140d.png)
...
1. Въведете *storage accounts* в **лентата за търсене** в горната част на портала и изберете **Storage accounts** от появилите се опции.
    ...
    ![Type storage accounts.](../../../../../../translated_images/bg/03-05-type-storage-accounts.9303de485e65e1e5.png)
...
1. Изпълнете следните действия, за да достигнете до страницата за добавяне на роля:
    ...
    ![Add role.](../../../../../../translated_images/bg/03-06-add-role.353ccbfdcf0789c2.png)
...
1. В страницата за добавяне на роля изпълнете следните действия:
    ...
    ![Select managed identity.](../../../../../../translated_images/bg/03-08-select-managed-identity.e80a2aad5247eb25.png)
...
1. Въведете *container registries* в **лентата за търсене** в горната част на портала и изберете **Container registries** от появилите се опции.
    ...
    ![Type container registries.](../../../../../../translated_images/bg/03-09-type-container-registries.7a4180eb2110e5a6.png)
...
1. Изберете папката *finetune-phi*, която сте създали, намираща се в *C:\Users\yourUserName\finetune-phi*.
    ...
    ![Изберете папката, която сте създали.](../../../../../../translated_images/bg/04-01-open-project-folder.f734374bcfd5f9e6.png)
...
1. В лявата част на Visual Studio Code, кликнете с десен бутон и изберете **New File**, за да създадете нов файл с име *download_dataset.py*.
    ...
    ![Създаване на нов файл.](../../../../../../translated_images/bg/04-02-create-new-file.cf9a330a3a9cff92.png)
...
1. Изберете **+ New**.
    ...
    ![Изберете изчислителни ресурси.](../../../../../../translated_images/bg/06-01-select-compute.a29cff290b480252.png)
...
1. Изпълнете следните задачи:
    ...
    ![Създаване на клъстер.](../../../../../../translated_images/bg/06-02-create-cluster.f221b65ae1221d4e.png)
...
1. Изпълнете следните задачи:
    ...
    ![Създаване на клъстер.](../../../../../../translated_images/bg/06-03-create-cluster.4a54ba20914f3662.png)
...
1. Изберете работното пространство на Azure Machine Learning, което сте създали.
    ...
    ![Изберете работно пространство, което сте създали.](../../../../../../translated_images/bg/06-04-select-workspace.a92934ac04f4f181.png)
...
1. Извършете следните стъпки:
    ...
    ![Въведете phi-3-mini-4k.](../../../../../../translated_images/bg/06-05-type-phi-3-mini-4k.8ab6d2a04418b250.png)

1. Изберете **Fine-tune** от навигационното меню.

    ![Изберете фино нагласяне.](../../../../../../translated_images/bg/06-06-select-fine-tune.2918a59be55dfeec.png)
...
1. Извършете следните стъпки:
    ...
    ![Попълнете страницата за фино нагласяне.](../../../../../../translated_images/bg/06-07-fill-finetuning.b6d14c89e7c27d0b.png)
...
1. В това упражнение успешно фино настроихте модела Phi-3 с помощта на Azure Machine Learning. Моля, обърнете внимание, че процесът на фино нагласяне може да отнеме значително време. След стартиране на задачата за фино нагласяне трябва да изчакате тя да завърши. Можете да наблюдавате статуса на задачата чрез навигация до раздела Jobs в лявата страна на вашето работно пространство в Azure Machine Learning. В следващата серия ще внедрите фино нагласения модел и ще го интегрирате с Prompt flow.
    ...
    ![Вижте задачата за фино нагласяне.](../../../../../../translated_images/bg/06-08-output.2bd32e59930672b1.png)
...
1. Изберете **From a job output**.
    ...
    ![Регистриране на модел.](../../../../../../translated_images/bg/07-01-register-model.ad1e7cc05e4b2777.png)

1. Изберете задачата, която сте създали.

    ![Изберете задача.](../../../../../../translated_images/bg/07-02-select-job.3e2e1144cd6cd093.png)
...
1. Уверете се, че е избран **Job output**; той трябва да е избран автоматично.
    ...
    ![Изберете изход.](../../../../../../translated_images/bg/07-03-select-output.4cf1a0e645baea1f.png)

2. Изберете **Next**.

3. Изберете **Register**.

    ![Изберете Регистриране.](../../../../../../translated_images/bg/07-04-register.fd82a3b293060bc7.png)

4. Можете да видите регистрирания си модел, като навигирате до менюто **Models** в страничната лента.

    ![Регистриран модел.](../../../../../../translated_images/bg/07-05-registered-model.7db9775f58dfd591.png)
...
1. Изберете **Real-time endpoints** от навигационното меню.
    ...
    ![Създаване на крайна точка.](../../../../../../translated_images/bg/07-06-create-endpoint.1ba865c606551f09.png)

1. Изберете **Create**.

1. Изберете регистрирания модел, който сте създали.

    ![Изберете регистриран модел.](../../../../../../translated_images/bg/07-07-select-registered-model.29c947c37fa30cb4.png)
...
1. Изпълнете следните стъпки:
    ...
    ![Попълнете настройките за внедряване.](../../../../../../translated_images/bg/07-08-deployment-setting.43ddc4209e673784.png)
...
1. Изберете крайната точка, която сте създали.
    ...
    ![Изберете крайни точки.](../../../../../../translated_images/bg/07-09-check-deployment.325d18cae8475ef4.png)
...
>
> ![Настройка на трафика.](../../../../../../translated_images/bg/07-10-set-traffic.085b847e5751ff3d.png)
>
...
1. Изберете **+ New hub** от навигационното меню.
    ![Създаване на hub.](../../../../../../translated_images/bg/08-01-create-hub.8f7dd615bb8d9834.png)
...
1. Изпълнете следните задачи:
    ...
    ![Попълване на hub.](../../../../../../translated_images/bg/08-02-fill-hub.c2d3b505bbbdba7c.png)
...
1. Изберете **+ Нов проект** от навигационното меню.
    ...
    ![Изберете нов проект.](../../../../../../translated_images/bg/08-04-select-new-project.390fadfc9c8f8f12.png)

1. Въведете **Име на проект**. То трябва да е уникална стойност.

    ![Създаване на проект.](../../../../../../translated_images/bg/08-05-create-project.4d97f0372f03375a.png)
...
1. Изберете **Endpoints** от страничната лента.
    ...
    ![Изберете endpoints.](../../../../../../translated_images/bg/08-06-select-endpoints.aff38d453bcf9605.png)

1. Изберете края точка, която сте създали.

    ![Изберете создан endpoint.](../../../../../../translated_images/bg/08-07-select-endpoint-created.47f0dc09df2e275e.png)

1. Изберете **Consume** от навигационното меню.

1. Копирайте вашия **REST endpoint** и **Основен ключ**.

    ![Копирайте api ключ и endpoint uri.](../../../../../../translated_images/bg/08-08-copy-endpoint-key.18f934b5953ae8cb.png)
...
1. Изберете **+ Нова връзка**.
    ...
    ![Изберете нова връзка.](../../../../../../translated_images/bg/08-09-select-new-connection.02eb45deadc401fc.png)

1. Изберете **Персонализирани ключове** от навигационното меню.

    ![Изберете персонализирани ключове.](../../../../../../translated_images/bg/08-10-select-custom-keys.856f6b2966460551.png)
...
1. Изпълнете следните задачи:
    ...
    ![Добавяне на връзка.](../../../../../../translated_images/bg/08-11-add-connection.785486badb4d2d26.png)
...
1. Изберете **+ Създай** от навигационното меню.
    ...
    ![Изберете Promptflow.](../../../../../../translated_images/bg/08-12-select-promptflow.6f4b451cb9821e5b.png)

1. Изберете **Chat flow** от навигационното меню.

    ![Изберете чат потока.](../../../../../../translated_images/bg/08-13-select-flow-type.2ec689b22da32591.png)

1. Въведете **Име на папка** за използване.

    ![Въведете име.](../../../../../../translated_images/bg/08-14-enter-name.ff9520fefd89f40d.png)
...
1. В Prompt flow изпълнете следните задачи, за да реконструирате съществуващия поток:
    ...
    ![Изберете режим на суров файл.](../../../../../../translated_images/bg/08-15-select-raw-file-mode.61d988b41df28985.png)
...
1. Добавете следния код във файла *integrate_with_promptflow.py*, за да използвате потребителския модел Phi-3 в Prompt flow.
    ...
    ![Поставете кода за prompt flow.](../../../../../../translated_images/bg/08-16-paste-promptflow-code.a6041b74a7d09777.png)
...
1. Изберете **Вход за чат**, **Изход за чат**, за да разрешите чат с вашия модел.
    ...
    ![Вход и изход.](../../../../../../translated_images/bg/08-17-select-input-output.64dbb39bbe59d03b.png)
...
>
> ![Пример за поток.](../../../../../../translated_images/bg/08-18-graph-example.d6457533952e690c.png)
>
...
1. Изберете **Стартирай изчислителни сесии**, за да стартирате Prompt flow.
    ...
    ![Стартиране на изчислителна сесия.](../../../../../../translated_images/bg/09-01-start-compute-session.a86fcf5be68e386b.png)

1. Изберете **Потвърдете и анализирайте входа**, за да обновите параметрите.

    ![Потвърдете входа.](../../../../../../translated_images/bg/09-02-validate-input.317c76ef766361e9.png)

1. Изберете **Стойност** на **връзката** към потребителската връзка, която сте създали. Например *connection*.

    ![Връзка.](../../../../../../translated_images/bg/09-03-select-connection.99bdddb4b1844023.png)

#### Чат с вашия потребителски модел

1. Изберете **Чат**.

    ![Изберете чат.](../../../../../../translated_images/bg/09-04-select-chat.61936dce6612a1e6.png)
...
1. Ето пример за резултатите: Сега можете да чатите с вашия персонализиран модел Phi-3. Препоръчва се да задавате въпроси, базирани на данните, използвани за фина настройка.
    ...
    ![Чат с prompt flow.](../../../../../../translated_images/bg/09-05-chat-with-promptflow.c8ca404c07ab126f.png)
