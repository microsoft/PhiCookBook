...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-16T21:40:15+00:00",
...
Phi-3-vision-128k-instruct позволява на Phi-3 не само да разбира езика, но и да вижда света визуално. Чрез Phi-3-vision-128k-instruct можем да решаваме различни визуални задачи, като OCR, анализ на таблици, разпознаване на обекти, описване на изображение и др. Лесно можем да изпълним задачи, които преди изискваха голямо количество обучителни данни. По-долу са изброени свързани техники и сценарии за приложение, цитирани от Phi-3-vision-128k-instruct
...
Освен анализ на изображението, можем също да извличаме информация от него. Това е процесът OCR, за който преди трябваше да пишем сложен код.
