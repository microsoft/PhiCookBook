...
[AI Toolkit за VS Code](https://marketplace.visualstudio.com/items?itemName=ms-windows-ai-studio.windows-ai-studio) улеснява разработката на генеративни AI приложения, като обединява най-съвременни инструменти и модели за AI от Microsoft Foundry Catalog и други каталози като Hugging Face. Ще можете да разглеждате каталога с AI модели, захранван от GitHub Models и Microsoft Foundry Model Catalogs, да ги изтегляте локално или отдалечено, да ги донастройвате, тествате и използвате във вашето приложение.
