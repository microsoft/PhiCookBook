...
Как да оцените вашето генеративно AI приложение с помощта на [Microsoft Foundry](https://ai.azure.com?WT.mc_id=aiml-138114-kinfeylo). Независимо дали оценявате еднократни или многократни разговори, Microsoft Foundry предоставя инструменти за оценка на представянето и безопасността на модела.
...
За по-подробни инструкции вижте [документацията на Microsoft Foundry](https://learn.microsoft.com/azure/ai-studio/how-to/evaluate-generative-ai-app?WT.mc_id=aiml-138114-kinfeylo)
...
Microsoft Foundry ви позволява да оценявате както еднократни, така и сложни многократни разговори.  
...
От интерфейса на Microsoft Foundry отидете на страницата Evaluate или Prompt Flow.  
