...
[Microsoft Foundry](https://ai.azure.com?WT.mc_id=aiml-138114-kinfeylo) е мощна платформа, която позволява на разработчиците и организациите бързо да създават интелигентни, модерни, готови за пазара и отговорни приложения. Ето някои ключови функции и възможности на Microsoft Foundry:

**Готови за използване API-та и модели**

Microsoft Foundry предоставя предварително изградени и персонализируеми API-та и модели. Те покриват широк спектър от AI задачи, включително генеративен AI, обработка на естествен език за разговори, търсене, мониторинг, превод, реч, визуализация и вземане на решения.

**Prompt Flow**

Prompt flow в Microsoft Foundry ви позволява да създавате разговорни AI преживявания. Тази функция улеснява проектирането и управлението на разговорни потоци, което прави изграждането на чатботове, виртуални асистенти и други интерактивни приложения по-лесно.
...
Microsoft Foundry предоставя инструменти за оценка и мониторинг на генеративни AI модели. Можете да прецените тяхната производителност, справедливост и други важни показатели, за да осигурите отговорно внедряване. Освен това, ако сте създали табло за управление, можете да използвате no-code UI в Azure Machine Learning Studio, за да персонализирате и генерирате Responsible AI Dashboard и свързаната scorecard, базирана на [Responsible AI Toolbox](https://responsibleaitoolbox.ai/?WT.mc_id=aiml-138114-kinfeylo) Python библиотеки. Тази scorecard ви помага да споделяте ключови прозрения, свързани със справедливост, важност на характеристиките и други съображения за отговорно внедряване както с технически, така и с нетехнически заинтересовани страни.
...
В заключение, Microsoft Responsible AI е инициатива, която цели да помогне на разработчиците и организациите да изграждат AI системи, които са прозрачни, надеждни и отговорни. Не забравяйте, че отговорното внедряване на AI е от ключово значение, а Microsoft Foundry цели да го направи практично за организациите. Следвайки етичните принципи и добрите практики, можем да гарантираме, че AI системите се разработват и внедряват по отговорен начин, който носи полза на обществото като цяло.
