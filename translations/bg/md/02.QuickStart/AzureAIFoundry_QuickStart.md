...
Създаването на проект и хъб в Microsoft Foundry е отличен начин да организирате и управлявате вашата AI работа. Ето стъпка по стъпка ръководство, което да ви помогне да започнете:
...
Отидете на страницата за разполагане, изберете Playground и чатете с Phi-3 на Microsoft Foundry
...
- Изберете модела, който искате да разположите от каталога с модели на Microsoft Foundry.
