...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2026-01-05T09:56:17+00:00",
...
[![Форкове в GitHub](https://img.shields.io/github/forks/microsoft/phicookbook.svg?style=social&label=Fork)](https://GitHub.com/microsoft/phicookbook/network/?WT.mc_id=aiml-137032-kinfeylo)
...
В момента Phi е най-мощният и икономически ефективен малък езиков модел (SLM), с много добри показатели в многоезично, разсъждения, генериране на текст/чат, кодиране, изображения, аудио и други сценарии.

Можете да внедрите Phi в облака или на крайни устройства и лесно да изграждате генеративни AI приложения с ограничена изчислителна мощност.

Следвайте тези стъпки, за да започнете да използвате тези ресурси:
1. **Форкнете хранилището**: Кликнете [![Форкове в GitHub](https://img.shields.io/github/forks/microsoft/phicookbook.svg?style=social&label=Fork)](https://GitHub.com/microsoft/phicookbook/network/?WT.mc_id=aiml-137032-kinfeylo)
...
- Въведение
  ...
  - [Хардуерна поддръжка на Phi](./md/01.Introduction/01/01.Hardwaresupport.md)
  - [Модели Phi и наличност на платформи](./md/01.Introduction/01/01.Edgeandcloud.md)
...
- Извеждане на Phi в различни среди
    ...
    -  [Каталог на Azure AI Foundry модели](./md/01.Introduction/02/03.AzureAIFoundry.md)
...
- Извеждане на Phi Family
    - [Извеждане на Phi на iOS](./md/01.Introduction/03/iOS_Inference.md)
    - [Извеждане на Phi на Android](./md/01.Introduction/03/Android_Inference.md)
    - [Извеждане на Phi на Jetson](./md/01.Introduction/03/Jetson_Inference.md)
    - [Извеждане на Phi на AI PC](./md/01.Introduction/03/AIPC_Inference.md)
    ...
    - [Извеждане Phi--Vision локално](./md/01.Introduction/03/Vision_Inference.md)
    - [Извеждане на Phi с Kaito AKS, Azure Containers (официална поддръжка)](./md/01.Introduction/03/Kaito_Inference.md)
-  [Квантоване на Phi Family](./md/01.Introduction/04/QuantifyingPhi.md)
    - [Квантоване на Phi-3.5 / 4 с llama.cpp](./md/01.Introduction/04/UsingLlamacppQuantifyingPhi.md)
    - [Квантоване на Phi-3.5 / 4 с разширения за генеративен AI за onnxruntime](./md/01.Introduction/04/UsingORTGenAIQuantifyingPhi.md)
    - [Квантоване на Phi-3.5 / 4 с Intel OpenVINO](./md/01.Introduction/04/UsingIntelOpenVINOQuantifyingPhi.md)
    - [Квантоване на Phi-3.5 / 4 с Apple MLX Framework](./md/01.Introduction/04/UsingAppleMLXQuantifyingPhi.md)
...
- Примери за разработка на приложения с Phi
  - Текстови и чат приложения
    ...
    - Примери с Phi-3 / 3.5
      ...
      -[Пример за приложение WinUI3 с мулти модел и AI функционалност](https://github.com/microsoft/ai-powered-notes-winui3-sample)
      ...
      - [Оценка на финно настроения Phi-3 / Phi-3.5 модел в Azure AI Foundry с фокус върху Принципите за отговорен AI на Майкрософт](./md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-Evaluation_AIFoundry.md)
      ...
      - [УебGPU RAG чатбот Phi-3.5-Instruct](./md/02.Application/01.TextAndChat/Phi3/WebGPUWithPhi35Readme.md)
      ...
      - [Q&A пример .NET, използващ локален ONNX Phi-3 модел с Microsoft.ML.OnnxRuntime](../../md/04.HOL/dotnet/src/LabsPhi301)
      - [Конзолно чат .NET приложение със Semantic Kernel и Phi-3](../../md/04.HOL/dotnet/src/LabsPhi302)

  - Примери за Azure AI Inference SDK с код
    - Примери Phi-4 🆕
      - [📓] [Генериране на код за проект с Phi-4-multimodal](./md/02.Application/02.Code/Phi4/GenProjectCode/README.md)
    - Примери Phi-3 / 3.5
      - [Създайте свой Visual Studio Code GitHub Copilot Chat с Microsoft Phi-3 Family](./md/02.Application/02.Code/Phi3/VSCodeExt/README.md)
      - [Създайте свой Visual Studio Code Chat Copilot агент с Phi-3.5 чрез GitHub модели](/md/02.Application/02.Code/Phi3/CreateVSCodeChatAgentWithGitHubModels.md)
  ...
  - Демонстрации
      ...
      - [Phi-4-multimodal демонстрации, хоствани в Hugginge Face Spaces](https://huggingface.co/spaces/microsoft/phi-4-multimodal?WT.mc_id=aiml-137032-kinfeylo)
  - Примери за визия
    - Примери Phi-4 🆕
      - [📓] [Използване на Phi-4-multimodal за прочитане на изображения и генериране на код](./md/02.Application/04.Vision/Phi4/CreateFrontend/README.md) 
    - Примери Phi-3 / 3.5
      -  [📓][Phi-3-vision - Текст от изображение към текст](./md/02.Application/04.Vision/Phi3/E2E_Phi-3-vision-image-text-to-text-online-endpoint.ipynb)
      - [Phi-3-vision-ONNX](https://onnxruntime.ai/docs/genai/tutorials/phi3-v.html)
      - [📓][Phi-3-vision CLIP вложение](./md/02.Application/04.Vision/Phi3/E2E_Phi-3-vision-image-text-to-text-online-endpoint.ipynb)
      ...
      - [📓][Пример за Phi-3.5 Vision с много кадри или изображения](./md/02.Application/04.Vision/Phi3/phi3-vision-demo.ipynb)
      - [Локален ONNX модел Phi-3 Vision чрез Microsoft.ML.OnnxRuntime .NET](../../md/04.HOL/dotnet/src/LabsPhi303)
      - [Меню-базирано локално ONNX модел за Phi-3 Vision чрез Microsoft.ML.OnnxRuntime .NET](../../md/04.HOL/dotnet/src/LabsPhi304)

  - Примери за математика
    - Phi-4-Mini-Flash-Reasoning-Instruct Примери 🆕 [Демонстрация по математика с Phi-4-Mini-Flash-Reasoning-Instruct](./md/02.Application/09.Math/MathDemo.ipynb)

  - Примери за аудио
    - Примери Phi-4 🆕
      - [📓] [Извличане на аудио транскрипти с Phi-4-multimodal](./md/02.Application/05.Audio/Phi4/Transciption/README.md)
      - [📓] [Аудио пример Phi-4-multimodal](./md/02.Application/05.Audio/Phi4/Siri/demo.ipynb)
      - [📓] [Пример за аудио превод с Phi-4-multimodal](./md/02.Application/05.Audio/Phi4/Translate/demo.ipynb)
      - [Конзолно .NET приложение с Phi-4-multimodal за анализ на аудио файл и генериране на транскрипция](../../md/04.HOL/dotnet/src/LabsPhi4-MultiModal-02Audio)

  - MOE Примери
    - Примери Phi-3 / 3.5
      - [📓] [Пример Phi-3.5 Mixture of Experts Models (MoEs) за социални мрежи](./md/02.Application/06.MoE/Phi3/phi3_moe_demo.ipynb)
  ...
  - Примери за извикване на функции
    - Примери Phi-4 🆕
      ...
      -  [📓] [Използване на извикване на функции за създаване на многоагентни системи с Phi-4-mini](./md/02.Application/07.FunctionCalling/Phi4/Multiagents/Phi_4_mini_multiagent.ipynb)
  ...
  - Примери за мултимодално смесване
    - Примери Phi-4 🆕
      ...
      - [Конзолно .NET приложение с Phi-4-multimodal за анализ на изображения](../../md/04.HOL/dotnet/src/LabsPhi4-MultiModal-01Images)

- Фина настройка на Phi примери
  - [Сценарии за фина настройка](./md/03.FineTuning/FineTuning_Scenarios.md)
  - [Фина настройка в сравнение с RAG](./md/03.FineTuning/FineTuning_vs_RAG.md)
  - [Фина настройка: Да направим Phi-3 индустриален експерт](./md/03.FineTuning/LetPhi3gotoIndustriy.md)
  ...
  - [Фина настройка на Phi-3 с Kaito AKS, Azure контейнери (официална поддръжка)](./md/03.FineTuning/FineTuning_Kaito.md)
  - [Фина настройка на Phi-3 и 3.5 Vision](https://github.com/2U1/Phi3-Vision-Finetune)

- Практическа лаборатория
  - [Изследване на най-съвременни модели: LLMs, SLMs, локална разработка и още](https://github.com/microsoft/aitour-exploring-cutting-edge-models)
  - [Отключване на потенциала на NLP: Фина настройка с Microsoft Olive](https://github.com/azure/Ignite_FineTuning_workshop)

- Академични изследователски документи и публикации
  - [Учебници са всичко, което ти трябва II: технически доклад phi-1.5](https://arxiv.org/abs/2309.05463)
  - [Технически доклад Phi-3: Много способен езиков модел локално на твоя телефон](https://arxiv.org/abs/2404.14219)
  - [Технически доклад Phi-4](https://arxiv.org/abs/2412.08905)
  - [Технически доклад Phi-4-Mini: Компактни, но мощни мултимодални езикови модели чрез Смес от LoRA](https://arxiv.org/abs/2503.01743)
  - [Оптимизиране на малки езикови модели за извикване на функции в превозно средство](https://arxiv.org/abs/2501.02342)
  - [(WhyPHI) Фина настройка на PHI-3 за отговаряне на въпроси с множествен избор: методология, резултати и предизвикателства](https://arxiv.org/abs/2501.01588)
  - [Технически доклад Phi-4-разсъждение](https://www.microsoft.com/en-us/research/wp-content/uploads/2025/04/phi_4_reasoning.pdf)
  - [Технически доклад Phi-4-mini-разсъждение](https://huggingface.co/microsoft/Phi-4-mini-reasoning/blob/main/Phi-4-Mini-Reasoning.pdf)

## Използване на Phi модели

### Phi в Azure AI Foundry

Можете да научите как да използвате Microsoft Phi и как да изградите край до край решения за различните си хардуерни устройства. За да изпробвате Phi сами, започнете да експериментирате с моделите и да персонализирате Phi за вашите сценарии, използвайки [Azure AI Foundry Azure AI Model Catalog](https://aka.ms/phi3-azure-ai). Можете да научите повече в Запознаване с [Azure AI Foundry](/md/02.QuickStart/AzureAIFoundry_QuickStart.md)

**Игрална площадка**
Всяка модел има специална игрова площадка за тестване на модела [Azure AI Playground](https://aka.ms/try-phi3).

### Phi в GitHub модели

Можете да научите как да използвате Microsoft Phi и как да изградите край до край решения за различните си хардуерни устройства. За да изпробвате Phi сами, започнете да експериментирате с модела и да персонализирате Phi за вашите сценарии, използвайки [GitHub Model Catalog](https://github.com/marketplace/models?WT.mc_id=aiml-137032-kinfeylo). Можете да научите повече в Запознаване с [GitHub Model Catalog](/md/02.QuickStart/GitHubModel_QuickStart.md)

**Игрална площадка**
Всеки модел има специална [играла площадка за тестване на модела](/md/02.QuickStart/GitHubModel_QuickStart.md).

### Phi в Hugging Face

Моделът също така може да бъде намерен на [Hugging Face](https://huggingface.co/microsoft)

**Игрална площадка**
[Hugging Chat игрова площадка](https://huggingface.co/chat/models/microsoft/Phi-3-mini-4k-instruct)
...
Microsoft се ангажира да помага на клиентите си да използват нашите AI продукти отговорно, споделяйки нашите опити и изграждайки партньорства, основани на доверие чрез инструменти като Бележки за прозрачност и Оценки на въздействието. Много от тези ресурси могат да бъдат намерени на [https://aka.ms/RAI](https://aka.ms/RAI).
Подходът на Microsoft към отговорния AI се основава на нашите AI принципи за справедливост, надеждност и безопасност, поверителност и сигурност, включващост, прозрачност и отговорност.

Големи естествени езикови, образни и речеви модели - като тези, използвани в този пример - могат потенциално да се държат по начини, които са несправедливи, ненадеждни или обидни, което може да причини вреди. Моля, консултирайте се с [Бележката за прозрачност на Azure OpenAI услугата](https://learn.microsoft.com/legal/cognitive-services/openai/transparency-note?tabs=text), за да бъдете информирани за рисковете и ограниченията.

Препоръчителният подход за намаляване на тези рискове е да включите в архитектурата си система за безопасност, която може да засича и предотвратява вредно поведение. [Azure AI Content Safety](https://learn.microsoft.com/azure/ai-services/content-safety/overview) предоставя независим слой защита, способен да засича вредно съдържание, генерирано от потребителите и AI, в приложения и услуги. Azure AI Content Safety включва API за текст и изображения, които позволяват да откривате вредни материали. В рамките на Azure AI Foundry, услугата Content Safety позволява да разглеждате, изследвате и изпробвате примерен код за засичане на вредно съдържание в различни модалности. Следната [бърза старт документация](https://learn.microsoft.com/azure/ai-services/content-safety/quickstart-text?tabs=visual-studio%2Clinux&pivots=programming-language-rest) ви води през изпращане на заявки към услугата.

Друг аспект, който трябва да се вземе предвид е цялостната производителност на приложението. При мултимодални и мултимоделни приложения, под производителност се разбира, че системата работи така, както вие и вашите потребители очаквате, включително да не генерира вредни изходи. Важно е да оцените производителността на цялото ви приложение, използвайки [оценките за производителност, качество, риск и безопасност](https://learn.microsoft.com/azure/ai-studio/concepts/evaluation-metrics-built-in). Също така имате възможност да създавате и оценявате с [персонализирани оценители](https://learn.microsoft.com/azure/ai-studio/how-to/develop/evaluate-sdk#custom-evaluators).
Можете да оцените вашето AI приложение във вашата среда за разработка, като използвате [Azure AI Evaluation SDK](https://microsoft.github.io/promptflow/index.html). Като използвате тестов набор от данни или цел, генерираният от вашето генеративно AI приложение резултат се измерва количествено с вградени оценители или персонализирани оценители по ваш избор. За да започнете с azure ai evaluation sdk за оценяване на вашата система, можете да следвате [бързия старт](https://learn.microsoft.com/azure/ai-studio/how-to/develop/flow-evaluate-sdk). След като изпълните оценъчно изпълнение, можете да [визуализирате резултатите в Azure AI Foundry](https://learn.microsoft.com/azure/ai-studio/how-to/evaluate-flow-results).

## Търговски марки

Този проект може да съдържа търговски марки или лога за проекти, продукти или услуги. Разрешената употреба на търговски марки или лога на Microsoft се подчинява на и трябва да следва [Правилата за търговски марки и брандове на Microsoft](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
Употребата на търговски марки или лога на Microsoft в модифицирани версии на този проект не трябва да предизвиква объркване или да поддържа внушението за спонсориране от Microsoft. Всяка употреба на търговски марки или лога на трети страни е обект на правилата на тези трети страни.
