...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-21T13:39:15+00:00",
...
[![Контрибутори в GitHub](https://img.shields.io/github/contributors/microsoft/phicookbook.svg)](https://GitHub.com/microsoft/phicookbook/graphs/contributors/?WT.mc_id=aiml-137032-kinfeylo)
[![Issues в GitHub](https://img.shields.io/github/issues/microsoft/phicookbook.svg)](https://GitHub.com/microsoft/phicookbook/issues/?WT.mc_id=aiml-137032-kinfeylo)
[![Pull заявки в GitHub](https://img.shields.io/github/issues-pr/microsoft/phicookbook.svg)](https://GitHub.com/microsoft/phicookbook/pulls/?WT.mc_id=aiml-137032-kinfeylo)
[![PR-и добре дошли](https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat-square)](http://makeapullrequest.com?WT.mc_id=aiml-137032-kinfeylo)

[![Watchers в GitHub](https://img.shields.io/github/watchers/microsoft/phicookbook.svg?style=social&label=Watch)](https://GitHub.com/microsoft/phicookbook/watchers/?WT.mc_id=aiml-137032-kinfeylo)
[![Forks в GitHub](https://img.shields.io/github/forks/microsoft/phicookbook.svg?style=social&label=Fork)](https://GitHub.com/microsoft/phicookbook/network/?WT.mc_id=aiml-137032-kinfeylo)
...
[![Discord на Microsoft Azure AI Foundry](https://dcbadge.limes.pink/api/server/ByRwuEEgH4)](https://discord.com/invite/ByRwuEEgH4)

Phi е серия от отворен код модели за изкуствен интелект, разработени от Microsoft. 

Phi в момента е най-мощният и икономичен малък езиков модел (SLM), с много добри резултати в многoезични задачи, разсъждаване, генериране на текст/чат, кодиране, изображения, аудио и други сценарии. 

Можете да разгърнете Phi в облака или на edge устройства, и лесно да изграждате генеративни AI приложения с ограничена изчислителна мощ.

Следвайте тези стъпки, за да започнете да използвате тези ресурси :
1. **Форкнете хранилището**: Кликнете [![Forks в GitHub](https://img.shields.io/github/forks/microsoft/phicookbook.svg?style=social&label=Fork)](https://GitHub.com/microsoft/phicookbook/network/?WT.mc_id=aiml-137032-kinfeylo)
...
- Въведение
  ...
  - [Безопасност на AI за Phi моделите](./md/01.Introduction/01/01.AISafety.md)
  - [Поддръжка на хардуер за Phi](./md/01.Introduction/01/01.Hardwaresupport.md)
  - [Phi модели и наличност в различни платформи](./md/01.Introduction/01/01.Edgeandcloud.md)
  ...
  - [Каталог на модели на Azure AI](https://ai.azure.com)
...
- Инференция на Phi в различни среди
    ...
    -  [AI Toolkit за VSCode (AITK)](./md/01.Introduction/02/05.AITK.md)
    -  [NVIDIA NIM](./md/01.Introduction/02/06.NVIDIA.md)
    -  [Foundry Local](./md/01.Introduction/02/07.FoundryLocal.md)

- Инференция на фамилията Phi
    - [Инференция на Phi в iOS](./md/01.Introduction/03/iOS_Inference.md)
    - [Инференция на Phi в Android](./md/01.Introduction/03/Android_Inference.md)
    - [Инференция на Phi в Jetson](./md/01.Introduction/03/Jetson_Inference.md)
    - [Инференция на Phi в AI PC](./md/01.Introduction/03/AIPC_Inference.md)
    - [Инференция на Phi с Apple MLX Framework](./md/01.Introduction/03/MLX_Inference.md)
    - [Инференция на Phi в Local Server](./md/01.Introduction/03/Local_Server_Inference.md)
    - [Инференция на Phi в Remote Server, използвайки AI Toolkit](./md/01.Introduction/03/Remote_Interence.md)
    - [Инференция на Phi с Rust](./md/01.Introduction/03/Rust_Inference.md)
    - [Инференция Phi--Vision в локална среда](./md/01.Introduction/03/Vision_Inference.md)
    - [Инференция на Phi с Kaito AKS, Azure Containers(официална поддръжка)](./md/01.Introduction/03/Kaito_Inference.md)
-  [Квантизиране на фамилията Phi](./md/01.Introduction/04/QuantifyingPhi.md)
    - [Квантизиране на Phi-3.5 / 4 с помощта на llama.cpp](./md/01.Introduction/04/UsingLlamacppQuantifyingPhi.md)
    - [Квантизиране на Phi-3.5 / 4 с помощта на Generative AI разширения за onnxruntime](./md/01.Introduction/04/UsingORTGenAIQuantifyingPhi.md)
...
- Примери за разработване на приложения с Phi
  - Текстови & чат приложения
    - Phi-4 Примери 🆕
      ...
      - [Чат .NET конзолно приложение с Phi-4 ONNX, използващо Sementic Kernel](../../md/04.HOL/dotnet/src/LabsPhi4-Chat-02SK)
    - Phi-3 / 3.5 Примери
      ...
      - [Оптимизация на модела - Как да оптимизирате Phi-3-min модел за ONNX Runtime Web с Olive](https://github.com/microsoft/Olive/tree/main/examples/phi3)
      - [WinUI3 приложение с Phi-3 mini-4k-instruct-onnx](https://github.com/microsoft/Phi3-Chat-WinUI3-Sample/)
      -[WinUI3 пример на приложение за бележки, захранвано от множество AI модели](https://github.com/microsoft/ai-powered-notes-winui3-sample)
      - [Фина настройка и интегриране на персонализирани Phi-3 модели с Prompt flow](./md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-FineTuning_PromptFlow_Integration.md)
      - [Фина настройка и интегриране на персонализирани Phi-3 модели с Prompt flow в Azure AI Foundry](./md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-FineTuning_PromptFlow_Integration_AIFoundry.md)
      - [Оценка на финно-настроените Phi-3 / Phi-3.5 модели в Azure AI Foundry с фокус върху принципите за отговорен AI на Microsoft](./md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-Evaluation_AIFoundry.md)
      ...
      - [Q&A .NET пример, използващ локален ONNX Phi-3 модел чрез Microsoft.ML.OnnxRuntime](../../md/04.HOL/dotnet/src/LabsPhi301)
      - [Конзолно .NET чат приложение със Semantic Kernel и Phi-3](../../md/04.HOL/dotnet/src/LabsPhi302)

  - Примери на код, базирани на Azure AI Inference SDK 
    - Phi-4 Примери 🆕
      - [📓] [Генериране на код за проект с Phi-4-multimodal](./md/02.Application/02.Code/Phi4/GenProjectCode/README.md)
    - Phi-3 / 3.5 Примери
      - [Изградете собствен Visual Studio Code GitHub Copilot Chat с Microsoft Phi-3 Family](./md/02.Application/02.Code/Phi3/VSCodeExt/README.md)
      - [Създайте собствен Visual Studio Code Chat Copilot агент с Phi-3.5 от GitHub Models](/md/02.Application/02.Code/Phi3/CreateVSCodeChatAgentWithGitHubModels.md)

  - Примери за напреднало разсъждение
    - Phi-4 Примери 🆕
      - [📓] [Примери за Phi-4-mini-reasoning или Phi-4-reasoning](./md/02.Application/03.AdvancedReasoning/Phi4/AdvancedResoningPhi4mini/README.md)
  ...
  - Демонстрации
      ...
      - [Phi-4-multimodal демонстрации, хоствани на Hugginge Face Spaces](https://huggingface.co/spaces/microsoft/phi-4-multimodal?WT.mc_id=aiml-137032-kinfeylo)
  - Примери за компютърно зрение
    - Phi-4 Примери 🆕
      - [📓] [Използвайте Phi-4-multimodal за четене на изображения и генериране на код](./md/02.Application/04.Vision/Phi4/CreateFrontend/README.md) 
    - Phi-3 / 3.5 Примери
      -  [📓][Phi-3-vision-Изображение текст към текст](./md/02.Application/04.Vision/Phi3/E2E_Phi-3-vision-image-text-to-text-online-endpoint.ipynb)
      ...
      - [📓][Phi-3.5 Vision пример за многокадрови или множество изображения](./md/02.Application/04.Vision/Phi3/phi3-vision-demo.ipynb)
      - [Phi-3 Vision Local ONNX Model using the Microsoft.ML.OnnxRuntime .NET](../../md/04.HOL/dotnet/src/LabsPhi303)
      - [Menu based Phi-3 Vision Local ONNX Model using the Microsoft.ML.OnnxRuntime .NET](../../md/04.HOL/dotnet/src/LabsPhi304)

  - Математически примерис
  ...
  - Аудио примери
    - Phi-4 Примери 🆕
      ...
      - [.NET конзолно приложение, използващо Phi-4-multimodal Audio за анализ на аудиофайл и генериране на транскрипт](../../md/04.HOL/dotnet/src/LabsPhi4-MultiModal-02Audio)

  - MOE Примери
    - Phi-3 / 3.5 Примери
      - [📓] [Пример за Phi-3.5 Mixture of Experts модели (MoEs) за социални медии](./md/02.Application/06.MoE/Phi3/phi3_moe_demo.ipynb)
      - [📓] [Изграждане на Retrieval-Augmented Generation (RAG) конвейер с NVIDIA NIM Phi-3 MOE, Azure AI Search и LlamaIndex](./md/02.Application/06.MoE/Phi3/azure-ai-search-nvidia-rag.ipynb)
      - 
...
- Примери за фина настройка на Phi
  ...
  - [Практически лабораторен курс за фина настройка с Microsoft Olive](./md/03.FineTuning/olive-lab/readme.md)
...
- Практически лаборатории
  - [Изследване на най-съвременните модели: LLMs, SLMs, локално разработване и други](https://github.com/microsoft/aitour-exploring-cutting-edge-models)
...
- Академични изследователски статии и публикации
  ...
  - [(WhyPHI) Финно настройване на PHI-3 за задачи с избор от няколко отговора: Методология, резултати и предизвикателства](https://arxiv.org/abs/2501.01588)
...
Можете да научите как да използвате Microsoft Phi и как да изграждате E2E решения за различните си хардуерни устройства. За да изпробвате Phi лично, започнете, като експериментирате с моделите и персонализирате Phi за вашите сценарии, като използвате [Azure AI Foundry Azure AI Model Catalog](https://aka.ms/phi3-azure-ai). Повече информация можете да намерите в Ръководството за започване с [Azure AI Foundry](/md/02.QuickStart/AzureAIFoundry_QuickStart.md)
...
Можете да научите как да използвате Microsoft Phi и как да изграждате E2E решения за различните си хардуерни устройства. За да изпробвате Phi лично, започнете, като експериментирате с модела и персонализирате Phi за вашите сценарии, като използвате [GitHub Model Catalog](https://github.com/marketplace/models?WT.mc_id=aiml-137032-kinfeylo). Повече информация ще намерите в Ръководството за започване с [GitHub Model Catalog](/md/02.QuickStart/GitHubModel_QuickStart.md)
...
Можете също така да намерите модела на [Hugging Face](https://huggingface.co/microsoft)
...
Microsoft се ангажира да помага на клиентите ни да използват нашите ИИ продукти отговорно, да споделя наученото и да изгражда партньорства, основани на доверие чрез инструменти като Transparency Notes и Impact Assessments. Много от тези ресурси могат да бъдат намерени на [https://aka.ms/RAI](https://aka.ms/RAI).
Подходът на Microsoft към отговорния ИИ е основан на нашите принципи за ИИ: справедливост, надеждност и безопасност, поверителност и сигурност, приобщаване, прозрачност и отчетност.

Големи модели за естествен език, изображения и реч — като тези, използвани в този пример — потенциално могат да се държат по начини, които са несправедливи, ненадеждни или обидни, което от своя страна може да причини вреди. Моля, консултирайте се с [Azure OpenAI service Transparency note](https://learn.microsoft.com/legal/cognitive-services/openai/transparency-note?tabs=text), за да се информирате за рисковете и ограниченията.

Препоръчителният подход за смекчаване на тези рискове е да включите система за безопасност в архитектурата си, която може да открива и предотвратява вредно поведение. [Azure AI Content Safety](https://learn.microsoft.com/azure/ai-services/content-safety/overview) предоставя независим слой за защита, способен да открива вредно съдържание, генерирано от потребители и от ИИ в приложения и услуги. Azure AI Content Safety включва текстови и изображенчески API, които ви позволяват да откривате материал, който е вреден. В рамките на Azure AI Foundry услугата Content Safety ви позволява да преглеждате, изследвате и изпробвате примерен код за откриване на вредно съдържание в различни модалности. Следната [документация за бърз старт](https://learn.microsoft.com/azure/ai-services/content-safety/quickstart-text?tabs=visual-studio%2Clinux&pivots=programming-language-rest) ви превежда през правенето на заявки към услугата.

Друг аспект, който трябва да се вземе предвид, е общата производителност на приложението. При мултимодални и мулти-моделни приложения под производителност разбираме това, че системата работи така, както вие и вашите потребители очаквате, включително да не генерира вредни изходи. Важно е да оцените производителността на цялото си приложение, използвайки [Performance and Quality and Risk and Safety evaluators](https://learn.microsoft.com/azure/ai-studio/concepts/evaluation-metrics-built-in). Също така имате възможност да създавате и оценявате с [custom evaluators](https://learn.microsoft.com/azure/ai-studio/how-to/develop/evaluate-sdk#custom-evaluators).

Можете да оцените вашето ИИ приложение в средата за разработка, използвайки [Azure AI Evaluation SDK](https://microsoft.github.io/promptflow/index.html). При предоставяне на тестов набор от данни или цел, генерациите на вашето генеративно ИИ приложение се измерват количествено с вградени оценители или с избрани от вас персонализирани оценители. За да започнете с azure ai evaluation sdk и да оцените вашата система, можете да следвате [ръководството за бърз старт](https://learn.microsoft.com/azure/ai-studio/how-to/develop/flow-evaluate-sdk). След като изпълните оценъчен рън, можете да [визуализирате резултатите в Azure AI Foundry](https://learn.microsoft.com/azure/ai-studio/how-to/evaluate-flow-results). 

## Търговски марки
Този проект може да съдържа търговски марки или лога на проекти, продукти или услуги. Упълномощеното използване на търговските марки или логата на Microsoft подлежи на и трябва да бъде в съответствие с [Ръководството за търговски марки и бранд на Microsoft](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
Използването на търговските марки или логата на Microsoft в модифицирани версии на този проект не трябва да създава объркване или да предполага спонсорство от Microsoft. Всяко използване на търговски марки или лога на трети страни подлежи на политиките на тези трети страни.

## Получаване на помощ

Ако заседнете или имате въпроси относно разработването на AI приложения, присъединете се:
