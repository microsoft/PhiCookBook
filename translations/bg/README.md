...
Phi е серия с отворен код на AI модели, разработени от Microsoft.

Понастоящем Phi е най-мощният и икономически ефективен малък езиков модел (SLM), с много добри показатели в многоезични, разсъждаващи, текстови/чат генерации, кодиране, изображения, аудио и други сценарии.
...
1. **Форкнете хранилището**: Натиснете [![GitHub forks](https://img.shields.io/github/forks/microsoft/phicookbook.svg?style=social&label=Fork)](https://GitHub.com/microsoft/phicookbook/network/?WT.mc_id=aiml-137032-kinfeylo)
...
- Въведение
  ...
  - [AI сигурност за Phi модели](./md/01.Introduction/01/01.AISafety.md)
...
-  [Квантуване на Phi семейството](./md/01.Introduction/04/QuantifyingPhi.md)
    - [Квантуване на Phi-3.5 / 4 с llama.cpp](./md/01.Introduction/04/UsingLlamacppQuantifyingPhi.md)
    - [Квантуване на Phi-3.5 / 4 с расширения за генеративен AI за onnxruntime](./md/01.Introduction/04/UsingORTGenAIQuantifyingPhi.md)
...
- RAG с Azure AI Търсене
    - [Как да използвате Phi-4-mini и Phi-4-мултимодален (RAG) с Azure AI Търсене](https://github.com/microsoft/PhiCookBook/blob/main/code/06.E2E/E2E_Phi-4-RAG-Azure-AI-Search.ipynb)
...
- Примери за разработка на Phi приложения
  - Текстови & Чат приложения
    - Phi-4 Примери 🆕
      ...
      - [Чат .NET конзолно приложение с Phi-4 ONNX чрез Sementic Kernel](../../md/04.HOL/dotnet/src/LabsPhi4-Chat-02SK)
    - Phi-3 / 3.5 Примери
      ...
      - [Оптимизация на модела - Как да оптимизирате модела Phi-3-min за ONNX Runtime Web с Olive](https://github.com/microsoft/Olive/tree/main/examples/phi3)
      - [WinUI3 приложение с Phi-3 mini-4k-instruct-onnx](https://github.com/microsoft/Phi3-Chat-WinUI3-Sample/)
      -[WinUI3 мулти модел AI захранено приложение за бележки пример](https://github.com/microsoft/ai-powered-notes-winui3-sample)
      ...
      - [Оценка на фино настроения Phi-3 / Phi-3.5 модел в Azure AI Foundry с фокус върху Принципите за отговорен AI на Microsoft](./md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-Evaluation_AIFoundry.md)
      - [📓] [Образец за езикова прогноза Phi-3.5-mini-instruct (китайски/английски)](./md/02.Application/01.TextAndChat/Phi3/phi3-instruct-demo.ipynb)
      ...
      - [Пример за въпроси и отговори .NET, използващ локален ONNX Phi-3 модел с Microsoft.ML.OnnxRuntime](../../md/04.HOL/dotnet/src/LabsPhi301)
      - [Конзолно чат .NET приложение със Semantic Kernel и Phi-3](../../md/04.HOL/dotnet/src/LabsPhi302)

  - Примери с код с Azure AI Inference SDK 
    - Phi-4 Примери 🆕
      - [📓] [Генериране на код за проект с Phi-4-мултимодален](./md/02.Application/02.Code/Phi4/GenProjectCode/README.md)
    - Phi-3 / 3.5 Примери
      ...
      - [Създайте свой собствен Visual Studio Code Chat Copilot агент с Phi-3.5 чрез GitHub модели](/md/02.Application/02.Code/Phi3/CreateVSCodeChatAgentWithGitHubModels.md)

  - Примери за напреднало разсъждение
    - Phi-4 Примери 🆕
      - [📓] [Phi-4-mini-разсъждение или Phi-4-разсъждения Примери](./md/02.Application/03.AdvancedReasoning/Phi4/AdvancedResoningPhi4mini/README.md)
      - [📓] [Фино настройване на Phi-4-mini-разсъждение с Microsoft Olive](./md/02.Application/03.AdvancedReasoning/Phi4/AdvancedResoningPhi4mini/olive_ft_phi_4_reasoning_with_medicaldata.ipynb)
      - [📓] [Фино настройване на Phi-4-mini-разсъждение с Apple MLX](./md/02.Application/03.AdvancedReasoning/Phi4/AdvancedResoningPhi4mini/mlx_ft_phi_4_reasoning_with_medicaldata.ipynb)
      - [📓] [Phi-4-mini-разсъждение с GitHub модели](./md/02.Application/02.Code/Phi4r/github_models_inference.ipynb)
      - [📓] [Phi-4-mini-разсъждение с модели от Azure AI Foundry](./md/02.Application/02.Code/Phi4r/azure_models_inference.ipynb)
  - Демота
      ...
      - [Phi-4-мултимодални демонстрации хоствани на Hugging Face Spaces](https://huggingface.co/spaces/microsoft/phi-4-multimodal?WT.mc_id=aiml-137032-kinfeylo)
  - Примери за визуално разпознаване
    - Phi-4 Примери 🆕
    ...
    - Phi-3 / 3.5 Примери
      -  [📓][Phi-3-vision-Текст към текст от изображение](./md/02.Application/04.Vision/Phi3/E2E_Phi-3-vision-image-text-to-text-online-endpoint.ipynb)
      - [Phi-3-vision-ONNX](https://onnxruntime.ai/docs/genai/tutorials/phi3-v.html)
      - [📓][Phi-3-vision CLIP ембединг](./md/02.Application/04.Vision/Phi3/E2E_Phi-3-vision-image-text-to-text-online-endpoint.ipynb)
      - [ДЕМО: Phi-3 рециклиране](https://github.com/jennifermarsman/PhiRecycling/)
      - [Phi-3-vision - Асистент за визуален език - с Phi3-Vision и OpenVINO](https://docs.openvino.ai/nightly/notebooks/phi-3-vision-with-output.html)
      ...
      - [Phi-3 Vision локален ONNX модел с помощта на Microsoft.ML.OnnxRuntime .NET](../../md/04.HOL/dotnet/src/LabsPhi303)
      - [Меню базиран Phi-3 Vision локален ONNX модел с помощта на Microsoft.ML.OnnxRuntime .NET](../../md/04.HOL/dotnet/src/LabsPhi304)
  ...
  - Аудио примери
    - Phi-4 Примери 🆕
      ...
      - [📓] [Аудио пример с Phi-4-мултимодален](./md/02.Application/05.Audio/Phi4/Siri/demo.ipynb)
      - [📓] [Пример за превод на реч с Phi-4-мултимодален](./md/02.Application/05.Audio/Phi4/Translate/demo.ipynb)
      - [Конзолно .NET приложение с Phi-4-мултимодален аудио за анализ на аудио файл и генериране на транскрипт](../../md/04.HOL/dotnet/src/LabsPhi4-MultiModal-02Audio)

  - Примери MOE
    - Phi-3 / 3.5 Примери
      - [📓] [Phi-3.5 Модели смес от експерти (MoEs) Пример за социални медии](./md/02.Application/06.MoE/Phi3/phi3_moe_demo.ipynb)
  ...
  - Примери за мултимодално смесване
    - Phi-4 Примери 🆕
      ...
      - [Конзолно .NET приложение използващо Phi-4-мултимодален за анализ на изображения](../../md/04.HOL/dotnet/src/LabsPhi4-MultiModal-01Images)
...
- Практическо упражнение
  - [Изследване на най-съвременни модели: LLMs, SLMs, локална разработка и други](https://github.com/microsoft/aitour-exploring-cutting-edge-models)
...
- Академични изследователски статии и публикации
  - [Учебници са всичко, от което имате нужда II: технически доклад phi-1.5](https://arxiv.org/abs/2309.05463)
  - [Phi-3 Технически доклад: Висококапацитен езиков модел локално на вашия телефон](https://arxiv.org/abs/2404.14219)
  ...
  - [(WhyPHI) Фино настройване на PHI-3 за многовариантно избиране на отговор: Методология, резултати и предизвикателства](https://arxiv.org/abs/2501.01588)
...
Можете да научите как да използвате Microsoft Phi и как да изграждате E2E решения на различните хардуерни устройства. За да изпробвате Phi сами, започнете да експериментирате с моделите и да персонализирате Phi за вашите сценарии, като използвате [Azure AI Foundry Azure AI Model Catalog](https://aka.ms/phi3-azure-ai). Можете да научите повече в Начин за започване с [Azure AI Foundry](/md/02.QuickStart/AzureAIFoundry_QuickStart.md).

**Пясъчник**
Всякакъв модел има отделен пясъчник за тестване на модела [Azure AI Playground](https://aka.ms/try-phi3).

### Phi в GitHub модели

Можете да научите как да използвате Microsoft Phi и как да изграждате E2E решения на различните хардуерни устройства. За да изпробвате Phi сами, започнете да експериментирате с модела и да персонализирате Phi за вашите сценарии, като използвате [GitHub Model Catalog](https://github.com/marketplace/models?WT.mc_id=aiml-137032-kinfeylo). Можете да научите повече в Начин за започване с [GitHub Model Catalog](/md/02.QuickStart/GitHubModel_QuickStart.md).
...
### Основно обучение
[![МО за начинаещи](https://img.shields.io/badge/ML%20for%20Beginners-22C55E?style=for-the-badge&labelColor=E5E7EB&color=22C55E)](https://aka.ms/ml-beginners?WT.mc_id=academic-105485-koreyst)
...
Microsoft е ангажиран да помага на нашите клиенти да използват нашите AI продукти отговорно, споделяйки наученото и изграждайки партньорства, основани на доверие чрез инструменти като Забележки за прозрачност и Оценки на въздействието. Много от тези ресурси могат да бъдат намерени на [https://aka.ms/RAI](https://aka.ms/RAI).
Подходът на Microsoft към отговорния ИИ е основан на нашите AI принципи за справедливост, надеждност и безопасност, поверителност и сигурност, приобщаване, прозрачност и отчетност.

Големите модели за естествен език, изображение и реч - като тези, използвани в този пример - могат потенциално да се държат по начин, който е несправедлив, ненадежден или обиден, което може да причини вреди. Моля, консултирайте се със [Забележката за прозрачност на услугата Azure OpenAI](https://learn.microsoft.com/legal/cognitive-services/openai/transparency-note?tabs=text), за да сте информирани за рисковете и ограниченията.

Препоръчителният подход за смекчаване на тези рискове е да включите система за безопасност в архитектурата си, която може да открива и предотвратява вредно поведение. [Azure AI Content Safety](https://learn.microsoft.com/azure/ai-services/content-safety/overview) предоставя независим слой защита, който може да открива вредно съдържание, генерирано от потребители и ИИ в приложения и услуги. Azure AI Content Safety включва текстови и визуални API, които ви позволяват да откривате материал, който е вреден. В рамките на Azure AI Foundry услугата Content Safety ви позволява да преглеждате, изследвате и изпробвате примерен код за откриване на вредно съдържание в различни модалности. Следната [документация за бързо започване](https://learn.microsoft.com/azure/ai-services/content-safety/quickstart-text?tabs=visual-studio%2Clinux&pivots=programming-language-rest) ви води през процеса на извършване на заявки към услугата.
Друг аспект, който трябва да се вземе предвид, е цялостната производителност на приложението. При мулти-модални и мулти-моделови приложения, под производителност разбираме, че системата работи според очакванията на вас и вашите потребители, включително и избегнато генериране на вредно съдържание. Важно е да оцените производителността на цялото си приложение с помощта на [оценители на производителността, качеството, риска и безопасността](https://learn.microsoft.com/azure/ai-studio/concepts/evaluation-metrics-built-in). Също така имате възможност да създавате и оценявате с [персонализирани оценители](https://learn.microsoft.com/azure/ai-studio/how-to/develop/evaluate-sdk#custom-evaluators).

Можете да оцените вашето AI приложение в средата за разработка, използвайки [Azure AI Evaluation SDK](https://microsoft.github.io/promptflow/index.html). Като използвате тестов набор от данни или цел, генерациите на вашето генеративно AI приложение се измерват количествено чрез вградени оценители или персонализирани оценители по ваш избор. За да започнете с azure ai evaluation sdk за оценка на вашата система, можете да следвате [бързото ръководство](https://learn.microsoft.com/azure/ai-studio/how-to/develop/flow-evaluate-sdk). След като изпълните оценъчно изпълнение, можете да [визуализирате резултатите в Azure AI Foundry](https://learn.microsoft.com/azure/ai-studio/how-to/evaluate-flow-results).

## Търговски марки

Този проект може да съдържа търговски марки или лога на проекти, продукти или услуги. Употребата на търговските марки или лога на Microsoft се извършва съгласно и трябва да спазва [Ръководството за търговски марки и бранд на Microsoft](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).  
Използването на търговски марки или лога на Microsoft в модифицирани версии на този проект не трябва да създава объркване или да предполага спонсорство от Microsoft. Всякаква употреба на търговски марки или лога на трети страни подлежи на правилата на тези трети страни.

## Получаване на помощ

Ако срещнете затруднения или имате въпроси относно изграждането на AI приложения, присъединете се към:

[![Azure AI Foundry Discord](https://img.shields.io/badge/Discord-Azure_AI_Foundry_Community_Discord-blue?style=for-the-badge&logo=discord&color=5865f2&logoColor=fff)](https://aka.ms/foundry/discord)

Ако имате обратна връзка за продукта или съобщавате за грешки по време на разработка, посетете:
