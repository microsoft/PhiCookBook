...
[![Заявки за вдигане в GitHub](https://img.shields.io/github/issues-pr/microsoft/phicookbook.svg)](https://GitHub.com/microsoft/phicookbook/pulls/?WT.mc_id=aiml-137032-kinfeylo)
...
Phi в момента е най-мощният и ефективен малък езиков модел (SLM), с много добри показатели в многоезично разбиране, разсъждение, генериране на текст/чат, кодиране, изображения, аудио и други сценарии.

Можете да разположите Phi в облака или на гранични устройства и лесно да създавате генеративни AI приложения с ограничени изчислителни ресурси.
...
3. [**Присъединете се към Microsoft AI Discord общността и се запознайте с експерти и други разработчици**](https://discord.com/invite/ByRwuEEgH4?WT.mc_id=aiml-137032-kinfeylo)
...
[Арабски](../ar/README.md) | [Бенгалски](../bn/README.md) | [Български](./README.md) | [Бирмански (Мианма)](../my/README.md) | [Китайски (опростен)](../zh-CN/README.md) | [Китайски (традиционен, Хонконг)](../zh-HK/README.md) | [Китайски (традиционен, Макао)](../zh-MO/README.md) | [Китайски (традиционен, Тайван)](../zh-TW/README.md) | [Хърватски](../hr/README.md) | [Чешки](../cs/README.md) | [Датски](../da/README.md) | [Холандски](../nl/README.md) | [Естонски](../et/README.md) | [Фински](../fi/README.md) | [Френски](../fr/README.md) | [Немски](../de/README.md) | [Гръцки](../el/README.md) | [Иврит](../he/README.md) | [Хинди](../hi/README.md) | [Унгарски](../hu/README.md) | [Индонезийски](../id/README.md) | [Италиански](../it/README.md) | [Японски](../ja/README.md) | [Каннада](../kn/README.md) | [Корейски](../ko/README.md) | [Литовски](../lt/README.md) | [Малайски](../ms/README.md) | [Малайалам](../ml/README.md) | [Маратхи](../mr/README.md) | [Непалски](../ne/README.md) | [Нигерийски пиджин](../pcm/README.md) | [Норвежки](../no/README.md) | [Персийски (Фарси)](../fa/README.md) | [Полски](../pl/README.md) | [Португалски (Бразилия)](../pt-BR/README.md) | [Португалски (Португалия)](../pt-PT/README.md) | [Панджаби (Гурмуки)](../pa/README.md) | [Румънски](../ro/README.md) | [Руски](../ru/README.md) | [Сръбски (кирилица)](../sr/README.md) | [Словашки](../sk/README.md) | [Словенски](../sl/README.md) | [Испански](../es/README.md) | [Суахили](../sw/README.md) | [Шведски](../sv/README.md) | [Тагалог (филипински)](../tl/README.md) | [Тамилски](../ta/README.md) | [Телугу](../te/README.md) | [Тайски](../th/README.md) | [Турски](../tr/README.md) | [Украински](../uk/README.md) | [Урду](../ur/README.md) | [Виетнамски](../vi/README.md)
...
- Въведение
  ...
  - [AI безопасност за модели Phi](./md/01.Introduction/01/01.AISafety.md)
...
- Извеждане на Phi в различни среди
    ...
    -  [Azure AI Foundry модел каталог](./md/01.Introduction/02/03.AzureAIFoundry.md)
...
-  [Квантоване на Phi фамилията](./md/01.Introduction/04/QuantifyingPhi.md)
    - [Квантоване на Phi-3.5 / 4 с llama.cpp](./md/01.Introduction/04/UsingLlamacppQuantifyingPhi.md)
    - [Квантоване на Phi-3.5 / 4 с генеративни AI разширения за onnxruntime](./md/01.Introduction/04/UsingORTGenAIQuantifyingPhi.md)
...
- Примери за разработка на приложения с Phi
  - Текстови и чат приложения
    - Phi-4 Примери 🆕
      ...
      - [Чат конзолно приложение .NET с Phi-4 ONNX използвайки Sementic Kernel](../../md/04.HOL/dotnet/src/LabsPhi4-Chat-02SK)
    - Phi-3 / 3.5 Примери
      - [Локален чатбот в браузъра, използващ Phi3, ONNX Runtime Web и WebGPU](https://github.com/microsoft/onnxruntime-inference-examples/tree/main/js/chat)
      ...
      -[Пример за приложение WinUI3 с мулти модел, захранван с AI бележки](https://github.com/microsoft/ai-powered-notes-winui3-sample)
      - [Фино настройване и интегриране на персонализирани Phi-3 модели с Prompt flow](./md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-FineTuning_PromptFlow_Integration.md)
      - [Фино настройване и интегриране на персонализирани Phi-3 модели с Prompt flow в Azure AI Foundry](./md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-FineTuning_PromptFlow_Integration_AIFoundry.md)
      - [Оценка на фино настроения модел Phi-3 / Phi-3.5 в Azure AI Foundry с акцент върху отговорните AI принципи на Microsoft](./md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-Evaluation_AIFoundry.md)
      ...
      - [Използване на Windows GPU за създаване на решение Prompt flow с Phi-3.5-Instruct ONNX](./md/02.Application/01.TextAndChat/Phi3/UsingPromptFlowWithONNX.md)
      ...
      - [Пример за въпроси и отговори .NET с локален ONNX Phi-3 модел, използващ Microsoft.ML.OnnxRuntime](../../md/04.HOL/dotnet/src/LabsPhi301)
      - [Конзолно чат .NET приложение със Semantic Kernel и Phi-3](../../md/04.HOL/dotnet/src/LabsPhi302)

  - Примери с код за Azure AI Inference SDK 
    - Примери с Phi-4 🆕
  ...
  - Примери за разширено разсъждение
    - Примери с Phi-4 🆕
      ...
      - [📓] [Фино настройване на Phi-4-mini-reasoning с Microsoft Olive](./md/02.Application/03.AdvancedReasoning/Phi4/AdvancedResoningPhi4mini/olive_ft_phi_4_reasoning_with_medicaldata.ipynb)
  ...
  - Примери за визия
    ...
    - Примери с Phi-3 / 3.5
      -  [📓][Phi-3-vision-образ текст към текст](./md/02.Application/04.Vision/Phi3/E2E_Phi-3-vision-image-text-to-text-online-endpoint.ipynb)
      - [Phi-3-vision-ONNX](https://onnxruntime.ai/docs/genai/tutorials/phi3-v.html)
      - [📓][Phi-3-vision CLIP embedding](./md/02.Application/04.Vision/Phi3/E2E_Phi-3-vision-image-text-to-text-online-endpoint.ipynb)
      - [DEMO: Phi-3 рециклиране](https://github.com/jennifermarsman/PhiRecycling/)
      ...
      - [📓][Phi-3.5 Vision мултирамков или мулти-изображен пример](./md/02.Application/04.Vision/Phi3/phi3-vision-demo.ipynb)
      - [Phi-3 Vision локален ONNX модел с използване на Microsoft.ML.OnnxRuntime .NET](../../md/04.HOL/dotnet/src/LabsPhi303)
      - [Меню базиран Phi-3 Vision локален ONNX модел с използване на Microsoft.ML.OnnxRuntime .NET](../../md/04.HOL/dotnet/src/LabsPhi304)

  - Примери с математика
  ...
  - Примери с аудио
    - Примери с Phi-4 🆕
      ...
      - [📓] [Phi-4-multimodal пример за речев превод](./md/02.Application/05.Audio/Phi4/Translate/demo.ipynb)
      - [Конзолно .NET приложение, използващо Phi-4-multimodal аудио за анализ на аудио файл и генериране на транскрипция](../../md/04.HOL/dotnet/src/LabsPhi4-MultiModal-02Audio)

  - MOE Примери
    - Примери с Phi-3 / 3.5
      - [📓] [Phi-3.5 Смес от експерти модели (MoEs) Пример за социални медии](./md/02.Application/06.MoE/Phi3/phi3_moe_demo.ipynb)
  ...
  - Примери за мултимодално смесване
    - Примери с Phi-4 🆕
      ...
      - [Конзолно .NET приложение, използващо Phi-4-multimodal за анализ на изображения](../../md/04.HOL/dotnet/src/LabsPhi4-MultiModal-01Images)
...
- Фино настройване на Phi примери
  ...
  - [Практически лабораторен курс за фино настройване с Microsoft Olive](./md/03.FineTuning/olive-lab/readme.md)
  ...
  - [Фино настройване на Phi-3 с Kaito AKS, Azure контейнерни услуги (официална поддръжка)](./md/03.FineTuning/FineTuning_Kaito.md)
  - [Фино настройване на Phi-3 и 3.5 Vision](https://github.com/2U1/Phi3-Vision-Finetune)

- Практически лабораторен курс
  - [Изследване на най-съвременните модели: LLMs, SLMs, локална разработка и други](https://github.com/microsoft/aitour-exploring-cutting-edge-models)
...
- Академични изследователски статии и публикации
  - [Учебниците са всичко, от което имате нужда II: технически доклад за phi-1.5](https://arxiv.org/abs/2309.05463)
  - [Технически доклад Phi-3: Много способен езиков модел локално на вашия телефон](https://arxiv.org/abs/2404.14219)
  - [Технически доклад Phi-4](https://arxiv.org/abs/2412.08905)
  - [Технически доклад Phi-4-Mini: Компактни, но мощни мултимодални езикови модели чрез Микс от LoRAs](https://arxiv.org/abs/2503.01743)
  - [Оптимизиране на малки езикови модели за извикване на функции в превозното средство](https://arxiv.org/abs/2501.02342)
  - [(WhyPHI) Финно настройване на PHI-3 за отговаряне на въпроси с множествен избор: методология, резултати и предизвикателства](https://arxiv.org/abs/2501.01588)
  - [Технически доклад Phi-4-засичане](https://www.microsoft.com/en-us/research/wp-content/uploads/2025/04/phi_4_reasoning.pdf)
  - [Технически доклад Phi-4-mini-засичане](https://huggingface.co/microsoft/Phi-4-mini-reasoning/blob/main/Phi-4-Mini-Reasoning.pdf)

## Използване на Phi модели

### Phi в Azure AI Foundry

Можете да научите как да използвате Microsoft Phi и как да изградите крайни решения (E2E) в различните си хардуерни устройства. За да изпробвате Phi сами, започнете с игра с моделите и персонализиране на Phi за вашите сценарии чрез [Azure AI Foundry Azure AI Model Catalog](https://aka.ms/phi3-azure-ai). Можете да научите повече в Започване с [Azure AI Foundry](/md/02.QuickStart/AzureAIFoundry_QuickStart.md)

**Пясъчник (Playground)**
Всеки модел има посветен пясъчник за тестване на модела [Azure AI Playground](https://aka.ms/try-phi3).

### Phi в GitHub Models

Можете да научите как да използвате Microsoft Phi и как да изградите крайни решения (E2E) в различните си хардуерни устройства. За да изпробвате Phi сами, започнете с игра с модела и персонализиране на Phi за вашите сценарии чрез [GitHub Model Catalog](https://github.com/marketplace/models?WT.mc_id=aiml-137032-kinfeylo). Можете да научите повече в Започване с [GitHub Model Catalog](/md/02.QuickStart/GitHubModel_QuickStart.md)

**Пясъчник (Playground)**
Всеки модел има посветен [пясъчник за тестване на модела](/md/02.QuickStart/GitHubModel_QuickStart.md).

### Phi в Hugging Face

Моделът също може да бъде намерен на [Hugging Face](https://huggingface.co/microsoft)
...
### Серия Copilot
[![Copilot за AI паралелно програмиране](https://img.shields.io/badge/Copilot%20for%20AI%20Paired%20Programming-FACC15?style=for-the-badge&labelColor=E5E7EB&color=FACC15)](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)
...
Microsoft е ангажиран да помага на клиентите си да използват нашите AI продукти отговорно, като споделя нашите знания и изгражда партньорства, базирани на доверие чрез инструменти като Записки за прозрачност и Оценки на въздействието. Много от тези ресурси могат да бъдат намерени на [https://aka.ms/RAI](https://aka.ms/RAI).  
Подходът на Microsoft към отговорния AI е основан на нашите принципи за AI: справедливост, надеждност и безопасност, поверителност и сигурност, включване, прозрачност и отчетност.

Големи модели за естествен език, изображения и реч – като тези, използвани в този пример – могат потенциално да се държат по несправедлив, ненадежден или обидителен начин, което може да причини вреди. Моля, консултирайте се със [Записката за прозрачност на услугата Azure OpenAI](https://learn.microsoft.com/legal/cognitive-services/openai/transparency-note?tabs=text), за да се информирате за рисковете и ограниченията.

Препоръчителният подход за намаляване на тези рискове е да включите в архитектурата си система за безопасност, която може да открива и предотвратява вредно поведение. [Azure AI Content Safety](https://learn.microsoft.com/azure/ai-services/content-safety/overview) предоставя независим защитен слой, способен да открива вредно съдържание, генерирано от потребителите или AI, в приложения и услуги. Azure AI Content Safety включва API за текст и изображения, които позволяват да откривате вреден материал. В Azure AI Foundry, услугата Content Safety позволява да разглеждате, изследвате и изпробвате примерен код за откриване на вредно съдържание в различни модалности. Следната [документация за бързо стартиране](https://learn.microsoft.com/azure/ai-services/content-safety/quickstart-text?tabs=visual-studio%2Clinux&pivots=programming-language-rest) ви води през процеса за изпращане на заявки към услугата.
Друг аспект, който трябва да се вземе предвид, е цялостното представяне на приложението. При мултимодални и многомоделни приложения, под представяне разбираме, че системата работи така, както вие и вашите потребители очаквате, включително да не генерира вредни резултати. Важно е да се оцени представянето на цялото ви приложение, използвайки [Оценители за представяне, качество, риск и безопасност](https://learn.microsoft.com/azure/ai-studio/concepts/evaluation-metrics-built-in). Вие също имате възможността да създавате и оценявате с [персонализирани оценители](https://learn.microsoft.com/azure/ai-studio/how-to/develop/evaluate-sdk#custom-evaluators).

Можете да оцените вашето AI приложение във вашата среда за разработка, използвайки [Azure AI Evaluation SDK](https://microsoft.github.io/promptflow/index.html). При наличие на тестов набор от данни или цел, генерациите на вашето генериращо AI приложение се измерват количествено с вградени оценители или с персонализирани оценители по ваш избор. За да започнете с azure ai evaluation sdk за оценка на вашата система, можете да следвате [ръководството за бърз старт](https://learn.microsoft.com/azure/ai-studio/how-to/develop/flow-evaluate-sdk). След като изпълните оценъчно изпълнение, можете да [визуализирате резултатите в Azure AI Foundry](https://learn.microsoft.com/azure/ai-studio/how-to/evaluate-flow-results).

## Търговски марки

Този проект може да съдържа търговски марки или лога на проекти, продукти или услуги. Разрешената употреба на търговски марки или лога на Microsoft подлежи на и трябва да следва [Правилата за търговски марки и брандиране на Microsoft](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
Използването на търговски марки или лога на Microsoft в модифицирани версии на този проект не трябва да предизвиква объркване или да предполага спонсорство от Microsoft. Всяка употреба на търговски марки или лога на трети страни е подчинена на правилата на тези трети страни.

## Получаване на помощ

Ако срещнете проблем или имате въпроси относно изграждането на AI приложения, присъединете се към:
