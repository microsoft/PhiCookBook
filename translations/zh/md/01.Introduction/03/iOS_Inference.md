...
![xcode](../../../../../translated_images/zh/xcode.8147789e6c25e3e2.png)

## **5. 将 ONNX 量化 INT4 模型复制到 App 项目中**

我们需要导入 ONNX 格式的 INT4 量化模型，需先下载该模型。

![hf](../../../../../translated_images/zh/hf.6b8504fd88ee48dd.png)

下载后，需要将其添加到 Xcode 项目的 Resources 目录中。

![model](../../../../../translated_images/zh/model.3b879b14e0be877d.png)
...
- **a.** 将对应的 C++ 头文件添加到项目中。
  ...
  ![Header File](../../../../../translated_images/zh/head.64cad021ce70a333.png)

- **b.** 在 Xcode 中引入 `onnxruntime-genai` 动态库。

  ![Library](../../../../../translated_images/zh/lib.a4209b9f21ddf344.png)
...
![Running Result](../../../../../translated_images/zh/result.326a947a6a2b9c51.jpg)
