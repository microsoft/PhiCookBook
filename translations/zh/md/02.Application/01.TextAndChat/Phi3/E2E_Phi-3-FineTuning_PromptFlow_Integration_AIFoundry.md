...
1. 选择您创建的 *finetune-phi* 文件夹，路径位于 *C:\Users\yourUserName\finetune-phi*。
    ...
    ![选择您创建的文件夹。](../../../../../../translated_images/04-01-open-project-folder.f734374bcfd5f9e6.zh.png)
...
1. 选择您创建的 Azure Machine Learning 工作区。
    ...
    ![选择您创建的工作区。](../../../../../../translated_images/06-04-select-workspace.a92934ac04f4f181.zh.png)
...
1. 在本练习中，您成功使用 Azure Machine Learning 微调了 Phi-3 模型。请注意，微调过程可能需要相当长的时间。运行微调作业后，需要等待其完成。您可以通过导航到 Azure Machine Learning 工作区左侧的作业选项卡来监控微调作业状态。在后续系列中，您将部署微调后的模型并将其与 Prompt flow 集成。
    ...
    ![查看微调作业。](../../../../../../translated_images/06-08-output.2bd32e59930672b1.zh.png)
...
1. 从导航菜单中选择 **+ 新建集线器**。
    ![创建中心。](../../../../../../translated_images/08-01-create-hub.8f7dd615bb8d9834.zh.png)
...
1. 执行以下任务：
    ...
    ![填写中心信息。](../../../../../../translated_images/08-02-fill-hub.c2d3b505bbbdba7c.zh.png)
...
1. 从导航菜单中选择 **+ 新建项目**。
    ...
    ![选择新建项目。](../../../../../../translated_images/08-04-select-new-project.390fadfc9c8f8f12.zh.png)
...
1. 从左侧选项卡中选择 **端点**。
    ...
    ![选择端点。](../../../../../../translated_images/08-06-select-endpoints.aff38d453bcf9605.zh.png)
...
1. 复制您的 **REST 端点** 和 **主密钥**。
    ...
    ![复制 api 密钥和端点 URI。](../../../../../../translated_images/08-08-copy-endpoint-key.18f934b5953ae8cb.zh.png)
...
1. 选择 **+ 新建连接**。
    ...
    ![选择新建连接。](../../../../../../translated_images/08-09-select-new-connection.02eb45deadc401fc.zh.png)
...
1. 从导航菜单选择 **聊天流**。
    ...
    ![选择聊天流。](../../../../../../translated_images/08-13-select-flow-type.2ec689b22da32591.zh.png)
...
1. 选择 **聊天输入**、**聊天输出** 以启用与模型的聊天。
    ...
    ![输入输出。](../../../../../../translated_images/08-17-select-input-output.64dbb39bbe59d03b.zh.png)
...
1. 选择您创建的自定义连接的 **连接** 的 **值**。例如，*connection*。
    ...
    ![连接。](../../../../../../translated_images/09-03-select-connection.99bdddb4b1844023.zh.png)
