...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-17T10:02:03+00:00",
...
Phi is currently the most powerful and cost-effective small language model (SLM), achieving excellent benchmarks in multilingual capabilities, reasoning, text/chat generation, coding, images, audio, and other applications.

You can deploy Phi to the cloud or edge devices, and it allows you to easily build generative AI applications even with limited computing resources.
...
Learn how to use Microsoft Phi and build end-to-end solutions for various hardware devices. To explore Phi, start by experimenting with the models and customizing Phi for your specific scenarios using the [Azure AI Foundry Azure AI Model Catalog](https://aka.ms/phi3-azure-ai). For more information, check out the guide [Getting Started with Azure AI Foundry](/md/02.QuickStart/AzureAIFoundry_QuickStart.md).

**Playground**  
Each model has a dedicated playground for testing: [Azure AI Playground](https://aka.ms/try-phi3).

### Phi on GitHub Models

Learn how to use Microsoft Phi and build end-to-end solutions for various hardware devices. To explore Phi, start by experimenting with the models and customizing Phi for your specific scenarios using the [GitHub Model Catalog](https://github.com/marketplace/models?WT.mc_id=aiml-137032-kinfeylo). For more information, check out the guide [Getting Started with GitHub Model Catalog](/md/02.QuickStart/GitHubModel_QuickStart.md).

**Playground**  
Each model has a dedicated [playground for testing](/md/02.QuickStart/GitHubModel_QuickStart.md).
...
Large-scale natural language, image, and speech models—like those used in this sample—may sometimes behave unfairly, unreliably, or offensively, potentially causing harm. Refer to the [Azure OpenAI service Transparency note](https://learn.microsoft.com/legal/cognitive-services/openai/transparency-note?tabs=text) to understand risks and limitations.

To mitigate these risks, it is recommended to include a safety system in your architecture to detect and prevent harmful behavior. [Azure AI Content Safety](https://learn.microsoft.com/azure/ai-services/content-safety/overview) provides an independent layer of protection, capable of detecting harmful user-generated and AI-generated content in applications and services. Azure AI Content Safety includes text and image APIs to identify harmful material. Within Azure AI Foundry, the Content Safety service allows you to explore and test sample code for detecting harmful content across different modalities. The following [quickstart documentation](https://learn.microsoft.com/azure/ai-services/content-safety/quickstart-text?tabs=visual-studio%2Clinux&pivots=programming-language-rest) explains how to make requests to the service.

Another important consideration is overall application performance. For multi-modal and multi-model applications, performance means the system behaves as expected, including avoiding harmful outputs. Evaluate your application’s performance using [Performance and Quality and Risk and Safety evaluators](https://learn.microsoft.com/azure/ai-studio/concepts/evaluation-metrics-built-in). You can also create and assess [custom evaluators](https://learn.microsoft.com/azure/ai-studio/how-to/develop/evaluate-sdk#custom-evaluators).

Evaluate your AI application in your development environment using the [Azure AI Evaluation SDK](https://microsoft.github.io/promptflow/index.html). With a test dataset or target, your generative AI application outputs can be quantitatively measured using built-in or custom evaluators. To start using the Azure AI Evaluation SDK, follow the [quickstart guide](https://learn.microsoft.com/azure/ai-studio/how-to/develop/flow-evaluate-sdk). After running an evaluation, you can [visualize the results in Azure AI Foundry](https://learn.microsoft.com/azure/ai-studio/how-to/evaluate-flow-results).
...
Using Microsoft trademarks or logos in modified versions of this project must not create confusion or imply Microsoft sponsorship. Use of third-party trademarks or logos must adhere to the policies of those third parties.
