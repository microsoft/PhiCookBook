...
![Phi-3-FineTuning_PromptFlow_Integration Overview.](../../../../../../translated_images/en/00-01-architecture.198ba0f1ae6d841a.webp)
...
1. **[Scenario 3: Integrate with Prompt flow and Chat with your custom model in Microsoft Foundry](../../../../../../md/02.Application/01.TextAndChat/Phi3)**
...
1. Type *azure machine learning* in the **search bar** at the top of the portal page and select **Azure Machine Learning** from the options that appear.
    ...
    ![Type azure machine learning.](../../../../../../translated_images/en/01-01-type-azml.acae6c5455e67b4b.webp)

2. Select **+ Create** from the navigation menu.

3. Select **New workspace** from the navigation menu.

    ![Select new workspace.](../../../../../../translated_images/en/01-02-select-new-workspace.cd09cd0ec4a60ef2.webp)
...
4. Perform the following tasks:
    ...
    ![Fill azure machine learning.](../../../../../../translated_images/en/01-03-fill-AZML.a1b6fd944be0090f.webp)
...
1. Perform the following tasks to request *Standard NCADSA100v4 Family* quota:
    ...
    - Select the **Request quota** from the navigation menu.
        ...
        ![Request quota.](../../../../../../translated_images/en/02-02-request-quota.c0428239a63ffdd5.webp)
...
1. Type *managed identities* in the **search bar** at the top of the portal page and select **Managed Identities** from the options that appear.
    ...
    ![Type managed identities.](../../../../../../translated_images/en/03-01-type-managed-identities.24de763e0f1f37e5.webp)

1. Select **+ Create**.

    ![Select create.](../../../../../../translated_images/en/03-02-select-create.92bf8989a5cd98f2.webp)
...
1. Perform the following tasks:
    ...
    ![Select create.](../../../../../../translated_images/en/03-03-fill-managed-identities-1.ef1d6a2261b449e0.webp)
...
1. Inside Add role assignment page, Perform the following tasks:
    ...
    ![Fill contributor role.](../../../../../../translated_images/en/03-04-fill-contributor-role.73990bc6a32e140d.webp)
...
1. Type *storage accounts* in the **search bar** at the top of the portal page and select **Storage accounts** from the options that appear.
    ...
    ![Type storage accounts.](../../../../../../translated_images/en/03-05-type-storage-accounts.9303de485e65e1e5.webp)
...
1. Perform the following tasks to navigate to Add role assignment page:
    ...
    ![Add role.](../../../../../../translated_images/en/03-06-add-role.353ccbfdcf0789c2.webp)
...
1. Inside Add role assignment page, Perform the following tasks:
    ...
    ![Select managed identity.](../../../../../../translated_images/en/03-08-select-managed-identity.e80a2aad5247eb25.webp)
...
1. Type *container registries* in the **search bar** at the top of the portal page and select **Container registries** from the options that appear.
    ...
    ![Type container registries.](../../../../../../translated_images/en/03-09-type-container-registries.7a4180eb2110e5a6.webp)
...
1. Select the *finetune-phi* folder that you created, which is located at *C:\Users\yourUserName\finetune-phi*.
    ...
    ![Select the folder that you created.](../../../../../../translated_images/en/04-01-open-project-folder.f734374bcfd5f9e6.webp)

1. In the left pane of Visual Studio Code, right-click and select **New File** to create a new file named *download_dataset.py*.

    ![Create a new file.](../../../../../../translated_images/en/04-02-create-new-file.cf9a330a3a9cff92.webp)
...
1. Select **+ New**.
    ...
    ![Select compute.](../../../../../../translated_images/en/06-01-select-compute.a29cff290b480252.webp)
...
1. Perform the following tasks:
    ...
    ![Create cluster.](../../../../../../translated_images/en/06-02-create-cluster.f221b65ae1221d4e.webp)
...
1. Perform the following tasks:
    ...
    ![Create cluster.](../../../../../../translated_images/en/06-03-create-cluster.4a54ba20914f3662.webp)
...
1. Select the Azure Machine Learning workspace that you created.

    ![Select workspace that you created.](../../../../../../translated_images/en/06-04-select-workspace.a92934ac04f4f181.webp)
...
1. Perform the following tasks:
    ...
    ![Type phi-3-mini-4k.](../../../../../../translated_images/en/06-05-type-phi-3-mini-4k.8ab6d2a04418b250.webp)

1. Select **Fine-tune** from the navigation menu.

    ![Select fine tune.](../../../../../../translated_images/en/06-06-select-fine-tune.2918a59be55dfeec.webp)
...
1. Perform the following tasks:
    ...
    ![Fill fine-tuning page.](../../../../../../translated_images/en/06-07-fill-finetuning.b6d14c89e7c27d0b.webp)
...
1. In this exercise, you successfully fine-tuned the Phi-3 model using Azure Machine Learning. Please note that the fine-tuning process can take a considerable amount of time. After running the fine-tuning job, you need to wait for it to complete. You can monitor the status of the fine-tuning job by navigating to the Jobs tab on the left side of your Azure Machine Learning Workspace. In the next series, you will deploy the fine-tuned model and integrate it with Prompt flow.
    ...
    ![See finetuning job.](../../../../../../translated_images/en/06-08-output.2bd32e59930672b1.webp)
...
1. Select **From a job output**.
    ...
    ![Register model.](../../../../../../translated_images/en/07-01-register-model.ad1e7cc05e4b2777.webp)

1. Select the job that you created.

    ![Select job.](../../../../../../translated_images/en/07-02-select-job.3e2e1144cd6cd093.webp)
...
1. Ensure that **Job output** is selected; it should be automatically selected.
    ...
    ![Select output.](../../../../../../translated_images/en/07-03-select-output.4cf1a0e645baea1f.webp)

2. Select **Next**.

3. Select **Register**.

    ![Select register.](../../../../../../translated_images/en/07-04-register.fd82a3b293060bc7.webp)

4. You can view your registered model by navigating to the **Models** menu from the left side tab.

    ![Registered model.](../../../../../../translated_images/en/07-05-registered-model.7db9775f58dfd591.webp)
...
1. Select **Real-time endpoints** from the navigation menu.
    ...
    ![Create endpoint.](../../../../../../translated_images/en/07-06-create-endpoint.1ba865c606551f09.webp)

1. Select **Create**.

1. select the registered model that you created.

    ![Select registered model.](../../../../../../translated_images/en/07-07-select-registered-model.29c947c37fa30cb4.webp)
...
1. Perform the following tasks:
    ...
    ![Fill the deployment setting.](../../../../../../translated_images/en/07-08-deployment-setting.43ddc4209e673784.webp)
...
1. Select the endpoint that you created.
    ...
    ![Select endpoints](../../../../../../translated_images/en/07-09-check-deployment.325d18cae8475ef4.webp)
...
>
> ![Set traffic.](../../../../../../translated_images/en/07-10-set-traffic.085b847e5751ff3d.webp)
>
...
You need to create a Hub before creating the Project. A Hub acts like a Resource Group, allowing you to organize and manage multiple Projects within Microsoft Foundry.
...
1. Select **+ New hub** from the navigation menu.
    ![Create hub.](../../../../../../translated_images/en/08-01-create-hub.8f7dd615bb8d9834.webp)
...
1. Perform the following tasks:
    ...
    ![Fill hub.](../../../../../../translated_images/en/08-02-fill-hub.c2d3b505bbbdba7c.webp)
...
1. Select **+ New project** from the navigation menu.
    ...
    ![Select new project.](../../../../../../translated_images/en/08-04-select-new-project.390fadfc9c8f8f12.webp)

1. Enter **Project name**. It must be a unique value.

    ![Create project.](../../../../../../translated_images/en/08-05-create-project.4d97f0372f03375a.webp)
...
1. Select **Endpoints** from the left side tab.
    ...
    ![Select endpoints.](../../../../../../translated_images/en/08-06-select-endpoints.aff38d453bcf9605.webp)

1. Select endpoint that you created.

    ![Select endpoints.](../../../../../../translated_images/en/08-07-select-endpoint-created.47f0dc09df2e275e.webp)

1. Select **Consume** from the navigation menu.

1. Copy your **REST endpoint** and **Primary key**.

    ![Copy api key and endpoint uri.](../../../../../../translated_images/en/08-08-copy-endpoint-key.18f934b5953ae8cb.webp)

#### Add the Custom Connection

1. Visit [Microsoft Foundry](https://ai.azure.com/?WT.mc_id=aiml-137032-kinfeylo).

1. Navigate to the Microsoft Foundry project that you created.

1. In the Project that you created, select **Settings** from the left side tab.

1. Select **+ New connection**.

    ![Select new connection.](../../../../../../translated_images/en/08-09-select-new-connection.02eb45deadc401fc.webp)

1. Select **Custom keys** from the navigation menu.

    ![Select custom keys.](../../../../../../translated_images/en/08-10-select-custom-keys.856f6b2966460551.webp)
...
1. Perform the following tasks:
    ...
    ![Add connection.](../../../../../../translated_images/en/08-11-add-connection.785486badb4d2d26.webp)

1. Select **Add connection**.

#### Create Prompt flow

You have added a custom connection in Microsoft Foundry. Now, let's create a Prompt flow using the following steps. Then, you will connect this Prompt flow to the custom connection so that you can use the fine-tuned model within the Prompt flow.
...
1. Select **+ Create** from the navigation menu.
    ...
    ![Select Promptflow.](../../../../../../translated_images/en/08-12-select-promptflow.6f4b451cb9821e5b.webp)

1. Select **Chat flow** from the navigation menu.

    ![Select chat flow.](../../../../../../translated_images/en/08-13-select-flow-type.2ec689b22da32591.webp)

1. Enter **Folder name** to use.

    ![Enter name.](../../../../../../translated_images/en/08-14-enter-name.ff9520fefd89f40d.webp)
...
1. In the Prompt flow, perform the following tasks to rebuild the existing flow:
    ...
    ![Select raw file mode.](../../../../../../translated_images/en/08-15-select-raw-file-mode.61d988b41df28985.webp)
...
1. Add the following code to *integrate_with_promptflow.py* file to use the custom Phi-3 model in Prompt flow.
    ...
    ![Paste prompt flow code.](../../../../../../translated_images/en/08-16-paste-promptflow-code.a6041b74a7d09777.webp)
...
1. Select **Chat input**, **Chat output** to enable chat with your model.
    ...
    ![Input Output.](../../../../../../translated_images/en/08-17-select-input-output.64dbb39bbe59d03b.webp)
...
>
> ![Flow example.](../../../../../../translated_images/en/08-18-graph-example.d6457533952e690c.webp)
>
...
1. Select **Start compute sessions** to start Prompt flow.
    ...
    ![Start compute session.](../../../../../../translated_images/en/09-01-start-compute-session.a86fcf5be68e386b.webp)

1. Select **Validate and parse input** to renew parameters.

    ![Validate input.](../../../../../../translated_images/en/09-02-validate-input.317c76ef766361e9.webp)

1. Select the **Value** of the **connection** to the custom connection you created. For example, *connection*.

    ![Connection.](../../../../../../translated_images/en/09-03-select-connection.99bdddb4b1844023.webp)

#### Chat with your custom model

1. Select **Chat**.

    ![Select chat.](../../../../../../translated_images/en/09-04-select-chat.61936dce6612a1e6.webp)
...
1. Here's an example of the results: Now you can chat with your custom Phi-3 model. It is recommended to ask questions based on the data used for fine-tuning.
    ...
    ![Chat with prompt flow.](../../../../../../translated_images/en/09-05-chat-with-promptflow.c8ca404c07ab126f.webp)
