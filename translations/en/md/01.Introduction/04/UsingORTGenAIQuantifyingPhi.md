...
4. By quantizing the CPU INT4 model, we can deploy it to Edge Devices, which has better application scenarios, so we have completed Phi-3.5-Instruct around INT4
