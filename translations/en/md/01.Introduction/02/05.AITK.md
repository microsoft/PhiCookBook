...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-09T19:48:48+00:00",
...
You will be asked to sign in to GitHub, so please click "Allow" to continue. You will be redirected to the GitHub sign-in page.

Sign in and follow the prompts. After successful sign-in, you will be redirected back to VS Code.
...
These are accessible in the Resources section. To get started, select **Model Catalog**.
