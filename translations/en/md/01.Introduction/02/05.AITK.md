...
[AI Toolkit for VS Code](https://marketplace.visualstudio.com/items?itemName=ms-windows-ai-studio.windows-ai-studio) makes generative AI app development easier by combining advanced AI development tools and models from the Microsoft Foundry Catalog and other sources like Hugging Face. You can browse AI models powered by GitHub Models and Microsoft Foundry Model Catalogs, download them locally or remotely, fine-tune, test, and integrate them into your applications.
