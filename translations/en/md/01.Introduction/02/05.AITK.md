...
[AI Toolkit for VS Code](https://marketplace.visualstudio.com/items?itemName=ms-windows-ai-studio.windows-ai-studio) simplifies generative AI app development by bringing together cutting-edge AI development tools and models from Microsoft Foundry Catalog and other catalogs like Hugging Face. You will be able to browse the AI models catalog powered by GitHub Models and Microsoft Foundry Model Catalogs, download them locally or remotely, fine-tune, test and use them in your application.

AI Toolkit Preview will run locally. Local inference or fine-tuning depends on the model you selected; you may need to have a GPU such as NVIDIA CUDA GPU. You can run GitHub Models directly with AITK too.
...
You will be prompted to sign in to GitHub, so please click "Allow" to continue. You will be redirected to GitHub sign-in page.
...
![AI toolkit model catalog](../../../../../translated_images/en/AItoolkitmodel_catalog.7a7be6a7d8468d31.webp)
...
![Load model in playground](../../../../../translated_images/en/AItoolkitload_model_into_playground.dcef5355b1653b52.webp)
