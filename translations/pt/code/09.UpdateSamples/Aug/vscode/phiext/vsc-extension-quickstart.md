...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-09T05:33:50+00:00",
...
* Execute a tarefa "watch" pelo comando **Tasks: Run Task**. Certifique-se de que ela esteja rodando, ou os testes podem não ser detectados.
...
* Faça alterações em `src/test/extension.test.ts` ou crie novos arquivos de teste dentro da pasta `test`.
  ...
  * Você pode criar pastas dentro da `test` para organizar seus testes como quiser.
