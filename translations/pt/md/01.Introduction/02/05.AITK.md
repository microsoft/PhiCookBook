...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-09T09:30:33+00:00",
...
[AI Toolkit for VS Code](https://marketplace.visualstudio.com/items?itemName=ms-windows-ai-studio.windows-ai-studio) facilita o desenvolvimento de aplicações de IA generativa ao reunir ferramentas avançadas de desenvolvimento de IA e modelos do Azure AI Foundry Catalog e outros catálogos como o Hugging Face. Você poderá navegar pelo catálogo de modelos de IA alimentado pelos GitHub Models e Azure AI Foundry Model Catalogs, baixá-los localmente ou remotamente, ajustar, testar e usar em sua aplicação.

O AI Toolkit Preview será executado localmente. A inferência ou ajuste fino local depende do modelo selecionado; pode ser necessário ter uma GPU, como uma NVIDIA CUDA GPU. Você também pode executar os GitHub Models diretamente com o AITK.
...
1. Na barra de busca de extensões, digite "AI Toolkit"
...
Ao abrir o AI Toolkit pela barra lateral do VS Code, você pode escolher entre as seguintes opções:

![AI toolkit model catalog](../../../../../translated_images/AItoolkitmodel_catalog.eee6b38a71f628501d730ffe9c2ae69b8f18706e7492ac2371423b045485996e.pt.png)

- Encontrar um modelo suportado no **Model Catalog** e baixar localmente
- Testar a inferência do modelo no **Model Playground**
- Ajustar o modelo localmente ou remotamente no **Model Fine-tuning**
...
> **GPU vs CPU**
>
> Você vai notar que os cards dos modelos mostram o tamanho do modelo, a plataforma e o tipo de acelerador (CPU, GPU). Para desempenho otimizado em **dispositivos Windows que possuem pelo menos uma GPU**, selecione versões de modelos que sejam específicas para Windows.
>
...
>
>Para verificar se você tem uma GPU no seu dispositivo Windows, abra o **Gerenciador de Tarefas** e selecione a aba **Desempenho**. Se você tiver GPU(s), elas aparecerão listadas com nomes como "GPU 0" ou "GPU 1".
...
![Load model in playground](../../../../../translated_images/AItoolkitload_model_into_playground.e442d8013c65406e69471fb4f8e4e3800505255fe1bd7aa9422f02ee715bad57.pt.png)

### Usar a REST API na sua aplicação

O AI Toolkit vem com um servidor web local REST API **na porta 5272** que utiliza o [formato de chat completions da OpenAI](https://platform.openai.com/docs/api-reference/chat/create).

Isso permite que você teste sua aplicação localmente sem depender de um serviço de modelo de IA na nuvem. Por exemplo, o arquivo JSON abaixo mostra como configurar o corpo da requisição:
...
Adicione a [biblioteca cliente Azure OpenAI para .NET](https://www.nuget.org/packages/Azure.AI.OpenAI/) ao seu projeto usando NuGet:
...
- Ajuste fino e inferência usando recursos computacionais locais.
...
Consulte nossa [página de Q&A](https://github.com/microsoft/vscode-ai-toolkit/blob/main/archive/QA.md) para as dúvidas mais comuns e suas soluções
