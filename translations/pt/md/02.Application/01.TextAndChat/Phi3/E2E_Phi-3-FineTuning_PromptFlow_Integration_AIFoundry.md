...
![Phi-3-FineTuning_PromptFlow_Integration Overview.](../../../../../../translated_images/00-01-architecture.198ba0f1ae6d841a.pt.png)
...
1. Digite *azure machine learning* na **barra de pesquisa** no topo da página do portal e selecione **Azure Machine Learning** das opções que aparecem.
    ...
    ![Type azure machine learning.](../../../../../../translated_images/01-01-type-azml.acae6c5455e67b4b.pt.png)

2. Selecione **+ Criar** no menu de navegação.

3. Selecione **Novo workspace** no menu de navegação.

    ![Select new workspace.](../../../../../../translated_images/01-02-select-new-workspace.cd09cd0ec4a60ef2.pt.png)
...
4. Execute as seguintes tarefas:
    ...
    ![Fill azure machine learning.](../../../../../../translated_images/01-03-fill-AZML.a1b6fd944be0090f.pt.png)
...
1. Execute as seguintes tarefas para solicitar a quota da *Standard NCADSA100v4 Family*:
    ...
    - Selecione **Solicitar quota** no menu de navegação.
        ...
        ![Request quota.](../../../../../../translated_images/02-02-request-quota.c0428239a63ffdd5.pt.png)
...
1. Digite *managed identities* na **barra de pesquisa** no topo da página do portal e selecione **Managed Identities** das opções que aparecem.
    ...
    ![Type managed identities.](../../../../../../translated_images/03-01-type-managed-identities.24de763e0f1f37e5.pt.png)

1. Selecione **+ Criar**.

    ![Select create.](../../../../../../translated_images/03-02-select-create.92bf8989a5cd98f2.pt.png)
...
1. Execute as seguintes tarefas:
    ...
    ![Select create.](../../../../../../translated_images/03-03-fill-managed-identities-1.ef1d6a2261b449e0.pt.png)
...
1. Na página Adicionar atribuição de função, execute as seguintes tarefas:
    ...
    ![Fill contributor role.](../../../../../../translated_images/03-04-fill-contributor-role.73990bc6a32e140d.pt.png)
...
1. Digite *storage accounts* na **barra de pesquisa** no topo da página do portal e selecione **Storage accounts** das opções que aparecem.
    ...
    ![Type storage accounts.](../../../../../../translated_images/03-05-type-storage-accounts.9303de485e65e1e5.pt.png)
...
1. Execute as seguintes tarefas para navegar até à página Adicionar atribuição de função:
    ...
    ![Add role.](../../../../../../translated_images/03-06-add-role.353ccbfdcf0789c2.pt.png)
...
1. Na página Adicionar atribuição de função, execute as seguintes tarefas:
    ...
    ![Select managed identity.](../../../../../../translated_images/03-08-select-managed-identity.e80a2aad5247eb25.pt.png)
...
1. Digite *container registries* na **barra de pesquisa** no topo da página do portal e selecione **Container registries** das opções que aparecem.
    ...
    ![Type container registries.](../../../../../../translated_images/03-09-type-container-registries.7a4180eb2110e5a6.pt.png)
...
1. Selecione a pasta *finetune-phi* que criou, que está localizada em *C:\Users\yourUserName\finetune-phi*.
    ...
    ![Selecione a pasta que criou.](../../../../../../translated_images/04-01-open-project-folder.f734374bcfd5f9e6.pt.png)
...
1. No painel esquerdo do Visual Studio Code, clique com o botão direito e selecione **New File** para criar um novo ficheiro chamado *download_dataset.py*.
    ...
    ![Criar um novo ficheiro.](../../../../../../translated_images/04-02-create-new-file.cf9a330a3a9cff92.pt.png)
...
1. Selecione **+ New**.
    ...
    ![Selecionar compute.](../../../../../../translated_images/06-01-select-compute.a29cff290b480252.pt.png)
...
1. Execute as seguintes tarefas:
    ...
    ![Criar cluster.](../../../../../../translated_images/06-02-create-cluster.f221b65ae1221d4e.pt.png)
...
1. Execute as seguintes tarefas:
    ...
    ![Criar cluster.](../../../../../../translated_images/06-03-create-cluster.4a54ba20914f3662.pt.png)
...
1. Selecione o workspace do Azure Machine Learning que criou.
    ...
    ![Selecionar workspace que criou.](../../../../../../translated_images/06-04-select-workspace.a92934ac04f4f181.pt.png)
...
1. Execute as seguintes tarefas:
    ...
    ![Escreva phi-3-mini-4k.](../../../../../../translated_images/06-05-type-phi-3-mini-4k.8ab6d2a04418b250.pt.png)

1. Selecione **Fine-tune** no menu de navegação.

    ![Selecionar fine tune.](../../../../../../translated_images/06-06-select-fine-tune.2918a59be55dfeec.pt.png)
...
1. Execute as seguintes tarefas:
    ...
    ![Preencher a página do fine-tuning.](../../../../../../translated_images/06-07-fill-finetuning.b6d14c89e7c27d0b.pt.png)
...
1. Neste exercício, afinou com sucesso o modelo Phi-3 usando o Azure Machine Learning. Note que o processo de fine-tuning pode levar um tempo considerável. Após iniciar o trabalho de fine-tuning, terá de aguardar que seja concluído. Pode monitorizar o estado do trabalho de fine-tuning navegando para o separador Jobs no lado esquerdo do seu Workspace do Azure Machine Learning. Na próxima série, irá implementar o modelo afinado e integrá-lo com o Prompt flow.
    ...
    ![Vejas o trabalho de fine-tuning.](../../../../../../translated_images/06-08-output.2bd32e59930672b1.pt.png)
...
1. Selecione **From a job output**.
    ...
    ![Registar modelo.](../../../../../../translated_images/07-01-register-model.ad1e7cc05e4b2777.pt.png)

1. Selecione o trabalho que criou.

    ![Selecionar trabalho.](../../../../../../translated_images/07-02-select-job.3e2e1144cd6cd093.pt.png)
...
1. Certifique-se de que **Job output** está selecionado; isto deve ser selecionado automaticamente.
    ...
    ![Selecionar output.](../../../../../../translated_images/07-03-select-output.4cf1a0e645baea1f.pt.png)

2. Selecione **Next**.

3. Selecione **Register**.

    ![Selecionar registar.](../../../../../../translated_images/07-04-register.fd82a3b293060bc7.pt.png)

4. Pode ver o seu modelo registado navegando para o menu **Models** no separador do lado esquerdo.

    ![Modelo registado.](../../../../../../translated_images/07-05-registered-model.7db9775f58dfd591.pt.png)
...
1. Selecione **Real-time endpoints** no menu de navegação.
    ...
    ![Criar endpoint.](../../../../../../translated_images/07-06-create-endpoint.1ba865c606551f09.pt.png)

1. Selecione **Create**.

1. selecione o modelo registado que criou.

    ![Selecionar modelo registado.](../../../../../../translated_images/07-07-select-registered-model.29c947c37fa30cb4.pt.png)
...
1. Execute as seguintes tarefas:
    ...
    ![Preencher as definições de implementação.](../../../../../../translated_images/07-08-deployment-setting.43ddc4209e673784.pt.png)
...
1. Selecione o endpoint que criou.
    ...
    ![Selecionar endpoints](../../../../../../translated_images/07-09-check-deployment.325d18cae8475ef4.pt.png)
...
>
> ![Definir tráfego.](../../../../../../translated_images/07-10-set-traffic.085b847e5751ff3d.pt.png)
>
...
1. Selecione **+ New hub** no menu de navegação.
    ![Criar hub.](../../../../../../translated_images/08-01-create-hub.8f7dd615bb8d9834.pt.png)
...
1. Execute as seguintes tarefas:
    ...
    ![Preencher hub.](../../../../../../translated_images/08-02-fill-hub.c2d3b505bbbdba7c.pt.png)
...
1. Selecione **+ Novo projeto** no menu de navegação.
    ...
    ![Selecionar novo projeto.](../../../../../../translated_images/08-04-select-new-project.390fadfc9c8f8f12.pt.png)

1. Introduza **Nome do projeto**. Deve ser um valor único.

    ![Criar projeto.](../../../../../../translated_images/08-05-create-project.4d97f0372f03375a.pt.png)
...
1. Selecione **Endpoints** no separador do lado esquerdo.
    ...
    ![Selecionar endpoints.](../../../../../../translated_images/08-06-select-endpoints.aff38d453bcf9605.pt.png)

1. Selecione o endpoint que criou.

    ![Selecionar endpoints.](../../../../../../translated_images/08-07-select-endpoint-created.47f0dc09df2e275e.pt.png)

1. Selecione **Consumir** no menu de navegação.

1. Copie o seu **endpoint REST** e a **Chave primária**.

    ![Copiar chave api e URI do endpoint.](../../../../../../translated_images/08-08-copy-endpoint-key.18f934b5953ae8cb.pt.png)
...
1. Selecione **+ Nova ligação**.
    ...
    ![Selecionar nova ligação.](../../../../../../translated_images/08-09-select-new-connection.02eb45deadc401fc.pt.png)

1. Selecione **Chaves personalizadas** no menu de navegação.

    ![Selecionar chaves personalizadas.](../../../../../../translated_images/08-10-select-custom-keys.856f6b2966460551.pt.png)
...
1. Execute as seguintes tarefas:
    ...
    ![Adicionar ligação.](../../../../../../translated_images/08-11-add-connection.785486badb4d2d26.pt.png)
...
1. Selecione **+ Criar** no menu de navegação.
    ...
    ![Selecionar Promptflow.](../../../../../../translated_images/08-12-select-promptflow.6f4b451cb9821e5b.pt.png)

1. Selecione **Chat flow** no menu de navegação.

    ![Selecionar chat flow.](../../../../../../translated_images/08-13-select-flow-type.2ec689b22da32591.pt.png)

1. Introduza **Nome da pasta** a utilizar.

    ![Introduzir nome.](../../../../../../translated_images/08-14-enter-name.ff9520fefd89f40d.pt.png)
...
1. No Prompt flow, execute as seguintes tarefas para reconstruir o fluxo existente:
    ...
    ![Selecionar modo ficheiro bruto.](../../../../../../translated_images/08-15-select-raw-file-mode.61d988b41df28985.pt.png)
...
1. Adicione o seguinte código ao ficheiro *integrate_with_promptflow.py* para usar o modelo Phi-3 personalizado no Prompt flow.
    ...
    ![Colar código do prompt flow.](../../../../../../translated_images/08-16-paste-promptflow-code.a6041b74a7d09777.pt.png)
...
1. Selecione **Entrada de chat**, **Saída de chat** para ativar a conversa com o seu modelo.
    ...
    ![Entrada Saída.](../../../../../../translated_images/08-17-select-input-output.64dbb39bbe59d03b.pt.png)
...
>
> ![Exemplo de fluxo.](../../../../../../translated_images/08-18-graph-example.d6457533952e690c.pt.png)
>
...
1. Selecione **Iniciar sessões de computação** para iniciar o Prompt flow.
    ...
    ![Iniciar sessão de computação.](../../../../../../translated_images/09-01-start-compute-session.a86fcf5be68e386b.pt.png)

1. Selecione **Validar e analisar entrada** para renovar os parâmetros.

    ![Validar entrada.](../../../../../../translated_images/09-02-validate-input.317c76ef766361e9.pt.png)

1. Selecione o **Valor** da **ligação** para a ligação personalizada que criou. Por exemplo, *ligação*.

    ![Ligação.](../../../../../../translated_images/09-03-select-connection.99bdddb4b1844023.pt.png)

#### Conversar com o seu modelo personalizado

1. Selecione **Conversar**.

    ![Selecionar conversar.](../../../../../../translated_images/09-04-select-chat.61936dce6612a1e6.pt.png)
...
1. Aqui está um exemplo dos resultados: Agora pode conversar com o seu modelo Phi-3 personalizado. Recomenda-se fazer perguntas baseadas nos dados usados para o ajuste fino.
    ...
    ![Conversar com prompt flow.](../../../../../../translated_images/09-05-chat-with-promptflow.c8ca404c07ab126f.pt.png)
