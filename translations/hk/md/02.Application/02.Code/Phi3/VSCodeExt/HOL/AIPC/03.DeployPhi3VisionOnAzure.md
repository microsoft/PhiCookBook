...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-17T04:04:41+00:00",
...
我們使用 NPU 完成本地代碼的生產部署，接著希望透過它引入 PHI-3-VISION 的能力，實現由圖片生成代碼的功能。
...
![Catalog](../../../../../../../../../translated_images/zh-HK/vison_catalog.f979823d5bde8aef.webp)


### **3. 在 Azure 上部署 Phi-3-Vision**


![Deploy](../../../../../../../../../translated_images/zh-HK/vision_deploy.a8114ccd849a9572.webp)


### **4. 在 Postman 測試 Endpoint**


![Test](../../../../../../../../../translated_images/zh-HK/vision_test.0b9c1b1d414131d0.webp)
...
**恭喜**！你已完成快速部署 PHI-3-VISION，並嘗試如何利用圖片生成代碼。接下來，我們可以結合 NPU 與雲端來構建應用程式。
