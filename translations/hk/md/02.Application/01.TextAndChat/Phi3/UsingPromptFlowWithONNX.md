...
![pfvscode](../../../../../../translated_images/hk/pfvscode.eff93dfc66a42cbe.png)

2. 安裝完 Prompt flow VS Code 擴充功能後，點選該擴充功能，選擇 **Installation dependencies**，依照指引在你的環境中安裝 Prompt flow SDK

![pfsetup](../../../../../../translated_images/hk/pfsetup.b46e93096f5a254f.png)

3. 下載 [範例程式碼](../../../../../../code/09.UpdateSamples/Aug/pf/onnx_inference_pf)，並使用 VS Code 開啟此範例

![pfsample](../../../../../../translated_images/hk/pfsample.8d89e70584ffe7c4.png)

4. 開啟 **flow.dag.yaml** 選擇你的 Python 環境

![pfdag](../../../../../../translated_images/hk/pfdag.264a77f7366458ff.png)

   開啟 **chat_phi3_ort.py** 修改你的 Phi-3.5-instruct ONNX 模型路徑

![pfphi](../../../../../../translated_images/hk/pfphi.72da81d74244b45f.png)

5. 執行你的 prompt flow 進行測試

開啟 **flow.dag.yaml**，點選視覺化編輯器

![pfv](../../../../../../translated_images/hk/pfv.ba8a81f34b20f603.png)

點擊後執行測試

![pfflow](../../../../../../translated_images/hk/pfflow.4e1135a089b1ce1b.png)
...
![pfresult](../../../../../../translated_images/hk/pfresult.c22c826f8062d7cb.png)
