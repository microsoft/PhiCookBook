...
![Fine-tune complete](../../../../../translated_images/hk/log-finetuning-res.7b92254e7e822c7f.webp)

### 配置 Azure 資源
你需要透過命令面板執行 `AI Toolkit: Provision Azure Container Apps for inference` 來設定遠端推理的 Azure 資源。設定過程中，系統會要求你選擇 Azure 訂閱和資源群組。  
![Provision Inference Resource](../../../../../translated_images/hk/command-provision-inference.467afc8d351642fc.webp)
...
![Deploy for inference](../../../../../translated_images/hk/command-deploy.9adb4e310dd0b0ae.webp)
...
![App Endpoint](../../../../../translated_images/hk/notification-deploy.446e480a44b1be58.webp)
