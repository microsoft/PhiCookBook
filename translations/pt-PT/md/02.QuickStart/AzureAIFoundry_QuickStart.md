...
Criar um projeto e um hub no Microsoft Foundry é uma ótima forma de organizar e gerir o seu trabalho de IA. Aqui está um guia passo a passo para começar:

### Criar um Projeto no Microsoft Foundry

1. **Aceda ao Microsoft Foundry**: Inicie sessão no portal Microsoft Foundry.
2. **Criar um Projeto**:
   - Se estiver dentro de um projeto, selecione "Microsoft Foundry" no canto superior esquerdo da página para ir à página inicial.
...
Vá à página de implementação, selecione Playground e converse com o Phi-3 do Microsoft Foundry
...
- Escolha o modelo que pretende implementar no catálogo de modelos do Microsoft Foundry.
...
## **5. Utilizar a API Phi no Microsoft Foundry**
