...
### Começar com Phi-3:  
Para começar a usar os modelos Phi, pode explorar o [catálogo de modelos Azure AI](https://ai.azure.com/explore/models) ou o [GitHub Marketplace Models](https://github.com/marketplace/models), que oferece modelos pré-construídos e personalizáveis. Além disso, pode usar ferramentas como o [Microsoft Foundry](https://ai.azure.com) para desenvolver e implementar as suas aplicações de IA.
