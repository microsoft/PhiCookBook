...
```swift
// នៅក្នុង Xcode: ឯកសារ > បន្ថែម​ការ​ពឹងផ្អែក​ពី​កញ្ចប់
...
class PhiViewModel: ObservableObject {
    ...
    func loadModel() async {
        ...
        do {
            ...
            // Phi 3.5 mini បានកំណត់រួចជាមុននៅក្នុងឧទាហរណ៍ Swift MLX
            let modelConfig = ModelRegistry.phi3_5_4bit
            
            // Phi 4 mini អាចត្រូវបានទាញពី Hugging Face ប៉ុន្តែត្រូវយោងឧទាហរណ៍ Swift MLX ពីសាខា main
...
// បន្ទាប់មកប្រើការកំណត់រចនាសម្ព័ន្ធនេះពេលផ្ទុកម៉ូឌែល
self.modelContainer = try await LLMModelFactory.shared.loadContainer(
...
> **Note:** Phi-4 support was added to the MLX Swift Examples repository at the end of February 2025 (in [PR #216](https://github.com/ml-explore/mlx-swift-examples/pull/216)). As of March 2025, the latest official release (2.21.2 from December 2024) does not include built-in Phi-4 support. To use Phi-4 models, you'll need to reference the package directly from the main branch:
>
>```swift
...
**ការបដិសេធ**:
ឯកសារនេះត្រូវបានបកប្រែដោយប្រើសេវាកម្មបកប្រែ AI [Co-op Translator](https://github.com/Azure/co-op-translator). បើទោះបីយើងខិតខំរកភាពត្រឹមត្រូវ ក៏សូមយកចិត្តទុកដាក់ថា ការបកប្រែដោយស្វ័យប្រវត្តិអាចមានកំហុស ឬមិនត្រឹមត្រូវ។ ឯកសារដើមនៅក្នុងភាសាមូលដ្ឋានគួរត្រូវបានចាត់ទុកជាឯកសារផ្លូវការដែលមានអាទិភាព។ សម្រាប់ព័ត៌មានសំខាន់ៗ យើងផ្ដល់អនុសាសន៍ឱ្យធ្វើការបកប្រែដោយអ្នកជំនាញមនុស្សវិជ្ជាជីវៈ។ យើងមិនទទួលខុសត្រូវចំពោះការយល់ច្រឡំ ឬការបកស្រាយខុសណាមួយ ដែលកើតឡើងពីការប្រើប្រាស់ការបកប្រែនេះទេ។
