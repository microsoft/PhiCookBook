...
此端對端（E2E）範例基於微軟技術社群的指南「[Evaluate Fine-tuned Phi-3 / 3.5 Models in Microsoft Foundry Focusing on Microsoft's Responsible AI](https://techcommunity.microsoft.com/blog/educatordeveloperblog/evaluate-fine-tuned-phi-3--3-5-models-in-azure-ai-studio-focusing-on-microsofts-/4227850?WT.mc_id=aiml-137032-kinfeylo)」。

## 概覽

### 如何在 Microsoft Foundry 中評估微調後的 Phi-3 / Phi-3.5 模型的安全性與效能？

微調模型有時可能導致意外或不理想的回應。為確保模型保持安全且有效，評估模型產生有害內容的可能性，以及其產生準確、相關且連貫回應的能力非常重要。在本教學中，您將學習如何評估整合於 Microsoft Foundry 中 Prompt flow 的微調 Phi-3 / Phi-3.5 模型的安全性與效能。

以下是 Microsoft Foundry 的評估流程。

![教學架構。](../../../../../../translated_images/zh-TW/architecture.10bec55250f5d6a4.webp)
...
1. [**情境 1：Microsoft Foundry 的 Prompt flow 評估介紹**](../../../../../../md/02.Application/01.TextAndChat/Phi3)

    - [安全性評估介紹](../../../../../../md/02.Application/01.TextAndChat/Phi3)
    - [效能評估介紹](../../../../../../md/02.Application/01.TextAndChat/Phi3)

1. [**情境 2：在 Microsoft Foundry 中評估 Phi-3 / Phi-3.5 模型**](../../../../../../md/02.Application/01.TextAndChat/Phi3)

    - [開始之前](../../../../../../md/02.Application/01.TextAndChat/Phi3)
    - [部署 Azure OpenAI 以評估 Phi-3 / Phi-3.5 模型](../../../../../../md/02.Application/01.TextAndChat/Phi3)
    - [使用 Microsoft Foundry 的 Prompt flow 評估微調後的 Phi-3 / Phi-3.5 模型](../../../../../../md/02.Application/01.TextAndChat/Phi3)
...
為確保您的 AI 模型符合倫理且安全，評估其是否符合微軟的負責任 AI 原則至關重要。在 Microsoft Foundry 中，安全性評估可幫助您檢視模型是否容易遭受越獄攻擊，以及其產生有害內容的潛力，這與這些原則直接相關。
...
> [!NOTE]  
> 如果你是按照「[Fine-Tune and Integrate Custom Phi-3 Models with Prompt Flow in Microsoft Foundry](https://techcommunity.microsoft.com/t5/educator-developer-blog/fine-tune-and-integrate-custom-phi-3-models-with-prompt-flow-in/ba-p/4191726?wt.mc_id=studentamb_279723)」中描述的低程式碼方法進行，可以跳過此練習，直接進入下一個。  
...
要繼續，您需要將微調後的 Phi-3 / Phi-3.5 模型整合到 Microsoft Foundry 的 Prompt flow 中。

#### 建立 Microsoft Foundry Hub

在建立專案之前，您需要先建立一個 Hub。Hub 類似於資源群組，讓您能在 Microsoft Foundry 中組織和管理多個專案。
...
1. 從導覽選單選擇 **+ New hub**。
    ...
    ![Create hub.](../../../../../../translated_images/zh-TW/create-hub.5be78fb1e21ffbf1.webp)
...
1. 執行以下操作：
    ...
    ![Fill hub.](../../../../../../translated_images/zh-TW/fill-hub.baaa108495c71e34.webp)
...
1. 從導覽選單選擇 **+ New project**。
    ...
    ![Select new project.](../../../../../../translated_images/zh-TW/select-new-project.cd31c0404088d7a3.webp)

1. 輸入 **Project name**，必須是唯一值。

    ![Create project.](../../../../../../translated_images/zh-TW/create-project.ca3b71298b90e420.webp)
...
1. 從左側標籤選擇 **Endpoints**。
    ...
    ![Select endpoints.](../../../../../../translated_images/zh-TW/select-endpoints.ee7387ecd68bd18d.webp)

1. 選擇您建立的端點。

    ![Select endpoints.](../../../../../../translated_images/zh-TW/select-endpoint-created.9f63af5e4cf98b2e.webp)

1. 從導覽選單選擇 **Consume**。

1. 複製您的 **REST endpoint** 和 **Primary key**。

    ![Copy api key and endpoint uri.](../../../../../../translated_images/zh-TW/copy-endpoint-key.0650c3786bd646ab.webp)
...
1. 選擇 **+ New connection**。
    ...
    ![Select new connection.](../../../../../../translated_images/zh-TW/select-new-connection.fa0f35743758a74b.webp)

1. 從導覽選單選擇 **Custom keys**。

    ![Select custom keys.](../../../../../../translated_images/zh-TW/select-custom-keys.5a3c6b25580a9b67.webp)
...
1. 執行以下操作：
    ...
    ![Add connection.](../../../../../../translated_images/zh-TW/add-connection.ac7f5faf8b10b0df.webp)

1. 選擇 **Add connection**。

#### 建立 Prompt flow

您已在 Microsoft Foundry 新增自訂連線。接下來，讓我們依照以下步驟建立 Prompt flow，然後將此 Prompt flow 連接到自訂連線，以便在 Prompt flow 中使用微調後的模型。
...
1. 從導覽選單選擇 **+ Create**。
    ...
    ![Select Promptflow.](../../../../../../translated_images/zh-TW/select-promptflow.18ff2e61ab9173eb.webp)

1. 從導覽選單選擇 **Chat flow**。

    ![Select chat flow.](../../../../../../translated_images/zh-TW/select-flow-type.28375125ec9996d3.webp)

1. 輸入要使用的 **Folder name**。

    ![Select chat flow.](../../../../../../translated_images/zh-TW/enter-name.02ddf8fb840ad430.webp)
...
1. 在 Prompt flow 中，執行以下操作以重建現有流程：
    ...
    ![Select raw file mode.](../../../../../../translated_images/zh-TW/select-raw-file-mode.06c1eca581ce4f53.webp)
...
1. 將以下程式碼加入 *integrate_with_promptflow.py*，以在 Prompt flow 中使用自訂 Phi-3 / Phi-3.5 模型。
    ...
    ![Paste prompt flow code.](../../../../../../translated_images/zh-TW/paste-promptflow-code.cd6d95b101c0ec28.webp)

> [!NOTE]
> 如需在 Microsoft Foundry 使用 Prompt flow 的詳細資訊，請參考 [Prompt flow in Microsoft Foundry](https://learn.microsoft.com/azure/ai-studio/how-to/prompt-flow)。

1. 選擇 **Chat input**、**Chat output**，以啟用與模型的對話功能。

    ![Select Input Output.](../../../../../../translated_images/zh-TW/select-input-output.c187fc58f25fbfc3.webp)
...
> 重建後的流程應該如下圖所示：
>
> ![Flow example](../../../../../../translated_images/zh-TW/graph-example.82fd1bcdd3fc545b.webp)
>
...
1. 選擇 **Start compute sessions** 以啟動 Prompt flow。
    ...
    ![Start compute session.](../../../../../../translated_images/zh-TW/start-compute-session.9acd8cbbd2c43df1.webp)

1. 選擇 **Validate and parse input** 以更新參數。

    ![Validate input.](../../../../../../translated_images/zh-TW/validate-input.c1adb9543c6495be.webp)

1. 選擇 **connection** 的 **Value**，並選擇您建立的自訂連線，例如 *connection*。

    ![Connection.](../../../../../../translated_images/zh-TW/select-connection.1f2b59222bcaafef.webp)

#### 與您的自訂 Phi-3 / Phi-3.5 模型聊天

1. 選擇 **Chat**。

    ![Select chat.](../../../../../../translated_images/zh-TW/select-chat.0406bd9687d0c49d.webp)

1. 以下是範例結果：現在您可以與自訂的 Phi-3 / Phi-3.5 模型聊天。建議根據用於微調的資料來提問。

    ![Chat with prompt flow.](../../../../../../translated_images/zh-TW/chat-with-promptflow.1cf8cea112359ada.webp)

### 部署 Azure OpenAI 以評估 Phi-3 / Phi-3.5 模型

要在 Microsoft Foundry 中評估 Phi-3 / Phi-3.5 模型，您需要部署一個 Azure OpenAI 模型。此模型將用於評估 Phi-3 / Phi-3.5 模型的效能。
...
1. 導覽至您建立的 Microsoft Foundry 專案。
    ...
    ![Select Project.](../../../../../../translated_images/zh-TW/select-project-created.5221e0e403e2c9d6.webp)
...
1. 選擇 **Deploy base model**。
    ...
    ![Select Deployments.](../../../../../../translated_images/zh-TW/deploy-openai-model.95d812346b25834b.webp)

1. 選擇您想使用的 Azure OpenAI 模型，例如 **gpt-4o**。

    ![Select Azure OpenAI model you'd like to use.](../../../../../../translated_images/zh-TW/select-openai-model.959496d7e311546d.webp)

1. 選擇 **Confirm**。

### 使用 Microsoft Foundry 的 Prompt flow 評估微調後的 Phi-3 / Phi-3.5 模型
...
1. 從導覽選單選擇 **+ New evaluation**。
    ...
    ![Select evaluation.](../../../../../../translated_images/zh-TW/select-evaluation.2846ad7aaaca7f4f.webp)

1. 選擇 **Prompt flow** 評估。

    ![Select Prompt flow evaluation.](../../../../../../translated_images/zh-TW/promptflow-evaluation.cb9758cc19b4760f.webp)
...
1. 執行以下操作：
    ...
    ![Prompt flow evaluation.](../../../../../../translated_images/zh-TW/evaluation-setting1.4aa08259ff7a536e.webp)
...
1. 執行以下操作：
    ...
    ![Prompt flow evaluation.](../../../../../../translated_images/zh-TW/evaluation-setting2.07036831ba58d64e.webp)
...
1. 執行以下操作以設定效能與品質指標：
    ...
    ![Prompt flow evaluation.](../../../../../../translated_images/zh-TW/evaluation-setting3-1.d1ae69e3bf80914e.webp)
...
1. 執行以下操作以設定風險與安全指標：
    ...
    ![Prompt flow evaluation.](../../../../../../translated_images/zh-TW/evaluation-setting3-2.d53bd075c60a45a2.webp)
...
您已成功評估整合 Prompt flow 的微調 Phi-3 模型於 Microsoft Foundry。這是確保您的 AI 模型不僅表現優異，還符合 Microsoft 負責任 AI 原則的重要步驟，幫助您打造值得信賴且可靠的 AI 應用。
...
- [Microsoft Foundry 介紹](https://learn.microsoft.com/training/modules/introduction-to-azure-ai-studio/?wt.mc_id=studentamb_279723)
