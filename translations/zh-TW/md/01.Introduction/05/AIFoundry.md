...
執行評估後，您可以在 Microsoft Foundry 中記錄、查看並分析詳細的評估指標，深入了解應用的能力與限制。

**Note** Microsoft Foundry 目前處於公開預覽階段，建議用於實驗和開發用途。若用於正式生產工作負載，請考慮其他方案。更多細節與操作步驟，請參考官方 [AI Foundry 文件](https://learn.microsoft.com/azure/ai-studio/?WT.mc_id=aiml-138114-kinfeylo)。
