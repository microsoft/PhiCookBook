...
[AI Toolkit for VS Code](https://marketplace.visualstudio.com/items?itemName=ms-windows-ai-studio.windows-ai-studio) जनरेटिव AI ऐप विकास को सरल बनाता है, जो Microsoft Foundry Catalog और Hugging Face जैसे अन्य कैटलॉग से अत्याधुनिक AI विकास उपकरण और मॉडल एक साथ लाता है। आप GitHub Models और Microsoft Foundry Model Catalogs द्वारा संचालित AI मॉडल कैटलॉग ब्राउज़ कर सकेंगे, उन्हें स्थानीय या रिमोटली डाउनलोड कर सकेंगे, फाइन-ट्यून कर सकेंगे, टेस्ट कर सकेंगे और अपने एप्लिकेशन में उपयोग कर सकेंगे।
