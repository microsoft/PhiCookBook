...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-09T18:38:45+00:00",
...
[![Furushi za GitHub](https://img.shields.io/github/forks/microsoft/phicookbook.svg?style=social&label=Fork)](https://GitHub.com/microsoft/phicookbook/network/?WT.mc_id=aiml-137032-kinfeylo)  
...
Unaweza kupeleka Phi kwenye wingu au kwenye vifaa vya edge, na unaweza kwa urahisi kujenga programu za AI zinazozalisha kwa nguvu ndogo za kompyuta.

Fuata hatua hizi kuanza kutumia rasilimali hizi:  
1. **Fanya Fork ya Hifadhi**: Bonyeza [![GitHub forks](https://img.shields.io/github/forks/microsoft/phicookbook.svg?style=social&label=Fork)](https://GitHub.com/microsoft/phicookbook/network/?WT.mc_id=aiml-137032-kinfeylo)  
2. **Nakili Hifadhi**: `git clone https://github.com/microsoft/PhiCookBook.git`  
3. [**Jiunge na Jumuiya ya Microsoft AI Discord na kutana na wataalamu na waendelezaji wenzako**](https://discord.com/invite/ByRwuEEgH4?WT.mc_id=aiml-137032-kinfeylo)
...
[Kifaransa](../fr/README.md) | [Kihispania](../es/README.md) | [Kijerumani](../de/README.md) | [Kirusi](../ru/README.md) | [Kiarabu](../ar/README.md) | [Kiajemi (Farsi)](../fa/README.md) | [Kiurdu](../ur/README.md) | [Kichina (Rahisi)](../zh/README.md) | [Kichina (Macao, Asili)](../mo/README.md) | [Kichina (Hong Kong, Asili)](../hk/README.md) | [Kichina (Taiwan, Asili)](../tw/README.md) | [Kijapani](../ja/README.md) | [Kikorea](../ko/README.md) | [Kihindi](../hi/README.md)  
...
- Kutafsiri Familia ya Phi  
    ...
    - [Kutafsiri Phi--Vision ndani ya eneo](./md/01.Introduction/03/Vision_Inference.md)  
...
- Sampuli za maendeleo ya programu za Phi  
  - Programu za Maandishi & Mazungumzo  
    ...
    - Sampuli za Phi-3 / 3.5  
      - [Chatbot ya Ndani ya Kivinjari kwa kutumia Phi3, ONNX Runtime Web na WebGPU](https://github.com/microsoft/onnxruntime-inference-examples/tree/main/js/chat)  
      - [OpenVino Chat](./md/02.Application/01.TextAndChat/Phi3/E2E_OpenVino_Chat.md)  
      - [Mfano wa Multi Model - Phi-3-mini na OpenAI Whisper](./md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-mini_with_whisper.md)  
      - [MLFlow - Kujenga wrapper na kutumia Phi-3 na MLFlow](./md//02.Application/01.TextAndChat/Phi3/E2E_Phi-3-MLflow.md)  
      - [Uboreshaji wa Modeli - Jinsi ya kuboresha mfano wa Phi-3-mini kwa ONNX Runtime Web kwa kutumia Olive](https://github.com/microsoft/Olive/tree/main/examples/phi3)  
...
- [Tathmini ya modeli ya Phi-3 / Phi-3.5 iliyoboreshwa katika Azure AI Foundry ikizingatia kanuni za AI za kuwajibika za Microsoft](./md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-Evaluation_AIFoundry.md)
...
- [Mfano wa Maswali na Majibu .NET ukitumia modeli ya ONNX Phi-3 ya eneo la karibu kwa kutumia Microsoft.ML.OnnxRuntime](../../md/04.HOL/dotnet/src/LabsPhi301)
...
- Sampuli za Azure AI Inference SDK Zinazotegemea Msimbo  
  ...
  - Sampuli za Phi-3 / 3.5  
    - [Jenga Visual Studio Code GitHub Copilot Chat yako mwenyewe na Familia ya Microsoft Phi-3](./md/02.Application/02.Code/Phi3/VSCodeExt/README.md)  
...
- Maonyesho  
    - [Maonyesho ya Phi-4-mini yanayohudumiwa kwenye Hugging Face Spaces](https://huggingface.co/spaces/microsoft/phi-4-mini?WT.mc_id=aiml-137032-kinfeylo)  
    - [Maonyesho ya Phi-4-multimodal yanayohudumiwa kwenye Hugging Face Spaces](https://huggingface.co/spaces/microsoft/phi-4-multimodal?WT.mc_id=aiml-137032-kinfeylo)  
- Sampuli za Maono  
  - Sampuli za Phi-4 🆕  
  ...
  - Sampuli za Phi-3 / 3.5  
    ...
    - [📓][Mfano wa Phi-3.5 Vision wa fremu nyingi au picha nyingi](../../md/02.Application/04.Vision/Phi3/phi3-vision-demo.ipynb)  
    - [Phi-3 Vision Modeli ya ONNX ya Eneo la Karibu ukitumia Microsoft.ML.OnnxRuntime .NET](../../md/04.HOL/dotnet/src/LabsPhi303)  
    - [Phi-3 Vision Modeli ya ONNX ya Eneo la Karibu yenye Menyu ukitumia Microsoft.ML.OnnxRuntime .NET](../../md/04.HOL/dotnet/src/LabsPhi304)  
...
- Sampuli za MOE  
  - Sampuli za Phi-3 / 3.5  
    - [📓] [Phi-3.5 Mixture of Experts Models (MoEs) Mfano wa Mitandao ya Kijamii](../../md/02.Application/06.MoE/Phi3/phi3_moe_demo.ipynb)  
    - [📓] [Kujenga Mlolongo wa Uzalishaji ulioboreshwa kwa Urejeshaji (RAG) na NVIDIA NIM Phi-3 MOE, Azure AI Search, na LlamaIndex](../../md/02.Application/06.MoE/Phi3/azure-ai-search-nvidia-rag.ipynb)  
...
- Boresha Sampuli za Phi  
  ...
  - [Boresha Phi-3 kwa AI Toolkit kwa VS Code](./md/03.FineTuning/Finetuning_VSCodeaitoolkit.md)  
  - [Boresha Phi-3 kwa Azure Machine Learning Service](./md/03.FineTuning/Introduce_AzureML.md)  
  ...
  - [Maabara ya Vitendo ya Microsoft Olive](./md/03.FineTuning/olive-lab/readme.md)  
...
- Maabara ya Vitendo  
  - [Kuchunguza modeli za kisasa: LLMs, SLMs, maendeleo ya eneo la karibu na zaidi](https://github.com/microsoft/aitour-exploring-cutting-edge-models)  
...
- Makala za Utafiti wa Kitaaluma na Machapisho  
  ...
  - [Ripoti ya Kiufundi ya Phi-4-Mini: Modeli za Lugha za Multimodal Zenye Ukubwa Mdogo Lakini Zenye Nguvu Kupitia Mchanganyiko wa LoRAs](https://arxiv.org/abs/2503.01743)  
...
Modeli kubwa za lugha asilia, picha, na sauti - kama zile zinazotumika katika sampuli hii - zinaweza kuonyesha tabia zisizo za haki, zisizo za kuaminika, au za kuudhi, na hivyo kusababisha madhara. Tafadhali rejelea [Azure OpenAI service Transparency note](https://learn.microsoft.com/legal/cognitive-services/openai/transparency-note?tabs=text) ili upate taarifa kuhusu hatari na vikwazo.

Mbinu inayopendekezwa kupunguza hatari hizi ni kujumuisha mfumo wa usalama katika usanifu wako unaoweza kugundua na kuzuia tabia zenye madhara. [Azure AI Content Safety](https://learn.microsoft.com/azure/ai-services/content-safety/overview) hutoa tabaka huru la ulinzi, linaloweza kugundua maudhui hatarishi yanayotengenezwa na watumiaji na AI katika programu na huduma. Azure AI Content Safety inajumuisha API za maandishi na picha zinazokuwezesha kugundua maudhui hatarishi. Ndani ya Azure AI Foundry, huduma ya Content Safety inakuwezesha kuona, kuchunguza na kujaribu mifano ya msimbo wa kugundua maudhui hatarishi katika aina mbalimbali. Hati ifuatayo ya [quickstart documentation](https://learn.microsoft.com/azure/ai-services/content-safety/quickstart-text?tabs=visual-studio%2Clinux&pivots=programming-language-rest) itakuongoza jinsi ya kutuma maombi kwa huduma hii.
