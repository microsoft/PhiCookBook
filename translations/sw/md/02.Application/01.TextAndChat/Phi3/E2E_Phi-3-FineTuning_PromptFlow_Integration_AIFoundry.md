...
1. Chagua folda ya *finetune-phi* uliyotengeneza, ambayo iko *C:\Users\yourUserName\finetune-phi*.
    ...
    ![Chagua folda uliyotengeneza.](../../../../../../translated_images/04-01-open-project-folder.f734374bcfd5f9e6.sw.png)
...
1. Katika sehemu ya kushoto ya Visual Studio Code, bonyeza kulia kisha chagua **New File** kuunda faili mpya inayoitwa *download_dataset.py*.
    ...
    ![Tengeneza faili mpya.](../../../../../../translated_images/04-02-create-new-file.cf9a330a3a9cff92.sw.png)
...
1. Fanya yafuatayo:
    ...
    ![Tengeneza klasta.](../../../../../../translated_images/06-02-create-cluster.f221b65ae1221d4e.sw.png)
...
1. Fanya yafuatayo:
    ...
    ![Tengeneza klasta.](../../../../../../translated_images/06-03-create-cluster.4a54ba20914f3662.sw.png)
...
1. Chagua anga kazi (workspace) ya Azure Machine Learning uliyotengeneza.
    ...
    ![Chagua anga kazi uliyotengeneza.](../../../../../../translated_images/06-04-select-workspace.a92934ac04f4f181.sw.png)
...
1. Katika zoezi hili, umefanikiwa kufine-tune model ya Phi-3 kwa kutumia Azure Machine Learning. Tafadhali fahamu kuwa mchakato wa fine-tuning unaweza kuchukua muda mwingi. Baada ya kuendesha kazi ya fine-tuning, inabidi usubiri ikamilike. Unaweza kufuatilia hali ya kazi ya fine-tuning kwa kwenda kwenye kichupo cha Jobs upande wa kushoto wa Azure Machine Learning Workspace yako. Katika safu inayofuata, utatuma model iliyofine-tune na kuunganisha na Prompt Flow.
    ...
    ![Angalia kazi ya fine-tuning.](../../../../../../translated_images/06-08-output.2bd32e59930672b1.sw.png)
...
1. Chagua **From a job output**.
    ...
    ![Sajili model.](../../../../../../translated_images/07-01-register-model.ad1e7cc05e4b2777.sw.png)
...
1. Hakikisha **Job output** imechaguliwa; inapaswa kuchaguliwa moja kwa moja.
    ...
    ![Chagua matokeo.](../../../../../../translated_images/07-03-select-output.4cf1a0e645baea1f.sw.png)

2. Chagua **Next**.

3. Chagua **Register**.

    ![Chagua sajili.](../../../../../../translated_images/07-04-register.fd82a3b293060bc7.sw.png)

4. Unaweza kutazama model yako iliyosajiliwa kwa kwenda kwenye menyu ya **Models** kutoka upande wa kushoto.

    ![Model iliyosajiliwa.](../../../../../../translated_images/07-05-registered-model.7db9775f58dfd591.sw.png)
...
1. Chagua **Real-time endpoints** kutoka kwenye menyu ya urambazaji.
    ...
    ![Tengeneza endpoint.](../../../../../../translated_images/07-06-create-endpoint.1ba865c606551f09.sw.png)

1. Chagua **Create**.

1. Chagua model iliyosajiliwa uliyotengeneza.

    ![Chagua model iliyosajiliwa.](../../../../../../translated_images/07-07-select-registered-model.29c947c37fa30cb4.sw.png)
...
1. Fanya yafuatayo:
    ...
    ![Jaza mpangilio wa deployment.](../../../../../../translated_images/07-08-deployment-setting.43ddc4209e673784.sw.png)
