...
Kwa maendeleo ya AI ya Kizazi, tunatarajia kutumia jukwaa moja la kuendesha mifano tofauti ya LLM na SLM, ushirikiano wa data za biashara, urekebishaji/mchakato wa RAG, na tathmini ya biashara mbalimbali baada ya kuunganisha LLM na SLM, n.k., ili AI ya kizazi iweze kutekelezwa vyema katika programu za Smart. [Microsoft Foundry](https://ai.azure.com) ni jukwaa la programu za AI za kizazi kwa kiwango cha biashara.

![aistudo](../../../../translated_images/sw/aifoundry_home.f28a8127c96c7d93.webp)

Kwa Microsoft Foundry, unaweza kutathmini majibu ya mifano mikubwa ya lugha (LLM) na kupanga vipengele vya programu za prompt kwa kutumia prompt flow kwa utendaji bora. Jukwaa hili linawezesha upanuzi kwa kubadilisha majaribio kuwa uzalishaji kamili kwa urahisi. Ufuatiliaji endelevu na maboresho husaidia mafanikio ya muda mrefu.

Tunaweza kupeleka haraka mfano wa Phi-3 kwenye Microsoft Foundry kwa hatua rahisi, kisha tumia Microsoft Foundry kukamilisha kazi zinazohusiana na Phi-3 kama Playground/Chat, urekebishaji, tathmini na kazi nyinginezo.
...
Kuunda mradi na kituo cha Microsoft Foundry ni njia nzuri ya kupanga na kusimamia kazi zako za AI. Hapa kuna mwongozo wa hatua kwa hatua kuanza:

### Kuunda Mradi katika Microsoft Foundry

1. **Nenda Microsoft Foundry**: Ingia kwenye lango la Microsoft Foundry.
2. **Unda Mradi**:
   - Ikiwa uko ndani ya mradi, chagua "Microsoft Foundry" juu kushoto wa ukurasa kurudi kwenye ukurasa wa Nyumbani.
...
1. **Nenda Microsoft Foundry**: Ingia kwa akaunti yako ya Azure.
2. **Unda Kituo**:
...
Unda Microsoft Foundry [QuickStarts](https://learn.microsoft.com/azure/ai-studio/quickstarts/get-started-code)

## **2. Kuweka Mfano wa Phi katika Microsoft Foundry**
...
## **3. Playground Chat Phi katika Microsoft Foundry**

Nenda kwenye ukurasa wa kuweka, chagua Playground, na zungumza na Phi-3 wa Microsoft Foundry

## **4. Kuweka Mfano kutoka Microsoft Foundry**

Ili kuweka mfano kutoka Katalogi ya Mifano ya Azure, fuata hatua hizi:

- Ingia kwenye Microsoft Foundry.
- Chagua mfano unayotaka kuweka kutoka katalogi ya mifano ya Microsoft Foundry.
