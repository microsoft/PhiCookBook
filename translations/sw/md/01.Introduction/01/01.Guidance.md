...
### Kuanzia na Phi-3:
Ili kuanza kutumia modeli za Phi, unaweza kuchunguza [katalogi ya modeli za Azure AI](https://ai.azure.com/explore/models) au [GitHub Marketplace Models](https://github.com/marketplace/models) ambayo hutoa modeli zilizojengwa awali na zinazoweza kubadilishwa. Zaidi ya hayo, unaweza kutumia zana kama [Microsoft Foundry](https://ai.azure.com) kuendeleza na kupeleka programu zako za AI.
