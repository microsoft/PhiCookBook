...
![ട്യൂട്ടോറിയലിന്റെ ആർക്കിടെക്ചർ.](../../../../../../translated_images/ml/architecture.10bec55250f5d6a4.png)
...
![സേഫ്റ്റി മൂല്യനിർണയം.](../../../../../../translated_images/ml/safety-evaluation.083586ec88dfa950.png)
...
![Fill hub.](../../../../../../translated_images/ml/responsibleai2.c07ef430113fad8c.png)
...
![സുരക്ഷയെ അടിസ്ഥാനമാക്കി വിലയിരുത്തുക.](../../../../../../translated_images/ml/evaluate-based-on-safety.c5df819f5b0bfc07.png)
...
![പ്രകടന മൂല്യനിർണയം.](../../../../../../translated_images/ml/performance-evaluation.48b3e7e01a098740.png)
...
![പ്രകടനത്തെ അടിസ്ഥാനമാക്കി വിലയിരുത്തുക.](../../../../../../translated_images/ml/evaluate-based-on-performance.3e801c647c7554e8.png)
...
1. നാവിഗേഷൻ മെനുവിൽ നിന്നും **+ New hub** തിരഞ്ഞെടുക്കുക.
    ...
    ![Hub സൃഷ്ടിക്കുക.](../../../../../../translated_images/ml/create-hub.5be78fb1e21ffbf1.png)
1. Perform the following tasks:
    ...
    ![ഹബ് പൂരിപ്പിക്കുക.](../../../../../../translated_images/ml/fill-hub.baaa108495c71e34.png)
...
1. നാവിഗേഷൻ മെനുവിൽ നിന്നുള്ള **+ New project** തിരഞ്ഞെടുക്കുക.
    ...
    ![പുതിയ പ്രോജക്ട് തിരഞ്ഞെടുക്കുക.](../../../../../../translated_images/ml/select-new-project.cd31c0404088d7a3.png)

1. **Project name** നൽകുക. ഇത് പ്രത്യേകമായ മൂല്യം ആയിരിക്കണം.

    ![പ്രോജക്ട് സൃഷ്ടിക്കുക.](../../../../../../translated_images/ml/create-project.ca3b71298b90e420.png)
...
1. ഇടത് ടാബിൽ നിന്നുള്ള **Endpoints** തിരഞ്ഞെടുക്കുക.
    ...
    ![Endpoints തിരഞ്ഞെടുക്കുക.](../../../../../../translated_images/ml/select-endpoints.ee7387ecd68bd18d.png)

1. നിങ്ങൾ സൃഷ്ടിച്ച എൻഡ്പോയിന്റ് തിരഞ്ഞെടുക്കുക.

    ![സൃഷ്ടിച്ച എൻഡ്പോയിന്റ് തിരഞ്ഞെടുക്കുക.](../../../../../../translated_images/ml/select-endpoint-created.9f63af5e4cf98b2e.png)

1. നാവിഗേഷൻ മെനുവിൽ നിന്നുള്ള **Consume** തിരഞ്ഞെടുക്കുക.

1. നിങ്ങളുടെ **REST endpoint** ഉം **Primary key** ഉം കോപ്പി ചെയ്യുക.

    ![API കീയും എൻഡ്പോയിന്റ് URIയും കോപ്പി ചെയ്യുക.](../../../../../../translated_images/ml/copy-endpoint-key.0650c3786bd646ab.png)
...
1. **+ New connection** തിരഞ്ഞെടുക്കുക.
    ...
    ![പുതിയ കണക്ഷൻ തിരഞ്ഞെടുക്കുക.](../../../../../../translated_images/ml/select-new-connection.fa0f35743758a74b.png)

1. നാവിഗേഷൻ മെനുവിൽ നിന്നുള്ള **Custom keys** തിരഞ്ഞെടുക്കുക.

    ![കസ്റ്റം കീകൾ തിരഞ്ഞെടുക്കുക.](../../../../../../translated_images/ml/select-custom-keys.5a3c6b25580a9b67.png)
...
1. താഴെ പറയപ്പെടുന്ന കാര്യങ്ങൾ ചെയ്യുക:
    ...
    ![കണക്ഷൻ ചേർക്കുക.](../../../../../../translated_images/ml/add-connection.ac7f5faf8b10b0df.png)
...
1. നാവിഗേഷൻ മെനുവിൽ നിന്നുള്ള **+ Create** തിരഞ്ഞെടുക്കുക.
    ...
    ![Promptflow തിരഞ്ഞെടുക്കുക.](../../../../../../translated_images/ml/select-promptflow.18ff2e61ab9173eb.png)

1. നാവിഗേഷൻ മെനുവിൽ നിന്നുള്ള **Chat flow** തിരഞ്ഞെടുക്കുക.

    ![ചാറ്റ് ഫ്ലോ തിരഞ്ഞെടുക്കുക.](../../../../../../translated_images/ml/select-flow-type.28375125ec9996d3.png)

1. ഉപയോഗിക്കാൻ **Folder name** നൽകുക.

    ![ചാറ്റ് ഫ്ലോ തിരഞ്ഞെടുക്കുക.](../../../../../../translated_images/ml/enter-name.02ddf8fb840ad430.png)
...
1. Prompt flow-ൽ, നിലവിലുള്ള ഫ്ലോ പുനർനിർമ്മിക്കാൻ താഴെ പറയുന്ന പ്രവർത്തനങ്ങൾ ചെയ്യുക:
    ...
    ![Raw file mode തിരഞ്ഞെടുക്കുക.](../../../../../../translated_images/ml/select-raw-file-mode.06c1eca581ce4f53.png)
...
1. Prompt flow-യിൽ കസ്റ്റം Phi-3 / Phi-3.5 മോഡൽ ഉപയോഗിക്കാൻ *integrate_with_promptflow.py* ഫയലിൽ താഴെയുള്ള കോഡ് ചേർക്കുക.
    ...
    ![Prompt flow കോഡ് പേസ്റ്റ് ചെയ്യുക.](../../../../../../translated_images/ml/paste-promptflow-code.cd6d95b101c0ec28.png)
...
> 1. **Chat input**, **Chat output** തിരഞ്ഞെടുക്കുക, നിങ്ങളുടെ മോഡലുമായി ചാറ്റ് ചെയ്യാൻ സജ്ജമാക്കാൻ.
    ...
    ![ഇൻപുട്ട് ഔട്ട്പുട്ട് തിരഞ്ഞെടുക്കുക.](../../../../../../translated_images/ml/select-input-output.c187fc58f25fbfc3.png)
...
>
> ![ഫ്ലോ ഉദാഹരണം](../../../../../../translated_images/ml/graph-example.82fd1bcdd3fc545b.png)
>
...
1. Prompt flow ആരംഭിക്കാൻ **Start compute sessions** തിരഞ്ഞെടുക്കുക.
    ...
    ![കമ്പ്യൂട്ട് സെഷൻസ് ആരംഭിക്കുക.](../../../../../../translated_images/ml/start-compute-session.9acd8cbbd2c43df1.png)

1. പാരാമീറ്ററുകൾ പുതുക്കാൻ **Validate and parse input** തിരഞ്ഞെടുക്കുക.

    ![ഇൻപുട്ട് സാധുതപരിശോധിക്കുക.](../../../../../../translated_images/ml/validate-input.c1adb9543c6495be.png)
...
1. നിങ്ങൾ സൃഷ്ടിച്ച കസ്റ്റം കണക്ഷനുമായി ബന്ധിപ്പിക്കാൻ **connection** എന്ന പ്ലംബിൽ ഉള്ള **Value** തിരഞ്ഞെടുക്കുക. ഉദാഹരണത്തിന്, *connection*.
    ...
    ![കണക്ഷൻ തിരഞ്ഞെടുക്കുക.](../../../../../../translated_images/ml/select-connection.1f2b59222bcaafef.png)

#### നിങ്ങളുടെ കസ്റ്റം Phi-3 / Phi-3.5 മോഡലുമായി ചാറ്റ് ചെയ്യുക

1. **Chat** തിരഞ്ഞെടുക്കുക.

    ![ചാറ്റ് തിരഞ്ഞെടുക്കുക.](../../../../../../translated_images/ml/select-chat.0406bd9687d0c49d.png)
...
1. ഫലങ്ങളുടെ ഒരു ഉദാഹരണം ഇവിടെുണ്ട്: ഇപ്പോൾ നിങ്ങൾ നിങ്ങളുടെ കസ്റ്റം Phi-3 / Phi-3.5 മോഡലുമായി ചാറ്റ് ചെയ്യാൻ കഴിയും. ഫൈൻ-ട്യൂണിംഗിനായി ഉപയോഗിച്ച ഡാറ്റ അനുസരിച്ച് ചോദ്യങ്ങൾ ചോദിക്കുക എന്നതാണ് ശുപാർശ.
    ...
    ![Prompt flow-ഉടെ ചാറ്റ് ചെയ്യുക.](../../../../../../translated_images/ml/chat-with-promptflow.1cf8cea112359ada.png)
...
1. നിങ്ങൾ സൃഷ്ടിച്ച Azure AI Foundry പ്രോജക്ടിലേക്കു നാവിഗേറ്റ് ചെയ്യുക.
    ...
    ![പ്രോജക്ട് തിരഞ്ഞെടുക്കുക.](../../../../../../translated_images/ml/select-project-created.5221e0e403e2c9d6.png)
...
1. **Deploy base model** തിരഞ്ഞെടുക്കുക.
    ...
    ![Deployments തിരഞ്ഞെടുക്കുക.](../../../../../../translated_images/ml/deploy-openai-model.95d812346b25834b.png)

1. ഉപയോഗിക്കാൻ ഇഷ്ടമുള്ള Azure OpenAI മോഡൽ തിരഞ്ഞെടുക്കുക. ഉദാഹരണത്തിന്, **gpt-4o**.

    ![ഉപയോഗിക്കാൻ ആവശ്യമുള്ള Azure OpenAI മോഡൽ തിരഞ്ഞെടുക്കുക.](../../../../../../translated_images/ml/select-openai-model.959496d7e311546d.png)
...
1. നാവിഗേഷൻ മെനുവിൽ നിന്നുള്ള **+ New evaluation** തിരഞ്ഞെടുക്കുക.
    ...
    ![മൂല്യനിർണയം തിരഞ്ഞെടുക്കുക.](../../../../../../translated_images/ml/select-evaluation.2846ad7aaaca7f4f.png)

1. **Prompt flow** മൂല്യനിർണയം തിരഞ്ഞെടുക്കുക.

    ![Prompt flow മൂല്യനിർണയം തിരഞ്ഞെടുക്കുക.](../../../../../../translated_images/ml/promptflow-evaluation.cb9758cc19b4760f.png)
...
1. താഴെ പറയുന്ന കാര്യങ്ങൾ ചെയ്യുക:
    ...
    ![Prompt flow മൂല്യനിർണയം ക്രമീകരിക്കുക.](../../../../../../translated_images/ml/evaluation-setting1.4aa08259ff7a536e.png)
...
1. താഴെ പറയുന്ന കാര്യങ്ങൾ ചെയ്യുക:
    ...
    ![Prompt flow മൂല്യനിർണയം ക്രമീകരിക്കുക.](../../../../../../translated_images/ml/evaluation-setting2.07036831ba58d64e.png)
...
1. പ്രകടനവും ഗുണനിലവാരവും മെട്രിക്സുകൾ ക്രമീകരിക്കാൻ താഴെ പറയുന്ന കാര്യങ്ങൾ ചെയ്യുക:
    ...
    ![Prompt flow മൂല്യനിർണയം ക്രമീകരിക്കുക.](../../../../../../translated_images/ml/evaluation-setting3-1.d1ae69e3bf80914e.png)
...
1. റിസ്‌കും സുരക്ഷാ മെട്രിക്സുകളും ക്രമീകരിക്കാൻ താഴെ പറയുന്ന കാര്യങ്ങൾ ചെയ്യുക:
    ...
    ![Prompt flow മൂല്യനിർണയം ക്രമീകരിക്കുക.](../../../../../../translated_images/ml/evaluation-setting3-2.d53bd075c60a45a2.png)
...
1. പ്രകടനവും ഗുണനിലവാര മെട്രിക്സുകൾ:
    ...
    ![മൂല്യനിർണയ ഫലം.](../../../../../../translated_images/ml/evaluation-result-gpu.85f48b42dfb74254.png)
...
1. റിസ്‌ക് ಮತ್ತು സുരക്ഷാ മെട്രിക്സുകൾ:
    ...
    ![മൂല്യന ഫലം.](../../../../../../translated_images/ml/evaluation-result-gpu-2.1b74e336118f4fd0.png)

1. നിങ്ങൾ താഴേക്ക് സ്ക്രോൾ ചെയ്ത് **വിശദ മെട്രിക് ഫലം** കാണാവുന്നതാണ്.

    ![മൂല്യന ഫലം.](../../../../../../translated_images/ml/detailed-metrics-result.afa2f5c39a4f5f17.png)
...
![ആർക്കിടെക്ചർ.](../../../../../../translated_images/ml/architecture.10bec55250f5d6a4.png)
