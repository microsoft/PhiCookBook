...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-11T11:15:48+00:00",
...
[![PR-ek szívesen látva](https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat-square)](http://makeapullrequest.com?WT.mc_id=aiml-137032-kinfeylo)
...
A Phi-t telepítheted a felhőbe vagy élkészülékekre, és könnyedén építhetsz generatív AI alkalmazásokat korlátozott számítási kapacitással.

Kövesd az alábbi lépéseket, hogy elkezdhesd használni ezeket az erőforrásokat:
1. **Forkold a repót**: Kattints ide [![GitHub forkok](https://img.shields.io/github/forks/microsoft/phicookbook.svg?style=social&label=Fork)](https://GitHub.com/microsoft/phicookbook/network/?WT.mc_id=aiml-137032-kinfeylo)
...
- Bevezetés
  ...
  - [Környezeted beállítása](./md/01.Introduction/01/01.EnvironmentSetup.md)
...
- Phi család futtatása
    ...
    - [Phi futtatása az Apple MLX Framework segítségével](./md/01.Introduction/03/MLX_Inference.md)
    - [Phi futtatása helyi szerveren](./md/01.Introduction/03/Local_Server_Inference.md)
    - [Phi futtatása távoli szerveren az AI Toolkit segítségével](./md/01.Introduction/03/Remote_Interence.md)
...
-  [Phi család kvantálása](./md/01.Introduction/04/QuantifyingPhi.md)
    - [Phi-3.5 / 4 kvantálása a llama.cpp segítségével](./md/01.Introduction/04/UsingLlamacppQuantifyingPhi.md)
    - [Phi-3.5 / 4 kvantálása a generatív AI kiterjesztésekkel az onnxruntime-hoz](./md/01.Introduction/04/UsingORTGenAIQuantifyingPhi.md)
    - [Phi-3.5 / 4 kvantálása az Intel OpenVINO segítségével](./md/01.Introduction/04/UsingIntelOpenVINOQuantifyingPhi.md)
    - [Phi-3.5 / 4 kvantálása az Apple MLX Framework segítségével](./md/01.Introduction/04/UsingAppleMLXQuantifyingPhi.md)
...
- RAG az Azure AI Search segítségével
    - [Hogyan használd a Phi-4-mini és Phi-4-multimodal (RAG) modelleket az Azure AI Search-csel](https://github.com/microsoft/PhiCookBook/blob/main/code/06.E2E/E2E_Phi-4-RAG-Azure-AI-Search.ipynb)

- Phi alkalmazásfejlesztési minták
  - Szöveg- és chatalkalmazások
    - Phi-4 minták 🆕
      - [📓] [Chat a Phi-4-mini ONNX modellel](./md/02.Application/01.TextAndChat/Phi4/ChatWithPhi4ONNX/README.md)
      - [Chat a Phi-4 helyi ONNX modellel .NET-ben](../../md/04.HOL/dotnet/src/LabsPhi4-Chat-01OnnxRuntime)
      - [Chat .NET konzolalkalmazás Phi-4 ONNX-szel a Szemantikus Kernel használatával](../../md/04.HOL/dotnet/src/LabsPhi4-Chat-02SK)
    - Phi-3 / 3.5 minták
      ...
      - [Modelloptimalizálás - Hogyan optimalizáljuk a Phi-3-mini modellt az ONNX Runtime Webhez Olive segítségével](https://github.com/microsoft/Olive/tree/main/examples/phi3)
- [WinUI3 alkalmazás Phi-3 mini-4k-instruct-onnx modellel](https://github.com/microsoft/Phi3-Chat-WinUI3-Sample/)
- [WinUI3 Többmodellű AI által támogatott jegyzetek alkalmazás mintapéldája](https://github.com/microsoft/ai-powered-notes-winui3-sample)
...
- [📓] [Phi-3.5-mini-instruct nyelvi előrejelzés mintapélda (kínai/angol)](../../md/02.Application/01.TextAndChat/Phi3/phi3-instruct-demo.ipynb)
...
- Azure AI Inference SDK kód alapú minták
  ...
  - Phi-3 / 3.5 minták
    ...
    - [Saját Visual Studio Code Chat Copilot Agent létrehozása Phi-3.5 modellel GitHub modellek használatával](/md/02.Application/02.Code/Phi3/CreateVSCodeChatAgentWithGitHubModels.md)
...
- Vizuális minták
  ...
  - Phi-3 / 3.5 minták
    ...
    - [📓][Phi-3.5 Vision több képkocka vagy több kép mintapélda](../../md/02.Application/04.Vision/Phi3/phi3-vision-demo.ipynb)
...
- Matematikai minták
  - Phi-4-Mini-Flash-Reasoning-Instruct minták 🆕 [Matematikai demó Phi-4-Mini-Flash-Reasoning-Instruct modellel](../../md/02.Application/09.Math/MathDemo.ipynb)

- Audio minták
  - Phi-4 minták 🆕
    - [📓] [Audio átiratok kinyerése Phi-4-multimodal használatával](./md/02.Application/05.Audio/Phi4/Transciption/README.md)
    - [📓] [Phi-4-multimodal audio mintapélda](../../md/02.Application/05.Audio/Phi4/Siri/demo.ipynb)
    - [📓] [Phi-4-multimodal beszédfordítás mintapélda](../../md/02.Application/05.Audio/Phi4/Translate/demo.ipynb)
    - [.NET konzolos alkalmazás Phi-4-multimodal audio használatával audiofájl elemzésére és átirat generálására](../../md/04.HOL/dotnet/src/LabsPhi4-MultiModal-02Audio)

- MOE minták
  - Phi-3 / 3.5 minták
    - [📓] [Phi-3.5 Mixture of Experts Models (MoEs) közösségi média mintapélda](../../md/02.Application/06.MoE/Phi3/phi3_moe_demo.ipynb)
...
- Funkcióhívási minták
  - Phi-4 minták 🆕
    - [📓] [Funkcióhívás használata Phi-4-mini modellel](./md/02.Application/07.FunctionCalling/Phi4/FunctionCallingBasic/README.md)
    - [📓] [Funkcióhívás használata több ügynök létrehozásához Phi-4-mini modellel](../../md/02.Application/07.FunctionCalling/Phi4/Multiagents/Phi_4_mini_multiagent.ipynb)
...
- Gyakorlati labor
  ...
  - [NLP potenciál kiaknázása: Finomhangolás Microsoft Olive-val](https://github.com/azure/Ignite_FineTuning_workshop)
...
- Tudományos kutatási cikkek és publikációk
  ...
  - [Phi-4-Mini technikai jelentés: Kompakt, de erőteljes multimodális nyelvi modellek LoRA keverékekkel](https://arxiv.org/abs/2503.01743)
...
A modellt megtalálhatja a [Hugging Face](https://huggingface.co/microsoft) platformon is.  
...
A Microsoft elkötelezett amellett, hogy segítse ügyfeleit AI termékeink felelős használatában, megossza tapasztalatait, és bizalmon alapuló partnerségeket építsen olyan eszközök segítségével, mint a Transparency Notes és az Impact Assessments. Ezeket az erőforrásokat megtalálhatja itt: [https://aka.ms/RAI](https://aka.ms/RAI).  
...
A kockázatok mérséklésének ajánlott megközelítése egy biztonsági rendszer beépítése az architektúrába, amely képes felismerni és megelőzni a káros viselkedést. Az [Azure AI Content Safety](https://learn.microsoft.com/azure/ai-services/content-safety/overview) egy független védelmi réteget biztosít, amely képes felismerni a felhasználók által generált és AI által generált káros tartalmakat alkalmazásokban és szolgáltatásokban. Az Azure AI Content Safety szöveg- és kép-API-kat tartalmaz, amelyek lehetővé teszik a káros anyagok felismerését. Az Azure AI Foundry-n belül a Content Safety szolgáltatás lehetővé teszi, hogy megtekintse, felfedezze és kipróbálja a káros tartalmak felismerésére szolgáló mintakódokat különböző modalitásokban. Az alábbi [gyorsindítási dokumentáció](https://learn.microsoft.com/azure/ai-services/content-safety/quickstart-text?tabs=visual-studio%2Clinux&pivots=programming-language-rest) végigvezeti Önt a szolgáltatás kéréseinek elkészítésén.  

Egy másik szempont, amelyet figyelembe kell venni, az alkalmazás teljesítménye. Többmodális és többmodellű alkalmazások esetében a teljesítmény azt jelenti, hogy a rendszer úgy működik, ahogy Ön és felhasználói elvárják, beleértve a káros kimenetek generálásának elkerülését. Fontos, hogy értékelje az alkalmazás teljesítményét az [Teljesítmény és Minőség, valamint Kockázat és Biztonság értékelők](https://learn.microsoft.com/azure/ai-studio/concepts/evaluation-metrics-built-in) segítségével. Lehetősége van arra is, hogy [egyedi értékelőket](https://learn.microsoft.com/azure/ai-studio/how-to/develop/evaluate-sdk#custom-evaluators) hozzon létre és értékeljen.  

AI alkalmazását fejlesztési környezetében értékelheti az [Azure AI Evaluation SDK](https://microsoft.github.io/promptflow/index.html) segítségével. Akár tesztadatkészletet, akár célt ad meg, generatív AI alkalmazásának generációit mennyiségileg mérik beépített vagy az Ön által választott egyedi értékelők segítségével. Az Azure AI Evaluation SDK-val történő kezdéshez, hogy értékelje rendszerét, kövesse a [gyorsindítási útmutatót](https://learn.microsoft.com/azure/ai-studio/how-to/develop/flow-evaluate-sdk). Miután végrehajtott egy értékelési futtatást, [vizualizálhatja az eredményeket az Azure AI Foundry-ban](https://learn.microsoft.com/azure/ai-studio/how-to/evaluate-flow-results).  

## Védjegyek  

Ez a projekt tartalmazhat védjegyeket vagy logókat projektekhez, termékekhez vagy szolgáltatásokhoz. A Microsoft védjegyek vagy logók engedélyezett használata a [Microsoft védjegy- és márka irányelveinek](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general) hatálya alá tartozik, és követnie kell azokat.  
A Microsoft védjegyek vagy logók használata módosított verziókban nem okozhat zavart, és nem sugallhatja a Microsoft szponzorálását. Harmadik fél védjegyeinek vagy logóinak használata az adott harmadik fél irányelveinek hatálya alá tartozik.  
