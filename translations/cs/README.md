...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-21T13:17:19+00:00",
...
[![Přispěvatelé GitHubu](https://img.shields.io/github/contributors/microsoft/phicookbook.svg)](https://GitHub.com/microsoft/phicookbook/graphs/contributors/?WT.mc_id=aiml-137032-kinfeylo)
...
Phi je v současnosti nejvýkonnějším a nákladově nejefektivnějším malým jazykovým modelem (SLM), s velmi dobrými výsledky v multijazyčných úlohách, uvažování, generování textu/chatu,kódování, práci s obrázky, zvukem a dalších scénářích. 

Phi lze nasadit do cloudu nebo na okrajová zařízení a lze s ním snadno vytvářet generativní AI aplikace s omezeným výpočetním výkonem.

Postupujte podle těchto kroků, abyste začali používat tyto zdroje :
1. **Vytvořte fork repozitáře**: Klikněte [![GitHub forks](https://img.shields.io/github/forks/microsoft/phicookbook.svg?style=social&label=Fork)](https://GitHub.com/microsoft/phicookbook/network/?WT.mc_id=aiml-137032-kinfeylo)
...
![obálka](../../translated_images/cover.eb18d1b9605d754b.cs.png)
...
-  [Kvantifikace rodiny Phi](./md/01.Introduction/04/QuantifyingPhi.md)
    ...
    - [Kvantizace Phi-3.5 / 4 pomocí Generative AI extensions for onnxruntime](./md/01.Introduction/04/UsingORTGenAIQuantifyingPhi.md)
    - [Kvantizace Phi-3.5 / 4 pomocí Intel OpenVINO](./md/01.Introduction/04/UsingIntelOpenVINOQuantifyingPhi.md)
    - [Kvantizace Phi-3.5 / 4 pomocí Apple MLX Framework](./md/01.Introduction/04/UsingAppleMLXQuantifyingPhi.md)
...
- Ukázky vývoje aplikací Phi
  - Textové a chatovací aplikace
    - Ukázky Phi-4 🆕
      - [📓] [Chat s ONNX modelem Phi-4-mini](./md/02.Application/01.TextAndChat/Phi4/ChatWithPhi4ONNX/README.md)
      - [Chat s lokálním ONNX modelem Phi-4 v .NET](../../md/04.HOL/dotnet/src/LabsPhi4-Chat-01OnnxRuntime)
      - [Chat .NET konzolová aplikace s Phi-4 ONNX používající Sementic Kernel](../../md/04.HOL/dotnet/src/LabsPhi4-Chat-02SK)
    - Ukázky Phi-3 / 3.5
      ...
      - [Aplikace WinUI3 s Phi-3 mini-4k-instruct-onnx](https://github.com/microsoft/Phi3-Chat-WinUI3-Sample/)
      -[Ukázka aplikace WinUI3 pro poznámky s více modely a AI](https://github.com/microsoft/ai-powered-notes-winui3-sample)
      - [Ladění a integrace vlastních modelů Phi-3 s Prompt flow](./md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-FineTuning_PromptFlow_Integration.md)
      - [Ladění a integrace vlastních modelů Phi-3 s Prompt flow v Azure AI Foundry](./md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-FineTuning_PromptFlow_Integration_AIFoundry.md)
      - [Vyhodnocení doladěného modelu Phi-3 / Phi-3.5 v Azure AI Foundry se zaměřením na zásady zodpovědné AI Microsoftu](./md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-Evaluation_AIFoundry.md)
      - [📓] [Phi-3.5-mini-instruct ukázka predikce jazyka (čínština/angličtina)](./md/02.Application/01.TextAndChat/Phi3/phi3-instruct-demo.ipynb)
      ...
      - [Příklad Q&A .NET používající místní ONNX Phi-3 model s Microsoft.ML.OnnxRuntime](../../md/04.HOL/dotnet/src/LabsPhi301)
      - [Konzolová chatovací .NET aplikace se Semantic Kernel a Phi-3](../../md/04.HOL/dotnet/src/LabsPhi302)

  - Azure AI Inference SDK Code Based Samples 
    - Phi-4 Ukázky 🆕
      - [📓] [Generovat kód projektu pomocí Phi-4-multimodal](./md/02.Application/02.Code/Phi4/GenProjectCode/README.md)
    - Phi-3 / 3.5 Ukázky
      - [Vytvořte si vlastní GitHub Copilot Chat pro Visual Studio Code s Microsoft Phi-3](./md/02.Application/02.Code/Phi3/VSCodeExt/README.md)
      - [Vytvořte si vlastního agenta Chat Copilot pro Visual Studio Code s Phi-3.5 od GitHub Models](/md/02.Application/02.Code/Phi3/CreateVSCodeChatAgentWithGitHubModels.md)

  - Ukázky pokročilého uvažování
    - Phi-4 Ukázky 🆕
      - [📓] [Phi-4-mini-reasoning nebo Phi-4-reasoning ukázky](./md/02.Application/03.AdvancedReasoning/Phi4/AdvancedResoningPhi4mini/README.md)
  ...
  - Ukázky pro počítačové vidění
    - Phi-4 Ukázky 🆕
      - [📓] [Použít Phi-4-multimodal ke čtení obrázků a generování kódu](./md/02.Application/04.Vision/Phi4/CreateFrontend/README.md) 
    - Phi-3 / 3.5 Ukázky
      -  [📓][Phi-3-vision-Image převod textu z obrázku na text](./md/02.Application/04.Vision/Phi3/E2E_Phi-3-vision-image-text-to-text-online-endpoint.ipynb)
      ...
      - [📓][Phi-3.5 Vision ukázka více snímků nebo více obrázků](./md/02.Application/04.Vision/Phi3/phi3-vision-demo.ipynb)
      - [Phi-3 Vision Local ONNX Model using the Microsoft.ML.OnnxRuntime .NET](../../md/04.HOL/dotnet/src/LabsPhi303)
      - [Menu založený Phi-3 Vision Local ONNX Model using the Microsoft.ML.OnnxRuntime .NET](../../md/04.HOL/dotnet/src/LabsPhi304)
  ...
  - Ukázky volání funkcí
    - Phi-4 Ukázky 🆕
      ...
      -  [📓] [Použití volání funkcí s ONNX](../../md/02.Application/07.FunctionCalling/Phi4/ONNX/onnx_parallel_functioncalling_ipynb)
  - Ukázky multimodálního kombinování
    - Phi-4 Ukázky 🆕
...
- Doladění Phi - ukázky
  ...
  - [Doladění: Nechte Phi-3 stát se průmyslovým odborníkem](./md/03.FineTuning/LetPhi3gotoIndustriy.md)
  ...
  - [Doladění Phi-3 s Kaito AKS , Azure Containers(official Support)](./md/03.FineTuning/FineTuning_Kaito.md)
  - [Doladění Phi-3 a 3.5 Vision](https://github.com/2U1/Phi3-Vision-Finetune)

- Praktické laboratoře
  - [Prozkoumání špičkových modelů: LLMs, SLMs, lokální vývoj a další](https://github.com/microsoft/aitour-exploring-cutting-edge-models)
  - [Odemknutí potenciálu NLP: Doladění pomocí Microsoft Olive](https://github.com/azure/Ignite_FineTuning_workshop)
...
Můžete se naučit, jak používat Microsoft Phi a jak vytvářet end-to-end řešení pro různá hardwarová zařízení. Aby jste si Phi vyzkoušeli sami, začněte hraním si s modely a přizpůsobováním Phi vašim scénářům pomocí [Katalogu modelů Azure AI Foundry](https://aka.ms/phi3-azure-ai). Více se můžete dozvědět v průvodci Začínáme s [Azure AI Foundry](/md/02.QuickStart/AzureAIFoundry_QuickStart.md)

**Ukázkové prostředí**
Každý model má vlastní ukázkové prostředí pro testování modelu [Azure AI Playground](https://aka.ms/try-phi3).

### Phi na GitHubu (modely)

Můžete se naučit, jak používat Microsoft Phi a jak vytvářet end-to-end řešení pro různá hardwarová zařízení. Aby jste si Phi vyzkoušeli sami, začněte hraním si s modelem a přizpůsobováním Phi vašim scénářům pomocí [GitHub Model Catalog](https://github.com/marketplace/models?WT.mc_id=aiml-137032-kinfeylo) Více se můžete dozvědět v průvodci Začínáme s [GitHub Model Catalog](/md/02.QuickStart/GitHubModel_QuickStart.md)

**Ukázkové prostředí**
Každý model má vyhrazené [ukázkové prostředí pro testování modelu](/md/02.QuickStart/GitHubModel_QuickStart.md).
...
**Ukázkové prostředí**
 [Ukázkové prostředí Hugging Chat](https://huggingface.co/chat/models/microsoft/Phi-3-mini-4k-instruct)

 ## 🎒 Další kurzy

Náš tým také připravuje další kurzy! Podívejte se:
...
Microsoft se zavazuje pomáhat našim zákazníkům používat naše AI produkty odpovědně, sdílet naše poznatky a budovat partnerství založená na důvěře prostřednictvím nástrojů jako jsou Poznámky o transparentnosti a Hodnocení dopadu. Mnoho z těchto zdrojů najdete na [https://aka.ms/RAI](https://aka.ms/RAI).
Přístup Microsoftu k zodpovědné AI je založen na našich principech AI: spravedlnost, spolehlivost a bezpečnost, ochrana soukromí a zabezpečení, inkluzivita, transparentnost a odpovědnost.

Velké modely pro přirozený jazyk, obrázky a řeč – jako ty, které jsou použity v tomto příkladu – se mohou potenciálně chovat nespravedlivě, nespolehlivě nebo urážlivě, což může způsobit škody. Prosíme, prostudujte si [Poznámku o transparentnosti služby Azure OpenAI](https://learn.microsoft.com/legal/cognitive-services/openai/transparency-note?tabs=text), abyste byli informováni o rizicích a omezeních.

Doporučený přístup k zmírnění těchto rizik je začlenit do vaší architektury bezpečnostní systém, který dokáže detekovat a zabránit škodlivému chování. [Azure AI Content Safety](https://learn.microsoft.com/azure/ai-services/content-safety/overview) poskytuje nezávislou ochrannou vrstvu, schopnou detekovat škodlivý obsah generovaný uživateli i AI v aplikacích a službách. Azure AI Content Safety zahrnuje textová a obrazová API, která vám umožní detekovat materiál, který je škodlivý. V rámci Azure AI Foundry služba Content Safety umožňuje prohlížet, prozkoumávat a vyzkoušet ukázkový kód pro detekci škodlivého obsahu napříč různými modalitami. Následující [dokumentace rychlého startu](https://learn.microsoft.com/azure/ai-services/content-safety/quickstart-text?tabs=visual-studio%2Clinux&pivots=programming-language-rest) vás provede tím, jak posílat požadavky na službu.

Dalším aspektem, který je třeba zohlednit, je celkový výkon aplikace. U multimodálních a multi-modelových aplikací považujeme výkon za to, že systém funguje tak, jak to očekáváte vy i vaši uživatelé, včetně toho, že negeneruje škodlivé výstupy. Je důležité posoudit výkon vaší celkové aplikace pomocí [evaluátorů výkonu, kvality, rizik a bezpečnosti](https://learn.microsoft.com/azure/ai-studio/concepts/evaluation-metrics-built-in). Máte také možnost vytvářet a hodnotit pomocí [vlastních evaluátorů](https://learn.microsoft.com/azure/ai-studio/how-to/develop/evaluate-sdk#custom-evaluators).

Svoji AI aplikaci můžete vyhodnotit ve vašem vývojovém prostředí pomocí [Azure AI Evaluation SDK](https://microsoft.github.io/promptflow/index.html). S použitím testovací datové sady nebo cíle jsou generace vaší generativní AI aplikace kvantitativně měřeny vestavěnými evaluátory nebo vámi zvolenými vlastními evaluátory. Pro začátek s Azure AI Evaluation SDK k hodnocení vašeho systému můžete následovat [průvodce rychlým startem](https://learn.microsoft.com/azure/ai-studio/how-to/develop/flow-evaluate-sdk). Po provedení vyhodnocovacího běhu můžete [vizualizovat výsledky v Azure AI Foundry](https://learn.microsoft.com/azure/ai-studio/how-to/evaluate-flow-results). 

## Ochranné známky
Tento projekt může obsahovat ochranné známky nebo loga projektů, produktů nebo služeb. Autorizované použití ochranných známek nebo log Microsoftu podléhá a musí dodržovat [Pokyny Microsoftu pro ochranné známky a značku](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
Použití ochranných známek nebo log Microsoftu v upravených verzích tohoto projektu nesmí způsobovat záměnu ani naznačovat sponzorství Microsoftu. Jakékoli použití ochranných známek nebo log třetích stran podléhá zásadám těchto třetích stran.

## Získání pomoci

Pokud narazíte na problém nebo máte jakékoli dotazy ohledně vytváření aplikací s AI, připojte se:
...
Tento dokument byl přeložen pomocí služby pro automatický překlad založené na umělé inteligenci [Co-op Translator](https://github.com/Azure/co-op-translator). Ačkoli usilujeme o přesnost, mějte prosím na paměti, že automatizované překlady mohou obsahovat chyby nebo nepřesnosti. Původní dokument v jeho originálním jazyce by měl být považován za závazný zdroj. Pro zásadní informace se doporučuje profesionální lidský překlad. Nejsme odpovědní za žádná nedorozumění ani nesprávné interpretace vzniklé v důsledku použití tohoto překladu.
