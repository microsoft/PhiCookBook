...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-09T19:48:27+00:00",
...
在上一个实验中，我们结合了 MX 框架和云端，完成了 Phi3 Agent 的 Visual Studio Code 扩展。

![agent](../../../../../../../../../translated_images/vscode_agent.409cc20073ede69c5bd4db0d611aff68cf40ed88d8c334a899a341c6ba82f013.cs.png)

### **1. 创建 VSCode 开发扩展**

请参考此链接 [https://code.visualstudio.com/api/get-started/your-first-extension](https://code.visualstudio.com/api/get-started/your-first-extension) 创建扩展项目

***NOTE:*** 本项目请使用 Typescript 和 WebPack 作为技术方案

### **2. 添加 vscode.d.ts**

Visual Studio Code Chat API 尚未合并到代码 API 中，现在通过扩展方式添加。
...
你可以在终端运行 **npm install** 并调试扩展进行测试。
...
恭喜！你已经完成了所有实验。希望这能帮助你理解 Phi-3 家族以及如何使用 GitHub Copilot Chat。
