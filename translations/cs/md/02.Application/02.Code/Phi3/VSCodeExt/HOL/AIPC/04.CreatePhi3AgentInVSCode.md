...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-09T19:33:32+00:00",
...
***NOTE:*** 请使用 Typescript 和 WebPack 作为本项目的技术方案

### **2. 添加 vscode.d.ts**

Visual Studio Code Chat API 还未合并到代码 API 中，目前通过扩展方式添加。
...
***Download Sample Code*** [点击这里](../../../../../../../../../code/07.Lab/01/AIPC)
...
恭喜！你已完成所有实验。希望这能帮助你理解 Phi-3 系列以及如何使用 GitHub Copilot Chat。
