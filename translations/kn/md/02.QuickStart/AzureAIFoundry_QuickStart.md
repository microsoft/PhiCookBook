# **Phi-3 ಅನ್ನು Microsoft Foundry ನಲ್ಲಿ ಬಳಸುವುದು**
...
1. **Go to Microsoft Foundry**: Microsoft Foundry ಪೋರ್ಟಲ್‌ಗೆ ಸೈನ್ ಇನ್ ಮಾಡಿ.
2. **Create a Project**:
...
1. **Go to Microsoft Foundry**: ನಿಮ್ಮ Azure ಖಾತೆಯಿಂದ ಸೈನ್ ಇನ್ ಮಾಡಿ.
2. **Create a Hub**:
...
## **3. Microsoft Foundry ನಲ್ಲಿ Playgroundನಲ್ಲಿ Phi ಜೊತೆ ಚಾಟ್**
