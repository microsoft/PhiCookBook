...
- Introductie
  ...
  - [Kerntechnologieën begrijpen](./md/01.Introduction/01/01.Understandingtech.md)
...
-  [Quantificatie van Phi Familie](./md/01.Introduction/04/QuantifyingPhi.md)
...
- RAG met Azure AI Search
    - [Hoe gebruik je Phi-4-mini en Phi-4-multimodal (RAG) met Azure AI Search](https://github.com/microsoft/PhiCookBook/blob/main/code/06.E2E/E2E_Phi-4-RAG-Azure-AI-Search.ipynb)
...
- Phi applicatie ontwikkelingsvoorbeelden
  - Tekst- & Chattoepassingen
    ...
    - Phi-3 / 3.5 Voorbeelden
      ...
      - [Evalueer het fijn-afgestelde Phi-3 / Phi-3.5 model in Azure AI Foundry met focus op Microsoft's Verantwoordelijke AI principes](./md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-Evaluation_AIFoundry.md)
      ...
      - [Q&A .NET voorbeeld met lokaal ONNX Phi-3 model gebruik makend van Microsoft.ML.OnnxRuntime](../../md/04.HOL/dotnet/src/LabsPhi301)
  ...
  - Azure AI Inference SDK code-gebaseerde voorbeelden 
    - Phi-4 Voorbeelden 🆕
      - [📓] [Gegenereerde projectcode met Phi-4-multimodaal](./md/02.Application/02.Code/Phi4/GenProjectCode/README.md)
    - Phi-3 / 3.5 Voorbeelden
  ...
  - Demo's
      ...
      - [Phi-4-multimodaal demo's gehost op Hugginge Face Spaces](https://huggingface.co/spaces/microsoft/phi-4-multimodal?WT.mc_id=aiml-137032-kinfeylo)
  - Visie Voorbeelden
    - Phi-4 Voorbeelden 🆕
    ...
    - Phi-3 / 3.5 Voorbeelden
      ...
      - [📓][Phi-3-visie CLIP ingebedde](./md/02.Application/04.Vision/Phi3/E2E_Phi-3-vision-image-text-to-text-online-endpoint.ipynb)
  ...
  - Audio Voorbeelden
    - Phi-4 Voorbeelden 🆕
      ...
      - [📓] [Phi-4-multimodaal Spraakvertalingsvoorbeeld](./md/02.Application/05.Audio/Phi4/Translate/demo.ipynb)
      - [.NET console applicatie die Phi-4-multimodaal Audio gebruikt om een audiobestand te analyseren en transcript te genereren](../../md/04.HOL/dotnet/src/LabsPhi4-MultiModal-02Audio)
  ...
  - Function Calling Voorbeelden
    - Phi-4 Voorbeelden 🆕
      -  [📓] [Gebruik van Function Calling met Phi-4-mini](./md/02.Application/07.FunctionCalling/Phi4/FunctionCallingBasic/README.md)
      -  [📓] [Gebruik van Function Calling om multi-agents te maken met Phi-4-mini](./md/02.Application/07.FunctionCalling/Phi4/Multiagents/Phi_4_mini_multiagent.ipynb)
      -  [📓] [Gebruik van Function Calling met Ollama](./md/02.Application/07.FunctionCalling/Phi4/Ollama/ollama_functioncalling.ipynb)
      -  [📓] [Gebruik van Function Calling met ONNX](./md/02.Application/07.FunctionCalling/Phi4/ONNX/onnx_parallel_functioncalling.ipynb)
  - Multimodaal Mix Voorbeelden
    - Phi-4 Voorbeelden 🆕
      -  [📓] [Gebruik van Phi-4-multimodaal als technologiejournalist](./md/02.Application/08.Multimodel/Phi4/TechJournalist/phi_4_mm_audio_text_publish_news.ipynb)
      - [.NET console app die Phi-4-multimodaal gebruikt om afbeeldingen te analyseren](../../md/04.HOL/dotnet/src/LabsPhi4-MultiModal-01Images)
...
- Hands-on Lab
  - [Verkenning van geavanceerde modellen: LLM's, SLM's, lokale ontwikkeling en meer](https://github.com/microsoft/aitour-exploring-cutting-edge-models)
...
- Academische onderzoeksartikelen en publicaties
  ...
  - [Phi-4-Mini Technisch Rapport: Compact maar Krachtig Multimodale Taalmodellen via Mengsel van LoRA's](https://arxiv.org/abs/2503.01743)
  - [Optimalisatie van Kleine Taalmodellen voor Functie-aanroepen in Voertuigen](https://arxiv.org/abs/2501.02342)
  - [(WhyPHI) Fijn-afstemming van PHI-3 voor Meerkeuzevragen: Methodologie, Resultaten en Uitdagingen](https://arxiv.org/abs/2501.01588)
...
Je kunt leren hoe je Microsoft Phi gebruikt en hoe je E2E-oplossingen bouwt op je verschillende hardwareapparaten. Om Phi zelf te ervaren, begin je met het uitproberen van de modellen en het aanpassen van Phi voor jouw scenario's met behulp van de [Azure AI Foundry Azure AI Model Catalog](https://aka.ms/phi3-azure-ai) je kunt meer leren in Aan de slag met [Azure AI Foundry](/md/02.QuickStart/AzureAIFoundry_QuickStart.md)

**Speelveld**  
Elk model heeft een speciaal speelveld om het model te testen [Azure AI Playground](https://aka.ms/try-phi3).

### Phi op GitHub-modellen

Je kunt leren hoe je Microsoft Phi gebruikt en hoe je E2E-oplossingen bouwt op je verschillende hardwareapparaten. Om Phi zelf te ervaren, begin je met het uitproberen van het model en het aanpassen van Phi voor jouw scenario's met behulp van de [GitHub Model Catalog](https://github.com/marketplace/models?WT.mc_id=aiml-137032-kinfeylo) je kunt meer leren in Aan de slag met [GitHub Model Catalog](/md/02.QuickStart/GitHubModel_QuickStart.md)

**Speelveld**  
Elk model heeft een speciaal [speelveld om het model te testen](/md/02.QuickStart/GitHubModel_QuickStart.md).
...
**Speelveld**  
 [Hugging Chat speelveld](https://huggingface.co/chat/models/microsoft/Phi-3-mini-4k-instruct)
...
### Copilot Serie
[![Copilot voor AI Paired Programming](https://img.shields.io/badge/Copilot%20voor%20AI%20Paired%20Programming-FACC15?style=for-the-badge&labelColor=E5E7EB&color=FACC15)](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)
...
Microsoft zet zich in om onze klanten te helpen onze AI-producten verantwoordelijk te gebruiken, onze inzichten te delen en op vertrouwen gebaseerde partnerschappen op te bouwen via tools zoals Transparency Notes en Impact Assessments. Veel van deze bronnen zijn te vinden op [https://aka.ms/RAI](https://aka.ms/RAI).  
...
Grote natuurlijke taal-, beeld- en spraakmodellen - zoals die in dit voorbeeld gebruikt worden - kunnen zich potentieel op een oneerlijke, onbetrouwbare of aanstootgevende manier gedragen, wat op zijn beurt schade kan veroorzaken. Raadpleeg de [Azure OpenAI service Transparency note](https://learn.microsoft.com/legal/cognitive-services/openai/transparency-note?tabs=text) om geïnformeerd te worden over risico’s en beperkingen.

De aanbevolen aanpak om deze risico’s te beperken is het opnemen van een veiligheidssysteem in je architectuur dat schadelijk gedrag kan detecteren en voorkomen. [Azure AI Content Safety](https://learn.microsoft.com/azure/ai-services/content-safety/overview) biedt een onafhankelijke beschermlaag, die schadelijke gebruikersgegenereerde en AI-gegenereerde inhoud in toepassingen en diensten kan detecteren. Azure AI Content Safety bevat tekst- en beeld-API's waarmee je schadelijk materiaal kunt detecteren. Binnen Azure AI Foundry stelt de Content Safety-service je in staat om voorbeeldcode te bekijken, te verkennen en uit te proberen om schadelijke inhoud in verschillende modaliteiten te detecteren. De volgende [quickstart-documentatie](https://learn.microsoft.com/azure/ai-services/content-safety/quickstart-text?tabs=visual-studio%2Clinux&pivots=programming-language-rest) begeleidt je bij het maken van verzoeken aan de service.

Een ander aspect om in acht te nemen is de algehele prestatie van de applicatie. Bij multimodale en multimeter-applicaties verstaan we onder prestaties dat het systeem presteert zoals jij en je gebruikers verwachten, inclusief het niet genereren van schadelijke output. Het is belangrijk om de prestaties van je gehele applicatie te beoordelen met behulp van [Performance and Quality and Risk and Safety evaluators](https://learn.microsoft.com/azure/ai-studio/concepts/evaluation-metrics-built-in). Je kunt ook zelf maken en evalueren met [aangepaste evaluatoren](https://learn.microsoft.com/azure/ai-studio/how-to/develop/evaluate-sdk#custom-evaluators).
Je kunt je AI-applicatie evalueren in je ontwikkelomgeving met de [Azure AI Evaluation SDK](https://microsoft.github.io/promptflow/index.html). Aan de hand van een testdataset of een doel, worden de generaties van je generatieve AI-applicatie kwantitatief gemeten met ingebouwde evaluators of eigen evaluators naar keuze. Om te beginnen met de azure ai evaluation sdk om je systeem te evalueren, kun je de [quickstart-gids](https://learn.microsoft.com/azure/ai-studio/how-to/develop/flow-evaluate-sdk) volgen. Zodra je een evaluatieloop uitvoert, kun je [de resultaten visualiseren in Azure AI Foundry](https://learn.microsoft.com/azure/ai-studio/how-to/evaluate-flow-results).

## Handelsmerken

Dit project kan handelsmerken of logo’s bevatten voor projecten, producten of diensten. Het geautoriseerde gebruik van Microsoft-handelsmerken of logo’s is onderhevig aan en moet voldoen aan de [Microsoft’s Trademark & Brand Guidelines](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general). Gebruik van Microsoft-handelsmerken of logo’s in gewijzigde versies van dit project mag geen verwarring veroorzaken of Microsoft-sponsoring impliceren. Elk gebruik van handelsmerken of logo’s van derden is onderhevig aan het beleid van die derden.
...
Als je productfeedback hebt of fouten ervaart tijdens het bouwen, bezoek:
