...
[AI Toolkit for VS Code](https://marketplace.visualstudio.com/items?itemName=ms-windows-ai-studio.windows-ai-studio) maakt het ontwikkelen van generatieve AI-apps eenvoudiger door geavanceerde AI-ontwikkeltools en modellen uit de Microsoft Foundry Catalog en andere catalogi zoals Hugging Face samen te brengen. Je kunt door de AI-modellencatalogus bladeren, aangedreven door GitHub Models en Microsoft Foundry Model Catalogs, deze lokaal of op afstand downloaden, fine-tunen, testen en gebruiken in je applicatie.
