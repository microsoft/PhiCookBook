...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-11T11:12:21+00:00",
...
-  [Kuantifikasi Keluarga Phi](./md/01.Introduction/04/QuantifyingPhi.md)
    ...
    - [Kuantifikasi Phi-3.5 / 4 menggunakan sambungan AI generatif untuk onnxruntime](./md/01.Introduction/04/UsingORTGenAIQuantifyingPhi.md)
...
- Sampel pembangunan aplikasi Phi
  - Aplikasi Teks & Chat
    - Sampel Phi-4 🆕
      ...
      - [Chat Aplikasi Konsol .NET dengan Phi-4 ONNX menggunakan Kernel Semantik](../../md/04.HOL/dotnet/src/LabsPhi4-Chat-02SK)
    - Sampel Phi-3 / 3.5
...
- [Penalaan dan Integrasi model Phi-3 tersuai dengan Prompt flow](./md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-FineTuning_PromptFlow_Integration.md)
- [Penalaan dan Integrasi model Phi-3 tersuai dengan Prompt flow di Azure AI Foundry](./md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-FineTuning_PromptFlow_Integration_AIFoundry.md)
- [Menilai Model Phi-3 / Phi-3.5 yang telah ditala di Azure AI Foundry dengan fokus pada Prinsip AI Bertanggungjawab Microsoft](./md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-Evaluation_AIFoundry.md)
...
- Contoh Penalaran Lanjutan
  - Contoh Phi-4 🆕
    ...
    - [📓] [Penalaan Phi-4-mini-reasoning dengan Microsoft Olive](../../md/02.Application/03.AdvancedReasoning/Phi4/AdvancedResoningPhi4mini/olive_ft_phi_4_reasoning_with_medicaldata.ipynb)
    - [📓] [Penalaan Phi-4-mini-reasoning dengan Apple MLX](../../md/02.Application/03.AdvancedReasoning/Phi4/AdvancedResoningPhi4mini/mlx_ft_phi_4_reasoning_with_medicaldata.ipynb)
...
- Contoh MOE
  - Contoh Phi-3 / 3.5
    - [📓] [Contoh Media Sosial Model Pakar Campuran Phi-3.5 (MoEs)](../../md/02.Application/06.MoE/Phi3/phi3_moe_demo.ipynb)
    - [📓] [Membina Pipeline Penjanaan Augmentasi Pengambilan (RAG) dengan NVIDIA NIM Phi-3 MOE, Azure AI Search, dan LlamaIndex](../../md/02.Application/06.MoE/Phi3/azure-ai-search-nvidia-rag.ipynb)
...
- Contoh Penalaan Phi
  - [Senario Penalaan](./md/03.FineTuning/FineTuning_Scenarios.md)
  - [Penalaan vs RAG](./md/03.FineTuning/FineTuning_vs_RAG.md)
  - [Penalaan Membolehkan Phi-3 menjadi pakar industri](./md/03.FineTuning/LetPhi3gotoIndustriy.md)
  - [Penalaan Phi-3 dengan AI Toolkit untuk VS Code](./md/03.FineTuning/Finetuning_VSCodeaitoolkit.md)
  - [Penalaan Phi-3 dengan Perkhidmatan Pembelajaran Mesin Azure](./md/03.FineTuning/Introduce_AzureML.md)
  - [Penalaan Phi-3 dengan Lora](./md/03.FineTuning/FineTuning_Lora.md)
  - [Penalaan Phi-3 dengan QLora](./md/03.FineTuning/FineTuning_Qlora.md)
  - [Penalaan Phi-3 dengan Azure AI Foundry](./md/03.FineTuning/FineTuning_AIFoundry.md)
  - [Penalaan Phi-3 dengan Azure ML CLI/SDK](./md/03.FineTuning/FineTuning_MLSDK.md)
  - [Penalaan dengan Microsoft Olive](./md/03.FineTuning/FineTuning_MicrosoftOlive.md)
  - [Penalaan dengan Makmal Hands-On Microsoft Olive](./md/03.FineTuning/olive-lab/readme.md)
  - [Penalaan Phi-3-vision dengan Weights and Bias](./md/03.FineTuning/FineTuning_Phi-3-visionWandB.md)
  - [Penalaan Phi-3 dengan Rangka Kerja Apple MLX](./md/03.FineTuning/FineTuning_MLX.md)
  - [Penalaan Phi-3-vision (sokongan rasmi)](./md/03.FineTuning/FineTuning_Vision.md)
  - [Penalaan Phi-3 dengan Kaito AKS, Kontena Azure (sokongan rasmi)](./md/03.FineTuning/FineTuning_Kaito.md)
  - [Penalaan Phi-3 dan 3.5 Vision](https://github.com/2U1/Phi3-Vision-Finetune)
...
- Makmal Hands-On
  ...
  - [Membuka Potensi NLP: Penalaan dengan Microsoft Olive](https://github.com/azure/Ignite_FineTuning_workshop)
...
- Kertas Penyelidikan Akademik dan Penerbitan
  ...
  - [(WhyPHI) Penyesuaian PHI-3 untuk Menjawab Soalan Pilihan Berganda: Metodologi, Keputusan, dan Cabaran](https://arxiv.org/abs/2501.01588)
...
Microsoft komited untuk membantu pelanggan menggunakan produk AI kami secara bertanggungjawab, berkongsi pembelajaran kami, dan membina perkongsian berdasarkan kepercayaan melalui alat seperti Nota Ketelusan dan Penilaian Impak. Banyak sumber ini boleh didapati di [https://aka.ms/RAI](https://aka.ms/RAI).  
...
Penggunaan tanda dagangan atau logo Microsoft dalam versi projek yang diubah suai tidak boleh menyebabkan kekeliruan atau menyiratkan penajaan oleh Microsoft. Sebarang penggunaan tanda dagangan atau logo pihak ketiga adalah tertakluk kepada dasar pihak ketiga tersebut.
