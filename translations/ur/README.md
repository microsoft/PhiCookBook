...
-  [Phi فیملی کی کوانٹیفیکیشن](./md/01.Introduction/04/QuantifyingPhi.md)  
    ...
    - [onnxruntime کے لیے Generative AI ایکسٹینشنز کے ذریعے Phi-3.5 / 4 کی کوانٹائزنگ](./md/01.Introduction/04/UsingORTGenAIQuantifyingPhi.md)  
...
- وژن نمونے  
  ...
  - Phi-3 / 3.5 نمونے  
    ...
    - [Microsoft.ML.OnnxRuntime .NET کا استعمال کرتے ہوئے مینو پر مبنی Phi-3 وژن لوکل ONNX ماڈل](../../md/04.HOL/dotnet/src/LabsPhi304)  
...
- آڈیو نمونے  
  - Phi-4 نمونے 🆕  
    ...
    - [Phi-4-multimodal آڈیو کا استعمال کرتے ہوئے .NET کنسول ایپلیکیشن جو آڈیو فائل کا تجزیہ کرتی ہے اور ٹرانسکرپٹ تیار کرتی ہے](../../md/04.HOL/dotnet/src/LabsPhi4-MultiModal-02Audio)  
...
- Phi کے نمونوں کی Fine-tuning  
  ...
  - [Phi-3 کو صنعت کا ماہر بنائیں](./md/03.FineTuning/LetPhi3gotoIndustriy.md)  
...
- علمی تحقیقی مقالے اور اشاعتیں  
  ...
  - [(WhyPHI) متعدد انتخابی سوالات کے جواب کے لیے PHI-3 کی Fine-Tuning: طریقہ کار، نتائج، اور چیلنجز](https://arxiv.org/abs/2501.01588)
...
Microsoft کے ٹریڈ مارکس یا لوگوز کا اس پروجیکٹ کے ترمیم شدہ ورژنز میں استعمال الجھن پیدا نہیں کرنا چاہیے اور نہ ہی Microsoft کی سرپرستی کا تاثر دینا چاہیے۔ کسی بھی تیسرے فریق کے ٹریڈ مارکس یا لوگوز کا استعمال ان فریقوں کی پالیسیوں کے تابع ہے۔
