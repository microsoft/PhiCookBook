# **Microsoft Foundry کا استعمال کرتے ہوئے جائزہ لینا**

![aistudo](../../../../../translated_images/ur/AIFoundry.9e0b513e999a1c5a.webp)

[Microsoft Foundry](https://ai.azure.com?WT.mc_id=aiml-138114-kinfeylo) کے ذریعے اپنی جنریٹو AI ایپلیکیشن کا جائزہ کیسے لیں۔ چاہے آپ سنگل ٹرن یا ملٹی ٹرن گفتگو کا جائزہ لے رہے ہوں، Microsoft Foundry ماڈل کی کارکردگی اور حفاظت کے لیے ٹولز فراہم کرتا ہے۔

![aistudo](../../../../../translated_images/ur/AIPortfolio.69da59a8e1eaa70f.webp)

## Microsoft Foundry کے ساتھ جنریٹو AI ایپس کا جائزہ لینے کا طریقہ
...
## Microsoft Foundry میں جنریٹو AI ماڈلز کا جائزہ لینا
...
Microsoft Foundry آپ کو سنگل ٹرن اور پیچیدہ، ملٹی ٹرن گفتگو دونوں کا جائزہ لینے کی اجازت دیتا ہے۔  
...
Microsoft Foundry UI سے، Evaluate صفحہ یا Prompt Flow صفحہ پر جائیں۔  
...
جائزہ چلانے کے بعد، Microsoft Foundry میں تفصیلی جائزہ میٹرکس کو لاگ، دیکھیں اور تجزیہ کریں۔ اپنی ایپلیکیشن کی صلاحیتوں اور حدود کے بارے میں بصیرت حاصل کریں۔

**Note** Microsoft Foundry اس وقت پبلک پریویو میں ہے، اس لیے اسے تجرباتی اور ترقیاتی مقاصد کے لیے استعمال کریں۔ پروڈکشن ورک لوڈز کے لیے دیگر اختیارات پر غور کریں۔ مزید تفصیلات اور مرحلہ وار ہدایات کے لیے سرکاری [AI Foundry documentation](https://learn.microsoft.com/azure/ai-studio/?WT.mc_id=aiml-138114-kinfeylo) دیکھیں۔
