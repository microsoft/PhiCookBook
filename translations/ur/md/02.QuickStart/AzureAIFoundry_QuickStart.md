# **Microsoft Foundry میں Phi-3 کا استعمال**

Generative AI کی ترقی کے ساتھ، ہم امید کرتے ہیں کہ ایک متحدہ پلیٹ فارم کے ذریعے مختلف LLM اور SLM، انٹرپرائز ڈیٹا انٹیگریشن، fine-tuning/RAG آپریشنز، اور LLM اور SLM کے انضمام کے بعد مختلف انٹرپرائز کاروباروں کی تشخیص کو منظم کیا جا سکے، تاکہ generative AI کی مدد سے اسمارٹ ایپلیکیشنز کو بہتر طریقے سے نافذ کیا جا سکے۔ [Microsoft Foundry](https://ai.azure.com) ایک انٹرپرائز سطح کا generative AI ایپلیکیشن پلیٹ فارم ہے۔

![aistudo](../../../../translated_images/ur/aifoundry_home.f28a8127c96c7d93.webp)

Microsoft Foundry کے ذریعے، آپ بڑے زبان کے ماڈلز (LLM) کے جوابات کا جائزہ لے سکتے ہیں اور بہتر کارکردگی کے لیے prompt flow کے ساتھ prompt application components کو منظم کر سکتے ہیں۔ یہ پلیٹ فارم proof of concepts کو آسانی سے مکمل پروڈکشن میں تبدیل کرنے کے لیے scalability فراہم کرتا ہے۔ مسلسل نگرانی اور بہتری طویل مدتی کامیابی کی حمایت کرتی ہے۔

ہم آسان مراحل کے ذریعے Microsoft Foundry پر Phi-3 ماڈل کو جلدی تعینات کر سکتے ہیں، اور پھر Microsoft Foundry کا استعمال کرتے ہوئے Phi-3 سے متعلق Playground/Chat، Fine-tuning، تشخیص اور دیگر متعلقہ کام مکمل کر سکتے ہیں۔
...
Microsoft Foundry میں پروجیکٹ اور ہب بنانا آپ کے AI کام کو منظم کرنے کا بہترین طریقہ ہے۔ شروع کرنے کے لیے یہ مرحلہ وار رہنمائی ہے:

### Microsoft Foundry میں پروجیکٹ بنانا

1. **Microsoft Foundry پر جائیں**: Microsoft Foundry پورٹل میں سائن ان کریں۔
2. **پروجیکٹ بنائیں**:
   - اگر آپ کسی پروجیکٹ میں ہیں، تو صفحے کے اوپر بائیں جانب "Microsoft Foundry" منتخب کریں تاکہ ہوم پیج پر جائیں۔
...
### Microsoft Foundry میں ہب بنانا

1. **Microsoft Foundry پر جائیں**: اپنے Azure اکاؤنٹ سے سائن ان کریں۔
2. **ہب بنائیں**:
...
Microsoft Foundry کے [QuickStarts](https://learn.microsoft.com/azure/ai-studio/quickstarts/get-started-code) بنائیں۔

## **2. Microsoft Foundry میں Phi ماڈل کی تعیناتی**
...
## **3. Microsoft Foundry میں Playground Chat Phi**

تعیناتی کے صفحے پر جائیں، Playground منتخب کریں، اور Microsoft Foundry کے Phi-3 کے ساتھ چیٹ کریں۔

## **4. Microsoft Foundry سے ماڈل کی تعیناتی**

Azure Model Catalog سے ماڈل تعینات کرنے کے لیے یہ مراحل اپنائیں:

- Microsoft Foundry میں سائن ان کریں۔
- Microsoft Foundry ماڈل کیٹلاگ سے وہ ماڈل منتخب کریں جسے آپ تعینات کرنا چاہتے ہیں۔
...
## **5. Microsoft Foundry میں Phi API کا استعمال**
