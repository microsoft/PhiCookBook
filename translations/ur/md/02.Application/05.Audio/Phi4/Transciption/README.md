...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-04-03T07:56:26+00:00",
...
Phi-4-multimodal ایک مکمل ماڈل ہے جو متن اور تصاویر کے علاوہ آڈیو کا بھی استعمال کر سکتا ہے۔ آئیے دیکھتے ہیں کہ اسے کیسے استعمال کیا جائے۔
