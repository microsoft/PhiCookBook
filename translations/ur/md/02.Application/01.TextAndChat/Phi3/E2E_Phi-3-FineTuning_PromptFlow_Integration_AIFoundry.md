# Microsoft Foundry میں Prompt flow کے ساتھ کسٹم Phi-3 ماڈلز کو Fine-tune اور انضمام کریں

یہ اختتام سے اختتام (E2E) نمونہ مائیکروسافٹ ٹیک کمیونٹی کے گائیڈ "[Microsoft Foundry میں Prompt flow کے ساتھ کسٹم Phi-3 ماڈلز کو Fine-tune اور انضمام کریں](https://techcommunity.microsoft.com/t5/educator-developer-blog/fine-tune-and-integrate-custom-phi-3-models-with-prompt-flow-in/ba-p/4191726?WT.mc_id=aiml-137032-kinfeylo)" پر مبنی ہے۔ یہ Microsoft Foundry میں کسٹم Phi-3 ماڈلز کو fine-tune کرنے، تعینات کرنے، اور Prompt flow کے ساتھ منسلک کرنے کے عمل کا تعارف کراتا ہے۔
...
اس E2E نمونے میں، آپ سیکھیں گے کہ Phi-3 ماڈل کو کیسے fine-tune کیا جائے اور Microsoft Foundry میں Prompt flow کے ساتھ اسے کیسے منسلک کیا جائے۔ Azure AI / ML اسٹوڈیو کا فائدہ اٹھاتے ہوئے، آپ کسٹم AI ماڈلز کو تعینات کرنے اور استعمال کرنے کے لیے ایک ورک فلو قائم کریں گے۔ یہ E2E نمونہ تین مناظر میں تقسیم ہے:
...
**منظر 3: Prompt flow کے ساتھ انضمام اور Microsoft Foundry میں اپنے کسٹم ماڈل سے بات چیت کریں**
...
1. **[منظر 3: Prompt flow کے ساتھ انضمام اور Microsoft Foundry میں اپنے کسٹم ماڈل سے بات چیت کریں](../../../../../../md/02.Application/01.TextAndChat/Phi3)**
...
1. *finetune-phi* فولڈر منتخب کریں جو آپ نے بنایا ہے، جو *C:\Users\yourUserName\finetune-phi* پر واقع ہے۔
    ...
    ![Select the folder that you created.](../../../../../../translated_images/ur/04-01-open-project-folder.f734374bcfd5f9e6.webp)
...
1. Visual Studio Code کے بائیں پین میں رائٹ کلک کریں اور **New File** منتخب کریں تاکہ *download_dataset.py* نامی نیا فائل بنایا جا سکے۔
    ...
    ![Create a new file.](../../../../../../translated_images/ur/04-02-create-new-file.cf9a330a3a9cff92.webp)
...
1. **+ New** منتخب کریں۔
    ...
    ![Select compute.](../../../../../../translated_images/ur/06-01-select-compute.a29cff290b480252.webp)
...
1. درج ذیل کام کریں:
    ...
    ![Create cluster.](../../../../../../translated_images/ur/06-02-create-cluster.f221b65ae1221d4e.webp)
...
1. درج ذیل کام کریں:
    ...
    ![Create cluster.](../../../../../../translated_images/ur/06-03-create-cluster.4a54ba20914f3662.webp)
...
1. جو Azure Machine Learning ورک اسپیس آپ نے بنایا ہے اسے منتخب کریں۔
    ...
    ![Select workspace that you created.](../../../../../../translated_images/ur/06-04-select-workspace.a92934ac04f4f181.webp)
...
1. درج ذیل کام کریں:
    ...
    ![Type phi-3-mini-4k.](../../../../../../translated_images/ur/06-05-type-phi-3-mini-4k.8ab6d2a04418b250.webp)

1. نیویگیشن مینو سے **Fine-tune** منتخب کریں۔

    ![Select fine tune.](../../../../../../translated_images/ur/06-06-select-fine-tune.2918a59be55dfeec.webp)
...
1. درج ذیل کام کریں:
    ...
    ![Fill fine-tuning page.](../../../../../../translated_images/ur/06-07-fill-finetuning.b6d14c89e7c27d0b.webp)
...
1. اس مشق میں، آپ نے کامیابی سے Azure Machine Learning میں Phi-3 ماڈل کو fine-tune کیا۔ براہ کرم نوٹ کریں کہ fine-tuning کا عمل کافی وقت لے سکتا ہے۔ fine-tuning جاب چلانے کے بعد، آپ کو اسے مکمل ہونے تک انتظار کرنا ہوگا۔ آپ Azure Machine Learning ورک اسپیس کے بائیں جانب کے ٹیب سے Jobs ٹیب میں جا کر fine-tuning جاب کی حالت مانیٹر کر سکتے ہیں۔ اگلے سلسلے میں، آپ fine-tuned ماڈل کو ڈیپلائے کریں گے اور اسے Prompt flow کے ساتھ مربوط کریں گے۔
    ...
    ![See finetuning job.](../../../../../../translated_images/ur/06-08-output.2bd32e59930672b1.webp)
...
1. **From a job output** منتخب کریں۔
    ...
    ![Register model.](../../../../../../translated_images/ur/07-01-register-model.ad1e7cc05e4b2777.webp)

1. اپنی تخلیق کردہ جاب کو منتخب کریں۔

    ![Select job.](../../../../../../translated_images/ur/07-02-select-job.3e2e1144cd6cd093.webp)
...
1. یقینی بنائیں کہ **Job output** منتخب ہے؛ اس کا خود بخود انتخاب ہونا چاہیے۔
    ...
    ![Select output.](../../../../../../translated_images/ur/07-03-select-output.4cf1a0e645baea1f.webp)

2. **Next** منتخب کریں۔

3. **Register** منتخب کریں۔

    ![Select register.](../../../../../../translated_images/ur/07-04-register.fd82a3b293060bc7.webp)

4. آپ اپنی رجسٹر شدہ ماڈل کو بائیں جانب کے ٹیب میں **Models** مینو میں جا کر دیکھ سکتے ہیں۔

    ![Registered model.](../../../../../../translated_images/ur/07-05-registered-model.7db9775f58dfd591.webp)
...
1. نیویگیشن مینو سے **Real-time endpoints** منتخب کریں۔
    ...
    ![Create endpoint.](../../../../../../translated_images/ur/07-06-create-endpoint.1ba865c606551f09.webp)

1. **Create** منتخب کریں۔

1. اپنا رجسٹر شدہ ماڈل منتخب کریں۔

    ![Select registered model.](../../../../../../translated_images/ur/07-07-select-registered-model.29c947c37fa30cb4.webp)
...
1. درج ذیل کام کریں:
    ...
    ![Fill the deployment setting.](../../../../../../translated_images/ur/07-08-deployment-setting.43ddc4209e673784.webp)
...
1. وہ اینڈپوائنٹ منتخب کریں جو آپ نے بنایا ہے۔
    ...
    ![Select endpoints](../../../../../../translated_images/ur/07-09-check-deployment.325d18cae8475ef4.webp)
...
>
> ![Set traffic.](../../../../../../translated_images/ur/07-10-set-traffic.085b847e5751ff3d.webp)
>

## منظرنامہ 3: Prompt flow کے ساتھ انٹیگریٹ کریں اور Microsoft Foundry میں اپنے کسٹم ماڈل کے ساتھ چیٹ کریں
...
- Microsoft Foundry پروجیکٹ تخلیق کریں۔
- Prompt flow بنائیں۔
...
پروجیکٹ بنانے سے پہلے آپ کو ایک Hub بنانا ہوگا۔ ایک Hub Resource Group کی طرح کام کرتا ہے، جو آپ کو Microsoft Foundry میں متعدد پروجیکٹس کو منظم کرنے اور ترتیب دینے کی اجازت دیتا ہے۔

1. [Microsoft Foundry](https://ai.azure.com/?WT.mc_id=aiml-137032-kinfeylo) پر جائیں۔
...
1. وہ Microsoft Foundry پروجیکٹ منتخب کریں جو آپ نے بنایا ہے۔
...
آپ نے Microsoft Foundry میں کسٹم کنکشن شامل کر لیا ہے۔ اب درج ذیل مراحل کے ذریعے Prompt flow بنائیں۔ پھر آپ اس Prompt flow کو کسٹم کنکشن سے جوڑیں گے تاکہ آپ fine-tuned ماڈل کو Prompt flow میں استعمال کر سکیں۔
...
> [!NOTE]
> Microsoft Foundry میں Prompt flow کے استعمال کی مزید تفصیلی معلومات کے لیے آپ [Prompt flow in Microsoft Foundry](https://learn.microsoft.com/azure/ai-studio/how-to/prompt-flow) کا حوالہ دے سکتے ہیں۔
