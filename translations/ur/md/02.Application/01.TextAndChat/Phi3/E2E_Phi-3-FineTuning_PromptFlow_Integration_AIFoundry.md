...
1. *finetune-phi* فولڈر منتخب کریں جو آپ نے بنایا ہے، جو *C:\Users\yourUserName\finetune-phi* پر واقع ہے۔
    ...
    ![اپنا بنایا ہوا فولڈر منتخب کریں۔](../../../../../../translated_images/04-01-open-project-folder.f734374bcfd5f9e6.ur.png)
...
1. Visual Studio Code کے بائیں پین میں، رائٹ کلک کریں اور **New File** منتخب کریں تاکہ *download_dataset.py* نامی نئی فائل بنائی جا سکے۔
    ...
    ![نئی فائل بنائیں۔](../../../../../../translated_images/04-02-create-new-file.cf9a330a3a9cff92.ur.png)
...
1. **+ New** منتخب کریں۔
    ...
    ![Compute منتخب کریں۔](../../../../../../translated_images/06-01-select-compute.a29cff290b480252.ur.png)
...
1. درج ذیل کام کریں:
    ...
    ![کلسٹر بنائیں۔](../../../../../../translated_images/06-02-create-cluster.f221b65ae1221d4e.ur.png)
...
1. درج ذیل کام کریں:
    ...
    ![کلسٹر بنائیں۔](../../../../../../translated_images/06-03-create-cluster.4a54ba20914f3662.ur.png)
...
1. اپنا بنایا ہوا Azure Machine Learning ورک اسپیس منتخب کریں۔
    ...
    ![اپنا ورک اسپیس منتخب کریں۔](../../../../../../translated_images/06-04-select-workspace.a92934ac04f4f181.ur.png)
...
1. درج ذیل کام کریں:
    ...
    ![phi-3-mini-4k ٹائپ کریں۔](../../../../../../translated_images/06-05-type-phi-3-mini-4k.8ab6d2a04418b250.ur.png)

1. نیویگیشن مینو سے **Fine-tune** منتخب کریں۔

    ![Fine-tune منتخب کریں۔](../../../../../../translated_images/06-06-select-fine-tune.2918a59be55dfeec.ur.png)
...
1. درج ذیل کام کریں:
    ...
    ![فائن ٹیوننگ کا صفحہ بھریں۔](../../../../../../translated_images/06-07-fill-finetuning.b6d14c89e7c27d0b.ur.png)
...
1. اس مشق میں، آپ نے کامیابی سے Azure Machine Learning میں Phi-3 ماڈل کی فائن ٹیوننگ کی۔ یاد رکھیں کہ فائن ٹیوننگ کا عمل کافی وقت لے سکتا ہے۔ فائن ٹیوننگ جاب چلانے کے بعد، آپ کو اس کے مکمل ہونے کا انتظار کرنا ہوگا۔ آپ Azure Machine Learning ورک اسپیس کے بائیں طرف کے ٹیب میں Jobs سیکشن میں جاب کی حالت مانیٹر کر سکتے ہیں۔ اگلی سیریز میں، آپ فائن ٹیونڈ ماڈل کو تعینات کریں گے اور اسے Prompt flow کے ساتھ مربوط کریں گے۔
    ...
    ![فائن ٹیوننگ جاب دیکھیں۔](../../../../../../translated_images/06-08-output.2bd32e59930672b1.ur.png)
...
1. **From a job output** منتخب کریں۔
    ...
    ![ماڈل رجسٹر کریں۔](../../../../../../translated_images/07-01-register-model.ad1e7cc05e4b2777.ur.png)

1. اپنی بنائی ہوئی جاب منتخب کریں۔

    ![جاب منتخب کریں۔](../../../../../../translated_images/07-02-select-job.3e2e1144cd6cd093.ur.png)
...
1. یقینی بنائیں کہ **Job output** منتخب ہے؛ یہ خود بخود منتخب ہو جائے گا۔
    ...
    ![آؤٹ پٹ منتخب کریں۔](../../../../../../translated_images/07-03-select-output.4cf1a0e645baea1f.ur.png)

2. **Next** منتخب کریں۔

3. **Register** منتخب کریں۔

    ![رجسٹر منتخب کریں۔](../../../../../../translated_images/07-04-register.fd82a3b293060bc7.ur.png)

4. آپ اپنے رجسٹر شدہ ماڈل کو بائیں طرف کے ٹیب میں **Models** مینو سے دیکھ سکتے ہیں۔

    ![رجسٹر شدہ ماڈل۔](../../../../../../translated_images/07-05-registered-model.7db9775f58dfd591.ur.png)
...
1. نیویگیشن مینو سے **Real-time endpoints** منتخب کریں۔
    ...
    ![اینڈ پوائنٹ بنائیں۔](../../../../../../translated_images/07-06-create-endpoint.1ba865c606551f09.ur.png)

1. **Create** منتخب کریں۔

1. اپنا رجسٹر شدہ ماڈل منتخب کریں۔

    ![رجسٹر شدہ ماڈل منتخب کریں۔](../../../../../../translated_images/07-07-select-registered-model.29c947c37fa30cb4.ur.png)
...
1. درج ذیل کام کریں:
    ...
    ![تعیناتی کی ترتیبات بھریں۔](../../../../../../translated_images/07-08-deployment-setting.43ddc4209e673784.ur.png)
...
1. اپنا بنایا ہوا اینڈ پوائنٹ منتخب کریں۔
    ...
    ![Endpoints منتخب کریں۔](../../../../../../translated_images/07-09-check-deployment.325d18cae8475ef4.ur.png)
...
>
> ![ٹریفک سیٹ کریں۔](../../../../../../translated_images/07-10-set-traffic.085b847e5751ff3d.ur.png)
>
