...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-07T13:42:15+00:00",
  "source_file": "md/02.Application/07.FunctionCalling/Phi4/FunctionCallingBasic/README.md",
  "language_code": "ur"
}
-->
## **Phi-4-mini میں Function calling**

Function calling سب سے پہلے Phi Family خاندان میں ظاہر ہوا، اور اب آپ اسے Phi-4-mini کے ذریعے استعمال کر سکتے ہیں۔

یہ مثال Premier League کے نتائج کی نقل کی نمائش کرتی ہے۔ مقصد یہ ہے کہ Phi-4-mini حقیقی وقت میں کھیل کی معلومات فراہم کرے۔ نیچے نمونہ کوڈ دیا گیا ہے:
...
**دستخطی**:  
یہ دستاویز AI ترجمہ سروس [Co-op Translator](https://github.com/Azure/co-op-translator) کے ذریعے ترجمہ کی گئی ہے۔ اگرچہ ہم درستگی کے لیے کوشاں ہیں، براہ کرم اس بات سے آگاہ رہیں کہ خودکار تراجم میں غلطیاں یا عدم درستیاں ہو سکتی ہیں۔ اصل دستاویز اپنی مادری زبان میں معتبر ماخذ سمجھی جانی چاہیے۔ اہم معلومات کے لیے پیشہ ورانہ انسانی ترجمہ کی سفارش کی جاتی ہے۔ ہم اس ترجمے کے استعمال سے پیدا ہونے والی کسی بھی غلط فہمی یا غلط تشریح کے ذمہ دار نہیں ہیں۔