...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-04-03T07:57:19+00:00",
...
فنکشن کالنگ پہلی بار Phi فیملی میں متعارف ہوئی، اور اب آپ اسے Phi-4-mini کے ذریعے استعمال کر سکتے ہیں۔

یہ مثال پریمیئر لیگ کے نتائج کی سیمولیشن کو ظاہر کرتی ہے۔ مقصد یہ ہے کہ Phi-4-mini حقیقی وقت میں گیم کی معلومات فراہم کرے۔ نیچے مثال کا کوڈ دیا گیا ہے:
