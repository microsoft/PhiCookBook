...
1. 作成した *finetune-phi* フォルダーを選択します。場所は *C:\Users\yourUserName\finetune-phi* です。
    ...
    ![作成したフォルダーを選択します。](../../../../../../translated_images/04-01-open-project-folder.f734374bcfd5f9e6.ja.png)
...
1. **+ New** を選択します。
    ...
    ![Compute を選択](../../../../../../translated_images/06-01-select-compute.a29cff290b480252.ja.png)
...
1. 次の設定を行います：
    ...
    ![クラスターの作成](../../../../../../translated_images/06-02-create-cluster.f221b65ae1221d4e.ja.png)
...
1. 次の設定を行います：
    ...
    ![クラスターの作成](../../../../../../translated_images/06-03-create-cluster.4a54ba20914f3662.ja.png)
...
1. 次の操作を行います：
    ...
    ![phi-3-mini-4k を入力](../../../../../../translated_images/06-05-type-phi-3-mini-4k.8ab6d2a04418b250.ja.png)

1. ナビゲーションメニューから **Fine-tune** を選択します。

    ![ファインチューンを選択](../../../../../../translated_images/06-06-select-fine-tune.2918a59be55dfeec.ja.png)
...
1. 次の操作を行います：
    ...
    ![ファインチューニング画面の入力](../../../../../../translated_images/06-07-fill-finetuning.b6d14c89e7c27d0b.ja.png)
...
1. この演習で、Azure Machine Learning を使用して Phi-3 モデルのファインチューニングに成功しました。ファインチューニングにはかなりの時間がかかることがあります。ファインチューニングジョブの実行後、完了するまで待つ必要があります。Azure Machine Learning ワークスペースの左のジョブタブで進行状況を確認できます。次のシリーズでは、ファインチューニングしたモデルをデプロイし、Prompt flow と統合します。
    ...
    ![ファインチューニングジョブの確認](../../../../../../translated_images/06-08-output.2bd32e59930672b1.ja.png)
...
1. **From a job output** を選択します。
    ...
    ![モデルを登録](../../../../../../translated_images/07-01-register-model.ad1e7cc05e4b2777.ja.png)

1. 作成したジョブを選択します。

    ![ジョブを選択](../../../../../../translated_images/07-02-select-job.3e2e1144cd6cd093.ja.png)
...
1. **Job output** が選択されていることを確認します。通常、自動的に選択されています。
    ...
    ![出力を選択](../../../../../../translated_images/07-03-select-output.4cf1a0e645baea1f.ja.png)

2. **Next** を選択します。

3. **Register** を選択します。

    ![登録を選択](../../../../../../translated_images/07-04-register.fd82a3b293060bc7.ja.png)

4. 左側のタブの **Models** メニューから登録したモデルを確認できます。

    ![登録済みモデル](../../../../../../translated_images/07-05-registered-model.7db9775f58dfd591.ja.png)
...
1. ナビゲーションメニューから **Real-time endpoints** を選択します。
    ...
    ![エンドポイントを作成](../../../../../../translated_images/07-06-create-endpoint.1ba865c606551f09.ja.png)

1. **Create** を選択します。

1. 登録済みのモデルを選択します。

    ![登録済みモデルを選択](../../../../../../translated_images/07-07-select-registered-model.29c947c37fa30cb4.ja.png)
...
1. 次の設定を行います：
    ...
    ![デプロイメントの設定を入力](../../../../../../translated_images/07-08-deployment-setting.43ddc4209e673784.ja.png)
...
1. 作成したエンドポイントを選択します。
    ...
    ![エンドポイントを選択](../../../../../../translated_images/07-09-check-deployment.325d18cae8475ef4.ja.png)
...
>
> ![トラフィックを設定](../../../../../../translated_images/07-10-set-traffic.085b847e5751ff3d.ja.png)
>
...
1. ナビゲーションメニューから **+ New hub** を選択します。
    ![ハブを作成します。](../../../../../../translated_images/08-01-create-hub.8f7dd615bb8d9834.ja.png)
...
1. 以下のタスクを実行します：
    ...
    ![ハブを入力します。](../../../../../../translated_images/08-02-fill-hub.c2d3b505bbbdba7c.ja.png)
...
1. ナビゲーションメニューから **+ 新しいプロジェクト** を選択します。
    ...
    ![新しいプロジェクトを選択します。](../../../../../../translated_images/08-04-select-new-project.390fadfc9c8f8f12.ja.png)

1. **プロジェクト名** を入力します。ユニークな値でなければなりません。

    ![プロジェクトを作成します。](../../../../../../translated_images/08-05-create-project.4d97f0372f03375a.ja.png)
...
1. 左側のタブから **エンドポイント** を選択します。
    ...
    ![エンドポイントを選択します。](../../../../../../translated_images/08-06-select-endpoints.aff38d453bcf9605.ja.png)

1. 作成したエンドポイントを選択します。

    ![作成したエンドポイントを選択します。](../../../../../../translated_images/08-07-select-endpoint-created.47f0dc09df2e275e.ja.png)

1. ナビゲーションメニューから **利用** を選択します。

1. **REST エンドポイント** と **プライマリキー** をコピーします。

    ![api キーとエンドポイント URI をコピーします。](../../../../../../translated_images/08-08-copy-endpoint-key.18f934b5953ae8cb.ja.png)
...
1. **+ 新しい接続** を選択します。
    ...
    ![新しい接続を選択します。](../../../../../../translated_images/08-09-select-new-connection.02eb45deadc401fc.ja.png)

1. ナビゲーションメニューから **カスタムキー** を選択します。

    ![カスタムキーを選択します。](../../../../../../translated_images/08-10-select-custom-keys.856f6b2966460551.ja.png)
...
1. 以下の操作を行います：
    ...
    ![接続を追加します。](../../../../../../translated_images/08-11-add-connection.785486badb4d2d26.ja.png)
...
1. ナビゲーションメニューから **+ 作成** を選択します。
    ...
    ![Prompt flow を選択します。](../../../../../../translated_images/08-12-select-promptflow.6f4b451cb9821e5b.ja.png)

1. ナビゲーションメニューから **チャットフロー** を選択します。

    ![チャットフローを選択します。](../../../../../../translated_images/08-13-select-flow-type.2ec689b22da32591.ja.png)

1. 使用する **フォルダー名** を入力します。

    ![名前を入力します。](../../../../../../translated_images/08-14-enter-name.ff9520fefd89f40d.ja.png)
...
1. Prompt flow で以下の操作を行い、既存のフローを再構築します：
    ...
    ![生ファイルモードを選択します。](../../../../../../translated_images/08-15-select-raw-file-mode.61d988b41df28985.ja.png)
...
1. *integrate_with_promptflow.py* ファイルに以下のコードを追加し、Prompt flow でカスタム Phi-3 モデルを使用します。
    ...
    ![Prompt flow コードを貼り付けます。](../../../../../../translated_images/08-16-paste-promptflow-code.a6041b74a7d09777.ja.png)
...
1. **チャット入力**、**チャット出力** を選択して、モデルとのチャットを有効にします。
    ...
    ![入力と出力を選択します。](../../../../../../translated_images/08-17-select-input-output.64dbb39bbe59d03b.ja.png)
...
>
> ![フロー例。](../../../../../../translated_images/08-18-graph-example.d6457533952e690c.ja.png)
>
...
1. **コンピュート セッションを開始** を選択して Prompt flow を開始します。
    ...
    ![コンピュート セッションを開始します。](../../../../../../translated_images/09-01-start-compute-session.a86fcf5be68e386b.ja.png)

1. **入力の検証と解析** を選択してパラメーターを更新します。

    ![入力を検証します。](../../../../../../translated_images/09-02-validate-input.317c76ef766361e9.ja.png)

1. 作成したカスタム接続の **connection** の **値** を選択します。例として *connection*。

    ![接続を選択します。](../../../../../../translated_images/09-03-select-connection.99bdddb4b1844023.ja.png)

#### カスタムモデルとチャットする

1. **チャット** を選択します。

    ![チャットを選択します。](../../../../../../translated_images/09-04-select-chat.61936dce6612a1e6.ja.png)

1. 結果例です：これでカスタム Phi-3 モデルとチャットできます。ファインチューニングに使用したデータに基づく質問をすることを推奨します。

    ![Prompt flow とチャットします。](../../../../../../translated_images/09-05-chat-with-promptflow.c8ca404c07ab126f.ja.png)
