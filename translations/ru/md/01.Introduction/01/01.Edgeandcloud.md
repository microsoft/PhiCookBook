...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-16T17:56:25+00:00",
  "source_file": "md/01.Introduction/01/01.Edgeandcloud.md",
  "language_code": "ru"
}
-->
# Модели Phi и их доступность на различных платформах
...
| | | | | | | | | |
|-|-|-|-|-|-|-|-|-|
|Model|Входные данные|Длина контента|Azure AI (MaaS)|Azure ML (MaaP)|ONNX|Hugging Face|Ollama|Nvidia NIM|
