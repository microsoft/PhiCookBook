...
Как оценить ваше приложение с генеративным ИИ с помощью [Microsoft Foundry](https://ai.azure.com?WT.mc_id=aiml-138114-kinfeylo). Независимо от того, оцениваете ли вы односторонние или многоступенчатые диалоги, Microsoft Foundry предоставляет инструменты для проверки производительности модели и безопасности.

![aistudo](../../../../../translated_images/ru/AIPortfolio.69da59a8e1eaa70f.webp)

## Как оценивать приложения с генеративным ИИ с помощью Microsoft Foundry  
...
## Оценка моделей генеративного ИИ в Microsoft Foundry
...
Microsoft Foundry позволяет оценивать как односторонние, так и сложные многоступенчатые диалоги.  
