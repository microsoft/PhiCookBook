...
С развитием генеративного ИИ мы стремимся использовать единую платформу для управления различными LLM и SLM, интеграции корпоративных данных, операций тонкой настройки/RAG и оценки различных бизнес-процессов после интеграции LLM и SLM, чтобы генеративный ИИ мог лучше реализовывать умные приложения. [Microsoft Foundry](https://ai.azure.com) — это корпоративная платформа для создания приложений на базе генеративного ИИ.

![aistudo](../../../../translated_images/ru/aifoundry_home.f28a8127c96c7d93.webp)

С помощью Microsoft Foundry вы можете оценивать ответы больших языковых моделей (LLM) и организовывать компоненты приложений с помощью prompt flow для повышения производительности. Платформа обеспечивает масштабируемость, позволяя легко превращать прототипы в полноценные производственные решения. Непрерывный мониторинг и доработка поддерживают долгосрочный успех.

Мы можем быстро развернуть модель Phi-3 в Microsoft Foundry простыми шагами, а затем использовать Microsoft Foundry для работы с Playground/Chat, тонкой настройкой, оценкой и другими задачами, связанными с Phi-3.
...
2. **Создайте проект**:
   - Если вы находитесь внутри проекта, выберите «Microsoft Foundry» в левом верхнем углу страницы, чтобы перейти на главную.
...
1. **Перейдите в Microsoft Foundry**: Войдите с помощью вашей учетной записи Azure.
2. **Создайте хаб**:
...
Перейдите на страницу развертывания, выберите Playground и общайтесь с Phi-3 в Microsoft Foundry
