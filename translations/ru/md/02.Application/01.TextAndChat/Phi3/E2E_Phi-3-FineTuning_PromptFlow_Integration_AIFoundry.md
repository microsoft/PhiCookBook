...
1. Выберите папку *finetune-phi*, которую вы создали, расположенную по пути *C:\Users\yourUserName\finetune-phi*.
    ...
    ![Выберите папку, которую вы создали.](../../../../../../translated_images/ru/04-01-open-project-folder.f734374bcfd5f9e6.webp)
...
1. Выберите **+ New**.
    ...
    ![Выберите вычислительные ресурсы.](../../../../../../translated_images/ru/06-01-select-compute.a29cff290b480252.webp)
...
1. Выберите **From a job output**.
    ...
    ![Зарегистрируйте модель.](../../../../../../translated_images/ru/07-01-register-model.ad1e7cc05e4b2777.webp)
...
1. Убедитесь, что выбран параметр **Job output**; он должен быть выбран автоматически.
    ...
    ![Выберите вывод.](../../../../../../translated_images/ru/07-03-select-output.4cf1a0e645baea1f.webp)
...
1. Выберите **Real-time endpoints** в навигационном меню.
    ...
    ![Создание конечного узла.](../../../../../../translated_images/ru/07-06-create-endpoint.1ba865c606551f09.webp)
...
1. Выберите созданный вами конечный узел.
    ...
    ![Выберите конечные узлы](../../../../../../translated_images/ru/07-09-check-deployment.325d18cae8475ef4.webp)
...
1. Выберите **+ Новый хаб (New hub)** в навигационном меню.
    ![Создать hub.](../../../../../../translated_images/ru/08-01-create-hub.8f7dd615bb8d9834.webp)
...
1. Выполните следующие действия:
    ...
    ![Заполните hub.](../../../../../../translated_images/ru/08-02-fill-hub.c2d3b505bbbdba7c.webp)
...
1. Выберите **+ Новый проект** в навигационном меню.
    ...
    ![Выберите новый проект.](../../../../../../translated_images/ru/08-04-select-new-project.390fadfc9c8f8f12.webp)

1. Введите **Имя проекта**. Оно должно быть уникальным.

    ![Создать проект.](../../../../../../translated_images/ru/08-05-create-project.4d97f0372f03375a.webp)
...
1. Выберите **Конечные точки** в левой вкладке.
    ...
    ![Выберите конечные точки.](../../../../../../translated_images/ru/08-06-select-endpoints.aff38d453bcf9605.webp)

1. Выберите созданную конечную точку.

    ![Выберите конечную точку.](../../../../../../translated_images/ru/08-07-select-endpoint-created.47f0dc09df2e275e.webp)

1. В навигационном меню выберите **Использовать**.

1. Скопируйте ваш **REST endpoint** и **Основной ключ**.

    ![Скопируйте api-ключ и URI конечной точки.](../../../../../../translated_images/ru/08-08-copy-endpoint-key.18f934b5953ae8cb.webp)
...
1. Выберите **+ Новое подключение**.
    ...
    ![Выберите новое подключение.](../../../../../../translated_images/ru/08-09-select-new-connection.02eb45deadc401fc.webp)

1. В навигационном меню выберите **Пользовательские ключи**.

    ![Выберите пользовательские ключи.](../../../../../../translated_images/ru/08-10-select-custom-keys.856f6b2966460551.webp)
...
1. Выполните следующие действия:
    ...
    ![Добавьте подключение.](../../../../../../translated_images/ru/08-11-add-connection.785486badb4d2d26.webp)
...
1. Выберите **+ Создать** в навигационном меню.
    ...
    ![Выберите Promptflow.](../../../../../../translated_images/ru/08-12-select-promptflow.6f4b451cb9821e5b.webp)

1. В навигационном меню выберите **Чат-флоу**.

    ![Выберите чат-флоу.](../../../../../../translated_images/ru/08-13-select-flow-type.2ec689b22da32591.webp)

1. Введите **Имя папки** для использования.

    ![Введите имя.](../../../../../../translated_images/ru/08-14-enter-name.ff9520fefd89f40d.webp)
...
1. В Prompt flow выполните следующие действия для перестройки существующего потока:
    ...
    ![Выберите режим редактирования сырого файла.](../../../../../../translated_images/ru/08-15-select-raw-file-mode.61d988b41df28985.webp)
...
1. Добавьте следующий код в файл *integrate_with_promptflow.py* для использования пользовательской модели Phi-3 в Prompt flow.
    ...
    ![Вставьте код prompt flow.](../../../../../../translated_images/ru/08-16-paste-promptflow-code.a6041b74a7d09777.webp)
...
1. Выберите **Ввод чата**, **Вывод чата**, чтобы включить чат с вашей моделью.
    ...
    ![Ввод и вывод.](../../../../../../translated_images/ru/08-17-select-input-output.64dbb39bbe59d03b.webp)
...
>
> ![Пример потока.](../../../../../../translated_images/ru/08-18-graph-example.d6457533952e690c.webp)
>
...
1. Выберите **Запустить сеансы вычислений**, чтобы запустить Prompt flow.
    ...
    ![Запуск вычислительной сессии.](../../../../../../translated_images/ru/09-01-start-compute-session.a86fcf5be68e386b.webp)

1. Выберите **Проверить и проанализировать ввод**, чтобы обновить параметры.

    ![Проверка ввода.](../../../../../../translated_images/ru/09-02-validate-input.317c76ef766361e9.webp)

1. Выберите **Значение** параметра **connection**, укажите созданное вами пользовательское подключение. Например, *connection*.

    ![Подключение.](../../../../../../translated_images/ru/09-03-select-connection.99bdddb4b1844023.webp)

#### Общение с вашей пользовательской моделью

1. Выберите **Чат**.

    ![Выберите чат.](../../../../../../translated_images/ru/09-04-select-chat.61936dce6612a1e6.webp)
...
1. Вот пример результатов: теперь вы можете общаться с вашей пользовательской моделью Phi-3. Рекомендуется задавать вопросы, основанные на данных, использованных для дообучения.
    ...
    ![Чат в prompt flow.](../../../../../../translated_images/ru/09-05-chat-with-promptflow.c8ca404c07ab126f.webp)
