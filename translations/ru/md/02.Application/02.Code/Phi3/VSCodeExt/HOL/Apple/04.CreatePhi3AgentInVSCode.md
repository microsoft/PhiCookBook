...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-17T04:37:13+00:00",
...
Пожалуйста, обратитесь к этой ссылке [https://code.visualstudio.com/api/get-started/your-first-extension](https://code.visualstudio.com/api/get-started/your-first-extension) для создания проекта расширения

***NOTE:*** Для этого проекта используйте Typescript и WebPack в качестве технического решения

### **2. Добавление vscode.d.ts**

API чата Visual Studio Code ещё не интегрировано в основной API кода, но сейчас добавляется через расширения.
