...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-07T14:26:55+00:00",
...
Phi-4-multimodal — это полноформатная модель, которая может работать с аудио, помимо текста и изображений. Давайте посмотрим, как её использовать.
