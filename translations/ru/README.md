...
Phi в настоящее время является самой мощной и экономически эффективной небольшой языковой моделью (SLM), демонстрирующей отличные показатели в многоязычных задачах, рассуждении, генерации текста/чата, кодировании, изображениях, аудио и других сценариях.

Вы можете развернуть Phi в облаке или на периферийных устройствах, а также легко создавать приложения генеративного ИИ с ограниченной вычислительной мощностью.
...
3. [**Присоединяйтесь к сообществу Microsoft AI в Discord и познакомьтесь с экспертами и разработчиками**](https://discord.com/invite/ByRwuEEgH4?WT.mc_id=aiml-137032-kinfeylo)

![обложка](../../translated_images/ru/cover.eb18d1b9605d754b.webp)
...
> В этом репозитории содержится более 50 переводов на разные языки, что значительно увеличивает размер скачивания. Чтобы клонировать без переводов, используйте sparse checkout:
> ```bash
...
- Вывод Phi в разных средах
    ...
    -  [Набор инструментов ИИ для VSCode (AITK)](./md/01.Introduction/02/05.AITK.md)
    -  [NVIDIA NIM](./md/01.Introduction/02/06.NVIDIA.md)
    -  [Foundry Local](./md/01.Introduction/02/07.FoundryLocal.md)

- Вывод Phi Family
    - [Вывод Phi в iOS](./md/01.Introduction/03/iOS_Inference.md)
    - [Вывод Phi в Android](./md/01.Introduction/03/Android_Inference.md)
    - [Вывод Phi в Jetson](./md/01.Introduction/03/Jetson_Inference.md)
...
-  [Квантификация Phi Family](./md/01.Introduction/04/QuantifyingPhi.md)
    - [Квантификация Phi-3.5 / 4 с помощью llama.cpp](./md/01.Introduction/04/UsingLlamacppQuantifyingPhi.md)
    - [Квантификация Phi-3.5 / 4 с помощью расширений генеративного ИИ для onnxruntime](./md/01.Introduction/04/UsingORTGenAIQuantifyingPhi.md)
    - [Квантификация Phi-3.5 / 4 с помощью Intel OpenVINO](./md/01.Introduction/04/UsingIntelOpenVINOQuantifyingPhi.md)
    - [Квантификация Phi-3.5 / 4 с помощью Apple MLX Framework](./md/01.Introduction/04/UsingAppleMLXQuantifyingPhi.md)
...
- Примеры разработки приложений Phi
  - Текстовые и чат-приложения
    - Примеры Phi-4 🆕
      ...
      - [Консольное приложение чат .NET с Phi-4 ONNX с использованием Semantic Kernel](../../md/04.HOL/dotnet/src/LabsPhi4-Chat-02SK)
    - Примеры Phi-3 / 3.5
      ...
      -[Пример приложения заметок WinUI3 Multi Model с искусственным интеллектом](https://github.com/microsoft/ai-powered-notes-winui3-sample)
      ...
      - [📓] [Пример прогнозирования языков Phi-3.5-mini-instruct (китайский/английский)](./md/02.Application/01.TextAndChat/Phi3/phi3-instruct-demo.ipynb)
  ...
  - Примеры кода Azure AI Inference SDK 
    - Примеры Phi-4 🆕
      - [📓] [Генерация кода проекта с использованием Phi-4-multimodal](./md/02.Application/02.Code/Phi4/GenProjectCode/README.md)
    - Примеры Phi-3 / 3.5
      - [Создайте собственный чат-агент Visual Studio Code с GitHub Copilot и семейством Microsoft Phi-3](./md/02.Application/02.Code/Phi3/VSCodeExt/README.md)
      - [Создайте собственного чат-агента Visual Studio Code Copilot с Phi-3.5 от GitHub Models](/md/02.Application/02.Code/Phi3/CreateVSCodeChatAgentWithGitHubModels.md)
  ...
  - Демонстрации
      ...
      - [Демо Phi-4-multimodal на Hugginge Face Spaces](https://huggingface.co/spaces/microsoft/phi-4-multimodal?WT.mc_id=aiml-137032-kinfeylo)
  - Примеры Vision
    - Примеры Phi-4 🆕
    ...
    - Примеры Phi-3 / 3.5
      -  [📓][Phi-3-vision-Текст изображения в текст](./md/02.Application/04.Vision/Phi3/E2E_Phi-3-vision-image-text-to-text-online-endpoint.ipynb)
      - [Phi-3-vision-ONNX](https://onnxruntime.ai/docs/genai/tutorials/phi3-v.html)
      - [📓][Phi-3-vision CLIP Embedding](./md/02.Application/04.Vision/Phi3/E2E_Phi-3-vision-image-text-to-text-online-endpoint.ipynb)
      - [ДЕМO: Phi-3 Переработка](https://github.com/jennifermarsman/PhiRecycling/)
      ...
      - [📓][Phi-3.5 Vision многокадровый или мульти-изображение пример](./md/02.Application/04.Vision/Phi3/phi3-vision-demo.ipynb)
      - [Phi-3 Vision локальная модель ONNX с использованием Microsoft.ML.OnnxRuntime .NET](../../md/04.HOL/dotnet/src/LabsPhi303)
      - [Меню на базе Phi-3 Vision локальная модель ONNX с использованием Microsoft.ML.OnnxRuntime .NET](../../md/04.HOL/dotnet/src/LabsPhi304)
  ...
  - Примеры MOE
    - Примеры Phi-3 / 3.5
      - [📓] [Модель Phi-3.5 Mixture of Experts (MoEs) пример в социальных сетях](./md/02.Application/06.MoE/Phi3/phi3_moe_demo.ipynb)
  ...
  - Примеры мультимодального смешивания
    - Примеры Phi-4 🆕
      ...
      - [Консольное приложение .NET для анализа изображений с использованием Phi-4-multimodal](../../md/04.HOL/dotnet/src/LabsPhi4-MultiModal-01Images)
...
- Тонкая настройка Phi
  ...
  - [Практическая лаборатория тонкой настройки с Microsoft Olive](./md/03.FineTuning/olive-lab/readme.md)
...
- Практические лаборатории
  - [Изучение современных моделей: LLMs, SLMs, локальная разработка и многое другое](https://github.com/microsoft/aitour-exploring-cutting-edge-models)
...
Вы можете узнать, как использовать Microsoft Phi и как создавать комплексные решения на ваших различных аппаратных устройствах. Чтобы познакомиться с Phi лично, начните с экспериментов с моделями и настройки Phi под ваши сценарии с помощью [Каталога моделей Azure AI Foundry](https://aka.ms/phi3-azure-ai). Подробнее можно узнать в руководстве по началу работы с [Azure AI Foundry](/md/02.QuickStart/AzureAIFoundry_QuickStart.md)
...
Вы можете узнать, как использовать Microsoft Phi и как создавать комплексные решения на ваших различных аппаратных устройствах. Чтобы познакомиться с Phi лично, начните с экспериментов с моделью и настройки Phi под ваши сценарии с помощью [Каталога моделей GitHub](https://github.com/marketplace/models?WT.mc_id=aiml-137032-kinfeylo). Подробнее в руководстве по работе с [Каталогом моделей GitHub](/md/02.QuickStart/GitHubModel_QuickStart.md)
...
Microsoft стремится помогать своим клиентам использовать наши продукты ИИ ответственно, делиться нашими знаниями и строить партнерства, основанные на доверии, через инструменты, такие как Transparency Notes и Impact Assessments. Многие из этих ресурсов доступны по адресу [https://aka.ms/RAI](https://aka.ms/RAI).
...
Крупномасштабные модели для обработки естественного языка, изображений и речи — такие, как используемые в этом примере — могут потенциально вести себя несправедливо, ненадежно или оскорбительно, что может нанести вред. Пожалуйста, ознакомьтесь с [заметкой о прозрачности сервиса Azure OpenAI](https://learn.microsoft.com/legal/cognitive-services/openai/transparency-note?tabs=text), чтобы быть в курсе рисков и ограничений.

Рекомендуемый подход к снижению этих рисков — включить в архитектуру систему безопасности, которая может обнаруживать и предотвращать вредоносное поведение. [Azure AI Content Safety](https://learn.microsoft.com/azure/ai-services/content-safety/overview) предоставляет независимый уровень защиты, способный обнаруживать вредоносный контент, созданный пользователями и ИИ, в приложениях и сервисах. Azure AI Content Safety включает API для текста и изображений, позволяющие выявлять вредоносные материалы. В рамках Azure AI Foundry сервис Content Safety позволяет просматривать, изучать и пробовать образцы кода для обнаружения вредоносного контента в разных модальностях. Следующая [документация по быстрому старту](https://learn.microsoft.com/azure/ai-services/content-safety/quickstart-text?tabs=visual-studio%2Clinux&pivots=programming-language-rest) проведет вас через процесс запросов к сервису.

Еще один аспект, который следует учитывать — общая производительность приложения. В многомодальных и мультимодельных приложениях под производительностью понимается выполнение системы в соответствии с вашими и вашими пользователями ожиданиями, включая отсутствие генерации вредоносных результатов. Важно оценивать производительность всего приложения с помощью [оценщиков производительности, качества, риска и безопасности](https://learn.microsoft.com/azure/ai-studio/concepts/evaluation-metrics-built-in). У вас также есть возможность создавать и оценивать с помощью [пользовательских оценщиков](https://learn.microsoft.com/azure/ai-studio/how-to/develop/evaluate-sdk#custom-evaluators).
Вы можете оценить свое AI-приложение в вашей среде разработки, используя [Azure AI Evaluation SDK](https://microsoft.github.io/promptflow/index.html). Имея тестовый набор данных или цель, ваши генерации генеративного AI-приложения количественно измеряются с помощью встроенных оценщиков или настраиваемых оценщиков по вашему выбору. Чтобы начать работу с azure ai evaluation sdk для оценки вашей системы, вы можете следовать [руководству по быстрому запуску](https://learn.microsoft.com/azure/ai-studio/how-to/develop/flow-evaluate-sdk). После выполнения оценки вы можете [визуализировать результаты в Azure AI Foundry](https://learn.microsoft.com/azure/ai-studio/how-to/evaluate-flow-results). 

## Торговые марки

Этот проект может содержать торговые марки или логотипы проектов, продуктов или услуг. Разрешенное использование торговых марок или логотипов Microsoft подчиняется и должно соответствовать [Правилам использования торговых марок и брендов Microsoft](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
Использование торговых марок или логотипов Microsoft в измененных версиях этого проекта не должно вызывать путаницы или подразумевать спонсорство Microsoft. Любое использование торговых марок или логотипов третьих сторон подчиняется правилам этих третьих сторон.
...
Если у вас есть отзывы о продукте или ошибки при разработке, посещайте:
