...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2026-01-05T08:23:38+00:00",
...
[![Запросы на изменение GitHub](https://img.shields.io/github/issues-pr/microsoft/phicookbook.svg)](https://GitHub.com/microsoft/phicookbook/pulls/?WT.mc_id=aiml-137032-kinfeylo)
...
Phi в настоящее время является самой мощной и экономичной малой языковой моделью (SLM) с очень хорошими показателями в многоязычных задачах, рассуждениях, генерации текста/чата, кодировании, изображениях, аудио и других сценариях.
...
1. **Форк репозитория**: Нажмите [![Форки GitHub](https://img.shields.io/github/forks/microsoft/phicookbook.svg?style=social&label=Fork)](https://GitHub.com/microsoft/phicookbook/network/?WT.mc_id=aiml-137032-kinfeylo)
...
![cover](../../translated_images/ru/cover.eb18d1b9605d754b.webp)

### 🌐 Многоязычная поддержка

#### Поддержка через GitHub Action (автоматизировано и всегда актуально)
...
> ```
> Это даст вам всё необходимое для прохождения курса при значительно более быстрой загрузке.
...
- Инференс семейства Phi
    - [Инференс Phi в iOS](./md/01.Introduction/03/iOS_Inference.md)
    - [Инференс Phi в Android](./md/01.Introduction/03/Android_Inference.md)
    - [Инференс Phi в Jetson](./md/01.Introduction/03/Jetson_Inference.md)
...
- Примеры разработки приложений Phi
  - Текстовые и чатовые приложения
    - Образцы Phi-4 🆕
      ...
      - [Чатовое консольное приложение .NET с Phi-4 ONNX с использованием Semantic Kernel](../../md/04.HOL/dotnet/src/LabsPhi4-Chat-02SK)
    - Образцы Phi-3 / 3.5
      ...
      - [Модель Multi Model - интерактивный Phi-3-mini и OpenAI Whisper](./md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-mini_with_whisper.md)
      ...
      -[Пример приложения заметок на базе WinUI3 с поддержкой мульти-моделей AI](https://github.com/microsoft/ai-powered-notes-winui3-sample)
      ...
      - [Пример Q&A .NET с использованием локальной модели ONNX Phi-3 и Microsoft.ML.OnnxRuntime](../../md/04.HOL/dotnet/src/LabsPhi301)
  ...
  - Примеры на основе SDK Azure AI Inference 
    ...
    - Примеры Phi-3 / 3.5
      - [Создайте собственного GitHub Copilot Chat в Visual Studio Code с Microsoft Phi-3 Family](./md/02.Application/02.Code/Phi3/VSCodeExt/README.md)
      - [Создание собственного агента Visual Studio Code Chat Copilot с Phi-3.5 по моделям GitHub](/md/02.Application/02.Code/Phi3/CreateVSCodeChatAgentWithGitHubModels.md)

  - Примеры продвинутого рассуждения
    - Примеры Phi-4 🆕
      - [📓] [Phi-4-mini-reasoning или примеры Phi-4-reasoning](./md/02.Application/03.AdvancedReasoning/Phi4/AdvancedResoningPhi4mini/README.md)
  ...
  - Демонстрации
      ...
      - [Демонстрации Phi-4-multimodal размещены на Hugging Face Spaces](https://huggingface.co/spaces/microsoft/phi-4-multimodal?WT.mc_id=aiml-137032-kinfeylo)
  - Примеры для видения
    - Примеры Phi-4 🆕
    ...
    - Примеры Phi-3 / 3.5
      -  [📓][Phi-3-vision-Image текст в текст](./md/02.Application/04.Vision/Phi3/E2E_Phi-3-vision-image-text-to-text-online-endpoint.ipynb)
      ...
      - [📓][Phi-3.5 Vision пример с многокадровым или мультиизображением](./md/02.Application/04.Vision/Phi3/phi3-vision-demo.ipynb)
      - [Phi-3 Vision локальная модель ONNX с использованием Microsoft.ML.OnnxRuntime .NET](../../md/04.HOL/dotnet/src/LabsPhi303)
      - [Меню-ориентированная Phi-3 Vision локальная модель ONNX с использованием Microsoft.ML.OnnxRuntime .NET](../../md/04.HOL/dotnet/src/LabsPhi304)
  ...
  - Примеры по аудио
    - Примеры Phi-4 🆕
      - [📓] [Извлечение аудиотранскриптов с использованием Phi-4-multimodal](./md/02.Application/05.Audio/Phi4/Transciption/README.md)
      - [📓] [Пример аудио Phi-4-multimodal](./md/02.Application/05.Audio/Phi4/Siri/demo.ipynb)
      - [📓] [Пример речевого перевода Phi-4-multimodal](./md/02.Application/05.Audio/Phi4/Translate/demo.ipynb)
  ...
  - Примеры MOE
    - Примеры Phi-3 / 3.5
      - [📓] [Модели смешения экспертов Phi-3.5 (MoEs) для социальных сетей](./md/02.Application/06.MoE/Phi3/phi3_moe_demo.ipynb)
...
- Тонкая настройка Phi Примеров
  ...
  - [Тонкая настройка Phi-3 с фреймворком Apple MLX](./md/03.FineTuning/FineTuning_MLX.md)
  - [Тонкая настройка Phi-3-vision (официальная поддержка)](./md/03.FineTuning/FineTuning_Vision.md)
  - [Тонкая настройка Phi-3 с Kaito AKS, контейнерами Azure (официальная поддержка)](./md/03.FineTuning/FineTuning_Kaito.md)
...
- Академические научные статьи и публикации
  - [Все, что вам нужно, это учебники II: технический отчет phi-1.5](https://arxiv.org/abs/2309.05463)
  ...
  - [(WhyPHI) Тонкая настройка PHI-3 для ответов на вопросы с выбором ответа: методология, результаты и задачи](https://arxiv.org/abs/2501.01588)
...
Вы можете узнать, как использовать Microsoft Phi и как создавать комплексные решения для различных аппаратных устройств. Чтобы испытать Phi самостоятельно, начните с работы с моделями и настройте Phi под свои сценарии, используя [Каталог моделей Azure AI Foundry](https://aka.ms/phi3-azure-ai). Подробнее можно узнать в разделе Начало работы с [Azure AI Foundry](/md/02.QuickStart/AzureAIFoundry_QuickStart.md)

**Песочница**  
Для каждой модели есть специальная песочница для тестирования [Azure AI Playground](https://aka.ms/try-phi3).

### Phi на GitHub Models

Вы можете узнать, как использовать Microsoft Phi и создавать комплексные решения на различных аппаратных устройствах. Чтобы испытать Phi самому, начните с работы с моделью и настройте Phi под свои сценарии, используя [Каталог моделей GitHub](https://github.com/marketplace/models?WT.mc_id=aiml-137032-kinfeylo). Подробнее читайте в разделе Начало работы с [Каталогом моделей GitHub](/md/02.QuickStart/GitHubModel_QuickStart.md)

**Песочница**  
Для каждой модели есть специальная [песочница для тестирования модели](/md/02.QuickStart/GitHubModel_QuickStart.md).

### Phi на Hugging Face

Вы также можете найти модели на [Hugging Face](https://huggingface.co/microsoft)
...
### Серия Copilot  
[![Copilot для парного программирования на основе ИИ](https://img.shields.io/badge/Copilot%20for%20AI%20Paired%20Programming-FACC15?style=for-the-badge&labelColor=E5E7EB&color=FACC15)](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)  
...
Microsoft стремится помочь нашим клиентам использовать наши продукты ИИ ответственно, делясь нашими знаниями и строя партнерства на основе доверия с помощью таких инструментов, как Transparency Notes и Impact Assessments. Многие из этих ресурсов доступны по адресу [https://aka.ms/RAI](https://aka.ms/RAI).  
...
Крупномасштабные модели обработки естественного языка, изображений и речи — такие, как использованные в этом примере — могут иногда вести себя несправедливо, ненадежно или оскорбительно, что может причинять вред. Пожалуйста, ознакомьтесь с [Примечанием о прозрачности сервиса Azure OpenAI](https://learn.microsoft.com/legal/cognitive-services/openai/transparency-note?tabs=text), чтобы быть информированным об рисках и ограничениях.

Рекомендуемый подход к смягчению этих рисков — включение в вашу архитектуру системы безопасности, которая может обнаруживать и предотвращать вредоносное поведение. [Azure AI Content Safety](https://learn.microsoft.com/azure/ai-services/content-safety/overview) предоставляет независимый уровень защиты, способный обнаруживать вредоносный контент, созданный пользователями или ИИ, в приложениях и сервисах. Azure AI Content Safety включает API для текста и изображений, позволяющие выявлять вредоносный материал. В Azure AI Foundry сервис Content Safety позволяет просматривать, изучать и проверять пример кода для обнаружения вредоносного контента в разных модальностях. Следующая [документация для быстрого старта](https://learn.microsoft.com/azure/ai-services/content-safety/quickstart-text?tabs=visual-studio%2Clinux&pivots=programming-language-rest) проведет вас через процесс отправки запросов к сервису.

Другой аспект — общая производительность приложения. В мультимодальных и мультимодельных приложениях под производительностью понимается то, что система работает так, как вы и ваши пользователи ожидаете, включая отсутствие генерации вредоносного вывода. Важно оценивать производительность вашего приложения с помощью [оценщиков производительности и качества, а также рисков и безопасности](https://learn.microsoft.com/azure/ai-studio/concepts/evaluation-metrics-built-in). Вы также можете создавать и оценивать с помощью [пользовательских оценщиков](https://learn.microsoft.com/azure/ai-studio/how-to/develop/evaluate-sdk#custom-evaluators).
Вы можете оценить свое ИИ-приложение в среде разработки с помощью [Azure AI Evaluation SDK](https://microsoft.github.io/promptflow/index.html). Имея либо тестовый набор данных, либо цель, генерации вашего генеративного ИИ-приложения количественно измеряются с помощью встроенных оценщиков или пользовательских оценщиков на ваш выбор. Чтобы начать работу с azure ai evaluation sdk для оценки вашей системы, вы можете следовать [руководству по быстрому началу](https://learn.microsoft.com/azure/ai-studio/how-to/develop/flow-evaluate-sdk). После выполнения запуска оценки вы можете [визуализировать результаты в Azure AI Foundry](https://learn.microsoft.com/azure/ai-studio/how-to/evaluate-flow-results).

## Торговые марки

Этот проект может содержать торговые марки или логотипы проектов, продуктов или услуг. Авторизованное использование торговых марок или логотипов Microsoft подчиняется и должно следовать [Руководству Microsoft по торговым маркам и брендам](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
Использование торговых марок или логотипов Microsoft в изменённых версиях этого проекта не должно вызывать путаницу или подразумевать спонсорство Microsoft. Любое использование торговых марок или логотипов третьих сторон подчиняется политикам этих третьих сторон.
