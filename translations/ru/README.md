...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-16T14:52:06+00:00",
...
В настоящее время Phi — самая мощная и экономичная небольшая языковая модель (SLM), показывающая отличные результаты в многоязычии, логическом мышлении, генерации текста и чата, программировании, работе с изображениями, аудио и других сценариях.
...
- Примеры MOE  
  - Примеры Phi-3 / 3.5  
    ...
    - [📓] [Создание Retrieval-Augmented Generation (RAG) пайплайна с NVIDIA NIM Phi-3 MOE, Azure AI Search и LlamaIndex](../../md/02.Application/06.MoE/Phi3/azure-ai-search-nvidia-rag.ipynb)  
...
Крупномасштабные модели для обработки естественного языка, изображений и речи — такие, как используемые в этом примере — могут иногда вести себя несправедливо, ненадежно или оскорбительно, что может привести к негативным последствиям. Пожалуйста, ознакомьтесь с [Transparency note сервиса Azure OpenAI](https://learn.microsoft.com/legal/cognitive-services/openai/transparency-note?tabs=text), чтобы быть в курсе рисков и ограничений.
