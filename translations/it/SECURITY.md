...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-09T04:18:20+00:00",
...
Se ritieni di aver trovato una vulnerabilità di sicurezza in un repository di proprietà Microsoft che rientra nella [definizione di vulnerabilità di sicurezza di Microsoft](https://aka.ms/security.md/definition), ti preghiamo di segnalarla come descritto di seguito.
...
Se preferisci inviare la segnalazione senza effettuare il login, manda un’email a [secure@microsoft.com](mailto:secure@microsoft.com). Se possibile, cripta il messaggio con la nostra chiave PGP; puoi scaricarla dalla [pagina della chiave PGP del Microsoft Security Response Center](https://aka.ms/security.md/msrc/pgp).

Dovresti ricevere una risposta entro 24 ore. Se per qualche motivo non la ricevi, ti preghiamo di inviare un sollecito via email per assicurarci di aver ricevuto il tuo messaggio originale. Ulteriori informazioni sono disponibili su [microsoft.com/msrc](https://www.microsoft.com/msrc).

Ti preghiamo di includere le informazioni richieste elencate qui sotto (per quanto possibile) per aiutarci a comprendere meglio la natura e la portata del problema:
...
Se stai segnalando per un bug bounty, report più completi possono contribuire a un premio più alto. Visita la nostra pagina [Microsoft Bug Bounty Program](https://aka.ms/security.md/msrc/bounty) per maggiori dettagli sui programmi attivi.
