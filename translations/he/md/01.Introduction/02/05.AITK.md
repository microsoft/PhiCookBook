...
[AI Toolkit for VS Code](https://marketplace.visualstudio.com/items?itemName=ms-windows-ai-studio.windows-ai-studio) מפשטת את פיתוח אפליקציות AI גנרטיביות על ידי איחוד כלים ומודלים מתקדמים לפיתוח AI מתוך Microsoft Foundry Catalog וקטלוגים נוספים כמו Hugging Face. תוכלו לגלוש בקטלוג המודלים של AI המופעל על ידי GitHub Models ו-Microsoft Foundry Model Catalogs, להוריד אותם למחשב המקומי או מרחוק, לכוונן, לבדוק ולהשתמש בהם באפליקציה שלכם.
...
![AI toolkit model catalog](../../../../../translated_images/he/AItoolkitmodel_catalog.7a7be6a7d8468d31.webp)
...
![Load model in playground](../../../../../translated_images/he/AItoolkitload_model_into_playground.dcef5355b1653b52.webp)
