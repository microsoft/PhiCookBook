...
- Phi अॅप्लिकेशन विकास नमुने
  ...
  - प्रगत तर्कनियमन सॅम्पल्स
    - Phi-4 सॅम्पल्स 🆕
      ...
      - [📓] [Azure AI Foundry मॉडेल्स सह Phi-4-mini-reasoning](./md/02.Application/02.Code/Phi4r/azure_models_inference.ipynb)
  - डेमो
...
आपण Microsoft Phi कसा वापरायचा आणि आपल्या विविध हार्डवेअर उपकरणांमध्ये E2E सोल्यूशन्स कसे तयार करायचे हे जाणून घेऊ शकता. स्वतः साठी Phi अनुभवण्यासाठी, प्रथम मॉडेल्ससह खेळा आणि आपल्या परिस्थितीसाठी Phi सानुकूलित करा, [Azure AI Foundry Azure AI Model Catalog](https://aka.ms/phi3-azure-ai) वापरून आपण अधिक माहिती मिळवू शकता Getting Started with [Azure AI Foundry](/md/02.QuickStart/AzureAIFoundry_QuickStart.md)
