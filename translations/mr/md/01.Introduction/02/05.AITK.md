...
[AI Toolkit for VS Code](https://marketplace.visualstudio.com/items?itemName=ms-windows-ai-studio.windows-ai-studio) जनरेटिव्ह AI अॅप विकास सुलभ करते, ज्यामध्ये Microsoft Foundry Catalog आणि Hugging Face सारख्या इतर कॅटलॉगमधील अत्याधुनिक AI विकास साधने आणि मॉडेल्स एकत्र आणले आहेत. तुम्ही GitHub Models आणि Microsoft Foundry Model Catalogs द्वारे समर्थित AI मॉडेल कॅटलॉग ब्राउझ करू शकता, ते स्थानिक किंवा रिमोट डाउनलोड करू शकता, फाइन-ट्यून करू शकता, चाचणी करू शकता आणि तुमच्या अॅप्लिकेशनमध्ये वापरू शकता.
