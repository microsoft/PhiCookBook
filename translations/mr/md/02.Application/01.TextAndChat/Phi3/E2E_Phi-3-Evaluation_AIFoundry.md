...
![Architecture of tutorial.](../../../../../../translated_images/mr/architecture.10bec55250f5d6a4.png)
...
![Safaty evaluation.](../../../../../../translated_images/mr/safety-evaluation.083586ec88dfa950.png)
...
![Fill hub.](../../../../../../translated_images/mr/responsibleai2.c07ef430113fad8c.png)
...
![Evaluate based on safety.](../../../../../../translated_images/mr/evaluate-based-on-safety.c5df819f5b0bfc07.png)
...
![Safaty evaluation.](../../../../../../translated_images/mr/performance-evaluation.48b3e7e01a098740.png)
...
![Evaluate based on performance.](../../../../../../translated_images/mr/evaluate-based-on-performance.3e801c647c7554e8.png)
...
1. नेव्हिगेशन मेनूमधून **+ New hub** निवडा.
    ...
    ![Create hub.](../../../../../../translated_images/mr/create-hub.5be78fb1e21ffbf1.png)
...
1. खालील कामे करा:
    ...
    ![Fill hub.](../../../../../../translated_images/mr/fill-hub.baaa108495c71e34.png)
...
1. नेव्हिगेशन मेनूमधून **+ New project** निवडा.
    ...
    ![Select new project.](../../../../../../translated_images/mr/select-new-project.cd31c0404088d7a3.png)

1. **Project name** टाका. हे नाव अनन्य असावे.

    ![Create project.](../../../../../../translated_images/mr/create-project.ca3b71298b90e420.png)
...
1. डाव्या बाजूच्या टॅबमधून **Endpoints** निवडा.
    ...
    ![Select endpoints.](../../../../../../translated_images/mr/select-endpoints.ee7387ecd68bd18d.png)

1. तुम्ही तयार केलेला endpoint निवडा.

    ![Select endpoints.](../../../../../../translated_images/mr/select-endpoint-created.9f63af5e4cf98b2e.png)

1. नेव्हिगेशन मेनूमधून **Consume** निवडा.

1. तुमचा **REST endpoint** आणि **Primary key** कॉपी करा.

    ![Copy api key and endpoint uri.](../../../../../../translated_images/mr/copy-endpoint-key.0650c3786bd646ab.png)
...
1. **+ New connection** निवडा.
    ...
    ![Select new connection.](../../../../../../translated_images/mr/select-new-connection.fa0f35743758a74b.png)

1. नेव्हिगेशन मेनूमधून **Custom keys** निवडा.

    ![Select custom keys.](../../../../../../translated_images/mr/select-custom-keys.5a3c6b25580a9b67.png)
...
1. खालील कामे करा:
    ...
    ![Add connection.](../../../../../../translated_images/mr/add-connection.ac7f5faf8b10b0df.png)
...
1. नेव्हिगेशन मेनूमधून **+ Create** निवडा.
    ...
    ![Select Promptflow.](../../../../../../translated_images/mr/select-promptflow.18ff2e61ab9173eb.png)

1. नेव्हिगेशन मेनूमधून **Chat flow** निवडा.

    ![Select chat flow.](../../../../../../translated_images/mr/select-flow-type.28375125ec9996d3.png)

1. वापरण्यासाठी **Folder name** टाका.

    ![Select chat flow.](../../../../../../translated_images/mr/enter-name.02ddf8fb840ad430.png)
...
1. Prompt flow मध्ये, विद्यमान flow पुन्हा तयार करण्यासाठी खालील कामे करा:
    ...
    ![Select raw file mode.](../../../../../../translated_images/mr/select-raw-file-mode.06c1eca581ce4f53.png)
...
1. Prompt flow मध्ये कस्टम Phi-3 / Phi-3.5 मॉडेल वापरण्यासाठी *integrate_with_promptflow.py* मध्ये खालील कोड जोडा.
    ...
    ![Paste prompt flow code.](../../../../../../translated_images/mr/paste-promptflow-code.cd6d95b101c0ec28.png)
...
1. **Chat input**, **Chat output** निवडा जेणेकरून तुमच्या मॉडेलशी चॅट करता येईल.
    ...
    ![Select Input Output.](../../../../../../translated_images/mr/select-input-output.c187fc58f25fbfc3.png)
...
>
> ![Flow example](../../../../../../translated_images/mr/graph-example.82fd1bcdd3fc545b.png)
>
...
1. Prompt flow सुरू करण्यासाठी **Start compute sessions** निवडा.
    ...
    ![Start compute session.](../../../../../../translated_images/mr/start-compute-session.9acd8cbbd2c43df1.png)

1. पॅरामीटर्स रिन्यू करण्यासाठी **Validate and parse input** निवडा.

    ![Validate input.](../../../../../../translated_images/mr/validate-input.c1adb9543c6495be.png)

1. तुम्ही तयार केलेल्या कस्टम कनेक्शनचा **connection** चा **Value** निवडा. उदाहरणार्थ, *connection*.

    ![Connection.](../../../../../../translated_images/mr/select-connection.1f2b59222bcaafef.png)

#### तुमच्या कस्टम Phi-3 / Phi-3.5 मॉडेलशी चॅट करा

1. **Chat** निवडा.

    ![Select chat.](../../../../../../translated_images/mr/select-chat.0406bd9687d0c49d.png)
...
1. खाली परिणामांचे उदाहरण आहे: आता तुम्ही तुमच्या कस्टम Phi-3 / Phi-3.5 मॉडेलशी चॅट करू शकता. फाइन-ट्यूनिंगसाठी वापरलेल्या डेटावर आधारित प्रश्न विचारणे शिफारसीय आहे.
    ...
    ![Chat with prompt flow.](../../../../../../translated_images/mr/chat-with-promptflow.1cf8cea112359ada.png)
...
1. तुम्ही तयार केलेल्या Azure AI Foundry प्रोजेक्टमध्ये जा.
    ...
    ![Select Project.](../../../../../../translated_images/mr/select-project-created.5221e0e403e2c9d6.png)
...
1. **Deploy base model** निवडा.
    ...
    ![Select Deployments.](../../../../../../translated_images/mr/deploy-openai-model.95d812346b25834b.png)

1. वापरायचा Azure OpenAI मॉडेल निवडा. उदाहरणार्थ, **gpt-4o**.

    ![Select Azure OpenAI model you'd like to use.](../../../../../../translated_images/mr/select-openai-model.959496d7e311546d.png)
...
1. नेव्हिगेशन मेनूमधून **+ New evaluation** निवडा.
    ...
    ![Select evaluation.](../../../../../../translated_images/mr/select-evaluation.2846ad7aaaca7f4f.png)

1. **Prompt flow** evaluation निवडा.

    ![Select Prompt flow evaluation.](../../../../../../translated_images/mr/promptflow-evaluation.cb9758cc19b4760f.png)
...
1. खालील कामे करा:
    ...
    ![Prompt flow evaluation.](../../../../../../translated_images/mr/evaluation-setting1.4aa08259ff7a536e.png)
...
1. खालील कामे करा:
    ...
    ![Prompt flow evaluation.](../../../../../../translated_images/mr/evaluation-setting2.07036831ba58d64e.png)
...
1. कामगिरी आणि गुणवत्ता मेट्रिक्स कॉन्फिगर करण्यासाठी खालील कामे करा:
    ...
    ![Prompt flow evaluation.](../../../../../../translated_images/mr/evaluation-setting3-1.d1ae69e3bf80914e.png)
...
1. धोका आणि सुरक्षा मेट्रिक्स कॉन्फिगर करण्यासाठी खालील कामे करा:
    ...
    ![Prompt flow evaluation.](../../../../../../translated_images/mr/evaluation-setting3-2.d53bd075c60a45a2.png)
...
1. कामगिरी आणि गुणवत्ता मेट्रिक्स:
    ...
    ![Evaluation result.](../../../../../../translated_images/mr/evaluation-result-gpu.85f48b42dfb74254.png)
...
1. धोका आणि सुरक्षितता मेट्रिक्स:
    ...
    ![Evaluation result.](../../../../../../translated_images/mr/evaluation-result-gpu-2.1b74e336118f4fd0.png)

1. तुम्ही खाली स्क्रोल करून **तपशीलवार मेट्रिक्स निकाल** पाहू शकता.

    ![Evaluation result.](../../../../../../translated_images/mr/detailed-metrics-result.afa2f5c39a4f5f17.png)
...
![Architecture.](../../../../../../translated_images/mr/architecture.10bec55250f5d6a4.png)
