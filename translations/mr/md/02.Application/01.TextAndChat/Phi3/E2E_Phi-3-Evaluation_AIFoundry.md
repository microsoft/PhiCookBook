# Microsoft Foundry मध्ये Microsoft च्या जबाबदार AI तत्त्वांवर लक्ष केंद्रित करून Fine-tuned Phi-3 / Phi-3.5 मॉडेलचे मूल्यांकन करा
...
### Microsoft Foundry मध्ये Fine-tuned Phi-3 / Phi-3.5 मॉडेलची सुरक्षा आणि कार्यक्षमता कशी मूल्यांकन करू शकता?

मॉडेलचे fine-tuning केल्यावर कधी कधी अनपेक्षित किंवा नको असलेले प्रतिसाद येऊ शकतात. मॉडेल सुरक्षित आणि प्रभावी राहील याची खात्री करण्यासाठी, त्याच्या हानिकारक सामग्री निर्माण करण्याच्या शक्यता आणि अचूक, संबंधित आणि सुसंगत प्रतिसाद देण्याच्या क्षमतेचे मूल्यांकन करणे महत्त्वाचे आहे. या ट्युटोरियलमध्ये, आपण Microsoft Foundry मध्ये Prompt flow सह एकत्रित केलेल्या Fine-tuned Phi-3 / Phi-3.5 मॉडेलची सुरक्षा आणि कार्यक्षमता कशी मूल्यांकन करायची ते शिकाल.

Microsoft Foundry चा मूल्यांकन प्रक्रिया खालीलप्रमाणे आहे.
...
1. [**परिस्थिती 1: Microsoft Foundry च्या Prompt flow मूल्यांकनाची ओळख**](../../../../../../md/02.Application/01.TextAndChat/Phi3)
...
1. [**परिस्थिती 2: Microsoft Foundry मध्ये Phi-3 / Phi-3.5 मॉडेलचे मूल्यांकन**](../../../../../../md/02.Application/01.TextAndChat/Phi3)
    ...
    - [Microsoft Foundry च्या Prompt flow मूल्यांकनाचा वापर करून Fine-tuned Phi-3 / Phi-3.5 मॉडेलचे मूल्यांकन करा](../../../../../../md/02.Application/01.TextAndChat/Phi3)

1. [अभिनंदन!](../../../../../../md/02.Application/01.TextAndChat/Phi3)

## **परिस्थिती 1: Microsoft Foundry च्या Prompt flow मूल्यांकनाची ओळख**

### सुरक्षा मूल्यांकनाची ओळख

आपले AI मॉडेल नैतिक आणि सुरक्षित आहे याची खात्री करण्यासाठी, Microsoft च्या जबाबदार AI तत्त्वांनुसार त्याचे मूल्यांकन करणे अत्यंत आवश्यक आहे. Microsoft Foundry मध्ये, सुरक्षा मूल्यांकन आपल्याला मॉडेलच्या jailbreak हल्ल्यांपासून असुरक्षिततेचे आणि हानिकारक सामग्री निर्माण करण्याच्या शक्यतेचे मूल्यांकन करण्याची परवानगी देते, जे थेट या तत्त्वांशी सुसंगत आहे.
...
या ट्युटोरियलमध्ये, आपण Microsoft Foundry च्या सुरक्षा मेट्रिक्सचा वापर करून Fine-tuned Phi-3 मॉडेलची सुरक्षा मूल्यांकन कराल. हे मेट्रिक्स मॉडेलच्या हानिकारक सामग्री निर्माण करण्याच्या शक्यता आणि jailbreak हल्ल्यांपासून असुरक्षिततेचे मूल्यांकन करण्यात मदत करतात. सुरक्षा मेट्रिक्समध्ये समाविष्ट आहे:
...
या ट्युटोरियलमध्ये, आपण Microsoft Foundry च्या कार्यक्षमता मेट्रिक्सचा वापर करून Fine-tuned Phi-3 / Phi-3.5 मॉडेलची कार्यक्षमता मूल्यांकन कराल. हे मेट्रिक्स मॉडेलच्या अचूक, संबंधित आणि सुसंगत प्रतिसाद निर्माण करण्याच्या कार्यक्षमतेचे मूल्यांकन करण्यात मदत करतात. कार्यक्षमता मेट्रिक्समध्ये समाविष्ट आहे:
...
## **परिस्थिती 2: Microsoft Foundry मध्ये Phi-3 / Phi-3.5 मॉडेलचे मूल्यांकन**

### सुरू करण्यापूर्वी

हा ट्युटोरियल मागील ब्लॉग पोस्ट्स "[Fine-Tune and Integrate Custom Phi-3 Models with Prompt Flow: Step-by-Step Guide](https://techcommunity.microsoft.com/t5/educator-developer-blog/fine-tune-and-integrate-custom-phi-3-models-with-prompt-flow/ba-p/4178612?wt.mc_id=studentamb_279723)" आणि "[Fine-Tune and Integrate Custom Phi-3 Models with Prompt Flow in Microsoft Foundry](https://techcommunity.microsoft.com/t5/educator-developer-blog/fine-tune-and-integrate-custom-phi-3-models-with-prompt-flow-in/ba-p/4191726?wt.mc_id=studentamb_279723)" यांचा पुढील भाग आहे. या पोस्ट्समध्ये, आपण Microsoft Foundry मध्ये Phi-3 / Phi-3.5 मॉडेलचे fine-tuning कसे करायचे आणि ते Prompt flow सह कसे एकत्रित करायचे हे पाहिले.

या ट्युटोरियलमध्ये, आपण Microsoft Foundry मध्ये Azure OpenAI मॉडेल एक मूल्यांकनकर्ता म्हणून तैनात कराल आणि त्याचा वापर करून आपले Fine-tuned Phi-3 / Phi-3.5 मॉडेलचे मूल्यांकन कराल.
...
3. Microsoft Foundry मध्ये आपल्या fine-tuned Phi-3 / Phi-3.5 मॉडेलसह एकत्रित केलेला Prompt flow.
...
प्रगती करण्यासाठी, तुम्हाला तुमचा फाइन-ट्यून केलेला Phi-3 / Phi-3.5 मॉडेल Microsoft Foundry मधील Prompt flow मध्ये एकत्रित करावा लागेल.

#### Microsoft Foundry हब तयार करा

प्रोजेक्ट तयार करण्यापूर्वी तुम्हाला हब तयार करावा लागेल. हब हा Resource Group सारखा असतो, जो तुम्हाला Microsoft Foundry मध्ये अनेक प्रोजेक्ट्सचे आयोजन आणि व्यवस्थापन करण्यास मदत करतो.
...
1. [Microsoft Foundry](https://ai.azure.com/?wt.mc_id=studentamb_279723) ला भेट द्या.
...
तुम्ही Microsoft Foundry मध्ये कस्टम कनेक्शन जोडले आहे. आता खालील टप्प्यांद्वारे Prompt flow तयार करूया. नंतर, तुम्ही या Prompt flow ला कस्टम कनेक्शनशी जोडून फाइन-ट्यून केलेला मॉडेल Prompt flow मध्ये वापरू शकता.
...
> [!NOTE]
> Microsoft Foundry मध्ये Prompt flow वापरण्याबाबत अधिक सविस्तर माहितीकरिता, तुम्ही [Prompt flow in Microsoft Foundry](https://learn.microsoft.com/azure/ai-studio/how-to/prompt-flow) पाहू शकता.
...
Phi-3 / Phi-3.5 मॉडेलचे Microsoft Foundry मध्ये मूल्यमापन करण्यासाठी, तुम्हाला Azure OpenAI मॉडेल तैनात करावे लागेल. हा मॉडेल Phi-3 / Phi-3.5 मॉडेलच्या कामगिरीचे मूल्यमापन करण्यासाठी वापरला जाईल.
...
### Microsoft Foundry च्या Prompt flow मूल्यमापनाचा वापर करून फाइन-ट्यून केलेल्या Phi-3 / Phi-3.5 मॉडेलचे मूल्यमापन करा
...
1. कामगिरी आणि गुणवत्ता मेट्रिक्स:
    ...
    ![Evaluation result.](../../../../../../translated_images/mr/evaluation-result-gpu.85f48b42dfb74254.webp)
...
1. धोका आणि सुरक्षितता मेट्रिक्स:
    ...
    ![Evaluation result.](../../../../../../translated_images/mr/evaluation-result-gpu-2.1b74e336118f4fd0.webp)

1. तुम्ही खाली स्क्रोल करून **तपशीलवार मेट्रिक्स निकाल** पाहू शकता.

    ![Evaluation result.](../../../../../../translated_images/mr/detailed-metrics-result.afa2f5c39a4f5f17.webp)
...
तुम्ही यशस्वीपणे Microsoft Foundry मध्ये Prompt flow सह एकत्रित केलेले fine-tuned Phi-3 मॉडेलचे मूल्यांकन केले आहे. हा एक महत्त्वाचा टप्पा आहे ज्यामुळे तुमची AI मॉडेल्स केवळ चांगली कामगिरी करत नाहीत तर Microsoft च्या जबाबदार AI तत्त्वांचे पालन करतात, ज्यामुळे तुम्हाला विश्वासार्ह आणि विश्वसनीय AI अनुप्रयोग तयार करता येतात.

![Architecture.](../../../../../../translated_images/mr/architecture.10bec55250f5d6a4.webp)
...
- [Microsoft Foundry दस्तऐवजीकरण](https://learn.microsoft.com/azure/ai-studio/?wt.mc_id=studentamb_279723)
