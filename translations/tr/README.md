...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2026-01-05T03:34:28+00:00",
...
[![PR'ler Hoşgeldiniz](https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat-square)](http://makeapullrequest.com?WT.mc_id=aiml-137032-kinfeylo)
...
Phi, şu anda çok dilli, akıl yürütme, metin/sohbet oluşturma, kodlama, görüntüler, ses ve diğer senaryolarda çok iyi kıyaslama sonuçlarına sahip, en güçlü ve maliyet-etkin küçük dil modellerinden (SLM) biridir. 

Phi'yi buluta veya uç cihazlara dağıtabilirsiniz ve sınırlı hesaplama gücüyle kolayca üretken yapay zeka uygulamaları geliştirebilirsiniz.

Bu kaynakları kullanmaya başlamak için şu adımları izleyin:
1. **Depoyu Fork'layın**: Tıklayın [![GitHub forks](https://img.shields.io/github/forks/microsoft/phicookbook.svg?style=social&label=Fork)](https://GitHub.com/microsoft/phicookbook/network/?WT.mc_id=aiml-137032-kinfeylo)
...
> ```
> Bu, çok daha hızlı bir indirme ile kursu tamamlamak için ihtiyacınız olan her şeyi sağlar.
...
- Phi'yi farklı ortamlarda çıkarma
...
- Phi Ailesinde Çıkarım
    ...
    - [Phi--Vision Yerelde Çıkarımı](./md/01.Introduction/03/Vision_Inference.md)
    - [Kaito AKS, Azure Containers ile Phi Çıkarımı (resmi destek)](./md/01.Introduction/03/Kaito_Inference.md)
-  [Phi Ailesinin Nicelendirilmesi](./md/01.Introduction/04/QuantifyingPhi.md)
    - [llama.cpp kullanarak Phi-3.5 / 4'ü Kuantize Etme](./md/01.Introduction/04/UsingLlamacppQuantifyingPhi.md)
    - [Generative AI extensions for onnxruntime kullanarak Phi-3.5 / 4'ü Kuantize Etme](./md/01.Introduction/04/UsingORTGenAIQuantifyingPhi.md)
    - [Intel OpenVINO kullanarak Phi-3.5 / 4'ü Kuantize Etme](./md/01.Introduction/04/UsingIntelOpenVINOQuantifyingPhi.md)
    - [Apple MLX Çerçevesi kullanarak Phi-3.5 / 4'ü Kuantize Etme](./md/01.Introduction/04/UsingAppleMLXQuantifyingPhi.md)
...
- Phi uygulama geliştirme örnekleri
  - Metin & Sohbet Uygulamaları
    ...
    - Phi-3 / 3.5 Örnekleri
      ...
      - [Model Optimizasyonu - Phi-3-mini modelini Olive ile ONNX Runtime Web için nasıl optimize edilir](https://github.com/microsoft/Olive/tree/main/examples/phi3)
      - [Phi-3 mini-4k-instruct-onnx ile WinUI3 Uygulaması](https://github.com/microsoft/Phi3-Chat-WinUI3-Sample/)
      -[WinUI3 Çok Modelli Yapay Zeka Destekli Notlar Uygulaması Örneği](https://github.com/microsoft/ai-powered-notes-winui3-sample)
      ...
      - [Azure AI Foundry'de Microsoft'un Sorumlu Yapay Zeka İlkelerine Odaklanarak İnce Ayar Yapılmış Phi-3 / Phi-3.5 Modelini Değerlendirme](./md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-Evaluation_AIFoundry.md)
      ...
      - [Phi-3.5-Instruct ONNX ile Prompt flow çözümü oluşturmak için Windows GPU kullanma](./md/02.Application/01.TextAndChat/Phi3/UsingPromptFlowWithONNX.md)
      ...
      - [Microsoft.ML.OnnxRuntime kullanarak yerel ONNX Phi-3 modelini kullanan Soru-Cevap .NET Örneği](../../md/04.HOL/dotnet/src/LabsPhi301)
  ...
  - Gelişmiş Akıl Yürütme Örnekleri
    - Phi-4 Örnekleri 🆕
      ...
      - [📓] [Phi-4-mini-akıl yürütmeyi Microsoft Olive ile ince ayar yapma](./md/02.Application/03.AdvancedReasoning/Phi4/AdvancedResoningPhi4mini/olive_ft_phi_4_reasoning_with_medicaldata.ipynb)
      - [📓] [Phi-4-mini-akıl yürütmeyi Apple MLX ile ince ayar yapma](./md/02.Application/03.AdvancedReasoning/Phi4/AdvancedResoningPhi4mini/mlx_ft_phi_4_reasoning_with_medicaldata.ipynb)
  ...
  - Demolar
      ...
      - [Hugginge Face Spaces'te barındırılan Phi-4-multimodal demoları](https://huggingface.co/spaces/microsoft/phi-4-multimodal?WT.mc_id=aiml-137032-kinfeylo)
  - Görsel Örnekler
    - Phi-4 Örnekleri 🆕
      - [📓] [Phi-4-multimodal kullanarak görüntüleri okuma ve kod oluşturma](./md/02.Application/04.Vision/Phi4/CreateFrontend/README.md) 
    - Phi-3 / 3.5 Örnekleri
      -  [📓][Phi-3-vision-Görüntü metinden metine](./md/02.Application/04.Vision/Phi3/E2E_Phi-3-vision-image-text-to-text-online-endpoint.ipynb)
      - [Phi-3-vision-ONNX](https://onnxruntime.ai/docs/genai/tutorials/phi3-v.html)
      - [📓][Phi-3-vision CLIP Yerleştirmesi](./md/02.Application/04.Vision/Phi3/E2E_Phi-3-vision-image-text-to-text-online-endpoint.ipynb)
      ...
      - [Phi-3 Vision Yerel ONNX Modeli kullanarak Microsoft.ML.OnnxRuntime .NET](../../md/04.HOL/dotnet/src/LabsPhi303)
      - [Menü tabanlı Phi-3 Vision Yerel ONNX Modeli kullanarak Microsoft.ML.OnnxRuntime .NET](../../md/04.HOL/dotnet/src/LabsPhi304)
  ...
  - Ses Örnekleri
    - Phi-4 Örnekleri 🆕
      ...
      - [.NET konsol uygulaması, bir ses dosyasını analiz etmek ve transkript oluşturmak için Phi-4-multimodal Ses kullanma](../../md/04.HOL/dotnet/src/LabsPhi4-MultiModal-02Audio)
  ...
  - Fonksiyon Çağırma Örnekleri
    - Phi-4 Örnekleri 🆕
      ...
      -  [📓] [Fonksiyon Çağırmayı kullanarak Phi-4-mini ile çoklu ajanlar oluşturma](./md/02.Application/07.FunctionCalling/Phi4/Multiagents/Phi_4_mini_multiagent.ipynb)
  ...
  - Çokmodlu Karışım Örnekleri
    - Phi-4 Örnekleri 🆕
      -  [📓] [Phi-4-multimodal kullanarak Teknoloji gazetecisi olma](../../md/02.Application/08.Multimodel/Phi4/TechJournalist/phi_4_mm_audio_text_publish_news_ipynb)
...
- Phi İnce Ayar Örnekleri
  ...
  - [Phi-3'ü bir sektör uzmanı haline getirme için İnce Ayar](./md/03.FineTuning/LetPhi3gotoIndustriy.md)
  - [AI Toolkit for VS Code ile Phi-3'ü İnce Ayar Yapma](./md/03.FineTuning/Finetuning_VSCodeaitoolkit.md)
  - [Azure Machine Learning Service ile Phi-3'ü İnce Ayar Yapma](./md/03.FineTuning/Introduce_AzureML.md)
  - [Lora ile Phi-3'ü İnce Ayar Yapma](./md/03.FineTuning/FineTuning_Lora.md)
  - [QLora ile Phi-3'ü İnce Ayar Yapma](./md/03.FineTuning/FineTuning_Qlora.md)
  - [Azure AI Foundry ile Phi-3'ü İnce Ayar Yapma](./md/03.FineTuning/FineTuning_AIFoundry.md)
  - [Azure ML CLI/SDK ile Phi-3'ü İnce Ayar Yapma](./md/03.FineTuning/FineTuning_MLSDK.md)
  - [Microsoft Olive ile İnce Ayar Yapma](./md/03.FineTuning/FineTuning_MicrosoftOlive.md)
  - [Microsoft Olive ile İnce Ayar Uygulamalı Laboratuvarı](./md/03.FineTuning/olive-lab/readme.md)
  - [Weights and Bias ile Phi-3-vision İnce Ayarı](./md/03.FineTuning/FineTuning_Phi-3-visionWandB.md)
  - [Apple MLX Framework ile Phi-3'ü İnce Ayar Yapma](./md/03.FineTuning/FineTuning_MLX.md)
  - [Phi-3-vision ile İnce Ayar (resmi destek)](./md/03.FineTuning/FineTuning_Vision.md)
  - [Kaito AKS , Azure Containers(official Support) ile Phi-3'ü İnce Ayar Yapma](./md/03.FineTuning/FineTuning_Kaito.md)
  - [Phi-3 ve 3.5 Vision'ı İnce Ayar](https://github.com/2U1/Phi3-Vision-Finetune)

- Uygulamalı Laboratuvar
  - [Çığır açan modelleri keşfetme: LLM'ler, SLM'ler, yerel geliştirme ve daha fazlası](https://github.com/microsoft/aitour-exploring-cutting-edge-models)
...
Microsoft Phi'nin nasıl kullanılacağını ve farklı donanım cihazlarınızda uçtan uca çözümler nasıl inşa edeceğinizi öğrenebilirsiniz. Phi'yi kendiniz deneyimlemek için, modellerle oynayarak ve senaryolarınız için Phi'yi özelleştirerek başlayın. Bunun için [Azure AI Foundry Azure AI Model Catalog](https://aka.ms/phi3-azure-ai) kullanabilirsiniz; hakkında daha fazla bilgiyi [Azure AI Foundry ile Başlarken](/md/02.QuickStart/AzureAIFoundry_QuickStart.md) bölümünde bulabilirsiniz.

**Deneme Alanı**
Her modelin testi için ayrılmış bir deneme alanı vardır: [Azure AI Playground](https://aka.ms/try-phi3).

### Phi on GitHub Models

Microsoft Phi'nin nasıl kullanılacağını ve farklı donanım cihazlarınızda uçtan uca çözümler nasıl inşa edeceğinizi öğrenebilirsiniz. Phi'yi kendiniz deneyimlemek için, modelle oynayarak ve senaryolarınız için Phi'yi özelleştirerek başlayın. Bunun için [GitHub Model Catalog](https://github.com/marketplace/models?WT.mc_id=aiml-137032-kinfeylo) kullanabilirsiniz; hakkında daha fazla bilgiyi [GitHub Model Catalog ile Başlarken](/md/02.QuickStart/GitHubModel_QuickStart.md) bölümünde bulabilirsiniz.

**Deneme Alanı**
Her modelin testi için ayrılmış bir [deneme alanı](/md/02.QuickStart/GitHubModel_QuickStart.md) vardır.
...
Bu örnekte kullanılanlar gibi büyük ölçekli doğal dil, görüntü ve konuşma modelleri haksız, güvenilmez veya saldırgan biçimlerde davranabilir ve dolayısıyla zararlara yol açabilir. Riskler ve sınırlamalar hakkında bilgi sahibi olmak için lütfen [Azure OpenAI service Transparency note](https://learn.microsoft.com/legal/cognitive-services/openai/transparency-note?tabs=text) belgelerine bakın.

Bu riskleri hafifletmenin önerilen yaklaşımı, mimarinizde zararlı davranışı tespit edebilecek ve engelleyebilecek bir güvenlik sistemi eklemektir. [Azure AI Content Safety](https://learn.microsoft.com/azure/ai-services/content-safety/overview) uygulamalarda ve hizmetlerde kullanıcı kaynaklı ve yapay zeka kaynaklı zararlı içeriği tespit edebilen bağımsız bir koruma katmanı sağlar. Azure AI Content Safety, zararlı materyali tespit etmenizi sağlayan metin ve görüntü API'lerini içerir. Azure AI Foundry içinde, Content Safety hizmeti farklı modalitelerde zararlı içeriği tespit etmek için örnek kodları görüntülemenize, keşfetmenize ve denemenize olanak tanır. Aşağıdaki [hızlı başlangıç belgeleri](https://learn.microsoft.com/azure/ai-services/content-safety/quickstart-text?tabs=visual-studio%2Clinux&pivots=programming-language-rest) hizmete nasıl istek yapılacağını adım adım gösterir.

Dikkate alınması gereken bir diğer yön ise genel uygulama performansıdır. Çok modlu ve çok model içeren uygulamalarda, performansın sizin ve kullanıcılarınızın beklentileri doğrultusunda çalışması (zararlı çıktılar üretmemesi de dahil) anlamına geldiğini kabul ederiz. Genel uygulamanızın performansını değerlendirmek için [Performans ve Kalite ve Risk ve Güvenlik değerlendiricileri](https://learn.microsoft.com/azure/ai-studio/concepts/evaluation-metrics-built-in) kullanmanız önemlidir. Ayrıca [özel değerlendiriciler](https://learn.microsoft.com/azure/ai-studio/how-to/develop/evaluate-sdk#custom-evaluators) oluşturup bunlarla değerlendirme yapma olanağına da sahipsiniz.
Geliştirme ortamınızda AI uygulamanızı [Azure AI Evaluation SDK](https://microsoft.github.io/promptflow/index.html) kullanarak değerlendirebilirsiniz. Bir test veri kümesi veya bir hedef verildiğinde, üretken AI uygulamanızın çıktıları yerleşik değerlendiriciler veya seçtiğiniz özel değerlendiricilerle niceliksel olarak ölçülür. Sisteminizi değerlendirmek için Azure AI Evaluation SDK ile başlamak istiyorsanız, [hızlı başlangıç kılavuzunu](https://learn.microsoft.com/azure/ai-studio/how-to/develop/flow-evaluate-sdk) takip edebilirsiniz. Bir değerlendirme çalıştırmasını yürüttüğünüzde, sonuçları [Azure AI Foundry'de görselleştirebilirsiniz](https://learn.microsoft.com/azure/ai-studio/how-to/evaluate-flow-results). 

## Ticari Markalar

Bu proje, projeler, ürünler veya hizmetler için ticari markalar veya logolar içerebilir. Microsoft ticari markalarının veya logolarının yetkili kullanımı, [Microsoft'un Ticari Marka ve Marka Yönergeleri](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general) uyarınca olmalı ve bu kurallara uymalıdır.
Bu projenin değiştirilmiş sürümlerinde Microsoft ticari markalarının veya logolarının kullanımı karışıklığa yol açmamalı veya Microsoft'un sponsoru olduğu izlenimini vermemelidir. Üçüncü taraf ticari markalarının veya logolarının herhangi bir kullanımı, ilgili üçüncü tarafın politikalarına tabidir.
...
Feragatname:
Bu belge, yapay zeka çeviri hizmeti [Co-op Translator](https://github.com/Azure/co-op-translator) kullanılarak çevrilmiştir. Doğruluk için çaba sarf etsek de, otomatik çevirilerin hata veya yanlışlıklar içerebileceğini lütfen unutmayın. Orijinal belge, kendi ana dilindeki sürümü yetkili kaynak olarak kabul edilmelidir. Kritik bilgiler için profesyonel insan çevirisi önerilir. Bu çevirinin kullanımından kaynaklanan herhangi bir yanlış anlama veya yanlış yorumdan sorumlu değiliz.
