...
[![Dev Containers'de Aç](https://img.shields.io/static/v1?style=for-the-badge&label=Dev%20Containers&message=Open&color=blue&logo=visualstudiocode)](https://vscode.dev/redirect?url=vscode://ms-vscode-remote.remote-containers/cloneInVolume?url=https://github.com/microsoft/phicookbook)
...
[![GitHub çekme talepleri](https://img.shields.io/github/issues-pr/microsoft/phicookbook.svg)](https://GitHub.com/microsoft/phicookbook/pulls/?WT.mc_id=aiml-137032-kinfeylo)
[![Katkılar Hoş Geldiniz](https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat-square)](http://makeapullrequest.com?WT.mc_id=aiml-137032-kinfeylo)
...
Phi, Microsoft tarafından geliştirilen açık kaynaklı bir yapay zeka model serisidir.

Phi şu anda çok dilli, akıl yürütme, metin/sohbet üretimi, kodlama, görüntüler, ses ve diğer senaryolarda çok iyi kıyaslamalara sahip en güçlü ve maliyet açısından en etkili küçük dil modelidir (SLM).

Phi'yi buluta veya uç cihazlara dağıtabilir ve sınırlı hesaplama gücü ile kolayca üretken yapay zeka uygulamaları oluşturabilirsiniz.

Bu kaynakları kullanmaya başlamak için şu adımları izleyin:
1. **Depoyu Çatalla**: Tıklayın [![GitHub çatallar](https://img.shields.io/github/forks/microsoft/phicookbook.svg?style=social&label=Fork)](https://GitHub.com/microsoft/phicookbook/network/?WT.mc_id=aiml-137032-kinfeylo)
...
- Giriş
  ...
  - [Phi Modelleri & Platformlara Göre Kullanılabilirlik](./md/01.Introduction/01/01.Edgeandcloud.md)
...
- Phi Ailesi ile çıkarım
    ...
    - [AI Toolkit kullanarak Uzaktan Sunucu Phi çıkarımı](./md/01.Introduction/03/Remote_Interence.md)
...
-  [Phi Ailesi için Ölçekleme](./md/01.Introduction/04/QuantifyingPhi.md)
    - [llama.cpp kullanarak Phi-3.5 / 4 ölçekleme](./md/01.Introduction/04/UsingLlamacppQuantifyingPhi.md)
    - [onnxruntime için Üretken Yapay Zeka eklentileri kullanarak Phi-3.5 / 4 ölçekleme](./md/01.Introduction/04/UsingORTGenAIQuantifyingPhi.md)
    - [Intel OpenVINO kullanarak Phi-3.5 / 4 ölçekleme](./md/01.Introduction/04/UsingIntelOpenVINOQuantifyingPhi.md)
    - [Apple MLX Framework kullanarak Phi-3.5 / 4 ölçekleme](./md/01.Introduction/04/UsingAppleMLXQuantifyingPhi.md)

-  Phi Değerlendirmesi
    - [Yapay Zeka Sorumluluğu](./md/01.Introduction/05/ResponsibleAI.md)
...
- Azure AI Search ile RAG
    - [Phi-4-mini ve Phi-4-multimodal(RAG)'i Azure AI Search ile nasıl kullanılır](https://github.com/microsoft/PhiCookBook/blob/main/code/06.E2E/E2E_Phi-4-RAG-Azure-AI-Search.ipynb)
...
- Phi uygulama geliştirme örnekleri
  - Metin & Sohbet Uygulamaları
    - Phi-4 Örnekleri 🆕
      ...
      - [Sementic Kernel kullanarak Phi-4 ONNX ile .NET Konsol Sohbet Uygulaması](../../md/04.HOL/dotnet/src/LabsPhi4-Chat-02SK)
    - Phi-3 / 3.5 Örnekleri
      ...
      - [Model Optimizasyonu - Olive ile Phi-3-min modelini ONNX Runtime Web için nasıl optimize edilir](https://github.com/microsoft/Olive/tree/main/examples/phi3)
      ...
      - [Microsoft'un Sorumlu AI İlkelerine Odaklanarak Azure AI Foundry'de İnce Ayarlanmış Phi-3 / Phi-3.5 Modelini Değerlendirme](./md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-Evaluation_AIFoundry.md)
      ...
      - [Prompt flow çözümü oluşturmak için Windows GPU kullanımı Phi-3.5-Instruct ONNX ile](./md/02.Application/01.TextAndChat/Phi3/UsingPromptFlowWithONNX.md)
  ...
  - Gelişmiş Akıl Yürütme Örnekleri
    - Phi-4 Örnekleri 🆕
      ...
      - [📓] [Microsoft Olive ile Phi-4-mini-akıl yürütmenin ince ayarı](./md/02.Application/03.AdvancedReasoning/Phi4/AdvancedResoningPhi4mini/olive_ft_phi_4_reasoning_with_medicaldata.ipynb)
      - [📓] [Apple MLX ile Phi-4-mini-akıl yürütmenin ince ayarı](./md/02.Application/03.AdvancedReasoning/Phi4/AdvancedResoningPhi4mini/mlx_ft_phi_4_reasoning_with_medicaldata.ipynb)
  ...
  - Demolar
      - [Hugging Face Spaces'te barındırılan Phi-4-mini demoları](https://huggingface.co/spaces/microsoft/phi-4-mini?WT.mc_id=aiml-137032-kinfeylo)
      - [Hugginge Face Spaces'te barındırılan Phi-4-multimodal demolar](https://huggingface.co/spaces/microsoft/phi-4-multimodal?WT.mc_id=aiml-137032-kinfeylo)
  - Görüntü Örnekleri
    - Phi-4 Örnekleri 🆕
      - [📓] [Phi-4-multimodal kullanarak görüntü okuma ve kod oluşturma](./md/02.Application/04.Vision/Phi4/CreateFrontend/README.md) 
    - Phi-3 / 3.5 Örnekleri
      -  [📓][Phi-3-vision-Görüntü metni çevrimiçi uç noktaya metne dönüştürme](./md/02.Application/04.Vision/Phi3/E2E_Phi-3-vision-image-text-to-text-online-endpoint.ipynb)
      ...
      - [Microsoft.ML.OnnxRuntime .NET kullanarak Menü tabanlı Phi-3 Görsel Yerel ONNX Modeli](../../md/04.HOL/dotnet/src/LabsPhi304)

  - Matematik Örnekleri
    -  Phi-4-Mini-Flash-Akıl Yürütme-Instruct Örnekleri 🆕 [Phi-4-Mini-Flash-Akıl Yürütme-Instruct ile Matematik Demo](./md/02.Application/09.Math/MathDemo.ipynb)
  ...
  - Ses Örnekleri
    - Phi-4 Örnekleri 🆕
      ...
      - [Phi-4-multimodal kullanarak ses dosyasını analiz eden ve döküm oluşturan .NET konsol uygulaması](../../md/04.HOL/dotnet/src/LabsPhi4-MultiModal-02Audio)

  - MOE Örnekleri
    - Phi-3 / 3.5 Örnekleri
      - [📓] [Phi-3.5 Uzman Karışımı Modelleri (MoEs) Sosyal Medya Örneği](./md/02.Application/06.MoE/Phi3/phi3_moe_demo.ipynb)
      - [📓] [NVIDIA NIM Phi-3 MOE, Azure AI Search ve LlamaIndex ile Bir Retrieval-Augmented Generation (RAG) Boru Hattı Oluşturma](./md/02.Application/06.MoE/Phi3/azure-ai-search-nvidia-rag.ipynb)
      - 
  - Fonksiyon Çağırma Örnekleri
    - Phi-4 Örnekleri 🆕
      ...
      -  [📓] [Fonksiyon Çağırma kullanarak Phi-4-mini ile çoklu ajanlar oluşturma](./md/02.Application/07.FunctionCalling/Phi4/Multiagents/Phi_4_mini_multiagent.ipynb)
  ...
  - Çok Modlu Karıştırma Örnekleri
    - Phi-4 Örnekleri 🆕
      ...
      - [.NET konsol uygulaması Phi-4-multimodal kullanarak görüntüleri analiz etme](../../md/04.HOL/dotnet/src/LabsPhi4-MultiModal-01Images)
...
- Phi İnce Ayar Örnekleri
  ...
  - [Phi-3'ün endüstri uzmanı olmasını sağlama](./md/03.FineTuning/LetPhi3gotoIndustriy.md)
  - [AI Toolkit for VS Code ile Phi-3'ün ince ayarı](./md/03.FineTuning/Finetuning_VSCodeaitoolkit.md)
  - [Azure Machine Learning Service ile Phi-3'ün ince ayarı](./md/03.FineTuning/Introduce_AzureML.md)
  - [Lora ile Phi-3'ün ince ayarı](./md/03.FineTuning/FineTuning_Lora.md)
  - [QLora ile Phi-3'ün ince ayarı](./md/03.FineTuning/FineTuning_Qlora.md)
  - [Azure AI Foundry ile Phi-3'ün ince ayarı](./md/03.FineTuning/FineTuning_AIFoundry.md)
  - [Azure ML CLI/SDK ile Phi-3'ün ince ayarı](./md/03.FineTuning/FineTuning_MLSDK.md)
  ...
  - [Weights and Bias kullanarak Phi-3-vision'in ince ayarı](./md/03.FineTuning/FineTuning_Phi-3-visionWandB.md)
  - [Apple MLX Framework ile Phi-3'ün ince ayarı](./md/03.FineTuning/FineTuning_MLX.md)
  - [Phi-3-vision'in ince ayarı (resmi destek)](./md/03.FineTuning/FineTuning_Vision.md)
  - [Kaito AKS , Azure Containers ile Phi-3'ün ince ayarı (resmi Destek)](./md/03.FineTuning/FineTuning_Kaito.md)
  - [Phi-3 ve 3.5 Vision İnce Ayarı](https://github.com/2U1/Phi3-Vision-Finetune)

- Uygulamalı Laboratuvar
  - [En son modellerin keşfi: LLM'ler, SLM'ler, yerel geliştirme ve daha fazlası](https://github.com/microsoft/aitour-exploring-cutting-edge-models)
...
- Akademik Araştırma Makaleleri ve Yayınlar
  - [Sadece Ders Kitapları Yeter II: phi-1.5 teknik raporu](https://arxiv.org/abs/2309.05463)
  ...
  - [Phi-4-Mini Teknik Raporu: LoRA Karışımı ile Kompakt Ama Güçlü Çok Modlu Dil Modelleri](https://arxiv.org/abs/2503.01743)
  - [Araç İçi Fonksiyon Çağrısı İçin Küçük Dil Modellerinin Optimize Edilmesi](https://arxiv.org/abs/2501.02342)
  - [(WhyPHI) PHI-3’ün Çoktan Seçmeli Soru Yanıtlama İçin İncelenmesi: Yöntem, Sonuçlar ve Zorluklar](https://arxiv.org/abs/2501.01588)
...
Microsoft Phi’yi nasıl kullanacağınızı ve farklı donanım cihazlarınızda uçtan uca çözümler nasıl oluşturacağınızı öğrenebilirsiniz. Phi’yi kendiniz deneyimlemek için, modellerle oynamaya ve senaryolarınız için Phi’yi özelleştirmeye [Azure AI Foundry Azure AI Model Kataloğu](https://aka.ms/phi3-azure-ai) üzerinden başlayabilir, daha fazlasını [Azure AI Foundry ile Başlarken](/md/02.QuickStart/AzureAIFoundry_QuickStart.md) bölümünden öğrenebilirsiniz.

**Oyun Alanı**
Her modelin testi için ayrılmış özel bir oyun alanı vardır [Azure AI Playground](https://aka.ms/try-phi3).

### GitHub Modellerinde Phi

Microsoft Phi’yi nasıl kullanacağınızı ve farklı donanım cihazlarınızda uçtan uca çözümler nasıl oluşturacağınızı öğrenebilirsiniz. Phi’yi kendiniz deneyimlemek için, modelle oynamaya ve senaryolarınız için Phi’yi özelleştirmeye [GitHub Model Kataloğu](https://github.com/marketplace/models?WT.mc_id=aiml-137032-kinfeylo) üzerinden başlayabilir, daha fazlasını [GitHub Model Kataloğu ile Başlarken](/md/02.QuickStart/GitHubModel_QuickStart.md) bölümünden öğrenebilirsiniz.

**Oyun Alanı**
Her modelin testi için ayrılmış [oyun alanı](/md/02.QuickStart/GitHubModel_QuickStart.md) vardır.
...
Ekibimiz başka kurslar da üretiyor! Bakınız:
...
[![Yeni Başlayanlar İçin AI Ajanları](https://img.shields.io/badge/AI%20Agents%20for%20Beginners-00C49A?style=for-the-badge&labelColor=E5E7EB&color=00C49A)](https://github.com/microsoft/ai-agents-for-beginners?WT.mc_id=academic-105485-koreyst)
...
### Temel Öğrenme
[![Yeni Başlayanlar İçin ML](https://img.shields.io/badge/ML%20for%20Beginners-22C55E?style=for-the-badge&labelColor=E5E7EB&color=22C55E)](https://aka.ms/ml-beginners?WT.mc_id=academic-105485-koreyst)
[![Yeni Başlayanlar İçin Veri Bilimi](https://img.shields.io/badge/Data%20Science%20for%20Beginners-84CC16?style=for-the-badge&labelColor=E5E7EB&color=84CC16)](https://aka.ms/datascience-beginners?WT.mc_id=academic-105485-koreyst)
[![Yeni Başlayanlar İçin AI](https://img.shields.io/badge/AI%20for%20Beginners-A3E635?style=for-the-badge&labelColor=E5E7EB&color=A3E635)](https://aka.ms/ai-beginners?WT.mc_id=academic-105485-koreyst)
...
### Copilot Serisi
[![Yapay Zeka Eşleştirmeli Programlama için Copilot](https://img.shields.io/badge/Copilot%20for%20AI%20Paired%20Programming-FACC15?style=for-the-badge&labelColor=E5E7EB&color=FACC15)](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)
...
Microsoft, müşterilerimizin yapay zeka ürünlerimizi sorumlu bir şekilde kullanmalarını desteklemeye, deneyimlerimizi paylaşmaya ve Şeffaflık Notları ve Etki Değerlendirmeleri gibi araçlar aracılığıyla güven temelli ortaklıklar kurmaya kararlıdır. Bu kaynakların çoğuna [https://aka.ms/RAI](https://aka.ms/RAI) adresinden ulaşılabilir.  
Microsoft’un sorumlu yapay zeka yaklaşımı, adalet, güvenilirlik ve güvenlik, gizlilik ve güvenlik, kapsayıcılık, şeffaflık ve hesap verebilirlik gibi yapay zeka ilkeleri üzerine dayanmaktadır.

Büyük ölçekli doğal dil, görüntü ve ses modelleri — bu örnekte kullanılanlar gibi — adaletsiz, güvenilmez veya saldırgan davranışlar sergileyebilir ve dolayısıyla zarara yol açabilir. Riskler ve sınırlar hakkında bilgi edinmek için lütfen [Azure OpenAI hizmeti Şeffaflık notu](https://learn.microsoft.com/legal/cognitive-services/openai/transparency-note?tabs=text) sayfasını inceleyin.

Bu riskleri azaltmak için önerilen yaklaşım, mimarinizde zararlı davranışları tespit eden ve engelleyen bir güvenlik sistemi bulundurmaktır. [Azure AI İçerik Güvenliği](https://learn.microsoft.com/azure/ai-services/content-safety/overview), uygulamalarda ve hizmetlerde kullanıcı veya yapay zeka tarafından oluşturulan zararlı içeriği tespit edebilen bağımsız bir koruma katmanı sağlar. Azure AI İçerik Güvenliği; zararlı materyalleri tespit etmek için metin ve görsel API’leri içerir. Azure AI Foundry içinde ise İçerik Güvenliği servisi, farklı modalitelerde zararlı içeriği tespit etmeye yönelik örnek kodları görüntülemenize, keşfetmenize ve denemenize olanak tanır. Aşağıdaki [hızlı başlangıç dokümantasyonu](https://learn.microsoft.com/azure/ai-services/content-safety/quickstart-text?tabs=visual-studio%2Clinux&pivots=programming-language-rest), servise istek yapmayı adım adım anlatır.

Dikkate alınması gereken bir diğer konu ise genel uygulama performansıdır. Çok modlu ve çok modellili uygulamalarda performans, sistemin sizin ve kullanıcılarınızın beklentilerini karşılaması yani zararlı çıktı üretmemesi anlamına gelir. Genel uygulamanızın performansını değerlendirmek için [Performans ve Kalite ile Risk ve Güvenlik değerlendirme araçlarını](https://learn.microsoft.com/azure/ai-studio/concepts/evaluation-metrics-built-in) kullanmanız önemlidir. Ayrıca [özel değerlendirme araçları](https://learn.microsoft.com/azure/ai-studio/how-to/develop/evaluate-sdk#custom-evaluators) oluşturup bunlarla değerlendirme yapabilirsiniz.
AI uygulamanızı geliştirme ortamınızda [Azure AI Evaluation SDK](https://microsoft.github.io/promptflow/index.html) kullanarak değerlendirebilirsiniz. Bir test veri seti veya hedef verildiğinde, üretken AI uygulama çıktılarınız yerleşik değerlendiricilerle veya tercih ettiğiniz özel değerlendiricilerle nicel olarak ölçülür. Sisteminizin değerlendirilmesine başlamak için azure ai evaluation sdk ile [hızlı başlangıç rehberini](https://learn.microsoft.com/azure/ai-studio/how-to/develop/flow-evaluate-sdk) takip edebilirsiniz. Bir değerlendirme çalıştırması gerçekleştirdikten sonra, sonuçları [Azure AI Foundry’de görselleştirebilirsiniz](https://learn.microsoft.com/azure/ai-studio/how-to/evaluate-flow-results).

## Ticari Markalar

Bu proje, projeler, ürünler veya hizmetler için ticari markalar veya logolar içerebilir. Microsoft ticari markalarının veya logolarının yetkili kullanımı [Microsoft'un Ticari Marka ve Marka Rehberlerine](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general) tabidir ve bu kurallara uyulmalıdır. Bu projenin değiştirilmiş sürümlerinde Microsoft ticari markalarının veya logolarının kullanımı karışıklığa yol açmamalı veya Microsoft sponsorluğunu ima etmemelidir. Üçüncü taraf ticari markalarının veya logolarının kullanımı ilgili üçüncü tarafların politikalarına tabidir.

## Yardım Alma

Tıkandığınızda veya AI uygulamaları oluşturma ile ilgili herhangi bir sorunuz olduğunda, katılın:
