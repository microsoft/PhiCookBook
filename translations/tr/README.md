...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-09T18:22:39+00:00",
  "source_file": "README.md",
  "language_code": "tr"
}
-->
# Phi Tarif Kitabı: Microsoft’un Phi Modelleri ile Uygulamalı Örnekler
...
Phi, şu anda çok dilli, muhakeme, metin/sohbet üretimi, kodlama, görseller, ses ve diğer senaryolarda çok iyi performans gösteren en güçlü ve maliyet açısından en uygun küçük dil modeli (SLM) konumundadır.
...
-  [Phi Ailesinin Kantifikasyonu](./md/01.Introduction/04/QuantifyingPhi.md)  
    ...
    - [onnxruntime için Üretken AI eklentileri kullanarak Phi-3.5 / 4’ü Kantifikasyon](./md/01.Introduction/04/UsingORTGenAIQuantifyingPhi.md)  
...
- Matematik Örnekleri  
  - Phi-4-Mini-Flash-Akıl Yürütme-Yönergeli Örnekler 🆕 [Phi-4-Mini-Flash-Akıl Yürütme ile Matematik Demo](../../md/02.Application/09.Math/MathDemo.ipynb)
...
- Phi İnce Ayar Örnekleri  
  ...
  - [Phi-3’ü bir sektör uzmanı haline getirmek için ince ayar](./md/03.FineTuning/LetPhi3gotoIndustriy.md)  
  ...
  - [Microsoft Olive ile uygulamalı ince ayar laboratuvarı](./md/03.FineTuning/olive-lab/readme.md)  
  ...
  - [Phi-3 ve 3.5 Görsel ince ayarı](https://github.com/2U1/Phi3-Vision-Finetune)
