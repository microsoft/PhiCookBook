...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-11T10:56:11+00:00",
...
- Phi Ailesi Çıkarımı
    ...
    - [AI Toolkit ile Uzaktan Sunucuda Phi Çıkarımı](./md/01.Introduction/03/Remote_Interence.md)
...
- [Phi Ailesini Kuantize Etme](./md/01.Introduction/04/QuantifyingPhi.md)
    ...
    - [Phi-3.5 / 4'ü onnxruntime için üretken AI uzantıları kullanarak kuantize etme](./md/01.Introduction/04/UsingORTGenAIQuantifyingPhi.md)
...
- Phi uygulama geliştirme örnekleri
  - Metin ve Sohbet Uygulamaları
    - Phi-4 Örnekleri 🆕
      ...
      - [Phi-4 ONNX ile Sementik Kernel kullanarak .NET Konsol Uygulaması Sohbeti](../../md/04.HOL/dotnet/src/LabsPhi4-Chat-02SK)
    - Phi-3 / 3.5 Örnekleri
...
- [WinUI3 Phi-3 mini-4k-instruct-onnx uygulaması](https://github.com/microsoft/Phi3-Chat-WinUI3-Sample/)
...
- [Phi-3 modellerini Azure AI Foundry'de Prompt flow ile özelleştirme ve entegre etme](./md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-FineTuning_PromptFlow_Integration_AIFoundry.md)
...
- Azure AI Inference SDK Kod Tabanlı Örnekler  
  ...
  - Phi-3 / 3.5 Örnekleri  
    - [Microsoft Phi-3 ailesi ile kendi Visual Studio Code GitHub Copilot Chat'inizi oluşturun](./md/02.Application/02.Code/Phi3/VSCodeExt/README.md)  
    - [Phi-3.5 ve GitHub modelleri ile kendi Visual Studio Code Chat Copilot Agent'inizi oluşturun](/md/02.Application/02.Code/Phi3/CreateVSCodeChatAgentWithGitHubModels.md)  
...
- Phi Örneklerini Özelleştirme  
  ...
  - [Phi-3'ü sektör uzmanı yapma](./md/03.FineTuning/LetPhi3gotoIndustriy.md)  
  ...
  - [Microsoft Olive Hands-On Lab ile özelleştirme](./md/03.FineTuning/olive-lab/readme.md)  
...
- Uygulamalı Laboratuvar  
  ...
  - [NLP Potansiyelini Açığa Çıkarmak: Microsoft Olive ile Özelleştirme](https://github.com/azure/Ignite_FineTuning_workshop)  
...
- Akademik Araştırma Makaleleri ve Yayınlar  
  ...
  - [Phi-4-Mini Teknik Raporu: Mixture-of-LoRAs ile Kompakt ve Güçlü Multimodal Dil Modelleri](https://arxiv.org/abs/2503.01743)  
...
Microsoft Phi'yi nasıl kullanacağınızı ve farklı donanım cihazlarınızda uçtan uca çözümler oluşturmayı öğrenebilirsiniz. Phi'yi kendiniz deneyimlemek için modelle oynayarak ve Phi'yi senaryolarınıza göre özelleştirerek başlayabilirsiniz. [GitHub Model Catalog](https://github.com/marketplace/models?WT.mc_id=aiml-137032-kinfeylo) üzerinden daha fazla bilgi edinebilirsiniz. Başlangıç için [GitHub Model Catalog](/md/02.QuickStart/GitHubModel_QuickStart.md) rehberine göz atabilirsiniz.
...
Microsoft, müşterilerimizin AI ürünlerimizi sorumlu bir şekilde kullanmalarına yardımcı olmaya, öğrendiklerimizi paylaşmaya ve Şeffaflık Notları ve Etki Değerlendirmeleri gibi araçlar aracılığıyla güvene dayalı ortaklıklar kurmaya kararlıdır. Bu kaynakların birçoğunu [https://aka.ms/RAI](https://aka.ms/RAI) adresinde bulabilirsiniz. Microsoft’un sorumlu AI yaklaşımı, adalet, güvenilirlik ve güvenlik, gizlilik ve güvenlik, kapsayıcılık, şeffaflık ve hesap verebilirlik gibi AI ilkelerine dayanmaktadır.

Bu örnekte kullanılanlar gibi büyük ölçekli doğal dil, görüntü ve konuşma modelleri, potansiyel olarak adaletsiz, güvenilmez veya saldırgan davranışlar sergileyebilir ve bu da zararlara yol açabilir. Riskler ve sınırlamalar hakkında bilgi sahibi olmak için lütfen [Azure OpenAI hizmeti Şeffaflık Notu](https://learn.microsoft.com/legal/cognitive-services/openai/transparency-note?tabs=text) belgesine danışın.

Bu riskleri azaltmanın önerilen yaklaşımı, zararlı davranışları tespit edebilen ve önleyebilen bir güvenlik sistemi mimarinize dahil etmektir. [Azure AI İçerik Güvenliği](https://learn.microsoft.com/azure/ai-services/content-safety/overview), uygulamalarda ve hizmetlerde kullanıcı tarafından oluşturulan ve AI tarafından oluşturulan zararlı içerikleri tespit edebilen bağımsız bir koruma katmanı sağlar. Azure AI İçerik Güvenliği, zararlı materyalleri tespit etmenize olanak tanıyan metin ve görüntü API'lerini içerir. Azure AI Foundry içinde, İçerik Güvenliği hizmeti, farklı modlarda zararlı içerikleri tespit etmek için örnek kodları görüntülemenize, keşfetmenize ve denemenize olanak tanır. Hizmete istek göndermeyi öğrenmek için [hızlı başlangıç belgeleri](https://learn.microsoft.com/azure/ai-services/content-safety/quickstart-text?tabs=visual-studio%2Clinux&pivots=programming-language-rest) rehberine göz atabilirsiniz.
