# Microsoft Foundry'de Microsoft'un Sorumlu AI İlkelerine Odaklanarak İnce Ayarlı Phi-3 / Phi-3.5 Modelini Değerlendirme
...
### Microsoft Foundry'de ince ayarlı Phi-3 / Phi-3.5 modelinin güvenlik ve performansını nasıl değerlendirebilirsiniz?

Bir modeli ince ayarlamak bazen istenmeyen veya beklenmedik yanıtlar üretebilir. Modelin güvenli ve etkili kalmasını sağlamak için, modelin zararlı içerik üretme potansiyelini ve doğru, ilgili ve tutarlı yanıtlar verme yeteneğini değerlendirmek önemlidir. Bu eğitimde, Microsoft Foundry'de Prompt flow ile entegre edilmiş ince ayarlı Phi-3 / Phi-3.5 modelinin güvenlik ve performansını nasıl değerlendireceğinizi öğreneceksiniz.
...
1. [**Senaryo 1: Microsoft Foundry'nin Prompt flow değerlendirmesine giriş**](../../../../../../md/02.Application/01.TextAndChat/Phi3)
...
1. [**Senaryo 2: Microsoft Foundry'de Phi-3 / Phi-3.5 modelini değerlendirme**](../../../../../../md/02.Application/01.TextAndChat/Phi3)
    ...
    - [Microsoft Foundry'nin Prompt flow değerlendirmesi ile ince ayarlı Phi-3 / Phi-3.5 modelini değerlendirme](../../../../../../md/02.Application/01.TextAndChat/Phi3)
...
Bu eğitimde, Microsoft Foundry'nin güvenlik metriklerini kullanarak ince ayarlı Phi-3 modelinin güvenliğini değerlendireceksiniz. Bu metrikler, modelin zararlı içerik üretme potansiyelini ve jailbreak saldırılarına karşı savunmasızlığını ölçmenize yardımcı olur. Güvenlik metrikleri şunlardır:
...
AI modelinizin beklendiği gibi çalıştığından emin olmak için, performans metriklerine göre değerlendirilmesi önemlidir. Microsoft Foundry'de performans değerlendirmeleri, modelinizin doğru, ilgili ve tutarlı yanıtlar üretme etkinliğini ölçmenize olanak tanır.
...
Bu eğitimde, Microsoft Foundry'nin performans metriklerini kullanarak ince ayarlı Phi-3 / Phi-3.5 modelinin performansını değerlendireceksiniz. Bu metrikler, modelin doğru, ilgili ve tutarlı yanıtlar üretme etkinliğini ölçmenize yardımcı olur. Performans metrikleri şunlardır:
...
## **Senaryo 2: Microsoft Foundry'de Phi-3 / Phi-3.5 modelini değerlendirme**

### Başlamadan önce

Bu eğitim, önceki blog yazıları "[Fine-Tune and Integrate Custom Phi-3 Models with Prompt Flow: Step-by-Step Guide](https://techcommunity.microsoft.com/t5/educator-developer-blog/fine-tune-and-integrate-custom-phi-3-models-with-prompt-flow/ba-p/4178612?wt.mc_id=studentamb_279723)" ve "[Fine-Tune and Integrate Custom Phi-3 Models with Prompt Flow in Microsoft Foundry](https://techcommunity.microsoft.com/t5/educator-developer-blog/fine-tune-and-integrate-custom-phi-3-models-with-prompt-flow-in/ba-p/4191726?wt.mc_id=studentamb_279723)" yazılarının devamıdır. Bu yazılarda, Microsoft Foundry'de Phi-3 / Phi-3.5 modelinin ince ayar süreci ve Prompt flow ile entegrasyonu anlatılmıştır.

Bu eğitimde, Microsoft Foundry'de bir değerlendirici olarak Azure OpenAI modelini dağıtacak ve ince ayarlı Phi-3 / Phi-3.5 modelinizi değerlendirmek için kullanacaksınız.
...
1. Microsoft Foundry'de ince ayarlı Phi-3 / Phi-3.5 modelinizle entegre edilmiş bir Prompt flow.
...
#### Microsoft Foundry'de Prompt flow ile özel Phi-3 / Phi-3.5 modelini entegre etme (Öncelikle kod yaklaşımı)
> [!NOTE]  
...
İlerlemeniz için, ince ayar yapılmış Phi-3 / Phi-3.5 modelinizi Microsoft Foundry'deki Prompt flow’a entegre etmeniz gerekiyor.

#### Microsoft Foundry Hub Oluşturma
...
Microsoft Foundry’da özel bir bağlantı eklediniz. Şimdi aşağıdaki adımları izleyerek bir Prompt flow oluşturacağız. Daha sonra bu Prompt flow’u özel bağlantıya bağlayarak ince ayar yapılmış modeli Prompt flow içinde kullanacaksınız.
...
> [!NOTE]
> Microsoft Foundry’de Prompt flow kullanımı hakkında daha detaylı bilgi için [Prompt flow in Microsoft Foundry](https://learn.microsoft.com/azure/ai-studio/how-to/prompt-flow) sayfasına bakabilirsiniz.
...
Phi-3 / Phi-3.5 modelini Microsoft Foundry’de değerlendirmek için bir Azure OpenAI modeli dağıtmanız gerekir. Bu model, Phi-3 / Phi-3.5 modelinin performansını değerlendirmek için kullanılacaktır.
...
### Microsoft Foundry’nin Prompt flow değerlendirmesi ile ince ayar yapılmış Phi-3 / Phi-3.5 modelini değerlendirme
...
- [Microsoft Foundry dokümantasyonu](https://learn.microsoft.com/azure/ai-studio/?wt.mc_id=studentamb_279723)
