...
Kullanmadan önce aşağıdaki Python kütüphanelerinin yüklü olduğundan emin olun (Python 3.10+ önerilir)
...
***CUDA 11.6+*** kullanılması ve flatten kurulması tavsiye edilir
...
## **3. Birden Fazla Görüntünün Karşılaştırılması**

Phi-3 Vision, birden fazla görüntünün karşılaştırılmasını destekler. Bu modeli kullanarak görüntüler arasındaki farkları bulabiliriz.
