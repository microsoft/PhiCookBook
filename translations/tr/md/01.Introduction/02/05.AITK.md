...
[AI Toolkit for VS Code](https://marketplace.visualstudio.com/items?itemName=ms-windows-ai-studio.windows-ai-studio), Microsoft Foundry Kataloğu ve Hugging Face gibi diğer kataloglardan en son AI geliştirme araçları ve modellerini bir araya getirerek üretken AI uygulama geliştirmeyi kolaylaştırır. GitHub Modelleri ve Microsoft Foundry Model Katalogları tarafından desteklenen AI modelleri kataloğunu gezebilir, modelleri yerel veya uzak olarak indirip, ince ayar yapabilir, test edebilir ve uygulamanızda kullanabilirsiniz.
