...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2026-01-05T15:36:08+00:00",
  "source_file": "README.md",
  "language_code": "sl"
}
-->
# Kuharica Phi: Primeri za prakso z Microsoftovimi modeli Phi
...
Phi je trenutno najbolj zmogljiv in stroškovno učinkovit mali jezikovni model (SLM), z zelo dobrimi rezultati v več jezikih, sklepanju, generiranju besedil/pogovorov, kodiranju, slikah, zvoku in drugih scenarijih. 

Phi lahko namestite v oblak ali na robne naprave, in z omejeno računalniško močjo zlahka ustvarite generativne AI aplikacije.

Sledite tem korakom, da začnete uporabljati te vire:
1. **Razvejajte repozitorij**: Kliknite [![GitHub vilice](https://img.shields.io/github/forks/microsoft/phicookbook.svg?style=social&label=Fork)](https://GitHub.com/microsoft/phicookbook/network/?WT.mc_id=aiml-137032-kinfeylo)
...
#### Podprto s pomočjo GitHub akcije (avtomatsko & vedno posodobljeno)
...
> Ta repozitorij vsebuje več kot 50 jezikovnih prevodov, kar znatno poveča velikost prenosa. Če želite klonirati brez prevodov, uporabite redčen checkout:
> ```bash
...
- Uvod
  ...
  - [Modeli Phi & razpoložljivost na različnih platformah](./md/01.Introduction/01/01.Edgeandcloud.md)
...
- Inferenca Phi v različnih okoljih
    ...
    -  [Modeli na GitHub](./md/01.Introduction/02/02.GitHubModel.md)
...
- Inferenca Phi Family
    ...
    - [Inferenca Phi z Apple MLX okvirom](./md/01.Introduction/03/MLX_Inference.md)
    - [Inferenca Phi na lokalnem strežniku](./md/01.Introduction/03/Local_Server_Inference.md)
    - [Inferenca Phi na oddaljenem strežniku z AI Toolkitom](./md/01.Introduction/03/Remote_Interence.md)
...
-  [Kvantisanje Phi Family](./md/01.Introduction/04/QuantifyingPhi.md)
    - [Kvantisanje Phi-3.5 / 4 z llama.cpp](./md/01.Introduction/04/UsingLlamacppQuantifyingPhi.md)
    - [Kvantisanje Phi-3.5 / 4 z razširitvami generativne AI za onnxruntime](./md/01.Introduction/04/UsingORTGenAIQuantifyingPhi.md)
    - [Kvantisanje Phi-3.5 / 4 z Intel OpenVINO](./md/01.Introduction/04/UsingIntelOpenVINOQuantifyingPhi.md)
    - [Kvantisanje Phi-3.5 / 4 z Apple MLX okvirom](./md/01.Introduction/04/UsingAppleMLXQuantifyingPhi.md)

-  Ocena Phi
    - [Odgovorna AI](./md/01.Introduction/05/ResponsibleAI.md)
    - [Azure AI Foundry za ocenjevanje](./md/01.Introduction/05/AIFoundry.md)
    - [Uporaba Promptflow za ocenjevanje](./md/01.Introduction/05/Promptflow.md)
...
- Primeri razvoja Phi aplikacij
  - Besedilo in klepetalni programi
    - Primeri Phi-4 🆕
    ...
    - Primeri Phi-3 / 3.5
      - [Lokalni klepetalni robot v brskalniku z Phi3, ONNX Runtime Web in WebGPU](https://github.com/microsoft/onnxruntime-inference-examples/tree/main/js/chat)
      ...
      -[Vzorec aplikacije WinUI3 z več modeli in podporo AI](https://github.com/microsoft/ai-powered-notes-winui3-sample)
      - [Fino nastavljanje in integracija prilagojenih modelov Phi-3 s Prompt flow](./md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-FineTuning_PromptFlow_Integration.md)
      - [Fino nastavljanje in integracija prilagojenih modelov Phi-3 s Prompt flow v Azure AI Foundry](./md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-FineTuning_PromptFlow_Integration_AIFoundry.md)
      - [Ocenjevanje fino nastavljenega modela Phi-3 / Phi-3.5 v Azure AI Foundry s poudarkom na Microsoftovih načelih odgovorne AI](./md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-Evaluation_AIFoundry.md)
      ...
      - [Primer Q&A .NET z uporabo lokalnega ONNX modela Phi-3 in Microsoft.ML.OnnxRuntime](../../md/04.HOL/dotnet/src/LabsPhi301)
      - [Konzolna .NET aplikacija za klepet z Semantic Kernel in Phi-3](../../md/04.HOL/dotnet/src/LabsPhi302)

  - Azure AI Inference SDK vzorci, ki temeljijo na kodi
    - Vzorci Phi-4 🆕
      - [📓] [Generiranje kode projektov z uporabo Phi-4-multimodal](./md/02.Application/02.Code/Phi4/GenProjectCode/README.md)
    - Vzorci Phi-3 / 3.5
      ...
      - [Ustvarite svojega Visual Studio Code Chat Copilot agenta z Phi-3.5 po modelih GitHub](/md/02.Application/02.Code/Phi3/CreateVSCodeChatAgentWithGitHubModels.md)

  - Vzorci za napredno sklepanje
    - Vzorci Phi-4 🆕
      ...
      - [📓] [Fino nastavljanje Phi-4-mini-reasoning z Microsoft Olive](./md/02.Application/03.AdvancedReasoning/Phi4/AdvancedResoningPhi4mini/olive_ft_phi_4_reasoning_with_medicaldata.ipynb)
      - [📓] [Fino nastavljanje Phi-4-mini-reasoning z Apple MLX](./md/02.Application/03.AdvancedReasoning/Phi4/AdvancedResoningPhi4mini/mlx_ft_phi_4_reasoning_with_medicaldata.ipynb)
  ...
  - Demo prikazi
      - [Phi-4-mini demo ogledi na Hugging Face Spaces](https://huggingface.co/spaces/microsoft/phi-4-mini?WT.mc_id=aiml-137032-kinfeylo)
      - [Phi-4-multimodal demo prikazi na Hugginge Face Spaces](https://huggingface.co/spaces/microsoft/phi-4-multimodal?WT.mc_id=aiml-137032-kinfeylo)
  - Vzorci vizije
    - Vzorci Phi-4 🆕
    ...
    - Vzorci Phi-3 / 3.5
      ...
      - [Meni temelječ Phi-3 Vision lokalni ONNX model z Microsoft.ML.OnnxRuntime .NET](../../md/04.HOL/dotnet/src/LabsPhi304)
  ...
  - Vzorci zvoka
    - Vzorci Phi-4 🆕
      - [📓] [Izvlečki avdio prepisk s Phi-4-multimodal](./md/02.Application/05.Audio/Phi4/Transciption/README.md)
      - [📓] [Vzorec zvoka Phi-4-multimodal](./md/02.Application/05.Audio/Phi4/Siri/demo.ipynb)
      - [📓] [Vzorec prevajanja govora Phi-4-multimodal](./md/02.Application/05.Audio/Phi4/Translate/demo.ipynb)
      - [.NET konzolna aplikacija, ki uporablja Phi-4-multimodal zvok za analizo zvočne datoteke in generiranje prepisa](../../md/04.HOL/dotnet/src/LabsPhi4-MultiModal-02Audio)

  - Vzorci ME (mišljenje ekspertov)
    - Vzorci Phi-3 / 3.5
      - [📓] [Phi-3.5 model mešanice strokovnjakov (MoEs) vzorec za družbena omrežja](./md/02.Application/06.MoE/Phi3/phi3_moe_demo.ipynb)
      - [📓] [Gradnja sekvence za iskanje z obogatitvijo generiranja (RAG) z NVIDIA NIM Phi-3 MOE, Azure AI Search in LlamaIndex](./md/02.Application/06.MoE/Phi3/azure-ai-search-nvidia-rag.ipynb)
      - 
...
- Fino nastavljanje vzorcev Phi
  - [Scenariji fino nastavitev](./md/03.FineTuning/FineTuning_Scenarios.md)
  - [Fino nastavljanje proti RAG](./md/03.FineTuning/FineTuning_vs_RAG.md)
  - [Fino nastavljanje, da Phi-3 postane industrijski strokovnjak](./md/03.FineTuning/LetPhi3gotoIndustriy.md)
  - [Fino nastavljanje Phi-3 z AI orodjarno za VS Code](./md/03.FineTuning/Finetuning_VSCodeaitoolkit.md)
...
- Praktična delavnica
  - [Raziščite najsodobnejše modele: LLM, SLM, lokalni razvoj in še več](https://github.com/microsoft/aitour-exploring-cutting-edge-models)
  - [Odkritje potenciala NLP: Fino nastavljanje z Microsoft Olive](https://github.com/azure/Ignite_FineTuning_workshop)
...
- Akademski raziskovalni članki in publikacije
  ...
  - [Phi-4-Mini tehnično poročilo: kompaktni a močni multimodalni jezikovni modeli prek mešanice LoRA](https://arxiv.org/abs/2503.01743)
...
Lahko se naučite, kako uporabljati Microsoft Phi in kako zgraditi E2E rešitve na različnih strojnih napravah. Če želite Phi preizkusiti sami, začnite z igranjem z modeli in prilagajanjem Phi za vaše scenarije z uporabo [Azure AI Foundry Azure AI Model Catalog](https://aka.ms/phi3-azure-ai). Več o tem lahko izveste v priročniku Začetek dela z [Azure AI Foundry](/md/02.QuickStart/AzureAIFoundry_QuickStart.md)

**Igralnica**  
Vsak model ima svojo namensko igralnico za testiranje modela [Azure AI Playground](https://aka.ms/try-phi3).

### Phi na GitHub modelih

Lahko se naučite, kako uporabljati Microsoft Phi in kako zgraditi E2E rešitve na različnih strojnih napravah. Če želite Phi preizkusiti sami, začnite z igranjem z modelom in prilagajanjem Phi za vaše scenarije z uporabo [GitHub Model Catalog](https://github.com/marketplace/models?WT.mc_id=aiml-137032-kinfeylo). Več o tem lahko izveste v priročniku Začetek dela z [GitHub Model Catalog](/md/02.QuickStart/GitHubModel_QuickStart.md)
...
Microsoft si prizadeva pomagati svojim strankam pri odgovorni uporabi naših AI produktov, deliti naše izkušnje in graditi partnerstva na zaupanju s pomočjo orodij, kot so Transparency Notes in Impact Assessments. Številni od teh virov so na voljo na [https://aka.ms/RAI](https://aka.ms/RAI).  
Microsoftov pristop k odgovorni AI temelji na naših AI načelih pravičnosti, zanesljivosti in varnosti, zasebnosti in varstvu, vključevanju, preglednosti ter odgovornosti.

Veliki naravni jezikovni, slikovni in govorni modeli - kot tisti, uporabljeni v tem vzorcu - se lahko potencialno obnašajo na načine, ki so nepravični, nezanesljivi ali žaljivi, kar lahko povzroči škodo. Za informacije o tveganjih in omejitvah si oglejte [opombo o preglednosti storitve Azure OpenAI](https://learn.microsoft.com/legal/cognitive-services/openai/transparency-note?tabs=text).

Priporočeni pristop k zmanjšanju teh tveganj je vključitev varnostnega sistema v vašo arhitekturo, ki lahko zazna in prepreči škodljivo vedenje. [Azure AI Content Safety](https://learn.microsoft.com/azure/ai-services/content-safety/overview) zagotavlja neodvisno zaščitno plast, sposobno zaznati škodljivo uporabniško in AI-generirano vsebino v aplikacijah in storitvah. Azure AI Content Safety vključuje API-je za besedilo in slike, ki omogočajo zaznavanje škodljive vsebine. Znotraj Azure AI Foundry vam storitev Content Safety omogoča ogled, raziskovanje in preizkušanje vzorčne kode za zaznavo škodljive vsebine v različnih modalitetah. Naslednja [hitri začetni dokument](https://learn.microsoft.com/azure/ai-services/content-safety/quickstart-text?tabs=visual-studio%2Clinux&pivots=programming-language-rest) vas vodi skozi poizvedbe na storitev.

Drugi vidik, ki ga je treba upoštevati, je splošna učinkovitost aplikacije. Pri večmodalnih in večmodelnih aplikacijah razumemo z učinkovitostjo, da sistem deluje tako, kot pričakujete vi in vaši uporabniki, vključno s tem, da ne generira škodljivih izhodov. Pomembno je oceniti učinkovitost vaše celotne aplikacije z uporabo [ocenjevalcev uspešnosti, kakovosti in tveganja ter varnosti](https://learn.microsoft.com/azure/ai-studio/concepts/evaluation-metrics-built-in). Prav tako imate možnost ustvarjanja in ocenjevanja z [lastnimi ocenjevalci](https://learn.microsoft.com/azure/ai-studio/how-to/develop/evaluate-sdk#custom-evaluators).
Vašo AI aplikacijo lahko ocenite v vašem razvojnem okolju z uporabo [Azure AI Evaluation SDK](https://microsoft.github.io/promptflow/index.html). Glede na testni nabor podatkov ali cilj, se generacije vaše generativne AI aplikacije kvantitativno merijo z vgrajenimi ocenjevalci ali po meri izbranimi ocenjevalci. Če želite začeti z azure ai evaluation sdk za ocenjevanje vašega sistema, lahko sledite [vodniku za hiter začetek](https://learn.microsoft.com/azure/ai-studio/how-to/develop/flow-evaluate-sdk). Ko izvedete izvajanje ocenjevanja, lahko [vizualizirate rezultate v Azure AI Foundry](https://learn.microsoft.com/azure/ai-studio/how-to/evaluate-flow-results).

## Trgovske znamke

Ta projekt lahko vsebuje trgovske znamke ali logotipe za projekte, izdelke ali storitve. Pooblaščena uporaba Microsoftovih trgovskih znamk ali logotipov je predmet in mora slediti [Microsoftovim smernicam za trgovske znamke in blagovne znamke](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
Uporaba Microsoftovih trgovskih znamk ali logotipov v spremenjenih različicah tega projekta ne sme povzročiti zmede ali nakazovati sponzorstva Microsofta. Vsaka uporaba trgovskih znamk ali logotipov tretjih oseb je podvržena pravilom teh tretjih oseb.

## Iskanje pomoči

Če zapadete v težave ali imate vprašanja o gradnji AI aplikacij, se pridružite:
...
**Opozorilo**:
Ta dokument je bil preveden z uporabo AI prevajalne storitve [Co-op Translator](https://github.com/Azure/co-op-translator). Čeprav si prizadevamo za natančnost, upoštevajte, da lahko avtomatski prevodi vsebujejo napake ali netočnosti. Izvirni dokument v maternem jeziku naj velja kot avtoritativni vir. Za ključne informacije priporočamo strokovni prevod, opravljen s strani človeka. Ne odgovarjamo za morebitne nesporazume ali napačne interpretacije, ki izhajajo iz uporabe tega prevoda.
