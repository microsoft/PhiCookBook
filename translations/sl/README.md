...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-09T18:49:13+00:00",
...
Phi lahko namestite v oblak ali na robne naprave, prav tako pa lahko z omejeno računalniško močjo enostavno ustvarjate generativne AI aplikacije.

Sledite tem korakom, da začnete uporabljati te vire:  
1. **Razvezi repozitorij**: Klikni [![GitHub forks](https://img.shields.io/github/forks/microsoft/phicookbook.svg?style=social&label=Fork)](https://GitHub.com/microsoft/phicookbook/network/?WT.mc_id=aiml-137032-kinfeylo)  
...
- [Kvantifikacija Phi družine](./md/01.Introduction/04/QuantifyingPhi.md)  
  - [Kvantizacija Phi-3.5 / 4 z llama.cpp](./md/01.Introduction/04/UsingLlamacppQuantifyingPhi.md)  
  - [Kvantizacija Phi-3.5 / 4 z generativnimi AI razširitvami za onnxruntime](./md/01.Introduction/04/UsingORTGenAIQuantifyingPhi.md)  
  - [Kvantizacija Phi-3.5 / 4 z Intel OpenVINO](./md/01.Introduction/04/UsingIntelOpenVINOQuantifyingPhi.md)  
  - [Kvantizacija Phi-3.5 / 4 z Apple MLX ogrodjem](./md/01.Introduction/04/UsingAppleMLXQuantifyingPhi.md)
...
- Primeri razvoja Phi aplikacij  
  - Tekstovne in klepetalne aplikacije  
    - Phi-4 primeri 🆕  
...
- Azure AI Inference SDK primeri na osnovi kode  
  ...
  - Phi-3 / 3.5 primeri  
    ...
    - [Ustvarite svoj Visual Studio Code Chat Copilot agent s Phi-3.5 po modelih GitHub](./md/02.Application/02.Code/Phi3/CreateVSCodeChatAgentWithGitHubModels.md)  
...
- MOE primeri  
  - Phi-3 / 3.5 primeri  
    - [📓] [Phi-3.5 mešanica strokovnjakov (MoEs) vzorec za družbena omrežja](../../md/02.Application/06.MoE/Phi3/phi3_moe_demo.ipynb)  
...
- Prilagajanje Phi modelov  
  ...
  - [Praktična delavnica prilagajanja z Microsoft Olive](./md/03.FineTuning/olive-lab/readme.md)  
...
Ta projekt lahko vsebuje zaščitne znake ali logotipe za projekte, izdelke ali storitve. Pooblaščena uporaba Microsoftovih zaščitnih znakov ali logotipov je podvržena in mora slediti [Microsoftovim smernicam za zaščitne znake in blagovne znamke](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).  
Uporaba Microsoftovih zaščitnih znakov ali logotipov v spremenjenih različicah tega projekta ne sme povzročati zmede ali nakazovati sponzorstva Microsofta. Vsaka uporaba zaščitnih znakov ali logotipov tretjih oseb je podvržena pravilom teh tretjih oseb.
