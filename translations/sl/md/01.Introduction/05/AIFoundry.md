...
Kako oceniti svojo generativno AI aplikacijo z uporabo [Microsoft Foundry](https://ai.azure.com?WT.mc_id=aiml-138114-kinfeylo). Ne glede na to, ali ocenjujete enkratne ali večkratne pogovore, Microsoft Foundry ponuja orodja za ocenjevanje zmogljivosti in varnosti modela.
...
Microsoft Foundry omogoča ocenjevanje tako enkratnih kot kompleksnih večkratnih pogovorov.  
...
V uporabniškem vmesniku Microsoft Foundry pojdite na stran Evaluate ali Prompt Flow.  
...
Po izvedbi ocenjevanja si v Microsoft Foundry oglejte, zabeležite in analizirajte podrobne metrike ocenjevanja. Pridobite vpogled v zmogljivosti in omejitve vaše aplikacije.

**Note** Microsoft Foundry je trenutno v javni predogledni fazi, zato ga uporabljajte za eksperimentiranje in razvoj. Za produkcijske naloge razmislite o drugih možnostih. Za več informacij in podrobna navodila si oglejte uradno [AI Foundry dokumentacijo](https://learn.microsoft.com/azure/ai-studio/?WT.mc_id=aiml-138114-kinfeylo).
