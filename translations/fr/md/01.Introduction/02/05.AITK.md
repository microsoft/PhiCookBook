...
[AI Toolkit for VS Code](https://marketplace.visualstudio.com/items?itemName=ms-windows-ai-studio.windows-ai-studio) facilite le développement d’applications d’IA générative en réunissant des outils et modèles d’IA de pointe issus du Microsoft Foundry Catalog et d’autres catalogues comme Hugging Face. Vous pourrez parcourir le catalogue de modèles d’IA alimenté par GitHub Models et Microsoft Foundry Model Catalogs, les télécharger localement ou à distance, les affiner, les tester et les utiliser dans votre application.
