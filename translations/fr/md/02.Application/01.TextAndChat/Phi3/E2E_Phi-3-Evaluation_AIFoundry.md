...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-07T14:22:04+00:00",
...
L’affinage d’un modèle peut parfois entraîner des réponses inattendues ou indésirables. Pour garantir que le modèle reste sûr et efficace, il est important d’évaluer son potentiel à générer du contenu nuisible ainsi que sa capacité à produire des réponses précises, pertinentes et cohérentes. Dans ce tutoriel, vous apprendrez comment évaluer la sécurité et les performances d’un modèle Phi-3 / Phi-3.5 affiné intégré avec Prompt flow dans Azure AI Foundry.
...
Avant de commencer les étapes techniques, il est essentiel de comprendre les principes d’IA responsable de Microsoft, un cadre éthique conçu pour guider le développement, le déploiement et l’exploitation responsables des systèmes d’IA. Ces principes orientent la conception, le développement et le déploiement responsables des systèmes d’IA, garantissant que les technologies d’IA sont conçues de manière juste, transparente et inclusive. Ces principes sont la base pour évaluer la sécurité des modèles d’IA.

Les principes d’IA responsable de Microsoft incluent :

- **Équité et inclusion** : Les systèmes d’IA doivent traiter tout le monde de manière équitable et éviter d’affecter différemment des groupes de personnes similaires. Par exemple, lorsque les systèmes d’IA fournissent des recommandations sur des traitements médicaux, des demandes de prêt ou l’emploi, ils doivent faire les mêmes recommandations à toutes les personnes ayant des symptômes, des situations financières ou des qualifications professionnelles similaires.

- **Fiabilité et sécurité** : Pour instaurer la confiance, il est essentiel que les systèmes d’IA fonctionnent de manière fiable, sûre et cohérente. Ces systèmes doivent pouvoir fonctionner comme prévu, répondre en toute sécurité à des conditions imprévues et résister à des manipulations malveillantes. Leur comportement et la variété des conditions qu’ils peuvent gérer reflètent la gamme de situations anticipées par les développeurs lors de la conception et des tests.

- **Transparence** : Lorsque les systèmes d’IA contribuent à des décisions ayant un impact majeur sur la vie des personnes, il est crucial que ces dernières comprennent comment ces décisions ont été prises. Par exemple, une banque peut utiliser un système d’IA pour décider si une personne est solvable. Une entreprise peut utiliser un système d’IA pour sélectionner les candidats les plus qualifiés.

- **Confidentialité et sécurité** : À mesure que l’IA devient plus répandue, la protection de la vie privée et la sécurisation des informations personnelles et professionnelles deviennent plus importantes et complexes. Avec l’IA, la confidentialité et la sécurité des données nécessitent une attention particulière car l’accès aux données est essentiel pour que les systèmes d’IA fassent des prédictions et prennent des décisions précises et éclairées sur les personnes.

- **Responsabilité** : Les personnes qui conçoivent et déploient des systèmes d’IA doivent être responsables de leur fonctionnement. Les organisations doivent s’appuyer sur des normes industrielles pour développer des règles de responsabilité. Ces règles garantissent que les systèmes d’IA ne sont pas l’autorité finale dans toute décision affectant la vie des personnes. Elles assurent également que les humains gardent un contrôle significatif sur des systèmes d’IA autrement très autonomes.

![Fill hub.](../../../../../../translated_images/responsibleai2.c07ef430113fad8c72329615ecf51a4e3df31043fb0d918f868525e7a9747b98.fr.png)
...
![Évaluation basée sur la sécurité.](../../../../../../translated_images/evaluate-based-on-safety.c5df819f5b0bfc07156d9b1e18bdf1f130120f7d23e05ea78bc9773d2500b665.fr.png)

### Introduction à l’évaluation des performances

Pour s’assurer que votre modèle d’IA fonctionne comme prévu, il est important d’évaluer ses performances à l’aide d’indicateurs spécifiques. Dans Azure AI Foundry, les évaluations de performances permettent de mesurer l’efficacité de votre modèle à générer des réponses précises, pertinentes et cohérentes.

![Évaluation de la performance.](../../../../../../translated_images/performance-evaluation.48b3e7e01a098740c7babf1904fa4acca46c5bd7ea8c826832989c776c0e01ca.fr.png)
...
- **Ancrage** : Évalue dans quelle mesure les réponses générées sont en accord avec les informations provenant de la source d’entrée.
- **Pertinence** : Évalue la pertinence des réponses générées par rapport aux questions posées.
- **Cohérence** : Évalue la fluidité du texte généré, sa lecture naturelle et sa ressemblance à un langage humain.
...
![Évaluation basée sur la performance.](../../../../../../translated_images/evaluate-based-on-performance.3e801c647c7554e820ceb3f7f148014fe0572c05dbdadb1af7205e1588fb0358.fr.png)
...
1. Saisissez un **Nom de projet**. Il doit être unique.

    ![Créer projet.](../../../../../../translated_images/create-project.ca3b71298b90e42049ce8f6f452313bde644c309331fd728fcacd8954a20e26d.fr.png)
...
1. Sélectionnez **Endpoints** dans l’onglet à gauche.
    ...
    ![Sélectionner endpoints.](../../../../../../translated_images/select-endpoints.ee7387ecd68bd18d35cd7f235f930ebe99841a8c8c9dea2f608b7f43508576dd.fr.png)

1. Sélectionnez le point de terminaison que vous avez créé.

    ![Sélectionner endpoints.](../../../../../../translated_images/select-endpoint-created.9f63af5e4cf98b2ec92358f15ad36d69820e627c048f14c7ec3750fdbce3558b.fr.png)

1. Sélectionnez **Consume** dans le menu de navigation.

1. Copiez votre **REST endpoint** et votre **Primary key**.

    ![Copier clé api et URI du point de terminaison.](../../../../../../translated_images/copy-endpoint-key.0650c3786bd646ab0b5a80833917b7b8f32ee011c09af0459f3830dc25b00760.fr.png)
...
1. Effectuez les opérations suivantes :
    ...
    - Sélectionnez de nouveau **+ Add key value pairs**.
    ...
    ![Ajouter connexion.](../../../../../../translated_images/add-connection.ac7f5faf8b10b0dfe6679422f479f88cc47c33cbf24568da138ab19fbb17dc4b.fr.png)

1. Sélectionnez **Add connection**.

#### Créer un Prompt flow

Vous avez ajouté une connexion personnalisée dans Azure AI Foundry. Passons maintenant à la création d’un Prompt flow en suivant les étapes ci-dessous. Ensuite, vous connecterez ce Prompt flow à la connexion personnalisée pour utiliser le modèle affiné dans le Prompt flow.
...
1. Saisissez un **Nom de dossier** à utiliser.
    ...
    ![Sélectionner chat flow.](../../../../../../translated_images/enter-name.02ddf8fb840ad4305ba88e0a804a5198ddd8720ebccb420d65ba13dcd481591f.fr.png)

1. Sélectionnez **Create**.

#### Configurer Prompt flow pour discuter avec votre modèle Phi-3 / Phi-3.5 personnalisé

Vous devez intégrer le modèle Phi-3 / Phi-3.5 affiné dans un Prompt flow. Cependant, le Prompt flow existant fourni n’est pas conçu à cet effet. Vous devez donc repenser le Prompt flow pour permettre l’intégration du modèle personnalisé.
...
1. Dans le Prompt flow, effectuez les opérations suivantes pour reconstruire le flux existant :
    ...
    ![Sélectionner mode fichier brut.](../../../../../../translated_images/select-raw-file-mode.06c1eca581ce4f5344b4801da9d695b3c1ea7019479754e566d2df495e868664.fr.png)
...
1. Sélectionnez **Chat input**, **Chat output** pour activer la discussion avec votre modèle.

    ![Sélectionner entrée sortie.](../../../../../../translated_images/select-input-output.c187fc58f25fbfc339811bdd5a2285589fef803aded96b8c58b40131f0663571.fr.png)

1. Vous êtes maintenant prêt à discuter avec votre modèle Phi-3 / Phi-3.5 personnalisé. Dans l’exercice suivant, vous apprendrez comment démarrer Prompt flow et l’utiliser pour discuter avec votre modèle affiné Phi-3 / Phi-3.5.
...
1. Sélectionnez **Start compute sessions** pour lancer Prompt flow.
    ...
    ![Démarrer session de calcul.](../../../../../../translated_images/start-compute-session.9acd8cbbd2c43df160358b6be6cad3e069a9c22271fd8b40addc847aeca83b44.fr.png)

1. Sélectionnez **Validate and parse input** pour renouveler les paramètres.

    ![Valider entrée.](../../../../../../translated_images/validate-input.c1adb9543c6495be3c94da090ce7c61a77cc8baf0718552e3d6e41b87eb96a41.fr.png)
...
1. Voici un exemple de résultats : vous pouvez maintenant discuter avec votre modèle Phi-3 / Phi-3.5 personnalisé. Il est conseillé de poser des questions basées sur les données utilisées pour l’affinage.
...
1. Accédez au projet Azure AI Foundry que vous avez créé.
    ...
    ![Sélectionner projet.](../../../../../../translated_images/select-project-created.5221e0e403e2c9d6a17c809ad9aee8de593cd48717f157cc3eb2b29a37aa02ae.fr.png)

1. Dans le projet que vous avez créé, sélectionnez **Deployments** dans l’onglet à gauche.
...
1. Sélectionnez le modèle Azure OpenAI que vous souhaitez utiliser. Par exemple, **gpt-4o**.
    ...
    ![Sélectionner modèle Azure OpenAI à utiliser.](../../../../../../translated_images/select-openai-model.959496d7e311546d66ec145dc4e0bf0cc806e6e5469b17e776788d6f5ba7a221.fr.png)
...
1. Dans le projet que vous avez créé, sélectionnez **Evaluation** dans l’onglet à gauche.

1. Sélectionnez **+ New evaluation** dans le menu de navigation.
![Sélectionnez l’évaluation.](../../../../../../translated_images/select-evaluation.2846ad7aaaca7f4f2cd3f728b640e64eeb639dc5dcb52f2d651099576b894848.fr.png)

1. Sélectionnez l’évaluation **Prompt flow**.

    ![Sélectionnez l’évaluation Prompt flow.](../../../../../../translated_images/promptflow-evaluation.cb9758cc19b4760f7a1ddda46bf47281cac59f2b1043f6a775a73977875f29a6.fr.png)
...
1. Effectuez les tâches suivantes :
    ...
    ![Évaluation du prompt flow.](../../../../../../translated_images/evaluation-setting1.4aa08259ff7a536e2e0e3011ff583f7164532d954a5ede4434fe9985cf51047e.fr.png)
...
1. Effectuez les tâches suivantes :
    ...
    - Sélectionnez la **Dataset column** appropriée correspondant à votre jeu de données. Par exemple, si vous utilisez le jeu de données **ULTRACHAT_200k**, sélectionnez **${data.prompt}** comme colonne.

    ![Évaluation du prompt flow.](../../../../../../translated_images/evaluation-setting2.07036831ba58d64ee622f9ee9b1c70f71b51cf39c3749dcd294414048c5b7e39.fr.png)
...
1. Effectuez les tâches suivantes pour configurer les métriques de performance et de qualité :
    ...
    - Sélectionnez le modèle Azure OpenAI que vous avez créé pour l’évaluation. Par exemple, choisissez **gpt-4o**.

    ![Évaluation du prompt flow.](../../../../../../translated_images/evaluation-setting3-1.d1ae69e3bf80914e68a0ad38486ca2d6c3ee5a30f4275f98fd3bc510c8d8f6d2.fr.png)
...
1. Effectuez les tâches suivantes pour configurer les métriques de risque et de sécurité :
    ...
    - Sélectionnez le seuil pour calculer le taux de défaut que vous souhaitez utiliser. Par exemple, choisissez **Medium**.
    ...
    ![Évaluation du prompt flow.](../../../../../../translated_images/evaluation-setting3-2.d53bd075c60a45a2fab8ffb7e4dc28e8e544d2a093fbc9f63449a03984df98d9.fr.png)

1. Sélectionnez **Next**.

1. Sélectionnez **Submit** pour lancer l’évaluation.

1. L’évaluation prendra un certain temps. Vous pouvez suivre sa progression dans l’onglet **Evaluation**.

### Examiner les résultats de l’évaluation

> [!NOTE]
> Les résultats présentés ci-dessous ont pour but d’illustrer le processus d’évaluation. Dans ce tutoriel, nous avons utilisé un modèle affiné sur un jeu de données relativement petit, ce qui peut conduire à des résultats sous-optimaux. Les résultats réels peuvent varier considérablement en fonction de la taille, de la qualité et de la diversité du jeu de données utilisé, ainsi que de la configuration spécifique du modèle.

Une fois l’évaluation terminée, vous pouvez consulter les résultats pour les métriques de performance et de sécurité.
...
1. Métriques de risque et de sécurité :
    ...
    - Assurez-vous que les réponses du modèle sont sûres et conformes aux principes de l’IA responsable, en évitant tout contenu nuisible ou offensant.
...
1. Vous pouvez faire défiler la page pour voir les **Résultats détaillés des métriques**.
...
1. En évaluant votre modèle personnalisé Phi-3 / Phi-3.5 sur les métriques de performance et de sécurité, vous pouvez confirmer que le modèle est non seulement efficace, mais aussi conforme aux pratiques responsables en IA, prêt pour un déploiement en conditions réelles.

## Félicitations !

### Vous avez terminé ce tutoriel

Vous avez évalué avec succès le modèle Phi-3 affiné et intégré à Prompt flow dans Azure AI Foundry. C’est une étape essentielle pour garantir que vos modèles d’IA offrent de bonnes performances tout en respectant les principes d’IA responsable de Microsoft, afin de construire des applications d’IA fiables et dignes de confiance.
...
Libérez vos ressources Azure pour éviter des frais supplémentaires sur votre compte. Rendez-vous sur le portail Azure et supprimez les ressources suivantes :
...
- [Métriques d’évaluation et de suivi pour l’IA générative](https://learn.microsoft.com/azure/ai-studio/concepts/evaluation-metrics-built-in?tabs=definition?wt.mc_id=studentamb_279723)
...
- [Annonce de nouveaux outils Azure AI pour vous aider à créer des applications d’IA générative plus sécurisées et fiables](https://azure.microsoft.com/blog/announcing-new-tools-in-azure-ai-to-help-you-build-more-secure-and-trustworthy-generative-ai-applications/?wt.mc_id=studentamb_279723)
