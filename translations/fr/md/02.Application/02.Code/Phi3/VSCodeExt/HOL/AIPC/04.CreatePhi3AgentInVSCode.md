...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-07T13:49:19+00:00",
...
![agent](../../../../../../../../../translated_images/vscode_agent.746efdf2e81957c20a3f416d82b504e416e87d2f8b9d20c0495d0fdc0dfc5b4c.fr.png)
...
L’API Visual Studio Code Chat n’a pas encore été intégrée à l’API de code, mais est désormais ajoutée via des extensions.
...
export function activate(extcontext: vscode.ExtensionContext) {
	...
	const phi3handler: vscode.ChatRequestHandler = async (request: vscode.ChatRequest, context: vscode.ChatContext, stream: vscode.ChatResponseStream, token: vscode.CancellationToken): Promise<IPHI3ChatResult> => {
		...
		if (request.command == 'img') {
			...
			{
				var result = "```txt"+"\n\n"+"Veuillez poser votre question de cette façon : Votre question (IMG_URL:https://example.com/image.jpg)"+"\n\n"++"```";
...
![code](../../../../../../../../../translated_images/result_code.ae0d053b45202798e2d0c9f5e9f4f6affda088a3210fe53c5725524ff253e617.fr.png)

Vous pouvez essayer ***@PHI3 /img***

![img](../../../../../../../../../translated_images/result_img.436817a2bb3a34cf540fddfade811128f12106b11c7f1a8e4b952e805cffd9d8.fr.png)
