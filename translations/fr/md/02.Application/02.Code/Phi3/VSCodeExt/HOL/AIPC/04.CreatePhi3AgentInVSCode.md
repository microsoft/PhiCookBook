...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-17T04:09:35+00:00",
  "source_file": "md/02.Application/02.Code/Phi3/VSCodeExt/HOL/AIPC/04.CreatePhi3AgentInVSCode.md",
  "language_code": "fr"
}
-->
# **Laboratoire 3 - Créer un agent @PHI3 dans GitHub Copilot Chat**
...
Lors du dernier laboratoire, nous avons combiné NPU et cloud pour réaliser une extension Visual Studio Code pour l’agent Phi3.
...
export function activate(extcontext: vscode.ExtensionContext) {
	...
	const phi3handler: vscode.ChatRequestHandler = async (request: vscode.ChatRequest, context: vscode.ChatContext, stream: vscode.ChatResponseStream, token: vscode.CancellationToken): Promise<IPHI3ChatResult> => {
		...
		if (request.command == 'img') {
			...
			{
				var result = "```txt"+"\n\n"+"Veuillez poser une question de cette façon : Votre question (IMG_URL:https://example.com/image.jpg)"+"\n\n"++"```";
...
Félicitations ! Vous avez terminé tous les laboratoires. J’espère que cela vous aidera à mieux comprendre la famille Phi-3 et comment utiliser GitHub Copilot Chat.
