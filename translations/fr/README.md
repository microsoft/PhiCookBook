...
[![Surveillants GitHub](https://img.shields.io/github/watchers/microsoft/phicookbook.svg?style=social&label=Watch)](https://GitHub.com/microsoft/phicookbook/watchers/?WT.mc_id=aiml-137032-kinfeylo)
...
Phi est actuellement le petit modèle de langage (SLM) le plus puissant et rentable, avec d'excellents résultats dans de nombreux domaines tels que le multilingue, le raisonnement, la génération de texte/chat, le codage, les images, l'audio et d'autres scénarios.

Vous pouvez déployer Phi sur le cloud ou sur des appareils en périphérie, et vous pouvez facilement créer des applications d'IA générative avec une puissance de calcul limitée.
...
![couverture](../../translated_images/fr/cover.eb18d1b9605d754b.webp)

### 🌐 Support multilingue

#### Pris en charge via GitHub Action (Automatique et toujours à jour)
...
-  [Quantification de la famille Phi](./md/01.Introduction/04/QuantifyingPhi.md)
    ...
    - [Quantification Phi-3.5 / 4 avec extensions Generative AI pour onnxruntime](./md/01.Introduction/04/UsingORTGenAIQuantifyingPhi.md)
...
- Exemples de développement d'applications Phi
  - Applications texte et chat
    ...
    - Échantillons Phi-3 / 3.5
      ...
      -[Exemple d'application WinUI3 Multi Model alimentée par l'IA](https://github.com/microsoft/ai-powered-notes-winui3-sample)
      ...
      - [Évaluation du modèle Phi-3 / Phi-3.5 affiné dans Azure AI Foundry en mettant l'accent sur les principes d'IA responsable de Microsoft](./md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-Evaluation_AIFoundry.md)
      ...
      - [Utilisation de Windows GPU pour créer une solution Prompt flow avec Phi-3.5-Instruct ONNX](./md/02.Application/01.TextAndChat/Phi3/UsingPromptFlowWithONNX.md)
  ...
  - Exemples de code basés sur Azure AI Inference SDK
    - Exemples Phi-4 🆕
      - [📓] [Générer le code du projet avec Phi-4-multimodal](./md/02.Application/02.Code/Phi4/GenProjectCode/README.md)
    - Exemples Phi-3 / 3.5
      ...
      - [Créez votre propre agent User Copilot Chat Visual Studio Code avec Phi-3.5 par les modèles GitHub](/md/02.Application/02.Code/Phi3/CreateVSCodeChatAgentWithGitHubModels.md)
  ...
  - Exemples de raisonnement avancé
    - Exemples Phi-4 🆕
      ...
      - [📓] [Affinage du raisonnement Phi-4-mini avec Microsoft Olive](./md/02.Application/03.AdvancedReasoning/Phi4/AdvancedResoningPhi4mini/olive_ft_phi_4_reasoning_with_medicaldata.ipynb)
      - [📓] [Affinage du raisonnement Phi-4-mini avec Apple MLX](./md/02.Application/03.AdvancedReasoning/Phi4/AdvancedResoningPhi4mini/mlx_ft_phi_4_reasoning_with_medicaldata.ipynb)
      - [📓] [Raisonnement Phi-4-mini avec modèles GitHub](./md/02.Application/02.Code/Phi4r/github_models_inference.ipynb)
      - [📓] [Raisonnement Phi-4-mini avec modèles Azure AI Foundry](./md/02.Application/02.Code/Phi4r/azure_models_inference.ipynb)
  - Démonstrations
  ...
  - Exemples Vision
    ...
    - Exemples Phi-3 / 3.5
      ...
      - [DEMO : Recyclage Phi-3](https://github.com/jennifermarsman/PhiRecycling/)
      ...
      - [📓][Exemple Phi-3.5 Vision multi-image ou multi-trame](./md/02.Application/04.Vision/Phi3/phi3-vision-demo.ipynb)
      - [Modèle local ONNX Phi-3 Vision utilisant Microsoft.ML.OnnxRuntime .NET](../../md/04.HOL/dotnet/src/LabsPhi303)
      - [Menu basé sur modèle local ONNX Phi-3 Vision utilisant Microsoft.ML.OnnxRuntime .NET](../../md/04.HOL/dotnet/src/LabsPhi304)
  ...
  - Exemples MOE
    - Exemples Phi-3 / 3.5
      - [📓] [Modèles Mixture of Experts Phi-3.5 (MoEs) Exemple sur les réseaux sociaux](./md/02.Application/06.MoE/Phi3/phi3_moe_demo.ipynb)
      - [📓] [Création d'un pipeline Generation Augmentée par Recherche (RAG) avec NVIDIA NIM Phi-3 MOE, Azure AI Search, et LlamaIndex](./md/02.Application/06.MoE/Phi3/azure-ai-search-nvidia-rag.ipynb)
      - 
...
- Exemples d'affinage Phi
  ...
  - [Affinage de Phi-3 via Azure ML CLI/SDK](./md/03.FineTuning/FineTuning_MLSDK.md)
  - [Affinage avec Microsoft Olive](./md/03.FineTuning/FineTuning_MicrosoftOlive.md)
  - [Laboratoire pratique d'affinage avec Microsoft Olive](./md/03.FineTuning/olive-lab/readme.md)
...
- Articles et publications de recherche académique
  ...
  - [Rapport technique Phi-4-réflexion](https://www.microsoft.com/en-us/research/wp-content/uploads/2025/04/phi_4_reasoning.pdf)
  - [Rapport technique Phi-4-mini-réflexion](https://huggingface.co/microsoft/Phi-4-mini-reasoning/blob/main/Phi-4-Mini-Reasoning.pdf)

## Utilisation des modèles Phi

### Phi sur Azure AI Foundry

Vous pouvez apprendre à utiliser Microsoft Phi et comment construire des solutions E2E sur vos différents appareils matériels. Pour tester Phi par vous-même, commencez par jouer avec les modèles et personnalisez Phi pour vos scénarios en utilisant le [catalogue de modèles Azure AI Foundry](https://aka.ms/phi3-azure-ai). Vous pouvez en apprendre davantage dans la section Découverte avec [Azure AI Foundry](/md/02.QuickStart/AzureAIFoundry_QuickStart.md)
...
Vous pouvez apprendre à utiliser Microsoft Phi et comment construire des solutions E2E sur vos différents appareils matériels. Pour tester Phi par vous-même, commencez par jouer avec le modèle et personnalisez Phi pour vos scénarios en utilisant le [catalogue de modèles GitHub](https://github.com/marketplace/models?WT.mc_id=aiml-137032-kinfeylo). Vous pouvez en apprendre davantage dans la section Découverte avec [GitHub Model Catalog](/md/02.QuickStart/GitHubModel_QuickStart.md)
...
Microsoft s'engage à aider ses clients à utiliser ses produits d'IA de manière responsable, en partageant nos enseignements et en construisant des partenariats fondés sur la confiance grâce à des outils tels que les Notes de transparence et les Évaluations d'impact. Beaucoup de ces ressources sont disponibles sur [https://aka.ms/RAI](https://aka.ms/RAI).  
...
Les modèles à grande échelle de langage naturel, d'image et de parole - comme ceux utilisés dans cet exemple - peuvent potentiellement se comporter de manière injuste, peu fiable ou offensante, ce qui peut causer des préjudices. Veuillez consulter la [note de transparence du service Azure OpenAI](https://learn.microsoft.com/legal/cognitive-services/openai/transparency-note?tabs=text) pour être informé des risques et limitations.  

La méthode recommandée pour atténuer ces risques est d'inclure un système de sécurité dans votre architecture capable de détecter et d'empêcher les comportements nuisibles. [Azure AI Content Safety](https://learn.microsoft.com/azure/ai-services/content-safety/overview) fournit une couche indépendante de protection, capable de détecter le contenu nuisible généré par l'utilisateur ou par l'IA dans les applications et services. Azure AI Content Safety comprend des API textuelles et d'image qui vous permettent de détecter du matériel nuisible. Dans Azure AI Foundry, le service Content Safety permet de visualiser, explorer et essayer des exemples de code pour détecter du contenu nuisible dans différentes modalités. La documentation de [démarrage rapide suivante](https://learn.microsoft.com/azure/ai-services/content-safety/quickstart-text?tabs=visual-studio%2Clinux&pivots=programming-language-rest) vous guide pour faire des requêtes vers ce service.
Un autre aspect à prendre en compte est la performance globale de l'application. Pour les applications multi-modales et multi-modèles, la performance signifie que le système fonctionne comme vous et vos utilisateurs l'attendez, y compris le fait de ne pas générer de résultats nuisibles. Il est important d’évaluer la performance de votre application globale en utilisant les [évaluateurs de Performance, Qualité, Risque et Sécurité](https://learn.microsoft.com/azure/ai-studio/concepts/evaluation-metrics-built-in). Vous avez également la possibilité de créer et d’évaluer avec des [évaluateurs personnalisés](https://learn.microsoft.com/azure/ai-studio/how-to/develop/evaluate-sdk#custom-evaluators).
...
Ce projet peut contenir des marques déposées ou des logos de projets, produits ou services. L’utilisation autorisée des marques déposées ou des logos Microsoft est soumise aux [Directives sur les marques et la marque de Microsoft](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general) et doit les respecter.  
L’utilisation des marques déposées ou des logos Microsoft dans des versions modifiées de ce projet ne doit pas créer de confusion ni impliquer un parrainage par Microsoft. Toute utilisation de marques déposées ou logos de tiers est soumise aux politiques de ces tiers.
