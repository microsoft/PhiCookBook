...
3. [**Rejoignez la Communauté Discord AI Microsoft et rencontrez des experts et d'autres développeurs**](https://discord.com/invite/ByRwuEEgH4?WT.mc_id=aiml-137032-kinfeylo)
...
-  [Quantification Phi Family](./md/01.Introduction/04/QuantifyingPhi.md)
    ...
    - [Quantification Phi-3.5 / 4 avec framework Apple MLX](./md/01.Introduction/04/UsingAppleMLXQuantifyingPhi.md)
...
- Exemples de développement d’applications Phi
  - Applications de texte et chat
    - Échantillons Phi-4 🆕
      - [📓] [Chat avec le modèle ONNX Phi-4-mini](./md/02.Application/01.TextAndChat/Phi4/ChatWithPhi4ONNX/README.md)
      - [Chat avec modèle local ONNX Phi-4 en .NET](../../md/04.HOL/dotnet/src/LabsPhi4-Chat-01OnnxRuntime)
    ...
    - Échantillons Phi-3 / 3.5
      ...
      -[Exemple d'application de notes alimentée par IA multi-modèles WinUI3](https://github.com/microsoft/ai-powered-notes-winui3-sample)
  ...
  - Échantillons de code basés sur Azure AI Inference SDK
    - Échantillons Phi-4 🆕
      - [📓] [Générer le code projet avec Phi-4-multimodal](./md/02.Application/02.Code/Phi4/GenProjectCode/README.md)
    - Échantillons Phi-3 / 3.5
      - [Construisez votre propre GitHub Copilot Chat pour Visual Studio Code avec la famille Microsoft Phi-3](./md/02.Application/02.Code/Phi3/VSCodeExt/README.md)
      - [Créez votre propre agent Chat Copilot pour Visual Studio Code avec Phi-3.5 par les modèles GitHub](/md/02.Application/02.Code/Phi3/CreateVSCodeChatAgentWithGitHubModels.md)
  ...
  - Échantillons Mathématiques
    - Échantillons Phi-4-Mini-Flash-Reasoning-Instruct 🆕 [Démo Mathématiques avec Phi-4-Mini-Flash-Reasoning-Instruct](./md/02.Application/09.Math/MathDemo.ipynb)
  ...
  - Échantillons de mix multimodal
    - Échantillons Phi-4 🆕
...
- Articles et publications académiques
  ...
  - [Rapport technique Phi-4-Mini : modèles linguistiques multimodaux compacts mais puissants via un mélange de LoRAs](https://arxiv.org/abs/2503.01743)
  - [Optimisation des petits modèles linguistiques pour l'appel de fonctions en véhicule](https://arxiv.org/abs/2501.02342)
...
Microsoft s'engage à aider nos clients à utiliser nos produits d'IA de manière responsable, à partager nos apprentissages et à établir des partenariats basés sur la confiance via des outils comme les Notes de transparence et les évaluations d'impact. Beaucoup de ces ressources sont disponibles sur [https://aka.ms/RAI](https://aka.ms/RAI).  
L'approche de Microsoft en matière d'IA responsable s'appuie sur nos principes d'IA que sont l'équité, la fiabilité et la sécurité, la confidentialité et la sécurité, l'inclusivité, la transparence et la responsabilité.

Les modèles à grande échelle de langage naturel, d'image et de parole - comme ceux utilisés dans cet exemple - peuvent potentiellement se comporter de manière injuste, peu fiable ou offensante, entraînant des dommages. Veuillez consulter la [note de transparence du service Azure OpenAI](https://learn.microsoft.com/legal/cognitive-services/openai/transparency-note?tabs=text) pour vous informer sur les risques et limitations.

L'approche recommandée pour atténuer ces risques est d'inclure un système de sécurité dans votre architecture qui peut détecter et prévenir les comportements nuisibles. [Azure AI Content Safety](https://learn.microsoft.com/azure/ai-services/content-safety/overview) fournit une couche de protection indépendante, capable de détecter le contenu nuisible généré par les utilisateurs et par l'IA dans les applications et services. Azure AI Content Safety inclut des API de texte et d'image qui vous permettent de détecter des contenus préjudiciables. Dans Azure AI Foundry, le service Content Safety vous permet de visualiser, explorer et essayer des exemples de code pour détecter les contenus nuisibles à travers différentes modalités. La documentation de démarrage rapide suivante [quickstart documentation](https://learn.microsoft.com/azure/ai-services/content-safety/quickstart-text?tabs=visual-studio%2Clinux&pivots=programming-language-rest) vous guide pour faire des requêtes au service.
...
L’utilisation des marques ou logos Microsoft dans des versions modifiées de ce projet ne doit pas créer de confusion ni laisser penser à un parrainage par Microsoft. Toute utilisation des marques ou logos de tiers est soumise aux politiques de ces tiers.
...
Si vous avez des retours produit ou rencontrez des erreurs pendant la création, consultez :
