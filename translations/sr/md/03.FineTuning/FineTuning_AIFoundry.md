...
Хајде да истражимо како да фино подесимо Microsoft-ов Phi-3 Mini језички модел користећи Microsoft Foundry. Фино подешавање вам омогућава да прилагодите Phi-3 Mini за специфичне задатке, чинећи га још моћнијим и свеснијим контекста.
...
- Azure контроле приступа засноване на улогама (Azure RBAC) се користе за доделу приступа операцијама у Microsoft Foundry. Да бисте извршили кораке у овом чланку, ваш кориснички налог мора имати __Azure AI Developer улогу__ на групи ресурса.
...
1. Извршите следеће задатке:
    ...
    - Изаберите **Training data** који желите да користите. Можете га отпремити преко Microsoft Foundry података или са вашег локалног окружења.
...
> [!NOTE]
> За детаљније информације о фино подешавању Phi-3, посетите [Fine-tune Phi-3 models in Microsoft Foundry](https://learn.microsoft.com/azure/ai-studio/how-to/fine-tune-phi-3?tabs=phi-3-mini).

## Брисање фино подешених модела

Можете избрисати фино подешени модел са листе модела за фино подешавање у [Microsoft Foundry](https://ai.azure.com) или са странице детаља модела. Изаберите фино подешени модел који желите да избришете са странице за фино подешавање, а затим изаберите дугме Delete да бисте га избрисали.
...
Phi модели фино подешени као услуга нуде се од стране Microsoft-а и интегрисани су са Microsoft Foundry за употребу. Можете пронаћи цене приликом [деплоја](https://learn.microsoft.com/azure/ai-studio/how-to/deploy-models-phi-3?tabs=phi-3-5&pivots=programming-language-python) или фино подешавања модела у одељку Pricing and terms у чаробњаку за деплој.
...
- Деплојујте као веб услугу: Деплојујте свој фино подешени модел као веб услугу у Microsoft Foundry.
