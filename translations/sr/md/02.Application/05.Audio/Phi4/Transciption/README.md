...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-17T05:13:24+00:00",
  "source_file": "md/02.Application/05.Audio/Phi4/Transciption/README.md",
  "language_code": "sr"
}
-->
## **Извлачење аудио транскрипата помоћу Phi-4-multimodal**

Phi-4-multimodal је модел са више модалитета који може да користи аудио поред текста и слика. Хајде да видимо како да га користимо.
