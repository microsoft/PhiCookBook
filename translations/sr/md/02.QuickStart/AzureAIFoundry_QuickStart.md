...
Са развојем генеративне вештачке интелигенције, желимо да користимо јединствену платформу за управљање различитим LLM и SLM моделима, интеграцију података предузећа, фино подешавање/RAG операције и процену различитих пословних процеса након интеграције LLM и SLM, како би се паметне апликације засноване на генеративној вештачкој интелигенцији боље реализовале. [Microsoft Foundry](https://ai.azure.com) је платформа за примену генеративне вештачке интелигенције на нивоу предузећа.

![aistudo](../../../../translated_images/sr/aifoundry_home.f28a8127c96c7d93.webp)

Помоћу Microsoft Foundry можете процењивати одговоре великих језичких модела (LLM) и оркестрирати компоненте апликација са prompt flow-ом ради бољих перформанси. Платформа омогућава лаку скалабилност за трансформацију прототипа у пуну производњу. Континуирано праћење и унапређење подржавају дугорочни успех.

Модел Phi-3 можемо брзо поставити на Microsoft Foundry кроз једноставне кораке, а затим користити Microsoft Foundry за завршетак повезаних активности као што су Playground/Chat, фино подешавање, процена и друго.
...
Креирање Microsoft Foundry пројекта и хаба је одличан начин да организујете и управљате својим AI радом. Ево корак по корак упутства за почетак:

### Креирање пројекта у Microsoft Foundry

1. **Идите на Microsoft Foundry**: Пријавите се на портал Microsoft Foundry.
...
1. **Идите на Microsoft Foundry**: Пријавите се са својим Azure налогом.
2. **Креирајте хаб**:
...
## **2. Постављање Phi модела у Microsoft Foundry**
...
Идите на страницу постављања, изаберите Playground и ћаскајте са Phi-3 у Microsoft Foundry

## **4. Постављање модела из Microsoft Foundry**

Да бисте поставили модел из Azure Model Catalog-а, пратите ове кораке:

- Пријавите се у Microsoft Foundry.
- Изаберите модел који желите да поставите из Microsoft Foundry каталога модела.
