...
[AI Toolkit for VS Code](https://marketplace.visualstudio.com/items?itemName=ms-windows-ai-studio.windows-ai-studio) поједностављује развој генеративних AI апликација тако што окупља најсавременије алате за развој AI и моделе из Microsoft Foundry каталога и других каталога као што је Hugging Face. Бићете у могућности да прегледате каталог AI модела који покрећу GitHub Models и Microsoft Foundry Model Catalogs, преузмете их локално или на даљину, фино подешавате, тестирате и користите у својој апликацији.
