...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-09T22:11:19+00:00",
...
[AI Toolkit för VS Code](https://github.com/microsoft/vscode-ai-toolkit/tree/main) samlar olika modeller från Azure AI Studio Catalog och andra kataloger som Hugging Face. Toolkit underlättar vanliga utvecklingsuppgifter för att bygga AI-appar med generativa AI-verktyg och modeller genom att:
- Komma igång med modellupptäckt och lekplats.
...
Nu går vi vidare till din AI-appsutveckling:
...
- [**\[Private Preview\]** Fjärrutveckling](../../../../md/03.FineTuning)
  ...
  - [Ställa in ett fjärrutvecklingsprojekt](../../../../md/03.FineTuning)
  - [Provisionera Azure-resurser](../../../../md/03.FineTuning)
  - [\[Valfritt\] Lägg till Huggingface-token i Azure Container App-hemligheten](../../../../md/03.FineTuning)
  - [Kör finjustering](../../../../md/03.FineTuning)
  - [Provisionera inferens-endpoint](../../../../md/03.FineTuning)
  - [Distribuera inferens-endpoint](../../../../md/03.FineTuning)
...
3. `Olive` förklaringar av nyckelinställningar som påverkar minnesanvändning.  

### Aktivera Conda
Eftersom vi använder WSL-miljön som är delad måste du manuellt aktivera conda-miljön. Efter detta steg kan du köra finjustering eller inferens.
...
När arbetsytan är öppen i en dev container, öppna en terminal (standardvägen är projektroten), och kör sedan kommandot nedan för att finjustera en LLM på det valda datasetet.

```bash
python finetuning/invoke_olive.py 
```

Checkpoints och slutgiltig modell sparas i `models` folder.
...
Once deployment is successfully completed, you can access the inference API by clicking on the "*Go to Inference Endpoint*" button displayed in the VSCode notification. Or, the web API endpoint can be found under `ACA_APP_ENDPOINT` in `./infra/inference.config.json` och i outputpanelen. Du är nu redo att utvärdera modellen med denna endpoint.
