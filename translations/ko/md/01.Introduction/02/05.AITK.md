...
[AI Toolkit for VS Code](https://marketplace.visualstudio.com/items?itemName=ms-windows-ai-studio.windows-ai-studio)는 Microsoft Foundry Catalog와 Hugging Face 같은 다른 카탈로그에서 제공하는 최신 AI 개발 도구와 모델을 한데 모아 생성형 AI 앱 개발을 간소화합니다. GitHub Models와 Microsoft Foundry Model Catalog가 지원하는 AI 모델 카탈로그를 탐색하고, 로컬 또는 원격으로 다운로드하며, 미세 조정, 테스트 후 애플리케이션에 사용할 수 있습니다.
