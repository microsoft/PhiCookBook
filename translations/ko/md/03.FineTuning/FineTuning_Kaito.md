...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-17T06:20:06+00:00",
...
- GPU 하드웨어에 맞춰 배포 파라미터를 조정할 필요 없이 사전 설정된 구성을 제공합니다.
...
Kaito 설치 후, 다음 명령어들을 실행하여 파인튜닝 서비스를 시작할 수 있습니다.
...
`workspace` 상태는 다음 명령어로 확인할 수 있습니다. WORKSPACEREADY 열이 `True`가 되면 모델이 성공적으로 배포된 것입니다.
...
다음으로, 추론 서비스의 클러스터 IP를 확인하고 임시 `curl` 파드를 사용해 클러스터 내 서비스 엔드포인트를 테스트할 수 있습니다.
