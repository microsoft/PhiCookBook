...
![GitHubModel](../../../../translated_images/ko/GitHub_ModelCatalog.aa43c51c36454747.webp)
...
실행할 수 있는 기본 예제가 몇 가지 준비되어 있습니다. samples 디렉터리에서 확인할 수 있습니다. 선호하는 언어로 바로 이동하고 싶다면, 다음 언어별 예제를 참고하세요:

- Python
- JavaScript
- cURL

샘플과 모델을 실행할 수 있는 전용 Codespaces 환경도 제공됩니다.

![Getting Started](../../../../translated_images/ko/GitHub_ModelGetStarted.150220a802da6fb6.webp)
...
아래 코드 스니펫을 사용하려면, 클라이언트 코드에서 토큰을 키로 설정하는 환경 변수를 만드세요.
...
아래 내용을 복사하여 폴더 내에 package.json 파일로 저장하세요.
...
![Model Catalog](../../../../translated_images/ko/GitHub_Model.ca6c125cb3117d0e.webp)

[플레이그라운드 및 무료 API 사용에 대한 요율 제한](https://docs.github.com/en/github-models/prototyping-with-ai-models#rate-limits)은 모델을 실험하고 AI 애플리케이션을 프로토타입하는 데 도움을 주기 위한 것입니다. 이 한도를 초과하여 사용하거나 애플리케이션을 확장하려면 Azure 계정에서 리소스를 프로비저닝하고 GitHub 개인 액세스 토큰 대신 해당 계정으로 인증해야 합니다. 코드의 다른 부분을 변경할 필요는 없습니다. Azure AI에서 무료 등급 한도를 초과하는 방법은 이 링크를 참고하세요.

### 고지 사항

모델과 상호작용할 때는 AI를 실험하는 것이므로 콘텐츠 오류가 발생할 수 있음을 기억하세요.
