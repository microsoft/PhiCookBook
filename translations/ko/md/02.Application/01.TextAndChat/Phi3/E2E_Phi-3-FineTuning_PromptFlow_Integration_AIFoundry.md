...
1. *C:\Users\yourUserName\finetune-phi* 경로에 생성한 *finetune-phi* 폴더를 선택합니다.
    ...
    ![생성한 폴더를 선택합니다.](../../../../../../translated_images/04-01-open-project-folder.f734374bcfd5f9e6.ko.png)
...
1. **+ 새로 만들기**를 선택합니다.
    ...
    ![컴퓨트 선택.](../../../../../../translated_images/06-01-select-compute.a29cff290b480252.ko.png)
...
1. 다음 작업을 수행합니다:
    ...
    ![클러스터 생성.](../../../../../../translated_images/06-02-create-cluster.f221b65ae1221d4e.ko.png)
...
1. 다음 내용을 입력합니다:
    ...
    ![클러스터 생성.](../../../../../../translated_images/06-03-create-cluster.4a54ba20914f3662.ko.png)
...
1. 생성한 Azure Machine Learning 작업 영역을 선택합니다.
    ...
    ![생성한 작업 영역 선택.](../../../../../../translated_images/06-04-select-workspace.a92934ac04f4f181.ko.png)
...
1. 다음 작업을 수행합니다:
    ...
    ![phi-3-mini-4k 입력.](../../../../../../translated_images/06-05-type-phi-3-mini-4k.8ab6d2a04418b250.ko.png)

1. 내비게이션 메뉴에서 **파인튜닝**을 선택합니다.

    ![파인튜닝 선택.](../../../../../../translated_images/06-06-select-fine-tune.2918a59be55dfeec.ko.png)
...
1. 다음 작업을 수행합니다:
    ...
    ![파인튜닝 페이지 작성.](../../../../../../translated_images/06-07-fill-finetuning.b6d14c89e7c27d0b.ko.png)
...
1. 이 실습에서는 Azure Machine Learning을 사용하여 Phi-3 모델을 성공적으로 파인튜닝했습니다. 파인튜닝 작업은 상당한 시간이 걸릴 수 있으니 작업이 완료될 때까지 기다려야 합니다. 작업 상태는 Azure Machine Learning 작업 영역 왼쪽 탭의 작업 탭에서 모니터링할 수 있습니다. 다음 시리즈에서는 파인튜닝된 모델을 배포하고 Prompt flow와 통합할 예정입니다.
    ...
    ![파인튜닝 작업 확인.](../../../../../../translated_images/06-08-output.2bd32e59930672b1.ko.png)
...
1. **작업 출력에서**를 선택합니다.
    ...
    ![모델 등록.](../../../../../../translated_images/07-01-register-model.ad1e7cc05e4b2777.ko.png)

1. 생성한 작업을 선택합니다.

    ![작업 선택.](../../../../../../translated_images/07-02-select-job.3e2e1144cd6cd093.ko.png)
...
1. **작업 출력**이 자동으로 선택되어 있는지 확인합니다.
    ...
    ![출력 선택.](../../../../../../translated_images/07-03-select-output.4cf1a0e645baea1f.ko.png)

2. **다음**을 선택합니다.

3. **등록**을 선택합니다.

    ![등록 선택.](../../../../../../translated_images/07-04-register.fd82a3b293060bc7.ko.png)

4. 좌측 탭의 **모델** 메뉴에서 등록된 모델을 조회할 수 있습니다.

    ![등록된 모델.](../../../../../../translated_images/07-05-registered-model.7db9775f58dfd591.ko.png)
...
1. 내비게이션 메뉴에서 **실시간 엔드포인트**를 선택합니다.
    ...
    ![엔드포인트 생성.](../../../../../../translated_images/07-06-create-endpoint.1ba865c606551f09.ko.png)

1. **생성**을 선택합니다.

1. 생성한 등록 모델을 선택합니다.

    ![등록된 모델 선택.](../../../../../../translated_images/07-07-select-registered-model.29c947c37fa30cb4.ko.png)
...
1. 다음 내용을 입력합니다:
    ...
    ![배포 설정 작성.](../../../../../../translated_images/07-08-deployment-setting.43ddc4209e673784.ko.png)
...
1. 생성한 엔드포인트를 선택합니다.
    ...
    ![엔드포인트 선택](../../../../../../translated_images/07-09-check-deployment.325d18cae8475ef4.ko.png)
...
>
> ![트래픽 설정.](../../../../../../translated_images/07-10-set-traffic.085b847e5751ff3d.ko.png)
>
