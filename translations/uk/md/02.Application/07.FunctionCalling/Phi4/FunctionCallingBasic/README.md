...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-17T05:17:36+00:00",
  "source_file": "md/02.Application/07.FunctionCalling/Phi4/FunctionCallingBasic/README.md",
  "language_code": "uk"
}
-->
## **Виклик функцій у Phi-4-mini**

Виклик функцій вперше з’явився у сімействі Phi Family, і тепер ви можете використовувати його через Phi-4-mini.

Цей приклад демонструє симуляцію результатів Прем’єр-ліги. Мета — щоб Phi-4-mini надавав інформацію про матчі в режимі реального часу. Нижче наведено приклад коду:
