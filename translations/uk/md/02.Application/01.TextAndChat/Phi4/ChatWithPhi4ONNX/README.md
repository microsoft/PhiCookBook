...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-17T03:20:06+00:00",
...
***ONNX*** — це відкритий формат, створений для представлення моделей машинного навчання. ONNX визначає спільний набір операторів — будівельних блоків моделей машинного та глибокого навчання — а також спільний формат файлів, що дозволяє розробникам ШІ використовувати моделі з різними фреймворками, інструментами, середовищами виконання та компіляторами.
