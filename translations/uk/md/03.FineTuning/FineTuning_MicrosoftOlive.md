...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-09T19:08:56+00:00",
...
Після встановлення ви можете налаштувати різні параметри, специфічні для моделі, через файл Config, включно з даними, обчисленнями, навчанням, розгортанням та генерацією моделей.
...
Якщо модель є локально, можна використати цей спосіб
...
Всі моделі в Azure мають бути налаштовані на PyTorch.MLflow.

Потрібно мати обліковий запис Hugging face та прив’язати ключ до значення Key в Azure AI Studio / Azure Machine Learning.
...
2. Конвертувати модель у onnx модель з потрібною точністю за допомогою ModelBuilder
...
**Увага**
- Якщо ви використовуєте QLoRA, наразі не підтримується квантизація за допомогою ONNXRuntime-genai.
- Варто зазначити, що ви можете налаштовувати наведені кроки відповідно до своїх потреб. Не обов’язково повністю виконувати всі кроки. Залежно від завдань, можна безпосередньо використовувати алгоритми без тонкого налаштування. Наприкінці потрібно налаштувати відповідні рушії.
