...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-09T19:10:18+00:00",
...
- Генерації LoRA адаптерів (тонко налаштованої моделі) для ефективного виконання на пристрої з ONNX Runtime.
...
4. Дотримуйтесь інструкцій на екрані для підключення до обчислювального ресурсу. Вам потрібно буде вибрати вашу підписку Azure, групу ресурсів, проект і ім’я обчислювального ресурсу, які ви налаштували в Лабораторній роботі 1.
...
### Крок 2: Відкриття папки у VS Code
...
3. **Навчання моделі:** Далі команда `olive finetune` тонко налаштовує квантизовану модель. Квантування моделі *перед* тонким налаштуванням, а не після, дає кращу точність, оскільки процес тонкого налаштування відновлює частину втрат, спричинених квантуванням.
    ...
    Тонке налаштування (100 кроків) займає приблизно **6 хвилин**.

4. **Оптимізація:** Після навчання моделі виконайте оптимізацію за допомогою команди `auto-opt` Olive, яка захоплює ONNX граф і автоматично виконує низку оптимізацій для покращення продуктивності моделі на CPU шляхом стиснення та ф’южн операцій. Варто зазначити, що ви також можете оптимізувати модель для інших пристроїв, таких як NPU або GPU, просто оновивши аргументи `--device` та `--provider` — але для цієї лабораторної роботи ми використовуємо CPU.
...
Потім ви зможете побачити завантажену модель і розгорнути її за адресою https://ml.azure.com/model/list
