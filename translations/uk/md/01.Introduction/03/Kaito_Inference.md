...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-16T20:54:30+00:00",
...
- Керує файлами моделей за допомогою контейнерних образів. HTTP-сервер надається для виконання викликів виведення з використанням бібліотеки моделей.
...
- Розміщує великі образи моделей у публічному Microsoft Container Registry (MCR), якщо ліцензія це дозволяє.
...
Статус workspace можна відстежувати за допомогою наступної команди. Коли у стовпці WORKSPACEREADY з’явиться значення `True`, модель успішно розгорнута.
