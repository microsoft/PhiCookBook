...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-09T20:03:10+00:00",
  "source_file": "md/01.Introduction/03/iOS_Inference_MLX.md",
  "language_code": "uk"
}
-->
# Запуск Phi-3 та Phi-4 на iOS з Apple MLX Framework
...
- Цільовий пристрій iOS 18 (або новіший) з мінімум 8 ГБ оперативної пам’яті (iPhone або iPad, сумісний з вимогами Apple Intelligence, які схожі на вимоги до квантизованих моделей Phi)
...
Спочатку створимо базову структуру для представлення повідомлень чату:
...
Ви можете створювати власні конфігурації моделей, щоб вказувати на будь-яку сумісну модель на Hugging Face. Наприклад, щоб використовувати Phi-4 mini, можна визначити власну конфігурацію:
...
Це дає доступ до останніх конфігурацій моделей, включно з Phi-4, до їх включення в офіційний реліз. Ви можете використовувати цей підхід для роботи з різними версіями моделей Phi або іншими моделями, конвертованими у формат MLX.
...
Інтерфейс складається з трьох основних компонентів, які разом створюють базовий чат. `ContentView` створює інтерфейс з двома станами, який показує або кнопку завантаження, або чат залежно від готовності моделі. `MessageView` відображає окремі повідомлення чату по-різному: повідомлення користувача — праворуч із синім фоном, відповіді моделі Phi — ліворуч із сірим фоном. `TypingIndicatorView` надає простий анімований індикатор, що показує, що ШІ обробляє запит.
