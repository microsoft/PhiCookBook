# **Використання Phi-3 в Microsoft Foundry**

З розвитком генеративного ШІ ми прагнемо використовувати єдину платформу для керування різними LLM та SLM, інтеграції корпоративних даних, операцій тонкого налаштування/RAG, а також оцінки різних бізнес-процесів після інтеграції LLM та SLM, щоб генеративний ШІ міг краще реалізовувати розумні додатки. [Microsoft Foundry](https://ai.azure.com) — це корпоративна платформа для застосування генеративного ШІ.

![aistudo](../../../../translated_images/uk/aifoundry_home.f28a8127c96c7d93.webp)

За допомогою Microsoft Foundry ви можете оцінювати відповіді великих мовних моделей (LLM) та організовувати компоненти застосунків із підказками за допомогою prompt flow для покращення продуктивності. Платформа забезпечує масштабованість, що дозволяє легко перетворювати прототипи в повноцінні продукти. Безперервний моніторинг і вдосконалення підтримують довгостроковий успіх.

Ми можемо швидко розгорнути модель Phi-3 на Microsoft Foundry за допомогою простих кроків, а потім використовувати Microsoft Foundry для виконання пов’язаних із Phi-3 завдань у Playground/Chat, тонкого налаштування, оцінки та інших.
...
Створення проекту та хаба в Microsoft Foundry — це чудовий спосіб організувати та керувати вашою роботою зі ШІ. Ось покрокова інструкція, щоб почати:

### Створення проекту в Microsoft Foundry

1. **Перейдіть до Microsoft Foundry**: Увійдіть у портал Microsoft Foundry.
2. **Створіть проект**:
   - Якщо ви перебуваєте в проекті, виберіть "Microsoft Foundry" у верхньому лівому куті сторінки, щоб перейти на головну сторінку.
...
1. **Перейдіть до Microsoft Foundry**: Увійдіть у свій обліковий запис Azure.
2. **Створіть хаб**:
...
Перейдіть на сторінку розгортання, виберіть Playground і спілкуйтеся з Phi-3 в Microsoft Foundry

## **4. Розгортання моделі з Microsoft Foundry**

Щоб розгорнути модель із каталогу моделей Azure, виконайте такі кроки:

- Увійдіть в Microsoft Foundry.
- Виберіть модель, яку хочете розгорнути, у каталозі моделей Microsoft Foundry.
...
## **5. Використання Phi API в Microsoft Foundry**
