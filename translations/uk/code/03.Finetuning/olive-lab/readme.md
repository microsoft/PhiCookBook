...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-09T20:16:05+00:00",
...
1. **Перегляд даних:** У цьому прикладі ви тонко налаштовуєте модель Phi-3.5-Mini, щоб вона спеціалізувалась на відповідях на питання, пов’язані з подорожами. Наведений код відображає перші кілька записів датасету у форматі JSON lines:
...
> [!NOTE]
> Замініть заповнювачі `{}` на назву вашої групи ресурсів і назву проекту Azure AI.
