...
[![Відкрити та використати приклади у GitHub Codespaces](https://github.com/codespaces/badge.svg)](https://codespaces.new/microsoft/phicookbook)
[![Відкрити у Dev Containers](https://img.shields.io/static/v1?style=for-the-badge&label=Dev%20Containers&message=Open&color=blue&logo=visualstudiocode)](https://vscode.dev/redirect?url=vscode://ms-vscode-remote.remote-containers/cloneInVolume?url=https://github.com/microsoft/phicookbook)

[![Співавтори GitHub](https://img.shields.io/github/contributors/microsoft/phicookbook.svg)](https://GitHub.com/microsoft/phicookbook/graphs/contributors/?WT.mc_id=aiml-137032-kinfeylo)
...
[![PRs Вітаються](https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat-square)](http://makeapullrequest.com?WT.mc_id=aiml-137032-kinfeylo)
...
Phi наразі є найпотужнішою та економічно вигідною маломасштабною мовною моделлю (SLM) з дуже хорошими показниками у багатомовності, розумінні, генерації тексту/чатів, програмуванні, зображеннях, аудіо та інших сценаріях.

Ви можете розгорнути Phi у хмарі або на периферійних пристроях, і легко створювати генеративні AI-додатки з обмеженою обчислювальною потужністю.
...
3. [**Приєднуйтесь до спільноти Microsoft AI Discord, щоб зустріти експертів і інших розробників**](https://discord.com/invite/ByRwuEEgH4?WT.mc_id=aiml-137032-kinfeylo)
...
> ```
> Це дасть вам усе необхідне для виконання курсу з набагато швидшим завантаженням.
...
- Вступ
  ...
  - [Безпека штучного інтелекту для моделей Phi](./md/01.Introduction/01/01.AISafety.md)
...
- Використання Phi Family
    ...
    - [Використання Phi на AI ПК](./md/01.Introduction/03/AIPC_Inference.md)
    - [Використання Phi з фреймворком Apple MLX](./md/01.Introduction/03/MLX_Inference.md)
    - [Використання Phi на локальному сервері](./md/01.Introduction/03/Local_Server_Inference.md)
    - [Використання Phi на віддаленому сервері через AI Toolkit](./md/01.Introduction/03/Remote_Interence.md)
...
-  [Квантування Phi Family](./md/01.Introduction/04/QuantifyingPhi.md)
    - [Квантування Phi-3.5 / 4 з використанням llama.cpp](./md/01.Introduction/04/UsingLlamacppQuantifyingPhi.md)
    - [Квантування Phi-3.5 / 4 з використанням розширень Generative AI для onnxruntime](./md/01.Introduction/04/UsingORTGenAIQuantifyingPhi.md)
    - [Квантування Phi-3.5 / 4 з використанням Intel OpenVINO](./md/01.Introduction/04/UsingIntelOpenVINOQuantifyingPhi.md)
    - [Квантування Phi-3.5 / 4 з використанням Apple MLX Framework](./md/01.Introduction/04/UsingAppleMLXQuantifyingPhi.md)

- Оцінка Phi
    - [Відповідальна AI](./md/01.Introduction/05/ResponsibleAI.md)
    - [Оцінка з Azure AI Foundry](./md/01.Introduction/05/AIFoundry.md)
...
- Приклади розробки додатків Phi
  - Текстові та чат-додатки
    ...
    - Phi-3 / 3.5 Приклади
      - [Локальний чатбот у браузері з Phi3, ONNX Runtime Web та WebGPU](https://github.com/microsoft/onnxruntime-inference-examples/tree/main/js/chat)
      - [OpenVino Chat](./md/02.Application/01.TextAndChat/Phi3/E2E_OpenVino_Chat.md)
      - [Мульти-модель - інтерактивні Phi-3-mini та OpenAI Whisper](./md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-mini_with_whisper.md)
      ...
      -[WinUI3 приклад мульти-модельового AI-записника](https://github.com/microsoft/ai-powered-notes-winui3-sample)
      - [Тонке налаштування та інтеграція власних моделей Phi-3 за допомогою Prompt flow](./md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-FineTuning_PromptFlow_Integration.md)
      - [Тонке налаштування та інтеграція власних моделей Phi-3 за допомогою Prompt flow в Azure AI Foundry](./md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-FineTuning_PromptFlow_Integration_AIFoundry.md)
      - [Оцінка тонко налаштованої моделі Phi-3 / Phi-3.5 в Azure AI Foundry з фокусом на принципи відповідального ШІ Microsoft](./md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-Evaluation_AIFoundry.md)
      - [📓] [Зразок прогнозування мови Phi-3.5-mini-instruct (китайська/англійська)](./md/02.Application/01.TextAndChat/Phi3/phi3-instruct-demo.ipynb)
      ...
      - [Питання і відповіді .NET приклад з локальною ONNX моделлю Phi-3 з використанням Microsoft.ML.OnnxRuntime](../../md/04.HOL/dotnet/src/LabsPhi301)
  ...
  - Приклади коду Azure AI Inference SDK 
    - Phi-4 Приклади 🆕
      - [📓] [Генерація коду проекту з використанням Phi-4-мультимодальної](./md/02.Application/02.Code/Phi4/GenProjectCode/README.md)
    - Приклади Phi-3 / 3.5
      - [Створіть власний Visual Studio Code GitHub Copilot Chat з Microsoft Phi-3 Family](./md/02.Application/02.Code/Phi3/VSCodeExt/README.md)
      - [Створіть власного агента чату Visual Studio Code Copilot з Phi-3.5 за моделями GitHub](/md/02.Application/02.Code/Phi3/CreateVSCodeChatAgentWithGitHubModels.md)

  - Приклади просунутого міркування
    - Phi-4 Приклади 🆕
      - [📓] [Phi-4-mini-mіркування або Phi-4-mіркування Приклади](./md/02.Application/03.AdvancedReasoning/Phi4/AdvancedResoningPhi4mini/README.md)
      - [📓] [Тонке налаштування Phi-4-mini-mіркування з Microsoft Olive](./md/02.Application/03.AdvancedReasoning/Phi4/AdvancedResoningPhi4mini/olive_ft_phi_4_reasoning_with_medicaldata.ipynb)
      - [📓] [Тонке налаштування Phi-4-mini-mіркування з Apple MLX](./md/02.Application/03.AdvancedReasoning/Phi4/AdvancedResoningPhi4mini/mlx_ft_phi_4_reasoning_with_medicaldata.ipynb)
      - [📓] [Phi-4-mini-mіркування з GitHub Models](./md/02.Application/02.Code/Phi4r/github_models_inference.ipynb)
      - [📓] [Phi-4-mini-mіркування з моделями Azure AI Foundry](./md/02.Application/02.Code/Phi4r/azure_models_inference.ipynb)
  - Демонстрації
      ...
      - [Phi-4-мультимодальні демо розміщені на Hugging Face Spaces](https://huggingface.co/spaces/microsoft/phi-4-multimodal?WT.mc_id=aiml-137032-kinfeylo)
  - Приклади зору
    - Phi-4 Приклади 🆕
      - [📓] [Використання Phi-4-мультимодальної для зчитування зображень та генерації коду](./md/02.Application/04.Vision/Phi4/CreateFrontend/README.md) 
    - Phi-3 / 3.5 Приклади
      -  [📓][Phi-3-vision-Зображення текст в текст](./md/02.Application/04.Vision/Phi3/E2E_Phi-3-vision-image-text-to-text-online-endpoint.ipynb)
      ...
      - [📓][Phi-3.5 Vision мульти-кадр або мультізображення приклад](./md/02.Application/04.Vision/Phi3/phi3-vision-demo.ipynb)
      - [Phi-3 Vision локальна ONNX модель з використанням Microsoft.ML.OnnxRuntime .NET](../../md/04.HOL/dotnet/src/LabsPhi303)
      - [Менюна основі Phi-3 Vision локальна ONNX модель з використанням Microsoft.ML.OnnxRuntime .NET](../../md/04.HOL/dotnet/src/LabsPhi304)
  ...
  - Приклади аудіо
    - Phi-4 Приклади 🆕
      - [📓] [Витяг аудіо транскриптів за допомогою Phi-4-мультимодальної](./md/02.Application/05.Audio/Phi4/Transciption/README.md)
      ...
      - [Консольний .NET додаток з використанням Phi-4-мультимодальної аудіо для аналізу аудіофайлу та генерації транскрипту](../../md/04.HOL/dotnet/src/LabsPhi4-MultiModal-02Audio)

  - Приклади MOE
    - Phi-3 / 3.5 Приклади
      - [📓] [Phi-3.5 Модель змішування експертів (MoEs) приклад соціальних мереж](./md/02.Application/06.MoE/Phi3/phi3_moe_demo.ipynb)
      - [📓] [Створення конвеєра Retrieval-Augmented Generation (RAG) з NVIDIA NIM Phi-3 MOE, Azure AI Search та LlamaIndex](./md/02.Application/06.MoE/Phi3/azure-ai-search-nvidia-rag.ipynb)
      - 
  - Приклади виклику функцій
    - Phi-4 Приклади 🆕
      ...
      -  [📓] [Використання виклику функцій для створення мульти-агентів з Phi-4-mini](./md/02.Application/07.FunctionCalling/Phi4/Multiagents/Phi_4_mini_multiagent.ipynb)
  ...
  - Приклади мультимодального змішування
    - Phi-4 Приклади 🆕
      -  [📓] [Використання Phi-4-мультимодальної як технологічного журналіста](./md/02.Application/08.Multimodel/Phi4/TechJournalist/phi_4_mm_audio_text_publish_news.ipynb)
      - [Консольний .NET додаток з використанням Phi-4-мультимодальної для аналізу зображень](../../md/04.HOL/dotnet/src/LabsPhi4-MultiModal-01Images)

- Тонке налаштування прикладів Phi
  ...
  - [Тонке налаштування Phi-3 із AI Toolkit для VS Code](./md/03.FineTuning/Finetuning_VSCodeaitoolkit.md)
  ...
  - [Тонке налаштування Phi-3 і 3.5 Vision](https://github.com/2U1/Phi3-Vision-Finetune)

- Практична лабораторія
  - [Дослідження передових моделей: LLM, SLM, локальна розробка тощо](https://github.com/microsoft/aitour-exploring-cutting-edge-models)
  - [Відкриття потенціалу NLP: тонке налаштування з Microsoft Olive](https://github.com/azure/Ignite_FineTuning_workshop)

- Наукові дослідницькі статті та публікації
  - [Підручники — це все, що вам потрібно II: технічний звіт phi-1.5](https://arxiv.org/abs/2309.05463)
  - [Технічний звіт Phi-3: високоефективна мовна модель локально на вашому телефоні](https://arxiv.org/abs/2404.14219)
  ...
  - [(WhyPHI) Налаштування PHI-3 для відповідей на питання з множинним вибором: методологія, результати та виклики](https://arxiv.org/abs/2501.01588)
...
Ви можете дізнатися, як використовувати Microsoft Phi та як створювати кінцеві рішення (E2E) на різних апаратних пристроях. Щоб випробувати Phi самостійно, почніть з роботи з моделями та налаштовуйте Phi для ваших сценаріїв за допомогою [Azure AI Foundry Azure AI Model Catalog](https://aka.ms/phi3-azure-ai). Ви можете дізнатися більше в розділі Початок роботи з [Azure AI Foundry](/md/02.QuickStart/AzureAIFoundry_QuickStart.md)

**Пісочниця**
Для кожної моделі є власна пісочниця для тестування моделі [Azure AI Playground](https://aka.ms/try-phi3).

### Phi на GitHub Models

Ви можете дізнатися, як використовувати Microsoft Phi та як створювати кінцеві рішення (E2E) на різних апаратних пристроях. Щоб випробувати Phi самостійно, почніть з роботи з моделлю та налаштовуйте Phi для ваших сценаріїв за допомогою [GitHub Model Catalog](https://github.com/marketplace/models?WT.mc_id=aiml-137032-kinfeylo). Ви можете дізнатися більше в розділі Початок роботи з [GitHub Model Catalog](/md/02.QuickStart/GitHubModel_QuickStart.md)

**Пісочниця**
Для кожної моделі є власна [пісочниця для тестування моделей](/md/02.QuickStart/GitHubModel_QuickStart.md).
...
### Серія Copilot
[![Copilot для AI-паралельного програмування](https://img.shields.io/badge/Copilot%20for%20AI%20Paired%20Programming-FACC15?style=for-the-badge&labelColor=E5E7EB&color=FACC15)](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)
...
Microsoft прагне допомагати нашим клієнтам відповідально використовувати наші AI-продукти, ділитися отриманими знаннями та будувати партнерства на основі довіри за допомогою інструментів, таких як Transparency Notes та Impact Assessments. Багато з цих ресурсів можна знайти за адресою [https://aka.ms/RAI](https://aka.ms/RAI).  
Підхід Microsoft до відповідального AI базується на наших принципах AI: справедливість, надійність та безпека, приватність і захист, інклюзивність, прозорість та підзвітність.

Великомасштабні моделі природної мови, зображень і мови – як ті, що використовуються в цьому прикладі – потенційно можуть поводитись несправедливо, ненадійно або образливо, що може спричинити шкоду. Будь ласка, ознайомтесь із [Transparency note сервісу Azure OpenAI](https://learn.microsoft.com/legal/cognitive-services/openai/transparency-note?tabs=text), щоб бути поінформованими про ризики та обмеження.

Рекомендований підхід до зменшення цих ризиків – включення системи безпеки у вашу архітектуру, яка може виявляти та запобігати шкідливій поведінці. [Azure AI Content Safety](https://learn.microsoft.com/azure/ai-services/content-safety/overview) надає незалежний рівень захисту, здатний виявляти шкідливий вміст, створений користувачами або AI, у застосунках і службах. Azure AI Content Safety включає текстові та графічні API, які дозволяють виявляти шкідливий матеріал. В межах Azure AI Foundry сервіс Content Safety дозволяє переглядати, досліджувати та випробовувати приклади коду для виявлення шкідливого контенту в різних модальностях. Наступна [документація швидкого старту](https://learn.microsoft.com/azure/ai-services/content-safety/quickstart-text?tabs=visual-studio%2Clinux&pivots=programming-language-rest) проводить вас через процес звернень до сервісу.
Іншим аспектом, який слід враховувати, є загальна продуктивність застосунку. Для мультимодальних та мультимодельних застосунків ми вважаємо продуктивність такою, що система працює, як ви та ваші користувачі очікують, включно з тим, що не генерує шкідливі результати. Важливо оцінити продуктивність вашого загального застосунку за допомогою [оцінювачів Продуктивності, Якості, Ризику та Безпеки](https://learn.microsoft.com/azure/ai-studio/concepts/evaluation-metrics-built-in). Ви також маєте можливість створювати та оцінювати з допомогою [власних оцінювачів](https://learn.microsoft.com/azure/ai-studio/how-to/develop/evaluate-sdk#custom-evaluators).

Ви можете оцінити свій AI-застосунок у вашому середовищі розробки, використовуючи [Azure AI Evaluation SDK](https://microsoft.github.io/promptflow/index.html). За наявності тестового набору даних або цілі, генерації вашого генеративного AI-застосунку кількісно вимірюються з допомогою вбудованих або власних оцінювачів за вашим вибором. Щоб розпочати роботу з azure ai evaluation sdk для оцінки вашої системи, ви можете слідувати [швидкому посібнику](https://learn.microsoft.com/azure/ai-studio/how-to/develop/flow-evaluate-sdk). Після виконання оцінювання ви можете [візуалізувати результати в Azure AI Foundry](https://learn.microsoft.com/azure/ai-studio/how-to/evaluate-flow-results).
...
Використання торгових марок або логотипів Microsoft у модифікованих версіях цього проєкту не має спричиняти плутанину або натякати на спонсорство Microsoft. Будь-яке використання торгових марок або логотипів третіх сторін підпорядковується їхнім політикам.

## Отримання допомоги

Якщо у вас виникли труднощі або є запитання щодо створення AI-застосунків, приєднуйтесь:
