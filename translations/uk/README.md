...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2026-01-05T15:56:42+00:00",
...
[![Відкрити та використовувати приклади у GitHub Codespaces](https://github.com/codespaces/badge.svg)](https://codespaces.new/microsoft/phicookbook)
...
Зараз Phi є найпотужнішою та найефективнішою за вартістю малою мовною моделлю (SLM), з дуже добрими показниками в багатомовності, логічному висновку, генерації тексту/чатів, програмуванні, зображеннях, аудіо та інших сценаріях.

Ви можете розгортати Phi у хмарі або на пристроях на кордоні мережі, і легко створювати генеративні AI-додатки з обмеженою обчислювальною потужністю.

Виконайте ці кроки, щоб почати використовувати цей ресурс:
1. **Форкніть репозиторій**: Клацніть [![Форки GitHub](https://img.shields.io/github/forks/microsoft/phicookbook.svg?style=social&label=Fork)](https://GitHub.com/microsoft/phicookbook/network/?WT.mc_id=aiml-137032-kinfeylo)
...
> ```
> Це надає вам все необхідне для проходження курсу значно швидше.
...
- Виконання Phi у різних середовищах
...
- Виконання Phi Family
    - [Виконання Phi в iOS](./md/01.Introduction/03/iOS_Inference.md)
    - [Виконання Phi в Android](./md/01.Introduction/03/Android_Inference.md)
    - [Виконання Phi в Jetson](./md/01.Introduction/03/Jetson_Inference.md)
    - [Виконання Phi в AI PC](./md/01.Introduction/03/AIPC_Inference.md)
...
-  [Квантитативний аналіз Phi Family](./md/01.Introduction/04/QuantifyingPhi.md)
    - [Квантування Phi-3.5 / 4 за допомогою llama.cpp](./md/01.Introduction/04/UsingLlamacppQuantifyingPhi.md)
    - [Квантування Phi-3.5 / 4 за допомогою розширень генеративного AI для onnxruntime](./md/01.Introduction/04/UsingORTGenAIQuantifyingPhi.md)
...
- RAG з Azure AI Search
    - [Як використовувати Phi-4-mini і Phi-4-мультимодальну (RAG) з Azure AI Search](https://github.com/microsoft/PhiCookBook/blob/main/code/06.E2E/E2E_Phi-4-RAG-Azure-AI-Search.ipynb)
...
- Приклади розробки додатків Phi
  - Текстові та чат-додатки
    - Phi-4 приклади 🆕
      ...
      - [Консольний додаток для чату на .NET з Phi-4 ONNX за допомогою Semantic Kernel](../../md/04.HOL/dotnet/src/LabsPhi4-Chat-02SK)
    - Phi-3 / 3.5 приклади
      ...
      - [MLFlow - Побудова обгортки та використання Phi-3 з MLFlow](./md//02.Application/01.TextAndChat/Phi3/E2E_Phi-3-MLflow.md)
      - [Оптимізація моделі - Як оптимізувати модель Phi-3-min для ONNX Runtime Web з Olive](https://github.com/microsoft/Olive/tree/main/examples/phi3)
      - [WinUI3 Застосунок з Phi-3 mini-4k-instruct-onnx](https://github.com/microsoft/Phi3-Chat-WinUI3-Sample/)
      -[WinUI3 Застосунок для нотаток з підтримкою ШІ на базі Multi Model](https://github.com/microsoft/ai-powered-notes-winui3-sample)
      ...
      - [Тонке налаштування та інтеграція кастомних моделей Phi-3 з Prompt flow у Azure AI Foundry](./md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-FineTuning_PromptFlow_Integration_AIFoundry.md)
      ...
      - [📓] [Приклад прогнозування мови Phi-3.5-mini-instruct (китайською/англійською)](./md/02.Application/01.TextAndChat/Phi3/phi3-instruct-demo.ipynb)
      ...
      - [Використання Microsoft Phi-3.5 tflite для створення Android застосунку](./md/02.Application/01.TextAndChat/Phi3/UsingPhi35TFLiteCreateAndroidApp.md)
      - [Приклад Q&A .NET з локальною моделлю ONNX Phi-3 з використанням Microsoft.ML.OnnxRuntime](../../md/04.HOL/dotnet/src/LabsPhi301)
      - [Консольний чат .NET застосунок із Semantic Kernel та Phi-3](../../md/04.HOL/dotnet/src/LabsPhi302)

  - Приклади коду на базі Azure AI Inference SDK 
    - Phi-4 Приклади 🆕
      - [📓] [Генерація коду проєкту з використанням Phi-4-multimodal](./md/02.Application/02.Code/Phi4/GenProjectCode/README.md)
    - Phi-3 / 3.5 Приклади
      ...
      - [Створіть власного агента для чату Visual Studio Code Copilot з Phi-3.5 за моделями GitHub](/md/02.Application/02.Code/Phi3/CreateVSCodeChatAgentWithGitHubModels.md)
  ...
  - Приклади розширеного мислення
    - Phi-4 Приклади 🆕
      ...
      - [📓] [Phi-4-mini-reasoning з GitHub Моделями](./md/02.Application/02.Code/Phi4r/github_models_inference.ipynb)
      - [📓] [Phi-4-mini-reasoning з Azure AI Foundry Моделями](./md/02.Application/02.Code/Phi4r/azure_models_inference.ipynb)
  - Демо
      ...
      - [Phi-4-multimodal демонстрації на Hugging Face Spaces](https://huggingface.co/spaces/microsoft/phi-4-multimodal?WT.mc_id=aiml-137032-kinfeylo)
  - Приклади для Vision
    - Phi-4 Приклади 🆕
    ...
    - Phi-3 / 3.5 Приклади
      -  [📓][Phi-3-vision - текст із зображення у текст](./md/02.Application/04.Vision/Phi3/E2E_Phi-3-vision-image-text-to-text-online-endpoint.ipynb)
      ...
      - [ДЕМO: переробка Phi-3](https://github.com/jennifermarsman/PhiRecycling/)
      - [Phi-3-vision - Візуальний мовний помічник - з Phi3-Vision та OpenVINO](https://docs.openvino.ai/nightly/notebooks/phi-3-vision-with-output.html)
      - [Phi-3 Vision Nvidia NIM](./md/02.Application/04.Vision/Phi3/E2E_Nvidia_NIM_Vision.md)
      - [Phi-3 Vision OpenVino](./md/02.Application/04.Vision/Phi3/E2E_OpenVino_Phi3Vision.md)
      - [📓][Phi-3.5 Vision мультикадровий або мультизображений приклад](./md/02.Application/04.Vision/Phi3/phi3-vision-demo.ipynb)
      - [Phi-3 Vision Локальна модель ONNX з Microsoft.ML.OnnxRuntime .NET](../../md/04.HOL/dotnet/src/LabsPhi303)
      - [Меню-орієнтована Phi-3 Vision Локальна модель ONNX з Microsoft.ML.OnnxRuntime .NET](../../md/04.HOL/dotnet/src/LabsPhi304)
  ...
  - Приклади з аудіо
    - Phi-4 Приклади 🆕
      - [📓] [Витягування аудіо транскриптів з Phi-4-multimodal](./md/02.Application/05.Audio/Phi4/Transciption/README.md)
      ...
      - [.NET консольний застосунок з Phi-4-multimodal Audio для аналізу аудіофайлу та генерації транскрипту](../../md/04.HOL/dotnet/src/LabsPhi4-MultiModal-02Audio)

  - Приклади MOE
    - Phi-3 / 3.5 Приклади
      - [📓] [Phi-3.5 Моделі Mixture of Experts (MoEs) приклад для соцмереж](./md/02.Application/06.MoE/Phi3/phi3_moe_demo.ipynb)
  ...
  - Приклади мульти-модального змішування
    - Phi-4 Приклади 🆕
      -  [📓] [Використання Phi-4-multimodal як технологічний журналіст](./md/02.Application/08.Multimodel/Phi4/TechJournalist/phi_4_mm_audio_text_publish_news.ipynb)
      - [.NET консольний застосунок з Phi-4-multimodal для аналізу зображень](../../md/04.HOL/dotnet/src/LabsPhi4-MultiModal-01Images)
...
- Тонке налаштування Phi Приклади
  ...
  - [Практичний лабораторний курс тонкого налаштування з Microsoft Olive](./md/03.FineTuning/olive-lab/readme.md)
...
- Академічні дослідницькі статті та публікації
  ...
  - [Технічний звіт Phi-3: Потужна мовна модель, що працює локально на вашому телефоні](https://arxiv.org/abs/2404.14219)
  ...
  - [(WhyPHI) Тонке налаштування PHI-3 для відповідей на запитання з вибором варіанту: методологія, результати та виклики](https://arxiv.org/abs/2501.01588)
...
Ви можете навчитися використовувати Microsoft Phi та створювати наскрізні рішення на різних апаратних пристроях. Щоб особисто ознайомитись з Phi, почніть експериментувати з моделями та налаштовувати Phi під свої сценарії, використовуючи [Каталог моделей Azure AI Foundry](https://aka.ms/phi3-azure-ai). Дізнатись більше можна в розділі Початок роботи з [Azure AI Foundry](/md/02.QuickStart/AzureAIFoundry_QuickStart.md).

**Пісочниця**  
Для кожної моделі є спеціальна пісочниця для тестування моделей [Azure AI Playground](https://aka.ms/try-phi3).

### Phi на моделях GitHub

Ви можете навчитися використовувати Microsoft Phi та створювати наскрізні рішення на різних апаратних пристроях. Щоб особисто ознайомитись з Phi, почніть експериментувати з моделлю та налаштовувати Phi під свої сценарії, використовуючи [Каталог моделей GitHub](https://github.com/marketplace/models?WT.mc_id=aiml-137032-kinfeylo). Дізнатись більше можна в розділі Початок роботи з [Каталогом моделей GitHub](/md/02.QuickStart/GitHubModel_QuickStart.md).

**Пісочниця**  
Для кожної моделі є спеціальна [пісочниця для тестування моделей](/md/02.QuickStart/GitHubModel_QuickStart.md).
...
Microsoft прагне допомогти нашим клієнтам відповідально використовувати наші продукти ШІ, ділитися нашими напрацюваннями та будувати довірчі партнерські відносини через інструменти, такі як Ноти про прозорість і Оцінки впливу. Багато з цих ресурсів доступні за адресою [https://aka.ms/RAI](https://aka.ms/RAI).  
Підхід Microsoft до відповідального ШІ базується на наших принципах ШІ: справедливість, надійність і безпека, конфіденційність і захист, інклюзивність, прозорість і підзвітність.

Великомасштабні моделі природної мови, зображень і голосу — як ті, що використовуються у цьому прикладі — потенційно можуть працювати несправедливо, ненадійно або образливо, що може завдати шкоди. Будь ласка, ознайомтесь із [Нотою про прозорість служби Azure OpenAI](https://learn.microsoft.com/legal/cognitive-services/openai/transparency-note?tabs=text), щоб дізнатися про ризики та обмеження.

Рекомендований підхід для зменшення цих ризиків — включити в вашу архітектуру систему безпеки, що може виявляти і запобігати шкідливій поведінці. [Azure AI Content Safety](https://learn.microsoft.com/azure/ai-services/content-safety/overview) пропонує незалежний рівень захисту, здатний виявляти шкідливий контент, створений користувачами та ШІ, у застосунках і сервісах. Azure AI Content Safety включає API для тексту та зображень, які дозволяють виявляти шкідливий матеріал. В межах Azure AI Foundry сервіс Content Safety дозволяє переглядати, досліджувати та випробовувати зразки коду для виявлення шкідливого контенту в різних модальностях. Наступна [документація швидкого старту](https://learn.microsoft.com/azure/ai-services/content-safety/quickstart-text?tabs=visual-studio%2Clinux&pivots=programming-language-rest) допоможе вам робити запити до сервісу.

Іншим аспектом є загальна продуктивність застосунку. У багатомодальних і багатомодельних застосунках продуктивність означає, що система працює так, як ви та ваші користувачі очікують, включно з тим, щоб не генерувати шкідливі результати. Важливо оцінювати продуктивність вашого застосунку загалом за допомогою [оцінювачів продуктивності, якості, ризиків і безпеки](https://learn.microsoft.com/azure/ai-studio/concepts/evaluation-metrics-built-in). Ви також можете створювати та оцінювати з [кастомними оцінювачами](https://learn.microsoft.com/azure/ai-studio/how-to/develop/evaluate-sdk#custom-evaluators).
Ви можете оцінити свій AI-додаток у вашому середовищі розробки, використовуючи [Azure AI Evaluation SDK](https://microsoft.github.io/promptflow/index.html). За наявності тестового набору даних або цільового завдання, генерації вашого генеративного AI-додатку кількісно вимірюються за допомогою вбудованих або кастомних оцінювачів на ваш вибір. Щоб почати працювати з azure ai evaluation sdk для оцінки вашої системи, ви можете скористатися [інструкцією швидкого старту](https://learn.microsoft.com/azure/ai-studio/how-to/develop/flow-evaluate-sdk). Після виконання оцінки ви можете [візуалізувати результати в Azure AI Foundry](https://learn.microsoft.com/azure/ai-studio/how-to/evaluate-flow-results). 

## Товарні знаки

Цей проект може містити товарні знаки або логотипи проектів, продуктів чи послуг. Авторизоване використання торгових марок або логотипів Microsoft підпорядковується і має дотримуватись [Керівництва Microsoft щодо торгових марок та брендів](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
Використання торгових марок або логотипів Microsoft у змінених версіях цього проекту не повинно спричиняти плутанину або натякати на спонсорство Microsoft. Використання торгових марок або логотипів третіх сторін підпорядковується політикам цих третіх сторін.
...
Цей документ був перекладений за допомогою сервісу автоматичного перекладу [Co-op Translator](https://github.com/Azure/co-op-translator). Хоча ми прагнемо до точності, зверніть увагу, що автоматичні переклади можуть містити помилки або неточності. Оригінальний документ рідною мовою слід вважати авторитетним джерелом. Для важливої інформації рекомендується звертатися до професійного людського перекладу. Ми не несемо відповідальності за будь-які непорозуміння або неправильні тлумачення, що виникли внаслідок використання цього перекладу.
