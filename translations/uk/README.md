...
На сьогодні Phi є найпотужнішою та найбільш економічно вигідною малою мовною моделлю (SLM) з дуже хорошими результатами в багатомовності, мисленні, генерації тексту/чатів, кодуванні, обробці зображень, аудіо та інших сценаріях.

Ви можете розгорнути Phi в хмарі або на пристроях на краю мережі, і легко створювати генеративні AI-додатки з обмеженими обчислювальними ресурсами.
...
3. [**Приєднуйтесь до спільноти Microsoft AI в Discord і спілкуйтесь з експертами та іншими розробниками**](https://discord.com/invite/ByRwuEEgH4?WT.mc_id=aiml-137032-kinfeylo)
...
> Цей репозиторій містить понад 50 перекладів, які значно збільшують розмір завантаження. Щоб клонувати без перекладів, використовуйте sparse checkout:
> ```bash
...
- Виведення Phi в різних середовищах
...
- Виведення сімейства Phi
    - [Виведення Phi на iOS](./md/01.Introduction/03/iOS_Inference.md)
    - [Виведення Phi на Android](./md/01.Introduction/03/Android_Inference.md)
    - [Виведення Phi на Jetson](./md/01.Introduction/03/Jetson_Inference.md)
    - [Виведення Phi на AI ПК](./md/01.Introduction/03/AIPC_Inference.md)
    - [Виведення Phi з використанням Apple MLX Framework](./md/01.Introduction/03/MLX_Inference.md)
    - [Виведення Phi на локальному сервері](./md/01.Introduction/03/Local_Server_Inference.md)
    - [Виведення Phi на віддаленому сервері з AI Toolkit](./md/01.Introduction/03/Remote_Interence.md)
    - [Виведення Phi з Rust](./md/01.Introduction/03/Rust_Inference.md)
    - [Виведення Phi—Vision локально](./md/01.Introduction/03/Vision_Inference.md)
    - [Виведення Phi з Kaito AKS, Azure Containers (офіційна підтримка)](./md/01.Introduction/03/Kaito_Inference.md)
-  [Квантифікація сімейства Phi](./md/01.Introduction/04/QuantifyingPhi.md)
    - [Квантифікація Phi-3.5 / 4 з використанням llama.cpp](./md/01.Introduction/04/UsingLlamacppQuantifyingPhi.md)
    - [Квантифікація Phi-3.5 / 4 з використанням розширень Generative AI для onnxruntime](./md/01.Introduction/04/UsingORTGenAIQuantifyingPhi.md)
    - [Квантифікація Phi-3.5 / 4 з використанням Intel OpenVINO](./md/01.Introduction/04/UsingIntelOpenVINOQuantifyingPhi.md)
    - [Квантифікація Phi-3.5 / 4 з використанням Apple MLX Framework](./md/01.Introduction/04/UsingAppleMLXQuantifyingPhi.md)
...
- RAG з Azure AI Search
    - [Як використовувати Phi-4-mini та Phi-4-мультимодальну (RAG) з Azure AI Search](https://github.com/microsoft/PhiCookBook/blob/main/code/06.E2E/E2E_Phi-4-RAG-Azure-AI-Search.ipynb)

- Приклади розробки додатків Phi
  - Текстові та чат-додатки
    - Phi-4 Приклади 🆕
      - [📓] [Чат із моделлю Phi-4-mini ONNX](./md/02.Application/01.TextAndChat/Phi4/ChatWithPhi4ONNX/README.md)
      - [Чат з локальною моделлю Phi-4 ONNX .NET](../../md/04.HOL/dotnet/src/LabsPhi4-Chat-01OnnxRuntime)
      - [Чат .NET Console App з Phi-4 ONNX за допомогою Semantic Kernel](../../md/04.HOL/dotnet/src/LabsPhi4-Chat-02SK)
    - Phi-3 / 3.5 Приклади
      ...
      - [Оцінка тонко налаштованої моделі Phi-3 / Phi-3.5 в Azure AI Foundry з фокусом на принципах відповідального ШІ від Microsoft](./md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-Evaluation_AIFoundry.md)
      ...
      - [Приклад Q&A .NET з використанням локальної моделі ONNX Phi-3 за допомогою Microsoft.ML.OnnxRuntime](../../md/04.HOL/dotnet/src/LabsPhi301)
      - [Консольний чат .NET додаток з Semantic Kernel та Phi-3](../../md/04.HOL/dotnet/src/LabsPhi302)

  - Зразки коду на основі Azure AI Inference SDK
    - Зразки Phi-4 🆕
    ...
    - Зразки Phi-3 / 3.5
      ...
      - [Створіть власного агента чату Visual Studio Code Copilot з Phi-3.5 за допомогою моделей GitHub](/md/02.Application/02.Code/Phi3/CreateVSCodeChatAgentWithGitHubModels.md)

  - Зразки розширених міркувань
    - Зразки Phi-4 🆕
  ...
  - Демонстрації
      - [Демонстрації Phi-4-mini на Hugging Face Spaces](https://huggingface.co/spaces/microsoft/phi-4-mini?WT.mc_id=aiml-137032-kinfeylo)
      - [Демонстрації Phi-4-multimodal на Hugging Face Spaces](https://huggingface.co/spaces/microsoft/phi-4-multimodal?WT.mc_id=aiml-137032-kinfeylo)
  - Зразки з обробки зору
    - Зразки Phi-4 🆕
      - [📓] [Використовуйте Phi-4-multimodal для читання зображень та генерації коду](./md/02.Application/04.Vision/Phi4/CreateFrontend/README.md) 
    - Зразки Phi-3 / 3.5
      ...
      - [📓][Phi-3.5 Vision мультикадровий або мультизображення зразок](./md/02.Application/04.Vision/Phi3/phi3-vision-demo.ipynb)
      - [Phi-3 Vision локальна модель ONNX із Microsoft.ML.OnnxRuntime .NET](../../md/04.HOL/dotnet/src/LabsPhi303)
      - [Меню-базована локальна модель Phi-3 Vision ONNX з Microsoft.ML.OnnxRuntime .NET](../../md/04.HOL/dotnet/src/LabsPhi304)

  - Зразки математичних розрахунків
  ...
  - Зразки аудіо
    - Зразки Phi-4 🆕
      - [📓] [Витяг аудіо транскриптів за допомогою Phi-4-multimodal](./md/02.Application/05.Audio/Phi4/Transciption/README.md)
      - [📓] [Аудіо зразок Phi-4-multimodal](./md/02.Application/05.Audio/Phi4/Siri/demo.ipynb)
      - [📓] [Зразок мовного перекладу Phi-4-multimodal](./md/02.Application/05.Audio/Phi4/Translate/demo.ipynb)
      - [Консольний .NET додаток з використанням Phi-4-multimodal Audio для аналізу аудіофайлу та генерації транскрипту](../../md/04.HOL/dotnet/src/LabsPhi4-MultiModal-02Audio)

  - Зразки MOE (Мікс експертних моделей)
    - Зразки Phi-3 / 3.5
      - [📓] [Модель суміші експертів Phi-3.5 (MoEs) - зразок для соцмереж](./md/02.Application/06.MoE/Phi3/phi3_moe_demo.ipynb)
      - [📓] [Побудова pipeline із генерацією з підкріпленням (RAG) з NVIDIA NIM Phi-3 MOE, Azure AI Search та LlamaIndex](./md/02.Application/06.MoE/Phi3/azure-ai-search-nvidia-rag.ipynb)
      - 
  ...
  - Зразки мультимодального змішування
    - Зразки Phi-4 🆕
      ...
      - [Консольний .NET додаток з використанням Phi-4-multimodal для аналізу зображень](../../md/04.HOL/dotnet/src/LabsPhi4-MultiModal-01Images)

- Тонке налаштування Phi моделей
  ...
  - [Практична лабораторія з тонкого налаштування за допомогою Microsoft Olive](./md/03.FineTuning/olive-lab/readme.md)
...
- Практична лабораторія
  - [Огляд найсучасніших моделей: LLMs, SLMs, локальна розробка тощо](https://github.com/microsoft/aitour-exploring-cutting-edge-models)
...
- Академічні дослідницькі статті та публікації
  - [Підручники — все, що вам потрібно II: технічний звіт phi-1.5](https://arxiv.org/abs/2309.05463)
  ...
  - [Технічний звіт Phi-4-Mini: компактні, але потужні мультимодальні мовні моделі через суміш LoRA](https://arxiv.org/abs/2503.01743)
  - [Оптимізація малих мовних моделей для виклику функцій у транспортному засобі](https://arxiv.org/abs/2501.02342)
  - [(WhyPHI) Додаткове навчання PHI-3 для відповіді на питання з множинним вибором: методологія, результати та виклики](https://arxiv.org/abs/2501.01588)
...
Ви можете дізнатися, як використовувати Microsoft Phi та як створювати комплексні рішення на різних апаратних пристроях. Щоб випробувати Phi особисто, почніть гратися з моделями та налаштовувати Phi під ваші сценарії за допомогою [Azure AI Foundry Azure AI Model Catalog](https://aka.ms/phi3-azure-ai). Більше інформації у розділі Початок роботи з [Azure AI Foundry](/md/02.QuickStart/AzureAIFoundry_QuickStart.md)

**Плейграунд**
Кожна модель має спеціальний плейграунд для тестування моделі [Azure AI Playground](https://aka.ms/try-phi3).

### Phi на GitHub Models

Ви можете дізнатися, як використовувати Microsoft Phi і як створювати комплексні рішення на різних апаратних пристроях. Щоб випробувати Phi особисто, почніть гратися з моделлю та налаштовувати Phi під ваші сценарії за допомогою [GitHub Model Catalog](https://github.com/marketplace/models?WT.mc_id=aiml-137032-kinfeylo). Більше інформації у розділі Початок роботи з [GitHub Model Catalog](/md/02.QuickStart/GitHubModel_QuickStart.md)

**Плейграунд**
Кожна модель має спеціальний [плейграунд для тестування моделі](/md/02.QuickStart/GitHubModel_QuickStart.md).
...
**Плейграунд**
 [Плейграунд Hugging Chat](https://huggingface.co/chat/models/microsoft/Phi-3-mini-4k-instruct)
...
Microsoft прагне допомогти нашим клієнтам відповідально використовувати продукти зі штучним інтелектом, ділитися своїм досвідом та будувати партнерства на основі довіри за допомогою інструментів, таких як Примітки щодо прозорості та Оцінки впливу. Багато з цих ресурсів можна знайти за адресою [https://aka.ms/RAI](https://aka.ms/RAI).
Підхід Microsoft до відповідального AI базується на наших принципах AI: справедливість, надійність і безпека, конфіденційність і безпека, інклюзивність, прозорість і підзвітність.

Великомасштабні моделі для природньої мови, зображень та мови — як ті, що використовуються в цьому прикладі — потенційно можуть поводитися несправедливо, ненадійно або образливо, що може призводити до шкоди. Будь ласка, ознайомтеся з [Приміткою щодо прозорості служби Azure OpenAI](https://learn.microsoft.com/legal/cognitive-services/openai/transparency-note?tabs=text), щоб отримати інформацію про ризики та обмеження.

Рекомендований підхід для пом’якшення цих ризиків — включити систему безпеки у вашу архітектуру, яка може виявляти та запобігати шкідливій поведінці. [Azure AI Content Safety](https://learn.microsoft.com/azure/ai-services/content-safety/overview) забезпечує незалежний рівень захисту, здатний виявляти шкідливий контент, створений користувачами та AI, у додатках і службах. Azure AI Content Safety включає API для тексту і зображень, які дозволяють виявляти шкідливий матеріал. У складі Azure AI Foundry служба Content Safety дозволяє переглядати, досліджувати та пробувати приклади коду для виявлення шкідливого контенту в різних модальностях. Наступна [документація для швидкого старту](https://learn.microsoft.com/azure/ai-services/content-safety/quickstart-text?tabs=visual-studio%2Clinux&pivots=programming-language-rest) допоможе вам зробити запити до служби.
Іншим аспектом, який слід враховувати, є загальна продуктивність застосунку. Для мультимодальних і мультимодельних застосунків ми вважаємо продуктивність такою, щоб система працювала відповідно до ваших і користувачів очікувань, включно з тим, щоб не генерувати шкідливі результати. Важливо оцінити продуктивність вашого загального застосунку за допомогою [оцінювачів продуктивності, якості, ризиків і безпеки](https://learn.microsoft.com/azure/ai-studio/concepts/evaluation-metrics-built-in). Ви також маєте можливість створювати і оцінювати за допомогою [індивідуальних оцінювачів](https://learn.microsoft.com/azure/ai-studio/how-to/develop/evaluate-sdk#custom-evaluators).

Ви можете оцінити ваш AI-застосунок у середовищі розробки за допомогою [Azure AI Evaluation SDK](https://microsoft.github.io/promptflow/index.html). Маючи тестовий набір даних або цільову мету, генеровані вихідні дані вашого генеративного AI-застосунку кількісно вимірюються за допомогою вбудованих або індивідуальних оцінювачів на ваш вибір. Щоб почати роботу з azure ai evaluation sdk для оцінки вашої системи, ви можете скористатися [швидким посібником](https://learn.microsoft.com/azure/ai-studio/how-to/develop/flow-evaluate-sdk). Після виконання запуску оцінки, ви можете [візуалізувати результати в Azure AI Foundry](https://learn.microsoft.com/azure/ai-studio/how-to/evaluate-flow-results). 

## Торгові марки

Цей проєкт може містити торгові марки або логотипи проєктів, продуктів чи послуг. Авторизоване використання торгових марок або логотипів Microsoft регламентується і повинно відповідати [Керівництву з використання торгових марок і брендів Microsoft](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
Використання торгових марок або логотипів Microsoft у змінених версіях цього проєкту не повинно викликати плутанину або припускати спонсорство Microsoft. Будь-яке використання торгових марок або логотипів третіх сторін підпорядковується політикам цих третіх сторін.

## Отримання допомоги

Якщо у вас виникли труднощі чи питання щодо створення AI-застосунків, приєднуйтеся:
