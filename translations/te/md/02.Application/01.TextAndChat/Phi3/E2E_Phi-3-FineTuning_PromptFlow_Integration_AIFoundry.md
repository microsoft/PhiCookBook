...
![Phi-3 ఫైన్‑ట్యూనింగ్ మరియు PromptFlow సమీకరణ అవలోకనం.](../../../../../../translated_images/00-01-architecture.198ba0f1ae6d841a.te.png)
...
1. పోర్టల్ పేజీ టాప్ లోని **search bar**లో *azure machine learning* టైప్ చేసి కనిపించే ఆప్షన్లలోని **Azure Machine Learning**ని ఎంచుకోండి.
    ...
    ![azure machine learning టైప్ చేయండి.](../../../../../../translated_images/01-01-type-azml.acae6c5455e67b4b.te.png)

2. నావిగేషన్ మెనూ నుండి **+ Create** ఎంచుకోండి.

3. నావిగేషన్ మెనూ నుండి **New workspace** ఎంచుకోండి.

    ![new workspace ఎంచుకోండి.](../../../../../../translated_images/01-02-select-new-workspace.cd09cd0ec4a60ef2.te.png)
...
4. క్రింద ఇవ్వబడిన పనులను చేయండి:
    ...
    ![azure machine learning ఫిలింగ్ చేయండి.](../../../../../../translated_images/01-03-fill-AZML.a1b6fd944be0090f.te.png)
...
1. పోర్టల్ పేజీ టాప్ లోని **search bar**లో *managed identities* టైప్ చేసి కనిపించే ఆప్షన్లలో **Managed Identities**ని ఎంచుకోండి.
    ...
    ![managed identities టైప్ చేయండి.](../../../../../../translated_images/03-01-type-managed-identities.24de763e0f1f37e5.te.png)

1. **+ Create** ఎంచుకోండి.

    ![Create ఎంచుకోండి.](../../../../../../translated_images/03-02-select-create.92bf8989a5cd98f2.te.png)
...
1. క్రింద ఇచ్చిన పనులు చేయండి:
    ...
    ![Managed identities సమాచారాన్ని పూరించండి.](../../../../../../translated_images/03-03-fill-managed-identities-1.ef1d6a2261b449e0.te.png)
...
1. Add role assignment పేజీలో, క్రింద ఇచ్చిన పనులను చేయండి:
    ...
    ![contributor role సమాచారాన్ని పూరించండి.](../../../../../../translated_images/03-04-fill-contributor-role.73990bc6a32e140d.te.png)
...
1. పోర్టల్ పేజీ టాప్ లోని **search bar**లో *storage accounts* టైప్ చేసి కనిపించే ఆప్షన్లలో **Storage accounts**ను ఎంచుకోండి.
    ...
    ![storage accounts టైప్ చేయండి.](../../../../../../translated_images/03-05-type-storage-accounts.9303de485e65e1e5.te.png)
...
1. Add role assignment పేజీలో క్రింద ఇచ్చిన పనులను చేయండి:
    ...
    ![Managed identity ఎంపిక చేయండి.](../../../../../../translated_images/03-08-select-managed-identity.e80a2aad5247eb25.te.png)
...
1. పోర్టల్ పేజీ టాప్ లోని **search bar**లో *container registries* టైప్ చేసి కనిపించే ఆప్షన్లలో **Container registries**ని ఎంచుకోండి.
    ...
    ![container registries టైప్ చేయండి.](../../../../../../translated_images/03-09-type-container-registries.7a4180eb2110e5a6.te.png)
...
1. **+ New** ఎంచుకోండి.
    ...
    ![కంప్యూట్‌ను ఎంచుకోండి.](../../../../../../translated_images/06-01-select-compute.a29cff290b480252.te.png)
...
1. నావిగేషన్ మెనూలో నుండి **Fine-tune** ఎంచుకోండి.
    ...
    ![ఫైన్‑ట్యూన్‌ను ఎంచుకోండి.](../../../../../../translated_images/06-06-select-fine-tune.2918a59be55dfeec.te.png)
...
1. క్రింది పనులను చేయండి:
    ...
    ![ఫైన్‑ట్యూనింగ్ పేజీను పూరించండి.](../../../../../../translated_images/06-07-fill-finetuning.b6d14c89e7c27d0b.te.png)
...
1. **From a job output** ఎంచుకోండి.
    ...
    ![మోడల్‌ను రిజిస్టర్ చేయండి.](../../../../../../translated_images/07-01-register-model.ad1e7cc05e4b2777.te.png)

1. మీరు సృష్టించిన జాబ్‌ను ఎంచుకోండి.

    ![జాబ్‌ను ఎంచుకోండి.](../../../../../../translated_images/07-02-select-job.3e2e1144cd6cd093.te.png)
...
1. **Job output** ఎంచుకోబడిందని నిర్ధారించండి; అది ఆపోమాటంగా ఎంచుకోబడుతుంది.
    ...
    ![ఔట్‌పుట్‌ను ఎంచుకోండి.](../../../../../../translated_images/07-03-select-output.4cf1a0e645baea1f.te.png)

2. **Next** ఎంచుకోండి.

3. **Register** ఎంచుకోండి.

    ![రిజిస్టర్‌ను ఎంచుకోండి.](../../../../../../translated_images/07-04-register.fd82a3b293060bc7.te.png)

4. ఎడమ బారులోని ట్యాబ్ నుండి **Models** మెనూకి వెళ్లి మీ రిజిస్టర్ చేసిన మోడల్‌ను చూడవచ్చు.

    ![రిజిస్టర్డ్ మోడల్.](../../../../../../translated_images/07-05-registered-model.7db9775f58dfd591.te.png)
...
1. నావిగేషన్ మెనూలో నుండి **Real-time endpoints** ఎంచుకోండి.
    ...
    ![ఎండ్‌పాయింట్ సృష్టించండి.](../../../../../../translated_images/07-06-create-endpoint.1ba865c606551f09.te.png)

1. **Create** ఎంచుకోండి.

1. మీరు రిజిస్టర్ చేసిన మోడల్‌ను ఎంచుకోండి.

    ![రిజిస్టర్డ్ మోడల్‌ను ఎంచుకోండి.](../../../../../../translated_images/07-07-select-registered-model.29c947c37fa30cb4.te.png)
...
1. మీరు సృష్టించిన ఎండ్‌పాయింట్‌ను ఎంచుకోండి.
    ...
    ![ఎండ్పాయింట్స్ ఎంచుకోండి](../../../../../../translated_images/07-09-check-deployment.325d18cae8475ef4.te.png)
...
1. నావిగేషన్ మెనూలో నుండి **+ New hub** ఎంచుకోండి.
    ![హబ్‌ను సృష్టించండి.](../../../../../../translated_images/08-01-create-hub.8f7dd615bb8d9834.te.png)
...
1. క్రింది పనులను నిర్వహించండి:
    ...
    ![హబ్‌ను పూరించండి.](../../../../../../translated_images/08-02-fill-hub.c2d3b505bbbdba7c.te.png)
...
1. నావిగేషన్ మెన్యూలోని **+ New project** ను ఎంచుకోండి.
    ...
    ![కొత్త ప్రాజెక్ట్‌ను ఎంచుకోండి.](../../../../../../translated_images/08-04-select-new-project.390fadfc9c8f8f12.te.png)

1. **Project name** ను నమోదు చేయండి. ఇది ప్రత్యేకమైన విలువ కావాలి.

    ![ప్రాజెక్ట్‌ని సృష్టించండి.](../../../../../../translated_images/08-05-create-project.4d97f0372f03375a.te.png)
...
1. ఎడమ వైపు ట్యాబ్ నుంచి **Endpoints** ను ఎంచుకోండి.
    ...
    ![Endpoints ను ఎంచుకోండి.](../../../../../../translated_images/08-06-select-endpoints.aff38d453bcf9605.te.png)

1. మీరు సృష్టించిన endpoint ను ఎంచుకోండి.

    ![Endpoints ని ఎంచుకోండి.](../../../../../../translated_images/08-07-select-endpoint-created.47f0dc09df2e275e.te.png)

1. నావిగేషన్ మెన్యూ నుండి **Consume** ను ఎంచుకోండి.

1. మీ **REST endpoint** మరియు **Primary key** ను కాపీ చేయండి.

    ![API కీ మరియు ఎండ్‌పాయింట్ URI ని కాపీ చేయండి.](../../../../../../translated_images/08-08-copy-endpoint-key.18f934b5953ae8cb.te.png)
...
1. **+ New connection** ను ఎంచుకోండి.
    ...
    ![కొత్త కనెక్షన్‌ని ఎంచుకోండి.](../../../../../../translated_images/08-09-select-new-connection.02eb45deadc401fc.te.png)

1. నావిగేషన్ మెన్యూలోని **Custom keys** ను ఎంచుకోండి.

    ![Custom keys ని ఎంచుకోండి.](../../../../../../translated_images/08-10-select-custom-keys.856f6b2966460551.te.png)
...
1. నావిగేషన్ మెన్యూలోని **+ Create** ను ఎంచుకోండి.
    ...
    ![Promptflow ను ఎంచుకోండి.](../../../../../../translated_images/08-12-select-promptflow.6f4b451cb9821e5b.te.png)

1. నావిగేషన్ మెన్యూలోని **Chat flow** ను ఎంచుకోండి.

    ![Chat flow ను ఎంచుకోండి.](../../../../../../translated_images/08-13-select-flow-type.2ec689b22da32591.te.png)
...
1. Prompt flowలో, ఇంటిగ్రేషన్ కోసం ఉన్న ప్రస్తుత ఫ్లోను పునర్నిర్మించడానికి క్రింది పనులు చేయండి:
    ...
    ![Raw file mode ను ఎంచుకోండి.](../../../../../../translated_images/08-15-select-raw-file-mode.61d988b41df28985.te.png)
...
1. Prompt flowలో కస్టమ్ Phi-3 మోడల్‌ను ఉపయోగించేందుకు *integrate_with_promptflow.py* ఫైల్‌లో దిగువ కోడ్‌ను జోడించండి.
    ...
    ![prompt flow కోడ్‌ను పేస్ట్ చేయండి.](../../../../../../translated_images/08-16-paste-promptflow-code.a6041b74a7d09777.te.png)
...
1. మీ మోడల్‌తో చాట్ చేయడానికి **Chat input**, **Chat output** ను ఎంచుకోండి.
    ...
    ![ఇన్పుట్ అవుట్‌పుట్.](../../../../../../translated_images/08-17-select-input-output.64dbb39bbe59d03b.te.png)
...
1. Prompt flow ప్రారంభించడానికి **Start compute sessions** ను ఎంచుకోండి.
    ...
    ![compute సెషన్‌ను ప్రారంభించండి.](../../../../../../translated_images/09-01-start-compute-session.a86fcf5be68e386b.te.png)

1. పరామితులను పునరుద్ధరించడానికి **Validate and parse input** ను ఎంచుకోండి.

    ![ఇన్పుట్‌ను ధ్రువీకరించండి.](../../../../../../translated_images/09-02-validate-input.317c76ef766361e9.te.png)
...
1. **Chat** ను ఎంచుకోండి.
    ...
    ![చాట్‌ను ఎంచుకోండి.](../../../../../../translated_images/09-04-select-chat.61936dce6612a1e6.te.png)
...
1. ఇక్కడ ఫలితాల ఒక ఉదాహరణ ఉంది: ఇప్పుడు మీరు మీ కస్టమ్ Phi-3 మోడల్‌తో చాట్ చేయవచ్చు. fine-tuning కోసం ఉపయోగించిన డేటాపై ఆధారపడి ప్రశ్నలు అడగాలని సూచించబడుతుంది.
    ...
    ![Prompt flowతో చాట్ చేయండి.](../../../../../../translated_images/09-05-chat-with-promptflow.c8ca404c07ab126f.te.png)
