...
1. మీరు సృష్టించిన Azure Machine Learning వర్క్‌స్పేస్‌ను ఎంచుకోండి.
    ...
    ![మీరు సృష్టించిన వర్క్‌స్పేస్‌ను ఎంచుకోండి.](../../../../../../translated_images/te/06-04-select-workspace.a92934ac04f4f181.webp)
...
1. క్రింది పనులు చేయండి:
    ...
    ![phi-3-mini-4k టైప్ చేయండి.](../../../../../../translated_images/te/06-05-type-phi-3-mini-4k.8ab6d2a04418b250.webp)

1. నావిగేషన్ మెనూ నుండి **Fine-tune** ఎంచుకోండి.

    ![ఫైన్-ట్యూన్ ఎంచుకోండి.](../../../../../../translated_images/te/06-06-select-fine-tune.2918a59be55dfeec.webp)
...
1. క్రింది పనులు చేయండి:
    ...
    ![ఫైన్-ట్యూనింగ్ పేజీని పూరించండి.](../../../../../../translated_images/te/06-07-fill-finetuning.b6d14c89e7c27d0b.webp)
...
1. ఈ వ్యాయామంలో, మీరు విజయవంతంగా Azure Machine Learning ఉపయోగించి Phi-3 మోడల్‌ను ఫైన్-ట్యూన్ చేసారు. దయచేసి గమనించండి, ఫైన్-ట్యూనింగ్ ప్రక్రియకు గణనీయమైన సమయం పట్టవచ్చు. ఫైన్-ట్యూనింగ్ జాబ్ నడుపిన తర్వాత, అది పూర్తి కావడానికి వేచి ఉండాలి. Azure Machine Learning వర్క్‌స్పేస్ ఎడమ వైపు టాబ్‌లోని Jobs టాబ్‌లో ఫైన్-ట్యూనింగ్ జాబ్ స్థితిని మీరు పరిశీలించవచ్చు. తదుపరి శ్రేణిలో, మీరు ఫైన్-ట్యూన్ చేసిన మోడల్‌ను డిప్లాయ్ చేసి Prompt flow తో ఇంటిగ్రేట్ చేస్తారు.
    ...
    ![ఫైన్‌ట్యూనింగ్ జాబ్‌ను చూడండి.](../../../../../../translated_images/te/06-08-output.2bd32e59930672b1.webp)
...
1. **From a job output** ఎంచుకోండి.
    ...
    ![మోడల్ రిజిస్ట్ చేయండి.](../../../../../../translated_images/te/07-01-register-model.ad1e7cc05e4b2777.webp)
...
1. **Job output** ఎంచుకోబడిందని నిర్ధారించుకోండి; ఇది ఆటోమేటిక్గా ఎంచుకోబడాలి.
    ...
    ![అవుట్‌పుట్ ఎంచుకోండి.](../../../../../../translated_images/te/07-03-select-output.4cf1a0e645baea1f.webp)
...
1. క్రింది పనులు చేయండి:
    ...
    ![డిప్లాయ్‌మెంట్ సెట్టింగ్‌ను పూరించండి.](../../../../../../translated_images/te/07-08-deployment-setting.43ddc4209e673784.webp)
...
1. మీరు సృష్టించిన ఎండ్పాయింట్‌ను ఎంచుకోండి.
    ...
    ![ఎండ్పాయింట్లను ఎంచుకోండి](../../../../../../translated_images/te/07-09-check-deployment.325d18cae8475ef4.webp)
...
1. నావిగేషన్ మెనూ నుండి **+ New hub** ఎంచుకోండి.
    ![హబ్ సృష్టించండి.](../../../../../../translated_images/te/08-01-create-hub.8f7dd615bb8d9834.webp)
...
1. క్రింది పనులు చేయండి:
    ...
    ![హబ్ పూరించండి.](../../../../../../translated_images/te/08-02-fill-hub.c2d3b505bbbdba7c.webp)
...
1. నావిగేషన్ మెనులో నుండి **+ కొత్త ప్రాజెక్ట్** ఎంచుకోండి.
    ...
    ![కొత్త ప్రాజెక్ట్ ఎంచుకోండి.](../../../../../../translated_images/te/08-04-select-new-project.390fadfc9c8f8f12.webp)

1. **ప్రాజెక్ట్ పేరు** నమోదు చేయండి. ఇది ప్రత్యేకమైన విలువ కావాలి.

    ![ప్రాజెక్ట్ సృష్టించండి.](../../../../../../translated_images/te/08-05-create-project.4d97f0372f03375a.webp)
...
1. ఎడమ వైపు ట్యాబ్ నుండి **ఎండ్పాయింట్లు** ను ఎంచుకోండి.
    ...
    ![ఎండ్పాయింట్లు ఎంచుకోండి.](../../../../../../translated_images/te/08-06-select-endpoints.aff38d453bcf9605.webp)

1. మీరు సృష్టించిన ఎండ్పాయింట్ ని ఎంచుకోండి.

    ![ఎండ్పాయింట్లు ఎంచుకోండి.](../../../../../../translated_images/te/08-07-select-endpoint-created.47f0dc09df2e275e.webp)

1. నావిగేషన్ మెనూ నుండి **ఉపయోగించండి** ను ఎంచుకోండి.

1. మీ **REST ఎండ్పాయింట్** మరియు **ప్రాథమిక కీ** ని కాపీ చేసుకోండి.

    ![API కీ మరియు ఎండ్పాయింట్ URI కాపీ చేసుకోండి.](../../../../../../translated_images/te/08-08-copy-endpoint-key.18f934b5953ae8cb.webp)
...
1. **+ కొత్త కనెక్షన్** ను ఎంచుకోండి.
    ...
    ![నూతన కనెక్షన్ ఎంచుకోండి.](../../../../../../translated_images/te/08-09-select-new-connection.02eb45deadc401fc.webp)

1. నావిగేషన్ మెనూ నుండి **కస్టమ్ కీస్**ను ఎంచుకోండి.

    ![కస్టమ్ కీస్ ఎంచుకోండి.](../../../../../../translated_images/te/08-10-select-custom-keys.856f6b2966460551.webp)
...
1. క్రింది పనులు చేయండి:
    ...
    ![కనెక్షన్ జోడించండి.](../../../../../../translated_images/te/08-11-add-connection.785486badb4d2d26.webp)
...
1. నావిగేషన్ మెనూ నుండి **+ సృష్టించండి** ను ఎంచుకోండి.
    ...
    ![Promptflow ఎంచుకోండి.](../../../../../../translated_images/te/08-12-select-promptflow.6f4b451cb9821e5b.webp)

1. నావిగేషన్ మెనూ నుండి **చాట్ ఫ్లో** ను ఎంచుకోండి.

    ![చాట్ ఫ్లో ఎంచుకోండి.](../../../../../../translated_images/te/08-13-select-flow-type.2ec689b22da32591.webp)

1. ఉపయోగించదలచిన **ఫోల్డర్ పేరు** ను నమోదు చేయండి.

    ![పేరు నమోదు చేయండి.](../../../../../../translated_images/te/08-14-enter-name.ff9520fefd89f40d.webp)
...
1. Prompt flowలో, క్రింది పనులు నిర్వహించి ప్రస్తుత ఫ్లోని తిరిగి నిర్మించండి:
    ...
    ![రా ఫైల్ మోడ్ ఎంచుకోండి.](../../../../../../translated_images/te/08-15-select-raw-file-mode.61d988b41df28985.webp)
...
1. **చాట్ ఇన్‌పుట్**, **చాట్ అవుట్పుట్** ను ఎంచుకుని మీ మోడల్ తో చాట్ ప్రారంభించండి.
    ...
    ![ఇన్‌పుట్ అవుట్పుట్ ఎంచుకోండి.](../../../../../../translated_images/te/08-17-select-input-output.64dbb39bbe59d03b.webp)
...
>
> ![ఫ్లో ఉదాహరణ.](../../../../../../translated_images/te/08-18-graph-example.d6457533952e690c.webp)
>
...
1. Prompt flow ప్రారంభించడానికి **స్టార్ట్ కంప్యూట్ సెషన్స్** ను ఎంచుకోండి.
    ...
    ![కంప్యూట్ సెషన్ ప్రారంభించండి.](../../../../../../translated_images/te/09-01-start-compute-session.a86fcf5be68e386b.webp)

1. పారామీటర్లను అప్‌డేట్ చేయడానికి **వెలిడేట్ మరియు ఇన్‌పుట్ విన్యాసం** ను ఎంచుకోండి.

    ![ఇన్‌పుట్ చెక్ చేయండి.](../../../../../../translated_images/te/09-02-validate-input.317c76ef766361e9.webp)

1. మీరు సృష్టించిన కస్టమ్ కానెక్షన్ కు చెందిన **కనెక్షన్** విలువను ఎంచుకోండి. ఉదాహరణకు, *connection*.

    ![కనెక్షన్.](../../../../../../translated_images/te/09-03-select-connection.99bdddb4b1844023.webp)

#### మీ కస్టమ్ మోడల్ తో చాట్ చేయండి

1. **చాట్** ను ఎంచుకోండి.

    ![చాట్ ఎంచుకోండి.](../../../../../../translated_images/te/09-04-select-chat.61936dce6612a1e6.webp)
...
1. ఫలితాల ఉదాహరణగా: ఇప్పుడు మీరు మీ కస్టమ్ Phi-3 మోడల్ తో చాట్ చేయవచ్చు. ఫైన్-ట్యూనింగ్ కోసం ఉపయోగించిన డేటా ఆధారంగా ప్రశ్నలు అడగడం మంచిది.
    ...
    ![Prompt flow తో చాట్ చేయండి.](../../../../../../translated_images/te/09-05-chat-with-promptflow.c8ca404c07ab126f.webp)
