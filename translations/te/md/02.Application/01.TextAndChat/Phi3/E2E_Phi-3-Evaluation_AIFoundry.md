# Microsoft Foundryలో Microsoft యొక్క Responsible AI సూత్రాలపైన దృష్టి సారించి ఫైన్-ట్యూన్ చేసిన Phi-3 / Phi-3.5 మోడల్‌ను మదింపుచెయ్యండి
...
1. [**సన్నివేశం 1: Microsoft Foundry యొక్క Prompt flow మదింపు పరిచయం**](../../../../../../md/02.Application/01.TextAndChat/Phi3)

    - [భద్రత మదింపుకు పరిచయం](../../../../../../md/02.Application/01.TextAndChat/Phi3)
    - [పనితీరు మదింపుకు పరిచయం](../../../../../../md/02.Application/01.TextAndChat/Phi3)

1. [**సన్నివేశం 2: Microsoft Foundryలో Phi-3 / Phi-3.5 మోడల్‌ను మదించడం**](../../../../../../md/02.Application/01.TextAndChat/Phi3)
    ...
    - [Microsoft Foundry యొక్క Prompt flow మదింపును ఉపయోగించి ఫైన్-ట్యూన్ చేసిన Phi-3 / Phi-3.5 మోడల్‌ను మదించడం](../../../../../../md/02.Application/01.TextAndChat/Phi3)
...
ఈ ట్యుటోరియల్‌లో, మీరు Microsoft Foundry యొక్క భద్రత మెట్రిక్స్ ఉపయోగించి ఫైన్-ట్యూన్ చేసిన Phi-3 మోడల్ యొక్క భద్రతను మదిస్తారు. ఈ మెట్రిక్స్ మోడల్ హానికర కంటెంట్ ఉత్పత్తి చేసే సామర్థ్యాన్ని మరియు jailbreak దాడులకు పట్ల మోడల్ యొక్క సున్నితత్వాన్ని అంచనావేస్తాయి. భద్రత మెట్రిక్స్ లో ఇవి ఉంటాయి:
...
మీ AI మోడల్ అనుకున్నట్లు పనిచేస్తుందో లేదో నిర్ధారించుకోవడానికి, దాని పనితీరును పనితీరు మెట్రిక్స్‌తో మదించడం ముఖ్యం. Microsoft Foundryలో, పనితీరు మదింపులు మీ మోడల్ సక్రమంగా, సంబంధితంగా మరియు సారigliaప్రభావవంతంగా ప్రతిస్పందనలు ఉత్పత్తి చేస్తున్నదో లేదో అంచనా వేయడానికి అనుమతిస్తాయి.
...
ఈ ట్యుటోరియల్‌లో, మీరు Microsoft Foundry యొక్క పనితీరు మెట్రిక్స్ ఉపయోగించి ఫైన్-ట్యూన్ చేసిన Phi-3 / Phi-3.5 మోడల్ యొక్క పనితీరును మదిస్తారు. ఈ మెట్రిక్స్ సృష్టించిన ప్రతిస్పందనల ఖచ్చితత్వం, సంబంధితత్వం, మరియు సమరూపతను అంచనా వేయడంలో సహాయపడతాయి. పనితీరు మెట్రిక్స్‌లో ఇవి ఉంటాయి:
...
## **సన్నివేశం 2: Microsoft Foundryలో Phi-3 / Phi-3.5 మోడల్‌ను మదించడం**

### ముందుగా ఏం చేయాలి

ఈ ట్యుటోరియల్ గత బ్లాగ్ పోస్టుల "[Fine-Tune and Integrate Custom Phi-3 Models with Prompt Flow: Step-by-Step Guide](https://techcommunity.microsoft.com/t5/educator-developer-blog/fine-tune-and-integrate-custom-phi-3-models-with-prompt-flow/ba-p/4178612?wt.mc_id=studentamb_279723)" మరియు "[Fine-Tune and Integrate Custom Phi-3 Models with Prompt Flow in Microsoft Foundry](https://techcommunity.microsoft.com/t5/educator-developer-blog/fine-tune-and-integrate-custom-phi-3-models-with-prompt-flow-in/ba-p/4191726?wt.mc_id=studentamb_279723)" కు అనుబంధంగా ఉంది. ఈ పోస్టులలో, మేము Microsoft Foundryలో Phi-3 / Phi-3.5 మోడల్‌ను ఫైన్-ట్యూన్ చేసి Prompt flowతో ఇంటిగ్రేట్ చేయడం యొక్క ప్రక్రియను చూశాము.

ఈ ట్యుటోరియల్‌లో, మీరు Microsoft Foundryలో ఓ ఎవాల్యుయేటర్‌గా Azure OpenAI మోడల్‌ను డిప్లాయ్ చేసి, మీ ఫైన్-ట్యూన్ చేసిన Phi-3 / Phi-3.5 మోడల్‌ను అది ఉపయోగించి మదిస్తారు.
...
1. Microsoft Foundryలో మీ ఫైన్-ట్యూన్ చేసిన Phi-3 / Phi-3.5 మోడల్‌తో ఇంటిగ్రేట్ చేయబడిన Prompt flow.
...
ప్రాసెస్ కొనసాగించడానికి, మీరు మీ ఫైన్-ట్యూన్ చేసిన Phi-3 / Phi-3.5 మోడల్‌ను Microsoft Foundryలో Prompt flowలో ఇంటిగ్రేట్ చేయాలి.

#### Microsoft Foundry Hub సృష్టించండి

Project సృష్టించేముందు మీరు Hub సృష్టించాలి. Hub ఒక Resource Group లాగా పనిచేసి, Microsoft Foundryలో బహుళ Projectsని గుర్తించి నిర్వహించడానికి అనుమతిస్తుంది.
...
1. [Microsoft Foundry](https://ai.azure.com/?wt.mc_id=studentamb_279723) ను సందర్శించండి.

1. మీరు సృష్టించిన Microsoft Foundry ప్రాజెక్టుకి నావిగేట్ చేయండి.
...
మీరు Microsoft Foundryలో ఒక కస్టమ్ కనెక్షన్‌ను జోడించారు. ఇప్పుడు, క్రింది దశల ద్వారా ఒక Prompt flowని సృష్టしまా. తరువాత, మీరు ఈ Prompt flowను కస్టమ్ కనెక్షన్‌కు కనెక్ట్ చేసి ఫైన్-ట్యూన్ చేయబడిన మోడల్‌ను Prompt flowలో ఉపయోగిస్తారు.
...
> [!NOTE]
> Microsoft Foundryలో Prompt flow ఉపయోగించే గురించి మరింత వివరాల కోసం, మీరు [Prompt flow in Microsoft Foundry](https://learn.microsoft.com/azure/ai-studio/how-to/prompt-flow) ను చూడవచ్చు.
...
Microsoft Foundryలో Phi-3 / Phi-3.5 మోడల్‌ను మూల్యాంకనం చేయడానికి, మీరు Azure OpenAI మోడల్‌ను డిప్లాయ్ చేయవలసి ఉంటుంది. ఈ మోడల్ Phi-3 / Phi-3.5 మోడల్ పనితీరు మూల్యాంకనం కోసం ఉపయోగించబడుతుంది.
...
### Microsoft Foundry యొక్క Prompt flow మూల్యాంకనాన్ని ఉపయోగించి ఫైన్-ట్యూన్ చేయబడిన Phi-3 / Phi-3.5 మోడల్‌ను మూల్యాంకనం చేయండి
...
మీరు Microsoft Foundryలో Prompt flow తో統కీకరించిన fine-tuned Phi-3 మోడల్‌ను విజయవంతంగా మూల్యాంకనం చేసారు. ఇది మీ AI మోడళ్లు ఒప్పుగా మంచి పనితీరును మాత్రమే కాదు, Microsoft యొక్క బాధ్యతాయుత AI సిద్ధాంతాలను అనుసరించుట ద్వారా విశ్వసనీయమైన మరియు నమ్మదగ్గ AI అప్లికేషన్లు నిర్మించడంలో సహాయపడే ముఖ్యమైన దశ.
...
- Microsoft Foundry Project వనరు.
...
- [Microsoft Foundryకి పరిచయం](https://learn.microsoft.com/training/modules/introduction-to-azure-ai-studio/?wt.mc_id=studentamb_279723)
