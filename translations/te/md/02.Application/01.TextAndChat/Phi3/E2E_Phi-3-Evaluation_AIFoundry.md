...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-21T21:20:51+00:00",
...
![ట్యుటోరియల్ ఆర్కిటెక్చర్.](../../../../../../translated_images/architecture.10bec55250f5d6a4e1438bb31c5c70309908e21e7ada24a621bbfdd8d0f834f4.te.png)
...
![భద్రత మదింపు.](../../../../../../translated_images/safety-evaluation.083586ec88dfa9500d3d25faf0720fd99cbf07c8c4b559dda5e70c84a0e2c1aa.te.png)
...
![Fill hub.](../../../../../../translated_images/responsibleai2.c07ef430113fad8c72329615ecf51a4e3df31043fb0d918f868525e7a9747b98.te.png)
...
![భద్రత ఆధారంగా మదించు.](../../../../../../translated_images/evaluate-based-on-safety.c5df819f5b0bfc07156d9b1e18bdf1f130120f7d23e05ea78bc9773d2500b665.te.png)
...
![పనితీరు మదింపు.](../../../../../../translated_images/performance-evaluation.48b3e7e01a098740c7babf1904fa4acca46c5bd7ea8c826832989c776c0e01ca.te.png)
...
![పనితీరు ఆధారంగా మదించు.](../../../../../../translated_images/evaluate-based-on-performance.3e801c647c7554e820ceb3f7f148014fe0572c05dbdadb1af7205e1588fb0358.te.png)
...
1. నావిగేషన్ మెనూ నుంచి **+ New hub** ని ఎంచుకోండి.
    ...
    ![హబ్ సృష్టించండి.](../../../../../../translated_images/create-hub.5be78fb1e21ffbf1aa9ecc232c2c95d337386f3cd0f361ca80c4475dc8aa2c7b.te.png)
1. క్రింది పనులను నిర్వహించండి:
    ...
    ![హబ్ నింపండి.](../../../../../../translated_images/fill-hub.baaa108495c71e3449667210a8ec5a0f3206bf2724ebacaa69cb09d3b12f29d3.te.png)
...
1. నావిగేషన్ మెనూలో నుండి **+ New project** ను ఎంచుకోండి.
    ...
    ![కొత్త ప్రాజెక్ట్ ఎంచుకోండి.](../../../../../../translated_images/select-new-project.cd31c0404088d7a32ee9018978b607dfb773956b15a88606f45579d3bc23c155.te.png)

1. **ప్రాజెక్ట్ పేరు** నమోదు చేయండి. ఇది ప్రత్యేకమైన విలువగా ఉండాలి.

    ![ప్రాజెక్ట్ సృష్టించండి.](../../../../../../translated_images/create-project.ca3b71298b90e42049ce8f6f452313bde644c309331fd728fcacd8954a20e26d.te.png)
...
1. ఎడమ పక్క ట్యాబ్ నుండి **Endpoints** ను ఎంచుకోండి.
    ...
    ![ఎండ్‌పాయింట్లు ఎంచుకోండి.](../../../../../../translated_images/select-endpoints.ee7387ecd68bd18d35cd7f235f930ebe99841a8c8c9dea2f608b7f43508576dd.te.png)

1. మీరు సృష్టించిన ఎండ్‌పాయింట్‌ను ఎంచుకోండి.

    ![ఎండ్‌పాయింట్‌ను ఎంచుకోండి.](../../../../../../translated_images/select-endpoint-created.9f63af5e4cf98b2ec92358f15ad36d69820e627c048f14c7ec3750fdbce3558b.te.png)

1. నావిగేషన్ మెనూలో నుండి **Consume** ను ఎంచుకోండి.

1. మీ **REST endpoint** మరియు **Primary key** ను కాపీ చేయండి.

    ![API కీ మరియు ఎండ్‌పాయింట్ URIను కాపీ చేయండి.](../../../../../../translated_images/copy-endpoint-key.0650c3786bd646ab0b5a80833917b7b8f32ee011c09af0459f3830dc25b00760.te.png)
...
1. **+ New connection** ను ఎంచుకోండి.
    ...
    ![కొత్త కనెక్షన్ ఎంచుకోండి.](../../../../../../translated_images/select-new-connection.fa0f35743758a74b6c5dca5f37ca22939163f5c89eac47d1fd0a8c663bd5904a.te.png)

1. నావిగేషన్ మెనూలో నుండి **Custom keys** ను ఎంచుకోండి.

    ![కస్టమ్ కీలు ఎంచుకోండి.](../../../../../../translated_images/select-custom-keys.5a3c6b25580a9b67df43e8c5519124268b987d8cb77d6e5fe5631f116714bd47.te.png)
...
1. క్రింది పనులు చేయండి:
    ...
    ![కనెక్షన్ జోడించండి.](../../../../../../translated_images/add-connection.ac7f5faf8b10b0dfe6679422f479f88cc47c33cbf24568da138ab19fbb17dc4b.te.png)
...
1. నావిగేషన్ మెనూలో నుండి **+ Create** ను ఎంచుకోండి.
    ...
    ![Promptflow ఎంచుకోండి.](../../../../../../translated_images/select-promptflow.18ff2e61ab9173eb94fbf771819d7ddf21e9c239f2689cb2684d4d3c739deb75.te.png)

1. నావిగేషన్ మెనూలో నుండి **Chat flow** ను ఎంచుకోండి.

    ![చాట్ ఫ్లో ఎంచుకోండి.](../../../../../../translated_images/select-flow-type.28375125ec9996d33a7d73eb77e59354e1b70fd246009e30bdd40db17143ec83.te.png)

1. ఉపయోగించడానికి **ఫోల్డర్ పేరు** ను నమోదు చేయండి.

    ![ఫోల్డర్ పేరు నమోదు చేయండి.](../../../../../../translated_images/enter-name.02ddf8fb840ad4305ba88e0a804a5198ddd8720ebccb420d65ba13dcd481591f.te.png)
...
1. Prompt flowలో, ప్రస్తుత ఫ్లోను పునర్నిర్మించడానికి క్రింది పనులను నిర్వహించండి:
    ...
    ![రా ఫైల్ మోడ్ ఎంచుకోండి.](../../../../../../translated_images/select-raw-file-mode.06c1eca581ce4f5344b4801da9d695b3c1ea7019479754e566d2df495e868664.te.png)
...
1. Prompt flowలో కస్టమ్ Phi-3 / Phi-3.5 మోడల్‌ను ఉపయోగించడానికి *integrate_with_promptflow.py* లో క్రింది కోడ్‌ను జోడించండి.
    ...
    ![Prompt flow కోడ్ పేస్ట్ చేయండి.](../../../../../../translated_images/paste-promptflow-code.cd6d95b101c0ec2818291eeeb2aa744d0e01320308a1fa6348ac7f51bec93de9.te.png)
...
1. మీ మోడల్‌తో చాట్ చేసేందుకు **Chat input**, **Chat output** ను ఎంచుకోండి.
    ...
    ![ఇన్పుట్ అవుట్పుట్ ఎంచుకోండి.](../../../../../../translated_images/select-input-output.c187fc58f25fbfc339811bdd5a2285589fef803aded96b8c58b40131f0663571.te.png)
...
>
> ![ఫ్లో ఉదాహరణ](../../../../../../translated_images/graph-example.82fd1bcdd3fc545bcc81d64cb6542972ae593588ab94564c8c25edf06fae27fc.te.png)
>
...
1. Prompt flow ప్రారంభించడానికి **Start compute sessions** ను ఎంచుకోండి.
    ...
    ![కంప్యూట్ సెషన్‌లు ప్రారంభించండి.](../../../../../../translated_images/start-compute-session.9acd8cbbd2c43df160358b6be6cad3e069a9c22271fd8b40addc847aeca83b44.te.png)

1. పారామీటర్లను పునరుద్ధరించడానికి **Validate and parse input** ను ఎంచుకోండి.

    ![ఇన్పుట్‌ను ధృవీకరించండి.](../../../../../../translated_images/validate-input.c1adb9543c6495be3c94da090ce7c61a77cc8baf0718552e3d6e41b87eb96a41.te.png)

1. మీరు సృష్టించిన కస్టమ్ కనెక్షన్‌కు సంబంధించిన **connection** యొక్క **Value** ను ఎంచుకోండి. ఉదాహరణకు, *connection*.

    ![కనెక్షన్.](../../../../../../translated_images/select-connection.1f2b59222bcaafefe7ac3726aaa2a7fdb04a5b969cd09f009acfe8b1e841efb6.te.png)

#### మీ కస్టమ్ Phi-3 / Phi-3.5 మోడల్‌తో చాట్ చేయండి

1. **Chat** ను ఎంచుకోండి.

    ![చాట్ ఎంచుకోండి.](../../../../../../translated_images/select-chat.0406bd9687d0c49d8bf2b8145f603ed5616b71ba82a0eadde189275b88e50a3f.te.png)
...
1. ఇక్కడ ఫలితాల ఒక ఉదాహరణ ఉంది: ఇప్పుడు మీరు మీ కస్టమ్ Phi-3 / Phi-3.5 మోడల్‌తో చాట్ చేయవచ్చు. ఫైన్-ట్యూన్ చేయడానికి ఉపయోగించిన డేటాపైన ఆధారపడి ప్రశ్నలు అడగటమే సిఫార్సు చేయబడుతుంది.
    ...
    ![Prompt flowతో చాట్ చేయండి.](../../../../../../translated_images/chat-with-promptflow.1cf8cea112359ada4628ea1d3d9f563f3e6df2c01cf917bade1a5eb9d197493a.te.png)
...
1. మీరు సృష్టించిన Azure AI Foundry ప్రాజెక్టుకి నావిగేట్ చేయండి.
    ...
    ![ప్రాజెక్ట్ ఎంచుకోండి.](../../../../../../translated_images/select-project-created.5221e0e403e2c9d6a17c809ad9aee8de593cd48717f157cc3eb2b29a37aa02ae.te.png)
...
1. **Deploy base model** ను ఎంచుకోండి.
    ...
    ![డిప్లాయ్‌మెంట్‌లను ఎంచుకోండి.](../../../../../../translated_images/deploy-openai-model.95d812346b25834b05b20fe43c20130da7eae1e485ad60bb8e46bbc85a6c613a.te.png)

1. మీరు ఉపయోగించదలచుకున్న Azure OpenAI మోడల్‌ను ఎంచుకోండి. ఉదాహరణకు, **gpt-4o**.

    ![మీరు ఉపయోగించదలచుకున్న Azure OpenAI మోడల్‌ను ఎంచుకోండి.](../../../../../../translated_images/select-openai-model.959496d7e311546d66ec145dc4e0bf0cc806e6e5469b17e776788d6f5ba7a221.te.png)
...
1. నావిగేషన్ మెనూలో నుండి **+ New evaluation** ను ఎంచుకోండి.
    ...
    ![ఎవాల్యూషన్ ఎంచుకోండి.](../../../../../../translated_images/select-evaluation.2846ad7aaaca7f4f2cd3f728b640e64eeb639dc5dcb52f2d651099576b894848.te.png)

1. **Prompt flow** evaluation ను ఎంచుకోండి.

    ![Prompt flow evaluation.](../../../../../../translated_images/promptflow-evaluation.cb9758cc19b4760f7a1ddda46bf47281cac59f2b1043f6a775a73977875f29a6.te.png)
...
1. క్రింది పనులను నిర్వహించండి:
    ...
    ![Prompt flow evaluation.](../../../../../../translated_images/evaluation-setting1.4aa08259ff7a536e2e0e3011ff583f7164532d954a5ede4434fe9985cf51047e.te.png)
...
1. క్రింది పనులను నిర్వహించండి:
    ...
    ![Prompt flow evaluation.](../../../../../../translated_images/evaluation-setting2.07036831ba58d64ee622f9ee9b1c70f71b51cf39c3749dcd294414048c5b7e39.te.png)
...
1. పనితీరు మరియు నాణ్యత ప్రమాణాలను కాన్ఫిగర్ చేయడానికి క్రింది పనులను చేయండి:
    ...
    ![Prompt flow evaluation.](../../../../../../translated_images/evaluation-setting3-1.d1ae69e3bf80914e68a0ad38486ca2d6c3ee5a30f4275f98fd3bc510c8d8f6d2.te.png)
...
1. రిస్క్ మరియు సేఫ్టీ మెట్రిక్స్‌ను కాన్ఫిగర్ చేయడానికి క్రింది పనులను చేయండి:
    ...
    ![Prompt flow evaluation.](../../../../../../translated_images/evaluation-setting3-2.d53bd075c60a45a2fab8ffb7e4dc28e8e544d2a093fbc9f63449a03984df98d9.te.png)
...
1. పనితీరు మరియు నాణ్యత ప్రమాణాలు:
    ...
    ![ఎవాల్యూషన్ ఫలితం.](../../../../../../translated_images/evaluation-result-gpu.85f48b42dfb7425434ec49685cff41376de3954fdab20f2a82c726f9fd690617.te.png)
...
1. రిస్క్ మరియు సేఫ్టీ మెట్రిక్స్:
    ...
    ![మూల్యాంకన ఫలితం.](../../../../../../translated_images/evaluation-result-gpu-2.1b74e336118f4fd0589153bf7fb6269cd10aaeb10c1456bc76a06b93b2be15e6.te.png)

1. మీరు దిగువకు స్క్రోల్ చేయటం ద్వారా **వివరమైన మెట్రిక్స్ ఫలితాన్ని** చూడవచ్చు.

    ![మూల్యాంకన ఫలితం.](../../../../../../translated_images/detailed-metrics-result.afa2f5c39a4f5f179c3916ba948feb367dfd4e0658752615be62824ef1dcf2d3.te.png)
...
![ఆర్కిటెక్చర్.](../../../../../../translated_images/architecture.10bec55250f5d6a4e1438bb31c5c70309908e21e7ada24a621bbfdd8d0f834f4.te.png)
