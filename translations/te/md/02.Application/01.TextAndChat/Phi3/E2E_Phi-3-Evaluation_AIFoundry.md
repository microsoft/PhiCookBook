...
![ట్యుటోరియల్ ఆర్కిటెక్చర్.](../../../../../../translated_images/architecture.10bec55250f5d6a4.te.png)
...
![భద్రత మదింపు.](../../../../../../translated_images/safety-evaluation.083586ec88dfa950.te.png)
...
![Fill hub.](../../../../../../translated_images/responsibleai2.c07ef430113fad8c.te.png)
...
![భద్రత ఆధారంగా మదించు.](../../../../../../translated_images/evaluate-based-on-safety.c5df819f5b0bfc07.te.png)
...
![పనితీరు మదింపు.](../../../../../../translated_images/performance-evaluation.48b3e7e01a098740.te.png)
...
![పనితీరు ఆధారంగా మదించు.](../../../../../../translated_images/evaluate-based-on-performance.3e801c647c7554e8.te.png)
...
1. నావిగేషన్ మెనూ నుంచి **+ New hub** ని ఎంచుకోండి.
    ...
    ![హబ్ సృష్టించండి.](../../../../../../translated_images/create-hub.5be78fb1e21ffbf1.te.png)
1. క్రింది పనులను నిర్వహించండి:
    ...
    ![హబ్ నింపండి.](../../../../../../translated_images/fill-hub.baaa108495c71e34.te.png)
...
1. నావిగేషన్ మెనూలో నుండి **+ New project** ను ఎంచుకోండి.
    ...
    ![కొత్త ప్రాజెక్ట్ ఎంచుకోండి.](../../../../../../translated_images/select-new-project.cd31c0404088d7a3.te.png)

1. **ప్రాజెక్ట్ పేరు** నమోదు చేయండి. ఇది ప్రత్యేకమైన విలువగా ఉండాలి.

    ![ప్రాజెక్ట్ సృష్టించండి.](../../../../../../translated_images/create-project.ca3b71298b90e420.te.png)
...
1. ఎడమ పక్క ట్యాబ్ నుండి **Endpoints** ను ఎంచుకోండి.
    ...
    ![ఎండ్‌పాయింట్లు ఎంచుకోండి.](../../../../../../translated_images/select-endpoints.ee7387ecd68bd18d.te.png)

1. మీరు సృష్టించిన ఎండ్‌పాయింట్‌ను ఎంచుకోండి.

    ![ఎండ్‌పాయింట్‌ను ఎంచుకోండి.](../../../../../../translated_images/select-endpoint-created.9f63af5e4cf98b2e.te.png)

1. నావిగేషన్ మెనూలో నుండి **Consume** ను ఎంచుకోండి.

1. మీ **REST endpoint** మరియు **Primary key** ను కాపీ చేయండి.

    ![API కీ మరియు ఎండ్‌పాయింట్ URIను కాపీ చేయండి.](../../../../../../translated_images/copy-endpoint-key.0650c3786bd646ab.te.png)
...
1. **+ New connection** ను ఎంచుకోండి.
    ...
    ![కొత్త కనెక్షన్ ఎంచుకోండి.](../../../../../../translated_images/select-new-connection.fa0f35743758a74b.te.png)

1. నావిగేషన్ మెనూలో నుండి **Custom keys** ను ఎంచుకోండి.

    ![కస్టమ్ కీలు ఎంచుకోండి.](../../../../../../translated_images/select-custom-keys.5a3c6b25580a9b67.te.png)
...
1. క్రింది పనులు చేయండి:
    ...
    ![కనెక్షన్ జోడించండి.](../../../../../../translated_images/add-connection.ac7f5faf8b10b0df.te.png)
...
1. నావిగేషన్ మెనూలో నుండి **+ Create** ను ఎంచుకోండి.
    ...
    ![Promptflow ఎంచుకోండి.](../../../../../../translated_images/select-promptflow.18ff2e61ab9173eb.te.png)

1. నావిగేషన్ మెనూలో నుండి **Chat flow** ను ఎంచుకోండి.

    ![చాట్ ఫ్లో ఎంచుకోండి.](../../../../../../translated_images/select-flow-type.28375125ec9996d3.te.png)

1. ఉపయోగించడానికి **ఫోల్డర్ పేరు** ను నమోదు చేయండి.

    ![ఫోల్డర్ పేరు నమోదు చేయండి.](../../../../../../translated_images/enter-name.02ddf8fb840ad430.te.png)
...
1. Prompt flowలో, ప్రస్తుత ఫ్లోను పునర్నిర్మించడానికి క్రింది పనులను నిర్వహించండి:
    ...
    ![రా ఫైల్ మోడ్ ఎంచుకోండి.](../../../../../../translated_images/select-raw-file-mode.06c1eca581ce4f53.te.png)
...
1. Prompt flowలో కస్టమ్ Phi-3 / Phi-3.5 మోడల్‌ను ఉపయోగించడానికి *integrate_with_promptflow.py* లో క్రింది కోడ్‌ను జోడించండి.
    ...
    ![Prompt flow కోడ్ పేస్ట్ చేయండి.](../../../../../../translated_images/paste-promptflow-code.cd6d95b101c0ec28.te.png)
...
1. మీ మోడల్‌తో చాట్ చేసేందుకు **Chat input**, **Chat output** ను ఎంచుకోండి.
    ...
    ![ఇన్పుట్ అవుట్పుట్ ఎంచుకోండి.](../../../../../../translated_images/select-input-output.c187fc58f25fbfc3.te.png)
...
>
> ![ఫ్లో ఉదాహరణ](../../../../../../translated_images/graph-example.82fd1bcdd3fc545b.te.png)
>
...
1. Prompt flow ప్రారంభించడానికి **Start compute sessions** ను ఎంచుకోండి.
    ...
    ![కంప్యూట్ సెషన్‌లు ప్రారంభించండి.](../../../../../../translated_images/start-compute-session.9acd8cbbd2c43df1.te.png)

1. పారామీటర్లను పునరుద్ధరించడానికి **Validate and parse input** ను ఎంచుకోండి.

    ![ఇన్పుట్‌ను ధృవీకరించండి.](../../../../../../translated_images/validate-input.c1adb9543c6495be.te.png)

1. మీరు సృష్టించిన కస్టమ్ కనెక్షన్‌కు సంబంధించిన **connection** యొక్క **Value** ను ఎంచుకోండి. ఉదాహరణకు, *connection*.

    ![కనెక్షన్.](../../../../../../translated_images/select-connection.1f2b59222bcaafef.te.png)

#### మీ కస్టమ్ Phi-3 / Phi-3.5 మోడల్‌తో చాట్ చేయండి

1. **Chat** ను ఎంచుకోండి.

    ![చాట్ ఎంచుకోండి.](../../../../../../translated_images/select-chat.0406bd9687d0c49d.te.png)
...
1. ఇక్కడ ఫలితాల ఒక ఉదాహరణ ఉంది: ఇప్పుడు మీరు మీ కస్టమ్ Phi-3 / Phi-3.5 మోడల్‌తో చాట్ చేయవచ్చు. ఫైన్-ట్యూన్ చేయడానికి ఉపయోగించిన డేటాపైన ఆధారపడి ప్రశ్నలు అడగటమే సిఫార్సు చేయబడుతుంది.
    ...
    ![Prompt flowతో చాట్ చేయండి.](../../../../../../translated_images/chat-with-promptflow.1cf8cea112359ada.te.png)
...
1. మీరు సృష్టించిన Azure AI Foundry ప్రాజెక్టుకి నావిగేట్ చేయండి.
    ...
    ![ప్రాజెక్ట్ ఎంచుకోండి.](../../../../../../translated_images/select-project-created.5221e0e403e2c9d6.te.png)
...
1. **Deploy base model** ను ఎంచుకోండి.
    ...
    ![డిప్లాయ్‌మెంట్‌లను ఎంచుకోండి.](../../../../../../translated_images/deploy-openai-model.95d812346b25834b.te.png)

1. మీరు ఉపయోగించదలచుకున్న Azure OpenAI మోడల్‌ను ఎంచుకోండి. ఉదాహరణకు, **gpt-4o**.

    ![మీరు ఉపయోగించదలచుకున్న Azure OpenAI మోడల్‌ను ఎంచుకోండి.](../../../../../../translated_images/select-openai-model.959496d7e311546d.te.png)
...
1. నావిగేషన్ మెనూలో నుండి **+ New evaluation** ను ఎంచుకోండి.
    ...
    ![ఎవాల్యూషన్ ఎంచుకోండి.](../../../../../../translated_images/select-evaluation.2846ad7aaaca7f4f.te.png)

1. **Prompt flow** evaluation ను ఎంచుకోండి.

    ![Prompt flow evaluation.](../../../../../../translated_images/promptflow-evaluation.cb9758cc19b4760f.te.png)
...
1. క్రింది పనులను నిర్వహించండి:
    ...
    ![Prompt flow evaluation.](../../../../../../translated_images/evaluation-setting1.4aa08259ff7a536e.te.png)
...
1. క్రింది పనులను నిర్వహించండి:
    ...
    ![Prompt flow evaluation.](../../../../../../translated_images/evaluation-setting2.07036831ba58d64e.te.png)
...
1. పనితీరు మరియు నాణ్యత ప్రమాణాలను కాన్ఫిగర్ చేయడానికి క్రింది పనులను చేయండి:
    ...
    ![Prompt flow evaluation.](../../../../../../translated_images/evaluation-setting3-1.d1ae69e3bf80914e.te.png)
...
1. రిస్క్ మరియు సేఫ్టీ మెట్రిక్స్‌ను కాన్ఫిగర్ చేయడానికి క్రింది పనులను చేయండి:
    ...
    ![Prompt flow evaluation.](../../../../../../translated_images/evaluation-setting3-2.d53bd075c60a45a2.te.png)
...
1. పనితీరు మరియు నాణ్యత ప్రమాణాలు:
    ...
    ![ఎవాల్యూషన్ ఫలితం.](../../../../../../translated_images/evaluation-result-gpu.85f48b42dfb74254.te.png)
...
1. రిస్క్ మరియు సేఫ్టీ మెట్రిక్స్:
    ...
    ![మూల్యాంకన ఫలితం.](../../../../../../translated_images/evaluation-result-gpu-2.1b74e336118f4fd0.te.png)

1. మీరు దిగువకు స్క్రోల్ చేయటం ద్వారా **వివరమైన మెట్రిక్స్ ఫలితాన్ని** చూడవచ్చు.

    ![మూల్యాంకన ఫలితం.](../../../../../../translated_images/detailed-metrics-result.afa2f5c39a4f5f17.te.png)
...
![ఆర్కిటెక్చర్.](../../../../../../translated_images/architecture.10bec55250f5d6a4.te.png)
