...
Microsoft Foundry ప్రాజెక్ట్ మరియు హబ్ సృష్టించడం మీ AI పనులను సమగ్రముగా నిర్వహించడానికి మరియు ఏర్పాటు చేయడానికి అద్భుతమైన విధానం. మీను ప్రారంభించడానికి ఇక్కడ స్టెప్-బై-స్టెప్ మార్గదర్శనం ఉంది:

### Creating a Project in Microsoft Foundry

1. **Go to Microsoft Foundry**: Microsoft Foundry పోర్టల్‌లో సైన్ ఇన్ చేయండి.
2. **Create a Project**:
   - మీరు ఒక ప్రాజెక్టులో ఉన్నట్లయితే, హోం పేజీకి చేరడానికి పేజీ పైఎడమకు "Microsoft Foundry" ను ఎంచుకోండి.
...
1. **Go to Microsoft Foundry**: మీ Azure ఖాతాతో సైన్ ఇన్ చేయండి.
2. **Create a Hub**:
...
## **2. Microsoft Foundryలో Phi మోడల్‌ను డిప్లాయ్ చేయడం**
...
## **3. Microsoft Foundryలో Playground లో Phi తో చాట్ చేయడం**

డిప్లాయ్‌మెంట్ పేజీకి వెళ్లి Playground ఎంచుకొని Microsoft Foundryలోని Phi-3 తో చాట్ చేయండి

## **4. Microsoft Foundry నుండి మోడల్‌ను డిప్లాయ్ చేయడం**

Azure Model Catalog నుండి మోడల్‌ను డిప్లాయ్ చేయడానికి, మీరు ఈ స్టెప్స్ ను అనుసరించవచ్చు:

- Microsoft Foundryలో సైన్ ఇన్ చేయండి.
