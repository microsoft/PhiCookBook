...
1. *finetune-phi* ਫੋਲਡਰ ਚੁਣੋ ਜੋ ਤੁਸੀਂ ਬਣਾਇਆ ਸੀ, ਜੋ ਕਿ *C:\Users\yourUserName\finetune-phi* ’ਤੇ ਸਥਿਤ ਹੈ।
    ...
    ![ਤੁਸੀਂ ਜਿਸ ਫੋਲਡਰ ਨੂੰ ਬਣਾਇਆ ਹੈ, ਉਸਨੂੰ ਚੁਣੋ।](../../../../../../translated_images/04-01-open-project-folder.f734374bcfd5f9e6.pa.png)
...
1. ਆਪਣਾ ਬਣਾਇਆ ਹੋਇਆ Azure Machine Learning ਵਰਕਸਪੇਸ ਚੁਣੋ।
    ...
    ![ਤੁਸੀਂ ਜੋ ਵਰਕਸਪੇਸ ਬਣਾਇਆ ਹੈ, ਉਹ ਚੁਣੋ।](../../../../../../translated_images/06-04-select-workspace.a92934ac04f4f181.pa.png)
...
1. ਹੇਠਾਂ ਦਿੱਤੇ ਕੰਮ ਕਰੋ:
    ...
    ![ਫਾਈਨ-ਟਿਊਨਿੰਗ ਸਫਾ ਭਰੋ।](../../../../../../translated_images/06-07-fill-finetuning.b6d14c89e7c27d0b.pa.png)
...
1. ਯਕੀਨੀ ਬਣਾਓ ਕਿ **Job output** ਚੁਣਿਆ ਹੋਇਆ ਹੈ; ਇਹ ਆਪਣੇ-ਆਪ ਹੀ ਚੁਣਿਆ ਹੋਣ ਚਾਹੀਦਾ ਹੈ।
    ...
    ![ਆउਟਪੁਟ ਚੁਣੋ।](../../../../../../translated_images/07-03-select-output.4cf1a0e645baea1f.pa.png)
...
1. ਆਪਣੇ ਬਣਾਏ ਹੋਏ ਰਜਿਸਟਰ ਮਾਡਲ ਨੂੰ ਚੁਣੋ।
    ...
    ![ਰਜਿਸਟਰ ਮਾਡਲ ਚੁਣੋ।](../../../../../../translated_images/07-07-select-registered-model.29c947c37fa30cb4.pa.png)
...
1. ਨੈਵੀਗੇਸ਼ਨ ਮੇਨੂ ਤੋਂ **+ New hub** ਚੁਣੋ।
    ![ਹੱਬ ਬਣਾਓ।](../../../../../../translated_images/08-01-create-hub.8f7dd615bb8d9834.pa.png)
...
1. ਹੇਠਾਂ ਦਿੱਤੇ ਕੰਮ ਕਰੋ:
    ...
    ![ਹੱਬ ਭਰੋ।](../../../../../../translated_images/08-02-fill-hub.c2d3b505bbbdba7c.pa.png)
...
1. ਨੈਵੀਗੇਸ਼ਨ ਮেনੂ ਤੋਂ **+ New project** ਚੁਣੋ।
    ...
    ![ਨਵਾਂ ਪ੍ਰੋਜੈਕਟ ਚੁਣੋ।](../../../../../../translated_images/08-04-select-new-project.390fadfc9c8f8f12.pa.png)

1. **Project name** ਦਰਜ ਕਰੋ। ਇਹ ਇੱਕ ਵਿਲੱਖਣ ਮੁੱਲ ਹੋਣਾ ਚਾਹੀਦਾ ਹੈ।

    ![ਪ੍ਰੋਜੈਕਟ ਬਣਾਓ।](../../../../../../translated_images/08-05-create-project.4d97f0372f03375a.pa.png)
...
1. ਖੱਬੇ ਪਾਸੇ ਟੈਬ ਤੋਂ **Endpoints** ਚੁਣੋ।
    ...
    ![Endpoints ਚੁਣੋ।](../../../../../../translated_images/08-06-select-endpoints.aff38d453bcf9605.pa.png)

1. ਆਪਣਾ ਬਣਾਇਆ ਹੋਇਆ endpoint ਚੁਣੋ।

    ![Endpoints ਚੁਣੋ।](../../../../../../translated_images/08-07-select-endpoint-created.47f0dc09df2e275e.pa.png)

1. ਨੈਵੀਗੇਸ਼ਨ ਮੈਨੂ ਤੋਂ **Consume** ਚੁਣੋ।

1. ਆਪਣਾ **REST endpoint** ਅਤੇ **Primary key** ਕਾਪੀ ਕਰੋ।

    ![api key ਅਤੇ endpoint uri ਕਾਪੀ ਕਰੋ।](../../../../../../translated_images/08-08-copy-endpoint-key.18f934b5953ae8cb.pa.png)
...
1. **+ New connection** ਚੁਣੋ।
    ...
    ![ਨਵਾਂ ਕਨੇਕਸ਼ਨ ਚੁਣੋ।](../../../../../../translated_images/08-09-select-new-connection.02eb45deadc401fc.pa.png)

1. ਨੈਵੀਗੇਸ਼ਨ ਮੈਨੂ ਤੋਂ **Custom keys** ਚੁਣੋ।

    ![ਕਸਟਮ ਕੁੰਜੀਆਂ ਚੁਣੋ।](../../../../../../translated_images/08-10-select-custom-keys.856f6b2966460551.pa.png)
...
1. ਹੇਠਾਂ ਦਿੱਤੇ ਕੰਮ ਕਰੋ:
    ...
    ![ਕਨੈਕਸ਼ਨ ਜੋੜੋ।](../../../../../../translated_images/08-11-add-connection.785486badb4d2d26.pa.png)
...
1. ਨੈਵੀਗੇਸ਼ਨ ਮੈਨੂ ਤੋਂ **+ Create** ਚੁਣੋ।
    ...
    ![Promptflow ਚੁਣੋ।](../../../../../../translated_images/08-12-select-promptflow.6f4b451cb9821e5b.pa.png)

1. ਨੈਵੀਗੇਸ਼ਨ ਮainedੂ ਤੋਂ **Chat flow** ਚੁਣੋ।

    ![ਚੈਟ ਫਲੋ ਚੁਣੋ।](../../../../../../translated_images/08-13-select-flow-type.2ec689b22da32591.pa.png)

1. ਵਰਤਣ ਲਈ **Folder name** ਦਰਜ ਕਰੋ।

    ![ਨਾਮ ਦਰਜ ਕਰੋ।](../../../../../../translated_images/08-14-enter-name.ff9520fefd89f40d.pa.png)
...
1. Prompt flow ਵਿੱਚ, ਮੌਜੂਦਾ ਫਲੋ ਨੂੰ ਦੁਬਾਰਾ ਬਣਾਉਣ ਲਈ ਹੇਠਾਂ ਦਿੱਤੇ ਕੰਮ ਕਰੋ:
    ...
    ![ਰਾਵ ਫਾਇਲ ਮੋਡ ਚੁਣੋ।](../../../../../../translated_images/08-15-select-raw-file-mode.61d988b41df28985.pa.png)
...
1. *integrate_with_promptflow.py* ਫਾਇਲ ਵਿੱਚ ਹੇਠਾਂ ਦਿੱਤਾ ਕੋਡ ਜੋੜੋ ਤਾਂ ਜੋ Prompt flow ਵਿੱਚ ਕਸਟਮ Phi-3 ਮਾਡਲ ਦੀ ਵਰਤੋਂ ਕੀਤੀ ਜਾ ਸਕੇ।
    ...
    ![Prompt flow ਕੋਡ ਪੇਸਟ ਕਰੋ।](../../../../../../translated_images/08-16-paste-promptflow-code.a6041b74a7d09777.pa.png)
...
1. **Chat input**, **Chat output** ਚੁਣੋ ਤਾਂ ਜੋ ਆਪਣੇ ਮਾਡਲ ਨਾਲ ਚੈਟ ਆਗਿਆਕਾਰੀ ਬਣਾਈ ਜਾ ਸਕੇ।
    ...
    ![ਇਨਪੁੱਟ ਆਉਟਪੁੱਟ ਚੁਣੋ।](../../../../../../translated_images/08-17-select-input-output.64dbb39bbe59d03b.pa.png)
...
>
> ![ਫਲੋ ਉਦਾਹਰਨ।](../../../../../../translated_images/08-18-graph-example.d6457533952e690c.pa.png)
>
...
1. Prompt flow ਸ਼ੁਰੂ ਕਰਨ ਲਈ **Start compute sessions** ਚੁਣੋ।
    ...
    ![ਕੰਪਿਊਟ ਸੈਸ਼ਨ ਸ਼ੁਰੂ ਕਰੋ।](../../../../../../translated_images/09-01-start-compute-session.a86fcf5be68e386b.pa.png)

1. ਪੈਰਾਮੀਟਰ ਨਵੀਨਤਮ ਕਰਨ ਲਈ **Validate and parse input** ਚੁਣੋ।

    ![ਇਨਪੁੱਟ ਵੈਲੀਡੇਟ ਕਰੋ।](../../../../../../translated_images/09-02-validate-input.317c76ef766361e9.pa.png)

1. ਜਦੋਂ ਤਕ ਨਵਾਂ ਬਣਾਇਆ ਗਿਆ ਕਸਟਮ ਕਨੇਕਸ਼ਨ ਚੁਣੋ, ਉਦਾਹਰਨ ਵਜੋਂ, *connection*।

    ![ਕਨੈਕਸ਼ਨ।](../../../../../../translated_images/09-03-select-connection.99bdddb4b1844023.pa.png)

#### ਆਪਣੇ ਕਸਟਮ ਮਾਡਲ ਨਾਲ ਚੈਟ ਕਰੋ

1. **Chat** ਚੁਣੋ।

    ![ਚੈਟ ਚੁਣੋ।](../../../../../../translated_images/09-04-select-chat.61936dce6612a1e6.pa.png)
...
1. ਨਤੀਜਿਆਂ ਦੀ ਇੱਕ ਉਦਾਹਰਨ ਹੇਠਾਂ ਦਿੱਤੀ ਹੈ: ਹੁਣ ਤੁਸੀਂ ਆਪਣੇ ਕਸਟਮ Phi-3 ਮਾਡਲ ਨਾਲ ਗੱਲਬਾਤ ਕਰ ਸਕਦੇ ਹੋ। ਇਹ ਸੁਝਾਅ ਦਿੱਤਾ ਜਾਂਦਾ ਹੈ ਕਿ fine-tuning ਲਈ ਵਰਤੇ ਗਏ ਡੇਟਾ ਦੇ ਆਧਾਰ 'ਤੇ ਪ੍ਰਸ਼ਨ ਪੁੱਛੋ।
    ...
    ![Prompt flow ਨਾਲ ਚੈਟ ਕਰੋ।](../../../../../../translated_images/09-05-chat-with-promptflow.c8ca404c07ab126f.pa.png)
