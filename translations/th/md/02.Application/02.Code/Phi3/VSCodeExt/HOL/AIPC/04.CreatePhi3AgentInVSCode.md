...
ในแลบก่อนหน้า เราได้รวม NPU และคลาวด์เพื่อสร้าง Visual Studio Code Extension สำหรับ Phi3 Agent
...
Visual Studio Code Chat API ยังไม่ได้ถูกรวมเข้าไปใน code API แต่ตอนนี้ถูกเพิ่มผ่าน extensions แล้ว
...
คุณสามารถรัน **npm install** ในเทอร์มินัลและดีบัก extension ของคุณเพื่อทดสอบได้

***Download Sample Code*** [คลิกที่นี่](../../../../../../../../../code/07.Lab/01/AIPC)
...
ยินดีด้วย! คุณได้ทำแลบทั้งหมดเสร็จเรียบร้อยแล้ว หวังว่าสิ่งนี้จะช่วยให้คุณเข้าใจ Phi-3 Family และวิธีการใช้ GitHub Copilot Chat ได้ดีขึ้น
...
เอกสารนี้ได้รับการแปลโดยใช้บริการแปลภาษาด้วย AI [Co-op Translator](https://github.com/Azure/co-op-translator) แม้เราจะพยายามให้มีความถูกต้อง แต่โปรดทราบว่าการแปลอัตโนมัติอาจมีข้อผิดพลาดหรือความไม่ถูกต้อง เอกสารต้นฉบับในภาษาต้นฉบับควรถูกพิจารณาเป็นแหล่งข้อมูลที่เชื่อถือได้ สำหรับข้อมูลที่สำคัญ แนะนำให้ใช้บริการแปลโดยมนุษย์มืออาชีพ เราจะไม่รับผิดชอบต่อความเข้าใจผิดหรือการตีความที่ผิดพลาดที่เกิดจากการใช้การแปลนี้