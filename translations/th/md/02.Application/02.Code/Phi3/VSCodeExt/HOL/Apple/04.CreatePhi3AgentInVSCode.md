...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-17T04:39:54+00:00",
...
ใน Lab ก่อนหน้า เราได้รวม MX framework และ cloud เพื่อสร้าง Visual Studio Code Extension สำหรับ Phi3 Agent

![agent](../../../../../../../../../translated_images/th/vscode_agent.746efdf2e81957c2.webp)
...
คุณสามารถรัน **npm install** ใน terminal และดีบัก extension ของคุณเพื่อลองทดสอบ

***ดาวน์โหลดตัวอย่างโค้ด*** [คลิกที่นี่](../../../../../../../../../code/07.Lab/01/Apple)
...
ยินดีด้วย! คุณทำ Lab ทั้งหมดเสร็จเรียบร้อยแล้ว หวังว่าสิ่งนี้จะช่วยให้คุณเข้าใจ Phi-3 Family และวิธีการใช้งาน GitHub Copilot Chat ได้ดีขึ้น

คุณสามารถลองใช้คำสั่ง ***@PHI3 /gen***

![code](../../../../../../../../../translated_images/th/result_code.ae0d053b45202798.webp)

คุณสามารถลองใช้คำสั่ง ***@PHI3 /img***

![img](../../../../../../../../../translated_images/th/result_img.436817a2bb3a34cf.webp)
