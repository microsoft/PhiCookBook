...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-09T20:08:21+00:00",
...
การเรียกใช้ฟังก์ชันเริ่มต้นในครอบครัว Phi Family และตอนนี้คุณสามารถใช้งานผ่าน Phi-4-mini ได้แล้ว

ตัวอย่างนี้แสดงการจำลองผลการแข่งขันพรีเมียร์ลีก โดยมีเป้าหมายให้ Phi-4-mini ส่งมอบข้อมูลเกมแบบเรียลไทม์ ด้านล่างเป็นตัวอย่างโค้ด: 
