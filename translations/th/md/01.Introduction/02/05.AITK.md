...
[AI Toolkit for VS Code](https://marketplace.visualstudio.com/items?itemName=ms-windows-ai-studio.windows-ai-studio) ช่วยให้งานพัฒนาแอป AI สร้างสรรค์ง่ายขึ้นโดยรวบรวมเครื่องมือและโมเดล AI ขั้นสูงจาก Microsoft Foundry Catalog และแคตตาล็อกอื่นๆ เช่น Hugging Face คุณจะสามารถเรียกดูแคตตาล็อกโมเดล AI ที่ขับเคลื่อนโดย GitHub Models และ Microsoft Foundry Model Catalogs ดาวน์โหลดมาใช้งานทั้งแบบเครื่องท้องถิ่นหรือระยะไกล ปรับแต่ง ทดสอบ และนำไปใช้ในแอปพลิเคชันของคุณได้
