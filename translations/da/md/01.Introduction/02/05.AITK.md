...
[AI Toolkit for VS Code](https://marketplace.visualstudio.com/items?itemName=ms-windows-ai-studio.windows-ai-studio) gør udvikling af generative AI-apps nemmere ved at samle avancerede AI-udviklingsværktøjer og modeller fra Microsoft Foundry Catalog og andre kataloger som Hugging Face. Du kan browse AI-modellernes katalog drevet af GitHub Models og Microsoft Foundry Model Catalogs, downloade dem lokalt eller eksternt, finjustere, teste og bruge dem i din applikation.
