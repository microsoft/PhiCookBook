...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-16T14:54:09+00:00",
...
3. [**عضویت در جامعه دیسکورد هوش مصنوعی مایکروسافت و ملاقات با کارشناسان و توسعه‌دهندگان هم‌فکر**](https://discord.com/invite/ByRwuEEgH4?WT.mc_id=aiml-137032-kinfeylo)
...
- نمونه‌های توسعه برنامه‌های Phi  
  - برنامه‌های متن و چت  
    ...
    - نمونه‌های Phi-3 / 3.5  
      ...
      - [چندمدلی - تعامل Phi-3-mini و OpenAI Whisper](./md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-mini_with_whisper.md)  
...
- [اپلیکیشن کنسول چت .NET با Semantic Kernel و Phi-3](../../md/04.HOL/dotnet/src/LabsPhi302)
...
- نمونه‌های کد مبتنی بر Azure AI Inference SDK  
  ...
  - نمونه‌های Phi-3 / 3.5  
    ...
    - [ایجاد عامل چت GitHub Copilot برای Visual Studio Code با Phi-3.5 و مدل‌های GitHub](/md/02.Application/02.Code/Phi3/CreateVSCodeChatAgentWithGitHubModels.md)  
...
- نمونه‌های MOE  
  - نمونه‌های Phi-3 / 3.5  
    - [📓] [نمونه مدل‌های Phi-3.5 Mixture of Experts (MoEs) در شبکه‌های اجتماعی](../../md/02.Application/06.MoE/Phi3/phi3_moe_demo.ipynb)  
...
- مقالات و انتشارات پژوهشی دانشگاهی  
  ...
  - [گزارش فنی Phi-4-Mini: مدل‌های زبان چندرسانه‌ای جمع و جور اما قدرتمند از طریق Mixture-of-LoRAs](https://arxiv.org/abs/2503.01743)  
...
می‌توانید یاد بگیرید چگونه از Microsoft Phi استفاده کنید و راه‌حل‌های انتها به انتها (E2E) را در دستگاه‌های سخت‌افزاری مختلف خود بسازید. برای تجربه Phi به صورت عملی، با مدل‌ها بازی کنید و Phi را برای سناریوهای خود سفارشی کنید با استفاده از [کاتالوگ مدل‌های Azure AI Foundry](https://aka.ms/phi3-azure-ai). برای اطلاعات بیشتر به راهنمای شروع به کار با [Azure AI Foundry](/md/02.QuickStart/AzureAIFoundry_QuickStart.md) مراجعه کنید.
...
می‌توانید یاد بگیرید چگونه از Microsoft Phi استفاده کنید و راه‌حل‌های انتها به انتها (E2E) را در دستگاه‌های سخت‌افزاری مختلف خود بسازید. برای تجربه Phi به صورت عملی، با مدل بازی کنید و Phi را برای سناریوهای خود سفارشی کنید با استفاده از [کاتالوگ مدل‌های GitHub](https://github.com/marketplace/models?WT.mc_id=aiml-137032-kinfeylo). برای اطلاعات بیشتر به راهنمای شروع به کار با [کاتالوگ مدل‌های GitHub](/md/02.QuickStart/GitHubModel_QuickStart.md) مراجعه کنید.
...
مایکروسافت متعهد است به کمک به مشتریان خود برای استفاده مسئولانه از محصولات هوش مصنوعی، به اشتراک گذاشتن تجربیات و ساخت شراکت‌های مبتنی بر اعتماد از طریق ابزارهایی مانند Transparency Notes و Impact Assessments. بسیاری از این منابع را می‌توانید در [https://aka.ms/RAI](https://aka.ms/RAI) بیابید.  
