# کتاب‌دستور فی: مثال‌های عملی با مدل‌های فی مایکروسافت
...
فی در حال حاضر قدرتمندترین و مقرون‌به‌صرفه‌ترین مدل زبان کوچک (SLM) است که معیارهای بسیار خوبی در موارد چندزبانه، استدلال، تولید متن/چت، کدنویسی، تصاویر، صوت و سایر سناریوها دارد.

شما می‌توانید فی را در فضای ابری یا روی دستگاه‌های لبه مستقر کنید و به سادگی برنامه‌های هوش مصنوعی مولد را با قدرت محاسباتی محدود بسازید.

برای شروع استفاده از این منابع، مراحل زیر را دنبال کنید:
1. **فورک مخزن**: کلیک کنید [![شاخۀ GitHub](https://img.shields.io/github/forks/microsoft/phicookbook.svg?style=social&label=Fork)](https://GitHub.com/microsoft/phicookbook/network/?WT.mc_id=aiml-137032-kinfeylo)
2. **کلون کردن مخزن**:  `git clone https://github.com/microsoft/PhiCookBook.git`
3. [**عضویت در جامعه Discord هوش مصنوعی مایکروسافت و ملاقات با متخصصین و توسعه‌دهندگان هم‌رشته**](https://discord.com/invite/ByRwuEEgH4?WT.mc_id=aiml-137032-kinfeylo)

![کاور](../../translated_images/fa/cover.eb18d1b9605d754b.webp)

### 🌐 پشتیبانی چندزبانۀ جهانی

#### پشتیبانی شده از طریق GitHub Action (خودکار و همیشه به‌روز)

<!-- CO-OP TRANSLATOR LANGUAGES TABLE START -->
[عربی](../ar/README.md) | [بنگالی](../bn/README.md) | [بلغاری](../bg/README.md) | [برمه‌ای (میانمار)](../my/README.md) | [چینی (ساده‌شده)](../zh-CN/README.md) | [چینی (سنتی، هنگ‌کنگ)](../zh-HK/README.md) | [چینی (سنتی، ماکائو)](../zh-MO/README.md) | [چینی (سنتی، تایوان)](../zh-TW/README.md) | [کرواتی](../hr/README.md) | [چکی](../cs/README.md) | [دانمارکی](../da/README.md) | [هلندی](../nl/README.md) | [استونیایی](../et/README.md) | [فنلاندی](../fi/README.md) | [فرانسوی](../fr/README.md) | [آلمانی](../de/README.md) | [یونانی](../el/README.md) | [عبری](../he/README.md) | [هندی](../hi/README.md) | [مجارستانی](../hu/README.md) | [اندونزیایی](../id/README.md) | [ایتالیایی](../it/README.md) | [ژاپنی](../ja/README.md) | [کانادایی](../kn/README.md) | [کره‌ای](../ko/README.md) | [لتونیایی](../lt/README.md) | [مالایی](../ms/README.md) | [مالایالام](../ml/README.md) | [مراتی](../mr/README.md) | [نپالی](../ne/README.md) | [پیدجین نیجریه‌ای](../pcm/README.md) | [نروژی](../no/README.md) | [فارسی](./README.md) | [لهستانی](../pl/README.md) | [پرتغالی (برزیل)](../pt-BR/README.md) | [پرتغالی (پرتغال)](../pt-PT/README.md) | [پنجابی (گرموخی)](../pa/README.md) | [رومانیایی](../ro/README.md) | [روسی](../ru/README.md) | [صربی (سیریلیک)](../sr/README.md) | [اسلواکی](../sk/README.md) | [اسلوونیایی](../sl/README.md) | [اسپانیایی](../es/README.md) | [سواحیلی](../sw/README.md) | [سوئدی](../sv/README.md) | [تاگالوگ (فیلیپینی)](../tl/README.md) | [تامیل](../ta/README.md) | [تلگو](../te/README.md) | [تایلندی](../th/README.md) | [ترکی](../tr/README.md) | [اوکراینی](../uk/README.md) | [اردو](../ur/README.md) | [ویتنامی](../vi/README.md)
...
> ```
>
> این به شما همه چیز مورد نیاز برای تکمیل دوره را با سرعت دانلود بسیار بیشتر می‌دهد.
<!-- CO-OP TRANSLATOR LANGUAGES TABLE END -->

## فهرست مطالب

- مقدمه
  - [به خانواده فی خوش آمدید](./md/01.Introduction/01/01.PhiFamily.md)
  ...
  - [کتابخانه مدل‌های Azure AI](https://ai.azure.com)
...
- اجرای خانواده فی
    - [اجرای فی در iOS](./md/01.Introduction/03/iOS_Inference.md)
    - [اجرای فی در Android](./md/01.Introduction/03/Android_Inference.md)
    - [اجرای فی در Jetson](./md/01.Introduction/03/Jetson_Inference.md)
    - [اجرای فی در AI PC](./md/01.Introduction/03/AIPC_Inference.md)
    - [اجرای فی با چارچوب Apple MLX](./md/01.Introduction/03/MLX_Inference.md)
    - [اجرای فی در سرور محلی](./md/01.Introduction/03/Local_Server_Inference.md)
    - [اجرای فی در سرور راه دور با استفاده از ابزارک AI](./md/01.Introduction/03/Remote_Interence.md)
    - [اجرای فی با Rust](./md/01.Introduction/03/Rust_Inference.md)
    - [اجرای فی–بینایی در محلی](./md/01.Introduction/03/Vision_Inference.md)
    - [اجرای فی با Kaito AKS، Azure Containers (پشتیبانی رسمی)](./md/01.Introduction/03/Kaito_Inference.md)
...
- نمونه‌های توسعه برنامه‌های فی
  - برنامه‌های متن و چت
    - نمونه‌های Phi-4 🆕
      ...
      - [اپلیکیشن کنسول چت .NET با Phi-4 ONNX با استفاده از Sementic Kernel](../../md/04.HOL/dotnet/src/LabsPhi4-Chat-02SK)
    - نمونه‌های Phi-3 / 3.5
      ...
      - [گفتگوی OpenVino](./md/02.Application/01.TextAndChat/Phi3/E2E_OpenVino_Chat.md)
      - [چندمدلی – تعاملی Phi-3-mini و OpenAI Whisper](./md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-mini_with_whisper.md)
      - [MLFlow – ساخت یک رابط و استفاده از Phi-3 با MLFlow](./md//02.Application/01.TextAndChat/Phi3/E2E_Phi-3-MLflow.md)
  ...
  - نمونه‌های کد مبتنی بر Azure AI Inference SDK
    ...
    - نمونه‌های Phi-3 / 3.5
      - [ساخت گیت‌هاب کاپیلوت چت مخصوص Visual Studio Code با خانواده Microsoft Phi-3](./md/02.Application/02.Code/Phi3/VSCodeExt/README.md)
      - [ساخت عامل چت Copilot مخصوص Visual Studio Code با Phi-3.5 توسط مدل‌های GitHub](/md/02.Application/02.Code/Phi3/CreateVSCodeChatAgentWithGitHubModels.md)
  ...
  - نمونه‌های بینایی
    ...
    - نمونه‌های Phi-3 / 3.5
      -  [📓][متن به متن تصویر دیداری Phi-3-vision](./md/02.Application/04.Vision/Phi3/E2E_Phi-3-vision-image-text-to-text-online-endpoint.ipynb)
      - [Phi-3-vision-ONNX](https://onnxruntime.ai/docs/genai/tutorials/phi3-v.html)
      - [📓][نمایه‌سازی CLIP دیداری Phi-3](./md/02.Application/04.Vision/Phi3/E2E_Phi-3-vision-image-text-to-text-online-endpoint.ipynb)
      - [دمو: بازیافت Phi-3](https://github.com/jennifermarsman/PhiRecycling/)
      - [Phi-3-vision – دستیار زبان دیداری – با Phi3-Vision و OpenVINO](https://docs.openvino.ai/nightly/notebooks/phi-3-vision-with-output.html)
  ...
  - نمونه‌های صوتی
    - نمونه‌های Phi-4 🆕
      ...
      - [اپلیکیشن کنسول .NET با استفاده از Phi-4-multimodal برای تحلیل فایل صوتی و تولید رونوشت](../../md/04.HOL/dotnet/src/LabsPhi4-MultiModal-02Audio)

  - نمونه‌های MOE
    - نمونه‌های Phi-3 / 3.5
      - [📓] [نمونه مدل‌های ترکیب متخصصین Phi-3.5 (MoEs) در شبکه‌های اجتماعی](./md/02.Application/06.MoE/Phi3/phi3_moe_demo.ipynb)
      - [📓] [ساخت درگاه تولید تکمیلی (RAG) با NVIDIA NIM Phi-3 MOE، جستجوی Azure AI و LlamaIndex](./md/02.Application/06.MoE/Phi3/azure-ai-search-nvidia-rag.ipynb)
      - 
  - نمونه‌های فراخوانی توابع
    - نمونه‌های Phi-4 🆕
      ...
      -  [📓] [استفاده از فراخوانی توابع برای ایجاد چندعامل با Phi-4-mini](./md/02.Application/07.FunctionCalling/Phi4/Multiagents/Phi_4_mini_multiagent.ipynb)
      -  [📓] [استفاده از فراخوانی توابع با Ollama](./md/02.Application/07.FunctionCalling/Phi4/Ollama/ollama_functioncalling.ipynb)
      -  [📓] [استفاده از فراخوانی توابع با ONNX](./md/02.Application/07.FunctionCalling/Phi4/ONNX/onnx_parallel_functioncalling.ipynb)
  - نمونه‌های مخلوط چندرسانه‌ای
    - نمونه‌های Phi-4 🆕
      -  [📓] [استفاده از Phi-4-multimodal به‌عنوان خبرنگار تکنولوژی](./md/02.Application/08.Multimodel/Phi4/TechJournalist/phi_4_mm_audio_text_publish_news.ipynb)
...
- نمونه‌های تنظیم دقیق Phi
  ...
  - [تنظیم دقیق برای اینکه Phi-3 به یک متخصص صنعت تبدیل شود](./md/03.FineTuning/LetPhi3gotoIndustriy.md)
...
- کارگاه عملی
  - [کاوش مدل‌های پیشرو: LLMها، SLMها، توسعه محلی و بیشتر](https://github.com/microsoft/aitour-exploring-cutting-edge-models)
  - [آزادسازی پتانسیل NLP: تنظیم دقیق با Microsoft Olive](https://github.com/azure/Ignite_FineTuning_workshop)
- مقالات و نشریات پژوهشی دانشگاهی  
  - [کتاب‌های درسی همه چیزی است که شما نیاز دارید II: گزارش فنی phi-1.5](https://arxiv.org/abs/2309.05463)  
  ...
  - [گزارش فنی Phi-4-Mini: مدل‌های زبان چندمودالی جمع‌وجور و قدرتمند از طریق ترکیب Mixture-of-LoRAs](https://arxiv.org/abs/2503.01743)  
  - [بهینه‌سازی مدل‌های زبان کوچک برای تماس به توابع در خودرو](https://arxiv.org/abs/2501.02342)  
  - [(WhyPHI) تنظیم دقیق PHI-3 برای پاسخگویی به پرسش‌های چندگزینه‌ای: روش‌شناسی، نتایج و چالش‌ها](https://arxiv.org/abs/2501.01588)  
  - [گزارش فنی دلیل‌یابی Phi-4](https://www.microsoft.com/en-us/research/wp-content/uploads/2025/04/phi_4_reasoning.pdf)  
  - [گزارش فنی دلیل‌یابی Phi-4-mini](https://huggingface.co/microsoft/Phi-4-mini-reasoning/blob/main/Phi-4-Mini-Reasoning.pdf)  
...
شما می‌توانید یاد بگیرید چگونه از Microsoft Phi استفاده کنید و چگونه راه‌حل‌های انتها به انتها را در دستگاه‌های سخت‌افزاری مختلف خود بسازید. برای تجربه کردن Phi به صورت عملی، ابتدا با مدل بازی کنید و Phi را برای سناریوهای خود سفارشی کنید با استفاده از کاتالوگ مدل‌های [GitHub Model Catalog](https://github.com/marketplace/models?WT.mc_id=aiml-137032-kinfeylo). می‌توانید برای شروع بیشتر، مستندات شروع کار با [GitHub Model Catalog](/md/02.QuickStart/GitHubModel_QuickStart.md) را مطالعه کنید.

**محیط آزمایش**  
هر مدل یک [محیط آزمایش اختصاصی دارد تا مدل را آزمایش کنید](/md/02.QuickStart/GitHubModel_QuickStart.md).
...
**محیط آزمایش**  
 [محیط آزمایش Hugging Chat playground](https://huggingface.co/chat/models/microsoft/Phi-3-mini-4k-instruct)
...
### سری AI تولیدی  
[![AI تولیدی برای مبتدیان](https://img.shields.io/badge/Generative%20AI%20for%20Beginners-8B5CF6?style=for-the-badge&labelColor=E5E7EB&color=8B5CF6)](https://github.com/microsoft/generative-ai-for-beginners?WT.mc_id=academic-105485-koreyst)  
[![AI تولیدی (.NET)](https://img.shields.io/badge/Generative%20AI%20(.NET)-9333EA?style=for-the-badge&labelColor=E5E7EB&color=9333EA)](https://github.com/microsoft/Generative-AI-for-beginners-dotnet?WT.mc_id=academic-105485-koreyst)  
[![AI تولیدی (Java)](https://img.shields.io/badge/Generative%20AI%20(Java)-C084FC?style=for-the-badge&labelColor=E5E7EB&color=C084FC)](https://github.com/microsoft/generative-ai-for-beginners-java?WT.mc_id=academic-105485-koreyst)  
[![AI تولیدی (JavaScript)](https://img.shields.io/badge/Generative%20AI%20(JavaScript)-E879F9?style=for-the-badge&labelColor=E5E7EB&color=E879F9)](https://github.com/microsoft/generative-ai-with-javascript?WT.mc_id=academic-105485-koreyst)  
...
### سری Copilot  
[![Copilot برای برنامه‌نویسی جفتی با AI](https://img.shields.io/badge/Copilot%20for%20AI%20Paired%20Programming-FACC15?style=for-the-badge&labelColor=E5E7EB&color=FACC15)](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)  
...
مایکروسافت متعهد است به کمک به مشتریان خود برای استفاده مسئولانه از محصولات هوش مصنوعی، به اشتراک گذاری تجربیات خود و ایجاد مشارکت‌های مبتنی بر اعتماد از طریق ابزارهایی مانند یادداشت‌های شفافیت و ارزیابی تأثیرات. بسیاری از این منابع را می‌توانید در [https://aka.ms/RAI](https://aka.ms/RAI) بیابید.  
رویکرد مایکروسافت برای هوش مصنوعی مسئولانه مبتنی بر اصول هوش مصنوعی ما در زمینه انصاف، قابلیت اطمینان و ایمنی، حفظ حریم خصوصی و امنیت، فراگیری، شفافیت و پاسخگویی است.
...
این پروژه ممکن است حاوی علائم تجاری یا لوگوهایی برای پروژه‌ها، محصولات یا خدمات باشد. استفاده مجاز از علائم تجاری یا لوگوهای مایکروسافت تابع و باید مطابق با [دستورالعمل علائم تجاری و برند مایکروسافت](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general) باشد.
استفاده از علائم تجاری یا لوگوهای مایکروسافت در نسخه‌های تغییر یافته این پروژه نباید باعث سردرگمی یا ایجاد مفهوم حمایت مایکروسافت شود. هرگونه استفاده از علائم تجاری یا لوگوهای طرف سوم مشروط به سیاست‌های آن طرف سوم است.
...
**توضیح مهم**:  
این سند با استفاده از سرویس ترجمه هوش مصنوعی [Co-op Translator](https://github.com/Azure/co-op-translator) ترجمه شده است. در حالی که ما تلاش می‌کنیم ترجمه‌ها دقیق باشند، لطفاً توجه داشته باشید که ترجمه‌های خودکار ممکن است شامل اشتباهات یا نادرستی‌هایی باشند. سند اصلی به زبان اصلی خود، منبع معتبر و قطعی محسوب می‌شود. برای اطلاعات حیاتی، توصیه به استفاده از ترجمه حرفه‌ای انسانی می‌شود. مسئولیتی در قبال سوتفاهم‌ها یا تفسیرهای نادرست ناشی از استفاده از این ترجمه پذیرفته نمی‌شود.
