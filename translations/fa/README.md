...
[![ارسال PR خوش‌آمدید](https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat-square)](http://makeapullrequest.com?WT.mc_id=aiml-137032-kinfeylo)
...
[![دیسکورد Microsoft Azure AI Foundry](https://dcbadge.limes.pink/api/server/ByRwuEEgH4)](https://discord.com/invite/ByRwuEEgH4)

Phi مجموعه‌ای از مدل‌های هوش مصنوعی متن‌باز است که توسط مایکروسافت توسعه یافته‌اند. 

در حال حاضر Phi قدرتمندترین و مقرون‌به‌صرفه‌ترین مدل زبان کوچک (SLM) است و در معیارها برای چندزبانه، استدلال، تولید متن/چت، کدنویسی، تصاویر، صدا و دیگر سناریوها عملکرد بسیار خوبی دارد. 

می‌توانید Phi را در ابر یا روی دستگاه‌های لبه‌ای مستقر کنید، و به‌راحتی برنامه‌های تولیدی هوش مصنوعی را با توان محاسباتی محدود بسازید.

برای شروع استفاده از این منابع مراحل زیر را دنبال کنید:
1. **مخزن را فورک کنید**: روی [![فورک‌های GitHub](https://img.shields.io/github/forks/microsoft/phicookbook.svg?style=social&label=Fork)](https://GitHub.com/microsoft/phicookbook/network/?WT.mc_id=aiml-137032-kinfeylo) کلیک کنید
2. **مخزن را کلون کنید**:   `git clone https://github.com/microsoft/PhiCookBook.git`
3. [**به جامعه دیسکورد Microsoft AI بپیوندید و با متخصصان و توسعه‌دهندگان دیگر آشنا شوید**](https://discord.com/invite/ByRwuEEgH4?WT.mc_id=aiml-137032-kinfeylo)

![کاور](../../translated_images/cover.eb18d1b9605d754b.fa.png)
...
- استنتاج در خانواده Phi
    - [استنتاج Phi در iOS](./md/01.Introduction/03/iOS_Inference.md)
    - [استنتاج Phi در Android](./md/01.Introduction/03/Android_Inference.md)
...
-  [کوانتایز کردن خانواده Phi](./md/01.Introduction/04/QuantifyingPhi.md)
    - [کوانتایز کردن Phi-3.5 / 4 با استفاده از llama.cpp](./md/01.Introduction/04/UsingLlamacppQuantifyingPhi.md)
    - [کوانتایز کردن Phi-3.5 / 4 با استفاده از افزونه‌های Generative AI برای onnxruntime](./md/01.Introduction/04/UsingORTGenAIQuantifyingPhi.md)
    - [کوانتایز کردن Phi-3.5 / 4 با استفاده از Intel OpenVINO](./md/01.Introduction/04/UsingIntelOpenVINOQuantifyingPhi.md)
    - [کوانتایز کردن Phi-3.5 / 4 با استفاده از Apple MLX Framework](./md/01.Introduction/04/UsingAppleMLXQuantifyingPhi.md)
...
- نمونه‌های توسعه برنامه‌های Phi
  - برنامه‌های متنی و چت
    ...
    - نمونه‌های Phi-3 / 3.5
      ...
      - [بهینه‌سازی مدل - چگونه مدل Phi-3-min را برای ONNX Runtime Web با Olive بهینه‌سازی کنیم](https://github.com/microsoft/Olive/tree/main/examples/phi3)
      - [اپلیکیشن WinUI3 با Phi-3 mini-4k-instruct-onnx](https://github.com/microsoft/Phi3-Chat-WinUI3-Sample/)
      -[نمونه اپ یادداشت‌برداری هوش‌مصنوعی چندمدلی WinUI3](https://github.com/microsoft/ai-powered-notes-winui3-sample)
      ...
      - [ارزیابی مدل Phi-3 / Phi-3.5 تنظیم‌شده در Azure AI Foundry با تمرکز بر اصول هوش مصنوعی مسئولانه مایکروسافت](./md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-Evaluation_AIFoundry.md)
      - [📓] [نمونه پیش‌بینی زبان Phi-3.5-mini-instruct (چینی/انگلیسی)](./md/02.Application/01.TextAndChat/Phi3/phi3-instruct-demo.ipynb)
      - [چت‌بات RAG Phi-3.5-Instruct با WebGPU](./md/02.Application/01.TextAndChat/Phi3/WebGPUWithPhi35Readme.md)
      ...
      - [استفاده از Microsoft Phi-3.5 tflite برای ساخت اپ اندروید](./md/02.Application/01.TextAndChat/Phi3/UsingPhi35TFLiteCreateAndroidApp.md)
      - [مثال پرسش و پاسخ .NET با استفاده از مدل محلی ONNX Phi-3 و Microsoft.ML.OnnxRuntime](../../md/04.HOL/dotnet/src/LabsPhi301)
      - [اپ کنسول چت .NET با Semantic Kernel و Phi-3](../../md/04.HOL/dotnet/src/LabsPhi302)
  ...
  - نمونه‌های مبتنی بر کد Azure AI Inference SDK 
    ...
    - نمونه‌های Phi-3 / 3.5
      ...
      - [ایجاد عامل Chat Copilot برای Visual Studio Code با Phi-3.5 توسط مدل‌های GitHub](/md/02.Application/02.Code/Phi3/CreateVSCodeChatAgentWithGitHubModels.md)
  ...
  - نمونه‌های بینایی
    ...
    - نمونه‌های Phi-3 / 3.5
      -  [📓][Phi-3-vision - تبدیل تصویر به متن](./md/02.Application/04.Vision/Phi3/E2E_Phi-3-vision-image-text-to-text-online-endpoint.ipynb)
      ...
      - [📓][نمونه چندفریمه یا چندتصویری Phi-3.5 Vision](./md/02.Application/04.Vision/Phi3/phi3-vision-demo.ipynb)
  ...
  - نمونه‌های MOE
    - نمونه‌های Phi-3 / 3.5
      - [📓] [نمونه رسانه‌های اجتماعی مدل‌های Phi-3.5 Mixture of Experts (MoEs)](./md/02.Application/06.MoE/Phi3/phi3_moe_demo.ipynb)
  ...
  - نمونه‌های فراخوانی تابع
    - نمونه‌های Phi-4 🆕
      -  [📓] [استفاده از Function Calling با Phi-4-mini](./md/02.Application/07.FunctionCalling/Phi4/FunctionCallingBasic/README.md)
      -  [📓] [استفاده از Function Calling برای ایجاد چندعامل با Phi-4-mini](./md/02.Application/07.FunctionCalling/Phi4/Multiagents/Phi_4_mini_multiagent.ipynb)
      -  [📓] [استفاده از Function Calling با Ollama](./md/02.Application/07.FunctionCalling/Phi4/Ollama/ollama_functioncalling.ipynb)
      -  [📓] [استفاده از Function Calling با ONNX](./md/02.Application/07.FunctionCalling/Phi4/ONNX/onnx_parallel_functioncalling.ipynb)
...
- تنظیم دقیق نمونه‌های Phi
  ...
  - [تنظیم دقیق: اجازه دهید Phi-3 تبدیل به یک کارشناس صنعتی شود](./md/03.FineTuning/LetPhi3gotoIndustriy.md)
  ...
  - [تنظیم دقیق Phi-3 با Kaito AKS , Azure Containers(official Support)](./md/03.FineTuning/FineTuning_Kaito.md)
...
- مقالات و انتشارات پژوهشی دانشگاهی
  ...
  - [گزارش فنی Phi-4-Mini: مدل‌های زبان چندرسانه‌ای جمع‌وجور اما قدرتمند از طریق مخلوطی از LoRAها](https://arxiv.org/abs/2503.01743)
  - [بهینه‌سازی مدل‌های کوچک زبان برای فراخوانی توابع درون‌خودرو](https://arxiv.org/abs/2501.02342)
  - [(WhyPHI) آموزش دقیق PHI-3 برای پاسخ‌دهی به سوالات چندگزینه‌ای: روش‌شناسی، نتایج و چالش‌ها](https://arxiv.org/abs/2501.01588)
...
می‌توانید بیاموزید چگونه از Microsoft Phi استفاده کنید و چگونه راه‌حل‌های E2E را در دستگاه‌های سخت‌افزاری مختلف خود بسازید. برای تجربه Phi به‌صورت عملی، با اجرای آزمایشی مدل‌ها و سفارشی‌سازی Phi برای سناریوهای خود شروع کنید با استفاده از [Azure AI Foundry Azure AI Model Catalog](https://aka.ms/phi3-azure-ai) می‌توانید اطلاعات بیشتری در Getting Started with [Azure AI Foundry](/md/02.QuickStart/AzureAIFoundry_QuickStart.md) بیاموزید

**Playground**
هر مدل دارای یک محیط آزمایشی اختصاصی برای تست مدل است [Azure AI Playground](https://aka.ms/try-phi3).

### Phi در GitHub Models

می‌توانید بیاموزید چگونه از Microsoft Phi استفاده کنید و چگونه راه‌حل‌های E2E را در دستگاه‌های سخت‌افزاری مختلف خود بسازید. برای تجربه Phi به‌صورت عملی، با اجرای آزمایشی مدل و سفارشی‌سازی Phi برای سناریوهای خود شروع کنید با استفاده از [GitHub Model Catalog](https://github.com/marketplace/models?WT.mc_id=aiml-137032-kinfeylo) می‌توانید اطلاعات بیشتری در Getting Started with [GitHub Model Catalog](/md/02.QuickStart/GitHubModel_QuickStart.md) بیاموزید

**Playground**
هر مدل دارای یک [محیط آزمایشی برای تست مدل](/md/02.QuickStart/GitHubModel_QuickStart.md) اختصاصی است.
...
مایکروسافت متعهد است به مشتریانمان کمک کند تا از محصولات هوش مصنوعی ما به‌صورت مسئولانه استفاده کنند، دانسته‌های خود را به اشتراک بگذارد، و از طریق ابزارهایی مانند Transparency Notes و Impact Assessments شراکت‌های مبتنی بر اعتماد بسازد. بسیاری از این منابع را می‌توانید در [https://aka.ms/RAI](https://aka.ms/RAI) بیابید.
رویکرد مایکروسافت به هوش مصنوعی مسئولانه بر اصول AI ما مبتنی است: عدالت، قابلیت اطمینان و ایمنی، حریم خصوصی و امنیت، فراگیری، شفافیت و پاسخگویی.

مدل‌های بزرگ در مقیاس وسیع برای زبان، تصویر و گفتار — مانند آن‌هایی که در این نمونه استفاده شده‌اند — ممکن است رفتارهایی ناعادلانه، غیرقابل‌اعتماد یا توهین‌آمیز از خود بروز دهند که می‌تواند منجر به آسیب شود. لطفاً برای اطلاع از ریسک‌ها و محدودیت‌ها به [Azure OpenAI service Transparency note](https://learn.microsoft.com/legal/cognitive-services/openai/transparency-note?tabs=text) مراجعه کنید.

رویکرد پیشنهادی برای کاهش این ریسک‌ها، قرار دادن یک سیستم ایمنی در معماری شماست که بتواند رفتارهای مضر را شناسایی و از آن‌ها جلوگیری کند. [Azure AI Content Safety](https://learn.microsoft.com/azure/ai-services/content-safety/overview) یک لایه حفاظتی مستقل فراهم می‌کند که قادر به شناسایی محتوای مضر تولیدشده توسط کاربران و محتوای تولیدشده توسط هوش مصنوعی در برنامه‌ها و خدمات است. Azure AI Content Safety شامل APIهای متنی و تصویری است که امکان شناسایی محتوای مضر را فراهم می‌کنند. در درون Azure AI Foundry، سرویس Content Safety به شما اجازه می‌دهد نمونه کدهای مربوط به تشخیص محتوای مضر در قالب‌های مختلف را مشاهده، بررسی و امتحان کنید. [مستندات راه‌اندازی سریع](https://learn.microsoft.com/azure/ai-services/content-safety/quickstart-text?tabs=visual-studio%2Clinux&pivots=programming-language-rest) زیر شما را در انجام درخواست‌ها به سرویس راهنمایی می‌کند.

جنبه دیگری که باید در نظر گرفته شود، عملکرد کلی برنامه است. در برنامه‌های چندرسانه‌ای و چندمدلی، عملکرد به این معنی است که سیستم همان‌گونه که شما و کاربران‌تان انتظار دارید عمل کند، از جمله عدم تولید خروجی‌های مضر. مهم است عملکرد کلی برنامه خود را با استفاده از [Performance and Quality and Risk and Safety evaluators](https://learn.microsoft.com/azure/ai-studio/concepts/evaluation-metrics-built-in) ارزیابی کنید. شما همچنین قابلیت ایجاد و ارزیابی با [custom evaluators](https://learn.microsoft.com/azure/ai-studio/how-to/develop/evaluate-sdk#custom-evaluators) را دارید.

می‌توانید برنامه هوش مصنوعی خود را در محیط توسعه با استفاده از [Azure AI Evaluation SDK](https://microsoft.github.io/promptflow/index.html) ارزیابی کنید. با داشتن یک مجموعه داده تست یا یک هدف، تولیدات برنامه هوش مولد شما به‌صورت کمی با ارزیاب‌های داخلی یا ارزیاب‌های سفارشی انتخابی اندازه‌گیری می‌شود. برای شروع با azure ai evaluation sdk جهت ارزیابی سیستم خود، می‌توانید راهنمای [quickstart guide](https://learn.microsoft.com/azure/ai-studio/how-to/develop/flow-evaluate-sdk) را دنبال کنید. پس از اجرای یک دور ارزیابی، می‌توانید [نتایج را در Azure AI Foundry بصری‌سازی کنید](https://learn.microsoft.com/azure/ai-studio/how-to/evaluate-flow-results). 

## علائم تجاری
این پروژه ممکن است حاوی علائم تجاری یا لوگوهایی برای پروژه‌ها، محصولات یا خدمات باشد. استفاده مجاز از علائم تجاری یا لوگوهای مایکروسافت منوط به و باید مطابق با [راهنمای علائم تجاری و برند مایکروسافت](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general) باشد.
استفاده از علائم تجاری یا لوگوهای مایکروسافت در نسخه‌های تغییر یافته این پروژه نباید موجب سردرگمی شود یا دلالت بر حمایت مایکروسافت داشته باشد. هرگونه استفاده از علائم تجاری یا لوگوهای شخص ثالث تابع سیاست‌های آن‌ها است.

## دریافت کمک

اگر در ساخت برنامه‌های هوش مصنوعی به مشکل خوردید یا سؤالی دارید، بپیوندید:
...
اگر بازخورد محصول دارید یا در حین ساخت با خطا مواجه شدید، مراجعه کنید:
