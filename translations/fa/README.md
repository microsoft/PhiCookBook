# کتاب‌طبخ فی: مثال‌های عملی با مدل‌های فی مایکروسافت
...
فی مجموعه‌ای از مدل‌های هوش مصنوعی متن‌باز است که توسط مایکروسافت توسعه یافته است.

فی در حال حاضر قدرتمندترین و مقرون‌به‌صرفه‌ترین مدل زبان کوچک (SLM) است که به‌خوبی در چند زبان، استدلال، تولید متن/چت، کدنویسی، تصاویر، صدا و سناریوهای دیگر ارزیابی شده است.

شما می‌توانید فی را در فضای ابری یا دستگاه‌های مرزی مستقر کنید و به آسانی برنامه‌های هوش مصنوعی مولد را با قدرت محاسباتی محدود بسازید.

برای شروع استفاده از این منابع، مراحل زیر را دنبال کنید:
1. **فورک مخزن**: کلیک کنید [![شاخه‌های GitHub](https://img.shields.io/github/forks/microsoft/phicookbook.svg?style=social&label=Fork)](https://GitHub.com/microsoft/phicookbook/network/?WT.mc_id=aiml-137032-kinfeylo)
2. **کلون کردن مخزن**:   `git clone https://github.com/microsoft/PhiCookBook.git`
3. [**به جامعه دیسکورد هوش مصنوعی مایکروسافت بپیوندید و با کارشناسان و توسعه‌دهندگان هم‌تراز ملاقات کنید**](https://discord.com/invite/ByRwuEEgH4?WT.mc_id=aiml-137032-kinfeylo)

![کاور](../../translated_images/fa/cover.eb18d1b9605d754b.webp)
...
> ```
> این به شما همه چیزی را که برای کامل کردن دوره نیاز دارید با دانلود بسیار سریع‌تر می‌دهد.
<!-- CO-OP TRANSLATOR LANGUAGES TABLE END -->

## فهرست مطالب

- مقدمه
  - [خوش‌آمدگویی به خانواده فی](./md/01.Introduction/01/01.PhiFamily.md)
  - [تنظیم محیط کاری خود](./md/01.Introduction/01/01.EnvironmentSetup.md)
...
- استنتاج خانواده فی
    ...
    - [استنتاج فی در رایانه هوش مصنوعی](./md/01.Introduction/03/AIPC_Inference.md)
    - [استنتاج فی با چارچوب MLX اپل](./md/01.Introduction/03/MLX_Inference.md)
    ...
    - [استنتاج فی--بینایی در محلی](./md/01.Introduction/03/Vision_Inference.md)
...
-  [کوانتیزه کردن خانواده فی](./md/01.Introduction/04/QuantifyingPhi.md)
    ...
    - [کوانتیزه کردن فی-3.5 / 4 با استفاده از چارچوب MLX اپل](./md/01.Introduction/04/UsingAppleMLXQuantifyingPhi.md)

- ارزیابی فی
    - [هوش مصنوعی مسئول](./md/01.Introduction/05/ResponsibleAI.md)
    - [کاتالوگ Azure AI Foundry برای ارزیابی](./md/01.Introduction/05/AIFoundry.md)
    - [استفاده از Promptflow برای ارزیابی](./md/01.Introduction/05/Promptflow.md)
 
- RAG با جستجوی Azure AI
    - [نحوه استفاده از Phi-4-mini و Phi-4-multimodal (RAG) با جستجوی Azure AI](https://github.com/microsoft/PhiCookBook/blob/main/code/06.E2E/E2E_Phi-4-RAG-Azure-AI-Search.ipynb)

- نمونه‌های توسعه برنامه‌های فی
  - برنامه‌های متن و چت
    - نمونه‌های فی-4 🆕
      - [📓] [چت با مدل ONNX Phi-4-mini](./md/02.Application/01.TextAndChat/Phi4/ChatWithPhi4ONNX/README.md)
      - [چت با مدل محلی ONNX فی-4 در .NET](../../md/04.HOL/dotnet/src/LabsPhi4-Chat-01OnnxRuntime)
      - [چت برنامه کنسولی .NET با فی-4 ONNX با استفاده از Sementic Kernel](../../md/04.HOL/dotnet/src/LabsPhi4-Chat-02SK)
    - نمونه‌های فی-3 / 3.5
      ...
      - [مدل چندگانه - Phi-3-mini تعاملی و OpenAI Whisper](./md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-mini_with_whisper.md)
      - [MLFlow - ساخت یک پوشش و استفاده از Phi-3 با MLFlow](./md//02.Application/01.TextAndChat/Phi3/E2E_Phi-3-MLflow.md)
      - [بهینه‌سازی مدل - چگونه مدل Phi-3-mini را برای ONNX Runtime Web با Olive بهینه کنیم](https://github.com/microsoft/Olive/tree/main/examples/phi3)
      - [برنامه WinUI3 با Phi-3 mini-4k-instruct-onnx](https://github.com/microsoft/Phi3-Chat-WinUI3-Sample/)
      -[نمونه برنامه یادداشت‌های چندمدلی WinUI3 هوش مصنوعی](https://github.com/microsoft/ai-powered-notes-winui3-sample)
      ...
      - [ربات گفتگو Phi-3.5-Instruct WebGPU RAG](./md/02.Application/01.TextAndChat/Phi3/WebGPUWithPhi35Readme.md)
  ...
  - نمونه‌های مبتنی بر کد Azure AI Inference SDK
    - نمونه‌های Phi-4 🆕
      - [📓] [تولید کد پروژه با استفاده از Phi-4-multimodal](./md/02.Application/02.Code/Phi4/GenProjectCode/README.md)
    - نمونه‌های Phi-3 / 3.5
      - [ساخت گیت‌هاب کوپایلوت چت Visual Studio Code خود با خانواده Microsoft Phi-3](./md/02.Application/02.Code/Phi3/VSCodeExt/README.md)
      - [ساخت نماینده چت گیت‌هاب کوپایلوت Visual Studio Code با مدل‌های Phi-3.5](./md/02.Application/02.Code/Phi3/CreateVSCodeChatAgentWithGitHubModels.md)
  ...
  - نمونه‌های صوتی
    - نمونه‌های Phi-4 🆕
      ...
      - [برنامه کنسول .NET با استفاده از Phi-4-multimodal برای آنالیز فایل صوتی و تولید متن](../../md/04.HOL/dotnet/src/LabsPhi4-MultiModal-02Audio)

  - نمونه‌های MOE
    - نمونه‌های Phi-3 / 3.5
      - [📓] [نمونه مدل‌های مخلوط متخصصین (MoEs) Phi-3.5 برای شبکه‌های اجتماعی](./md/02.Application/06.MoE/Phi3/phi3_moe_demo.ipynb)
      - [📓] [ساخت خط لوله بازیابی-افزوده‌شده (RAG) با NVIDIA NIM Phi-3 MOE، Azure AI Search و LlamaIndex](./md/02.Application/06.MoE/Phi3/azure-ai-search-nvidia-rag.ipynb)
      - 
  - نمونه‌های فراخوانی تابع
    - نمونه‌های Phi-4 🆕
      ...
      -  [📓] [استفاده از فراخوانی تابع برای ایجاد چند نماینده با Phi-4-mini](./md/02.Application/07.FunctionCalling/Phi4/Multiagents/Phi_4_mini_multiagent.ipynb)
...
- تنظیم دقیق نمونه‌های Phi
  ...
  - [تنظیم دقیق بگذارید Phi-3 به یک کارشناس صنعتی تبدیل شود](./md/03.FineTuning/LetPhi3gotoIndustriy.md)
  - [تنظیم دقیق Phi-3 با کیت ابزار AI برای VS Code](./md/03.FineTuning/Finetuning_VSCodeaitoolkit.md)
...
- مقالات و انتشارات پژوهشی دانشگاهی
  - [کتاب‌های درسی تمام آن چیزی است که شما نیاز دارید II: گزارش فنی phi-1.5](https://arxiv.org/abs/2309.05463)
  ...
  - [گزارش فنی Phi-4-Mini: مدل‌های زبان چندوجهی جمع‌وجور اما قدرتمند از طریق ترکیب LoRA‌ها](https://arxiv.org/abs/2503.01743)
  - [بهینه‌سازی مدل‌های زبان کوچک برای فراخوانی عملکرد درون‌خودرویی](https://arxiv.org/abs/2501.02342)
  - [(دلایل PHI) ریزتنظیم PHI-3 برای پاسخ‌دهی به سوالات چندگزینه‌ای: روش‌شناسی، نتایج و چالش‌ها](https://arxiv.org/abs/2501.01588)
...
شما می‌توانید یاد بگیرید چگونه از Microsoft Phi استفاده کنید و چگونه راه‌حل‌های انتها به انتها را در دستگاه‌های سخت‌افزاری متفاوت خود بسازید. برای تجربه کردن Phi به‌صورت عملی، با بازی کردن با مدل‌ها شروع کنید و Phi را بر اساس سناریوهای خود شخصی‌سازی کنید با استفاده از [کاتالوگ مدل Azure AI Foundry](
https://aka.ms/phi3-azure-ai) می‌توانید اطلاعات بیشتری در شروع کار با [Azure AI Foundry](/md/02.QuickStart/AzureAIFoundry_QuickStart.md) بیاموزید.

**مسابقه**
هر مدل یک محیط آزمایشی اختصاصی برای تست دارد [مسابقه Azure AI](https://aka.ms/try-phi3).

### Phi در مدل‌های GitHub

شما می‌توانید یاد بگیرید چگونه از Microsoft Phi استفاده کنید و چگونه راه‌حل‌های انتها به انتها را در دستگاه‌های سخت‌افزاری مختلف خود بسازید. برای تجربه کردن Phi به‌صورت عملی، با بازی کردن با مدل شروع کنید و Phi را برای سناریوهای خود شخصی‌سازی کنید با استفاده از [کاتالوگ مدل GitHub](https://github.com/marketplace/models?WT.mc_id=aiml-137032-kinfeylo) می‌توانید اطلاعات بیشتری در شروع کار با [کاتالوگ مدل GitHub](/md/02.QuickStart/GitHubModel_QuickStart.md) بیاموزید.
...
### سری Copilot
[![Copilot برای برنامه‌نویسی جفت‌ی هوش مصنوعی](https://img.shields.io/badge/Copilot%20for%20AI%20Paired%20Programming-FACC15?style=for-the-badge&labelColor=E5E7EB&color=FACC15)](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)
...
مایکروسافت متعهد است به کمک به مشتریان خود برای استفاده مسئولانه از محصولات هوش مصنوعی، به اشتراک‌گذاری آموخته‌ها و ساخت شراکت‌های مبتنی بر اعتماد از طریق ابزارهایی مانند یادداشت‌های شفاف‌سازی و ارزیابی‌های تأثیر. بسیاری از این منابع را می‌توانید در [https://aka.ms/RAI](https://aka.ms/RAI) بیابید.
رویکرد مایکروسافت به هوش مصنوعی مسئولانه بر اساس اصول هوش مصنوعی ما است؛ عدالت، قابلیت اطمینان و ایمنی، حفظ حریم خصوصی و امنیت، شمولیت، شفافیت و پاسخگویی.

مدل‌های بزرگ مقیاس زبان طبیعی، تصویر و گفتار - مانند آن‌هایی که در این نمونه استفاده شده‌اند - ممکن است به طرقی رفتار کنند که ناعادلانه، غیرقابل اعتماد یا توهین‌آمیز باشد و به همین ترتیب آسیب‌هایی ایجاد کنند. لطفاً برای آگاهی از ریسک‌ها و محدودیت‌ها به [یادداشت شفافیت سرویس Azure OpenAI](https://learn.microsoft.com/legal/cognitive-services/openai/transparency-note?tabs=text) مراجعه کنید.

رویکرد توصیه‌شده برای کاهش این خطرات، افزودن یک سیستم ایمنی در معماری شما است که بتواند رفتارهای مضر را شناسایی و از آن جلوگیری کند. [ایمنی محتوای Azure AI](https://learn.microsoft.com/azure/ai-services/content-safety/overview) لایه‌ای مستقل از حفاظت فراهم می‌کند که قادر به شناسایی محتوای مضر تولیدشده توسط کاربر و هوش مصنوعی در برنامه‌ها و خدمات است. ایمنی محتوای Azure AI شامل API‌های متن و تصویر است که به شما اجازه می‌دهد محتوای مضر را شناسایی کنید. در Azure AI Foundry، سرویس ایمنی محتوا امکان مشاهده، بررسی و آزمایش نمونه کد برای شناسایی محتوای مضر در مدالیتی‌های مختلف را فراهم می‌کند. مستندات [شروع سریع](https://learn.microsoft.com/azure/ai-services/content-safety/quickstart-text?tabs=visual-studio%2Clinux&pivots=programming-language-rest) زیر شما را در فرایند ارسال درخواست به این سرویس راهنمایی می‌کند.
جنبه دیگر که باید در نظر گرفت، عملکرد کلی برنامه است. با برنامه‌های چندرسانه‌ای و چندمدلی، منظور ما از عملکرد این است که سیستم طبق انتظار شما و کاربران‌تان عمل کند، از جمله تولید نکردن خروجی‌های مضر. ارزیابی عملکرد برنامه کلی خود با استفاده از [ارزیاب‌های عملکرد، کیفیت، ریسک و ایمنی](https://learn.microsoft.com/azure/ai-studio/concepts/evaluation-metrics-built-in) مهم است. همچنین امکان ایجاد و ارزیابی با [ارزیاب‌های سفارشی](https://learn.microsoft.com/azure/ai-studio/how-to/develop/evaluate-sdk#custom-evaluators) را دارید.

شما می‌توانید برنامه هوش مصنوعی خود را در محیط توسعه خود با استفاده از [Azure AI Evaluation SDK](https://microsoft.github.io/promptflow/index.html) ارزیابی کنید. با داشتن یک مجموعه داده آزمایشی یا هدف مشخص، تولیدات برنامه هوش مصنوعی تولیدی شما به‌صورت کمی با ارزیاب‌های داخلی یا ارزیاب‌های سفارشی انتخابی شما اندازه‌گیری می‌شوند. برای شروع کار با Azure AI Evaluation SDK جهت ارزیابی سیستم خود، می‌توانید از [راهنمای سریع شروع](https://learn.microsoft.com/azure/ai-studio/how-to/develop/flow-evaluate-sdk) پیروی کنید. پس از اجرای یک ارزیابی، می‌توانید [نتایج را در Azure AI Foundry مشاهده کنید](https://learn.microsoft.com/azure/ai-studio/how-to/evaluate-flow-results).

## علائم تجاری

این پروژه ممکن است حاوی علائم تجاری یا لوگوهایی برای پروژه‌ها، محصولات یا خدمات باشد. استفاده مجاز از علائم تجاری یا لوگوهای مایکروسافت مشروط به رعایت [راهنمای علائم تجاری و برند مایکروسافت](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general) است.
استفاده از علائم تجاری یا لوگوهای مایکروسافت در نسخه‌های تغییر یافته این پروژه نباید موجب سردرگمی یا القای حمایت مایکروسافت شود. هرگونه استفاده از علائم تجاری یا لوگوهای شخص ثالث مشروط به سیاست‌های آن شخص ثالث است.

## دریافت کمک

اگر به مشکل خوردید یا سوالی درباره ساخت برنامه‌های هوش مصنوعی داشتید، به:

[![Azure AI Foundry Discord](https://img.shields.io/badge/Discord-Azure_AI_Foundry_Community_Discord-blue?style=for-the-badge&logo=discord&color=5865f2&logoColor=fff)](https://aka.ms/foundry/discord)

اگر بازخورد محصول یا خطایی هنگام ساخت داشتید، به:

[![Azure AI Foundry Developer Forum](https://img.shields.io/badge/GitHub-Azure_AI_Foundry_Developer_Forum-blue?style=for-the-badge&logo=github&color=000000&logoColor=fff)](https://aka.ms/foundry/forum) مراجعه کنید.

---

<!-- CO-OP TRANSLATOR DISCLAIMER START -->
**سلب مسئولیت**:  
این سند با استفاده از سرویس ترجمه هوش مصنوعی [Co-op Translator](https://github.com/Azure/co-op-translator) ترجمه شده است. در حالی که ما در صحت ترجمه تلاش می‌کنیم، لطفاً توجه داشته باشید که ترجمه‌های خودکار ممکن است دارای خطاها یا نادرستی‌هایی باشند. سند اصلی به زبان بومی خود باید به عنوان منبع معتبر در نظر گرفته شود. برای اطلاعات حیاتی، ترجمه حرفه‌ای انسانی توصیه می‌شود. ما مسئولیتی در قبال هرگونه سوء تفاهم یا تفسیر نادرست ناشی از استفاده از این ترجمه نداریم.
