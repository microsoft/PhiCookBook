...
![AIFoundry Models](../../../../translated_images/fa/AIFoundryModels.0e1b16f7d0b09b73.png)
...
![Finetune AI Foundry](../../../../translated_images/fa/AIFoundryfinetune.193aaddce48d553c.png)
...
1. برای ایجاد پروژه جدید، **+New project** را انتخاب کنید.
    ...
    ![FineTuneSelect](../../../../translated_images/fa/select-new-project.cd31c0404088d7a3.png)
...
1. کارهای زیر را انجام دهید:
    ...
    ![FineTuneSelect](../../../../translated_images/fa/create-project.ca3b71298b90e420.png)
...
1. برای ایجاد یک هاب جدید، کارهای زیر را انجام دهید:
    ...
    ![FineTuneSelect](../../../../translated_images/fa/create-hub.49e53d235e80779e.png)
...
1. در **نوار جستجو** عبارت *phi-3* را تایپ کرده و مدل phi-3 مورد نظر خود را انتخاب کنید.
    ...
    ![FineTuneSelect](../../../../translated_images/fa/select-model.60ef2d4a6a3cec57.png)

1. روی **Fine-tune** کلیک کنید.

    ![FineTuneSelect](../../../../translated_images/fa/select-finetune.a976213b543dd9d8.png)

1. نام **مدل آموزش دیده دقیق** را وارد کنید.

    ![FineTuneSelect](../../../../translated_images/fa/finetune1.c2b39463f0d34148.png)
...
1. کارهای زیر را انجام دهید:
    ...
    ![FineTuneSelect](../../../../translated_images/fa/finetune2.43cb099b1a94442d.png)

1. روی **Next** کلیک کنید.

1. داده‌های **اعتبارسنجی** مورد نظر خود را بارگذاری کنید یا گزینه **Automatic split of training data** را انتخاب کنید.

    ![FineTuneSelect](../../../../translated_images/fa/finetune3.fd96121b67dcdd92.png)
...
1. کارهای زیر را انجام دهید:
    ...
    ![FineTuneSelect](../../../../translated_images/fa/finetune4.e18b80ffccb5834a.png)

1. برای شروع فرآیند آموزش دقیق، روی **Submit** کلیک کنید.

    ![FineTuneSelect](../../../../translated_images/fa/select-submit.0a3802d581bac271.png)
...
1. پس از اتمام آموزش دقیق، وضعیت مدل به صورت **Completed** نمایش داده می‌شود، همانطور که در تصویر زیر می‌بینید. اکنون می‌توانید مدل را مستقر کرده و در برنامه خود، در محیط آزمایشی یا در prompt flow استفاده کنید. برای اطلاعات بیشتر، به [نحوه استقرار خانواده مدل‌های کوچک زبان Phi-3 با Azure AI Foundry](https://learn.microsoft.com/azure/ai-studio/how-to/deploy-models-phi-3?tabs=phi-3-5&pivots=programming-language-python) مراجعه کنید.
    ...
    ![FineTuneSelect](../../../../translated_images/fa/completed.4dc8d2357144cdef.png)
