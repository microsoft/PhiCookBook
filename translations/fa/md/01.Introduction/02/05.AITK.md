...
[AI Toolkit برای VS Code](https://marketplace.visualstudio.com/items?itemName=ms-windows-ai-studio.windows-ai-studio) توسعه برنامه‌های هوش مصنوعی مولد را با گردآوری ابزارها و مدل‌های پیشرفته توسعه هوش مصنوعی از Microsoft Foundry Catalog و سایر کاتالوگ‌ها مانند Hugging Face ساده می‌کند. شما می‌توانید کاتالوگ مدل‌های هوش مصنوعی که توسط GitHub Models و Microsoft Foundry Model Catalogs پشتیبانی می‌شود را مرور کنید، مدل‌ها را به صورت محلی یا از راه دور دانلود کنید، آن‌ها را بهینه‌سازی، آزمایش و در برنامه خود استفاده نمایید.
