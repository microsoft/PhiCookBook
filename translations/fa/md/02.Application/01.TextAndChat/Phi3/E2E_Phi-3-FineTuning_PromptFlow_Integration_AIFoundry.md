...
> 4. پوشه *finetune-phi* که ایجاد کرده‌اید و در مسیر *C:\Users\yourUserName\finetune-phi* قرار دارد را انتخاب کنید.
    ...
    ![پوشه‌ای که ایجاد کرده‌اید را انتخاب کنید.](../../../../../../translated_images/04-01-open-project-folder.f734374bcfd5f9e6f63a0a50961e51a39cc6de7a7ddc86da5f4896e815f28abd.fa.png)
...
5. در پنل سمت چپ Visual Studio Code، راست‌کلیک کرده و گزینه **New File** را انتخاب کنید تا فایلی جدید به نام *download_dataset.py* ایجاد شود.
    ...
    ![یک فایل جدید ایجاد کنید.](../../../../../../translated_images/04-02-create-new-file.cf9a330a3a9cff927ede875300e1b5c91ab90d1e486c77a43bb9494880cf9b6f.fa.png)
...
4. روی **+ New** کلیک کنید.
    ...
    ![انتخاب Compute.](../../../../../../translated_images/06-01-select-compute.a29cff290b480252d04ffd0142c073486df7d3b7256335964a98b87e28072523.fa.png)
...
5. موارد زیر را انجام دهید:
    ...
    ![ایجاد کلاستر.](../../../../../../translated_images/06-02-create-cluster.f221b65ae1221d4e4baa9c5ccf86510f21df87515c231b2a255e1ee545496458.fa.png)
...
7. موارد زیر را انجام دهید:
    ...
    ![ایجاد کلاستر.](../../../../../../translated_images/06-03-create-cluster.4a54ba20914f3662edc0f95ad364a869b4dbb7f7be08ff259528fea96312e77e.fa.png)
...
2. فضای کاری Azure Machine Learning که ایجاد کرده‌اید را انتخاب کنید.
    ...
    ![انتخاب فضای کاری که ایجاد کرده‌اید.](../../../../../../translated_images/06-04-select-workspace.a92934ac04f4f18133117ca7d6a6c6f03a6d9267dae544308b8df243835a21d0.fa.png)
...
3. موارد زیر را انجام دهید:
    ...
    ![تایپ phi-3-mini-4k.](../../../../../../translated_images/06-05-type-phi-3-mini-4k.8ab6d2a04418b25018a7e7353ce6525d8f5803b0af9bc9a60a9be4204dd77578.fa.png)

4. از منوی ناوبری، گزینه **Fine-tune** را انتخاب کنید.

    ![انتخاب fine tune.](../../../../../../translated_images/06-06-select-fine-tune.2918a59be55dfeecb897ac74882792b59086893b8a7448a89be3628aee62fc1b.fa.png)
...
5. موارد زیر را انجام دهید:
    ...
    ![پر کردن صفحه فاین‌تیونینگ.](../../../../../../translated_images/06-07-fill-finetuning.b6d14c89e7c27d0bbc6b248af9e7369ca98379770badec9f73b6bced7a8b7806.fa.png)
...
7. در این تمرین، شما با موفقیت مدل Phi-3 را با استفاده از Azure Machine Learning فاین‌تیون کردید. توجه داشته باشید که فرآیند فاین‌تیونینگ ممکن است زمان قابل توجهی طول بکشد. پس از اجرای کار فاین‌تیونینگ، باید منتظر بمانید تا تکمیل شود. می‌توانید وضعیت کار فاین‌تیونینگ را با مراجعه به تب Jobs در سمت چپ فضای کاری Azure Machine Learning خود مشاهده کنید. در سری بعدی، مدل فاین‌تیون شده را مستقر کرده و آن را با Prompt flow یکپارچه خواهید کرد.
    ...
    ![مشاهده کار فاین‌تیونینگ.](../../../../../../translated_images/06-08-output.2bd32e59930672b1cc1de86056e2fbc91e338f59e2a29d7dac86ede49a9714b2.fa.png)
...
5. گزینه **From a job output** را انتخاب کنید.
    ...
    ![ثبت مدل.](../../../../../../translated_images/07-01-register-model.ad1e7cc05e4b2777c8c39906ce5cd57f16b54fb3887dd4e4de1ce963b26499ad.fa.png)

6. کاری که ایجاد کرده‌اید را انتخاب کنید.

    ![انتخاب کار.](../../../../../../translated_images/07-02-select-job.3e2e1144cd6cd09315953b4eb2cc9d62d0d77ab0d9d877e34c6827fa6d2b6be4.fa.png)
...
9. اطمینان حاصل کنید که **Job output** انتخاب شده است؛ این گزینه باید به صورت خودکار انتخاب شده باشد.
    ...
    ![انتخاب خروجی.](../../../../../../translated_images/07-03-select-output.4cf1a0e645baea1f267b40f73de77f092a5b02808ade72f8eb94e5fe9723feb3.fa.png)

10. روی **Next** کلیک کنید.

11. روی **Register** کلیک کنید.

    ![انتخاب ثبت.](../../../../../../translated_images/07-04-register.fd82a3b293060bc78399e613293032d3d301c02a6fd8092bec52bfaf4f3104de.fa.png)

12. می‌توانید مدل ثبت شده خود را با مراجعه به منوی **Models** در تب سمت چپ مشاهده کنید.

    ![مدل ثبت شده.](../../../../../../translated_images/07-05-registered-model.7db9775f58dfd591b7995686b95396ffd8c185ba66f0a1f6be18f4aea05e93d5.fa.png)
...
3. از منوی ناوبری، گزینه **Real-time endpoints** را انتخاب کنید.
    ...
    ![ایجاد نقطه انتهایی.](../../../../../../translated_images/07-06-create-endpoint.1ba865c606551f09618ce29b467276523838b8cc766d79ebfecdb052fef2c4df.fa.png)

4. روی **Create** کلیک کنید.

5. مدل ثبت شده‌ای که ایجاد کرده‌اید را انتخاب کنید.

    ![انتخاب مدل ثبت شده.](../../../../../../translated_images/07-07-select-registered-model.29c947c37fa30cb4460f7646dfaa59121fb1384ed1957755427d358462c25225.fa.png)
...
7. موارد زیر را انجام دهید:
    ...
    ![پر کردن تنظیمات استقرار.](../../../../../../translated_images/07-08-deployment-setting.43ddc4209e67378494bb8d81418bc3bdaceb8c57151727d538594cb378697f36.fa.png)
...
3. نقطه انتهایی که ایجاد کرده‌اید را انتخاب کنید.
    ...
    ![انتخاب نقاط انتهایی](../../../../../../translated_images/07-09-check-deployment.325d18cae8475ef4a302f0efc8875002e1c382167083c7fefbdb42ede274d0da.fa.png)
...
>
> ![تنظیم ترافیک.](../../../../../../translated_images/07-10-set-traffic.085b847e5751ff3d30c64ecabac4b17a7b5dc004ba52ad387cbaaf7b266eeadf.fa.png)
>
...
1. **REST endpoint** و **Primary key** خود را کپی کنید.
    ...
    ![Copy api key and endpoint uri.](../../../../../../translated_images/08-08-copy-endpoint-key.18f934b5953ae8cbe30a20b889154d04109bf17c5c09816060a8689933dc0fd7.fa.png)
...
1. روی **+ New connection** کلیک کنید.
    ...
    ![Select new connection.](../../../../../../translated_images/08-09-select-new-connection.02eb45deadc401fc77130c3a16fbb8ee59407ecbf74fd3502cb8720c61384446.fa.png)

1. از منوی ناوبری، **Custom keys** را انتخاب کنید.

    ![Select custom keys.](../../../../../../translated_images/08-10-select-custom-keys.856f6b29664605513ccc134f1adaefaf27f951981c511783a6a0d1118c9178a5.fa.png)
...
1. کارهای زیر را انجام دهید:
    ...
    ![Add connection.](../../../../../../translated_images/08-11-add-connection.785486badb4d2d26e8df1bbd0948e06aa20aa0dc102faa96c8144722ef7f0b72.fa.png)
...
1. از منوی ناوبری، **+ Create** را انتخاب کنید.
    ...
    ![Select Promptflow.](../../../../../../translated_images/08-12-select-promptflow.6f4b451cb9821e5ba79bedfd35e2f2fb430f344844994375680fcfc111a994ae.fa.png)

1. از منوی ناوبری، **Chat flow** را انتخاب کنید.

    ![Select chat flow.](../../../../../../translated_images/08-13-select-flow-type.2ec689b22da32591f6cc6360bc35c8fca8d63519c09111c6c431de9b46eed143.fa.png)

1. نام **Folder** مورد نظر را وارد کنید.

    ![Enter name.](../../../../../../translated_images/08-14-enter-name.ff9520fefd89f40d824bad779a54e55d808a09394b6b730fbea55d78421f52ff.fa.png)
...
1. در Prompt flow، برای بازسازی جریان موجود، کارهای زیر را انجام دهید:
    ...
    ![Select raw file mode.](../../../../../../translated_images/08-15-select-raw-file-mode.61d988b41df28985b76e070bf170e1d0d0d26b38d93bc635624642191f715a6d.fa.png)
...
1. کد زیر را به فایل *integrate_with_promptflow.py* اضافه کنید تا از مدل سفارشی Phi-3 در Prompt flow استفاده شود.
    ...
    ![Paste prompt flow code.](../../../../../../translated_images/08-16-paste-promptflow-code.a6041b74a7d097779ab1c429be9fc07e3f4171e41fbbfb747a6e755816411e6d.fa.png)
...
1. گزینه‌های **Chat input** و **Chat output** را انتخاب کنید تا امکان گفتگو با مدل فراهم شود.
    ...
    ![Input Output.](../../../../../../translated_images/08-17-select-input-output.64dbb39bbe59d03ba022a21159e51d544c6e063e73c10e772c942d4e44da0d30.fa.png)
...
>
> ![Flow example.](../../../../../../translated_images/08-18-graph-example.d6457533952e690c10b7375192511a8e2aba847e442b294a2e65d88ffac8f63b.fa.png)
>
...
1. برای شروع Prompt flow، روی **Start compute sessions** کلیک کنید.
    ...
    ![Start compute session.](../../../../../../translated_images/09-01-start-compute-session.a86fcf5be68e386b4809b60d75ce9b0ad53e0729cc1449935ccbe90b954401dc.fa.png)

1. برای به‌روزرسانی پارامترها، روی **Validate and parse input** کلیک کنید.

    ![Validate input.](../../../../../../translated_images/09-02-validate-input.317c76ef766361e97038d7529b9060a23dc59d7ddbeb38ac9c4562ef4f5b32f7.fa.png)

1. مقدار **connection** را به اتصال سفارشی که ساخته‌اید انتخاب کنید. برای مثال، *connection*.

    ![Connection.](../../../../../../translated_images/09-03-select-connection.99bdddb4b184402368a6ec383814b139686118331a5b2eefa489678902269dfc.fa.png)

#### گفتگو با مدل سفارشی

1. روی **Chat** کلیک کنید.

    ![Select chat.](../../../../../../translated_images/09-04-select-chat.61936dce6612a1e636a5e1516b6c64fdf2345ceb3142db2bed93ab7e6f03bbb2.fa.png)
...
1. در اینجا نمونه‌ای از نتایج آمده است: حالا می‌توانید با مدل سفارشی Phi-3 خود گفتگو کنید. توصیه می‌شود سوالات خود را بر اساس داده‌های استفاده شده برای تنظیم مدل مطرح کنید.
    ...
    ![Chat with prompt flow.](../../../../../../translated_images/09-05-chat-with-promptflow.c8ca404c07ab126fa4886e6fd0e7482cfdc6c907fa36f7f2f13d04126f9eda14.fa.png)
