...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-07T13:42:01+00:00",
...
فراخوانی تابع ابتدا در خانواده Phi Family ظاهر شد و اکنون می‌توانید از آن در Phi-4-mini استفاده کنید.

این مثال شبیه‌سازی نتایج لیگ برتر را نشان می‌دهد. هدف این است که Phi-4-mini اطلاعات بازی را به‌صورت لحظه‌ای ارائه دهد. کد نمونه در زیر آمده است:
