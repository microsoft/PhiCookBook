...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-17T05:14:15+00:00",
...
فراخوانی تابع ابتدا در خانواده Phi Family معرفی شد و اکنون می‌توانید از آن در Phi-4-mini استفاده کنید.

این مثال شبیه‌سازی نتایج لیگ برتر را نشان می‌دهد. هدف این است که Phi-4-mini اطلاعات بازی را به صورت زنده ارائه دهد. در ادامه کد نمونه آمده است:
