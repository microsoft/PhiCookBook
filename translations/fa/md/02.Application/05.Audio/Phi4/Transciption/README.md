...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-07T14:26:47+00:00",
...
Phi-4-multimodal یک مدل چندوجهی کامل است که علاوه بر متن و تصاویر، می‌تواند از صوت نیز استفاده کند. بیایید ببینیم چگونه می‌توان از آن استفاده کرد.
