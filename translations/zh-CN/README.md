...
- Phi 应用开发示例
  - 文本与聊天应用
    ...
    - Phi-3 / 3.5 示例
      ...
      - [在 Azure AI Foundry 中评估微调的 Phi-3 / Phi-3.5 模型，重点关注微软责任 AI 原则](./md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-Evaluation_AIFoundry.md)
  ...
  - 高级推理示例
    - Phi-4 示例 🆕
      ...
      - [📓] [基于 Azure AI Foundry 模型的 Phi-4-mini-reasoning](./md/02.Application/02.Code/Phi4r/azure_models_inference.ipynb)
  - 演示
...
您可以学习如何使用 Microsoft Phi 以及如何在不同的硬件设备上构建端到端解决方案。想亲身体验 Phi，您可以先在 [Azure AI Foundry Azure AI 模型目录](https://aka.ms/phi3-azure-ai) 中玩转模型并针对您的场景定制 Phi。您也可以在[入门 Azure AI Foundry](/md/02.QuickStart/AzureAIFoundry_QuickStart.md)了解更多。
...
缓解这些风险的推荐方法是在您的架构中包含安全系统，以检测并防止有害行为。[Azure AI 内容安全](https://learn.microsoft.com/azure/ai-services/content-safety/overview)提供了一层独立的保护，能够检测应用和服务中用户生成的和 AI 生成的有害内容。Azure AI 内容安全包括文本和图像 API，允许您检测有害内容。在 Azure AI Foundry 中，内容安全服务允许您查看、探索并尝试用于检测不同模态中有害内容的示例代码。以下[快速入门文档](https://learn.microsoft.com/azure/ai-services/content-safety/quickstart-text?tabs=visual-studio%2Clinux&pivots=programming-language-rest)指导您如何向该服务发起请求。
