...
Phi 目前是最强大且具有成本效益的小型语言模型（SLM），在多语言、推理、文本/聊天生成、编码、图像、音频和其他场景中具有非常好的基准性能。

您可以将 Phi 部署到云端或边缘设备，并且可以轻松构建在有限计算能力下的生成式 AI 应用。
...
[阿拉伯语](../ar/README.md) | [孟加拉语](../bn/README.md) | [保加利亚语](../bg/README.md) | [缅甸语 (Myanmar)](../my/README.md) | [中文（简体）](./README.md) | [中文（繁体，香港）](../zh-HK/README.md) | [中文（繁体，澳门）](../zh-MO/README.md) | [中文（繁体，台湾）](../zh-TW/README.md) | [克罗地亚语](../hr/README.md) | [捷克语](../cs/README.md) | [丹麦语](../da/README.md) | [荷兰语](../nl/README.md) | [爱沙尼亚语](../et/README.md) | [芬兰语](../fi/README.md) | [法语](../fr/README.md) | [德语](../de/README.md) | [希腊语](../el/README.md) | [希伯来语](../he/README.md) | [印地语](../hi/README.md) | [匈牙利语](../hu/README.md) | [印度尼西亚语](../id/README.md) | [意大利语](../it/README.md) | [日语](../ja/README.md) | [坎纳达语](../kn/README.md) | [韩语](../ko/README.md) | [立陶宛语](../lt/README.md) | [马来语](../ms/README.md) | [马拉雅拉姆语](../ml/README.md) | [马拉地语](../mr/README.md) | [尼泊尔语](../ne/README.md) | [尼日利亚皮钦语](../pcm/README.md) | [挪威语](../no/README.md) | [波斯语 (法尔西)](../fa/README.md) | [波兰语](../pl/README.md) | [葡萄牙语 (巴西)](../pt-BR/README.md) | [葡萄牙语 (葡萄牙)](../pt-PT/README.md) | [旁遮普语 (古鲁穆奇)](../pa/README.md) | [罗马尼亚语](../ro/README.md) | [俄语](../ru/README.md) | [塞尔维亚语 (西里尔)](../sr/README.md) | [斯洛伐克语](../sk/README.md) | [斯洛文尼亚语](../sl/README.md) | [西班牙语](../es/README.md) | [斯瓦希里语](../sw/README.md) | [瑞典语](../sv/README.md) | [他加禄语 (菲律宾)](../tl/README.md) | [泰米尔语](../ta/README.md) | [泰卢固语](../te/README.md) | [泰语](../th/README.md) | [土耳其语](../tr/README.md) | [乌克兰语](../uk/README.md) | [乌尔都语](../ur/README.md) | [越南语](../vi/README.md)

> **想要本地克隆？**

> 本仓库包含 50 多种语言的翻译内容，显著增加了下载大小。若想克隆时不包含翻译内容，请使用稀疏检出：
> ```bash
> git clone --filter=blob:none --sparse https://github.com/microsoft/PhiCookBook.git
> cd PhiCookBook
> git sparse-checkout set --no-cone '/*' '!translations' '!translated_images'
> ```
> 这使您能以更快的速度完成课程所需的全部内容。
...
- Phi 家族推理
    ...
    - [安卓上推理 Phi](./md/01.Introduction/03/Android_Inference.md)
    ...
    - [使用 AI 工具包远程服务器推理 Phi](./md/01.Introduction/03/Remote_Interence.md)
    - [用 Rust 推理 Phi](./md/01.Introduction/03/Rust_Inference.md)
...
- 评估 Phi
    - [响应式 AI](./md/01.Introduction/05/ResponsibleAI.md)
    - [Azure AI Foundry 评估](./md/01.Introduction/05/AIFoundry.md)
    - [使用 Promptflow 进行评估](./md/01.Introduction/05/Promptflow.md)
 
- 结合 Azure AI 搜索的 RAG
    - [如何使用 Phi-4-mini 和 Phi-4-multimodal(RAG) 搭配 Azure AI 搜索](https://github.com/microsoft/PhiCookBook/blob/main/code/06.E2E/E2E_Phi-4-RAG-Azure-AI-Search.ipynb)

- Phi 应用开发示例
  - 文本及聊天应用
    - Phi-4 示例 🆕
      - [📓] [用 Phi-4-mini ONNX 模型聊天](./md/02.Application/01.TextAndChat/Phi4/ChatWithPhi4ONNX/README.md)
      - [使用本地 Phi-4 ONNX 模型的聊天 .NET 应用](../../md/04.HOL/dotnet/src/LabsPhi4-Chat-01OnnxRuntime)
    ...
    - Phi-3 / 3.5 示例
      ...
      - [多模型 - 互动 Phi-3-mini 和 OpenAI Whisper](./md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-mini_with_whisper.md)
      - [MLFlow - 构建包装并使用 Phi-3 与 MLFlow](./md//02.Application/01.TextAndChat/Phi3/E2E_Phi-3-MLflow.md)
      ...
      - [使用 Azure AI Foundry 中的 Prompt flow 微调并集成自定义 Phi-3 模型](./md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-FineTuning_PromptFlow_Integration_AIFoundry.md)
      ...
      - [使用本地 ONNX Phi-3 模型，基于 Microsoft.ML.OnnxRuntime 的问答 .NET 示例](../../md/04.HOL/dotnet/src/LabsPhi301)
      - [使用 Semantic Kernel 与 Phi-3 的控制台聊天 .NET 应用](../../md/04.HOL/dotnet/src/LabsPhi302)
  ...
  - Azure AI 推理 SDK 代码示例 
    ...
    - Phi-3 / 3.5 示例
      ...
      - [使用 GitHub 模型和 Phi-3.5 创建 Visual Studio Code 聊天 Copilot 代理](/md/02.Application/02.Code/Phi3/CreateVSCodeChatAgentWithGitHubModels.md)
  ...
  - 视觉示例
    ...
    - Phi-3 / 3.5 示例
      ...
      - [使用 Microsoft.ML.OnnxRuntime .NET 的本地 Phi-3 视觉 ONNX 模型](../../md/04.HOL/dotnet/src/LabsPhi303)
      - [基于菜单的 Phi-3 视觉本地 ONNX 模型，使用 Microsoft.ML.OnnxRuntime .NET](../../md/04.HOL/dotnet/src/LabsPhi304)

  - 数学示例
    -  Phi-4-Mini-Flash-推理-指令示例 🆕 [Phi-4-Mini-Flash-推理-指令数学演示](./md/02.Application/09.Math/MathDemo.ipynb)
  ...
  - 函数调用示例
    - Phi-4 示例 🆕
      ...
      -  [📓] [用函数调用创建多代理，基于 Phi-4-mini](./md/02.Application/07.FunctionCalling/Phi4/Multiagents/Phi_4_mini_multiagent.ipynb)
...
- Phi 微调示例
  ...
  - [Microsoft Olive 动手实验室微调](./md/03.FineTuning/olive-lab/readme.md)
  - [使用 Weights and Bias 微调 Phi-3-vision](./md/03.FineTuning/FineTuning_Phi-3-visionWandB.md)
  - [使用 Apple MLX Framework 微调 Phi-3](./md/03.FineTuning/FineTuning_MLX.md)
...
- 学术研究论文和出版物
  - [教科书是你所需要的一切 II：phi-1.5 技术报告](https://arxiv.org/abs/2309.05463)
  - [Phi-3 技术报告：在您的手机本地运行的高性能语言模型](https://arxiv.org/abs/2404.14219)
  ...
  - [(WhyPHI) 微调 PHI-3 进行多项选择题回答：方法论、结果与挑战](https://arxiv.org/abs/2501.01588)
...
您可以学习如何使用 Microsoft Phi 以及如何在不同硬件设备上构建端到端解决方案。要亲自体验 Phi，首先通过 [Azure AI Foundry Azure AI 模型目录](https://aka.ms/phi3-azure-ai) 玩转模型并根据您的场景定制 Phi，您可以在 [Azure AI Foundry 入门](/md/02.QuickStart/AzureAIFoundry_QuickStart.md) 了解更多信息。

**试玩场**
每个模型都有专用的试玩场来测试模型 [Azure AI Playground](https://aka.ms/try-phi3)。

### GitHub 模型上的 Phi

您可以学习如何使用 Microsoft Phi 以及如何在不同硬件设备上构建端到端解决方案。要亲自体验 Phi，首先通过 [GitHub 模型目录](https://github.com/marketplace/models?WT.mc_id=aiml-137032-kinfeylo) 玩转模型并根据您的场景定制 Phi，您可以在 [GitHub 模型目录入门](/md/02.QuickStart/GitHubModel_QuickStart.md) 了解更多信息。

**试玩场**
每个模型都有专用的[试玩场来测试模型](/md/02.QuickStart/GitHubModel_QuickStart.md)。
...
微软致力于帮助客户负责任地使用我们的 AI 产品，分享我们的经验教训，并通过如透明度说明和影响评估等工具建立基于信任的合作伙伴关系。许多资源可在 [https://aka.ms/RAI](https://aka.ms/RAI) 找到。
微软的负责任 AI 方法基于我们的 AI 原则：公平性、可靠性与安全性、隐私与安全、包容性、透明度与问责制。

大型的自然语言、图像和语音模型——如本示例中使用的模型——可能存在不公平、不可靠或冒犯性的行为，进而造成伤害。请参阅[Azure OpenAI 服务透明度说明](https://learn.microsoft.com/legal/cognitive-services/openai/transparency-note?tabs=text)了解相关风险和限制。

减轻这些风险的推荐方法是在您的架构中包含一个安全系统，能够检测和防止有害行为。[Azure AI 内容安全](https://learn.microsoft.com/azure/ai-services/content-safety/overview)提供了一个独立的保护层，能够检测应用和服务中的用户生成和 AI 生成的有害内容。Azure AI 内容安全包括文本和图像 API，使您能够检测有害材料。在 Azure AI Foundry 中，内容安全服务允许您查看、探索并尝试用于检测不同模态有害内容的示例代码。以下[快速入门文档](https://learn.microsoft.com/azure/ai-services/content-safety/quickstart-text?tabs=visual-studio%2Clinux&pivots=programming-language-rest)指导您如何向该服务发出请求。

另一个需要考虑的方面是整体应用性能。对于多模态和多模型应用，我们认为性能意味着系统按您和用户预期的方式运行，包括不生成有害输出。评估整体应用性能时，建议使用[性能与质量以及风险与安全评估器](https://learn.microsoft.com/azure/ai-studio/concepts/evaluation-metrics-built-in)。您还可以使用[自定义评估器](https://learn.microsoft.com/azure/ai-studio/how-to/develop/evaluate-sdk#custom-evaluators)创建和评估。
您可以使用[Azure AI 评估 SDK](https://microsoft.github.io/promptflow/index.html)在开发环境中评估您的 AI 应用程序。给定测试数据集或目标，您的生成式 AI 应用的生成结果将通过内置评估器或您选择的自定义评估器进行定量测量。要开始使用 azure ai 评估 sdk 评估您的系统，您可以按照[快速入门指南](https://learn.microsoft.com/azure/ai-studio/how-to/develop/flow-evaluate-sdk)操作。执行评估运行后，您可以在[Azure AI Foundry 中可视化结果](https://learn.microsoft.com/azure/ai-studio/how-to/evaluate-flow-results)。
...
在本项目的修改版本中使用微软商标或徽标不得引起混淆或暗示微软赞助。任何第三方商标或徽标的使用均受该第三方政策的约束。
...
**免责声明**：  
本文档采用 AI 翻译服务 [Co-op Translator](https://github.com/Azure/co-op-translator) 翻译。虽然我们努力确保准确性，但请注意自动翻译可能包含错误或不准确之处。应以原始语言的原始文档为权威来源。对于重要信息，建议采用专业人工翻译。因使用本翻译引起的任何误解或曲解，我们概不负责。
