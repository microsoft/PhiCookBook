...
[Microsoft Foundry](https://ai.azure.com?WT.mc_id=aiml-138114-kinfeylo) 是一个强大的平台，帮助开发者和组织快速创建智能、先进、面向市场且负责任的应用。以下是 Microsoft Foundry 的一些关键功能和能力：

**开箱即用的 API 和模型**

Microsoft Foundry 提供预构建且可定制的 API 和模型，涵盖生成式 AI、对话式自然语言处理、搜索、监控、翻译、语音、视觉和决策等多种 AI 任务。

**Prompt Flow**

Microsoft Foundry 中的 Prompt Flow 使您能够创建对话式 AI 体验，设计和管理对话流程，便于构建聊天机器人、虚拟助手及其他交互式应用。
...
Microsoft Foundry 提供评估和监控生成式 AI 模型的工具，帮助评估其性能、公平性等关键指标，确保负责任的部署。此外，如果您创建了仪表板，可以使用 Azure Machine Learning Studio 中的无代码 UI，基于 [Repsonsible AI Toolbox](https://responsibleaitoolbox.ai/?WT.mc_id=aiml-138114-kinfeylo) Python 库自定义并生成 Responsible AI 仪表板及相关评分卡。该评分卡有助于向技术和非技术利益相关者分享公平性、特征重要性及其他负责任部署的关键信息。
...
总之，Microsoft Responsible AI 是一项旨在帮助开发者和组织构建透明、可信且负责任 AI 系统的倡议。负责任的 AI 实施至关重要，而 Microsoft Foundry 致力于让组织能够切实实现这一目标。通过遵循伦理原则和最佳实践，我们可以确保 AI 系统以负责任的方式开发和部署，造福整个社会。
