...
[![Ανοικτά ζητήματα στο GitHub](https://img.shields.io/github/issues/microsoft/phicookbook.svg)](https://GitHub.com/microsoft/phicookbook/issues/?WT.mc_id=aiml-137032-kinfeylo)
[![Αιτήματα συγχώνευσης στο GitHub](https://img.shields.io/github/issues-pr/microsoft/phicookbook.svg)](https://GitHub.com/microsoft/phicookbook/pulls/?WT.mc_id=aiml-137032-kinfeylo)
[![Καλωσορίζουμε PRs](https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat-square)](http://makeapullrequest.com?WT.mc_id=aiml-137032-kinfeylo)
...
[![Αντίγραφα (forks) στο GitHub](https://img.shields.io/github/forks/microsoft/phicookbook.svg?style=social&label=Fork)](https://GitHub.com/microsoft/phicookbook/network/?WT.mc_id=aiml-137032-kinfeylo)
...
Το Phi είναι μια σειρά μοντέλων τεχνητής νοημοσύνης ανοιχτού κώδικα που αναπτύχθηκαν από τη Microsoft.

Το Phi είναι αυτή τη στιγμή το πιο ισχυρό και οικονομικά αποδοτικό μικρό μοντέλο γλώσσας (SLM), με πολύ καλά benchmarks σε πολλαπλές γλώσσες, συλλογισμό, δημιουργία κειμένου/συνομιλίας, κωδικοποίηση, εικόνες, ήχο και άλλα σενάρια.

Μπορείτε να αναπτύξετε το Phi στο νέφος ή σε συσκευές άκρου, και μπορείτε εύκολα να δημιουργήσετε εφαρμογές γενετικής τεχνητής νοημοσύνης με περιορισμένη υπολογιστική ισχύ.

Ακολουθήστε αυτά τα βήματα για να ξεκινήσετε να χρησιμοποιείτε αυτούς τους πόρους:
1. **Αντιγράψτε το Αποθετήριο** (Fork): Κάντε κλικ [![Αντίγραφα στο GitHub](https://img.shields.io/github/forks/microsoft/phicookbook.svg?style=social&label=Fork)](https://GitHub.com/microsoft/phicookbook/network/?WT.mc_id=aiml-137032-kinfeylo)
2. **Κλωνοποιήστε το Αποθετήριο**: `git clone https://github.com/microsoft/PhiCookBook.git`
3. [**Εγγραφείτε στην Κοινότητα Microsoft AI Discord και συναντήστε ειδικούς και άλλους προγραμματιστές**](https://discord.com/invite/ByRwuEEgH4?WT.mc_id=aiml-137032-kinfeylo)
...
- Εισαγωγή
  ...
  - [Ρύθμιση περιβάλλοντος](./md/01.Introduction/01/01.EnvironmentSetup.md)
...
- Οικογένεια Φι Εκτέλεσης
    ...
    - [Εκτέλεση Phi σε Απομακρυσμένο Διακομιστή με χρήση AI Toolkit](./md/01.Introduction/03/Remote_Interence.md)
    - [Εκτέλεση Phi με Rust](./md/01.Introduction/03/Rust_Inference.md)
    - [Εκτέλεση Phi -- Όραση τοπικά](./md/01.Introduction/03/Vision_Inference.md)
    - [Εκτέλεση Phi με Kaito AKS, Azure Containers (επίσημη υποστήριξη)](./md/01.Introduction/03/Kaito_Inference.md)
-  [Ποσοτικοποίηση Οικογένειας Phi](./md/01.Introduction/04/QuantifyingPhi.md)
    - [Ποσοτικοποίηση Phi-3.5 / 4 με χρήση llama.cpp](./md/01.Introduction/04/UsingLlamacppQuantifyingPhi.md)
    - [Ποσοτικοποίηση Phi-3.5 / 4 με χρήση επεκτάσεων Γενετικής AI για onnxruntime](./md/01.Introduction/04/UsingORTGenAIQuantifyingPhi.md)
...
- Παραδείγματα ανάπτυξης εφαρμογών Phi
  - Εφαρμογές Κειμένου & Συνομιλίας
    - Παραδείγματα Phi-4 🆕
      ...
      - [Εφαρμογή συνομιλίας .NET κονσόλας με Phi-4 ONNX χρησιμοποιώντας Semantic Kernel](../../md/04.HOL/dotnet/src/LabsPhi4-Chat-02SK)
    - Παραδείγματα Phi-3 / 3.5
      ...
      - [Πολυμοντέλο - Interactive Phi-3-mini και OpenAI Whisper](./md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-mini_with_whisper.md)
      ...
      - [WinUI3 App με Phi-3 mini-4k-instruct-onnx](https://github.com/microsoft/Phi3-Chat-WinUI3-Sample/)
      -[WinUI3 Πολυμοντέλο AI Powered Notes App Δείγμα](https://github.com/microsoft/ai-powered-notes-winui3-sample)
      - [Βελτίωση και Ενσωμάτωση προσαρμοσμένων μοντέλων Phi-3 με Prompt flow](./md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-FineTuning_PromptFlow_Integration.md)
      - [Βελτίωση και Ενσωμάτωση προσαρμοσμένων μοντέλων Phi-3 με Prompt flow στο Azure AI Foundry](./md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-FineTuning_PromptFlow_Integration_AIFoundry.md)
      - [Αξιολόγηση του βελτιωμένου μοντέλου Phi-3 / Phi-3.5 στο Azure AI Foundry με έμφαση στις Αρχές Υπεύθυνης Τεχνητής Νοημοσύνης της Microsoft](./md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-Evaluation_AIFoundry.md)
      ...
      - [Χρήση Microsoft Phi-3.5 tflite για δημιουργία Android app](./md/02.Application/01.TextAndChat/Phi3/UsingPhi35TFLiteCreateAndroidApp.md)
      - [Παράδειγμα Q&A .NET που χρησιμοποιεί τοπικό μοντέλο ONNX Phi-3 με την Microsoft.ML.OnnxRuntime](../../md/04.HOL/dotnet/src/LabsPhi301)
      - [Εφαρμογή συνομιλίας .NET κονσόλας με Semantic Kernel και Phi-3](../../md/04.HOL/dotnet/src/LabsPhi302)

  - Δείγματα κώδικα Azure AI Inference SDK 
    - Δείγματα Phi-4 🆕
    ...
    - Δείγματα Phi-3 / 3.5
      ...
      - [Δημιουργήστε το δικό σας Visual Studio Code Chat Copilot Agent με Phi-3.5 από μοντέλα GitHub](/md/02.Application/02.Code/Phi3/CreateVSCodeChatAgentWithGitHubModels.md)

  - Δείγματα Προχωρημένης Σκέψης
    - Δείγματα Phi-4 🆕
  ...
  - Demo
      ...
      - [Παρουσιάσεις Phi-4-multimodal φιλοξενούμενες στο Hugginge Face Spaces](https://huggingface.co/spaces/microsoft/phi-4-multimodal?WT.mc_id=aiml-137032-kinfeylo)
  - Δείγματα Όρασης
    - Δείγματα Phi-4 🆕
    ...
    - Δείγματα Phi-3 / 3.5
      ...
      - [📓][Phi-3-vision Ενσωμάτωση CLIP](./md/02.Application/04.Vision/Phi3/E2E_Phi-3-vision-image-text-to-text-online-endpoint.ipynb)
      ...
      - [📓][Phi-3.5 Όραση πολυ-πλαισίου ή πολυ-εικόνας δείγμα](./md/02.Application/04.Vision/Phi3/phi3-vision-demo.ipynb)
      - [Phi-3 Όραση Τοπικό Μοντέλο ONNX με Microsoft.ML.OnnxRuntime .NET](../../md/04.HOL/dotnet/src/LabsPhi303)
      - [Μενού βασισμένο σε Phi-3 Όραση Τοπικό Μοντέλο ONNX με Microsoft.ML.OnnxRuntime .NET](../../md/04.HOL/dotnet/src/LabsPhi304)

  - Δείγματα Μαθηματικών
    -  Δείγματα Phi-4-Mini-Flash-Reasoning-Instruct 🆕 [Demo Μαθηματικών με Phi-4-Mini-Flash-Reasoning-Instruct](./md/02.Application/09.Math/MathDemo.ipynb)

  - Δείγματα Ήχου
    - Δείγματα Phi-4 🆕
      - [📓] [Ανάκτηση απομαγνητοφωνήσεων ήχου με χρήση Phi-4-multimodal](./md/02.Application/05.Audio/Phi4/Transciption/README.md)
      - [📓] [Delta δείγμα ήχου Phi-4-multimodal](./md/02.Application/05.Audio/Phi4/Siri/demo.ipynb)
      - [📓] [Δείγμα μετάφρασης φωνής με Phi-4-multimodal](./md/02.Application/05.Audio/Phi4/Translate/demo.ipynb)
      - [Εφαρμογή .NET κονσόλας που χρησιμοποιεί Phi-4-multimodal Audio για ανάλυση αρχείου ήχου και δημιουργία απομαγνητοφώνησης](../../md/04.HOL/dotnet/src/LabsPhi4-MultiModal-02Audio)

  - Δείγματα MOE
    - Δείγματα Phi-3 / 3.5
      - [📓] [Μοντέλα Μείγματος Εμπειρογνωμόνων Phi-3.5 (MoEs) Δείγμα Κοινωνικών Μέσων](./md/02.Application/06.MoE/Phi3/phi3_moe_demo.ipynb)
      - [📓] [Δημιουργία Pipeline Αναδρομικής Ενίσχυσης (RAG) με NVIDIA NIM Phi-3 MOE, Azure AI Search και LlamaIndex](./md/02.Application/06.MoE/Phi3/azure-ai-search-nvidia-rag.ipynb)
      - 
  - Δείγματα Κλήσης Συνάρτησης
    - Δείγματα Phi-4 🆕
      -  [📓] [Χρήση Κλήσης Συνάρτησης με Phi-4-mini](./md/02.Application/07.FunctionCalling/Phi4/FunctionCallingBasic/README.md)
      -  [📓] [Χρήση Κλήσης Συνάρτησης για δημιουργία πολλαπλών πρακτόρων με Phi-4-mini](./md/02.Application/07.FunctionCalling/Phi4/Multiagents/Phi_4_mini_multiagent.ipynb)
      -  [📓] [Χρήση Κλήσης Συνάρτησης με Ollama](./md/02.Application/07.FunctionCalling/Phi4/Ollama/ollama_functioncalling.ipynb)
      -  [📓] [Χρήση Κλήσης Συνάρτησης με ONNX](./md/02.Application/07.FunctionCalling/Phi4/ONNX/onnx_parallel_functioncalling.ipynb)
  - Δείγματα πολυτροπικού μίγματος
    - Δείγματα Phi-4 🆕
      ...
      - [Εφαρμογή .NET κονσόλας που χρησιμοποιεί Phi-4-multimodal για ανάλυση εικόνων](../../md/04.HOL/dotnet/src/LabsPhi4-MultiModal-01Images)

- Παραμετροποίηση μοντέλων Phi
  - [Σενάρια παραμετροποίησης](./md/03.FineTuning/FineTuning_Scenarios.md)
  - [Παραμετροποίηση vs RAG](./md/03.FineTuning/FineTuning_vs_RAG.md)
  - [Παραμετροποίηση: Αφήστε το Phi-3 να γίνει ειδικός στη βιομηχανία](./md/03.FineTuning/LetPhi3gotoIndustriy.md)
  - [Παραμετροποίηση Phi-3 με AI Toolkit για VS Code](./md/03.FineTuning/Finetuning_VSCodeaitoolkit.md)
  - [Παραμετροποίηση Phi-3 με Azure Machine Learning Service](./md/03.FineTuning/Introduce_AzureML.md)
  - [Παραμετροποίηση Phi-3 με Lora](./md/03.FineTuning/FineTuning_Lora.md)
  - [Παραμετροποίηση Phi-3 με QLora](./md/03.FineTuning/FineTuning_Qlora.md)
  - [Παραμετροποίηση Phi-3 με Azure AI Foundry](./md/03.FineTuning/FineTuning_AIFoundry.md)
  - [Παραμετροποίηση Phi-3 με Azure ML CLI/SDK](./md/03.FineTuning/FineTuning_MLSDK.md)
  - [Παραμετροποίηση με Microsoft Olive](./md/03.FineTuning/FineTuning_MicrosoftOlive.md)
  - [Εργαστήριο παραμετροποίησης με Microsoft Olive](./md/03.FineTuning/olive-lab/readme.md)
  - [Παραμετροποίηση Phi-3-vision με Weights and Bias](./md/03.FineTuning/FineTuning_Phi-3-visionWandB.md)
  - [Παραμετροποίηση Phi-3 με Apple MLX Framework](./md/03.FineTuning/FineTuning_MLX.md)
  - [Παραμετροποίηση Phi-3-vision (επίσημη υποστήριξη)](./md/03.FineTuning/FineTuning_Vision.md)
  - [Παραμετροποίηση Phi-3 με Kaito AKS, Azure Containers (επίσημη υποστήριξη)](./md/03.FineTuning/FineTuning_Kaito.md)
  - [Παραμετροποίηση Phi-3 και 3.5 Όραση](https://github.com/2U1/Phi3-Vision-Finetune)

- Πρακτικό Εργαστήριο
  - [Εξερευνώντας μοντέλα αιχμής: LLMs, SLMs, τοπική ανάπτυξη και περισσότερα](https://github.com/microsoft/aitour-exploring-cutting-edge-models)
  - [Ξεκλειδώνοντας το δυναμικό NLP: Παραμετροποίηση με Microsoft Olive](https://github.com/azure/Ignite_FineTuning_workshop)
...
- Ακαδημαϊκές Ερευνητικές Εργασίες και Δημοσιεύσεις
  ...
  - [Τεχνική Αναφορά Phi-3: Ένα Υψηλής Ικανότητας Μοντέλο Γλώσσας Τοπικά στο Τηλέφωνό σας](https://arxiv.org/abs/2404.14219)
  - [Τεχνική Αναφορά Phi-4](https://arxiv.org/abs/2412.08905)
  - [Τεχνική Αναφορά Phi-4-Mini: Συμπαγή αλλά Ισχυρά Πολυτροπικά Μοντέλα Γλώσσας μέσω Μείγματος LoRA](https://arxiv.org/abs/2503.01743)
  - [Βελτιστοποίηση Μικρών Μοντέλων Γλώσσας για Κλήση Λειτουργιών Εντός Οχήματος](https://arxiv.org/abs/2501.02342)
  - [(WhyPHI) Εκπαίδευση Μετά το Φινίρισμα του PHI-3 για Απαντήσεις σε Ερωτήσεις Πολλαπλής Επιλογής: Μεθοδολογία, Αποτελέσματα και Προκλήσεις](https://arxiv.org/abs/2501.01588)
  - [Τεχνική Αναφορά Λογικής Phi-4](https://www.microsoft.com/en-us/research/wp-content/uploads/2025/04/phi_4_reasoning.pdf)
  - [Τεχνική Αναφορά Λογικής Phi-4-mini](https://huggingface.co/microsoft/Phi-4-mini-reasoning/blob/main/Phi-4-Mini-Reasoning.pdf)

## Χρήση των Μοντέλων Phi

### Phi στο Azure AI Foundry

Μπορείτε να μάθετε πώς να χρησιμοποιείτε το Microsoft Phi και πώς να δημιουργείτε ολοκληρωμένες λύσεις σε διάφορες συσκευές υλικού σας. Για να δοκιμάσετε το Phi μόνοι σας, ξεκινήστε παίζοντας με τα μοντέλα και προσαρμόζοντας το Phi για τα σενάριά σας χρησιμοποιώντας τον [Κατάλογο Μοντέλων Azure AI Foundry Azure AI](https://aka.ms/phi3-azure-ai). Μπορείτε να μάθετε περισσότερα στο Ξεκινώντας με το [Azure AI Foundry](/md/02.QuickStart/AzureAIFoundry_QuickStart.md)

**Παιδική Χαρά**
Κάθε μοντέλο έχει μια αφοσιωμένη παιδική χαρά για να δοκιμάσετε το μοντέλο [Azure AI Playground](https://aka.ms/try-phi3).

### Phi στα Μοντέλα GitHub

Μπορείτε να μάθετε πώς να χρησιμοποιείτε το Microsoft Phi και πώς να δημιουργείτε ολοκληρωμένες λύσεις σε διάφορες συσκευές υλικού σας. Για να το δοκιμάσετε μόνοι σας, ξεκινήστε παίζοντας με το μοντέλο και προσαρμόζοντας το Phi για τα δικά σας σενάρια μέσω του [Καταλόγου Μοντέλων GitHub](https://github.com/marketplace/models?WT.mc_id=aiml-137032-kinfeylo). Μπορείτε να μάθετε περισσότερα στο Ξεκινώντας με τον [Κατάλογο Μοντέλων GitHub](/md/02.QuickStart/GitHubModel_QuickStart.md)

**Παιδική Χαρά**
Κάθε μοντέλο έχει μια αφοσιωμένη [παιδική χαρά για να δοκιμάσετε το μοντέλο](/md/02.QuickStart/GitHubModel_QuickStart.md).
...
### Σειρά Copilot
[![Copilot για AI Προγραμματισμό με Βοήθεια](https://img.shields.io/badge/Copilot%20for%20AI%20Paired%20Programming-FACC15?style=for-the-badge&labelColor=E5E7EB&color=FACC15)](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)
...
Η Microsoft δεσμεύεται να βοηθά τους πελάτες της να χρησιμοποιούν τα προϊόντα τεχνητής νοημοσύνης με υπευθυνότητα, να μοιράζεται τα διδάγματα της και να χτίζει σχέσεις εμπιστοσύνης μέσω εργαλείων όπως οι Σημειώσεις Διαφάνειας και οι Αξιολογήσεις Επιπτώσεων. Πολλοί από αυτούς τους πόρους είναι διαθέσιμοι στο [https://aka.ms/RAI](https://aka.ms/RAI).
Η προσέγγιση της Microsoft στην υπεύθυνη τεχνητή νοημοσύνη βασίζεται στις αρχές τεχνητής νοημοσύνης όπως τη δικαιοσύνη, την αξιοπιστία και ασφάλεια, το απόρρητο και την ασφάλεια, την ενσωμάτωση, τη διαφάνεια και την λογοδοσία.

Μεγάλα μοντέλα φυσικής γλώσσας, εικόνας και ομιλίας - όπως αυτά που χρησιμοποιούνται σε αυτό το δείγμα - μπορεί ενδεχομένως να συμπεριφέρονται με τρόπους που είναι άδικοι, αναξιόπιστοι ή προσβλητικοί, προκαλώντας έτσι βλάβες. Παρακαλούμε ανατρέξτε στη [Σημείωση Διαφάνειας υπηρεσίας Azure OpenAI](https://learn.microsoft.com/legal/cognitive-services/openai/transparency-note?tabs=text) για να ενημερωθείτε σχετικά με κινδύνους και περιορισμούς.

Η συνιστώμενη προσέγγιση για τη μείωση αυτών των κινδύνων είναι η ενσωμάτωση συστήματος ασφαλείας στην αρχιτεκτονική σας που μπορεί να ανιχνεύει και να αποτρέπει επιβλαβείς συμπεριφορές. Το [Azure AI Content Safety](https://learn.microsoft.com/azure/ai-services/content-safety/overview) παρέχει ένα ανεξάρτητο επίπεδο προστασίας, ικανό να ανιχνεύει επιβλαβές περιεχόμενο που δημιουργείται από χρήστες και AI σε εφαρμογές και υπηρεσίες. Το Azure AI Content Safety περιλαμβάνει APIs κειμένου και εικόνας που σας επιτρέπουν να ανιχνεύετε επιβλαβές υλικό. Μέσα στο Azure AI Foundry, η υπηρεσία Content Safety σας επιτρέπει να προβάλετε, να εξερευνήσετε και να δοκιμάσετε δείγματα κώδικα για ανίχνευση επιβλαβούς περιεχομένου σε διαφορετικές μορφές. Η παρακάτω [τεκμηρίωση γρήγορης εκκίνησης](https://learn.microsoft.com/azure/ai-services/content-safety/quickstart-text?tabs=visual-studio%2Clinux&pivots=programming-language-rest) σας καθοδηγεί στη χρήση του συστήματος μέσω αιτημάτων.
Ένας ακόμα παράγοντας που πρέπει να ληφθεί υπόψη είναι η συνολική απόδοση της εφαρμογής. Με εφαρμογές πολλαπλών τρόπων και πολλαπλών μοντέλων, θεωρούμε απόδοση ότι το σύστημα λειτουργεί όπως εσείς και οι χρήστες σας αναμένετε, συμπεριλαμβανομένου του να μην παράγει επιβλαβή αποτελέσματα. Είναι σημαντικό να αξιολογήσετε την απόδοση της συνολικής εφαρμογής σας χρησιμοποιώντας τους [αξιολογητές Απόδοσης και Ποιότητας και Κινδύνου και Ασφαλείας](https://learn.microsoft.com/azure/ai-studio/concepts/evaluation-metrics-built-in). Έχετε επίσης τη δυνατότητα να δημιουργήσετε και να αξιολογήσετε με [προσαρμοσμένους αξιολογητές](https://learn.microsoft.com/azure/ai-studio/how-to/develop/evaluate-sdk#custom-evaluators).

Μπορείτε να αξιολογήσετε την εφαρμογή AI στον περιβάλλον ανάπτυξής σας χρησιμοποιώντας το [Azure AI Evaluation SDK](https://microsoft.github.io/promptflow/index.html). Δοθείσης είτε μιας δοκιμαστικής βάσης δεδομένων είτε ενός στόχου, οι γεννήσεις της εφαρμογής γενετικής AI μετριούνται ποσοτικά με ενσωματωμένους ή προσαρμοσμένους αξιολογητές της επιλογής σας. Για να ξεκινήσετε με το azure ai evaluation sdk για να αξιολογήσετε το σύστημά σας, μπορείτε να ακολουθήσετε τον [οδηγό γρήγορης εκκίνησης](https://learn.microsoft.com/azure/ai-studio/how-to/develop/flow-evaluate-sdk). Αφού εκτελέσετε μια αξιολόγηση, μπορείτε να [οπτικοποιήσετε τα αποτελέσματα στο Azure AI Foundry](https://learn.microsoft.com/azure/ai-studio/how-to/evaluate-flow-results).

## Εμπορικά Σήματα

Αυτό το έργο μπορεί να περιέχει εμπορικά σήματα ή λογότυπα για έργα, προϊόντα ή υπηρεσίες. Η εξουσιοδοτημένη χρήση των εμπορικών σημάτων ή λογότυπων της Microsoft υπόκειται και πρέπει να ακολουθεί τις [Οδηγίες Εμπορικών Σημάτων & Εταιρικής Ταυτότητας της Microsoft](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).  
Η χρήση των εμπορικών σημάτων ή λογότυπων της Microsoft σε τροποποιημένες εκδόσεις αυτού του έργου δεν πρέπει να προκαλεί σύγχυση ή να υπονοεί χορηγία από τη Microsoft. Οποιαδήποτε χρήση εμπορικών σημάτων ή λογότυπων τρίτων υπόκειται στις πολιτικές των αντίστοιχων τρίτων.
