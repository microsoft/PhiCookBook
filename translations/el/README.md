...
[![PRs Καλωσορίζονται](https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat-square)](http://makeapullrequest.com?WT.mc_id=aiml-137032-kinfeylo)
...
[![Αντίγραφα στο GitHub](https://img.shields.io/github/forks/microsoft/phicookbook.svg?style=social&label=Fork)](https://GitHub.com/microsoft/phicookbook/network/?WT.mc_id=aiml-137032-kinfeylo)
...
Το Phi είναι αυτή τη στιγμή το πιο ισχυρό και οικονομικά αποδοτικό μικρό γλωσσικό μοντέλο (SLM), με πολύ καλά benchmarks σε πολυγλωσσικότητα, συλλογισμό, δημιουργία κειμένου/συνομιλίας, προγραμματισμό, εικόνες, ήχο και άλλα σενάρια.

Μπορείτε να αναπτύξετε το Phi στο cloud ή σε edge συσκευές, και μπορείτε εύκολα να δημιουργήσετε εφαρμογές γεννητικής AI με περιορισμένη υπολογιστική ισχύ.

Ακολουθήστε αυτά τα βήματα για να ξεκινήσετε με αυτούς τους πόρους:
1. **Κάντε Fork το Αποθετήριο**: Πατήστε [![Αντίγραφα στο GitHub](https://img.shields.io/github/forks/microsoft/phicookbook.svg?style=social&label=Fork)](https://GitHub.com/microsoft/phicookbook/network/?WT.mc_id=aiml-137032-kinfeylo)
...
[Αραβικά](../ar/README.md) | [Μπενγκάλι](../bn/README.md) | [Βουλγαρικά](../bg/README.md) | [Βιρμανικά (Μυανμάρ)](../my/README.md) | [Κινέζικα (Απλοποιημένα)](../zh/README.md) | [Κινέζικα (Παραδοσιακά, Χονγκ Κονγκ)](../hk/README.md) | [Κινέζικα (Παραδοσιακά, Μακάου)](../mo/README.md) | [Κινέζικα (Παραδοσιακά, Ταϊβάν)](../tw/README.md) | [Κροατικά](../hr/README.md) | [Τσέχικα](../cs/README.md) | [Δανικά](../da/README.md) | [Ολλανδικά](../nl/README.md) | [Εσθονικά](../et/README.md) | [Φινλανδικά](../fi/README.md) | [Γαλλικά](../fr/README.md) | [Γερμανικά](../de/README.md) | [Ελληνικά](./README.md) | [Εβραϊκά](../he/README.md) | [Χίντι](../hi/README.md) | [Ουγγρικά](../hu/README.md) | [Ινδονησιακά](../id/README.md) | [Ιταλικά](../it/README.md) | [Ιαπωνικά](../ja/README.md) | [Κανάντα](../kn/README.md) | [Κορεάτικα](../ko/README.md) | [Λιθουανικά](../lt/README.md) | [Μαλαισιανά](../ms/README.md) | [Μαλαγιαλάμ](../ml/README.md) | [Μαράθι](../mr/README.md) | [Νεπάλι](../ne/README.md) | [Νιγηριανή Πίτζιν](../pcm/README.md) | [Νορβηγικά](../no/README.md) | [Περσικά (Φαρσί)](../fa/README.md) | [Πολωνικά](../pl/README.md) | [Πορτογαλικά (Βραζιλία)](../br/README.md) | [Πορτογαλικά (Πορτογαλία)](../pt/README.md) | [Πουντζάμπι (Γκουρμούκι)](../pa/README.md) | [Ρουμανικά](../ro/README.md) | [Ρωσικά](../ru/README.md) | [Σερβικά (Κυριλλικά)](../sr/README.md) | [Σλοβακικά](../sk/README.md) | [Σλοβενικά](../sl/README.md) | [Ισπανικά](../es/README.md) | [Σουαχίλι](../sw/README.md) | [Σουηδικά](../sv/README.md) | [Ταγκαλόγ (Φιλιππινέζικα)](../tl/README.md) | [Ταμίλ](../ta/README.md) | [Τελούγκου](../te/README.md) | [Ταϊλανδικά](../th/README.md) | [Τουρκικά](../tr/README.md) | [Ουκρανικά](../uk/README.md) | [Ουρντού](../ur/README.md) | [Βιετναμικά](../vi/README.md)

> **Προτιμάτε να Κλωνοποιήσετε Τοπικά;**

> Αυτό το αποθετήριο περιλαμβάνει 50+ μεταφράσεις σε γλώσσες που αυξάνουν σημαντικά το μέγεθος λήψης. Για να κλωνοποιήσετε χωρίς τις μεταφράσεις, χρησιμοποιήστε sparse checkout:
> ```bash
...
- Εισαγωγή
  ...
  - [Μοντέλα Αγοράς GitHub](https://github.com/marketplace/models)
...
- Εκτέλεση Phi σε διαφορετικά περιβάλλοντα
    ...
    -  [Foundry τοπικά](./md/01.Introduction/02/07.FoundryLocal.md)
...
- Εκτέλεση Phi Family
    ...
    - [Εκτέλεση Phi--Vision σε Τοπικό Περιβάλλον](./md/01.Introduction/03/Vision_Inference.md)
...
-  [Ποσοτικοποίηση Phi Family](./md/01.Introduction/04/QuantifyingPhi.md)
    ...
    - [Ποσοτικοποίηση Phi-3.5 / 4 με χρήση των επεκτάσεων Generative AI για onnxruntime](./md/01.Introduction/04/UsingORTGenAIQuantifyingPhi.md)
...
- Παραδείγματα ανάπτυξης εφαρμογών Phi
  - Εφαρμογές Κειμένου & Συνομιλίας
    ...
    - Δείγματα Phi-3 / 3.5
      ...
      -[WinUI3 Πολλαπλό Μοντέλο Εφαρμογή Σημειώσεων με Τεχνητή Νοημοσύνη Δείγμα](https://github.com/microsoft/ai-powered-notes-winui3-sample)
      ...
      - [Αξιολόγηση του Fine-tuned μοντέλου Phi-3 / Phi-3.5 στο Azure AI Foundry με εστίαση στις Αρχές Υπεύθυνης ΤΝ της Microsoft](./md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-Evaluation_AIFoundry.md)
      ...
      - [Παράδειγμα ερωταπαντήσεων .NET που χρησιμοποιεί το τοπικό μοντέλο ONNX Phi-3 με το Microsoft.ML.OnnxRuntime](../../md/04.HOL/dotnet/src/LabsPhi301)
      - [Εφαρμογή συνομιλιών κονσόλας .NET με Semantic Kernel και Phi-3](../../md/04.HOL/dotnet/src/LabsPhi302)
  ...
  - Δείγματα Προηγμένης Λογικής  
    - Δείγματα Phi-4 🆕
      ...
      - [📓] [Fine-tuning Phi-4-mini-reasoning με Microsoft Olive](./md/02.Application/03.AdvancedReasoning/Phi4/AdvancedResoningPhi4mini/olive_ft_phi_4_reasoning_with_medicaldata.ipynb)
      - [📓] [Fine-tuning Phi-4-mini-reasoning με Apple MLX](./md/02.Application/03.AdvancedReasoning/Phi4/AdvancedResoningPhi4mini/mlx_ft_phi_4_reasoning_with_medicaldata.ipynb)
  ...
  - Επιδείξεις
      ...
      - [Phi-4-multimodal επιδείξεις φιλοξενούμενες στο Hugginge Face Spaces](https://huggingface.co/spaces/microsoft/phi-4-multimodal?WT.mc_id=aiml-137032-kinfeylo)
  - Δείγματα Όρασης
    - Δείγματα Phi-4 🆕
    ...
    - Δείγματα Phi-3 / 3.5
      ...
      - [📓][Phi-3.5 Όραση πολυπλαισιακό ή πολυεικονο παράδειγμα](./md/02.Application/04.Vision/Phi3/phi3-vision-demo.ipynb)
      - [Phi-3 Όραση Τοπικό μοντέλο ONNX χρησιμοποιώντας το Microsoft.ML.OnnxRuntime .NET](../../md/04.HOL/dotnet/src/LabsPhi303)
      - [Μενού βασισμένο σε Phi-3 Όραση Τοπικό μοντέλο ONNX χρησιμοποιώντας το Microsoft.ML.OnnxRuntime .NET](../../md/04.HOL/dotnet/src/LabsPhi304)

  - Δείγματα Μαθηματικών
    -  Δείγματα Phi-4-Mini-Flash-Reasoning-Instruct 🆕 [Δοκιμαστικό Μαθηματικών με Phi-4-Mini-Flash-Reasoning-Instruct](./md/02.Application/09.Math/MathDemo.ipynb)

  - Δείγματα Ήχου
    - Δείγματα Phi-4 🆕
      - [📓] [Εξαγωγή απομαγνητοφωνήσεων με χρήση Phi-4-multimodal](./md/02.Application/05.Audio/Phi4/Transciption/README.md)
      - [📓] [Δείγμα Ήχου Phi-4-multimodal](./md/02.Application/05.Audio/Phi4/Siri/demo.ipynb)
      - [📓] [Δείγμα μεταφράσεων ομιλίας Phi-4-multimodal](./md/02.Application/05.Audio/Phi4/Translate/demo.ipynb)
      - [Εφαρμογή κονσόλας .NET με χρήση Phi-4-multimodal Audio για ανάλυση αρχείου ήχου και δημιουργία απομαγνητοφώνησης](../../md/04.HOL/dotnet/src/LabsPhi4-MultiModal-02Audio)

  - Δείγματα MOE
    - Δείγματα Phi-3 / 3.5
      - [📓] [Phi-3.5 Μείγμα Μοντέλων Ειδικών (MoEs) Κοινωνικά Μέσα Δείγμα](./md/02.Application/06.MoE/Phi3/phi3_moe_demo.ipynb)
      - [📓] [Δημιουργία Pipeline Αναζήτησης με Ενίσχυση Παραγωγής (RAG) με NVIDIA NIM Phi-3 MOE, Azure AI Search, και LlamaIndex](./md/02.Application/06.MoE/Phi3/azure-ai-search-nvidia-rag.ipynb)
      - 
  ...
  - Δείγματα Πολυτροπικού Μείγματος
    - Δείγματα Phi-4 🆕
...
- Fine-tuning Delta Samples  
  ...
  - [Fine-tuning σε σύγκριση με RAG](./md/03.FineTuning/FineTuning_vs_RAG.md)
  - [Fine-tuning για να γίνει το Phi-3 ειδικός της βιομηχανίας](./md/03.FineTuning/LetPhi3gotoIndustriy.md)
  ...
  - [Fine-tuning με εργαστήριο Microsoft Olive Hands-On Lab](./md/03.FineTuning/olive-lab/readme.md)
  - [Fine-tuning του Phi-3-vision με Weights and Bias](./md/03.FineTuning/FineTuning_Phi-3-visionWandB.md)
  - [Fine-tuning του Phi-3 με Apple MLX Framework](./md/03.FineTuning/FineTuning_MLX.md)
  ...
  - [Fine-Tuning του Phi-3 και 3.5 Vision](https://github.com/2U1/Phi3-Vision-Finetune)

- Εργαστήριο Hands on Lab  
  - [Εξερεύνηση αιχμής μοντέλων: LLMs, SLMs, τοπική ανάπτυξη και άλλα](https://github.com/microsoft/aitour-exploring-cutting-edge-models)
  - [Ξεκλείδωμα δυνατοτήτων NLP: Fine-Tuning με Microsoft Olive](https://github.com/azure/Ignite_FineTuning_workshop)

- Ακαδημαϊκά Ερευνητικά Άρθρα και Εκδόσεις
  - [Τα Βιβλία Είναι Όλα Όσα Χρειάζεσαι II: τεχνική αναφορά phi-1.5](https://arxiv.org/abs/2309.05463)
  ...
  - [Τεχνική Αναφορά Phi-4-Mini: Συμπαγή αλλά Ισχυρά Πολυμορφικά Μοντέλα Γλώσσας μέσω Mixture-of-LoRAs](https://arxiv.org/abs/2503.01743)
  - [Βελτιστοποίηση Μικρών Μοντέλων Γλώσσας για Κλήσεις Λειτουργιών Εντός Οχήματος](https://arxiv.org/abs/2501.02342)
  - [(WhyPHI) Fine-Tuning PHI-3 για Απαντήσεις σε Ερωτήσεις Πολλαπλής Επιλογής: Μεθοδολογία, Αποτελέσματα και Προκλήσεις](https://arxiv.org/abs/2501.01588)
...
**Χώρος Δοκιμών**  
Κάθε μοντέλο διαθέτει έναν [χώρο δοκιμών για να το δοκιμάσετε](/md/02.QuickStart/GitHubModel_QuickStart.md).
...
**Χώρος Δοκιμών**  
 [Χώρος δοκιμών Hugging Chat](https://huggingface.co/chat/models/microsoft/Phi-3-mini-4k-instruct)
...
### Σειρά Copilot  
[![Copilot για Συνεργατικό Προγραμματισμό Με Τεχνητή Νοημοσύνη](https://img.shields.io/badge/Copilot%20for%20AI%20Paired%20Programming-FACC15?style=for-the-badge&labelColor=E5E7EB&color=FACC15)](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)  
...
Η Microsoft είναι αφοσιωμένη στο να βοηθά τους πελάτες της να χρησιμοποιούν τα προϊόντα τεχνητής νοημοσύνης με υπευθυνότητα, μοιράζοντας τα μαθήματά μας και δημιουργώντας σχέσεις εμπιστοσύνης μέσω εργαλείων όπως οι Σημειώσεις Διαφάνειας και οι Αξιολογήσεις Επιπτώσεων. Πολλοί από αυτούς τους πόρους βρίσκονται στη διεύθυνση [https://aka.ms/RAI](https://aka.ms/RAI).  
Η προσέγγιση της Microsoft για την υπεύθυνη τεχνητή νοημοσύνη βασίζεται στις αρχές μας για τη δικαιοσύνη, την αξιοπιστία και την ασφάλεια, το απόρρητο και την ασφάλεια, την ενσωμάτωση, τη διαφάνεια και την υπευθυνότητα.

Τα μεγάλου μεγέθους μοντέλα φυσικής γλώσσας, εικόνας και ομιλίας - όπως αυτά που χρησιμοποιούνται σε αυτό το δείγμα - ενδέχεται να συμπεριφέρονται με τρόπους που είναι άδικοι, αναξιόπιστοι ή προσβλητικοί, προκαλώντας έτσι ζημία. Παρακαλούμε ανατρέξτε στη [Σημείωση Διαφάνειας υπηρεσίας Azure OpenAI](https://learn.microsoft.com/legal/cognitive-services/openai/transparency-note?tabs=text) για να ενημερωθείτε σχετικά με τους κινδύνους και τους περιορισμούς.

Η προτεινόμενη προσέγγιση για την αντιμετώπιση αυτών των κινδύνων είναι η ενσωμάτωση ενός συστήματος ασφαλείας στην αρχιτεκτονική σας που μπορεί να ανιχνεύσει και να αποτρέψει επιβλαβή συμπεριφορά. Το [Azure AI Content Safety](https://learn.microsoft.com/azure/ai-services/content-safety/overview) παρέχει ένα ανεξάρτητο στρώμα προστασίας, ικανό να εντοπίζει επιβλαβές περιεχόμενο που δημιουργείται από χρήστες και AI σε εφαρμογές και υπηρεσίες. Το Azure AI Content Safety περιλαμβάνει APIs για κείμενο και εικόνα που σας επιτρέπουν να ανιχνεύετε υλικό που είναι επιβλαβές. Μέσα στο Azure AI Foundry, η υπηρεσία Content Safety σας επιτρέπει να δείτε, να εξερευνήσετε και να δοκιμάσετε δείγμα κώδικα για την ανίχνευση επιβλαβούς περιεχομένου σε διάφορες μορφές. Η ακόλουθη [τεκμηρίωση γρήγορης εκκίνησης](https://learn.microsoft.com/azure/ai-services/content-safety/quickstart-text?tabs=visual-studio%2Clinux&pivots=programming-language-rest) σας καθοδηγεί στο πώς να κάνετε αιτήματα προς την υπηρεσία.

Ένα άλλο στοιχείο που πρέπει να ληφθεί υπόψη είναι η συνολική απόδοση της εφαρμογής. Με εφαρμογές πολλαπλών μορφών και πολλαπλών μοντέλων, θεωρούμε ότι απόδοση σημαίνει ότι το σύστημα λειτουργεί όπως εσείς και οι χρήστες σας αναμένετε, συμπεριλαμβανομένης της μη παραγωγής επιβλαβών αποτελεσμάτων. Είναι σημαντικό να αξιολογήσετε την απόδοση της συνολικής εφαρμογής σας χρησιμοποιώντας [εκτιμητές απόδοσης, ποιότητας, κινδύνου και ασφάλειας](https://learn.microsoft.com/azure/ai-studio/concepts/evaluation-metrics-built-in). Επίσης, έχετε τη δυνατότητα να δημιουργείτε και να αξιολογείτε με [προσαρμοσμένους εκτιμητές](https://learn.microsoft.com/azure/ai-studio/how-to/develop/evaluate-sdk#custom-evaluators).
Μπορείτε να αξιολογήσετε την εφαρμογή AI σας στο περιβάλλον ανάπτυξής σας χρησιμοποιώντας το [Azure AI Evaluation SDK](https://microsoft.github.io/promptflow/index.html). Δεδομένου ενός δοκιμαστικού συνόλου δεδομένων ή ενός στόχου, οι γεννήσεις της γενετικής AI εφαρμογής σας μετρώνται ποσοτικά με ενσωματωμένους αξιολογητές ή προσαρμοσμένους αξιολογητές της επιλογής σας. Για να ξεκινήσετε με το azure ai evaluation sdk για να αξιολογήσετε το σύστημά σας, μπορείτε να ακολουθήσετε τον [οδηγό εκκίνησης](https://learn.microsoft.com/azure/ai-studio/how-to/develop/flow-evaluate-sdk). Μόλις εκτελέσετε μια εκτέλεση αξιολόγησης, μπορείτε να [οπτικοποιήσετε τα αποτελέσματα στο Azure AI Foundry](https://learn.microsoft.com/azure/ai-studio/how-to/evaluate-flow-results). 

## Εμπορικά Σήματα

Αυτό το έργο ενδέχεται να περιέχει εμπορικά σήματα ή λογότυπα για έργα, προϊόντα ή υπηρεσίες. Η εξουσιοδοτημένη χρήση των εμπορικών σημάτων ή λογοτύπων της Microsoft υπόκειται και πρέπει να ακολουθεί τις [Οδηγίες Εμπορικών Σημάτων & Μάρκας της Microsoft](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
Η χρήση εμπορικών σημάτων ή λογοτύπων της Microsoft σε τροποποιημένες εκδόσεις αυτού του έργου δεν πρέπει να προκαλεί σύγχυση ή να υπονοεί χορηγία από τη Microsoft. Οποιαδήποτε χρήση εμπορικών σημάτων ή λογοτύπων τρίτων υπόκειται στις πολιτικές των τρίτων αυτών.

## Λήψη Βοήθειας

Αν κολλήσετε ή έχετε απορίες σχετικά με την κατασκευή εφαρμογών AI, συμμετάσχετε:
...
**Αποποίηση Ευθυνών**:  
Αυτό το έγγραφο έχει μεταφραστεί χρησιμοποιώντας την υπηρεσία μετάφρασης με τεχνητή νοημοσύνη [Co-op Translator](https://github.com/Azure/co-op-translator). Παρά τις προσπάθειές μας για ακρίβεια, παρακαλούμε να γνωρίζετε ότι οι αυτόματες μεταφράσεις ενδέχεται να περιέχουν λάθη ή ανακρίβειες. Το πρωτότυπο έγγραφο στη μητρική του γλώσσα πρέπει να θεωρείται η επίσημη πηγή. Για κρίσιμες πληροφορίες, συνιστάται επαγγελματική μετάφραση από ανθρώπινο μεταφραστή. Δεν φέρουμε καμία ευθύνη για τυχόν παρεξηγήσεις ή λανθασμένες ερμηνείες που προκύπτουν από τη χρήση αυτής της μετάφρασης.
