...
Μπορούμε να αναπτύξουμε γρήγορα το μοντέλο Phi-3 στο Microsoft Foundry μέσα από απλά βήματα και στη συνέχεια να χρησιμοποιήσουμε το Microsoft Foundry για να ολοκληρώσουμε το Playground/Chat, το Fine-tuning, την αξιολόγηση και άλλες σχετικές εργασίες του Phi-3.
...
Η δημιουργία ενός έργου και hub στο Microsoft Foundry είναι ένας εξαιρετικός τρόπος να οργανώσετε και να διαχειριστείτε τη δουλειά σας στην AI. Ακολουθεί ένας οδηγός βήμα προς βήμα για να ξεκινήσετε:

### Δημιουργία έργου στο Microsoft Foundry

1. **Μεταβείτε στο Microsoft Foundry**: Συνδεθείτε στην πύλη του Microsoft Foundry.
2. **Δημιουργία έργου**:
   - Αν βρίσκεστε ήδη σε ένα έργο, επιλέξτε "Microsoft Foundry" πάνω αριστερά για να μεταβείτε στην Αρχική σελίδα.
...
1. **Μεταβείτε στο Microsoft Foundry**: Συνδεθείτε με τον λογαριασμό σας Azure.
2. **Δημιουργία hub**:
...
Δημιουργήστε Microsoft Foundry [QuickStarts](https://learn.microsoft.com/azure/ai-studio/quickstarts/get-started-code)
...
## **3. Playground Chat Phi στο Microsoft Foundry**
