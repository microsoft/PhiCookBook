...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-09T20:08:16+00:00",
...
Η κλήση συναρτήσεων εμφανίστηκε πρώτα στην οικογένεια Phi Family, και τώρα μπορείτε να τη χρησιμοποιήσετε μέσω του Phi-4-mini.

Αυτό το παράδειγμα δείχνει την προσομοίωση των αποτελεσμάτων της Premier League. Ο στόχος είναι το Phi-4-mini να παρέχει πληροφορίες αγώνα σε πραγματικό χρόνο. Παρακάτω βρίσκεται ο δείγμα κώδικα:
