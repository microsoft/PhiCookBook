...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-17T05:15:42+00:00",
  "source_file": "md/02.Application/07.FunctionCalling/Phi4/FunctionCallingBasic/README.md",
  "language_code": "el"
}
-->
## **Κλήση συναρτήσεων στο Phi-4-mini**

Η κλήση συναρτήσεων εμφανίστηκε αρχικά στην οικογένεια Phi Family, και τώρα μπορείτε να τη χρησιμοποιήσετε μέσω του Phi-4-mini.

Αυτό το παράδειγμα δείχνει τη προσομοίωση αποτελεσμάτων της Premier League. Ο στόχος είναι το Phi-4-mini να παρέχει πληροφορίες αγώνων σε πραγματικό χρόνο. Παρακάτω βρίσκεται ο δείγμα κώδικα:
