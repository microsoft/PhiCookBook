...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-09T20:06:04+00:00",
  "source_file": "md/02.Application/05.Audio/Phi4/Transciption/README.md",
  "language_code": "el"
}
-->
## **Εξαγωγή μεταγραφών ήχου χρησιμοποιώντας το Phi-4-multimodal**

Το Phi-4-multimodal είναι ένα πολυτροπικό μοντέλο που μπορεί να χρησιμοποιήσει ήχο εκτός από κείμενο και εικόνες. Ας δούμε πώς να το χρησιμοποιήσουμε.
