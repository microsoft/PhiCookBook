...
[AI Toolkit για VS Code](https://marketplace.visualstudio.com/items?itemName=ms-windows-ai-studio.windows-ai-studio) απλοποιεί την ανάπτυξη εφαρμογών γενετικής AI, συνδυάζοντας προηγμένα εργαλεία και μοντέλα AI από το Microsoft Foundry Catalog και άλλα καταλόγους όπως το Hugging Face. Θα μπορείτε να περιηγηθείτε στον κατάλογο μοντέλων AI που υποστηρίζεται από τα GitHub Models και Microsoft Foundry Model Catalogs, να τα κατεβάσετε τοπικά ή απομακρυσμένα, να τα προσαρμόσετε, να τα δοκιμάσετε και να τα χρησιμοποιήσετε στην εφαρμογή σας.
...
![AI toolkit model catalog](../../../../../translated_images/el/AItoolkitmodel_catalog.7a7be6a7d8468d31.webp)
...
![Load model in playground](../../../../../translated_images/el/AItoolkitload_model_into_playground.dcef5355b1653b52.webp)
