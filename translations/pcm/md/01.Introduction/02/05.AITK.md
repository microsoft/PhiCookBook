...
[AI Toolkit for VS Code](https://marketplace.visualstudio.com/items?itemName=ms-windows-ai-studio.windows-ai-studio) dey make generative AI app development easy by bring together cutting-edge AI development tools and models from Microsoft Foundry Catalog and oda catalogs like Hugging Face. You go fit browse di AI models catalog wey GitHub Models and Microsoft Foundry Model Catalogs power, download dem locally or remote, fine-tune, test and use dem for your application.
