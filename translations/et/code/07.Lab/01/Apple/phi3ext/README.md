...
Kui sinu laiendus lisab VS Code'i seadistusi läbi `contributes.configuration` laienduspunkti, siis lisa need siia.

Näiteks:

See laiendus pakub järgmisi seadeid:
...
Teadaolevate probleemide välja toomine aitab vähendada kasutajate poolt korduvate probleemide avamist sinu laienduse kohta.
...
## Markdowniga töötamine

Sa saad kasutada Visual Studio Code'i oma README kirjutamiseks. Siin on mõned kasulikud redaktori kiirklahvid:
