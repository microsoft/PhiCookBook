...
Phi mudelite kasutamiseks saate uurida [Azure AI mudelikataloogi](https://ai.azure.com/explore/models) või [GitHub Marketplace'i mudeleid](https://github.com/marketplace/models), mis pakuvad eelvalmistatud ja kohandatavaid mudeleid. Lisaks saate kasutada tööriistu nagu [Microsoft Foundry](https://ai.azure.com), et arendada ja juurutada oma AI-rakendusi.
