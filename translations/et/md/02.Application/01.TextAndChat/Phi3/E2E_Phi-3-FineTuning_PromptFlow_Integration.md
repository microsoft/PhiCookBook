...
![Phi-3-FineTuning_PromptFlow_Integration Overview](../../../../../../translated_images/et/00-01-architecture.02fc569e266d468c.webp)
...
1. Tippige portaalilehe ülaosas otsiribale *azure machine learning* ja valige kuvatud valikute hulgast **Azure Machine Learning**.
    ...
    ![Type azure machine learning](../../../../../../translated_images/et/01-01-type-azml.a5116f8454d98c60.webp)

1. Valige navigeerimismenüüst **+ Create**.

1. Valige navigeerimismenüüst **New workspace**.

    ![Select new workspace](../../../../../../translated_images/et/01-02-select-new-workspace.83e17436f8898dc4.webp)
...
1. Täitke järgmised ülesanded:
    ...
    ![Fill AZML.](../../../../../../translated_images/et/01-03-fill-AZML.730a5177757bbebb.webp)
...
1. Täitke järgmised ülesanded, et taotleda *Standard NCADSA100v4 Family* kvanti:
    ...
    - Valige navigeerimismenüüst **Request quota**.
        ...
        ![Request quota.](../../../../../../translated_images/et/01-04-request-quota.3d3670c3221ab834.webp)
...
1. Tippige portaalilehe ülaosas otsiribale *managed identities* ja valige kuvatud valikute hulgast **Managed Identities**.
    ...
    ![Type managed identities.](../../../../../../translated_images/et/01-05-type-managed-identities.9297b6039874eff8.webp)

1. Valige **+ Create**.

    ![Select create.](../../../../../../translated_images/et/01-06-select-create.936d8d66d7144f9a.webp)
...
1. Rolli määramise lisamise lehel täitke järgmised ülesanded:
    ...
    ![Fill contributor role.](../../../../../../translated_images/et/01-07-fill-contributor-role.29ca99b7c9f687e0.webp)
...
1. Tippige portaalilehe ülaosas otsiribale *storage accounts* ja valige kuvatud valikute hulgast **Storage accounts**.
    ...
    ![Type storage accounts.](../../../../../../translated_images/et/01-08-type-storage-accounts.1186c8e42933e49b.webp)
...
1. Täitke järgmised ülesanded, et jõuda rolli määramise lisamise lehele:
    ...
    ![Add role.](../../../../../../translated_images/et/01-09-add-role.d2db22fec1b187f0.webp)
...
1. Rolli määramise lisamise lehel täitke järgmised ülesanded:
    ...
    ![Select managed identity.](../../../../../../translated_images/et/01-10-select-managed-identity.5ce5ba181f72a4df.webp)
...
1. Tippige portaalilehe ülaosas otsiribale *container registries* ja valige kuvatud valikute hulgast **Container registries**.
    ...
    ![Type container registries.](../../../../../../translated_images/et/01-11-type-container-registries.ff3b8bdc49dc596c.webp)
...
1. Valige loodud *finetune-phi* kaust, mis asub aadressil *C:\Users\yourUserName\finetune-phi*.
    ...
    ![Ava projekti kaust.](../../../../../../translated_images/et/01-12-open-project-folder.1fff9c7f41dd1639.webp)
...
1. Visual Studio Code vasaku paneeli sees paremklõpsake ja valige **New File**, et luua uus fail nimega *deploy_model.py*.
    ...
    ![Loo uus fail.](../../../../../../translated_images/et/01-13-create-new-file.c17c150fff384a39.webp)
...
1. Tehke järgmised toimingud Azure tellimuse ID lisamiseks:
    ...
    ![Leia tellimuse ID.](../../../../../../translated_images/et/01-14-find-subscriptionid.4f4ca33555f1e637.webp)
...
1. Tehke järgmised toimingud Azure tööruumi nime lisamiseks:
    ...
    ![Leia Azure Machine Learning nimi.](../../../../../../translated_images/et/01-15-find-AZML-name.1975f0422bca19a7.webp)
...
1. Tehke järgmised toimingud Azure ressursside grupi nime lisamiseks:
    ...
    ![Leia ressursside grupi nimi.](../../../../../../translated_images/et/01-16-find-AZML-resourcegroup.855a349d0af134a3.webp)
...
2. Tehke järgmised toimingud Azure hallatava identiteedi nime lisamiseks:
    ...
    ![Leia UAI.](../../../../../../translated_images/et/01-17-find-uai.3529464f53499827.webp)
...
1. Valige kasutatav Azure tellimus.
    ...
    ![Leia ressursside grupi nimi.](../../../../../../translated_images/et/02-01-login-using-azure-cli.dfde31cb75e58a87.webp)
...
1. Selles harjutuses peenhäälestasite edukalt Phi-3 mudeli, kasutades Azure Machine Learningut. Käivitades skripti *setup_ml.py*, seadistasite Azure Machine Learning keskkonna ja käivitasite *fine_tune.py* failis määratletud peenhäälestusprotsessi. Pange tähele, et peenhäälestus võib võtta märkimisväärselt aega. Pärast `python setup_ml.py` käivitamist peate protsessi lõpuni ootama. Peenhäälestuse töö olekut saate jälgida terminalis kuvatava lingi kaudu Azure Machine Learning portaali.
    ...
    ![Vaata peenhäälestustöö olekut.](../../../../../../translated_images/et/02-02-see-finetuning-job.59393bc3b143871e.webp)
...
1. Vali vasakpoolsest menüüst **Endpoints**.
    ...
    ![Select endpoints.](../../../../../../translated_images/et/02-03-select-endpoints.c3136326510baff1.webp)

2. Vali loodud otspunkt.

    ![Select endpoints that you created.](../../../../../../translated_images/et/02-04-select-endpoint-created.0363e7dca51dabb4.webp)
...
1. Kopeeri ja kleebi oma **Primary key** faili *config.py*, asendades `AZURE_ML_API_KEY = "your_fine_tuned_model_api_key"` oma **Primary key**-ga.
    ...
    ![Copy api key and endpoint uri.](../../../../../../translated_images/et/02-05-copy-apikey-endpoint.88b5a92e6462c53b.webp)
...
1. Näide tulemustest: nüüd saad suhelda oma kohandatud Phi-3 mudeliga. Soovitatav on esitada küsimusi, mis põhinevad peenhäälestamiseks kasutatud andmetel.
    ...
    ![Prompt flow example.](../../../../../../translated_images/et/02-06-promptflow-example.89384abaf3ad71f6.webp)
