...
Microsoft Foundry projekti ja hubi loomine on suurepärane viis oma tehisintellekti töö korraldamiseks ja haldamiseks. Siin on samm-sammuline juhend alustamiseks:

### Projekti loomine Microsoft Foundry platvormil

1. **Minge Microsoft Foundry lehele**: Logige sisse Microsoft Foundry portaalis.
2. **Looge projekt**:
   - Kui olete projektis, valige lehe vasakust ülanurgast "Microsoft Foundry", et minna avalehele.
...
### Hubi loomine Microsoft Foundry platvormil

1. **Minge Microsoft Foundry lehele**: Logige sisse oma Azure kontoga.
2. **Looge hub**:
...
Looge Microsoft Foundry [QuickStarts](https://learn.microsoft.com/azure/ai-studio/quickstarts/get-started-code)

## **2. Phi mudeli juurutamine Microsoft Foundry platvormil**
...
## **3. Playground Chat Phi Microsoft Foundry platvormil**

Minge juurutamise lehele, valige Playground ja vestelge Microsoft Foundry Phi-3 mudeliga.

## **4. Mudeli juurutamine Microsoft Foundry platvormilt**

Mudeli juurutamiseks Azure Model Catalog kaudu järgige neid samme:

- Logige sisse Microsoft Foundry platvormil.
- Valige mudel, mida soovite juurutada, Microsoft Foundry mudelikataloogist.
...
## **5. Phi API kasutamine Microsoft Foundry platvormil**
