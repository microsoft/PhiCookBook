...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-09T18:06:01+00:00",
...
- Azure AI 推論 SDK 程式碼範例  
  ...
  - Phi-3 / 3.5 範例  
    - [使用 Microsoft Phi-3 系列打造自己的 Visual Studio Code GitHub Copilot 聊天機器人](./md/02.Application/02.Code/Phi3/VSCodeExt/README.md)  
    - [使用 GitHub 模型與 Phi-3.5 建立自己的 Visual Studio Code 聊天 Copilot 代理人](/md/02.Application/02.Code/Phi3/CreateVSCodeChatAgentWithGitHubModels.md)  
...
**Playground**  
每個模型都有專屬的測試平台，請至 [Azure AI Playground](https://aka.ms/try-phi3) 試用。
