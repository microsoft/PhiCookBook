...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-04-04T12:53:49+00:00",
  "source_file": "md\\02.Application\\02.Code\\Phi3\\VSCodeExt\\HOL\\AIPC\\04.CreatePhi3AgentInVSCode.md",
  "language_code": "mo"
}
-->
# **Lab 3 - Création d'un agent @PHI3 dans GitHub Copilot Chat**

Dans Visual Studio Code Copilot Chat, vous pouvez gérer l'ensemble du projet via @workspace. Pour des scénarios d'entreprise, nous pouvons également personnaliser l'agent Copilot Chat de manière plus flexible.

Lors du dernier laboratoire, nous avons combiné NPU et cloud pour compléter une extension Visual Studio Code pour l'agent Phi3.
...
L'API Visual Studio Code Chat n'a pas encore été intégrée à l'API code, mais elle est désormais ajoutée via des extensions.
...
export function activate(extcontext: vscode.ExtensionContext) {
	...
	const phi3handler: vscode.ChatRequestHandler = async (request: vscode.ChatRequest, context: vscode.ChatContext, stream: vscode.ChatResponseStream, token: vscode.CancellationToken): Promise<IPHI3ChatResult> => {
		...
		if (request.command == 'img') {
			...
			{
				var result = "```txt"+"\n\n"+"Posez une question comme ceci Votre question (IMG_URL:https://example.com/image.jpg)"+"\n\n"++"```";
...
It seems you are asking for a translation to "mo." Could you clarify what "mo" refers to? Are you requesting a translation to Maori, Mongolian, or another language or code?