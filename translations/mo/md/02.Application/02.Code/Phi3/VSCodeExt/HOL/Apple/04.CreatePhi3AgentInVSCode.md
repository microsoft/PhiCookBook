...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-07T13:54:23+00:00",
...
En Visual Studio Code Copilot Chat, puedes gestionar todo el proyecto a través de @workspace. Para escenarios empresariales, también podemos personalizar el Agente de Copilot Chat de forma más flexible.

En el laboratorio anterior, combinamos el framework MX y la nube para completar una extensión de Visual Studio Code para el agente Phi3.
...
Consulta este enlace [https://code.visualstudio.com/api/get-started/your-first-extension](https://code.visualstudio.com/api/get-started/your-first-extension) para crear un proyecto de extensión

***NOTE:*** Por favor, utiliza Typescript y WebPack como solución técnica para este proyecto
...
***NOTE:*** Ejecuta esto en Visual Studio Code Insiders 1.90+
...
¡Felicidades! Has completado todos los laboratorios. Espero que esto te ayude a comprender la familia Phi-3 y cómo usar GitHub Copilot Chat.
