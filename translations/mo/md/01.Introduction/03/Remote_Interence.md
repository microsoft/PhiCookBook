...
![Fine-tune complete](../../../../../translated_images/mo/log-finetuning-res.7b92254e7e822c7f.webp)

### 配置 Azure 資源
您需要透過命令面板執行 `AI Toolkit: Provision Azure Container Apps for inference` 來設定遠端推論所需的 Azure 資源。設定過程中，系統會要求您選擇 Azure 訂閱和資源群組。  
![Provision Inference Resource](../../../../../translated_images/mo/command-provision-inference.467afc8d351642fc.webp)
...
![Deploy for inference](../../../../../translated_images/mo/command-deploy.9adb4e310dd0b0ae.webp)
...
![App Endpoint](../../../../../translated_images/mo/notification-deploy.446e480a44b1be58.webp)
