...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-16T21:36:29+00:00",
...
Phi-3-vision-128k-instruct 不僅讓 Phi-3 能理解語言，還能以視覺方式感知世界。透過 Phi-3-vision-128k-instruct，我們可以解決各種視覺問題，例如 OCR、表格分析、物體識別、圖片描述等。過去需要大量數據訓練才能完成的任務，現在都能輕鬆實現。以下是 Phi-3-vision-128k-instruct 引用的相關技術與應用場景。
