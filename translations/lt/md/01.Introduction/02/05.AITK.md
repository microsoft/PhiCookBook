...
[AI Toolkit for VS Code](https://marketplace.visualstudio.com/items?itemName=ms-windows-ai-studio.windows-ai-studio) supaprastina generatyvios AI programų kūrimą, sujungdamas pažangiausius AI kūrimo įrankius ir modelius iš Microsoft Foundry katalogo bei kitų katalogų, tokių kaip Hugging Face. Galėsite naršyti AI modelių katalogą, kurį palaiko GitHub Models ir Microsoft Foundry Model Catalogs, atsisiųsti juos lokaliai arba nuotoliniu būdu, pritaikyti, testuoti ir naudoti savo programoje.
