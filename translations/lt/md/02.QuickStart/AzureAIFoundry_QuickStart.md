...
Microsoft Foundry projekto ir centro (hub) kūrimas yra puikus būdas organizuoti ir valdyti jūsų dirbtinio intelekto darbus. Štai žingsnis po žingsnio vadovas, kaip pradėti:
...
2. **Sukurkite projektą**:
   - Jei jau esate projekte, pasirinkite „Microsoft Foundry“ viršutiniame kairiajame puslapio kampe, kad grįžtumėte į pagrindinį puslapį.
...
### Centro kūrimas Microsoft Foundry

1. **Eikite į Microsoft Foundry**: Prisijunkite naudodami savo Azure paskyrą.
2. **Sukurkite centrą**:
...
Eikite į diegimo puslapį, pasirinkite „Playground“ ir bendraukite su Phi-3 Microsoft Foundry platformoje.
