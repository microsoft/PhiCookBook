...
[AI Toolkit für VS Code](https://marketplace.visualstudio.com/items?itemName=ms-windows-ai-studio.windows-ai-studio) erleichtert die Entwicklung generativer KI-Anwendungen, indem es modernste KI-Entwicklungstools und Modelle aus dem Microsoft Foundry Catalog sowie anderen Katalogen wie Hugging Face zusammenbringt. Du kannst den KI-Modellkatalog durchsuchen, der von GitHub Models und Microsoft Foundry Model Catalogs unterstützt wird, Modelle lokal oder remote herunterladen, feinabstimmen, testen und in deiner Anwendung verwenden.
