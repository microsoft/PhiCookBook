...
Wir können das Phi-3-Modell schnell über einfache Schritte auf Microsoft Foundry bereitstellen und anschließend Microsoft Foundry nutzen, um Phi-3-bezogene Playground/Chat-, Fine-Tuning-, Bewertungs- und weitere Aufgaben durchzuführen.
...
Ein Microsoft Foundry-Projekt und Hub zu erstellen, ist eine gute Möglichkeit, Ihre KI-Arbeiten zu organisieren und zu verwalten. Hier eine Schritt-für-Schritt-Anleitung, um loszulegen:

### Erstellen eines Projekts in Microsoft Foundry
...
### Erstellen eines Hubs in Microsoft Foundry
...
Gehen Sie zur Bereitstellungsseite, wählen Sie Playground und chatten Sie mit Phi-3 von Microsoft Foundry.

## **4. Bereitstellung des Modells aus Microsoft Foundry**
...
- Wählen Sie das Modell aus dem Microsoft Foundry Model Catalog aus, das Sie bereitstellen möchten.
