...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-07T10:16:18+00:00",
...
* Ejecuta la tarea "watch" mediante el comando **Tasks: Run Task**. Asegúrate de que esté en ejecución, de lo contrario las pruebas podrían no detectarse.
* Abre la vista de Testing desde la barra de actividades y haz clic en el botón "Run Test", o usa la tecla rápida `Ctrl/Cmd + ; A`
* Consulta el resultado de la prueba en la vista de Resultados de Pruebas.
