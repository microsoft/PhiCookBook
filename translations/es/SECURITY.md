...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-04-03T05:54:46+00:00",
...
Deberías recibir una respuesta dentro de 24 horas. Si por alguna razón no la recibes, por favor envía un correo de seguimiento para asegurarte de que recibimos tu mensaje original. Puedes encontrar información adicional en [microsoft.com/msrc](https://www.microsoft.com/msrc).
...
Por favor, incluye la información solicitada que se detalla a continuación (tanto como puedas proporcionar) para ayudarnos a comprender mejor la naturaleza y el alcance del posible problema:
  ...
  * Impacto del problema, incluyendo cómo un atacante podría aprovecharlo

Esta información nos ayudará a priorizar tu reporte más rápidamente.

Si estás reportando para un programa de recompensas, los reportes más completos pueden contribuir a obtener una recompensa mayor. Por favor visita nuestra página del [Programa de Recompensas de Microsoft](https://aka.ms/security.md/msrc/bounty) para más detalles sobre nuestros programas activos.
