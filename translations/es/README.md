...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-09T16:14:03+00:00",
...
- Ejemplos MOE  
  - Ejemplos Phi-3 / 3.5  
    ...
    - [📓] [Construcción de una pipeline Retrieval-Augmented Generation (RAG) con NVIDIA NIM Phi-3 MOE, Azure AI Search y LlamaIndex](../../md/02.Application/06.MoE/Phi3/azure-ai-search-nvidia-rag.ipynb)  
-  
...
- Artículos académicos y publicaciones  
  ...
  - [Optimización de modelos de lenguaje pequeños para llamada a funciones en vehículos](https://arxiv.org/abs/2501.02342)  
