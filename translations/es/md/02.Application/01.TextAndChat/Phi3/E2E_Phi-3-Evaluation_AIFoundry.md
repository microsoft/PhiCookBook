...
![Arquitectura del tutorial.](../../../../../../translated_images/architecture.10bec55250f5d6a4.es.png)
...
![Evaluación de seguridad.](../../../../../../translated_images/safety-evaluation.083586ec88dfa950.es.png)
...
![Centro de llenado.](../../../../../../translated_images/responsibleai2.c07ef430113fad8c.es.png)
...
![Evaluar basado en seguridad.](../../../../../../translated_images/evaluate-based-on-safety.c5df819f5b0bfc07.es.png)
...
![Evaluación de seguridad.](../../../../../../translated_images/performance-evaluation.48b3e7e01a098740.es.png)
...
![Evaluar basado en rendimiento.](../../../../../../translated_images/evaluate-based-on-performance.3e801c647c7554e8.es.png)
...
1. Selecciona **+ New hub** en el menú de navegación.
    ...
    ![Create hub.](../../../../../../translated_images/create-hub.5be78fb1e21ffbf1.es.png)
...
1. Realiza las siguientes tareas:
    ...
    ![Fill hub.](../../../../../../translated_images/fill-hub.baaa108495c71e34.es.png)
...
1. Selecciona **+ New project** en el menú de navegación.
    ...
    ![Select new project.](../../../../../../translated_images/select-new-project.cd31c0404088d7a3.es.png)

1. Ingresa el **Project name**. Debe ser un valor único.

    ![Create project.](../../../../../../translated_images/create-project.ca3b71298b90e420.es.png)
...
1. Selecciona **Endpoints** en la pestaña lateral izquierda.
    ...
    ![Select endpoints.](../../../../../../translated_images/select-endpoints.ee7387ecd68bd18d.es.png)

1. Selecciona el endpoint que creaste.

    ![Select endpoints.](../../../../../../translated_images/select-endpoint-created.9f63af5e4cf98b2e.es.png)

1. Selecciona **Consume** en el menú de navegación.

1. Copia tu **REST endpoint** y tu **Primary key**.

    ![Copy api key and endpoint uri.](../../../../../../translated_images/copy-endpoint-key.0650c3786bd646ab.es.png)
...
1. Selecciona **+ New connection**.
    ...
    ![Select new connection.](../../../../../../translated_images/select-new-connection.fa0f35743758a74b.es.png)

1. Selecciona **Custom keys** en el menú de navegación.

    ![Select custom keys.](../../../../../../translated_images/select-custom-keys.5a3c6b25580a9b67.es.png)
...
1. Realiza las siguientes tareas:
    ...
    ![Add connection.](../../../../../../translated_images/add-connection.ac7f5faf8b10b0df.es.png)
...
1. Selecciona **+ Create** en el menú de navegación.
    ...
    ![Select Promptflow.](../../../../../../translated_images/select-promptflow.18ff2e61ab9173eb.es.png)

1. Selecciona **Chat flow** en el menú de navegación.

    ![Select chat flow.](../../../../../../translated_images/select-flow-type.28375125ec9996d3.es.png)

1. Ingresa el **Folder name** que usarás.

    ![Select chat flow.](../../../../../../translated_images/enter-name.02ddf8fb840ad430.es.png)
...
1. En el Prompt flow, realiza las siguientes tareas para reconstruir el flujo existente:
    ...
    ![Select raw file mode.](../../../../../../translated_images/select-raw-file-mode.06c1eca581ce4f53.es.png)
...
1. Añade el siguiente código en *integrate_with_promptflow.py* para usar el modelo personalizado Phi-3 / Phi-3.5 en Prompt flow.
    ...
    ![Paste prompt flow code.](../../../../../../translated_images/paste-promptflow-code.cd6d95b101c0ec28.es.png)
...
1. Selecciona **Chat input**, **Chat output** para habilitar el chat con tu modelo.
    ...
    ![Select Input Output.](../../../../../../translated_images/select-input-output.c187fc58f25fbfc3.es.png)
...
>
> ![Flow example](../../../../../../translated_images/graph-example.82fd1bcdd3fc545b.es.png)
>
...
1. Selecciona **Start compute sessions** para iniciar Prompt flow.
    ...
    ![Start compute session.](../../../../../../translated_images/start-compute-session.9acd8cbbd2c43df1.es.png)

1. Selecciona **Validate and parse input** para renovar los parámetros.

    ![Validate input.](../../../../../../translated_images/validate-input.c1adb9543c6495be.es.png)

1. Selecciona el **Value** de la **connection** a la conexión personalizada que creaste. Por ejemplo, *connection*.

    ![Connection.](../../../../../../translated_images/select-connection.1f2b59222bcaafef.es.png)

#### Chatear con tu modelo personalizado Phi-3 / Phi-3.5

1. Selecciona **Chat**.

    ![Select chat.](../../../../../../translated_images/select-chat.0406bd9687d0c49d.es.png)
...
1. Aquí tienes un ejemplo de los resultados: ahora puedes chatear con tu modelo personalizado Phi-3 / Phi-3.5. Se recomienda hacer preguntas basadas en los datos usados para el ajuste fino.
    ...
    ![Chat with prompt flow.](../../../../../../translated_images/chat-with-promptflow.1cf8cea112359ada.es.png)
...
1. Navega al proyecto de Azure AI Foundry que creaste.
    ...
    ![Select Project.](../../../../../../translated_images/select-project-created.5221e0e403e2c9d6.es.png)
...
1. Selecciona **Deploy base model**.
    ...
    ![Select Deployments.](../../../../../../translated_images/deploy-openai-model.95d812346b25834b.es.png)

1. Selecciona el modelo Azure OpenAI que deseas usar. Por ejemplo, **gpt-4o**.

    ![Select Azure OpenAI model you'd like to use.](../../../../../../translated_images/select-openai-model.959496d7e311546d.es.png)
...
1. Selecciona **+ New evaluation** en el menú de navegación.
    ...
    ![Select evaluation.](../../../../../../translated_images/select-evaluation.2846ad7aaaca7f4f.es.png)

1. Selecciona la evaluación **Prompt flow**.

    ![Select Prompt flow evaluation.](../../../../../../translated_images/promptflow-evaluation.cb9758cc19b4760f.es.png)
...
1. Realiza las siguientes tareas:
    ...
    ![Prompt flow evaluation.](../../../../../../translated_images/evaluation-setting1.4aa08259ff7a536e.es.png)
...
1. Realiza las siguientes tareas:
    ...
    ![Prompt flow evaluation.](../../../../../../translated_images/evaluation-setting2.07036831ba58d64e.es.png)
...
1. Realiza las siguientes tareas para configurar las métricas de rendimiento y calidad:
    ...
    ![Prompt flow evaluation.](../../../../../../translated_images/evaluation-setting3-1.d1ae69e3bf80914e.es.png)
...
1. Realiza las siguientes tareas para configurar las métricas de riesgo y seguridad:
    ...
    ![Prompt flow evaluation.](../../../../../../translated_images/evaluation-setting3-2.d53bd075c60a45a2.es.png)
...
1. Métricas de rendimiento y calidad:
    ...
    ![Evaluation result.](../../../../../../translated_images/evaluation-result-gpu.85f48b42dfb74254.es.png)
...
1. Métricas de riesgo y seguridad:
    ...
    ![Evaluation result.](../../../../../../translated_images/evaluation-result-gpu-2.1b74e336118f4fd0.es.png)

1. Puedes desplazarte hacia abajo para ver el **resultado detallado de las métricas**.

    ![Evaluation result.](../../../../../../translated_images/detailed-metrics-result.afa2f5c39a4f5f17.es.png)
...
![Architecture.](../../../../../../translated_images/architecture.10bec55250f5d6a4.es.png)
