...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2026-01-04T06:34:00+00:00",
  "source_file": "md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-FineTuning_PromptFlow_Integration.md",
  "language_code": "es"
}
-->
# Afinar e integrar modelos personalizados Phi-3 con Prompt flow

Este ejemplo de extremo a extremo (E2E) se basa en la guía "[Guía paso a paso: Afinar e integrar modelos Phi-3 personalizados con Prompt Flow](https://techcommunity.microsoft.com/t5/educator-developer-blog/fine-tune-and-integrate-custom-phi-3-models-with-prompt-flow/ba-p/4178612?WT.mc_id=aiml-137032-kinfeylo)" de Microsoft Tech Community. Presenta los procesos de afinamiento, despliegue e integración de modelos Phi-3 personalizados con Prompt flow.

## Descripción general

En este ejemplo E2E, aprenderás cómo afinar el modelo Phi-3 e integrarlo con Prompt flow. Aprovechando Azure Machine Learning y Prompt flow, establecerás un flujo de trabajo para desplegar y utilizar modelos de IA personalizados. Este ejemplo E2E está dividido en tres escenarios:

**Escenario 1: Configurar recursos de Azure y preparar el ajuste fino**
...
![Descripción general de la integración Phi-3 FineTuning y PromptFlow](../../../../../../translated_images/00-01-architecture.02fc569e266d468c.es.png)

### Tabla de contenidos

1. **[Escenario 1: Configurar recursos de Azure y preparar el ajuste fino](../../../../../../md/02.Application/01.TextAndChat/Phi3)**
...
1. **[Escenario 2: Afinar el modelo Phi-3 y desplegarlo en Azure Machine Learning Studio](../../../../../../md/02.Application/01.TextAndChat/Phi3)**
    - [Configurar Azure CLI](../../../../../../md/02.Application/01.TextAndChat/Phi3)
    - [Afinar el modelo Phi-3](../../../../../../md/02.Application/01.TextAndChat/Phi3)
    - [Desplegar el modelo afinado](../../../../../../md/02.Application/01.TextAndChat/Phi3)
...
1. Escribe *azure machine learning* en la **barra de búsqueda** en la parte superior de la página del portal y selecciona **Azure Machine Learning** de las opciones que aparecen.
    ...
    ![Escribe azure machine learning](../../../../../../translated_images/01-01-type-azml.a5116f8454d98c60.es.png)

1. Selecciona **+ Crear** en el menú de navegación.

1. Selecciona **Nuevo espacio de trabajo** en el menú de navegación.

    ![Selecciona nuevo espacio de trabajo](../../../../../../translated_images/01-02-select-new-workspace.83e17436f8898dc4.es.png)

1. Realiza las siguientes tareas:

    - Selecciona tu **suscripción** de Azure.
    - Selecciona el **grupo de recursos** a utilizar (crea uno nuevo si es necesario).
    - Introduce **Nombre del espacio de trabajo**. Debe ser un valor único.
    - Selecciona la **región** que te gustaría utilizar.
    ...
    ![Completa AZML.](../../../../../../translated_images/01-03-fill-AZML.730a5177757bbebb.es.png)
...
>
> Para quienes utilicen suscripciones de beneficios (como Visual Studio Enterprise Subscription) o para quienes deseen probar rápidamente el proceso de ajuste fino y despliegue, este tutorial también ofrece orientación para afinar con un conjunto de datos mínimo usando una CPU. Sin embargo, es importante tener en cuenta que los resultados del ajuste fino son significativamente mejores cuando se utiliza una GPU con conjuntos de datos más grandes.

1. Visita [Azure ML Studio](https://ml.azure.com/home?wt.mc_id=studentamb_279723).

1. Realiza las siguientes tareas para solicitar la cuota *Standard NCADSA100v4 Family*:

    - Selecciona **Quota** en la pestaña lateral izquierda.
    ...
    - Selecciona **Request quota** en el menú de navegación.
        ...
        ![Solicitar cuota.](../../../../../../translated_images/01-04-request-quota.3d3670c3221ab834.es.png)

    - Dentro de la página Request quota, ingresa el **New cores limit** que te gustaría usar. Por ejemplo, 24.
    - Dentro de la página Request quota, selecciona **Submit** para solicitar la cuota de GPU.

> [!NOTE]
> Puedes seleccionar la GPU o CPU apropiada para tus necesidades consultando el documento [Sizes for Virtual Machines in Azure](https://learn.microsoft.com/azure/virtual-machines/sizes/overview?tabs=breakdownseries%2Cgeneralsizelist%2Ccomputesizelist%2Cmemorysizelist%2Cstoragesizelist%2Cgpusizelist%2Cfpgasizelist%2Chpcsizelist).

### Agregar asignación de rol

Para afinar y desplegar tus modelos, primero debes crear una Managed Identity asignada por el usuario (UAI) y asignarle los permisos correspondientes. Esta UAI se utilizará para la autenticación durante el despliegue

#### Crear una Managed Identity asignada por el usuario (UAI)
...
1. Escribe *managed identities* en la **barra de búsqueda** en la parte superior de la página del portal y selecciona **Managed Identities** de las opciones que aparecen.
    ...
    ![Escribe managed identities.](../../../../../../translated_images/01-05-type-managed-identities.9297b6039874eff8.es.png)

1. Selecciona **+ Crear**.

    ![Selecciona crear.](../../../../../../translated_images/01-06-select-create.936d8d66d7144f9a.es.png)
...
#### Agregar asignación de rol Contributor a la Managed Identity

1. Navega al recurso Managed Identity que creaste.

1. Selecciona **Azure role assignments** en la pestaña lateral izquierda.

1. Selecciona **+Add role assignment** en el menú de navegación.

1. Dentro de la página Add role assignment, realiza las siguientes tareas:
    - Selecciona el **Ámbito (Scope)** a **Resource group**.
    - Selecciona tu **suscripción** de Azure.
    - Selecciona el **grupo de recursos** a utilizar.
    - Selecciona el **Rol (Role)** **Contributor**.

    ![Rellena el rol Contributor.](../../../../../../translated_images/01-07-fill-contributor-role.29ca99b7c9f687e0.es.png)

1. Selecciona **Guardar**.

#### Agregar asignación de rol Storage Blob Data Reader a la Managed Identity
...
1. Escribe *storage accounts* en la **barra de búsqueda** en la parte superior de la página del portal y selecciona **Storage accounts** de las opciones que aparecen.
    ...
    ![Escribe storage accounts.](../../../../../../translated_images/01-08-type-storage-accounts.1186c8e42933e49b.es.png)
...
1. Realiza las siguientes tareas para navegar a la página Add role assignment:

    - Navega a la cuenta de Azure Storage que creaste.
    - Selecciona **Access Control (IAM)** en la pestaña lateral izquierda.
    - Selecciona **+ Add** en el menú de navegación.
    - Selecciona **Add role assignment** en el menú de navegación.

    ![Agregar rol.](../../../../../../translated_images/01-09-add-role.d2db22fec1b187f0.es.png)

1. Dentro de la página Add role assignment, realiza las siguientes tareas:

    - Dentro de la página Role, escribe *Storage Blob Data Reader* en la **barra de búsqueda** y selecciona **Storage Blob Data Reader** de las opciones que aparecen.
    - Dentro de la página Role, selecciona **Siguiente (Next)**.
    - Dentro de la página Members, selecciona **Asignar acceso a (Assign access to)** **Managed identity**.
    - Dentro de la página Members, selecciona **+ Select members**.
    - Dentro de la página Select managed identities, selecciona tu **suscripción** de Azure.
    - Dentro de la página Select managed identities, selecciona la **Managed identity** a **Manage Identity**.
    - Dentro de la página Select managed identities, selecciona la Managed Identity que creaste. Por ejemplo, *finetunephi-managedidentity*.
    - Dentro de la página Select managed identities, selecciona **Select**.

    ![Selecciona la managed identity.](../../../../../../translated_images/01-10-select-managed-identity.5ce5ba181f72a4df.es.png)

1. Selecciona **Revisar + asignar**.

#### Agregar asignación de rol AcrPull a la Managed Identity
...
1. Escribe *container registries* en la **barra de búsqueda** en la parte superior de la página del portal y selecciona **Container registries** de las opciones que aparecen.
    ...
    ![Escribe container registries.](../../../../../../translated_images/01-11-type-container-registries.ff3b8bdc49dc596c.es.png)
...
1. Dentro de la página Add role assignment, realiza las siguientes tareas:
    ...
    - Dentro de la página Role, escribe *AcrPull* en la **barra de búsqueda** y selecciona **AcrPull** de las opciones que aparecen.
    - Dentro de la página Role, selecciona **Siguiente (Next)**.
    - Dentro de la página Members, selecciona **Asignar acceso a (Assign access to)** **Managed identity**.
    - Dentro de la página Members, selecciona **+ Select members**.
    - Dentro de la página Select managed identities, selecciona tu **suscripción** de Azure.
...
#### Crear una carpeta para trabajar en ella
...
En este ejercicio, crearás los archivos esenciales para nuestro proyecto. Estos archivos incluyen scripts para descargar el conjunto de datos, configurar el entorno de Azure Machine Learning, ajustar finamente el modelo Phi-3, y desplegar el modelo ajustado. También crearás un archivo *conda.yml* para configurar el entorno de fine-tuning.

En este ejercicio, harás lo siguiente:

- Crea un archivo *download_dataset.py* para descargar el conjunto de datos.
- Crea un archivo *setup_ml.py* para configurar el entorno de Azure Machine Learning.
- Crea un archivo *fine_tune.py* en la carpeta *finetuning_dir* para ajustar finamente el modelo Phi-3 usando el conjunto de datos.
- Crea un archivo *conda.yml* para configurar el entorno de fine-tuning.
- Crea un archivo *deploy_model.py* para desplegar el modelo ajustado.
- Crea un archivo *integrate_with_promptflow.py*, para integrar el modelo ajustado y ejecutar el modelo usando Prompt Flow.
- Crea un archivo flow.dag.yml, para configurar la estructura del flujo de trabajo para Prompt Flow.
- Crea un archivo *config.py* para introducir la información de Azure.
...
1. Selecciona **File** en la barra de menús.
...
1. Agrega el siguiente código en el archivo *conda.yml* para configurar el entorno de fine-tuning para el modelo Phi-3.
...
1. Agrega el siguiente código en el archivo *config.py* para incluir tu información de Azure.
    ...
    # Configuración de Identidad Administrada de Azure
    ...
    # Configuración del modelo afinado
...
1. Realiza las siguientes tareas para agregar el ID de suscripción de Azure:
    ...
    - Copia y pega tu Subscription ID en el archivo *config.py*.
...
1. Realiza las siguientes tareas para agregar el nombre del grupo de recursos de Azure:
    ...
    - Navega al recurso de Azure Machine Learning que creaste.
    - Copia y pega el nombre de tu Azure Resource Group en el archivo *config.py*.

    ![Encontrar nombre del grupo de recursos.](../../../../../../translated_images/01-16-find-AZML-resourcegroup.855a349d0af134a3.es.png)

2. Realiza las siguientes tareas para agregar el nombre de la Managed Identity de Azure

    - Navega al recurso Managed Identities que creaste.
    - Copia y pega el nombre de tu Azure Managed Identity en el archivo *config.py*.

    ![Encontrar UAI.](../../../../../../translated_images/01-17-find-uai.3529464f53499827.es.png)

### Preparar el conjunto de datos para el fine-tuning

En este ejercicio, ejecutarás el archivo *download_dataset.py* para descargar los conjuntos de datos *ULTRACHAT_200k* a tu entorno local. Luego usarás estos conjuntos de datos para ajustar finamente el modelo Phi-3 en Azure Machine Learning.
...
1. Agrega el siguiente código en *download_dataset.py*.
    ...
    def load_and_split_dataset(dataset_name, config_name, split_ratio):
        ...
        """
        # Cargar el conjunto de datos con el nombre, la configuración y la proporción de división especificados
    ...
    def main():
        ...
        """
        # Cargar y dividir el conjunto de datos ULTRACHAT_200k con una configuración y una proporción de división específicas
        dataset = load_and_split_dataset("HuggingFaceH4/ultrachat_200k", 'default', 'train_sft[:1%]')
        
        # Extraer los conjuntos de datos de entrenamiento y prueba desde la división
...
> [!TIP]
>
> **Guía para el fine-tuning con un conjunto de datos mínimo usando CPU**
>
> Si quieres usar una CPU para el fine-tuning, este enfoque es ideal para quienes tienen suscripciones con beneficios (como Visual Studio Enterprise Subscription) o para probar rápidamente el proceso de fine-tuning y despliegue.
>
...
### Ajustar finamente el modelo Phi-3

En este ejercicio, ajustarás finamente el modelo Phi-3 usando el conjunto de datos proporcionado. Primero, definirás el proceso de fine-tuning en el archivo *fine_tune.py*. Luego, configurarás el entorno de Azure Machine Learning e iniciarás el proceso de fine-tuning ejecutando el archivo *setup_ml.py*. Este script garantiza que el fine-tuning ocurra dentro del entorno de Azure Machine Learning.

Al ejecutar *setup_ml.py*, ejecutarás el proceso de fine-tuning en el entorno de Azure Machine Learning.

#### Agrega código al archivo *fine_tune.py*
...
1. Agrega el siguiente código en *fine_tune.py*.
    ...
    # Para evitar el error INVALID_PARAMETER_VALUE en MLflow, desactive la integración de MLflow
...
> [!TIP]
> **Puedes ajustar finamente el modelo Phi-3.5**
>
> En el archivo *fine_tune.py*, puedes cambiar `pretrained_model_name` de `"microsoft/Phi-3-mini-4k-instruct"` a cualquier modelo que desees ajustar. Por ejemplo, si lo cambias a `"microsoft/Phi-3.5-mini-instruct"`, estarás usando el modelo Phi-3.5-mini-instruct para el fine-tuning. Para encontrar y usar el nombre del modelo que prefieras, visita [Hugging Face](https://huggingface.co/), busca el modelo que te interese y luego copia y pega su nombre en el campo `pretrained_model_name` de tu script.
>
> <image type="content" src="../../../../imgs/02/FineTuning-PromptFlow/finetunephi3.5.png" alt-text="Ajuste fino de Phi-3.5.">
>

#### Agrega código al archivo *setup_ml.py*
...
1. Agrega el siguiente código en *setup_ml.py*.
    ...
    # Descomenta las siguientes líneas para usar una instancia CPU para entrenamiento
    # COMPUTE_INSTANCE_TYPE = "Standard_E16s_v3" # CPU
    # COMPUTE_NAME = "cpu-e16s-v3"
    # DOCKER_IMAGE_NAME = "mcr.microsoft.com/azureml/openmpi4.1.0-ubuntu20.04:latest"

    # Descomenta las siguientes líneas para usar una instancia GPU para entrenamiento
    ...
    def create_or_get_environment(ml_client):
        ...
        """
        env = Environment(
            image=DOCKER_IMAGE_NAME,  # Imagen de Docker para el entorno
    ...
    def create_or_get_compute_cluster(ml_client, compute_name, COMPUTE_INSTANCE_TYPE, location):
        ...
        try:
            ...
            compute_cluster = AmlCompute(
                ...
                location=location,
                tier="Dedicated",  # Nivel del clúster de cómputo
    ...
    def create_fine_tuning_job(env, compute_name):
        ...
        return command(
            ...
            compute=compute_name,  # Clúster de cómputo a usar
            inputs={
    ...
    def main():
        ...
        # Crear u obtener el clúster de cómputo existente
        create_or_get_compute_cluster(ml_client, COMPUTE_NAME, COMPUTE_INSTANCE_TYPE, LOCATION)

        # Crear y enviar el trabajo de ajuste fino
...
1. Reemplaza `COMPUTE_INSTANCE_TYPE`, `COMPUTE_NAME`, y `LOCATION` con tus detalles específicos.
    ...
    ```python
   # Descomenta las siguientes líneas para usar una instancia de GPU para el entrenamiento
    COMPUTE_INSTANCE_TYPE = "Standard_NC24ads_A100_v4"
    COMPUTE_NAME = "gpu-nc24s-a100-v4"
    ...
    LOCATION = "eastus2" # Reemplaza con la ubicación de tu clúster de cómputo
...
> **Guía para el fine-tuning con un conjunto de datos mínimo usando CPU**
>
> Si deseas usar una CPU para el fine-tuning, este enfoque es ideal para quienes tienen suscripciones con beneficios (como Visual Studio Enterprise Subscription) o para probar rápidamente el proceso de fine-tuning y despliegue.
>
...
1. Escribe el siguiente comando para ejecutar el script *setup_ml.py* e iniciar el proceso de fine-tuning en Azure Machine Learning.

    ```python
    python setup_ml.py
    ```

1. En este ejercicio, ajustaste finamente con éxito el modelo Phi-3 usando Azure Machine Learning. Al ejecutar el script *setup_ml.py*, configuraste el entorno de Azure Machine Learning e iniciaste el proceso de fine-tuning definido en el archivo *fine_tune.py*. Ten en cuenta que el proceso de fine-tuning puede tardar bastante tiempo. Después de ejecutar el comando `python setup_ml.py`, debes esperar a que el proceso se complete. Puedes monitorear el estado del trabajo de fine-tuning siguiendo el enlace proporcionado en la terminal al portal de Azure Machine Learning.

    ![Ver trabajo de fine-tuning.](../../../../../../translated_images/02-02-see-finetuning-job.59393bc3b143871e.es.png)

### Desplegar el modelo ajustado

Para integrar el modelo Phi-3 ajustado con Prompt Flow, necesitas desplegar el modelo para que sea accesible para inferencias en tiempo real. Este proceso implica registrar el modelo, crear un endpoint en línea y desplegar el modelo.

#### Establece el nombre del modelo, el nombre del endpoint y el nombre del despliegue para el despliegue
...
#### Agrega código al archivo *deploy_model.py*

Ejecutar el archivo *deploy_model.py* automatiza todo el proceso de despliegue. Registra el modelo, crea un endpoint y realiza el despliegue según la configuración especificada en el archivo config.py, que incluye el nombre del modelo, el nombre del endpoint y el nombre del despliegue.
...
1. Agrega el siguiente código en *deploy_model.py*.
    ...
    def set_traffic_to_deployment(ml_client, endpoint_name, deployment_name):
        ...
        try:
            # Obtener los detalles actuales del punto de enlace
            endpoint = ml_client.online_endpoints.get(name=endpoint_name)
            
            # Registrar la asignación de tráfico actual para depuración
            logger.info(f"Current traffic allocation: {endpoint.traffic}")
            
            # Establecer la asignación de tráfico para el despliegue
            endpoint.traffic = {deployment_name: 100}
            
            # Actualizar el punto de enlace con la nueva asignación de tráfico
...
1. Realiza las siguientes tareas para obtener el `JOB_NAME`:
    ...
    - Navega al recurso de Azure Machine Learning que creaste.
    - Selecciona **Studio web URL** para abrir el workspace de Azure Machine Learning.
    - Selecciona **Jobs** en la pestaña del lado izquierdo.
    - Selecciona el experimento de fine-tuning. Por ejemplo, *finetunephi*.
    - Selecciona el job que creaste.
    - Copia y pega el nombre de tu trabajo en la `JOB_NAME = "your-job-name"` en el archivo *deploy_model.py*.
...
#### Verificar el estado de la implementación en el espacio de trabajo de Azure Machine Learning
...
1. Selecciona **Endpoints** en la pestaña del lado izquierdo.
    ...
    ![Selecciona Endpoints.](../../../../../../translated_images/02-03-select-endpoints.c3136326510baff1.es.png)

2. Selecciona el endpoint que creaste.

    ![Selecciona el endpoint que creaste.](../../../../../../translated_images/02-04-select-endpoint-created.0363e7dca51dabb4.es.png)
...
Después de implementar correctamente tu modelo afinado, ahora puedes integrarlo con Prompt flow para usar tu modelo en aplicaciones en tiempo real, permitiendo una variedad de tareas interactivas con tu modelo personalizado Phi-3.

#### Establecer la clave de API y la URI del endpoint del modelo Phi-3 afinado

1. Navega al espacio de trabajo de Azure Machine Learning que creaste.
1. Selecciona **Endpoints** en la pestaña del lado izquierdo.
1. Selecciona el endpoint que creaste.
1. Selecciona **Consume** en el menú de navegación.
1. Copia y pega tu **REST endpoint** en el archivo *config.py*, reemplazando `AZURE_ML_ENDPOINT = "your_fine_tuned_model_endpoint_uri"` por tu **REST endpoint**.
1. Copia y pega tu **Primary key** en el archivo *config.py*, reemplazando `AZURE_ML_API_KEY = "your_fine_tuned_model_api_key"` por tu **Primary key**.

    ![Copia la clave de la API y la URI del endpoint.](../../../../../../translated_images/02-05-copy-apikey-endpoint.88b5a92e6462c53b.es.png)
...
#### Agrega código al archivo *integrate_with_promptflow.py*
...
1. Aquí hay un ejemplo de los resultados: ahora puedes chatear con tu modelo personalizado Phi-3. Se recomienda hacer preguntas basadas en los datos utilizados para el afinamiento.
