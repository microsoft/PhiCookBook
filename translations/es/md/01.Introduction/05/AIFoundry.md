# **Uso de Microsoft Foundry para evaluación**

![aistudo](../../../../../translated_images/es/AIFoundry.9e0b513e999a1c5a.webp)

Cómo evaluar tu aplicación de IA generativa usando [Microsoft Foundry](https://ai.azure.com?WT.mc_id=aiml-138114-kinfeylo). Ya sea que estés evaluando conversaciones de un solo turno o de múltiples turnos, Microsoft Foundry ofrece herramientas para medir el rendimiento y la seguridad del modelo.
...
## Evaluación de modelos de IA generativa en Microsoft Foundry
...
Desde la interfaz de Microsoft Foundry, navega a la página Evaluate o a la página Prompt Flow.  
