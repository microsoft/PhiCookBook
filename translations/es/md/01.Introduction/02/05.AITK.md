...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-07T10:37:53+00:00",
...
[AI Toolkit para VS Code](https://marketplace.visualstudio.com/items?itemName=ms-windows-ai-studio.windows-ai-studio) facilita el desarrollo de aplicaciones de IA generativa al reunir herramientas y modelos de desarrollo de IA de última generación del Azure AI Foundry Catalog y otros catálogos como Hugging Face. Podrás explorar el catálogo de modelos de IA impulsado por GitHub Models y Azure AI Foundry Model Catalogs, descargarlos local o remotamente, ajustarlos, probarlos y usarlos en tu aplicación.

La vista previa de AI Toolkit se ejecutará localmente. La inferencia o ajuste fino local depende del modelo que hayas seleccionado; puede que necesites una GPU como NVIDIA CUDA GPU. También puedes ejecutar GitHub Models directamente con AITK.
...
- Para ajuste fino tanto en Windows como en Linux, necesitarás una GPU Nvidia. Además, **Windows** requiere el subsistema de Linux con la distribución Ubuntu 18.4 o superior. [Aprende más sobre cómo instalar el subsistema de Windows para Linux](https://learn.microsoft.com/windows/wsl/install) y [cómo cambiar la distribución predeterminada](https://learn.microsoft.com/windows/wsl/install#change-the-default-linux-distribution-installed).
...
El [AI Toolkit está disponible en Visual Studio Marketplace](https://marketplace.visualstudio.com/items?itemName=ms-windows-ai-studio.windows-ai-studio) y puede instalarse como cualquier otra extensión de VS Code.
...
Se te pedirá iniciar sesión en GitHub, por favor haz clic en "Permitir" para continuar. Serás redirigido a la página de inicio de sesión de GitHub.

Por favor, inicia sesión y sigue los pasos del proceso. Tras completar exitosamente, serás redirigido a VS Code.

Una vez instalada la extensión, verás que el ícono de AI Toolkit aparece en tu barra de actividades.
...
- Busca un modelo compatible en **Model Catalog** y descárgalo localmente  
- Prueba la inferencia del modelo en el **Model Playground**  
- Ajusta el modelo local o remotamente en **Model Fine-tuning**  
- Despliega modelos ajustados en la nube vía la paleta de comandos de AI Toolkit  
- Evalúa modelos
...
> **GPU vs CPU**
>
> Notarás que las tarjetas de los modelos muestran el tamaño del modelo, la plataforma y el tipo de acelerador (CPU, GPU). Para un rendimiento optimizado en **dispositivos Windows que tengan al menos una GPU**, selecciona versiones de modelos que solo estén dirigidas a Windows.
>
...
Una vez configurados todos los parámetros, haz clic en **Generate Project**.

Cuando tu modelo se haya descargado, selecciona **Load in Playground** en la tarjeta del modelo en el catálogo:

- Inicia la descarga del modelo  
- Instala todos los prerrequisitos y dependencias  
- Crea el espacio de trabajo en VS Code
...
### Uso de la biblioteca cliente OpenAI para Python
...
### Uso de la biblioteca cliente Azure OpenAI para .NET
...
- Comienza con el descubrimiento de modelos y playground.  
- Ajuste fino y inferencia de modelos usando recursos de cómputo locales.  
