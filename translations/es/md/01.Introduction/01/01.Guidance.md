...
Estamos integrando [Guidance](https://github.com/guidance-ai/guidance) en el endpoint serverless Phi-3.5-mini de Microsoft Foundry para hacer que los resultados sean más predecibles mediante la definición de una estructura adaptada a una aplicación. Con Guidance, puedes eliminar costosos reintentos y, por ejemplo, restringir al modelo para que seleccione de listas predefinidas (p. ej., códigos médicos), limitar las salidas a citas textuales del contexto proporcionado o seguir cualquier expresión regular. Guidance guía al modelo token por token en la pila de inferencia, reduciendo el costo y la latencia entre un 30 y 50 %, lo que lo convierte en un complemento único y valioso para el [endpoint serverless Phi-3-mini](https://aka.ms/try-phi3.5mini).
