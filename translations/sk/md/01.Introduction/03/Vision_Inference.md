...
Odporúča sa používať ***CUDA 11.6+*** a nainštalovať flatten

```bash
pip install flash-attn --no-build-isolation
```

Vytvorte nový Notebook. Na dokončenie príkladov je vhodné najskôr vytvoriť nasledujúci obsah.
...
Relevantné odpovede získame spustením nasledujúceho skriptu v Notebooku
