...
[AI Toolkit pre VS Code](https://marketplace.visualstudio.com/items?itemName=ms-windows-ai-studio.windows-ai-studio) zjednodušuje vývoj generatívnych AI aplikácií tým, že spája najmodernejšie nástroje a modely AI z Microsoft Foundry Catalog a ďalších katalógov ako Hugging Face. Budete môcť prehliadať katalóg AI modelov poháňaný GitHub Models a Microsoft Foundry Model Catalogs, sťahovať ich lokálne alebo na diaľku, doladiť, testovať a používať vo svojej aplikácii.
