...
Vytvorenie projektu a hubu v Microsoft Foundry je skvelý spôsob, ako organizovať a spravovať svoju AI prácu. Tu je krok za krokom návod, ako začať:

### Vytvorenie projektu v Microsoft Foundry

1. **Prejdite na Microsoft Foundry**: Prihláste sa do portálu Microsoft Foundry.
2. **Vytvorte projekt**:
   - Ak ste už v nejakom projekte, vyberte v ľavom hornom rohu stránky „Microsoft Foundry“ pre návrat na domovskú stránku.
...
1. **Prejdite na Microsoft Foundry**: Prihláste sa pomocou svojho Azure účtu.
2. **Vytvorte hub**:
...
## **2. Nasadenie modelu Phi v Microsoft Foundry**
...
Prejdite na stránku nasadenia, vyberte Playground a komunikujte s Phi-3 v Microsoft Foundry
