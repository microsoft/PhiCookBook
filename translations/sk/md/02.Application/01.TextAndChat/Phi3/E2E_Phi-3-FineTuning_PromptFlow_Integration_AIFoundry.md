...
![Phi-3-FineTuning_PromptFlow_Integration Overview.](../../../../../../translated_images/00-01-architecture.198ba0f1ae6d841a.sk.png)
...
1. Do **vyhľadávacieho poľa** v hornej časti portálu napíšte *azure machine learning* a zo zobrazených možností vyberte **Azure Machine Learning**.
    ...
    ![Type azure machine learning.](../../../../../../translated_images/01-01-type-azml.acae6c5455e67b4b.sk.png)

2. V navigačnom menu vyberte **+ Create**.

3. V navigačnom menu vyberte **New workspace**.

    ![Select new workspace.](../../../../../../translated_images/01-02-select-new-workspace.cd09cd0ec4a60ef2.sk.png)
...
4. Vykonajte nasledujúce kroky:
    ...
    ![Fill azure machine learning.](../../../../../../translated_images/01-03-fill-AZML.a1b6fd944be0090f.sk.png)
...
1. Vykonajte nasledujúce kroky pre žiadosť kvóty *Standard NCADSA100v4 Family*:
    ...
    - V navigačnom menu vyberte **Request quota**.
        ...
        ![Request quota.](../../../../../../translated_images/02-02-request-quota.c0428239a63ffdd5.sk.png)
...
1. Do **vyhľadávacieho poľa** v hornej časti portálu napíšte *managed identities* a zo zobrazených možností vyberte **Managed Identities**.
    ...
    ![Type managed identities.](../../../../../../translated_images/03-01-type-managed-identities.24de763e0f1f37e5.sk.png)

1. Vyberte **+ Create**.

    ![Select create.](../../../../../../translated_images/03-02-select-create.92bf8989a5cd98f2.sk.png)
...
1. Vykonajte nasledujúce kroky:
    ...
    ![Select create.](../../../../../../translated_images/03-03-fill-managed-identities-1.ef1d6a2261b449e0.sk.png)
...
1. Na stránke Add role assignment vykonajte nasledovné kroky:
    ...
    ![Fill contributor role.](../../../../../../translated_images/03-04-fill-contributor-role.73990bc6a32e140d.sk.png)
...
1. Do **vyhľadávacieho poľa** v hornej časti portálu napíšte *storage accounts* a zo zobrazených možností vyberte **Storage accounts**.
    ...
    ![Type storage accounts.](../../../../../../translated_images/03-05-type-storage-accounts.9303de485e65e1e5.sk.png)
...
1. Vykonajte nasledujúce kroky pre navigáciu na stránku Add role assignment:
    ...
    ![Add role.](../../../../../../translated_images/03-06-add-role.353ccbfdcf0789c2.sk.png)
...
1. Na stránke Add role assignment vykonajte nasledovné kroky:
    ...
    ![Select managed identity.](../../../../../../translated_images/03-08-select-managed-identity.e80a2aad5247eb25.sk.png)
...
1. Do **vyhľadávacieho poľa** v hornej časti portálu napíšte *container registries* a zo zobrazených možností vyberte **Container registries**.
    ...
    ![Type container registries.](../../../../../../translated_images/03-09-type-container-registries.7a4180eb2110e5a6.sk.png)
...
1. Vyberte **+ Nový**.
    ...
    ![Vyberte výpočty.](../../../../../../translated_images/06-01-select-compute.a29cff290b480252.sk.png)
...
1. Vykonajte nasledujúce kroky:
    ...
    ![Vytvorte klaster.](../../../../../../translated_images/06-02-create-cluster.f221b65ae1221d4e.sk.png)
...
1. Vykonajte nasledujúce kroky:
    ...
    ![Vytvorte klaster.](../../../../../../translated_images/06-03-create-cluster.4a54ba20914f3662.sk.png)
...
1. Vyberte **Doladiť** z navigačného menu.
    ...
    ![Vyberte doladenie.](../../../../../../translated_images/06-06-select-fine-tune.2918a59be55dfeec.sk.png)
...
1. Vyberte **Z výstupu úlohy**.
    ...
    ![Registrovať model.](../../../../../../translated_images/07-01-register-model.ad1e7cc05e4b2777.sk.png)
...
1. Uistite sa, že je vybratý **Výstup úlohy**; mal by byť vybraný automaticky.
    ...
    ![Vybrať výstup.](../../../../../../translated_images/07-03-select-output.4cf1a0e645baea1f.sk.png)

2. Vyberte **Ďalej**.

3. Vyberte **Registrovať**.

    ![Vybrať registráciu.](../../../../../../translated_images/07-04-register.fd82a3b293060bc7.sk.png)
...
1. Vyberte **Endpointy v reálnom čase** z navigačného menu.
    ...
    ![Vytvoriť endpoint.](../../../../../../translated_images/07-06-create-endpoint.1ba865c606551f09.sk.png)

1. Vyberte **Vytvoriť**.

1. Vyberte registrovaný model, ktorý ste vytvorili.

    ![Vybrať registrovaný model.](../../../../../../translated_images/07-07-select-registered-model.29c947c37fa30cb4.sk.png)
...
1. Vykonajte nasledujúce kroky:
    ...
    ![Vyplňte nastavenie nasadenia.](../../../../../../translated_images/07-08-deployment-setting.43ddc4209e673784.sk.png)
...
1. Vyberte endpoint, ktorý ste vytvorili.
    ...
    ![Vybrať endpointy](../../../../../../translated_images/07-09-check-deployment.325d18cae8475ef4.sk.png)
...
>
> ![Nastaviť prevádzku.](../../../../../../translated_images/07-10-set-traffic.085b847e5751ff3d.sk.png)
>
...
![Vytvoriť centrum.](../../../../../../translated_images/08-01-create-hub.8f7dd615bb8d9834.sk.png)
...
![Vyplniť centrum.](../../../../../../translated_images/08-02-fill-hub.c2d3b505bbbdba7c.sk.png)
...
![Vybrať nový projekt.](../../../../../../translated_images/08-04-select-new-project.390fadfc9c8f8f12.sk.png)

1. Zadajte **Názov projektu**. Musí to byť jedinečná hodnota.

![Vytvoriť projekt.](../../../../../../translated_images/08-05-create-project.4d97f0372f03375a.sk.png)
...
![Vybrať endpoints.](../../../../../../translated_images/08-06-select-endpoints.aff38d453bcf9605.sk.png)

1. Vyberte endpoint, ktorý ste vytvorili.

![Vybrať endpoint.](../../../../../../translated_images/08-07-select-endpoint-created.47f0dc09df2e275e.sk.png)

1. Vyberte **Consume** z navigačného menu.

1. Skopírujte svoj **REST endpoint** a **Primárny kľúč**.

![Kopírovať api kľúč a endpoint uri.](../../../../../../translated_images/08-08-copy-endpoint-key.18f934b5953ae8cb.sk.png)
...
![Vybrať nové pripojenie.](../../../../../../translated_images/08-09-select-new-connection.02eb45deadc401fc.sk.png)

1. Vyberte **Vlastné kľúče** z navigačného menu.

![Vybrať vlastné kľúče.](../../../../../../translated_images/08-10-select-custom-keys.856f6b2966460551.sk.png)
...
![Pridať pripojenie.](../../../../../../translated_images/08-11-add-connection.785486badb4d2d26.sk.png)
...
![Vybrať Promptflow.](../../../../../../translated_images/08-12-select-promptflow.6f4b451cb9821e5b.sk.png)

1. Vyberte **Chat flow** z navigačného menu.

![Vybrať chat flow.](../../../../../../translated_images/08-13-select-flow-type.2ec689b22da32591.sk.png)

1. Zadajte **Názov priečinka**, ktorý chcete použiť.

![Zadať názov.](../../../../../../translated_images/08-14-enter-name.ff9520fefd89f40d.sk.png)
...
![Vybrať režim surového súboru.](../../../../../../translated_images/08-15-select-raw-file-mode.61d988b41df28985.sk.png)
...
![Vložiť kód Prompt flow.](../../../../../../translated_images/08-16-paste-promptflow-code.a6041b74a7d09777.sk.png)
...
![Vstup Výstup.](../../../../../../translated_images/08-17-select-input-output.64dbb39bbe59d03b.sk.png)
...
>
> ![Príklad toku.](../../../../../../translated_images/08-18-graph-example.d6457533952e690c.sk.png)
>
...
![Spustiť výpočtovú reláciu.](../../../../../../translated_images/09-01-start-compute-session.a86fcf5be68e386b.sk.png)

1. Vyberte **Overiť a analyzovať vstup** na obnovenie parametrov.

![Overiť vstup.](../../../../../../translated_images/09-02-validate-input.317c76ef766361e9.sk.png)

1. Vyberte **Hodnotu** **connection** vo vlastnom pripojení, ktoré ste vytvorili. Napríklad *connection*.

![Pripojenie.](../../../../../../translated_images/09-03-select-connection.99bdddb4b1844023.sk.png)

#### Chatovať s vlastným modelom

1. Vyberte **Chat**.

![Vybrať chat.](../../../../../../translated_images/09-04-select-chat.61936dce6612a1e6.sk.png)
...
![Chatovať s prompt flow.](../../../../../../translated_images/09-05-chat-with-promptflow.c8ca404c07ab126f.sk.png)
