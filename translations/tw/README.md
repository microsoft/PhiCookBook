...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-12T13:26:04+00:00",
  "source_file": "README.md",
  "language_code": "tw"
}
-->
# Phi 食譜：使用 Microsoft Phi 模型的實作範例
...
[法文](../fr/README.md) | [西班牙文](../es/README.md) | [德文](../de/README.md) | [俄文](../ru/README.md) | [阿拉伯文](../ar/README.md) | [波斯文（法爾西）](../fa/README.md) | [烏爾都文](../ur/README.md) | [中文（簡體）](../zh/README.md) | [中文（繁體，澳門）](../mo/README.md) | [中文（繁體，香港）](../hk/README.md) | [中文（繁體，台灣）](./README.md) | [日文](../ja/README.md) | [韓文](../ko/README.md) | [印地文](../hi/README.md)  
...
- Azure AI 推理 SDK 程式碼範例
  ...
  - Phi-3 / 3.5 範例
    - [建立自己的 Visual Studio Code GitHub Copilot 聊天功能，使用 Microsoft Phi-3 系列](./md/02.Application/02.Code/Phi3/VSCodeExt/README.md)
...
- 音頻範例
  - Phi-4 範例 🆕
    ...
    - [.NET 控制台應用程式使用 Phi-4-multimodal 分析音頻檔案並生成文字稿](../../md/04.HOL/dotnet/src/LabsPhi4-MultiModal-02Audio)
...
您可以學習如何使用 Microsoft Phi，並在不同的硬體設備上構建端到端解決方案。要親自體驗 Phi，請先試用模型並根據您的場景自訂 Phi，使用 [Azure AI Foundry Azure AI Model Catalog](https://aka.ms/phi3-azure-ai)。您可以在[Azure AI Foundry 快速入門](/md/02.QuickStart/AzureAIFoundry_QuickStart.md)中了解更多資訊。  
...
您可以學習如何使用 Microsoft Phi，並在不同的硬體設備上構建端到端解決方案。要親自體驗 Phi，請先試用模型並根據您的場景自訂 Phi，使用 [GitHub Model Catalog](https://github.com/marketplace/models?WT.mc_id=aiml-137032-kinfeylo)。您可以在[GitHub Model Catalog 快速入門](/md/02.QuickStart/GitHubModel_QuickStart.md)中了解更多資訊。  
...
Microsoft 致力於幫助客戶負責任地使用我們的 AI 產品，分享我們的經驗，並通過透明度說明和影響評估等工具建立基於信任的合作夥伴關係。許多這些資源可以在 [https://aka.ms/RAI](https://aka.ms/RAI) 找到。  
Microsoft 的負責任 AI 方法基於我們的 AI 原則，包括公平性、可靠性與安全性、隱私與安全性、包容性、透明度和問責性。  

大規模自然語言、圖像和語音模型（例如本範例中使用的模型）可能會以不公平、不可靠或冒犯的方式運作，從而造成傷害。請參閱 [Azure OpenAI 服務透明度說明](https://learn.microsoft.com/legal/cognitive-services/openai/transparency-note?tabs=text)，了解相關風險和限制。  

減輕這些風險的建議方法是在您的架構中包含一個安全系統，該系統可以檢測並防止有害行為。[Azure AI Content Safety](https://learn.microsoft.com/azure/ai-services/content-safety/overview) 提供了一個獨立的保護層，能夠檢測應用程式和服務中的有害用戶生成內容和 AI 生成內容。Azure AI Content Safety 包括文本和圖像 API，允許您檢測有害材料。在 Azure AI Foundry 中，Content Safety 服務允許您查看、探索並試用檢測不同模態有害內容的範例程式碼。以下[快速入門文檔](https://learn.microsoft.com/azure/ai-services/content-safety/quickstart-text?tabs=visual-studio%2Clinux&pivots=programming-language-rest)將指導您向服務發送請求。  

另一個需要考慮的方面是整體應用程式性能。對於多模態和多模型應用程式，我們認為性能意味著系統按您和您的用戶期望的方式運作，包括不生成有害輸出。重要的是使用[性能與質量以及風險與安全評估工具](https://learn.microsoft.com/azure/ai-studio/concepts/evaluation-metrics-built-in)來評估整體應用程式的性能。您還可以使用[自訂評估工具](https://learn.microsoft.com/azure/ai-studio/how-to/develop/evaluate-sdk#custom-evaluators)進行創建和評估。  

您可以在開發環境中使用 [Azure AI Evaluation SDK](https://microsoft.github.io/promptflow/index.html) 評估您的 AI 應用程式。給定測試數據集或目標，您的生成式 AI 應用程式生成的內容可以通過內建評估工具或您選擇的自訂評估工具進行定量測量。要開始使用 Azure AI Evaluation SDK 評估您的系統，您可以遵循[快速入門指南](https://learn.microsoft.com/azure/ai-studio/how-to/develop/flow-evaluate-sdk)。執行評估後，您可以[在 Azure AI Foundry 中可視化結果](https://learn.microsoft.com/azure/ai-studio/how-to/evaluate-flow-results)。  
