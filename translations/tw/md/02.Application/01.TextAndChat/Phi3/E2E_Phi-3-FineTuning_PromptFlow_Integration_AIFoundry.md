...
1. 選擇您建立的 *finetune-phi* 資料夾，位於 *C:\Users\yourUserName\finetune-phi*。
    ...
    ![選擇您建立的資料夾。](../../../../../../translated_images/04-01-open-project-folder.f734374bcfd5f9e6.tw.png)

1. 在 Visual Studio Code 左側窗格中，右鍵點擊並選擇 **New File**，建立名為 *download_dataset.py* 的新檔案。

    ![建立新的檔案。](../../../../../../translated_images/04-02-create-new-file.cf9a330a3a9cff92.tw.png)
...
1. 選取您建立的 Azure Machine Learning 工作區。
    ...
    ![選取您建立的工作區。](../../../../../../translated_images/06-04-select-workspace.a92934ac04f4f181.tw.png)
...
4. 您可透過左側標籤的 **Models** 選單查看註冊的模型。
    ...
    ![已註冊模型。](../../../../../../translated_images/07-05-registered-model.7db9775f58dfd591.tw.png)
...
1. 選擇您先前註冊的模型。
    ...
    ![選擇已註冊模型。](../../../../../../translated_images/07-07-select-registered-model.29c947c37fa30cb4.tw.png)
...
1. 從導覽選單點選 **+ New hub**。
    ![建立集線器。](../../../../../../translated_images/08-01-create-hub.8f7dd615bb8d9834.tw.png)
...
1. 執行以下任務：
    ...
    ![填寫集線器。](../../../../../../translated_images/08-02-fill-hub.c2d3b505bbbdba7c.tw.png)
...
1. 從導覽選單中選擇 **+ 新增專案**。
    ...
    ![選擇新專案。](../../../../../../translated_images/08-04-select-new-project.390fadfc9c8f8f12.tw.png)

1. 輸入 **專案名稱**。它必須是唯一值。

    ![建立專案。](../../../../../../translated_images/08-05-create-project.4d97f0372f03375a.tw.png)
...
1. 從左側標籤中選擇 **端點**。
    ...
    ![選擇端點。](../../../../../../translated_images/08-06-select-endpoints.aff38d453bcf9605.tw.png)

1. 選擇您建立的端點。

    ![選擇已建立的端點。](../../../../../../translated_images/08-07-select-endpoint-created.47f0dc09df2e275e.tw.png)

1. 從導覽選單中選擇 **使用**。

1. 複製您的 **REST 端點** 和 **主要金鑰**。

    ![複製 api 金鑰和端點 uri。](../../../../../../translated_images/08-08-copy-endpoint-key.18f934b5953ae8cb.tw.png)
...
1. 選擇 **+ 新增連接**。
    ...
    ![選擇新增連接。](../../../../../../translated_images/08-09-select-new-connection.02eb45deadc401fc.tw.png)

1. 從導覽選單選擇 **自訂金鑰**。

    ![選擇自訂金鑰。](../../../../../../translated_images/08-10-select-custom-keys.856f6b2966460551.tw.png)
...
1. 執行以下任務：
    ...
    ![新增連接。](../../../../../../translated_images/08-11-add-connection.785486badb4d2d26.tw.png)
...
1. 從導覽選單中選擇 **+ 建立**。
    ...
    ![選擇 Promptflow。](../../../../../../translated_images/08-12-select-promptflow.6f4b451cb9821e5b.tw.png)

1. 從導覽選單中選擇 **聊天流程**。

    ![選擇聊天流程。](../../../../../../translated_images/08-13-select-flow-type.2ec689b22da32591.tw.png)

1. 輸入要使用的 **資料夾名稱**。

    ![輸入名稱。](../../../../../../translated_images/08-14-enter-name.ff9520fefd89f40d.tw.png)
...
1. 在 Prompt flow 中，執行以下任務以重建現有流程：
    ...
    ![選擇原始檔模式。](../../../../../../translated_images/08-15-select-raw-file-mode.61d988b41df28985.tw.png)
...
1. 將以下程式碼新增到 *integrate_with_promptflow.py* 檔案中，以便在 Prompt flow 中使用自訂 Phi-3 模型。
    ...
    ![貼上 prompt flow 程式碼。](../../../../../../translated_images/08-16-paste-promptflow-code.a6041b74a7d09777.tw.png)
...
1. 選擇 **聊天輸入**、**聊天輸出** 以啟用與您的模型聊天。
    ...
    ![輸入 輸出。](../../../../../../translated_images/08-17-select-input-output.64dbb39bbe59d03b.tw.png)
...
> 重建後的流程應該如下圖所示：
>
> ![流程範例。](../../../../../../translated_images/08-18-graph-example.d6457533952e690c.tw.png)
>
...
1. 選擇 **啟動計算階段** 以啟動 Prompt flow。
    ...
    ![啟動計算階段。](../../../../../../translated_images/09-01-start-compute-session.a86fcf5be68e386b.tw.png)

1. 選擇 **驗證並解析輸入** 以更新參數。

    ![驗證輸入。](../../../../../../translated_images/09-02-validate-input.317c76ef766361e9.tw.png)

1. 選擇 **連接** 的 **值** 為您建立的自訂連接，例如 *connection*。

    ![連接。](../../../../../../translated_images/09-03-select-connection.99bdddb4b1844023.tw.png)

#### 與您的自訂模型聊天

1. 選擇 **聊天**。

    ![選擇聊天。](../../../../../../translated_images/09-04-select-chat.61936dce6612a1e6.tw.png)

1. 以下是結果範例：您現在可以與您的自訂 Phi-3 模型聊天。建議根據用於微調的資料進行提問。

    ![與 prompt flow 聊天。](../../../../../../translated_images/09-05-chat-with-promptflow.c8ca404c07ab126f.tw.png)
