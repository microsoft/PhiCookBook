...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-17T04:43:57+00:00",
...
Phi-4-mini 延續了 Phi 家族強大的程式編寫能力。你可以使用 Prompt 來詢問與程式相關的問題。當然，加入了強大的推理能力後，它的程式編寫能力更強，例如能根據需求生成專案。舉例來說，可以根據需求生成專案，例如：
