...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-17T05:32:42+00:00",
...
![GitHubModel](../../../../translated_images/zh-TW/GitHub_ModelCatalog.aa43c51c36454747.webp)
...
![Getting Started](../../../../translated_images/zh-TW/GitHub_ModelGetStarted.150220a802da6fb6.webp)
...
為了更好的使用者體驗，你會想串流模型的回應，讓第一個 token 盡早出現，避免等待過久。
...
![Model Catalog](../../../../translated_images/zh-TW/GitHub_Model.ca6c125cb3117d0e.webp)

[試用環境與免費 API 使用的速率限制](https://docs.github.com/en/github-models/prototyping-with-ai-models#rate-limits) 是為了幫助你實驗模型並快速開發 AI 應用。若超出這些限制，並想將應用擴展到生產環境，必須從 Azure 帳戶配置資源，並從那裡進行驗證，而非使用 GitHub 個人存取權杖。你不需要更改程式碼的其他部分。請使用此連結了解如何突破 Azure AI 的免費層限制。
