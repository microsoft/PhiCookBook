...
![AIFoundry Models](../../../../translated_images/tw/AIFoundryModels.0e1b16f7d0b09b73.png)
...
![Finetune AI Foundry](../../../../translated_images/tw/AIFoundryfinetune.193aaddce48d553c.png)
...
2. 選擇 **+New project** 以在 Azure AI Foundry 建立新專案。
    ...
    ![FineTuneSelect](../../../../translated_images/tw/select-new-project.cd31c0404088d7a3.png)
...
3. 執行以下操作：
    ...
    ![FineTuneSelect](../../../../translated_images/tw/create-project.ca3b71298b90e420.png)
...
4. 建立新 hub 時，請執行以下操作：
    ...
    ![FineTuneSelect](../../../../translated_images/tw/create-hub.49e53d235e80779e.png)
...
2. 在 **搜尋欄** 輸入 *phi-3*，並選擇你想使用的 phi-3 模型。
    ...
    ![FineTuneSelect](../../../../translated_images/tw/select-model.60ef2d4a6a3cec57.png)

3. 選擇 **Fine-tune**。

    ![FineTuneSelect](../../../../translated_images/tw/select-finetune.a976213b543dd9d8.png)

4. 輸入 **Fine-tuned model name**。

    ![FineTuneSelect](../../../../translated_images/tw/finetune1.c2b39463f0d34148.png)
...
6. 執行以下操作：
    ...
    ![FineTuneSelect](../../../../translated_images/tw/finetune2.43cb099b1a94442d.png)

7. 選擇 **Next**。

8. 上傳你想使用的 **Validation data**，或選擇 **Automatic split of training data**。

    ![FineTuneSelect](../../../../translated_images/tw/finetune3.fd96121b67dcdd92.png)
...
10. 執行以下操作：
    ...
    ![FineTuneSelect](../../../../translated_images/tw/finetune4.e18b80ffccb5834a.png)

11. 選擇 **Submit** 開始微調流程。

    ![FineTuneSelect](../../../../translated_images/tw/select-submit.0a3802d581bac271.png)
...
12. 微調完成後，狀態會顯示為 **Completed**，如下圖所示。你現在可以部署模型，並在自己的應用程式、遊樂場或提示流程中使用。更多資訊請參考 [如何使用 Azure AI Foundry 部署 Phi-3 系列小型語言模型](https://learn.microsoft.com/azure/ai-studio/how-to/deploy-models-phi-3?tabs=phi-3-5&pivots=programming-language-python)。
    ...
    ![FineTuneSelect](../../../../translated_images/tw/completed.4dc8d2357144cdef.png)
