...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-16T15:48:37+00:00",
...
![Olive 流程圖](../../../../../translated_images/olive-flow.a47985655a756dcba73521511ea42eef359509a3a33cbd4b9ac04ba433287b80.tw.png)
...
- **內建 40 多種模型優化元件**，涵蓋量化、壓縮、圖形優化和微調的前沿技術。
...
3. **訓練模型：** 接著，使用 `olive finetune` 指令微調量化後的模型。先量化再微調比起先微調後量化能獲得更佳準確度，因為微調過程會彌補部分量化造成的損失。
...
若要查詢你的資源群組 `"resourceGroup"` 與 Azure AI 專案名稱，請執行以下指令：
