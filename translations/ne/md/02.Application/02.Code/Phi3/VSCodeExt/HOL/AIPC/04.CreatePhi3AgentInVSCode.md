...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-09T19:31:02+00:00",
  "source_file": "md/02.Application/02.Code/Phi3/VSCodeExt/HOL/AIPC/04.CreatePhi3AgentInVSCode.md",
  "language_code": "ne"
}
-->
# **Lab 3 - GitHub Copilot Chat मा @PHI3 एजेन्ट बनाउनुहोस्**

Visual Studio Code Copilot Chat मा, तपाईंले @workspace मार्फत सम्पूर्ण प्रोजेक्ट व्यवस्थापन गर्न सक्नुहुन्छ। एंटरप्राइज प्रयोगका लागि, हामी Copilot Chat को Agent लाई अझ लचिलो तरिकाले अनुकूलित गर्न सक्छौं।

अघिल्लो Lab मा, हामीले NPU र क्लाउडलाई मिलाएर Phi3 Agent को लागि Visual Studio Code Extension पूरा गरेका थियौं।

![agent](../../../../../../../../../translated_images/vscode_agent.409cc20073ede69c5bd4db0d611aff68cf40ed88d8c334a899a341c6ba82f013.ne.png)

### **1. VSCode विकास एक्सटेन्सन बनाउनुहोस्**

कृपया यो लिंक [https://code.visualstudio.com/api/get-started/your-first-extension](https://code.visualstudio.com/api/get-started/your-first-extension) लाई हेरेर Extension प्रोजेक्ट बनाउनुहोस्।

***NOTE:*** कृपया यस प्रोजेक्टका लागि Typescript र WebPack प्राविधिक समाधानको रूपमा प्रयोग गर्नुहोस्।

### **2. vscode.d.ts थप्नुहोस्**

Visual Studio Code Chat API अझै कोड API मा मर्ज भएको छैन, तर अब एक्सटेन्सनहरू मार्फत थपिएको छ।
...
टर्मिनलमा **npm install** चलाएर आफ्नो एक्सटेन्सन डिबग गरी परीक्षण गर्न सक्नुहुन्छ।

***Download Sample Code*** [यहाँ क्लिक गर्नुहोस्](../../../../../../../../../code/07.Lab/01/AIPC)
...
बधाई छ! तपाईंले सबै Labs पूरा गर्नुभयो। आशा छ यसले तपाईंलाई Phi-3 परिवार र GitHub Copilot Chat कसरी प्रयोग गर्ने बुझ्न मद्दत पुर्‍याउँछ।
...
तपाईं ***@PHI3 /img*** पनि प्रयास गर्न सक्नुहुन्छ।
