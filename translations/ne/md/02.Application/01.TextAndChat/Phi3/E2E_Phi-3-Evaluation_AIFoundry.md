...
![Architecture of tutorial.](../../../../../../translated_images/ne/architecture.10bec55250f5d6a4.png)
...
![Safaty evaluation.](../../../../../../translated_images/ne/safety-evaluation.083586ec88dfa950.png)
...
![Fill hub.](../../../../../../translated_images/ne/responsibleai2.c07ef430113fad8c.png)
...
![Evaluate based on safety.](../../../../../../translated_images/ne/evaluate-based-on-safety.c5df819f5b0bfc07.png)
...
![Safaty evaluation.](../../../../../../translated_images/ne/performance-evaluation.48b3e7e01a098740.png)
...
![Evaluate based on performance.](../../../../../../translated_images/ne/evaluate-based-on-performance.3e801c647c7554e8.png)
...
1. नेभिगेसन मेनुबाट **+ New hub** चयन गर्नुहोस्।
    ...
    ![Create hub.](../../../../../../translated_images/ne/create-hub.5be78fb1e21ffbf1.png)
...
1. तलका कार्यहरू गर्नुहोस्:
    ...
    ![Fill hub.](../../../../../../translated_images/ne/fill-hub.baaa108495c71e34.png)
...
1. नेभिगेसन मेनुबाट **+ New project** चयन गर्नुहोस्।
    ...
    ![Select new project.](../../../../../../translated_images/ne/select-new-project.cd31c0404088d7a3.png)

1. **Project name** प्रविष्ट गर्नुहोस्। यो अनौठो मान हुनुपर्छ।

    ![Create project.](../../../../../../translated_images/ne/create-project.ca3b71298b90e420.png)
...
1. बाँया पट्टि रहेको ट्याबबाट **Endpoints** चयन गर्नुहोस्।
    ...
    ![Select endpoints.](../../../../../../translated_images/ne/select-endpoints.ee7387ecd68bd18d.png)

1. तपाईंले सिर्जना गरेको endpoint चयन गर्नुहोस्।

    ![Select endpoints.](../../../../../../translated_images/ne/select-endpoint-created.9f63af5e4cf98b2e.png)

1. नेभिगेसन मेनुबाट **Consume** चयन गर्नुहोस्।

1. आफ्नो **REST endpoint** र **Primary key** कपी गर्नुहोस्।

    ![Copy api key and endpoint uri.](../../../../../../translated_images/ne/copy-endpoint-key.0650c3786bd646ab.png)
...
1. **+ New connection** चयन गर्नुहोस्।
    ...
    ![Select new connection.](../../../../../../translated_images/ne/select-new-connection.fa0f35743758a74b.png)

1. नेभिगेसन मेनुबाट **Custom keys** चयन गर्नुहोस्।

    ![Select custom keys.](../../../../../../translated_images/ne/select-custom-keys.5a3c6b25580a9b67.png)
...
1. तलका कार्यहरू गर्नुहोस्:
    ...
    ![Add connection.](../../../../../../translated_images/ne/add-connection.ac7f5faf8b10b0df.png)
...
1. नेभिगेसन मेनुबाट **+ Create** चयन गर्नुहोस्।
    ...
    ![Select Promptflow.](../../../../../../translated_images/ne/select-promptflow.18ff2e61ab9173eb.png)

1. नेभिगेसन मेनुबाट **Chat flow** चयन गर्नुहोस्।

    ![Select chat flow.](../../../../../../translated_images/ne/select-flow-type.28375125ec9996d3.png)

1. प्रयोग गर्न चाहेको **Folder name** प्रविष्ट गर्नुहोस्।

    ![Select chat flow.](../../../../../../translated_images/ne/enter-name.02ddf8fb840ad430.png)
...
1. Prompt flow भित्र, पुरानो flow पुनर्निर्माण गर्न तलका कार्यहरू गर्नुहोस्:
    ...
    ![Select raw file mode.](../../../../../../translated_images/ne/select-raw-file-mode.06c1eca581ce4f53.png)
...
1. Prompt flow मा कस्टम Phi-3 / Phi-3.5 मोडेल प्रयोग गर्न *integrate_with_promptflow.py* मा तलको कोड थप्नुहोस्।
    ...
    ![Paste prompt flow code.](../../../../../../translated_images/ne/paste-promptflow-code.cd6d95b101c0ec28.png)
...
1. **Chat input**, **Chat output** चयन गरेर आफ्नो मोडेलसँग कुराकानी सक्षम गर्नुहोस्।
    ...
    ![Select Input Output.](../../../../../../translated_images/ne/select-input-output.c187fc58f25fbfc3.png)
...
>
> ![Flow example](../../../../../../translated_images/ne/graph-example.82fd1bcdd3fc545b.png)
>
...
1. Prompt flow सुरु गर्न **Start compute sessions** चयन गर्नुहोस्।
    ...
    ![Start compute session.](../../../../../../translated_images/ne/start-compute-session.9acd8cbbd2c43df1.png)

1. प्यारामिटरहरू नवीकरण गर्न **Validate and parse input** चयन गर्नुहोस्।

    ![Validate input.](../../../../../../translated_images/ne/validate-input.c1adb9543c6495be.png)

1. तपाईंले सिर्जना गरेको कस्टम कनेक्शनको **connection** मान चयन गर्नुहोस्। उदाहरणका लागि, *connection*।

    ![Connection.](../../../../../../translated_images/ne/select-connection.1f2b59222bcaafef.png)

#### आफ्नो कस्टम Phi-3 / Phi-3.5 मोडेलसँग कुराकानी गर्नुहोस्

1. **Chat** चयन गर्नुहोस्।

    ![Select chat.](../../../../../../translated_images/ne/select-chat.0406bd9687d0c49d.png)
...
1. यहाँ परिणामको उदाहरण छ: अब तपाईं आफ्नो कस्टम Phi-3 / Phi-3.5 मोडेलसँग कुराकानी गर्न सक्नुहुन्छ। फाइन-ट्युनिङका लागि प्रयोग गरिएको डाटामा आधारित प्रश्न सोध्न सिफारिस गरिन्छ।
    ...
    ![Chat with prompt flow.](../../../../../../translated_images/ne/chat-with-promptflow.1cf8cea112359ada.png)
...
1. तपाईंले सिर्जना गरेको Azure AI Foundry प्रोजेक्टमा जानुहोस्।
    ...
    ![Select Project.](../../../../../../translated_images/ne/select-project-created.5221e0e403e2c9d6.png)
...
1. **Deploy base model** चयन गर्नुहोस्।
    ...
    ![Select Deployments.](../../../../../../translated_images/ne/deploy-openai-model.95d812346b25834b.png)

1. प्रयोग गर्न चाहेको Azure OpenAI मोडेल चयन गर्नुहोस्। उदाहरणका लागि, **gpt-4o**।

    ![Select Azure OpenAI model you'd like to use.](../../../../../../translated_images/ne/select-openai-model.959496d7e311546d.png)
...
1. नेभिगेसन मेनुबाट **+ New evaluation** चयन गर्नुहोस्।
    ...
    ![Select evaluation.](../../../../../../translated_images/ne/select-evaluation.2846ad7aaaca7f4f.png)

1. **Prompt flow** मूल्याङ्कन चयन गर्नुहोस्।

    ![Select Prompt flow evaluation.](../../../../../../translated_images/ne/promptflow-evaluation.cb9758cc19b4760f.png)
...
1. तलका कार्यहरू गर्नुहोस्:
    ...
    ![Prompt flow evaluation.](../../../../../../translated_images/ne/evaluation-setting1.4aa08259ff7a536e.png)
...
1. तलका कार्यहरू गर्नुहोस्:
    ...
    ![Prompt flow evaluation.](../../../../../../translated_images/ne/evaluation-setting2.07036831ba58d64e.png)
...
1. प्रदर्शन र गुणस्तर मेट्रिक्स कन्फिगर गर्न तलका कार्यहरू गर्नुहोस्:
    ...
    ![Prompt flow evaluation.](../../../../../../translated_images/ne/evaluation-setting3-1.d1ae69e3bf80914e.png)
...
1. जोखिम र सुरक्षा मेट्रिक्स कन्फिगर गर्न तलका कार्यहरू गर्नुहोस्:
    ...
    ![Prompt flow evaluation.](../../../../../../translated_images/ne/evaluation-setting3-2.d53bd075c60a45a2.png)
...
1. प्रदर्शन र गुणस्तर मेट्रिक्स:
    ...
    ![Evaluation result.](../../../../../../translated_images/ne/evaluation-result-gpu.85f48b42dfb74254.png)
...
1. जोखिम र सुरक्षा मेट्रिक्स:
    ...
    ![Evaluation result.](../../../../../../translated_images/ne/evaluation-result-gpu-2.1b74e336118f4fd0.png)

1. तपाईं तल स्क्रोल गरेर **विस्तृत मेट्रिक्स परिणाम** हेर्न सक्नुहुन्छ।

    ![Evaluation result.](../../../../../../translated_images/ne/detailed-metrics-result.afa2f5c39a4f5f17.png)
...
![Architecture.](../../../../../../translated_images/ne/architecture.10bec55250f5d6a4.png)
