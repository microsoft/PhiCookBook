...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-09T18:14:45+00:00",
...
तपाईं Phi लाई क्लाउड वा एज उपकरणहरूमा तैनाथ गर्न सक्नुहुन्छ, र सीमित कम्प्युटिङ शक्ति भएको अवस्थामा पनि सजिलैसँग जेनेरेटिभ AI अनुप्रयोगहरू बनाउन सक्नुहुन्छ।
...
- [Phi परिवारको क्वान्टिफाइङ](./md/01.Introduction/04/QuantifyingPhi.md)  
  ...
  - [onnxruntime का लागि जेनेरेटिभ AI एक्सटेन्सनहरू प्रयोग गरी Phi-3.5 / 4 को क्वान्टाइजिङ](./md/01.Introduction/04/UsingORTGenAIQuantifyingPhi.md)  
...
- Phi अनुप्रयोग विकास नमूनाहरू  
  - पाठ र च्याट अनुप्रयोगहरू  
    ...
    - Phi-3 / 3.5 नमूनाहरू  
      ...
      - [MLFlow - Phi-3 सँग र्यापर बनाउने र MLFlow प्रयोग गर्ने](./md//02.Application/01.TextAndChat/Phi3/E2E_Phi-3-MLflow.md)  
      - [मोडेल अनुकूलन - ONNX Runtime Web का लागि Phi-3-min मोडेल कसरी अनुकूलन गर्ने Olive प्रयोग गरी](https://github.com/microsoft/Olive/tree/main/examples/phi3)  
      - [Phi-3 mini-4k-instruct-onnx सँग WinUI3 एप्लिकेसन](https://github.com/microsoft/Phi3-Chat-WinUI3-Sample/)  
      - [WinUI3 बहु मोडेल AI संचालित नोट्स एप्लिकेसन नमूना](https://github.com/microsoft/ai-powered-notes-winui3-sample)
- [Prompt flow सँग कस्टम Phi-3 मोडेलहरूलाई फाइन-ट्यून र एकीकृत गर्ने](./md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-FineTuning_PromptFlow_Integration.md)
- [Azure AI Foundry मा Prompt flow सँग कस्टम Phi-3 मोडेलहरूलाई फाइन-ट्यून र एकीकृत गर्ने](./md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-FineTuning_PromptFlow_Integration_AIFoundry.md)
- [Microsoft को जिम्मेवार AI सिद्धान्तहरूमा केन्द्रित भएर Azure AI Foundry मा फाइन-ट्यून गरिएको Phi-3 / Phi-3.5 मोडेलको मूल्याङ्कन गर्ने](./md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-Evaluation_AIFoundry.md)
...
- [Windows GPU प्रयोग गरेर Phi-3.5-Instruct ONNX सँग Prompt flow समाधान बनाउने](./md/02.Application/01.TextAndChat/Phi3/UsingPromptFlowWithONNX.md)
...
- [Microsoft.ML.OnnxRuntime प्रयोग गरेर स्थानीय ONNX Phi-3 मोडेलसँग Q&A .NET उदाहरण](../../md/04.HOL/dotnet/src/LabsPhi301)
...
- Azure AI Inference SDK कोड आधारित नमूनाहरू  
  - Phi-4 नमूनाहरू 🆕  
    - [📓] [Phi-4-multimodal प्रयोग गरेर प्रोजेक्ट कोड उत्पन्न गर्ने](./md/02.Application/02.Code/Phi4/GenProjectCode/README.md)  
  - Phi-3 / 3.5 नमूनाहरू  
    ...
    - [GitHub मोडेलहरूसँग Phi-3.5 प्रयोग गरेर आफ्नो Visual Studio Code Chat Copilot Agent बनाउने](/md/02.Application/02.Code/Phi3/CreateVSCodeChatAgentWithGitHubModels.md)  
...
- उन्नत तर्क नमूनाहरू  
  - Phi-4 नमूनाहरू 🆕  
    ...
    - [📓] [Microsoft Olive सँग Phi-4-mini-reasoning को फाइन-ट्यूनिङ](../../md/02.Application/03.AdvancedReasoning/Phi4/AdvancedResoningPhi4mini/olive_ft_phi_4_reasoning_with_medicaldata.ipynb)  
    - [📓] [Apple MLX सँग Phi-4-mini-reasoning को फाइन-ट्यूनिङ](../../md/02.Application/03.AdvancedReasoning/Phi4/AdvancedResoningPhi4mini/mlx_ft_phi_4_reasoning_with_medicaldata.ipynb)  
...
- भिजन नमूनाहरू  
  - Phi-4 नमूनाहरू 🆕  
    - [📓] [Phi-4-multimodal प्रयोग गरेर तस्बिरहरू पढ्ने र कोड उत्पन्न गर्ने](./md/02.Application/04.Vision/Phi4/CreateFrontend/README.md)  
  - Phi-3 / 3.5 नमूनाहरू  
    - [📓][Phi-3-vision-तस्बिर टेक्स्टबाट टेक्स्टमा](../../md/02.Application/04.Vision/Phi3/E2E_Phi-3-vision-image-text-to-text-online-endpoint.ipynb)  
    ...
    - [Microsoft.ML.OnnxRuntime .NET प्रयोग गरेर Phi-3 Vision स्थानीय ONNX मोडेल](../../md/04.HOL/dotnet/src/LabsPhi303)  
...
- अडियो नमूनाहरू  
  - Phi-4 नमूनाहरू 🆕  
    ...
    - [Phi-4-multimodal प्रयोग गरेर अडियो फाइल विश्लेषण गरी ट्रान्सक्रिप्ट उत्पन्न गर्ने .NET कन्सोल एप्लिकेसन](../../md/04.HOL/dotnet/src/LabsPhi4-MultiModal-02Audio)  
...
- Function Calling नमूनाहरू  
  - Phi-4 नमूनाहरू 🆕  
    ...
    - [📓] [Phi-4-mini सँग Function Calling प्रयोग गरेर बहु-एजेन्टहरू बनाउने](../../md/02.Application/07.FunctionCalling/Phi4/Multiagents/Phi_4_mini_multiagent.ipynb)  
...
- Multimodal Mixing नमूनाहरू  
  - Phi-4 नमूनाहरू 🆕  
    ...
    - [Phi-4-multimodal प्रयोग गरेर तस्बिरहरू विश्लेषण गर्ने .NET कन्सोल एप्लिकेसन](../../md/04.HOL/dotnet/src/LabsPhi4-MultiModal-01Images)  

- Phi फाइन-ट्यूनिङ नमूनाहरू  
  - [फाइन-ट्यूनिङ परिदृश्यहरू](./md/03.FineTuning/FineTuning_Scenarios.md)  
  - [फाइन-ट्यूनिङ र RAG बीच तुलना](./md/03.FineTuning/FineTuning_vs_RAG.md)  
  - [Phi-3 लाई उद्योग विशेषज्ञ बनाउने फाइन-ट्यूनिङ](./md/03.FineTuning/LetPhi3gotoIndustriy.md)  
  - [VS Code को लागि AI Toolkit सँग Phi-3 फाइन-ट्यूनिङ](./md/03.FineTuning/Finetuning_VSCodeaitoolkit.md)  
  - [Azure Machine Learning Service सँग Phi-3 फाइन-ट्यूनिङ](./md/03.FineTuning/Introduce_AzureML.md)  
  ...
  - [Weights and Bias सँग Phi-3-vision फाइन-ट्यूनिङ](./md/03.FineTuning/FineTuning_Phi-3-visionWandB.md)  
  - [Apple MLX Framework सँग Phi-3 फाइन-ट्यूनिङ](./md/03.FineTuning/FineTuning_MLX.md)  
  - [Phi-3-vision (आधिकारिक समर्थन) फाइन-ट्यूनिङ](./md/03.FineTuning/FineTuning_Vision.md)  
  - [Kaito AKS, Azure Containers (आधिकारिक समर्थन) सँग Phi-3 फाइन-ट्यूनिङ](./md/03.FineTuning/FineTuning_Kaito.md)  
  - [Phi-3 र 3.5 Vision फाइन-ट्यूनिङ](https://github.com/2U1/Phi3-Vision-Finetune)  

- Hands on Lab  
  - [अत्याधुनिक मोडेलहरू अन्वेषण: LLMs, SLMs, स्थानीय विकास र थप](https://github.com/microsoft/aitour-exploring-cutting-edge-models)  
  - [NLP सम्भावना खोल्दै: Microsoft Olive सँग फाइन-ट्यूनिङ](https://github.com/azure/Ignite_FineTuning_workshop)  
...
- शैक्षिक अनुसन्धान कागजातहरू र प्रकाशनहरू  
  ...
  - [(WhyPHI) बहुविकल्प प्रश्न उत्तरका लागि PHI-3 को फाइन-ट्यूनिङ: विधि, परिणामहरू, र चुनौतीहरू](https://arxiv.org/abs/2501.01588)
...
**प्लेलगाउँड**  
[Hugging Chat प्लेलगाउँड](https://huggingface.co/chat/models/microsoft/Phi-3-mini-4k-instruct)
...
यस परियोजनाको संशोधित संस्करणहरूमा Microsoft ट्रेडमार्क वा लोगोहरूको प्रयोगले भ्रम सिर्जना गर्नु हुँदैन वा Microsoft को प्रायोजन संकेत गर्नु हुँदैन। तेस्रो पक्षका ट्रेडमार्क वा लोगोहरूको कुनै पनि प्रयोग तिनीहरूको नीति अनुसार हुनुपर्छ।
