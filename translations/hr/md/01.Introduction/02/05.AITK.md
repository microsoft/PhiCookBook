...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-09T09:47:41+00:00",
...
[AI Toolkit za VS Code](https://marketplace.visualstudio.com/items?itemName=ms-windows-ai-studio.windows-ai-studio) olakšava razvoj generativnih AI aplikacija tako što okuplja najsuvremenije AI razvojne alate i modele iz Azure AI Foundry kataloga i drugih kataloga poput Hugging Face. Moći ćete pregledavati katalog AI modela koji pokreću GitHub Models i Azure AI Foundry Model Catalogs, preuzimati ih lokalno ili na daljinu, fino podešavati, testirati i koristiti u svojoj aplikaciji.

AI Toolkit Preview će raditi lokalno. Lokalna inferencija ili fino podešavanje, ovisno o odabranom modelu, može zahtijevati GPU poput NVIDIA CUDA GPU. Također možete direktno pokretati GitHub modele putem AITK.
...
- Za fino podešavanje na Windows i Linux sustavima, potrebna vam je Nvidia GPU. Osim toga, **Windows** zahtijeva subsistem za Linux s Ubuntu distribucijom 18.4 ili novijom. [Saznajte više o instalaciji Windows subsistema za Linux](https://learn.microsoft.com/windows/wsl/install) i [promjeni zadane distribucije](https://learn.microsoft.com/windows/wsl/install#change-the-default-linux-distribution-installed).
...
1. U Activity Baru u VS Code odaberite **Extensions**
...
Nakon instalacije ekstenzije vidjet ćete ikonu AI Toolkita u vašem Activity Baru.
...
Dostupne su u odjeljku Resources. Za početak odaberite **Model Catalog**.
...
- Testirajte model u **Model Playground**
- Fino podešavanje modela lokalno ili na daljinu u **Model Fine-tuning**
- Postavite fino podešavane modele u oblak putem komandne palete AI Toolkita
- Evaluacija modela
...
Kada se model preuzme, odaberite **Load in Playground** na kartici modela u katalogu:
...
To vam omogućuje da testirate svoju aplikaciju lokalno bez oslanjanja na AI model uslugu u oblaku. Na primjer, sljedeća JSON datoteka prikazuje kako konfigurirati tijelo zahtjeva:
...
Zatim zalijepite sljedeći kod u vašu datoteku **Program.cs**:
...
- Fino podešavanje i inferencija modela koristeći lokalne računalne resurse.
- Udaljeno fino podešavanje i inferencija koristeći Azure resurse
