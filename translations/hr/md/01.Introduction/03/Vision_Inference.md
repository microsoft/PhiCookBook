...
Molimo provjerite jesu li sljedeće Python biblioteke instalirane prije korištenja (preporučuje se Python 3.10+)
...
Preporučuje se korištenje ***CUDA 11.6+*** i instalacija flatten
...
Želimo da AI može analizirati sadržaj naših slika i dati relevantne opise
...
Relevantne odgovore možemo dobiti izvršavanjem sljedećeg skripta u Notebooku
