...
Kreiranje Microsoft Foundry projekta i huba odličan je način za organizaciju i upravljanje vašim AI radom. Evo vodiča korak po korak za početak:

### Kreiranje projekta u Microsoft Foundry

1. **Idite na Microsoft Foundry**: Prijavite se u Microsoft Foundry portal.
2. **Kreirajte projekt**:
   - Ako ste unutar nekog projekta, odaberite "Microsoft Foundry" u gornjem lijevom kutu stranice da biste otišli na početnu stranicu.
...
### Kreiranje huba u Microsoft Foundry
...
Kreirajte Microsoft Foundry [QuickStarts](https://learn.microsoft.com/azure/ai-studio/quickstarts/get-started-code)
...
- Odaberite model koji želite implementirati iz Microsoft Foundry model kataloga.
...
## **5. Korištenje Phi API-ja u Microsoft Foundry**
