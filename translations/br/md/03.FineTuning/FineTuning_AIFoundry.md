...
![AIFoundry Models](../../../../translated_images/AIFoundryModels.0e1b16f7d0b09b73.br.png)
...
![Finetune AI Foundry](../../../../translated_images/AIFoundryfinetune.193aaddce48d553c.br.png)
...
1. Selecione **+New project** para criar um novo projeto no Azure AI Foundry.
    ...
    ![FineTuneSelect](../../../../translated_images/select-new-project.cd31c0404088d7a3.br.png)
...
1. Realize as seguintes tarefas:
    ...
    ![FineTuneSelect](../../../../translated_images/create-project.ca3b71298b90e420.br.png)
...
1. Realize as seguintes tarefas para criar um novo hub:
    ...
    ![FineTuneSelect](../../../../translated_images/create-hub.49e53d235e80779e.br.png)
...
1. Digite *phi-3* na **barra de busca** e selecione o modelo phi-3 que deseja usar.
    ...
    ![FineTuneSelect](../../../../translated_images/select-model.60ef2d4a6a3cec57.br.png)

1. Selecione **Fine-tune**.

    ![FineTuneSelect](../../../../translated_images/select-finetune.a976213b543dd9d8.br.png)

1. Insira o **Nome do modelo ajustado**.

    ![FineTuneSelect](../../../../translated_images/finetune1.c2b39463f0d34148.br.png)
...
1. Realize as seguintes tarefas:
    ...
    ![FineTuneSelect](../../../../translated_images/finetune2.43cb099b1a94442d.br.png)

1. Selecione **Next**.

1. Envie os **dados de validação** que deseja usar ou selecione **Divisão automática dos dados de treinamento**.

    ![FineTuneSelect](../../../../translated_images/finetune3.fd96121b67dcdd92.br.png)
...
1. Realize as seguintes tarefas:
    ...
    ![FineTuneSelect](../../../../translated_images/finetune4.e18b80ffccb5834a.br.png)

1. Selecione **Submit** para iniciar o processo de ajuste fino.

    ![FineTuneSelect](../../../../translated_images/select-submit.0a3802d581bac271.br.png)
...
1. Quando seu modelo estiver ajustado, o status será exibido como **Completed**, conforme a imagem abaixo. Agora você pode implantar o modelo e usá-lo em sua própria aplicação, no playground ou no prompt flow. Para mais informações, veja [Como implantar a família de modelos pequenos Phi-3 com Azure AI Foundry](https://learn.microsoft.com/azure/ai-studio/how-to/deploy-models-phi-3?tabs=phi-3-5&pivots=programming-language-python).
    ...
    ![FineTuneSelect](../../../../translated_images/completed.4dc8d2357144cdef.br.png)
