...
![AIFoundry Models](../../../../translated_images/br/AIFoundryModels.0e1b16f7d0b09b73.png)
...
![Finetune AI Foundry](../../../../translated_images/br/AIFoundryfinetune.193aaddce48d553c.png)
...
1. Selecione **+New project** para criar um novo projeto no Azure AI Foundry.
    ...
    ![FineTuneSelect](../../../../translated_images/br/select-new-project.cd31c0404088d7a3.png)
...
1. Realize as seguintes tarefas:
    ...
    ![FineTuneSelect](../../../../translated_images/br/create-project.ca3b71298b90e420.png)
...
1. Realize as seguintes tarefas para criar um novo hub:
    ...
    ![FineTuneSelect](../../../../translated_images/br/create-hub.49e53d235e80779e.png)
...
1. Digite *phi-3* na **barra de busca** e selecione o modelo phi-3 que deseja usar.
    ...
    ![FineTuneSelect](../../../../translated_images/br/select-model.60ef2d4a6a3cec57.png)

1. Selecione **Fine-tune**.

    ![FineTuneSelect](../../../../translated_images/br/select-finetune.a976213b543dd9d8.png)

1. Insira o **Nome do modelo ajustado**.

    ![FineTuneSelect](../../../../translated_images/br/finetune1.c2b39463f0d34148.png)
...
1. Realize as seguintes tarefas:
    ...
    ![FineTuneSelect](../../../../translated_images/br/finetune2.43cb099b1a94442d.png)

1. Selecione **Next**.

1. Envie os **dados de validação** que deseja usar ou selecione **Divisão automática dos dados de treinamento**.

    ![FineTuneSelect](../../../../translated_images/br/finetune3.fd96121b67dcdd92.png)
...
1. Realize as seguintes tarefas:
    ...
    ![FineTuneSelect](../../../../translated_images/br/finetune4.e18b80ffccb5834a.png)

1. Selecione **Submit** para iniciar o processo de ajuste fino.

    ![FineTuneSelect](../../../../translated_images/br/select-submit.0a3802d581bac271.png)
...
1. Quando seu modelo estiver ajustado, o status será exibido como **Completed**, conforme a imagem abaixo. Agora você pode implantar o modelo e usá-lo em sua própria aplicação, no playground ou no prompt flow. Para mais informações, veja [Como implantar a família de modelos pequenos Phi-3 com Azure AI Foundry](https://learn.microsoft.com/azure/ai-studio/how-to/deploy-models-phi-3?tabs=phi-3-5&pivots=programming-language-python).
    ...
    ![FineTuneSelect](../../../../translated_images/br/completed.4dc8d2357144cdef.png)
