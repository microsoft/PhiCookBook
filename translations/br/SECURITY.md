...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-09T04:18:13+00:00",
...
Inclua as informações solicitadas abaixo (na medida do possível) para nos ajudar a entender melhor a natureza e o escopo do possível problema:
...
Essas informações nos ajudarão a analisar seu relatório mais rapidamente.

Se estiver reportando para um programa de recompensa por bugs, relatórios mais completos podem contribuir para uma recompensa maior. Visite nossa página do [Microsoft Bug Bounty Program](https://aka.ms/security.md/msrc/bounty) para mais detalhes sobre nossos programas ativos.
...
A Microsoft segue o princípio da [Coordinated Vulnerability Disclosure](https://aka.ms/security.md/cvd).
