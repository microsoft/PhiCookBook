...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-17T10:29:28+00:00",
  "source_file": "README.md",
  "language_code": "vi"
}
-->
# Sách hướng dẫn Phi: Ví dụ thực hành với các mô hình Phi của Microsoft
...
Phi hiện là mô hình ngôn ngữ nhỏ (SLM) mạnh mẽ và tiết kiệm chi phí nhất, với các điểm chuẩn rất tốt trong các lĩnh vực đa ngôn ngữ, suy luận, tạo văn bản/chat, mã hóa, hình ảnh, âm thanh và các kịch bản khác.

Bạn có thể triển khai Phi lên đám mây hoặc các thiết bị biên, và dễ dàng xây dựng các ứng dụng AI tạo nội dung với sức mạnh tính toán hạn chế.
...
- Suy luận Phi trong các môi trường khác nhau
    ...
    -  [Các mô hình trên GitHub](./md/01.Introduction/02/02.GitHubModel.md)
...
-  [Định lượng gia đình Phi](./md/01.Introduction/04/QuantifyingPhi.md)
    ...
    - [Định lượng Phi-3.5 / 4 bằng các phần mở rộng AI tạo nội dung cho onnxruntime](./md/01.Introduction/04/UsingORTGenAIQuantifyingPhi.md)
...
- [Mẫu ứng dụng ghi chú AI đa mô hình trên WinUI3](https://github.com/microsoft/ai-powered-notes-winui3-sample)
...
- [📓] [Mẫu dự đoán ngôn ngữ Phi-3.5-mini-instruct (Trung Quốc/Anh)](../../md/02.Application/01.TextAndChat/Phi3/phi3-instruct-demo.ipynb)
...
- Mẫu Vision
  ...
  - Mẫu Phi-3 / 3.5
    ...
    - [📓][Mẫu Phi-3.5 Vision đa khung hoặc đa hình ảnh](../../md/02.Application/04.Vision/Phi3/phi3-vision-demo.ipynb)
    - [Mô hình ONNX Phi-3 Vision cục bộ sử dụng Microsoft.ML.OnnxRuntime .NET](../../md/04.HOL/dotnet/src/LabsPhi303)
    - [Mô hình ONNX Phi-3 Vision cục bộ dựa trên menu sử dụng Microsoft.ML.OnnxRuntime .NET](../../md/04.HOL/dotnet/src/LabsPhi304)
...
- Mẫu Âm thanh
  - Mẫu Phi-4 🆕
    ...
    - [Ứng dụng console .NET sử dụng Phi-4-multimodal để phân tích tệp âm thanh và tạo bản ghi](../../md/04.HOL/dotnet/src/LabsPhi4-MultiModal-02Audio)

- Mẫu MOE
  - Mẫu Phi-3 / 3.5
    - [📓] [Mẫu Phi-3.5 Mixture of Experts Models (MoEs) Social Media](../../md/02.Application/06.MoE/Phi3/phi3_moe_demo.ipynb)
...
- Các bài báo nghiên cứu và xuất bản học thuật
  ...
  - [Báo cáo kỹ thuật Phi-3: Mô hình ngôn ngữ rất mạnh mẽ trên điện thoại của bạn](https://arxiv.org/abs/2404.14219)
  - [Báo cáo kỹ thuật Phi-4](https://arxiv.org/abs/2412.08905)
  - [Báo cáo kỹ thuật Phi-4-Mini: Mô hình ngôn ngữ đa mô hình nhỏ gọn nhưng mạnh mẽ qua Mixture-of-LoRAs](https://arxiv.org/abs/2503.01743)
  - [Tối ưu hóa Mô hình Ngôn ngữ Nhỏ cho Gọi Chức năng Trong Xe](https://arxiv.org/abs/2501.02342)
  - [(WhyPHI) Tinh chỉnh PHI-3 cho Trả lời Câu hỏi Nhiều Lựa chọn: Phương pháp, Kết quả và Thách thức](https://arxiv.org/abs/2501.01588)
...
Microsoft cam kết giúp khách hàng sử dụng sản phẩm AI của chúng tôi một cách có trách nhiệm, chia sẻ những bài học kinh nghiệm và xây dựng các mối quan hệ đối tác dựa trên sự tin tưởng thông qua các công cụ như Ghi chú Minh bạch và Đánh giá Tác động. Nhiều tài nguyên này có thể được tìm thấy tại [https://aka.ms/RAI](https://aka.ms/RAI).  
