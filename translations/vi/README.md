...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2026-01-05T08:48:20+00:00",
...
[![Chào mừng PR](https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat-square)](http://makeapullrequest.com?WT.mc_id=aiml-137032-kinfeylo)
...
Phi hiện là mô hình ngôn ngữ nhỏ (SLM) mạnh mẽ và tiết kiệm chi phí nhất, với các tiêu chuẩn rất tốt trong đa ngôn ngữ, suy luận, tạo văn bản/trò chuyện, mã hóa, hình ảnh, âm thanh và các kịch bản khác.

Bạn có thể triển khai Phi lên đám mây hoặc thiết bị biên, và bạn có thể dễ dàng xây dựng các ứng dụng AI tạo sinh với sức mạnh tính toán hạn chế.

Thực hiện các bước này để bắt đầu sử dụng các tài nguyên này:
1. **Bifork Kho Lưu trữ**: Nhấn [![Forks GitHub](https://img.shields.io/github/forks/microsoft/phicookbook.svg?style=social&label=Fork)](https://GitHub.com/microsoft/phicookbook/network/?WT.mc_id=aiml-137032-kinfeylo)
2. **Sao chép Kho Lưu trữ**:   `git clone https://github.com/microsoft/PhiCookBook.git`
3. [**Tham gia Cộng đồng Microsoft AI Discord và gặp gỡ các chuyên gia cũng như các nhà phát triển đồng hành**](https://discord.com/invite/ByRwuEEgH4?WT.mc_id=aiml-137032-kinfeylo)
...
> **Ưu tiên Clone Tại Máy Tính Cá Nhân?**

> Kho lưu trữ này bao gồm hơn 50 bản dịch ngôn ngữ làm tăng đáng kể kích thước tải về. Để clone mà không có bản dịch, sử dụng sparse checkout:
> ```bash
> git clone --filter=blob:none --sparse https://github.com/microsoft/PhiCookBook.git
> cd PhiCookBook
> git sparse-checkout set --no-cone '/*' '!translations' '!translated_images'
> ```
> Điều này cung cấp cho bạn mọi thứ cần thiết để hoàn thành khóa học với tốc độ tải xuống nhanh hơn rất nhiều.
...
- Giới thiệu
  ...
  - [Các Mô hình Phi & Khả năng sẵn có trên nhiều nền tảng](./md/01.Introduction/01/01.Edgeandcloud.md)
...
- Suy luận Phi trên các môi trường khác nhau
...
-  [Lượng tử hóa Phi Family](./md/01.Introduction/04/QuantifyingPhi.md)
    ...
    - [Lượng tử hóa Phi-3.5 / 4 bằng các tiện ích mở rộng Generative AI cho onnxruntime](./md/01.Introduction/04/UsingORTGenAIQuantifyingPhi.md)
...
-  Đánh giá Phi
    - [Trách nhiệm AI](./md/01.Introduction/05/ResponsibleAI.md)
...
- Ví dụ phát triển ứng dụng Phi
  - Ứng dụng Văn bản & Trò chuyện
    - Mẫu Phi-4 🆕
      ...
      - [Trò chuyện với Mô hình Phi-4 ONNX local .NET](../../md/04.HOL/dotnet/src/LabsPhi4-Chat-01OnnxRuntime)
    ...
    - Mẫu Phi-3 / 3.5
      ...
      - [Multi Model - Phi-3-mini tương tác và OpenAI Whisper](./md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-mini_with_whisper.md)
      ...
      -[Mẫu ứng dụng ghi chú đa mô hình WinUI3 AI](https://github.com/microsoft/ai-powered-notes-winui3-sample)
      ...
      - [Đánh giá mô hình Phi-3 / Phi-3.5 đã tinh chỉnh trong Azure AI Foundry tập trung vào các nguyên tắc AI có trách nhiệm của Microsoft](./md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-Evaluation_AIFoundry.md)
  ...
  - Mẫu mã dựa trên SDK Azure AI Inference 
    - Mẫu Phi-4 🆕
    ...
    - Mẫu Phi-3 / 3.5
      ...
      - [Tạo đại lý Chat Copilot Visual Studio Code riêng với Phi-3.5 bằng GitHub Models](/md/02.Application/02.Code/Phi3/CreateVSCodeChatAgentWithGitHubModels.md)
  ...
  - Mẫu Lý luận nâng cao
    - Mẫu Phi-4 🆕
      ...
      - [📓] [Phi-4-mini-lý luận với GitHub Models](./md/02.Application/02.Code/Phi4r/github_models_inference.ipynb)
      - [📓] [Phi-4-mini-lý luận với Azure AI Foundry Models](./md/02.Application/02.Code/Phi4r/azure_models_inference.ipynb)
  - Demo
      ...
      - [Demo Phi-4-multimodal được lưu trữ trên Hugginge Face Spaces](https://huggingface.co/spaces/microsoft/phi-4-multimodal?WT.mc_id=aiml-137032-kinfeylo)
  - Mẫu Thị giác
    - Mẫu Phi-4 🆕
      - [📓] [Sử dụng Phi-4-multimodal để đọc hình ảnh và tạo mã](./md/02.Application/04.Vision/Phi4/CreateFrontend/README.md) 
    - Mẫu Phi-3 / 3.5
      -  [📓][Phi-3-vision-Ảnh văn bản sang văn bản](./md/02.Application/04.Vision/Phi3/E2E_Phi-3-vision-image-text-to-text-online-endpoint.ipynb)
      ...
      - [📓][Phi-3.5 Vision đa khung hoặc đa hình ảnh mẫu](./md/02.Application/04.Vision/Phi3/phi3-vision-demo.ipynb)
      - [Mô hình ONNX Phi-3 Thị giác cục bộ sử dụng Microsoft.ML.OnnxRuntime .NET](../../md/04.HOL/dotnet/src/LabsPhi303)
  ...
  - Mẫu Âm thanh
    - Mẫu Phi-4 🆕
      ...
      - [Ứng dụng console .NET sử dụng Phi-4-multimodal Âm thanh để phân tích tập tin âm thanh và tạo bản ghi](../../md/04.HOL/dotnet/src/LabsPhi4-MultiModal-02Audio)

  - Mẫu MOE
    - Mẫu Phi-3 / 3.5
      - [📓] [Mẫu Mô hình Phi-3.5 Hỗn hợp Chuyên gia (MoEs) trên mạng xã hội](./md/02.Application/06.MoE/Phi3/phi3_moe_demo.ipynb)
  ...
  - Mẫu Hợp nhất Đa mô hình
    - Mẫu Phi-4 🆕
      -  [📓] [Sử dụng Phi-4-multimodal làm nhà báo Công nghệ](./md/02.Application/08.Multimodel/Phi4/TechJournalist/phi_4_mm_audio_text_publish_news.ipynb)
...
- Các bài nghiên cứu và công bố học thuật
  ...
  - [Báo Cáo Kỹ Thuật Phi-4-Mini: Mô Hình Ngôn Ngữ Đa Modal Nhỏ Gọn Nhưng Mạnh Mẽ Qua Mixture-of-LoRAs](https://arxiv.org/abs/2503.01743)
  - [Tối Ưu Hóa Mô Hình Ngôn Ngữ Nhỏ Cho Gọi Hàm Trong Xe](https://arxiv.org/abs/2501.02342)
  - [(WhyPHI) Tinh Chỉnh PHI-3 Cho Trả Lời Câu Hỏi Lựa Chọn Nhiều: Phương Pháp, Kết Quả và Thách Thức](https://arxiv.org/abs/2501.01588)
...
Bạn có thể học cách sử dụng Microsoft Phi và cách xây dựng các giải pháp đầu-cuối trong các thiết bị phần cứng khác nhau của bạn. Để tự trải nghiệm Phi, hãy bắt đầu bằng cách thử nghiệm mô hình và tùy chỉnh Phi cho các kịch bản của bạn sử dụng [Azure AI Foundry Azure AI Model Catalog](https://aka.ms/phi3-azure-ai) bạn có thể tìm hiểu thêm tại Bắt Đầu Với [Azure AI Foundry](/md/02.QuickStart/AzureAIFoundry_QuickStart.md)

**Sân Chơi**
Mỗi mô hình có một sân chơi riêng để kiểm thử mô hình [Azure AI Playground](https://aka.ms/try-phi3).

### Phi trên Các Mô Hình GitHub

Bạn có thể học cách sử dụng Microsoft Phi và cách xây dựng các giải pháp đầu-cuối trên các thiết bị phần cứng khác nhau. Để tự trải nghiệm Phi, hãy bắt đầu bằng cách thử nghiệm mô hình và tùy chỉnh Phi cho các kịch bản của bạn sử dụng [GitHub Model Catalog](https://github.com/marketplace/models?WT.mc_id=aiml-137032-kinfeylo) bạn có thể tìm hiểu thêm tại Bắt Đầu Với [GitHub Model Catalog](/md/02.QuickStart/GitHubModel_QuickStart.md)

**Sân Chơi**
Mỗi mô hình có một [sân chơi để kiểm thử mô hình](/md/02.QuickStart/GitHubModel_QuickStart.md).
...
### Chuỗi Copilot
[![Copilot cho Lập Trình Hợp Tác AI](https://img.shields.io/badge/Copilot%20for%20AI%20Paired%20Programming-FACC15?style=for-the-badge&labelColor=E5E7EB&color=FACC15)](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)
...
Microsoft cam kết giúp khách hàng sử dụng sản phẩm AI của chúng tôi một cách có trách nhiệm, chia sẻ kinh nghiệm, và xây dựng các quan hệ đối tác dựa trên sự tin tưởng thông qua các công cụ như Ghi Chú Minh Bạch và Đánh Giá Tác Động. Nhiều tài nguyên này có thể được tìm thấy tại [https://aka.ms/RAI](https://aka.ms/RAI).
Cách tiếp cận của Microsoft về AI có trách nhiệm dựa trên các nguyên tắc AI về công bằng, độ tin cậy và an toàn, quyền riêng tư và bảo mật, tính bao trùm, minh bạch và trách nhiệm giải trình.

Các mô hình ngôn ngữ, hình ảnh và giọng nói quy mô lớn - như những mô hình được sử dụng trong mẫu này - có thể tiềm ẩn hành vi không công bằng, không đáng tin cậy hoặc xúc phạm, dẫn đến các tác hại. Vui lòng tham khảo [Ghi Chú Minh Bạch dịch vụ Azure OpenAI](https://learn.microsoft.com/legal/cognitive-services/openai/transparency-note?tabs=text) để được thông tin về các rủi ro và hạn chế.

Cách tiếp cận được khuyến nghị để giảm thiểu các rủi ro này là bao gồm một hệ thống an toàn trong kiến trúc của bạn để phát hiện và ngăn chặn hành vi có hại. [Azure AI Content Safety](https://learn.microsoft.com/azure/ai-services/content-safety/overview) cung cấp một lớp bảo vệ độc lập, có khả năng phát hiện nội dung do người dùng và AI tạo ra có hại trong các ứng dụng và dịch vụ. Azure AI Content Safety bao gồm các API văn bản và hình ảnh cho phép bạn phát hiện vật liệu có hại. Trong Azure AI Foundry, dịch vụ Content Safety cho phép bạn xem, khám phá và thử mã mẫu để phát hiện nội dung có hại trên các hình thức khác nhau. Tài liệu [bắt đầu nhanh sau đây](https://learn.microsoft.com/azure/ai-services/content-safety/quickstart-text?tabs=visual-studio%2Clinux&pivots=programming-language-rest) hướng dẫn bạn cách gửi yêu cầu đến dịch vụ.

Một khía cạnh khác cần lưu ý là hiệu suất tổng thể của ứng dụng. Với các ứng dụng đa mô hình và đa dạng phương thức, chúng tôi xem hiệu suất là hệ thống hoạt động như bạn và người dùng mong đợi, bao gồm cả việc không tạo ra các kết quả đầu ra có hại. Việc đánh giá hiệu suất tổng thể của ứng dụng của bạn bằng cách sử dụng [các bộ đánh giá Hiệu Suất và Chất Lượng cũng như Rủi Ro và An Toàn](https://learn.microsoft.com/azure/ai-studio/concepts/evaluation-metrics-built-in) là rất quan trọng. Bạn cũng có khả năng tạo và đánh giá với [các bộ đánh giá tùy chỉnh](https://learn.microsoft.com/azure/ai-studio/how-to/develop/evaluate-sdk#custom-evaluators).
Bạn có thể đánh giá ứng dụng AI của mình trong môi trường phát triển bằng cách sử dụng [Azure AI Evaluation SDK](https://microsoft.github.io/promptflow/index.html). Cho dù là bộ dữ liệu thử nghiệm hay một mục tiêu, các thế hệ ứng dụng AI sinh tạo của bạn sẽ được đo lường định lượng bằng các bộ đánh giá có sẵn hoặc bộ đánh giá tùy chỉnh theo lựa chọn của bạn. Để bắt đầu với azure ai evaluation sdk nhằm đánh giá hệ thống của bạn, bạn có thể làm theo [hướng dẫn khởi động nhanh](https://learn.microsoft.com/azure/ai-studio/how-to/develop/flow-evaluate-sdk). Khi bạn thực hiện một lần chạy đánh giá, bạn có thể [trực quan hóa kết quả trong Azure AI Foundry](https://learn.microsoft.com/azure/ai-studio/how-to/evaluate-flow-results).

## Nhãn hiệu thương mại

Dự án này có thể chứa nhãn hiệu hoặc logo cho các dự án, sản phẩm hoặc dịch vụ. Việc sử dụng nhãn hiệu hoặc logo của Microsoft được ủy quyền phải tuân theo và phải theo [Hướng dẫn Nhãn hiệu & Thương hiệu của Microsoft](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).  
Việc sử dụng nhãn hiệu hoặc logo Microsoft trong các phiên bản đã chỉnh sửa của dự án này không được gây nhầm lẫn hoặc ngụ ý có sự bảo trợ của Microsoft. Mọi việc sử dụng nhãn hiệu hoặc logo của bên thứ ba đều phải tuân theo chính sách của bên thứ ba đó.
...
Tài liệu này đã được dịch bằng dịch vụ dịch thuật AI [Co-op Translator](https://github.com/Azure/co-op-translator). Mặc dù chúng tôi cố gắng đảm bảo độ chính xác, xin lưu ý rằng bản dịch tự động có thể chứa lỗi hoặc sai sót. Văn bản gốc bằng ngôn ngữ nguyên bản nên được coi là nguồn thông tin chính thức. Đối với các thông tin quan trọng, nên sử dụng dịch vụ dịch thuật chuyên nghiệp bởi con người. Chúng tôi không chịu trách nhiệm về bất kỳ sự hiểu lầm hay giải thích sai nào phát sinh từ việc sử dụng bản dịch này.
