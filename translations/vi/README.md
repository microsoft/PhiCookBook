...
[![Người đóng góp trên GitHub](https://img.shields.io/github/contributors/microsoft/phicookbook.svg)](https://GitHub.com/microsoft/phicookbook/graphs/contributors/?WT.mc_id=aiml-137032-kinfeylo)
...
1. **Fork the Repository**: Click [![Fork trên GitHub](https://img.shields.io/github/forks/microsoft/phicookbook.svg?style=social&label=Fork)](https://GitHub.com/microsoft/phicookbook/network/?WT.mc_id=aiml-137032-kinfeylo)
2. **Clone the Repository**:   `git clone https://github.com/microsoft/PhiCookBook.git`
3. [**Tham gia Cộng đồng Microsoft AI trên Discord và gặp gỡ chuyên gia cùng các nhà phát triển khác**](https://discord.com/invite/ByRwuEEgH4?WT.mc_id=aiml-137032-kinfeylo)

![bìa](../../translated_images/cover.eb18d1b9605d754b.vi.png)

### 🌐 Hỗ trợ đa ngôn ngữ

#### Hỗ trợ thông qua GitHub Action (Tự động & Luôn luôn Cập nhật)
...
- Giới thiệu
  ...
  - [Các mô hình Phi & Khả dụng trên các nền tảng](./md/01.Introduction/01/01.Edgeandcloud.md)
...
- Triển khai Phi Family
    ...
    - [Triển khai Phi—Thị giác (Vision) cục bộ](./md/01.Introduction/03/Vision_Inference.md)
    - [Triển khai Phi với Kaito AKS, Azure Containers (hỗ trợ chính thức)](./md/01.Introduction/03/Kaito_Inference.md)
-  [Lượng tử hóa Phi](./md/01.Introduction/04/QuantifyingPhi.md)
    - [Lượng tử hóa Phi-3.5 / 4 sử dụng llama.cpp](./md/01.Introduction/04/UsingLlamacppQuantifyingPhi.md)
    - [Lượng tử hóa Phi-3.5 / 4 sử dụng phần mở rộng Generative AI cho onnxruntime](./md/01.Introduction/04/UsingORTGenAIQuantifyingPhi.md)
...
- Ví dụ phát triển ứng dụng Phi
  - Ứng dụng Văn bản & Trò chuyện
    - Mẫu Phi-4 🆕
      ...
      - [Chat với mô hình Phi-4 local ONNX .NET](../../md/04.HOL/dotnet/src/LabsPhi4-Chat-01OnnxRuntime)
      - [Ứng dụng .NET Console Chat với Phi-4 ONNX sử dụng Semantic Kernel](../../md/04.HOL/dotnet/src/LabsPhi4-Chat-02SK)
    - Mẫu Phi-3 / 3.5
      ...
      - [Đa mô hình - Tương tác Phi-3-mini và OpenAI Whisper](./md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-mini_with_whisper.md)
      ...
      -[Mẫu Ứng dụng Ghi chú WinUI3 Nhiều Mô hình được hỗ trợ bởi AI](https://github.com/microsoft/ai-powered-notes-winui3-sample)
      ...
      - [Đánh giá Mô hình Phi-3 / Phi-3.5 đã được tinh chỉnh trong Azure AI Foundry Tập trung vào Nguyên tắc AI Có Trách nhiệm của Microsoft](./md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-Evaluation_AIFoundry.md)
      - [📓] [Mẫu dự đoán ngôn ngữ Phi-3.5-mini-instruct (Tiếng Trung/Tiếng Anh)](./md/02.Application/01.TextAndChat/Phi3/phi3-instruct-demo.ipynb)
      - [Chatbot RAG Phi-3.5-Instruct trên WebGPU](./md/02.Application/01.TextAndChat/Phi3/WebGPUWithPhi35Readme.md)
  ...
  - Mẫu mã nguồn Azure AI Inference SDK
    - Ví dụ Phi-4 🆕
      - [📓] [Tạo mã dự án sử dụng Phi-4-multimodal](./md/02.Application/02.Code/Phi4/GenProjectCode/README.md)
    - Ví dụ Phi-3 / 3.5
      - [Xây dựng Chat GitHub Copilot cho Visual Studio Code của bạn với gia đình Microsoft Phi-3](./md/02.Application/02.Code/Phi3/VSCodeExt/README.md)
      - [Tạo đại lý Chat Copilot trên Visual Studio Code của bạn với Phi-3.5 từ GitHub Models](/md/02.Application/02.Code/Phi3/CreateVSCodeChatAgentWithGitHubModels.md)
  ...
  - Demo
      ...
      - [Bản demo Phi-4-multimodal được lưu trữ trên Hugginge Face Spaces](https://huggingface.co/spaces/microsoft/phi-4-multimodal?WT.mc_id=aiml-137032-kinfeylo)
  - Mẫu Thị giác
    - Ví dụ Phi-4 🆕
      - [📓] [Sử dụng Phi-4-multimodal để đọc hình ảnh và tạo mã](./md/02.Application/04.Vision/Phi4/CreateFrontend/README.md) 
    - Mẫu Phi-3 / 3.5
      -  [📓][Phi-3-vision- Chuyển văn bản trong ảnh sang văn bản](./md/02.Application/04.Vision/Phi3/E2E_Phi-3-vision-image-text-to-text-online-endpoint.ipynb)
      - [Phi-3-vision-ONNX](https://onnxruntime.ai/docs/genai/tutorials/phi3-v.html)
      - [📓][Phi-3-vision Nhúng CLIP](./md/02.Application/04.Vision/Phi3/E2E_Phi-3-vision-image-text-to-text-online-endpoint.ipynb)
      ...
      - [📓][Mẫu Phi-3.5 Vision đa khung hình hoặc đa ảnh](./md/02.Application/04.Vision/Phi3/phi3-vision-demo.ipynb)
      - [Phi-3 Vision Local ONNX Model using the Microsoft.ML.OnnxRuntime .NET](../../md/04.HOL/dotnet/src/LabsPhi303)
      - [Menu based Phi-3 Vision Local ONNX Model using the Microsoft.ML.OnnxRuntime .NET](../../md/04.HOL/dotnet/src/LabsPhi304)

  - Mẫu Toán học
    -  Phi-4-Mini-Flash-Reasoning-Instruct Mẫu 🆕 [Demo Toán học với Phi-4-Mini-Flash-Reasoning-Instruct](./md/02.Application/09.Math/MathDemo.ipynb)

  - Mẫu Âm thanh
    - Phi-4 Samples 🆕
      - [📓] [Trích xuất bản ghi âm bằng Phi-4-multimodal](./md/02.Application/05.Audio/Phi4/Transciption/README.md)
  ...
  - Mẫu MOE
    - Phi-3 / 3.5 Samples
      ...
      - [📓] [Xây dựng đường ống Retrieval-Augmented Generation (RAG) với NVIDIA NIM Phi-3 MOE, Azure AI Search, và LlamaIndex](./md/02.Application/06.MoE/Phi3/azure-ai-search-nvidia-rag.ipynb)
      - 
  - Mẫu Gọi Hàm
    - Phi-4 Samples 🆕
      ...
      -  [📓] [Sử dụng Function Calling với ONNX](./md/02.Application/07.FunctionCalling/Phi4/ONNX/onnx_parallel_functioncalling.ipynb)
  - Mẫu Kết hợp đa phương thức
    - Phi-4 Samples 🆕
      -  [📓] [Sử dụng Phi-4-multimodal như một nhà báo công nghệ](../../md/02.Application/08.Multimodel/Phi4/TechJournalist/phi_4_mm_audio_text_publish_news_ipynb)
...
- Tinh chỉnh các mẫu Phi
  ...
  - [Tinh chỉnh - Biến Phi-3 thành chuyên gia trong ngành](./md/03.FineTuning/LetPhi3gotoIndustriy.md)
  ...
  - [Tinh chỉnh Phi-3 với Kaito AKS , Azure Containers(official Support)](./md/03.FineTuning/FineTuning_Kaito.md)
  - [Tinh chỉnh Phi-3 và Phi-3.5 Vision](https://github.com/2U1/Phi3-Vision-Finetune)
...
- Phòng thực hành
  ...
  - [Khai mở tiềm năng NLP: Tinh chỉnh với Microsoft Olive](https://github.com/azure/Ignite_FineTuning_workshop)

- Các bài báo nghiên cứu học thuật và ấn phẩm
  - [Textbooks Are All You Need II: phi-1.5 báo cáo kỹ thuật](https://arxiv.org/abs/2309.05463)
  - [Báo cáo kỹ thuật Phi-3: Một mô hình ngôn ngữ có năng lực cao chạy cục bộ trên điện thoại của bạn](https://arxiv.org/abs/2404.14219)
  - [Báo cáo kỹ thuật Phi-4](https://arxiv.org/abs/2412.08905)
  - [Báo cáo kỹ thuật Phi-4-Mini: Mô hình ngôn ngữ đa phương thức nhỏ gọn nhưng mạnh mẽ thông qua Mixture-of-LoRAs](https://arxiv.org/abs/2503.01743)
...
Bạn có thể tìm hiểu cách sử dụng Microsoft Phi và cách xây dựng các giải pháp đầu-cuối (E2E) trên các thiết bị phần cứng khác nhau của bạn. Để tự trải nghiệm Phi, hãy bắt đầu bằng cách thử nghiệm với các mô hình và tùy chỉnh Phi cho các kịch bản của bạn bằng cách sử dụng [Azure AI Foundry Azure AI Model Catalog](https://aka.ms/phi3-azure-ai) bạn có thể tìm hiểu thêm tại Bắt đầu với [Azure AI Foundry](/md/02.QuickStart/AzureAIFoundry_QuickStart.md)

**Bảng thử nghiệm**
Mỗi mô hình có một bảng thử nghiệm riêng để kiểm tra mô hình [Azure AI Playground](https://aka.ms/try-phi3).

### Phi trên GitHub Models

Bạn có thể tìm hiểu cách sử dụng Microsoft Phi và cách xây dựng các giải pháp đầu-cuối (E2E) trên các thiết bị phần cứng khác nhau của bạn. Để tự trải nghiệm Phi, hãy bắt đầu bằng cách thử nghiệm với mô hình và tùy chỉnh Phi cho các kịch bản của bạn bằng cách sử dụng [GitHub Model Catalog](https://github.com/marketplace/models?WT.mc_id=aiml-137032-kinfeylo) bạn có thể tìm hiểu thêm tại Bắt đầu với [GitHub Model Catalog](/md/02.QuickStart/GitHubModel_QuickStart.md)

**Bảng thử nghiệm**
Mỗi mô hình có một [trường thử nghiệm để thử mô hình](/md/02.QuickStart/GitHubModel_QuickStart.md).
...
**Bảng thử nghiệm**
 [Bảng thử nghiệm Hugging Chat](https://huggingface.co/chat/models/microsoft/Phi-3-mini-4k-instruct)

 ## 🎒 Các Khóa học Khác

Nhóm của chúng tôi còn có các khóa học khác! Khám phá:
...
### Loạt Copilot
[![Copilot cho Lập trình ghép đôi cùng AI](https://img.shields.io/badge/Copilot%20for%20AI%20Paired%20Programming-FACC15?style=for-the-badge&labelColor=E5E7EB&color=FACC15)](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)
...
Microsoft cam kết giúp khách hàng sử dụng các sản phẩm AI của chúng tôi một cách có trách nhiệm, chia sẻ những bài học của chúng tôi và xây dựng các quan hệ đối tác dựa trên niềm tin thông qua các công cụ như Transparency Notes và Impact Assessments. Nhiều tài nguyên này có thể được tìm thấy tại [https://aka.ms/RAI](https://aka.ms/RAI).
Cách tiếp cận của Microsoft đối với AI có trách nhiệm được dựa trên các nguyên tắc AI của chúng tôi về công bằng, độ tin cậy và an toàn, quyền riêng tư và bảo mật, bao quát, minh bạch và trách nhiệm giải trình.

Các mô hình ngôn ngữ, hình ảnh và giọng nói quy mô lớn — như những mô hình được sử dụng trong mẫu này — có thể hành xử theo những cách không công bằng, không đáng tin cậy hoặc xúc phạm, từ đó gây hại. Vui lòng tham khảo [Azure OpenAI service Transparency note](https://learn.microsoft.com/legal/cognitive-services/openai/transparency-note?tabs=text) để được thông tin về rủi ro và hạn chế.

Cách tiếp cận được khuyến nghị để giảm thiểu các rủi ro này là bao gồm một hệ thống an toàn trong kiến trúc của bạn có thể phát hiện và ngăn chặn hành vi gây hại. [Azure AI Content Safety](https://learn.microsoft.com/azure/ai-services/content-safety/overview) cung cấp một lớp bảo vệ độc lập, có khả năng phát hiện nội dung do người dùng và AI tạo ra có hại trong các ứng dụng và dịch vụ. Azure AI Content Safety bao gồm API văn bản và hình ảnh cho phép bạn phát hiện các tài liệu có hại. Trong Azure AI Foundry, dịch vụ Content Safety cho phép bạn xem, khám phá và thử mã ví dụ để phát hiện nội dung có hại trên các phương thức khác nhau. [tài liệu khởi động nhanh](https://learn.microsoft.com/azure/ai-services/content-safety/quickstart-text?tabs=visual-studio%2Clinux&pivots=programming-language-rest) sau đây hướng dẫn bạn cách gửi yêu cầu tới dịch vụ.

Một khía cạnh khác cần xem xét là hiệu suất tổng thể của ứng dụng. Với các ứng dụng đa phương thức và đa mô hình, chúng tôi coi hiệu suất là hệ thống hoạt động theo mong đợi của bạn và người dùng của bạn, bao gồm cả việc không tạo ra kết quả có hại. Điều quan trọng là đánh giá hiệu suất của toàn bộ ứng dụng của bạn bằng cách sử dụng [bộ đánh giá Hiệu suất và Chất lượng và Rủi ro và An toàn](https://learn.microsoft.com/azure/ai-studio/concepts/evaluation-metrics-built-in). Bạn cũng có khả năng tạo và đánh giá bằng [các bộ đánh giá tùy chỉnh](https://learn.microsoft.com/azure/ai-studio/how-to/develop/evaluate-sdk#custom-evaluators).

Bạn có thể đánh giá ứng dụng AI của mình trong môi trường phát triển bằng cách sử dụng [Azure AI Evaluation SDK](https://microsoft.github.io/promptflow/index.html). Với một bộ dữ liệu kiểm thử hoặc một mục tiêu, các sinh tác của ứng dụng AI tạo sinh của bạn được đo lường định lượng bằng các bộ đánh giá tích hợp sẵn hoặc các bộ đánh giá tùy chỉnh mà bạn chọn. Để bắt đầu với azure ai evaluation sdk để đánh giá hệ thống của bạn, bạn có thể theo [hướng dẫn khởi động nhanh](https://learn.microsoft.com/azure/ai-studio/how-to/develop/flow-evaluate-sdk). Khi bạn thực thi một lần chạy đánh giá, bạn có thể [trực quan hóa kết quả trong Azure AI Foundry](https://learn.microsoft.com/azure/ai-studio/how-to/evaluate-flow-results). 

## Nhãn hiệu
Dự án này có thể chứa nhãn hiệu hoặc logo cho các dự án, sản phẩm hoặc dịch vụ. Việc sử dụng nhãn hiệu hoặc logo của Microsoft phải được ủy quyền và phải tuân theo [Hướng dẫn Nhãn hiệu & Thương hiệu của Microsoft](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
Việc sử dụng nhãn hiệu hoặc logo của Microsoft trong các phiên bản sửa đổi của dự án này không được gây nhầm lẫn hoặc ngụ ý Microsoft tài trợ. Mọi việc sử dụng nhãn hiệu hoặc logo của bên thứ ba phải tuân theo chính sách của bên thứ ba đó.
...
Tài liệu này đã được dịch bằng dịch vụ dịch thuật AI [Co-op Translator](https://github.com/Azure/co-op-translator). Mặc dù chúng tôi cố gắng đảm bảo độ chính xác, xin lưu ý rằng các bản dịch tự động có thể chứa lỗi hoặc thiếu chính xác. Vui lòng coi tài liệu gốc bằng ngôn ngữ gốc là nguồn tham khảo có thẩm quyền. Đối với những thông tin quan trọng, nên sử dụng dịch vụ dịch thuật chuyên nghiệp do con người thực hiện. Chúng tôi không chịu trách nhiệm về bất kỳ hiểu lầm hoặc diễn giải sai nào phát sinh từ việc sử dụng bản dịch này.
