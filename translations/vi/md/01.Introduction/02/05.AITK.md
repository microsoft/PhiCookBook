...
[AI Toolkit for VS Code](https://marketplace.visualstudio.com/items?itemName=ms-windows-ai-studio.windows-ai-studio) giúp đơn giản hóa việc phát triển ứng dụng AI sinh tạo bằng cách tập hợp các công cụ và mô hình AI tiên tiến từ Microsoft Foundry Catalog và các catalog khác như Hugging Face. Bạn có thể duyệt catalog các mô hình AI được hỗ trợ bởi GitHub Models và Microsoft Foundry Model Catalogs, tải về cục bộ hoặc từ xa, tinh chỉnh, kiểm tra và sử dụng chúng trong ứng dụng của mình.
