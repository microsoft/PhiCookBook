...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-09T06:47:57+00:00",
  "source_file": "md/01.Introduction/01/01.Edgeandcloud.md",
  "language_code": "vi"
}
-->
# Phi Models & Sự sẵn có trên các nền tảng

## Các kịch bản Edge & Cloud

![EdgeCloud](../../../../../translated_images/01.phiedgecloud.b0223093d5c9be1e3050490fca4a8b42a0ea7445386aefc1e5b3f25d122b589d.vi.png)

## Sự sẵn có của mô hình và tài nguyên

| | | | | | | | | |
|-|-|-|-|-|-|-|-|-|
|Model|Input|Độ dài nội dung|Azure AI (MaaS)|Azure ML (MaaP)|ONNX|Hugging Face|Ollama|Nvidia NIM|
