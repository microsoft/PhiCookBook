...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-11T11:25:32+00:00",
...
Phi သည် လက်ရှိတွင် အကောင်းဆုံးနှင့် စျေးနှုန်းသက်သာသော Small Language Model (SLM) ဖြစ်ပြီး၊ ဘာသာစကားများစွာ၊ အကြောင်းအရာဆင်ခြင်း၊ စာသား/စကားပြော ဖန်တီးခြင်း၊ ကုဒ်ရေးခြင်း၊ ပုံများ၊ အသံများနှင့် အခြားအခြေအနေများတွင် အထူးကောင်းမွန်သော စမ်းသပ်မှုရလဒ်များ ရရှိထားသည်။

Phi ကို cloud သို့မဟုတ် edge devices တွင် တင်ဆောင်နိုင်ပြီး၊ အနည်းငယ်သော ကွန်ပျူတာစွမ်းရည်ဖြင့် Generative AI အက်ပလီကေးရှင်းများကို လွယ်ကူစွာ တည်ဆောက်နိုင်သည်။
...
- အကျဉ်းချုပ်
  ...
  - [Phi Hardware အထောက်အပံ့](./md/01.Introduction/01/01.Hardwaresupport.md)
...
- မတူညီသော ပတ်ဝန်းကျင်များတွင် Phi ကို Inference လုပ်ခြင်း
...
- Phi မိသားစုကို Inference လုပ်ခြင်း
    ...
    - [Kaito AKS, Azure Containers (တရားဝင်အထောက်အပံ့) ဖြင့် Phi ကို Inference လုပ်ခြင်း](./md/01.Introduction/03/Kaito_Inference.md)
...
- Phi အက်ပလီကေးရှင်း ဖွံ့ဖြိုးမှု နမူနာများ
  - စာသားနှင့် စကားပြော အက်ပလီကေးရှင်းများ
    - Phi-4 နမူနာများ 🆕
      - [📓] [Phi-4-mini ONNX Model ဖြင့် စကားပြောခြင်း](./md/02.Application/01.TextAndChat/Phi4/ChatWithPhi4ONNX/README.md)
      - [Phi-4 local ONNX Model .NET ဖြင့် စကားပြောခြင်း](../../md/04.HOL/dotnet/src/LabsPhi4-Chat-01OnnxRuntime)
      - [Sementic Kernel အသုံးပြု၍ Phi-4 ONNX ဖြင့် .NET Console App စကားပြောခြင်း](../../md/04.HOL/dotnet/src/LabsPhi4-Chat-02SK)
    - Phi-3 / 3.5 နမူနာများ
      ...
      - [MLFlow - Wrapper တစ်ခုတည်ဆောက်ပြီး Phi-3 ကို MLFlow ဖြင့် အသုံးပြုခြင်း](./md//02.Application/01.TextAndChat/Phi3/E2E_Phi-3-MLflow.md)
      - [Model Optimization - Olive ဖြင့် Phi-3-min model ကို ONNX Runtime Web အတွက် optimize လုပ်နည်း](https://github.com/microsoft/Olive/tree/main/examples/phi3)
...
- Academic Research Papers and Publications
  ...
  - [ကားတွင်းလုပ်ဆောင်ချက်များအတွက် သေးငယ်သောဘာသာစကားမော်ဒယ်များကို အကောင်းဆုံးလုပ်ဆောင်ရန်](https://arxiv.org/abs/2501.02342)
  - [(WhyPHI) PHI-3 ကို Multiple-Choice Question Answering အတွက် Fine-Tuning လုပ်ခြင်း: နည်းလမ်း၊ ရလဒ်များနှင့် စိန်ခေါ်မှုများ](https://arxiv.org/abs/2501.01588)
...
Microsoft Phi ကို ဘယ်လိုအသုံးပြုရမလဲ၊ သင့်ရဲ့ hardware စက်ပစ္စည်းများအတွက် E2E ဖြေရှင်းချက်များကို ဘယ်လိုတည်ဆောက်ရမလဲဆိုတာကို သင်ယူနိုင်ပါတယ်။ Phi ကို ကိုယ်တိုင်အတွေ့အကြုံရဖို့၊ မော်ဒယ်များကို စမ်းသပ်ပြီး သင့်ရဲ့အခြေအနေများအတွက် Phi ကို customize လုပ်ခြင်းဖြင့် စတင်ပါ။ [Azure AI Foundry Azure AI Model Catalog](https://aka.ms/phi3-azure-ai) တွင် သင်ယူနိုင်ပြီး [Azure AI Foundry](/md/02.QuickStart/AzureAIFoundry_QuickStart.md) တွင် စတင်အသုံးပြုရန် လမ်းညွှန်ချက်များကို ဖတ်ရှုနိုင်ပါတယ်။

**Playground**
မော်ဒယ်တစ်ခုစီမှာ မော်ဒယ်ကို စမ်းသပ်ဖို့အတွက် အထူးပြု playground ရှိပါတယ် [Azure AI Playground](https://aka.ms/try-phi3)။

### GitHub မော်ဒယ်များတွင် Phi

Microsoft Phi ကို ဘယ်လိုအသုံးပြုရမလဲ၊ သင့်ရဲ့ hardware စက်ပစ္စည်းများအတွက် E2E ဖြေရှင်းချက်များကို ဘယ်လိုတည်ဆောက်ရမလဲဆိုတာကို သင်ယူနိုင်ပါတယ်။ Phi ကို ကိုယ်တိုင်အတွေ့အကြုံရဖို့၊ မော်ဒယ်ကို စမ်းသပ်ပြီး သင့်ရဲ့အခြေအနေများအတွက် Phi ကို customize လုပ်ခြင်းဖြင့် စတင်ပါ။ [GitHub Model Catalog](https://github.com/marketplace/models?WT.mc_id=aiml-137032-kinfeylo) တွင် သင်ယူနိုင်ပြီး [GitHub Model Catalog](/md/02.QuickStart/GitHubModel_QuickStart.md) တွင် စတင်အသုံးပြုရန် လမ်းညွှန်ချက်များကို ဖတ်ရှုနိုင်ပါတယ်။

**Playground**
မော်ဒယ်တစ်ခုစီမှာ [မော်ဒယ်ကို စမ်းသပ်ဖို့ playground ရှိပါတယ်](/md/02.QuickStart/GitHubModel_QuickStart.md)။
...
Microsoft သည် ကျွန်ုပ်တို့၏ AI ထုတ်ကုန်များကို တာဝန်ရှိစွာ အသုံးပြုရန် ကျွန်ုပ်တို့၏ဖောက်သည်များကို ကူညီပေးရန်၊ ကျွန်ုပ်တို့၏အတွေ့အကြုံများကို မျှဝေရန်နှင့် Transparency Notes နှင့် Impact Assessments ကဲ့သို့သော ကိရိယာများမှတစ်ဆင့် ယုံကြည်မှုအခြေခံသော မိတ်ဖက်ဆက်ဆံရေးများ တည်ဆောက်ရန် အတတ်နိုင်ဆုံး ကြိုးစားနေပါသည်။ အများစုကို [https://aka.ms/RAI](https://aka.ms/RAI) တွင် ရှာဖွေနိုင်ပါသည်။ Microsoft ၏ တာဝန်ရှိသော AI ကို အသုံးပြုရန် လမ်းစဉ်သည် ကျွန်ုပ်တို့၏ AI အခြေခံသဘောတရားများဖြစ်သော တရားမျှတမှု၊ ယုံကြည်စိတ်ချရမှုနှင့် လုံခြုံမှု၊ ကိုယ်ရေးအချက်အလက်နှင့် လုံခြုံရေး၊ ပါဝင်မှု၊ ထင်ရှားမှုနှင့် တာဝန်ယူမှုတို့အပေါ် အခြေခံထားပါသည်။

ဤနမူနာတွင် အသုံးပြုထားသော သဘာဝဘာသာစကား၊ ပုံရိပ်နှင့် အသံမော်ဒယ်များက မတရား၊ ယုံကြည်စိတ်မချရမှု သို့မဟုတ် စိတ်ထိခိုက်စေသော အပြုအမူများကို ပြုလုပ်နိုင်ပြီး ထိခိုက်မှုများ ဖြစ်ပေါ်စေနိုင်ပါသည်။ အန္တရာယ်များနှင့် ကန့်သတ်ချက်များအကြောင်း သိရှိရန် [Azure OpenAI service Transparency note](https://learn.microsoft.com/legal/cognitive-services/openai/transparency-note?tabs=text) ကို ဖတ်ရှုပါ။

ဤအန္တရာယ်များကို လျှော့ချရန် အကြံပြုထားသော နည်းလမ်းမှာ သင့် architecture တွင် အန္တရာယ်ရှိသော အပြုအမူများကို ရှာဖွေပြီး ကာကွယ်နိုင်သော လုံခြုံရေးစနစ်ကို ထည့်သွင်းပါ။ [Azure AI Content Safety](https://learn.microsoft.com/azure/ai-services/content-safety/overview) သည် လွတ်လပ်သော ကာကွယ်မှုအလွှာတစ်ခုကို ပေးစွမ်းပြီး အသုံးပြုသူများနှင့် AI မှ ထုတ်လုပ်သော အကြောင်းအရာများကို ရှာဖွေနိုင်စွမ်းရှိသည်။ Azure AI Content Safety တွင် text နှင့် image APIs ပါဝင်ပြီး အန္တရာယ်ရှိသော အကြောင်းအရာများကို ရှာဖွေနိုင်စွမ်းရှိသည်။ Azure AI Foundry တွင် Content Safety service သည် အန္တရာယ်ရှိသော အကြောင်းအရာများကို ရှာဖွေခြင်းနှင့် စမ်းသပ်ရန် နမူနာကုဒ်ကို ကြည့်ရှု၊ စူးစမ်းနှင့် စမ်းသပ်နိုင်စေသည်။ [quickstart documentation](https://learn.microsoft.com/azure/ai-services/content-safety/quickstart-text?tabs=visual-studio%2Clinux&pivots=programming-language-rest) သည် service သို့ တောင်းဆိုမှုများ ပြုလုပ်ရန် လမ်းညွှန်ချက်များကို ပေးသည်။

အခြားအရေးပါသောအချက်မှာ application စနစ်၏ စွမ်းဆောင်ရည်ဖြစ်သည်။ multi-modal နှင့် multi-models applications တွင် စွမ်းဆောင်ရည်သည် စနစ်သည် သင့်နှင့် သင့်အသုံးပြုသူများ၏ မျှော်မှန်းချက်များနှင့်အညီ လုပ်ဆောင်ရမည်ဖြစ်ပြီး အန္တရာယ်ရှိသော output များကို မထုတ်လုပ်ရပါ။ [Performance and Quality and Risk and Safety evaluators](https://learn.microsoft.com/azure/ai-studio/concepts/evaluation-metrics-built-in) ကို အသုံးပြု၍ သင့် application စနစ်၏ စွမ်းဆောင်ရည်ကို အကဲဖြတ်ရန် အရေးကြီးပါသည်။ သင့်စနစ်ကို အကဲဖြတ်ရန် [custom evaluators](https://learn.microsoft.com/azure/ai-studio/how-to/develop/evaluate-sdk#custom-evaluators) ကို ဖန်တီးပြီး အကဲဖြတ်နိုင်စွမ်းလည်း ရှိပါသည်။

သင့် AI application ကို development environment တွင် [Azure AI Evaluation SDK](https://microsoft.github.io/promptflow/index.html) ကို အသုံးပြု၍ အကဲဖြတ်နိုင်ပါသည်။ test dataset သို့မဟုတ် target တစ်ခုကို အသုံးပြု၍ သင့် generative AI application မှ ထုတ်လုပ်သော အကြောင်းအရာများကို built-in evaluators သို့မဟုတ် သင့်ရွေးချယ်မှုအတိုင်း custom evaluators ဖြင့် အရည်အသွေးကို တိုင်းတာနိုင်သည်။ azure ai evaluation sdk ကို အသုံးပြု၍ သင့်စနစ်ကို အကဲဖြတ်ရန် စတင်လိုပါက [quickstart guide](https://learn.microsoft.com/azure/ai-studio/how-to/develop/flow-evaluate-sdk) ကို လိုက်နာပါ။ evaluation run တစ်ခုကို အကောင်အထည်ဖော်ပြီးနောက် [Azure AI Foundry တွင် ရလဒ်များကို visualized လုပ်နိုင်သည်](https://learn.microsoft.com/azure/ai-studio/how-to/evaluate-flow-results)။

## အမှတ်တံဆိပ်များ

ဤပရောဂျက်တွင် ပရောဂျက်များ၊ ထုတ်ကုန်များ သို့မဟုတ် ဝန်ဆောင်မှုများအတွက် အမှတ်တံဆိပ်များ သို့မဟုတ် logo များ ပါဝင်နိုင်ပါသည်။ Microsoft အမှတ်တံဆိပ်များ သို့မဟုတ် logo များကို အသုံးပြုရန် ခွင့်ပြုချက်သည် [Microsoft's Trademark & Brand Guidelines](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general) ကို လိုက်နာရမည်ဖြစ်သည်။
ဤပရောဂျက်၏ ပြင်ဆင်ထားသော version များတွင် Microsoft အမှတ်တံဆိပ်များ သို့မဟုတ် logo များကို အသုံးပြုခြင်းသည် ရှုပ်ထွေးမှုများ ဖြစ်ပေါ်စေခြင်း သို့မဟုတ် Microsoft ၏ အားပေးမှုကို ဖော်ပြခြင်း မဖြစ်စေရပါ။ တတိယပါတီ၏ အမှတ်တံဆိပ်များ သို့မဟုတ် logo များကို အသုံးပြုခြင်းသည် အဆိုပါ တတိယပါတီ၏ မူဝါဒများကို လိုက်နာရမည်ဖြစ်သည်။

---

**အကြောင်းကြားချက်**:  
ဤစာရွက်စာတမ်းကို AI ဘာသာပြန်ဝန်ဆောင်မှု [Co-op Translator](https://github.com/Azure/co-op-translator) ကို အသုံးပြု၍ ဘာသာပြန်ထားပါသည်။ ကျွန်ုပ်တို့သည် တိကျမှုအတွက် ကြိုးစားနေသော်လည်း အလိုအလျောက် ဘာသာပြန်မှုများတွင် အမှားများ သို့မဟုတ် မတိကျမှုများ ပါဝင်နိုင်သည်ကို သတိပြုပါ။ မူရင်းဘာသာစကားဖြင့် ရေးသားထားသော စာရွက်စာတမ်းကို အာဏာတရ အရင်းအမြစ်အဖြစ် သတ်မှတ်သင့်ပါသည်။ အရေးကြီးသော အချက်အလက်များအတွက် လူ့ဘာသာပြန်ပညာရှင်များကို အသုံးပြုရန် အကြံပြုပါသည်။ ဤဘာသာပြန်မှုကို အသုံးပြုခြင်းမှ ဖြစ်ပေါ်လာသော အလွဲသုံးစားမှု သို့မဟုတ် အနားလွဲမှုများအတွက် ကျွန်ုပ်တို့သည် တာဝန်မယူပါ။