# Microsoft ၏ တာဝန်ရှိသော AI စည်းကမ်းများကို ဦးတည်၍ Microsoft Foundry တွင် Fine-tuned Phi-3 / Phi-3.5 မော်ဒယ်ကို သုံးသပ်ခြင်း
...
### Microsoft Foundry တွင် Fine-tuned Phi-3 / Phi-3.5 မော်ဒယ်၏ လုံခြုံမှုနှင့် စွမ်းဆောင်ရည်ကို မည်သို့ သုံးသပ်နိုင်မလဲ?

မော်ဒယ်တစ်ခုကို fine-tune လုပ်ခြင်းသည် မမျှော်လင့်ထားသော သို့မဟုတ် မလိုလားအပ်သော တုံ့ပြန်ချက်များ ဖြစ်ပေါ်စေနိုင်သည်။ မော်ဒယ်သည် လုံခြုံပြီး ထိရောက်မှုရှိနေစေရန်အတွက်၊ မော်ဒယ်မှ ထုတ်ပေးနိုင်သော အန္တရာယ်ရှိသော အကြောင်းအရာများနှင့် တိကျမှန်ကန်ပြီး သက်ဆိုင်မှုရှိသော၊ စည်းလုံးညီညွတ်သော တုံ့ပြန်ချက်များ ထုတ်ပေးနိုင်မှုကို သုံးသပ်ရန် အရေးကြီးသည်။ ဤသင်ခန်းစာတွင် Microsoft Foundry တွင် Prompt flow နှင့် ပေါင်းစပ်ထားသော Fine-tuned Phi-3 / Phi-3.5 မော်ဒယ်၏ လုံခြုံမှုနှင့် စွမ်းဆောင်ရည်ကို မည်သို့ သုံးသပ်ရမည်ကို သင်ယူမည်ဖြစ်သည်။

အောက်တွင် Microsoft Foundry ၏ သုံးသပ်မှု လုပ်ငန်းစဉ်ကို ဖော်ပြထားသည်။
...
1. [**Scenario 1: Microsoft Foundry ၏ Prompt flow သုံးသပ်မှု မိတ်ဆက်**](../../../../../../md/02.Application/01.TextAndChat/Phi3)
...
1. [**Scenario 2: Microsoft Foundry တွင် Phi-3 / Phi-3.5 မော်ဒယ် သုံးသပ်ခြင်း**](../../../../../../md/02.Application/01.TextAndChat/Phi3)
    ...
    - [Microsoft Foundry ၏ Prompt flow သုံးသပ်မှုဖြင့် Fine-tuned Phi-3 / Phi-3.5 မော်ဒယ် သုံးသပ်ခြင်း](../../../../../../md/02.Application/01.TextAndChat/Phi3)

1. [ဂုဏ်ယူပါတယ်!](../../../../../../md/02.Application/01.TextAndChat/Phi3)

## **Scenario 1: Microsoft Foundry ၏ Prompt flow သုံးသပ်မှု မိတ်ဆက်**

### လုံခြုံမှု သုံးသပ်မှု မိတ်ဆက်

သင့် AI မော်ဒယ်သည် သမာဓိရှိပြီး လုံခြုံကြောင်း သေချာစေရန် Microsoft ၏ တာဝန်ရှိသော AI စည်းကမ်းများနှင့် ကိုက်ညီမှုရှိမရှိ သုံးသပ်ရမည်။ Microsoft Foundry တွင် လုံခြုံမှု သုံးသပ်မှုများက မော်ဒယ်၏ jailbreak တိုက်ခိုက်မှုများအပေါ် အားနည်းချက်နှင့် အန္တရာယ်ရှိသော အကြောင်းအရာများ ထုတ်ပေးနိုင်မှုကို သုံးသပ်နိုင်စေပြီး၊ ၎င်းသည် တိုက်ရိုက် Microsoft ၏ တာဝန်ရှိသော AI စည်းကမ်းများနှင့် ကိုက်ညီသည်။
...
ဤသင်ခန်းစာတွင် Microsoft Foundry ၏ လုံခြုံမှု မီထရစ်များကို အသုံးပြု၍ Fine-tuned Phi-3 မော်ဒယ်၏ လုံခြုံမှုကို သုံးသပ်မည်ဖြစ်သည်။ ဤမီထရစ်များက မော်ဒယ်မှ အန္တရာယ်ရှိသော အကြောင်းအရာ ထုတ်ပေးနိုင်မှုနှင့် jailbreak တိုက်ခိုက်မှုများအပေါ် အားနည်းချက်ကို သုံးသပ်ရာတွင် အကူအညီပေးသည်။ လုံခြုံမှု မီထရစ်များမှာ -
...
ဤသင်ခန်းစာတွင် Microsoft Foundry ၏ စွမ်းဆောင်ရည် မီထရစ်များကို အသုံးပြု၍ Fine-tuned Phi-3 / Phi-3.5 မော်ဒယ်၏ စွမ်းဆောင်ရည်ကို သုံးသပ်မည်ဖြစ်သည်။ ဤမီထရစ်များက မော်ဒယ်မှ တိကျမှန်ကန်ပြီး သက်ဆိုင်မှုရှိသော၊ စည်းလုံးညီညွတ်သော တုံ့ပြန်ချက်များ ထုတ်ပေးနိုင်မှုကို သုံးသပ်ရာတွင် အကူအညီပေးသည်။ စွမ်းဆောင်ရည် မီထရစ်များမှာ -
...
Microsoft Foundry တွင် သင့် fine-tuned Phi-3 / Phi-3.5 မော်ဒယ်ကို Prompt flow ထဲသို့ ပေါင်းစည်းရန် လိုအပ်ပါသည်။

#### Microsoft Foundry Hub တည်ဆောက်ခြင်း

Project တည်ဆောက်မည့်အရင်မှာ Hub တစ်ခု ဖန်တီးရပါမည်။ Hub သည် Resource Group အဖြစ် လုပ်ဆောင်ပြီး Microsoft Foundry အတွင်းရှိ Project များစွာကို စီမံခန့်ခွဲရန် အဆင်ပြေစေပါသည်။

1. [Microsoft Foundry](https://ai.azure.com/?wt.mc_id=studentamb_279723) တွင် လက်မှတ်ထိုးဝင်ပါ။
...
#### Microsoft Foundry Project တည်ဆောက်ခြင်း
...
1. ဖန်တီးထားသော Microsoft Foundry project သို့ သွားပါ။
...
Microsoft Foundry တွင် custom connection ထည့်သွင်းပြီးပါပြီ။ ယခုအခါ အောက်ပါအဆင့်များဖြင့် Prompt flow တစ်ခု ဖန်တီးပါ။ ထို့နောက် Prompt flow ကို custom connection နှင့် ချိတ်ဆက်၍ fine-tuned မော်ဒယ်ကို Prompt flow အတွင်း အသုံးပြုနိုင်ပါမည်။
...
> [!NOTE]
> Microsoft Foundry တွင် Prompt flow အသုံးပြုနည်း ပိုမိုအသေးစိတ် သိရှိလိုပါက [Prompt flow in Microsoft Foundry](https://learn.microsoft.com/azure/ai-studio/how-to/prompt-flow) ကို ကြည့်ရှုနိုင်ပါသည်။
...
Phi-3 / Phi-3.5 မော်ဒယ်ကို Microsoft Foundry တွင် သုံးသပ်ရန် Azure OpenAI မော်ဒယ်တစ်ခု တပ်ဆင်ရပါမည်။ ဤမော်ဒယ်ကို Phi-3 / Phi-3.5 မော်ဒယ်၏ စွမ်းဆောင်ရည်ကို သုံးသပ်ရန် အသုံးပြုပါမည်။
...
### Microsoft Foundry ၏ Prompt flow evaluation ဖြင့် fine-tuned Phi-3 / Phi-3.5 မော်ဒယ်ကို သုံးသပ်ခြင်း
...
သင်သည် Microsoft Foundry တွင် Prompt flow ဖြင့် ပေါင်းစပ်ထားသော fine-tuned Phi-3 မော်ဒယ်ကို အောင်မြင်စွာ အကဲဖြတ်နိုင်ခဲ့ပါသည်။ ၎င်းသည် သင်၏ AI မော်ဒယ်များသည် ကောင်းမွန်စွာ လုပ်ဆောင်နိုင်ခြင်းသာမက Microsoft ၏ တာဝန်ရှိသော AI စည်းကမ်းများကိုလည်း လိုက်နာကာ ယုံကြည်စိတ်ချရပြီး ယုံကြည်စိတ်ချရသော AI အက်ပလီကေးရှင်းများ တည်ဆောက်ရာတွင် အရေးကြီးသော အဆင့်ဖြစ်ပါသည်။
...
- [Microsoft Foundry စာတမ်းများ](https://learn.microsoft.com/azure/ai-studio/?wt.mc_id=studentamb_279723)
...
- [Microsoft Foundry မိတ်ဆက်](https://learn.microsoft.com/training/modules/introduction-to-azure-ai-studio/?wt.mc_id=studentamb_279723)
