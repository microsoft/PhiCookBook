...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-09T19:32:43+00:00",
...
ယခင် Lab မှာ NPU နဲ့ cloud ကို ပေါင်းစပ်ပြီး Phi3 Agent အတွက် Visual Studio Code Extension တစ်ခု ပြီးစီးခဲ့ပါတယ်။
...
***NOTE:*** Visual Studio Code Insiders 1.90+ မှာ ပြေးရန် လိုအပ်ပါသည်။
...
***နမူနာကုဒ် ဒေါင်းလုပ်*** [ဒီမှာနှိပ်ပါ](../../../../../../../../../code/07.Lab/01/AIPC)
...
export function activate(extcontext: vscode.ExtensionContext) {
	...
	const phi3handler: vscode.ChatRequestHandler = async (request: vscode.ChatRequest, context: vscode.ChatContext, stream: vscode.ChatResponseStream, token: vscode.CancellationToken): Promise<IPHI3ChatResult> => {
		...
		if (request.command == 'img') {
			...
			{
				var result = "```txt"+"\n\n"+"ဒီလို မေးခွန်းမေးပါ Your question (IMG_URL:https://example.com/image.jpg)"+"\n\n"++"```";
...
ဂုဏ်ယူပါတယ်! Lab အားလုံး ပြီးစီးပါပြီ။ Phi-3 မိသားစုနဲ့ GitHub Copilot Chat ကို ဘယ်လို အသုံးပြုရမယ်ဆိုတာ နားလည်ဖို့ အထောက်အကူဖြစ်မယ်လို့ မျှော်လင့်ပါတယ်။
