...
Microsoft Foundry project နှင့် hub တည်ဆောက်ခြင်းသည် သင့် AI လုပ်ငန်းများကို စနစ်တကျ စီမံခန့်ခွဲရန် အကောင်းဆုံးနည်းလမ်းဖြစ်သည်။ စတင်ရန် အဆင့်ဆင့် လမ်းညွှန်ချက်如下:

### Microsoft Foundry တွင် Project တည်ဆောက်ခြင်း

1. **Microsoft Foundry သို့ သွားပါ**: Microsoft Foundry portal တွင် လက်မှတ်ထိုးဝင်ပါ။
2. **Project တစ်ခု ဖန်တီးပါ**:
   - သင်သည် project အတွင်းရှိပါက၊ စာမျက်နှာ၏ ဘယ်ဘက်အပေါ်တွင် "Microsoft Foundry" ကို ရွေးချယ်၍ Home စာမျက်နှာသို့ ပြန်သွားပါ။
...
### Microsoft Foundry တွင် Hub တည်ဆောက်ခြင်း

1. **Microsoft Foundry သို့ သွားပါ**: သင့် Azure အကောင့်ဖြင့် လက်မှတ်ထိုးဝင်ပါ။
...
## **3. Microsoft Foundry တွင် Playground Chat Phi အသုံးပြုခြင်း**

Deployment စာမျက်နှာသို့ သွားပြီး Playground ကို ရွေးချယ်ကာ Microsoft Foundry ၏ Phi-3 နှင့် စကားပြောပါ။

## **4. Microsoft Foundry မှ မော်ဒယ် တပ်ဆင်ခြင်း**

Azure Model Catalog မှ မော်ဒယ်တစ်ခု တပ်ဆင်ရန် အောက်ပါအဆင့်များကို လိုက်နာနိုင်ပါသည်။

- Microsoft Foundry တွင် လက်မှတ်ထိုးဝင်ပါ။
- Microsoft Foundry model catalog မှ တပ်ဆင်လိုသော မော်ဒယ်ကို ရွေးချယ်ပါ။
