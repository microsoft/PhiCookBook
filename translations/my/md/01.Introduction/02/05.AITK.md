...
[AI Toolkit for VS Code](https://marketplace.visualstudio.com/items?itemName=ms-windows-ai-studio.windows-ai-studio) သည် Microsoft Foundry Catalog နှင့် Hugging Face ကဲ့သို့သော အခြား catalog များမှ နောက်ဆုံးပေါ် AI ဖွံ့ဖြိုးရေးကိရိယာများနှင့် မော်ဒယ်များကို ပေါင်းစပ်ပေးခြင်းဖြင့် generative AI app ဖန်တီးမှုကို လွယ်ကူစေသည်။ GitHub Models နှင့် Microsoft Foundry Model Catalogs မှ ထောက်ပံ့ထားသော AI မော်ဒယ်များ catalog ကို ကြည့်ရှုနိုင်ပြီး၊ ဒေါင်းလုပ်လုပ်၍ ဒေသတွင်း သို့မဟုတ် ဝေးလံရာမှ fine-tune၊ စမ်းသပ်ပြီး သင့် application တွင် အသုံးပြုနိုင်ပါသည်။
