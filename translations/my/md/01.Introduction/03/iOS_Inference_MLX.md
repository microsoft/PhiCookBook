...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-09T20:02:41+00:00",
...
မော်ဒယ်များကို preload လုပ်ခြင်းနှင့် inference လုပ်ခြင်းအတွက် လိုအပ်သော dependencies နှင့် helper များ ပါဝင်သော [MLX Examples package](https://github.com/ml-explore/mlx-swift-examples) ကို ထည့်သွင်းပါ။
...
အခြေခံ [MLX Swift package](https://github.com/ml-explore/mlx-swift) သည် tensor operation များနှင့် အခြေခံ ML လုပ်ဆောင်ချက်များအတွက် လုံလောက်သော်လည်း၊ MLX Examples package သည် ဘာသာစကား မော်ဒယ်များနှင့် inference လုပ်ငန်းစဉ်ကို ပိုမိုလွယ်ကူစေရန် အပို components များ ပါဝင်သည်။

- Hugging Face မှ မော်ဒယ်ဒေါင်းလုပ်လုပ်ခြင်းကို စီမံခန့်ခွဲသော မော်ဒယ် loading utilities
- tokenizer ပေါင်းစည်းမှု
- စာသားထုတ်လုပ်မှုအတွက် inference helpers
- ကြိုတင်ပြင်ဆင်ထားသော မော်ဒယ် သတ်မှတ်ချက်များ

## အဆင့် ၃: Entitlements များ ပြင်ဆင်ခြင်း

အက်ပလီကေးရှင်းအား မော်ဒယ်ဒေါင်းလုပ်လုပ်ခွင့်နှင့် လုံလောက်သော memory ခွဲဝေပေးရန် အတွက် အထူး entitlements များ ထည့်သွင်းရမည်။ သင့်အက်ပလီကေးရှင်းအတွက် `.entitlements` ဖိုင်ကို အောက်ပါအတိုင်း ဖန်တီးပါ။
...
> **Note:** `com.apple.developer.kernel.increased-memory-limit` entitlement သည် မော်ဒယ်အရွယ်အစားကြီးများကို ပြေးဆွဲရာတွင် အရေးကြီးသည်။ အက်ပလီကေးရှင်းအား ပုံမှန်ထက် memory ပိုမိုတောင်းဆိုခွင့်ပြုသည်။

## အဆင့် ၄: Chat Message Model ဖန်တီးခြင်း

ပထမဦးဆုံး chat message များကို ကိုယ်စားပြုရန် အခြေခံ structure တစ်ခု ဖန်တီးပါ။
...
- မိုဘိုင်းစက်များတွင် memory အသုံးပြုမှုကို အကောင်းဆုံးဖြစ်စေရန် `MLX.GPU.set(cacheLimit:)` ဖြင့် GPU cache ကန့်သတ်ချက် သတ်မှတ်ခြင်း
- `LLMModelFactory` ကို အသုံးပြု၍ မော်ဒယ်ကို လိုအပ်သလို ဒေါင်းလုပ်လုပ်ပြီး MLX အတွက် optimize ပြုလုပ်ထားသော မော်ဒယ်ကို စတင်ခြင်း
...
- temperature နှင့် token ကန့်သတ်ချက်များကို သင့်တော်စွာ စီမံခန့်ခွဲ၍ inference လုပ်ငန်းစဉ်ကို ထိန်းချုပ်ခြင်း

streaming token ထုတ်လုပ်မှုနည်းလမ်းသည် မော်ဒယ်မှ စာသားထုတ်လုပ်သည့်အခါ အသုံးပြုသူအား ချက်ချင်းတုံ့ပြန်မှု ပေးနိုင်သည်။ ၎င်းသည် server-based မော်ဒယ်များကဲ့သို့ token များကို စီးဆင်းပေးသော်လည်း network request ၏ နောက်ကျမှု မရှိပါ။
...
> **Important:** Phi မော်ဒယ်များကို MLX ၏ default သို့မဟုတ် GGUF ဖော်မတ်ဖြင့် မသုံးနိုင်ပါ။ MLX ဖော်မတ်သို့ ပြောင်းလဲထားရမည်ဖြစ်ပြီး ၎င်းကို MLX community မှ စီမံခန့်ခွဲသည်။ ပြောင်းလဲပြီး မော်ဒယ်များကို [huggingface.co/mlx-community](https://huggingface.co/mlx-community) တွင် ရှာဖွေနိုင်သည်။
...
သင်သည် Hugging Face တွင် ရှိသည့် ကိုက်ညီသော မော်ဒယ် မည်သည့်မော်ဒယ်ကိုမဆို ကိုယ်ပိုင် မော်ဒယ် configuration များ ဖန်တီးနိုင်သည်။ ဥပမာအားဖြင့် Phi-4 mini ကို အသုံးပြုလိုပါက ကိုယ်ပိုင် configuration ကို အောက်ပါအတိုင်း သတ်မှတ်နိုင်သည်။
...
ယခုအခါ view model နှင့် ဆက်သွယ်ရန် ရိုးရှင်းသော chat interface တစ်ခုကို အကောင်အထည်ဖော်ပါ။
...
## အဆင့် ၇: အက်ပလီကေးရှင်း တည်ဆောက်ခြင်းနှင့် ပြေးဆွဲခြင်း

ယခုအခါ အက်ပလီကေးရှင်းကို တည်ဆောက်ပြီး ပြေးဆွဲရန် အသင့်ဖြစ်ပါပြီ။

> **Important!** MLX သည် simulator ကို မထောက်ပံ့ပါ။ Apple Silicon chip ပါသော စက်တစ်လုံးပေါ်တွင်သာ အက်ပလီကေးရှင်းကို ပြေးဆွဲရမည်။ အသေးစိတ်အချက်အလက်များအတွက် [ဒီနေရာ](https://swiftpackageindex.com/ml-explore/mlx-swift/main/documentation/mlx/running-on-ios#Developing-for-iOS) ကို ကြည့်ပါ။
...
iPad Air M1 ပေါ်တွင် အက်ပလီကေးရှင်း ပြေးဆွဲနေသည့် ပုံစံမှာ အောက်ပါအတိုင်း ဖြစ်သည်။
