...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-09T19:08:30+00:00",
...
ဤကိရိယာသည် စက်မှုလုပ်ငန်းတွင် အသုံးပြုသော hardware architecture များအတွက် မော်ဒယ်များကို ထိရောက်စွာ အသုံးပြုနိုင်ရန် အဆင့်မြှင့်တင်ခြင်းလုပ်ငန်းစဉ်ကို လွယ်ကူစေဖို့ ရည်ရွယ်ထားသည်။
...
## အဓိက လက္ခဏာများ
- Olive သည် လိုအပ်သော hardware target များအတွက် optimization နည်းပညာများကို စုပေါင်းပြီး အလိုအလျောက် လုပ်ဆောင်ပေးသည်။
...
- Olive သည် လိုအပ်သော hardware အတွက် optimization နည်းပညာများကို အလိုအလျောက် လုပ်ဆောင်ပေးခြင်းဖြင့် အတွေ့အကြုံကို လွယ်ကူစေသည်။

## အသုံးပြုနိုင်သော End-to-End Optimization ဖြေရှင်းချက်
ပေါင်းစပ်ပြီး အဆင့်မြှင့်တင်နည်းပညာများကို တစ်စုတစ်စည်းအဖြစ် ဖန်တီးခြင်းဖြင့် Olive သည် end-to-end optimization အတွက် ညီညွတ်သော ဖြေရှင်းချက်တစ်ခုကို ပေးစွမ်းသည်။
...
ONNX မော်ဒယ်ကို CPU ဖြင့် run မည်ဆိုလျှင်

```bash
pip install olive-ai[cpu]
```

GPU ဖြင့် run မည်ဆိုလျှင်

```python
pip install olive-ai[gpu]
```

Azure ML အသုံးပြုမည်ဆိုလျှင်
...
Local ဖြစ်ရန်လိုလျှင် ဒေတာရင်းမြစ်များကို တိုက်ရိုက်အသုံးပြုနိုင်သည်။ Azure AI Studio / Azure Machine Learning Service ၏ အရင်းအမြစ်များကို အသုံးပြုရန် လိုလျှင် Azure parameter များ၊ ကွန်ပျူတာအင်အားအမည်များ စသည့် ဆက်တင်များ ပြင်ဆင်ရမည်။
...
Azure AI Studio/Azure Machine Learning Service တွင် container ဖြင့် run ဖြစ်သောကြောင့် လိုအပ်သော ပတ်ဝန်းကျင်ကို conda.yaml ဖိုင်တွင် ပြင်ဆင်ရမည်။
...
**သတိပြုရန်:**
Azure AI Studio / Azure Machine Learning Service နှင့် ပေါင်းစည်းရန် လိုအပ်သဖြင့် မော်ဒယ်တပ်ဆင်ရာတွင် ဗားရှင်းနံပါတ်နှင့် နာမည်များကို ကိုးကားပါ။
...
Microsoft Olive သည် Lora နှင့် QLora fine-tuning အယ်လဂိုရီသမ်များကို ကောင်းစွာ ထုပ်ပိုးထားသည်။ သင့်အား ပြင်ဆင်ရမည့် parameter အချို့သာ ရှိသည်။ ဤနေရာတွင် QLora ကို ဥပမာအဖြစ် ယူထားသည်။
...
- အထက်ဖော်ပြပါ အဆင့်များကို သင့်လိုအပ်ချက်အရ ပြင်ဆင်နိုင်ပြီး အားလုံးကို တစ်ပြိုင်နက် ပြင်ဆင်ရန် မလိုအပ်ပါ။ လိုအပ်သလို အယ်လဂိုရီသမ်အဆင့်များကို တိုက်ရိုက် အသုံးပြုနိုင်ပြီး နောက်ဆုံးတွင် engine များကို ပြင်ဆင်ရမည်။
...
Command line တွင် olive-config.json ဖိုင်ရှိ directory တွင် အောက်ပါအတိုင်း အမိန့်ကို အကောင်အထည်ဖော်ပါ။
