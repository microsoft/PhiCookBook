...
Kami menghadirkan [Guidance](https://github.com/guidance-ai/guidance) ke endpoint serverless Phi-3.5-mini di Microsoft Foundry untuk membuat output lebih dapat diprediksi dengan mendefinisikan struktur yang disesuaikan dengan aplikasi. Dengan Guidance, Anda bisa menghilangkan kebutuhan retry yang mahal, dan misalnya, membatasi model untuk memilih dari daftar yang sudah ditentukan (misalnya, kode medis), membatasi output hanya pada kutipan langsung dari konteks yang diberikan, atau mengikuti pola regex tertentu. Guidance mengarahkan model token demi token dalam tumpukan inferensi, mengurangi biaya dan latensi sebesar 30-50%, menjadikannya tambahan yang unik dan berharga untuk [endpoint serverless Phi-3-mini](https://aka.ms/try-phi3.5mini).
