...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-16T15:03:35+00:00",
...
Phi বর্তমানে সবচেয়ে শক্তিশালী এবং খরচে সাশ্রয়ী ছোট ভাষা মডেল (SLM), যা বহু ভাষা, যুক্তি, টেক্সট/চ্যাট জেনারেশন, কোডিং, ছবি, অডিও এবং অন্যান্য পরিস্থিতিতে খুব ভালো পারফরম্যান্স দেখায়।
...
![cover](../../translated_images/cover.eb18d1b9605d754b30973f4e17c6e11ea4f8473d9686ee378d6e7b44e3c70ac7.bn.png)
...
- পরিচিতি  
  ...
  - [Phi মডেল ও প্ল্যাটফর্ম জুড়ে প্রাপ্যতা](./md/01.Introduction/01/01.Edgeandcloud.md)  
...
- Phi অ্যাপ্লিকেশন ডেভেলপমেন্ট স্যাম্পলস  
  - টেক্সট ও চ্যাট অ্যাপ্লিকেশন  
    - Phi-4 স্যাম্পলস 🆕  
      ...
      - [Semantic Kernel ব্যবহার করে Phi-4 ONNX দিয়ে .NET কনসোল অ্যাপ চ্যাট](../../md/04.HOL/dotnet/src/LabsPhi4-Chat-02SK)  
    - Phi-3 / 3.5 স্যাম্পলস  
      ...
      - [MLFlow - একটি র‍্যাপার তৈরি এবং Phi-3 MLFlow-এর সাথে ব্যবহার](./md//02.Application/01.TextAndChat/Phi3/E2E_Phi-3-MLflow.md)  
      - [মডেল অপটিমাইজেশন - Phi-3-mini মডেল ONNX Runtime Web-এর জন্য Olive দিয়ে কীভাবে অপটিমাইজ করবেন](https://github.com/microsoft/Olive/tree/main/examples/phi3)  
...
- Azure AI Inference SDK কোড ভিত্তিক নমুনা
  ...
  - Phi-3 / 3.5 নমুনা
    - [Microsoft Phi-3 পরিবার দিয়ে নিজের Visual Studio Code GitHub Copilot চ্যাট তৈরি করুন](./md/02.Application/02.Code/Phi3/VSCodeExt/README.md)
    - [GitHub মডেল দিয়ে Phi-3.5 ব্যবহার করে নিজের Visual Studio Code চ্যাট কপিলট এজেন্ট তৈরি করুন](/md/02.Application/02.Code/Phi3/CreateVSCodeChatAgentWithGitHubModels.md)
...
- অডিও নমুনা
  - Phi-4 নমুনা 🆕
    ...
    - [Phi-4-multimodal অডিও ব্যবহার করে অডিও ফাইল বিশ্লেষণ এবং ট্রান্সক্রিপ্ট তৈরি করার জন্য .NET কনসোল অ্যাপ্লিকেশন](../../md/04.HOL/dotnet/src/LabsPhi4-MultiModal-02Audio)
...
- ফাংশন কলিং নমুনা
  - Phi-4 নমুনা 🆕
    - [📓] [Phi-4-mini এর সাথে ফাংশন কলিং ব্যবহার করা](./md/02.Application/07.FunctionCalling/Phi4/FunctionCallingBasic/README.md)
...
- মাল্টিমোডাল মিক্সিং নমুনা
  - Phi-4 নমুনা 🆕
    ...
    - [Phi-4-multimodal ব্যবহার করে ছবি বিশ্লেষণ করার জন্য .NET কনসোল অ্যাপ্লিকেশন](../../md/04.HOL/dotnet/src/LabsPhi4-MultiModal-01Images)
...
- Phi ফাইন-টিউনিং
  ...
  - [VS Code এর AI Toolkit দিয়ে Phi-3 ফাইন-টিউনিং](./md/03.FineTuning/Finetuning_VSCodeaitoolkit.md)
...
- হ্যান্ডস অন ল্যাব
  - [সর্বাধুনিক মডেল অন্বেষণ: LLMs, SLMs, স্থানীয় ডেভেলপমেন্ট এবং আরও অনেক কিছু](https://github.com/microsoft/aitour-exploring-cutting-edge-models)
...
- একাডেমিক গবেষণা পত্র এবং প্রকাশনা
  ...
  - [(WhyPHI) বহু-বিকল্প প্রশ্নোত্তরের জন্য PHI-3 ফাইন-টিউনিং: পদ্ধতি, ফলাফল এবং চ্যালেঞ্জ](https://arxiv.org/abs/2501.01588)
...
আপনি Microsoft Phi কীভাবে ব্যবহার করবেন এবং বিভিন্ন হার্ডওয়্যার ডিভাইসে E2E সমাধান কীভাবে তৈরি করবেন তা শিখতে পারেন। Phi নিজে থেকে অনুভব করতে, মডেলের সাথে খেলতে শুরু করুন এবং আপনার পরিস্থিতির জন্য Phi কাস্টমাইজ করুন [GitHub Model Catalog](https://github.com/marketplace/models?WT.mc_id=aiml-137032-kinfeylo) ব্যবহার করে। আরও জানতে পারেন [GitHub Model Catalog শুরু করার গাইড]( /md/02.QuickStart/GitHubModel_QuickStart.md) থেকে।
...
বড় আকারের প্রাকৃতিক ভাষা, ছবি, এবং ভাষণ মডেলগুলো—যেমন এই নমুনায় ব্যবহৃত মডেলগুলো—সম্ভাব্যভাবে এমন আচরণ করতে পারে যা অন্যায়, অবিশ্বস্ত বা আপত্তিকর হতে পারে, যা ক্ষতি ডেকে আনতে পারে। ঝুঁকি ও সীমাবদ্ধতা সম্পর্কে অবগত হতে [Azure OpenAI service Transparency note](https://learn.microsoft.com/legal/cognitive-services/openai/transparency-note?tabs=text) দেখুন।

এই ঝুঁকিগুলো কমানোর জন্য সুপারিশকৃত পদ্ধতি হলো আপনার আর্কিটেকচারে একটি নিরাপত্তা ব্যবস্থা অন্তর্ভুক্ত করা যা ক্ষতিকর আচরণ সনাক্ত ও প্রতিরোধ করতে পারে। [Azure AI Content Safety](https://learn.microsoft.com/azure/ai-services/content-safety/overview) একটি স্বাধীন সুরক্ষা স্তর প্রদান করে, যা অ্যাপ্লিকেশন ও সেবায় ক্ষতিকর ব্যবহারকারী-উত্পাদিত এবং AI-উত্পাদিত বিষয়বস্তু সনাক্ত করতে সক্ষম। Azure AI Content Safety-তে টেক্সট এবং ইমেজ API রয়েছে যা ক্ষতিকর উপাদান সনাক্ত করতে সাহায্য করে। Azure AI Foundry-র মধ্যে Content Safety সার্ভিস আপনাকে বিভিন্ন মাধ্যম জুড়ে ক্ষতিকর বিষয়বস্তু সনাক্ত করার জন্য নমুনা কোড দেখতে, অন্বেষণ করতে এবং চেষ্টা করতে দেয়। নিম্নলিখিত [quickstart ডকুমেন্টেশন](https://learn.microsoft.com/azure/ai-services/content-safety/quickstart-text?tabs=visual-studio%2Clinux&pivots=programming-language-rest) আপনাকে সার্ভিসে রিকোয়েস্ট পাঠানোর প্রক্রিয়ায় গাইড করবে।

আরেকটি বিষয় যা বিবেচনা করতে হবে তা হলো সামগ্রিক অ্যাপ্লিকেশন পারফরম্যান্স। মাল্টি-মোডাল এবং মাল্টি-মডেল অ্যাপ্লিকেশনগুলোর ক্ষেত্রে, পারফরম্যান্স বলতে আমরা বুঝি যে সিস্টেমটি আপনার এবং আপনার ব্যবহারকারীদের প্রত্যাশা অনুযায়ী কাজ করছে, যার মধ্যে ক্ষতিকর আউটপুট তৈরি না করাও অন্তর্ভুক্ত। আপনার সামগ্রিক অ্যাপ্লিকেশনের পারফরম্যান্স মূল্যায়ন করা গুরুত্বপূর্ণ [Performance and Quality and Risk and Safety evaluators](https://learn.microsoft.com/azure/ai-studio/concepts/evaluation-metrics-built-in) ব্যবহার করে। এছাড়াও আপনি [custom evaluators](https://learn.microsoft.com/azure/ai-studio/how-to/develop/evaluate-sdk#custom-evaluators) তৈরি ও মূল্যায়ন করার ক্ষমতাও রাখেন।
...
Microsoft ট্রেডমার্ক বা লোগো এই প্রকল্পের সংশোধিত সংস্করণে ব্যবহার করলে বিভ্রান্তি সৃষ্টি করা বা Microsoft-এর স্পন্সরশিপ বোঝানো যাবে না। তৃতীয় পক্ষের ট্রেডমার্ক বা লোগোর যেকোনো ব্যবহার সেই তৃতীয় পক্ষের নীতিমালা অনুসারে হতে হবে।
