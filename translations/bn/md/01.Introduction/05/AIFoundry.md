# **Microsoft Foundry ব্যবহার করে মূল্যায়ন**

![aistudo](../../../../../translated_images/bn/AIFoundry.9e0b513e999a1c5a.webp)

[Microsoft Foundry](https://ai.azure.com?WT.mc_id=aiml-138114-kinfeylo) ব্যবহার করে আপনার জেনারেটিভ AI অ্যাপ্লিকেশন কীভাবে মূল্যায়ন করবেন। আপনি একক-টর্ন বা বহু-টর্ন কথোপকথন মূল্যায়ন করুক না কেন, Microsoft Foundry মডেলের কর্মক্ষমতা এবং নিরাপত্তা যাচাই করার জন্য প্রয়োজনীয় সরঞ্জাম সরবরাহ করে।

![aistudo](../../../../../translated_images/bn/AIPortfolio.69da59a8e1eaa70f.webp)

## Microsoft Foundry দিয়ে জেনারেটিভ AI অ্যাপ্লিকেশন মূল্যায়ন করার পদ্ধতি
...
## Microsoft Foundry-তে জেনারেটিভ AI মডেল মূল্যায়ন
...
Microsoft Foundry একক-টর্ন এবং জটিল বহু-টর্ন কথোপকথন উভয়ই মূল্যায়ন করার সুযোগ দেয়।  
...
Microsoft Foundry UI থেকে Evaluate পেজ অথবা Prompt Flow পেজে যান।  
...
মূল্যায়ন চালানোর পর, Microsoft Foundry-তে বিস্তারিত মূল্যায়ন মেট্রিক্স লগ, দেখুন এবং বিশ্লেষণ করুন। আপনার অ্যাপ্লিকেশনের সক্ষমতা এবং সীমাবদ্ধতা সম্পর্কে অন্তর্দৃষ্টি পান।
