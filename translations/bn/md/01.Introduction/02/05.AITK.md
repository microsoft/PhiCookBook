...
[AI Toolkit for VS Code](https://marketplace.visualstudio.com/items?itemName=ms-windows-ai-studio.windows-ai-studio) জেনারেটিভ AI অ্যাপ ডেভেলপমেন্টকে সহজ করে তোলে, কারণ এটি Microsoft Foundry Catalog এবং Hugging Face-এর মতো অন্যান্য ক্যাটালগ থেকে আধুনিক AI ডেভেলপমেন্ট টুলস এবং মডেলগুলো একত্রিত করে। আপনি GitHub Models এবং Microsoft Foundry Model Catalogs দ্বারা চালিত AI মডেল ক্যাটালগ ব্রাউজ করতে পারবেন, সেগুলো লোকালি বা রিমোটে ডাউনলোড করতে পারবেন, ফাইন-টিউন, টেস্ট এবং আপনার অ্যাপ্লিকেশনে ব্যবহার করতে পারবেন।
