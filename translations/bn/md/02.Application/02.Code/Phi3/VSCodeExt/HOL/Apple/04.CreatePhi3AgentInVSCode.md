...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-09T19:45:49+00:00",
...
গত ল্যাবে, আমরা MX ফ্রেমওয়ার্ক এবং ক্লাউড একত্রিত করে Phi3 এজেন্টের জন্য একটি Visual Studio Code এক্সটেনশন তৈরি করেছি।
...
এক্সটেনশন প্রজেক্ট তৈরির জন্য এই লিঙ্কটি দেখুন [https://code.visualstudio.com/api/get-started/your-first-extension](https://code.visualstudio.com/api/get-started/your-first-extension)

***NOTE:*** এই প্রজেক্টের জন্য দয়া করে Typescript, WebPack প্রযুক্তিগত সমাধান হিসেবে ব্যবহার করুন

### **২. vscode.d.ts যোগ করুন**

Visual Studio Code Chat API এখনও কোড API-তে মিশে যায়নি, তবে এখন এক্সটেনশনের মাধ্যমে যুক্ত হয়েছে।
...
***NOTE:*** দয়া করে এটি Visual Studio Code Insiders 1.90+ এ চালান
...
***ডাউনলোড স্যাম্পল কোড*** [এখানে ক্লিক করুন](../../../../../../../../../code/07.Lab/01/Apple)
...
অভিনন্দন! আপনি সব ল্যাব সম্পন্ন করেছেন। আশা করি এটি আপনাকে Phi-3 পরিবার এবং GitHub Copilot Chat কীভাবে ব্যবহার করবেন তা বুঝতে সাহায্য করবে।
...
**অস্বীকৃতি**:  
এই নথিটি AI অনুবাদ সেবা [Co-op Translator](https://github.com/Azure/co-op-translator) ব্যবহার করে অনূদিত হয়েছে। আমরা যথাসাধ্য সঠিকতার চেষ্টা করি, তবে স্বয়ংক্রিয় অনুবাদে ভুল বা অমিল থাকতে পারে। মূল নথিটি তার নিজ ভাষায়ই কর্তৃত্বপূর্ণ উৎস হিসেবে বিবেচিত হওয়া উচিত। গুরুত্বপূর্ণ তথ্যের জন্য পেশাদার মানব অনুবাদের পরামর্শ দেওয়া হয়। এই অনুবাদের ব্যবহার থেকে উদ্ভূত কোনো ভুল বোঝাবুঝি বা ভুল ব্যাখ্যার জন্য আমরা দায়বদ্ধ নই।