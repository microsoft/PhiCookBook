...
Microsoft Foundry প্রজেক্ট এবং হাব তৈরি করা আপনার AI কাজ সংগঠিত ও পরিচালনার জন্য একটি চমৎকার উপায়। শুরু করার জন্য ধাপে ধাপে নির্দেশিকা নিচে দেওয়া হলো:

### Microsoft Foundry-তে প্রজেক্ট তৈরি করা

1. **Microsoft Foundry-তে যান**: Microsoft Foundry পোর্টালে সাইন ইন করুন।
2. **প্রজেক্ট তৈরি করুন**:
   - যদি আপনি কোনো প্রজেক্টের মধ্যে থাকেন, তাহলে পৃষ্ঠার বাম উপরের দিকে "Microsoft Foundry" নির্বাচন করে হোম পেজে যান।
...
### Microsoft Foundry-তে হাব তৈরি করা

1. **Microsoft Foundry-তে যান**: আপনার Azure অ্যাকাউন্ট দিয়ে সাইন ইন করুন।
2. **হাব তৈরি করুন**:
...
## **2. Microsoft Foundry-তে Phi মডেল ডিপ্লয় করা**
...
## **3. Microsoft Foundry-তে Playground Chat Phi**

ডিপ্লয়মেন্ট পেজে যান, Playground নির্বাচন করুন এবং Microsoft Foundry-এর Phi-3 এর সাথে চ্যাট করুন।

## **4. Microsoft Foundry থেকে মডেল ডিপ্লয় করা**

Azure Model Catalog থেকে মডেল ডিপ্লয় করতে নিচের ধাপগুলো অনুসরণ করুন:

- Microsoft Foundry-তে সাইন ইন করুন।
- Microsoft Foundry মডেল ক্যাটালগ থেকে ডিপ্লয় করতে চান এমন মডেল নির্বাচন করুন।
...
## **5. Microsoft Foundry-তে Phi API ব্যবহার**
