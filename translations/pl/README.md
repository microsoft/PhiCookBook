...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-09T18:21:25+00:00",
...
- Inference Phi Family  
    ...
    - [Inference Phi na zdalnym serwerze z AI Toolkit](./md/01.Introduction/03/Remote_Interence.md)  
...
- Przykłady wizji  
  ...
  - Przykłady Phi-3 / 3.5  
    ...
    - [Menu bazowane na Phi-3 Vision lokalnym modelu ONNX z użyciem Microsoft.ML.OnnxRuntime .NET](../../md/04.HOL/dotnet/src/LabsPhi304)  
...
- Dostrajanie próbek Phi  
  ...
  - [Laboratorium praktyczne z dostrajania Microsoft Olive](./md/03.FineTuning/olive-lab/readme.md)  
...
Możesz nauczyć się, jak korzystać z Microsoft Phi oraz jak tworzyć kompleksowe rozwiązania na różnych urządzeniach sprzętowych. Aby samodzielnie wypróbować Phi, zacznij od eksperymentowania z modelem i dostosowywania Phi do swoich scenariuszy, korzystając z [Katalogu modeli na GitHub](https://github.com/marketplace/models?WT.mc_id=aiml-137032-kinfeylo). Więcej informacji znajdziesz w przewodniku Rozpoczęcie pracy z [GitHub Model Catalog](/md/02.QuickStart/GitHubModel_QuickStart.md).
