...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-21T12:10:20+00:00",
...
[![GitHub observers](https://img.shields.io/github/watchers/microsoft/phicookbook.svg?style=social&label=Watch)](https://GitHub.com/microsoft/phicookbook/watchers/?WT.mc_id=aiml-137032-kinfeylo)
...
Phi er for øyeblikket den mest kraftfulle og kostnadseffektive småspråkmodellen (SLM), med svært gode resultater innen flerspråklighet, resonnering, tekst-/chatgenerering, koding, bilder, lyd og andre scenarioer. 

Du kan distribuere Phi til skyen eller til edge-enheter, og du kan enkelt bygge generative AI-applikasjoner med begrenset beregningskraft.

Følg disse trinnene for å komme i gang med disse ressursene:
1. **Opprett en fork av depotet**: Klikk [![GitHub-forks](https://img.shields.io/github/forks/microsoft/phicookbook.svg?style=social&label=Fork)](https://GitHub.com/microsoft/phicookbook/network/?WT.mc_id=aiml-137032-kinfeylo)
...
![forside](../../translated_images/cover.eb18d1b9605d754b30973f4e17c6e11ea4f8473d9686ee378d6e7b44e3c70ac7.no.png)
...
- Introduksjon
  ...
  - [Maskinvarestøtte for Phi](./md/01.Introduction/01/01.Hardwaresupport.md)
...
- Inferens av Phi i forskjellige miljøer
...
- Inferens for Phi-familien
    ...
    - [Inferens av Phi med Apple MLX-rammeverk](./md/01.Introduction/03/MLX_Inference.md)
    - [Inferens av Phi på lokal server](./md/01.Introduction/03/Local_Server_Inference.md)
    - [Inferens av Phi på fjernserver ved bruk av AI Toolkit](./md/01.Introduction/03/Remote_Interence.md)
    - [Inferens av Phi med Rust](./md/01.Introduction/03/Rust_Inference.md)
    - [Inferens av Phi -- visjon lokalt](./md/01.Introduction/03/Vision_Inference.md)
    - [Inferens av Phi med Kaito AKS, Azure Containers (offisiell støtte)](./md/01.Introduction/03/Kaito_Inference.md)
-  [Kvantisering av Phi-familien](./md/01.Introduction/04/QuantifyingPhi.md)
    - [Kvantisering av Phi-3.5 / 4 ved hjelp av llama.cpp](./md/01.Introduction/04/UsingLlamacppQuantifyingPhi.md)
    - [Kvantisering av Phi-3.5 / 4 ved bruk av Generative AI-utvidelser for onnxruntime](./md/01.Introduction/04/UsingORTGenAIQuantifyingPhi.md)
    - [Kvantisering av Phi-3.5 / 4 ved bruk av Intel OpenVINO](./md/01.Introduction/04/UsingIntelOpenVINOQuantifyingPhi.md)
    - [Kvantisering av Phi-3.5 / 4 ved bruk av Apple MLX-rammeverk](./md/01.Introduction/04/UsingAppleMLXQuantifyingPhi.md)
...
- Eksempler på Phi-applikasjonsutvikling
  - Tekst- og chatteapplikasjoner
    - Phi-4-eksempler 🆕
      ...
      - [Chat .NET-konsollapp med Phi-4 ONNX ved bruk av Sementic Kernel](../../md/04.HOL/dotnet/src/LabsPhi4-Chat-02SK)
    - Phi-3 / 3.5-eksempler
      ...
      -[WinUI3 Flermodells AI-drevet notatapp - eksempel](https://github.com/microsoft/ai-powered-notes-winui3-sample)
  ...
  - Azure AI Inference SDK kodebaserte eksempler 
    ...
    - Phi-3 / 3.5-eksempler
      ...
      - [Lag din egen Visual Studio Code Chat Copilot-agent med Phi-3.5 fra GitHub Models](/md/02.Application/02.Code/Phi3/CreateVSCodeChatAgentWithGitHubModels.md)

  - Eksempler på avansert resonnement
    - Phi-4-eksempler 🆕
      ...
      - [📓] [Phi-4-mini-resonnement med GitHub Models](./md/02.Application/02.Code/Phi4r/github_models_inference.ipynb)
  ...
  - Visjonseksempler
    ...
    - Phi-3 / 3.5-eksempler
      ...
      - [📓][Phi-3.5 Vision eksempel med flere rammer eller flere bilder](./md/02.Application/04.Vision/Phi3/phi3-vision-demo.ipynb)
  ...
  - Eksempler på funksjonskall
    - Phi-4-eksempler 🆕
      ...
      -  [📓] [Bruke funksjonskall med ONNX](../../md/02.Application/07.FunctionCalling/Phi4/ONNX/onnx_parallel_functioncalling_ipynb)
  - Eksempler på multimodal miksing
    - Phi-4-eksempler 🆕
      -  [📓] [Bruke Phi-4-multimodal som teknologijournalist](../../md/02.Application/08.Multimodel/Phi4/TechJournalist/phi_4_mm_audio_text_publish_news_ipynb)
...
- Finjustering av Phi-eksempler
  ...
  - [Finjustering av Phi-3 med Apple MLX-rammeverket](./md/03.FineTuning/FineTuning_MLX.md)
...
- Akademiske forskningsartikler og publikasjoner
  ...
  - [Phi-4-Mini Technical Report: Kompakte, men kraftige multimodale språkmodeller via Mixture-of-LoRAs](https://arxiv.org/abs/2503.01743)
...
Du kan lære hvordan du bruker Microsoft Phi og hvordan du bygger E2E-løsninger på forskjellige maskinvareenheter. For å oppleve Phi selv, start med å prøve modellene og tilpasse Phi for dine scenarier ved å bruke [Azure AI Foundry Azure AI Model Catalog](https://aka.ms/phi3-azure-ai) du kan lære mer i Komme i gang med [Azure AI Foundry](/md/02.QuickStart/AzureAIFoundry_QuickStart.md)

**Prøveområde**
Hver modell har et eget prøveområde for å teste modellen [Azure AI Playground](https://aka.ms/try-phi3).

### Phi på GitHub-modeller

Du kan lære hvordan du bruker Microsoft Phi og hvordan du bygger E2E-løsninger på forskjellige maskinvareenheter. For å oppleve Phi selv, start med å prøve modellen og tilpasse Phi for dine scenarier ved å bruke [GitHub Model Catalog](https://github.com/marketplace/models?WT.mc_id=aiml-137032-kinfeylo) du kan lære mer i Komme i gang med [GitHub Model Catalog](/md/02.QuickStart/GitHubModel_QuickStart.md)

**Prøveområde**
Hver modell har et eget [prøveområde for å teste modellen](/md/02.QuickStart/GitHubModel_QuickStart.md).
...
Microsoft forplikter seg til å hjelpe kundene våre med å bruke våre AI-produkter på en ansvarlig måte, dele våre erfaringer, og bygge tillitsbaserte partnerskap gjennom verktøy som Transparency Notes og Impact Assessments. Mange av disse ressursene finnes på [https://aka.ms/RAI](https://aka.ms/RAI).
...
Storskala modeller for naturlig språk, bilde og tale - som de som brukes i dette eksempelet - kan potensielt oppføre seg på måter som er urettferdige, upålitelige eller støtende, og som dermed kan forårsake skade. Vennligst se [Azure OpenAI service Transparency note](https://learn.microsoft.com/legal/cognitive-services/openai/transparency-note?tabs=text) for å bli informert om risikoer og begrensninger.

Den anbefalte tilnærmingen for å redusere disse risikoene er å inkludere et sikkerhetssystem i arkitekturen din som kan oppdage og forhindre skadelig oppførsel. [Azure AI Content Safety](https://learn.microsoft.com/azure/ai-services/content-safety/overview) gir et uavhengig beskyttelseslag, i stand til å oppdage skadelig bruker- og AI-generert innhold i applikasjoner og tjenester. Azure AI Content Safety inkluderer tekst- og bilde-APIer som lar deg oppdage materiale som er skadelig. Innenfor Azure AI Foundry lar Content Safety-tjenesten deg vise, utforske og prøve eksempel-kode for å oppdage skadelig innhold på tvers av forskjellige modaliteter. Følgende [hurtigstartdokumentasjon](https://learn.microsoft.com/azure/ai-services/content-safety/quickstart-text?tabs=visual-studio%2Clinux&pivots=programming-language-rest) veileder deg gjennom hvordan du sender forespørsler til tjenesten.

En annen side å ta i betraktning er applikasjonens totale ytelse. Med multimodale og multimodell-applikasjoner mener vi at systemet yter som du og brukerne dine forventer, inkludert at det ikke genererer skadelige utdata. Det er viktig å vurdere ytelsen til hele applikasjonen din ved hjelp av [Performance and Quality and Risk and Safety evaluators](https://learn.microsoft.com/azure/ai-studio/concepts/evaluation-metrics-built-in). Du har også muligheten til å opprette og evaluere med [tilpassede evaluatorer](https://learn.microsoft.com/azure/ai-studio/how-to/develop/evaluate-sdk#custom-evaluators).

Du kan evaluere AI-applikasjonen din i utviklingsmiljøet ved å bruke [Azure AI Evaluation SDK](https://microsoft.github.io/promptflow/index.html). Gitt enten et testdatasett eller et mål, blir generasjonene fra din generative AI-applikasjon kvantitativt målt med innebygde evaluatorer eller tilpassede evaluatorer etter eget valg. For å komme i gang med Azure AI Evaluation SDK for å evaluere systemet ditt, kan du følge [hurtigstart-guiden](https://learn.microsoft.com/azure/ai-studio/how-to/develop/flow-evaluate-sdk). Når du har kjørt en evaluering, kan du [visualisere resultatene i Azure AI Foundry](https://learn.microsoft.com/azure/ai-studio/how-to/evaluate-flow-results). 
...
Bruk av Microsoft-varemerker eller -logoer i modifiserte versjoner av dette prosjektet må ikke føre til forvirring eller antyde at Microsoft sponser prosjektet. Enhver bruk av tredjeparts varemerker eller logoer er underlagt tredjepartenes retningslinjer.
