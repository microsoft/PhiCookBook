...
Vennligst sørg for at følgende Python-biblioteker er installert før bruk (Python 3.10+ anbefales)
...
Det anbefales å bruke ***CUDA 11.6+*** og installere flatten
...
## **1. Analyser bildet med Phi-3-Vision**

Vi ønsker at AI skal kunne analysere innholdet i bildene våre og gi relevante beskrivelser
...
Vi kan få relevante svar ved å kjøre følgende skript i Notebook
...
## **3. Sammenligning av flere bilder**

Phi-3 Vision støtter sammenligning av flere bilder. Vi kan bruke denne modellen for å finne forskjellene mellom bildene.
