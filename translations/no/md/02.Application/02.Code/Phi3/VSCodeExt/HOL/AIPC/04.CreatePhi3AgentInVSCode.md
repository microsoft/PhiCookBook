...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-09T19:32:23+00:00",
...
I Visual Studio Code Copilot Chat kan du administrere hele prosjektet gjennom @workspace. For bedriftsløsninger kan vi også tilpasse Copilot Chats Agent mer fleksibelt.
...
Visual Studio Code Chat API er ennå ikke slått sammen med kode-API-en, men legges nå til via utvidelser.
