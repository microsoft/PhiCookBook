...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-09T19:47:18+00:00",
...
I forrige lab kombinerte vi MX-rammeverket og skyen for å fullføre en Visual Studio Code-utvidelse for Phi3-agenten.
...
***NOTE:*** Bruk Typescript og WebPack som teknologiløsning for dette prosjektet

### **2. Legg til vscode.d.ts**

Visual Studio Code Chat API er ikke enda slått sammen med kode-API-en, men legges nå til via utvidelser.
