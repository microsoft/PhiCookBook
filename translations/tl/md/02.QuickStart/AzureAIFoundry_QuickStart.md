...
Sa pag-unlad ng Generative AI, layunin naming gamitin ang isang pinag-isang platform upang pamahalaan ang iba't ibang LLM at SLM, integrasyon ng datos ng enterprise, fine-tuning/RAG na operasyon, at pagsusuri ng iba't ibang negosyo ng enterprise pagkatapos ng integrasyon ng LLM at SLM, atbp., upang mas mahusay na maipatupad ang mga smart application gamit ang generative AI. Ang [Microsoft Foundry](https://ai.azure.com) ay isang enterprise-level na platform para sa generative AI na aplikasyon.
...
Mabilis nating maideploy ang Phi-3 model sa Microsoft Foundry sa pamamagitan ng simpleng mga hakbang, at pagkatapos ay magagamit ang Microsoft Foundry para tapusin ang mga kaugnay na gawain tulad ng Playground/Chat, Fine-tuning, pagsusuri, at iba pa.
...
Ang paggawa ng Microsoft Foundry project at hub ay isang mahusay na paraan upang ayusin at pamahalaan ang iyong AI na mga gawain. Narito ang step-by-step na gabay para makapagsimula ka:

### Paglikha ng Project sa Microsoft Foundry

1. **Pumunta sa Microsoft Foundry**: Mag-sign in sa Microsoft Foundry portal.
2. **Gumawa ng Project**:
   - Kung nasa loob ka ng isang project, piliin ang "Microsoft Foundry" sa itaas kaliwa ng pahina para pumunta sa Home page.
...
## **4. Pag-deploy ng Model mula sa Microsoft Foundry**

Para mag-deploy ng model mula sa Azure Model Catalog, sundin ang mga hakbang na ito:

- Mag-sign in sa Microsoft Foundry.
- Piliin ang model na gusto mong i-deploy mula sa Microsoft Foundry model catalog.
