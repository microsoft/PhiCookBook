...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-09T19:33:09+00:00",
...
Sa Visual Studio Code Copilot Chat, maaari mong pamahalaan ang buong proyekto gamit ang @workspace. Para sa mga enterprise na sitwasyon, maaari rin nating i-customize nang mas flexible ang Copilot Chat's Agent.

Sa nakaraang Lab, pinagsama natin ang NPU at cloud para makagawa ng Visual Studio Code Extension para sa Phi3 Agent.
...
Mangyaring tingnan ang link na ito [https://code.visualstudio.com/api/get-started/your-first-extension] para gumawa ng Extension project

***NOTE:*** Gamitin ang Typescript at WebPack bilang teknikal na solusyon para sa proyektong ito

### **2. Idagdag ang vscode.d.ts**

Ang Visual Studio Code Chat API ay hindi pa na-merge sa code API, pero maaari na itong idagdag gamit ang extensions.

I-download ang vscode.d.ts [https://github.com/microsoft/vscode/blob/main/src/vscode-dts/vscode.d.ts]
...
Maaari mong patakbuhin ang **npm install** sa terminal at i-debug ang extension para subukan.
...
Congrats! Natapos mo na lahat ng labs. Sana makatulong ito para maintindihan mo ang Phi-3 Family at kung paano gamitin ang GitHub Copilot Chat.
