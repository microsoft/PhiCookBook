...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-05-09T19:48:06+00:00",
...
Sa Visual Studio Code Copilot Chat, maaari mong pamahalaan ang buong proyekto gamit ang @workspace. Para sa mga enterprise na senaryo, maaari rin nating i-customize nang mas flexible ang Copilot Chat's Agent.

Sa nakaraang Lab, pinagsama natin ang MX framework at cloud para makagawa ng Visual Studio Code Extension para sa Phi3 Agent.
...
Mangyaring sundan ang link na ito [https://code.visualstudio.com/api/get-started/your-first-extension](https://code.visualstudio.com/api/get-started/your-first-extension) para gumawa ng Extension project

***NOTE:*** Gumamit ng Typescript at WebPack bilang teknikal na solusyon para sa proyektong ito

### **2. Idagdag ang vscode.d.ts**

Hindi pa naisama ang Visual Studio Code Chat API sa code API, ngunit ngayon ay nadagdag na ito sa pamamagitan ng extensions.
...
Congrats! Natapos mo na ang lahat ng labs. Sana nakatulong ito para mas maintindihan mo ang Phi-3 Family at kung paano gamitin ang GitHub Copilot Chat.
