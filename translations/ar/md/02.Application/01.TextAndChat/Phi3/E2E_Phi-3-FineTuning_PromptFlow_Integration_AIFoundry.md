...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2026-01-06T04:11:01+00:00",
...
1. اختر **ضبط** من قائمة التنقل.
    ...
    ![اختر ضبط.](../../../../../../translated_images/06-06-select-fine-tune.2918a59be55dfeec.ar.png)
...
1. قم بالمهام التالية:
    ...
    ![املأ صفحة الضبط.](../../../../../../translated_images/06-07-fill-finetuning.b6d14c89e7c27d0b.ar.png)
...
1. في هذا التمرين، قمت بضبط نموذج Phi-3 بنجاح باستخدام Azure Machine Learning. يرجى ملاحظة أن عملية الضبط قد تستغرق وقتًا طويلاً. بعد تشغيل مهمة الضبط، تحتاج إلى الانتظار حتى تكتمل. يمكنك مراقبة حالة مهمة الضبط عن طريق الانتقال إلى تبويب الوظائف على الجانب الأيسر من مساحة عمل Azure Machine Learning الخاصة بك. في السلسلة التالية، ستقوم بنشر النموذج الذي تم ضبطه ودمجه مع Prompt flow.
    ...
    ![عرض مهمة الضبط.](../../../../../../translated_images/06-08-output.2bd32e59930672b1.ar.png)
...
3. اختر **تسجيل**.
    ...
    ![اختر تسجيل.](../../../../../../translated_images/07-04-register.fd82a3b293060bc7.ar.png)
...
>
> ![ضبط حركة المرور.](../../../../../../translated_images/07-10-set-traffic.085b847e5751ff3d.ar.png)
>
...
1. اختر **+ مركز جديد** من قائمة التنقل.
    ![إنشاء المحور.](../../../../../../translated_images/08-01-create-hub.8f7dd615bb8d9834.ar.png)
...
1. قم بتنفيذ المهام التالية:
    ...
    ![املأ المحور.](../../../../../../translated_images/08-02-fill-hub.c2d3b505bbbdba7c.ar.png)
...
1. اختر **+ مشروع جديد** من قائمة التنقل.
    ...
    ![اختر مشروع جديد.](../../../../../../translated_images/08-04-select-new-project.390fadfc9c8f8f12.ar.png)

1. أدخل **اسم المشروع**. يجب أن يكون قيمة فريدة.

    ![إنشاء المشروع.](../../../../../../translated_images/08-05-create-project.4d97f0372f03375a.ar.png)
...
1. اختر **نقاط النهاية** من تبويب الجانب الأيسر.
    ...
    ![اختر نقاط النهاية.](../../../../../../translated_images/08-06-select-endpoints.aff38d453bcf9605.ar.png)

1. اختر نقطة النهاية التي أنشأتها.

    ![اختر نقطة النهاية التي أنشأتها.](../../../../../../translated_images/08-07-select-endpoint-created.47f0dc09df2e275e.ar.png)

1. اختر **الاستهلاك** من قائمة التنقل.

1. انسخ **نقطة نهاية REST** و **المفتاح الأساسي** الخاص بك.

    ![انسخ مفتاح API وعنوان URI لنقطة النهاية.](../../../../../../translated_images/08-08-copy-endpoint-key.18f934b5953ae8cb.ar.png)
...
1. اختر **+ اتصال جديد**.
    ...
    ![اختر اتصال جديد.](../../../../../../translated_images/08-09-select-new-connection.02eb45deadc401fc.ar.png)

1. اختر **المفاتيح المخصصة** من قائمة التنقل.

    ![اختر المفاتيح المخصصة.](../../../../../../translated_images/08-10-select-custom-keys.856f6b2966460551.ar.png)
...
1. قم بتنفيذ المهام التالية:
    ...
    ![أضف الاتصال.](../../../../../../translated_images/08-11-add-connection.785486badb4d2d26.ar.png)
...
1. اختر **+ إنشاء** من قائمة التنقل.
    ...
    ![اختر Promptflow.](../../../../../../translated_images/08-12-select-promptflow.6f4b451cb9821e5b.ar.png)

1. اختر **تدفق الدردشة** من قائمة التنقل.

    ![اختر تدفق الدردشة.](../../../../../../translated_images/08-13-select-flow-type.2ec689b22da32591.ar.png)

1. أدخل **اسم المجلد** للاستخدام.

    ![أدخل الاسم.](../../../../../../translated_images/08-14-enter-name.ff9520fefd89f40d.ar.png)
...
1. في Prompt flow، قم بتنفيذ المهام التالية لإعادة بناء التدفق الحالي:
    ...
    ![اختر وضع الملف الخام.](../../../../../../translated_images/08-15-select-raw-file-mode.61d988b41df28985.ar.png)
...
1. أضف الكود التالي إلى ملف *integrate_with_promptflow.py* لاستخدام نموذج Phi-3 المخصص في Prompt flow.
    ...
    ![الصق كود Prompt flow.](../../../../../../translated_images/08-16-paste-promptflow-code.a6041b74a7d09777.ar.png)
...
1. اختر **إدخال الدردشة**، و **إخراج الدردشة** لتمكين الدردشة مع نموذجك.
    ...
    ![إدخال وإخراج.](../../../../../../translated_images/08-17-select-input-output.64dbb39bbe59d03b.ar.png)
...
>
> ![مثال على التدفق.](../../../../../../translated_images/08-18-graph-example.d6457533952e690c.ar.png)
>
...
1. اختر **بدء جلسات الحوسبة** لبدء Prompt flow.
    ...
    ![بدء جلسة الحوسبة.](../../../../../../translated_images/09-01-start-compute-session.a86fcf5be68e386b.ar.png)

1. اختر **التحقق من صحة وتحليل الإدخال** لتحديث المعلمات.

    ![التحقق من صحة الإدخال.](../../../../../../translated_images/09-02-validate-input.317c76ef766361e9.ar.png)

1. اختر **قيمة** الـ **connection** للاتصال المخصص الذي أنشأته. على سبيل المثال، *connection*.

    ![الاتصال.](../../../../../../translated_images/09-03-select-connection.99bdddb4b1844023.ar.png)

#### دردش مع نموذجك المخصص

1. اختر **الدردشة**.

    ![اختر الدردشة.](../../../../../../translated_images/09-04-select-chat.61936dce6612a1e6.ar.png)
...
1. فيما يلي مثال على النتائج: الآن يمكنك الدردشة مع نموذج Phi-3 المخصص الخاص بك. يُنصح بطرح أسئلة بناءً على البيانات المستخدمة لضبط النموذج.
    ...
    ![الدردشة مع Prompt flow.](../../../../../../translated_images/09-05-chat-with-promptflow.c8ca404c07ab126f.ar.png)
