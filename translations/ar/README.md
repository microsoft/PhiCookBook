...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2026-01-05T08:29:03+00:00",
  "source_file": "README.md",
  "language_code": "ar"
}
-->
# كتاب وصفات في: أمثلة عملية مع نماذج في من مايكروسوفت
...
[![افتح في حاويات Dev](https://img.shields.io/static/v1?style=for-the-badge&label=Dev%20Containers&message=Open&color=blue&logo=visualstudiocode)](https://vscode.dev/redirect?url=vscode://ms-vscode-remote.remote-containers/cloneInVolume?url=https://github.com/microsoft/phicookbook)
...
[![خادم Discord مايكروسوفت أزور AI Foundry](https://dcbadge.limes.pink/api/server/ByRwuEEgH4)](https://discord.com/invite/ByRwuEEgH4)

في هو سلسلة من نماذج الذكاء الاصطناعي مفتوحة المصدر التي طورتها مايكروسوفت. 

في هو حالياً أقوى وأوفر نموذج لغة صغير (SLM)، مع مؤشرات أداء جيدة جداً في تعدد اللغات، التفكير، توليد النصوص/الدردشة، الترميز، الصور، الصوت وغيرها من السيناريوهات. 

يمكنك نشر في على السحابة أو على أجهزة الحافة، ويمكنك بسهولة بناء تطبيقات ذكاء اصطناعي توليدية باستخدام طاقة حوسبة محدودة.

اتبع هذه الخطوات للبدء باستخدام هذه الموارد:
1. **انشئ فورك للمستودع**: انقر على [![التفرعات في GitHub](https://img.shields.io/github/forks/microsoft/phicookbook.svg?style=social&label=Fork)](https://GitHub.com/microsoft/phicookbook/network/?WT.mc_id=aiml-137032-kinfeylo)
...
[العربية](./README.md) | [البنغالية](../bn/README.md) | [البلغارية](../bg/README.md) | [البورمية (ميانمار)](../my/README.md) | [الصينية (المبسطة)](../zh/README.md) | [الصينية (التقليدية، هونغ كونغ)](../hk/README.md) | [الصينية (التقليدية، ماكاو)](../mo/README.md) | [الصينية (التقليدية، تايوان)](../tw/README.md) | [الكرواتية](../hr/README.md) | [التشيكية](../cs/README.md) | [الدانمركية](../da/README.md) | [الهولندية](../nl/README.md) | [الإستونية](../et/README.md) | [الفنلندية](../fi/README.md) | [الفرنسية](../fr/README.md) | [الألمانية](../de/README.md) | [اليونانية](../el/README.md) | [العبرية](../he/README.md) | [الهندية](../hi/README.md) | [الهنغارية](../hu/README.md) | [الإندونيسية](../id/README.md) | [الإيطالية](../it/README.md) | [اليابانية](../ja/README.md) | [الكانادا](../kn/README.md) | [الكورية](../ko/README.md) | [الليتوانية](../lt/README.md) | [الماليزية](../ms/README.md) | [المالايالامية](../ml/README.md) | [المراثية](../mr/README.md) | [النيبالية](../ne/README.md) | [البيجن النيجيري](../pcm/README.md) | [النرويجية](../no/README.md) | [الفارسية (اللغة الفارسية)](../fa/README.md) | [البولندية](../pl/README.md) | [البرتغالية (البرازيل)](../br/README.md) | [البرتغالية (البرتغال)](../pt/README.md) | [البنجابية (غورموخي)](../pa/README.md) | [الرومانية](../ro/README.md) | [الروسية](../ru/README.md) | [الصربية (السيريلية)](../sr/README.md) | [السلوفاكية](../sk/README.md) | [السلوفينية](../sl/README.md) | [الإسبانية](../es/README.md) | [السواحلية](../sw/README.md) | [السويدية](../sv/README.md) | [التاغالوغ (الفلبينية)](../tl/README.md) | [التاميلية](../ta/README.md) | [التيلجو](../te/README.md) | [التايلاندية](../th/README.md) | [التركية](../tr/README.md) | [الأوكرانية](../uk/README.md) | [الأردية](../ur/README.md) | [الفيتنامية](../vi/README.md)

> **تفضل النسخ محليًا؟**

> هذا المستودع يشمل أكثر من 50 ترجمة للغات مما يزيد بشكل كبير من حجم التنزيل. لنسخ بدون الترجمات، استخدم sparse checkout:
> ```bash
...
- مقدمة
  - [مرحباً بك في عائلة في](./md/01.Introduction/01/01.PhiFamily.md)
  ...
  - [السلامة في الذكاء الاصطناعي لنماذج في](./md/01.Introduction/01/01.AISafety.md)
  - [دعم الأجهزة لنماذج في](./md/01.Introduction/01/01.Hardwaresupport.md)
  - [نماذج في وتوفرها عبر المنصات](./md/01.Introduction/01/01.Edgeandcloud.md)
  - [استخدام Guidance-ai و في](./md/01.Introduction/01/01.Guidance.md)
  - [نماذج سوق GitHub](https://github.com/marketplace/models)
  - [كتالوج نماذج أزور AI](https://ai.azure.com)

- استنتاج في في بيئات مختلفة
    -  [Hugging face](./md/01.Introduction/02/01.HF.md)
    -  [نماذج GitHub](./md/01.Introduction/02/02.GitHubModel.md)
    -  [كتالوج نماذج أزور AI Foundry](./md/01.Introduction/02/03.AzureAIFoundry.md)
    -  [Ollama](./md/01.Introduction/02/04.Ollama.md)
    -  [أدوات الذكاء الاصطناعي VSCode (AITK)](./md/01.Introduction/02/05.AITK.md)
    -  [NVIDIA NIM](./md/01.Introduction/02/06.NVIDIA.md)
    -  [Foundry Local](./md/01.Introduction/02/07.FoundryLocal.md)

- استنتاج عائلة في
    - [استنتاج في في iOS](./md/01.Introduction/03/iOS_Inference.md)
    - [استنتاج في في Android](./md/01.Introduction/03/Android_Inference.md)
    - [استنتاج في في Jetson](./md/01.Introduction/03/Jetson_Inference.md)
    - [استنتاج في في AI PC](./md/01.Introduction/03/AIPC_Inference.md)
    - [استنتاج في بإطار عمل Apple MLX](./md/01.Introduction/03/MLX_Inference.md)
    - [استنتاج في في الخادم المحلي](./md/01.Introduction/03/Local_Server_Inference.md)
    - [استنتاج في في الخادم البعيد باستخدام أدوات AI](./md/01.Introduction/03/Remote_Interence.md)
    - [استنتاج في باستخدام Rust](./md/01.Introduction/03/Rust_Inference.md)
    - [استنتاج في--الرؤية محليًا](./md/01.Introduction/03/Vision_Inference.md)
    - [استنتاج في مع Kaito AKS، حاويات Azure (الدعم الرسمي)](./md/01.Introduction/03/Kaito_Inference.md)
...
- عينات تطوير تطبيقات في
  - تطبيقات النص والدردشة
    - عينات Phi-4 🆕
      ...
      - [تطبيق دردشة .NET Console باستخدام Phi-4 ONNX مع Sementic Kernel](../../md/04.HOL/dotnet/src/LabsPhi4-Chat-02SK)
    - عينات Phi-3 / 3.5
      - [روبوت محادثة محلي في المتصفح باستخدام Phi3، ONNX Runtime Web و WebGPU](https://github.com/microsoft/onnxruntime-inference-examples/tree/main/js/chat)
      - [دردشة OpenVino](./md/02.Application/01.TextAndChat/Phi3/E2E_OpenVino_Chat.md)
      - [نماذج متعددة - Phi-3-mini التفاعلي و OpenAI Whisper](./md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-mini_with_whisper.md)
      ...
      -[مثال تطبيق WinUI3 متعدد النماذج مدعوم بالذكاء الاصطناعي](https://github.com/microsoft/ai-powered-notes-winui3-sample)
      ...
      - [تقييم نموذج Phi-3 / Phi-3.5 المضبوط بدقة في Azure AI Foundry مع التركيز على مبادئ الذكاء الاصطناعي المسؤول من مايكروسوفت](./md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-Evaluation_AIFoundry.md)
      - [📓] [عينة توقع لغة Phi-3.5-mini-instruct (صينية/إنجليزية)](./md/02.Application/01.TextAndChat/Phi3/phi3-instruct-demo.ipynb)
      - [دردشة Phi-3.5-Instruct WebGPU RAG](./md/02.Application/01.TextAndChat/Phi3/WebGPUWithPhi35Readme.md)
      ...
      - [مثال سؤال وجواب .NET باستخدام نموذج Phi-3 المحلي ONNX باستخدام Microsoft.ML.OnnxRuntime](../../md/04.HOL/dotnet/src/LabsPhi301)
      - [تطبيق دردشة Console .NET مع Semantic Kernel و Phi-3](../../md/04.HOL/dotnet/src/LabsPhi302)

  - عينات قائمة على رمز SDK لاستدلال Azure AI
    - عينات Phi-4 🆕
      - [📓] [توليد رمز المشروع باستخدام Phi-4-multimodal](./md/02.Application/02.Code/Phi4/GenProjectCode/README.md)
    - عينات Phi-3 / 3.5
      - [بناء مساعد دردشة GitHub Visual Studio Code الخاص بك مع عائلة Microsoft Phi-3](./md/02.Application/02.Code/Phi3/VSCodeExt/README.md)
  ...
  - عينات التفكير المتقدم
    - عينات Phi-4 🆕
      ...
      - [📓] [Phi-4-mini-reasoning باستخدام نماذج GitHub](./md/02.Application/02.Code/Phi4r/github_models_inference.ipynb)
      - [📓] [Phi-4-mini-reasoning باستخدام نماذج Azure AI Foundry](./md/02.Application/02.Code/Phi4r/azure_models_inference.ipynb)
  - العروض التوضيحية
  ...
  - عينات الرؤية
    ...
    - عينات Phi-3 / 3.5
      -  [📓][النص إلى نص في رؤية الصور Phi-3](./md/02.Application/04.Vision/Phi3/E2E_Phi-3-vision-image-text-to-text-online-endpoint.ipynb)
      - [Phi-3-vision-ONNX](https://onnxruntime.ai/docs/genai/tutorials/phi3-v.html)
      - [📓][تضمين CLIP في رؤية Phi-3](./md/02.Application/04.Vision/Phi3/E2E_Phi-3-vision-image-text-to-text-online-endpoint.ipynb)
      - [تجريبي: إعادة التدوير Phi-3](https://github.com/jennifermarsman/PhiRecycling/)
      - [Phi-3-vision - مساعد لغة مرئية - مع Phi3-Vision و OpenVINO](https://docs.openvino.ai/nightly/notebooks/phi-3-vision-with-output.html)
      - [Phi-3 Vision Nvidia NIM](./md/02.Application/04.Vision/Phi3/E2E_Nvidia_NIM_Vision.md)
      - [Phi-3 Vision OpenVino](./md/02.Application/04.Vision/Phi3/E2E_OpenVino_Phi3Vision.md)
      - [📓][عينات رؤية Phi-3.5 متعددة الإطارات أو متعددة الصور](./md/02.Application/04.Vision/Phi3/phi3-vision-demo.ipynb)
      - [نموذج محلي Phi-3 Vision ONNX باستخدام Microsoft.ML.OnnxRuntime .NET](../../md/04.HOL/dotnet/src/LabsPhi303)
      - [نموذج محلي Phi-3 Vision ONNX قائم على القائمة باستخدام Microsoft.ML.OnnxRuntime .NET](../../md/04.HOL/dotnet/src/LabsPhi304)
  ...
  - عينات الصوت
    - عينات Phi-4 🆕
      ...
      - [📓] [عينات ترجمة الكلام Phi-4-multimodal](./md/02.Application/05.Audio/Phi4/Translate/demo.ipynb)
      - [تطبيق Console .NET باستخدام Phi-4-multimodal لتحليل ملف صوتي وتوليد النص](../../md/04.HOL/dotnet/src/LabsPhi4-MultiModal-02Audio)

  - عينات MOE
    - عينات Phi-3 / 3.5
      - [📓] [نماذج مزيج من الخبراء Phi-3.5 (MoEs) عينة وسائل التواصل الاجتماعي](./md/02.Application/06.MoE/Phi3/phi3_moe_demo.ipynb)
      - [📓] [بناء خط أنابيب الاسترجاع والتوليد المعزز (RAG) باستخدام NVIDIA NIM Phi-3 MOE، بحث Azure AI، و LlamaIndex](./md/02.Application/06.MoE/Phi3/azure-ai-search-nvidia-rag.ipynb)
      - 
...
- عينات الضبط الدقيق لـ Phi
  ...
  - [جعل Phi-3 خبيرًا صناعيًا عبر الضبط الدقيق](./md/03.FineTuning/LetPhi3gotoIndustriy.md)
  ...
  - [معمل عملي للضبط الدقيق باستخدام Microsoft Olive](./md/03.FineTuning/olive-lab/readme.md)
  ...
  - [الضبط الدقيق لـ Phi-3 مع Kaito AKS ، حاويات Azure (الدعم الرسمي)](./md/03.FineTuning/FineTuning_Kaito.md)
...
- معمل عملي
  ...
  - [إطلاق الإمكانات في معالجة اللغة الطبيعية: الضبط الدقيق باستخدام Microsoft Olive](https://github.com/azure/Ignite_FineTuning_workshop)

- الأوراق البحثية والمنشورات الأكاديمية
  - [الكتب هي كل ما تحتاجه II: تقرير فني عن phi-1.5](https://arxiv.org/abs/2309.05463)
  - [تقرير فني عن Phi-3: نموذج لغة عالي القدرات محليًا على هاتفك](https://arxiv.org/abs/2404.14219)
  ...
  - [(WhyPHI) تعديل دقيق لـ PHI-3 للإجابة على أسئلة الاختيار من متعدد: المنهجية، النتائج، والتحديات](https://arxiv.org/abs/2501.01588)
...
يمكنك تعلم كيفية استخدام Microsoft Phi وكيفية بناء حلول شاملة في أجهزتك المختلفة. لتجربة Phi بنفسك، ابدأ بالتفاعل مع النموذج وتخصيص Phi لسيناريوهاتك باستخدام [كتالوج نماذج GitHub](https://github.com/marketplace/models?WT.mc_id=aiml-137032-kinfeylo). يمكنك تعلم المزيد في البدء مع [كتالوج نماذج GitHub](/md/02.QuickStart/GitHubModel_QuickStart.md)

**ساحة اللعب**  
لكل نموذج ساحة لعب مخصصة [لاختبار النموذج](/md/02.QuickStart/GitHubModel_QuickStart.md).
...
تلتزم Microsoft بمساعدة عملائنا على استخدام منتجات الذكاء الاصطناعي الخاصة بنا بمسؤولية، ومشاركة خبراتنا، وبناء شراكات قائمة على الثقة من خلال أدوات مثل ملاحظات الشفافية وتقييمات الأثر. يمكن العثور على العديد من هذه الموارد في [https://aka.ms/RAI](https://aka.ms/RAI).  
نهج Microsoft تجاه الذكاء الاصطناعي المسؤول يستند إلى مبادئ الذكاء الاصطناعي التي تشمل العدالة، الموثوقية والسلامة، الخصوصية والأمان، الشمولية، الشفافية، والمسؤولية.

يمكن للنماذج واسعة النطاق للغة الطبيعية، والصورة، والكلام - مثل تلك المستخدمة في هذا المثال - أن تتصرف بطرق قد تكون غير عادلة أو غير موثوقة أو مسيئة، مما يسبب أضرارًا. يرجى مراجعة [ملاحظة الشفافية لخدمة Azure OpenAI](https://learn.microsoft.com/legal/cognitive-services/openai/transparency-note?tabs=text) لتكون على اطلاع بالمخاطر والقيود.

النهج الموصى به لتخفيف هذه المخاطر هو تضمين نظام أمان في تصميمك يمكنه اكتشاف ومنع السلوك الضار. توفر [خدمة أمان المحتوى في Azure AI](https://learn.microsoft.com/azure/ai-services/content-safety/overview) طبقة حماية مستقلة، قادرة على اكتشاف المحتوى الضار الذي ينشئه المستخدمون وأيضًا المحتوى الذي ينشئه الذكاء الاصطناعي في التطبيقات والخدمات. تتضمن خدمة أمان المحتوى في Azure AI واجهات برمجة تطبيقات للنصوص والصور تتيح لك اكتشاف المواد الضارة. ضمن Azure AI Foundry، تتيح لك خدمة أمان المحتوى عرض، واستكشاف، وتجربة أمثلة على الكود لاكتشاف المحتوى الضار عبر وسائط متعددة. يوجهك [وثيقة البدء السريع التالية](https://learn.microsoft.com/azure/ai-services/content-safety/quickstart-text?tabs=visual-studio%2Clinux&pivots=programming-language-rest) خلال كيفية إرسال الطلبات إلى الخدمة.

جانب آخر يجب أخذه في الاعتبار هو أداء التطبيق العام. مع التطبيقات متعددة الوسائط والنماذج المتعددة، نعتبر الأداء يعني أن النظام يعمل كما تتوقع أنت ومستخدموك، بما في ذلك عدم توليد مخرجات ضارة. من المهم تقييم أداء التطبيق الكلي باستخدام [مقاييس الأداء والجودة ومقاييس المخاطر والسلامة](https://learn.microsoft.com/azure/ai-studio/concepts/evaluation-metrics-built-in). لديك أيضًا القدرة على إنشاء وتقييم باستخدام [المقاييس المخصصة](https://learn.microsoft.com/azure/ai-studio/how-to/develop/evaluate-sdk#custom-evaluators).
يمكنك تقييم تطبيق الذكاء الاصطناعي الخاص بك في بيئة التطوير الخاصة بك باستخدام [Azure AI Evaluation SDK](https://microsoft.github.io/promptflow/index.html). بالنظر إلى مجموعة بيانات اختبار أو هدف، يتم قياس نتائج تطبيق الذكاء الاصطناعي التوليدي الخاص بك بطريقة كمية باستخدام المقيمين المدمجين أو المقيمين المخصصين من اختيارك. للبدء باستخدام azure ai evaluation sdk لتقييم نظامك، يمكنك متابعة [دليل البداية السريعة](https://learn.microsoft.com/azure/ai-studio/how-to/develop/flow-evaluate-sdk). بمجرد تنفيذ تقييم تجريبي، يمكنك [عرض النتائج في Azure AI Foundry](https://learn.microsoft.com/azure/ai-studio/how-to/evaluate-flow-results).

## العلامات التجارية

قد يحتوي هذا المشروع على علامات تجارية أو شعارات لمشاريع أو منتجات أو خدمات. يجب أن يخضع الاستخدام المصرح به لعلامات مايكروسوفت التجارية أو شعاراتها واتباع [إرشادات العلامة التجارية والعلامات التجارية لشركة مايكروسوفت](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
يجب ألا يؤدي استخدام علامات مايكروسوفت التجارية أو شعاراتها في نسخ معدلة من هذا المشروع إلى إحداث أي لبس أو التلميح إلى رعاية مايكروسوفت. أي استخدام لعلامات تجارية أو شعارات تابع لأطراف ثالثة يخضع لسياسات تلك الأطراف الثالثة.
...
**إخلاء المسؤولية**:  
تم ترجمة هذا المستند باستخدام خدمة الترجمة الآلية [Co-op Translator](https://github.com/Azure/co-op-translator). وعلى الرغم من أننا نسعى لتحقيق الدقة، يرجى العلم أن الترجمات الآلية قد تحتوي على أخطاء أو عدم دقة. ينبغي اعتبار المستند الأصلي بلغته الأصلية المصدر الرسمي والموثوق به. بالنسبة للمعلومات الهامة، يوصى بالترجمة البشرية المهنية. نحن غير مسؤولين عن أي سوء فهم أو تفسير خاطئ ناتج عن استخدام هذه الترجمة.
