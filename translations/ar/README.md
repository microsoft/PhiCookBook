...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2026-01-04T07:08:01+00:00",
...
Phi هي سلسلة من نماذج الذكاء الاصطناعي مفتوحة المصدر طوّرتها مايكروسوفت. 

في الوقت الحالي، تُعَدّ Phi أقوى وأنسب من ناحية التكلفة بين نماذج اللغة الصغيرة (SLM)، مع نتائج قياسية جيدة جدًا في تعدد اللغات، والاستدلال، وتوليد النص/الدردشة، والبرمجة، والصور، والصوت، وسيناريوهات أخرى. 

يمكنك نشر Phi إلى السحابة أو إلى أجهزة الحافة، ويمكنك بسهولة بناء تطبيقات ذكاء اصطناعي توليدية بقدرة حوسبة محدودة.

اتّبع هذه الخطوات للبدء باستخدام هذه الموارد :
1. **استنسخ المستودع (Fork the Repository)**: Click [![التفرعات في GitHub](https://img.shields.io/github/forks/microsoft/phicookbook.svg?style=social&label=Fork)](https://GitHub.com/microsoft/phicookbook/network/?WT.mc_id=aiml-137032-kinfeylo)
...
- استدلال عائلة Phi
    ...
    - [استدلال Phi—الرؤى محليًا](./md/01.Introduction/03/Vision_Inference.md)
    - [استدلال Phi مع Kaito AKS، Azure Containers(الدعم الرسمي)](./md/01.Introduction/03/Kaito_Inference.md)
-  [تكميم عائلة Phi](./md/01.Introduction/04/QuantifyingPhi.md)
    ...
    - [تكميم Phi-3.5 / 4 باستخدام ملحقات الذكاء التوليدي لـ onnxruntime](./md/01.Introduction/04/UsingORTGenAIQuantifyingPhi.md)
...
- أمثلة لتطوير تطبيقات Phi
  - تطبيقات النص والدردشة
    - نماذج Phi-4 🆕
      ...
      - [تطبيق سطر أوامر .NET للدردشة مع Phi-4 ONNX باستخدام Semantic Kernel](../../md/04.HOL/dotnet/src/LabsPhi4-Chat-02SK)
    - نماذج Phi-3 / 3.5
      - [دردشة محلية في المتصفح باستخدام Phi3 وONNX Runtime Web وWebGPU](https://github.com/microsoft/onnxruntime-inference-examples/tree/main/js/chat)
      - [دردشة OpenVino](./md/02.Application/01.TextAndChat/Phi3/E2E_OpenVino_Chat.md)
      - [نماذج متعددة - Phi-3-mini التفاعلي وOpenAI Whisper](./md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-mini_with_whisper.md)
      ...
      - [تقييم نموذج Phi-3 / Phi-3.5 المُحسّن في Azure AI Foundry مع التركيز على مبادئ الذكاء الاصطناعي المسؤولة لشركة Microsoft](./md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-Evaluation_AIFoundry.md)
      - [📓] [عينة توقع اللغة لـ Phi-3.5-mini-instruct (صيني/إنجليزي)](./md/02.Application/01.TextAndChat/Phi3/phi3-instruct-demo.ipynb)
      - [Phi-3.5-Instruct روبوت دردشة RAG على WebGPU](./md/02.Application/01.TextAndChat/Phi3/WebGPUWithPhi35Readme.md)
      - [استخدام GPU الخاص بWindows لإنشاء حل Prompt flow باستخدام Phi-3.5-Instruct ONNX](./md/02.Application/01.TextAndChat/Phi3/UsingPromptFlowWithONNX.md)
      ...
      - [مثال سؤال وجواب .NET باستخدام نموذج ONNX محلي لـ Phi-3 باستخدام Microsoft.ML.OnnxRuntime](../../md/04.HOL/dotnet/src/LabsPhi301)
      - [تطبيق دردشة .NET عبر وحدة تحكم مع Semantic Kernel وPhi-3](../../md/04.HOL/dotnet/src/LabsPhi302)

  - عينات قائمة على الكود لمجموعة Azure AI Inference SDK 
    - عينات Phi-4 🆕
      - [📓] [توليد كود المشروع باستخدام Phi-4-multimodal](./md/02.Application/02.Code/Phi4/GenProjectCode/README.md)
    - عينات Phi-3 / 3.5
      - [بناء دردشة GitHub Copilot في Visual Studio Code باستخدام عائلة Microsoft Phi-3](./md/02.Application/02.Code/Phi3/VSCodeExt/README.md)
      - [إنشاء وكيل Chat Copilot في Visual Studio Code خاصتك باستخدام Phi-3.5 عبر نماذج GitHub](/md/02.Application/02.Code/Phi3/CreateVSCodeChatAgentWithGitHubModels.md)
  ...
  - عينات الرؤية
    ...
    - عينات Phi-3 / 3.5
      ...
      - [نموذج ONNX محلي لـ Phi-3 Vision قائم على قائمة باستخدام Microsoft.ML.OnnxRuntime .NET](../../md/04.HOL/dotnet/src/LabsPhi304)

  - عينات الرياضيات
    -  عينات Phi-4-Mini-Flash-Reasoning-Instruct 🆕 [عرض توضيحي رياضي مع Phi-4-Mini-Flash-Reasoning-Instruct](./md/02.Application/09.Math/MathDemo.ipynb)

  - عينات الصوت
    - عينات Phi-4 🆕
      - [📓] [استخراج نصوص الصوت باستخدام Phi-4-multimodal](./md/02.Application/05.Audio/Phi4/Transciption/README.md)
      - [📓] [عينة صوت لـ Phi-4-multimodal](./md/02.Application/05.Audio/Phi4/Siri/demo.ipynb)
      - [📓] [عينة ترجمة كلام لـ Phi-4-multimodal](./md/02.Application/05.Audio/Phi4/Translate/demo.ipynb)
      - [تطبيق .NET عبر وحدة التحكم يستخدم صوت Phi-4-multimodal لتحليل ملف صوتي وتوليد نص](../../md/04.HOL/dotnet/src/LabsPhi4-MultiModal-02Audio)

  - عينات MOE
    - عينات Phi-3 / 3.5
      - [📓] [عينة وسائل التواصل الاجتماعي لنماذج Phi-3.5 خليط الخبراء (MoEs)](./md/02.Application/06.MoE/Phi3/phi3_moe_demo.ipynb)
      - [📓] [بناء مسار إنتاج معزز بالاسترجاع (RAG) باستخدام NVIDIA NIM Phi-3 MOE وAzure AI Search وLlamaIndex](./md/02.Application/06.MoE/Phi3/azure-ai-search-nvidia-rag.ipynb)
      - 
  ...
  - عينات المزج متعدد الوسائط
    - عينات Phi-4 🆕
      ...
      - [تطبيق .NET عبر وحدة تحكم يستخدم Phi-4-multimodal لتحليل الصور](../../md/04.HOL/dotnet/src/LabsPhi4-MultiModal-01Images)
...
- ضبط نماذج Phi
  ...
  - [الضبط الدقيق - جعل Phi-3 خبيرًا في الصناعة](./md/03.FineTuning/LetPhi3gotoIndustriy.md)
  ...
  - [الضبط الدقيق لـ Phi-3 مع Kaito AKS , Azure Containers(دعم رسمي)](./md/03.FineTuning/FineTuning_Kaito.md)
  - [الضبط الدقيق لـ Phi-3 وPhi-3.5 Vision](https://github.com/2U1/Phi3-Vision-Finetune)
...
- مختبر عملي
  ...
  - [إطلاق إمكانات معالجة اللغة الطبيعية: الضبط الدقيق باستخدام Microsoft Olive](https://github.com/azure/Ignite_FineTuning_workshop)
...
- الأوراق البحثية والمنشورات الأكاديمية
  ...
  - [تقرير فني Phi-3: نموذج لغة عالي القدرة تعمل محليًا على هاتفك](https://arxiv.org/abs/2404.14219)
  - [تقرير فني Phi-4](https://arxiv.org/abs/2412.08905)
  - [تقرير فني Phi-4-Mini: نماذج لغوية متعددة الوسائط مدمجة لكنها قوية عبر مزيج من LoRAs](https://arxiv.org/abs/2503.01743)
  - [تحسين نماذج اللغة الصغيرة لاستدعاء الوظائف داخل المركبة](https://arxiv.org/abs/2501.02342)
  - [(WhyPHI) الضبط الدقيق لـ PHI-3 للإجابة على أسئلة الاختيار المتعدد: المنهجية والنتائج والتحديات](https://arxiv.org/abs/2501.01588)
...
**منصة تجربة**
Each model has a dedicated [منصة لاختبار النموذج](/md/02.QuickStart/GitHubModel_QuickStart.md).
...
**منصة تجربة**
 [منصة تجربة Hugging Chat](https://huggingface.co/chat/models/microsoft/Phi-3-mini-4k-instruct)
...
### Copilot Series
[![Copilot للبرمجة التشاركية مع الذكاء الاصطناعي](https://img.shields.io/badge/Copilot%20for%20AI%20Paired%20Programming-FACC15?style=for-the-badge&labelColor=E5E7EB&color=FACC15)](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)
...
تلتزم Microsoft بمساعدة عملائنا على استخدام منتجات الذكاء الاصطناعي لدينا بمسؤولية، ومشاركة ما تعلمناه، وبناء شراكات قائمة على الثقة من خلال أدوات مثل ملاحظات الشفافية وتقييمات الأثر. يمكن العثور على العديد من هذه الموارد في [https://aka.ms/RAI](https://aka.ms/RAI).
نهج Microsoft تجاه الذكاء الاصطناعي المسؤول يستند إلى مبادئ الذكاء الاصطناعي لدينا: العدالة، والموثوقية والسلامة، والخصوصية والأمن، والشمولية، والشفافية، والمساءلة.

يمكن لنماذج اللغة الطبيعية والصور والكلام واسعة النطاق — مثل تلك المستخدمة في هذا المثال — أن تتصرف بطرق قد تكون ظالمة أو غير موثوقة أو مسيئة، مما قد يسبب أضرارًا. يرجى الاطلاع على [ملاحظة الشفافية لخدمة Azure OpenAI](https://learn.microsoft.com/legal/cognitive-services/openai/transparency-note?tabs=text) للاطلاع على المخاطر والقيود.

النهج الموصى به للتخفيف من هذه المخاطر هو تضمين نظام أمان في بنيتك قادر على اكتشاف ومنع السلوك الضار. توفر [خدمة سلامة محتوى Azure AI](https://learn.microsoft.com/azure/ai-services/content-safety/overview) طبقة حماية مستقلة، قادرة على اكتشاف المحتوى الضار الذي ينشئه المستخدم أو الذي يولده الذكاء الاصطناعي في التطبيقات والخدمات. تتضمن خدمة سلامة محتوى Azure AI واجهات برمجة تطبيقات للنص والصورة تتيح لك اكتشاف المواد الضارة. داخل Azure AI Foundry، تتيح لك خدمة سلامة المحتوى عرض واستكشاف وتجربة أمثلة الشيفرة لاكتشاف المحتوى الضار عبر وسائط مختلفة. يرتشدك [توثيق البدء السريع التالي](https://learn.microsoft.com/azure/ai-services/content-safety/quickstart-text?tabs=visual-studio%2Clinux&pivots=programming-language-rest) خلال إجراء الطلبات إلى الخدمة.

جانب آخر يجب أخذه في الاعتبار هو أداء التطبيق ككل. بالنسبة للتطبيقات متعددة الوسائط ومتعددة النماذج، نعتبر أن الأداء يعني أن النظام يعمل كما تتوقع أنت ومستخدموك، بما في ذلك عدم توليد مخرجات ضارة. من المهم تقييم أداء تطبيقك الكلي باستخدام [مقَيِّمات الأداء والجودة والمخاطر والسلامة](https://learn.microsoft.com/azure/ai-studio/concepts/evaluation-metrics-built-in). كما لديك القدرة على الإنشاء والتقييم باستخدام [مقَيِّمات مخصصة](https://learn.microsoft.com/azure/ai-studio/how-to/develop/evaluate-sdk#custom-evaluators).
يمكنك تقييم تطبيق الذكاء الاصطناعي الخاص بك في بيئة التطوير باستخدام [حزمة Azure AI للتقييم](https://microsoft.github.io/promptflow/index.html). سواء باستخدام مجموعة بيانات اختبار أو هدف، يتم قياس مخرجات تطبيق الذكاء الاصطناعي التوليدية قياسًا كميًا باستخدام المقيّمين المدمجين أو مقيّمين مخصصين من اختيارك. للبدء باستخدام حزمة Azure AI للتقييم لتقييم نظامك، يمكنك اتباع [دليل البدء السريع](https://learn.microsoft.com/azure/ai-studio/how-to/develop/flow-evaluate-sdk). بمجرد تنفيذ تشغيل تقييم، يمكنك [عرض النتائج في Azure AI Foundry](https://learn.microsoft.com/azure/ai-studio/how-to/evaluate-flow-results). 

## العلامات التجارية

قد يحتوي هذا المشروع على علامات تجارية أو شعارات لمشروعات أو منتجات أو خدمات. يخضع الاستخدام المصرح به لعلامات Microsoft التجارية أو شعاراتها لما ورد في واتباع [إرشادات العلامات التجارية والهوية لمايكروسوفت](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
يجب ألا يتسبب استخدام علامات Microsoft التجارية أو شعاراتها في نسخ معدلة من هذا المشروع في إحداث لبس أو الإيحاء برعاية من Microsoft. يخضع أي استخدام لعلامات تجارية أو شعارات طرف ثالث لسياسات ذلك الطرف الثالث.

## الحصول على المساعدة

إذا علقت أو كانت لديك أي أسئلة حول بناء تطبيقات الذكاء الاصطناعي، انضم إلى:

[![Discord الخاص بـ Azure AI Foundry](https://img.shields.io/badge/Discord-Azure_AI_Foundry_Community_Discord-blue?style=for-the-badge&logo=discord&color=5865f2&logoColor=fff)](https://aka.ms/foundry/discord)
