# كتاب في: أمثلة تطبيقية مع نماذج في من مايكروسوفت
...
[![الشُّعب على GitHub](https://img.shields.io/github/forks/microsoft/phicookbook.svg?style=social&label=Fork)](https://GitHub.com/microsoft/phicookbook/network/?WT.mc_id=aiml-137032-kinfeylo)
...
[![خادم Microsoft Azure AI Foundry على Discord](https://dcbadge.limes.pink/api/server/ByRwuEEgH4)](https://discord.com/invite/ByRwuEEgH4)

في هي سلسلة من نماذج الذكاء الاصطناعي مفتوحة المصدر التي طورتها مايكروسوفت.

في هو حالياً النموذج الصغير للغة الأكثر قوة وفعالية من حيث التكلفة (SLM)، مع معايير أداء جيدة جدًا في تعدد اللغات، الاستدلال، توليد النص/الدردشة، البرمجة، الصور، الصوت وسيناريوهات أخرى.

يمكنك نشر في على السحابة أو على أجهزة الحافة، ويمكنك بسهولة بناء تطبيقات الذكاء الاصطناعي التوليدي مع قدرة حوسبية محدودة.

اتبع هذه الخطوات للبدء باستخدام هذه الموارد:
1. **استنسخ المستودع**: انقر على [![الشُّعب على GitHub](https://img.shields.io/github/forks/microsoft/phicookbook.svg?style=social&label=Fork)](https://GitHub.com/microsoft/phicookbook/network/?WT.mc_id=aiml-137032-kinfeylo)
2. **انسخ المستودع**:   `git clone https://github.com/microsoft/PhiCookBook.git`
3. [**انضم إلى مجتمع Discord لمايكروسوفت للذكاء الاصطناعي والتقِ بالخبراء والمطورين**](https://discord.com/invite/ByRwuEEgH4?WT.mc_id=aiml-137032-kinfeylo)
...
[العربية](./README.md) | [البنغالية](../bn/README.md) | [البلغارية](../bg/README.md) | [البورمية (ميانمار)](../my/README.md) | [الصينية (المبسطة)](../zh-CN/README.md) | [الصينية (التقليدية، هونغ كونغ)](../zh-HK/README.md) | [الصينية (التقليدية، ماكاو)](../zh-MO/README.md) | [الصينية (التقليدية، تايوان)](../zh-TW/README.md) | [الكرواتية](../hr/README.md) | [التشيكية](../cs/README.md) | [الدانماركية](../da/README.md) | [الهولندية](../nl/README.md) | [الإستونية](../et/README.md) | [الفنلندية](../fi/README.md) | [الفرنسية](../fr/README.md) | [الألمانية](../de/README.md) | [اليونانية](../el/README.md) | [العبرية](../he/README.md) | [الهندية](../hi/README.md) | [الهنغارية](../hu/README.md) | [الإندونيسية](../id/README.md) | [الإيطالية](../it/README.md) | [اليابانية](../ja/README.md) | [الكانادية](../kn/README.md) | [الكورية](../ko/README.md) | [اللتوانية](../lt/README.md) | [الماليزية](../ms/README.md) | [المالية](../ml/README.md) | [الماراثية](../mr/README.md) | [النيبالية](../ne/README.md) | [النيجيرية بيدجين](../pcm/README.md) | [النرويجية](../no/README.md) | [الفارسية (اللغة)](../fa/README.md) | [البولندية](../pl/README.md) | [البرتغالية (البرازيل)](../pt-BR/README.md) | [البرتغالية (البرتغال)](../pt-PT/README.md) | [البنجابية (الجرموخي)](../pa/README.md) | [الرومانية](../ro/README.md) | [الروسية](../ru/README.md) | [الصربية (السيريلية)](../sr/README.md) | [السلوفاكية](../sk/README.md) | [السلوفينية](../sl/README.md) | [الإسبانية](../es/README.md) | [السواحيلية](../sw/README.md) | [السويدية](../sv/README.md) | [التاغالوغ (الفلبينية)](../tl/README.md) | [التاميلية](../ta/README.md) | [التيلجو](../te/README.md) | [التايلاندية](../th/README.md) | [التركية](../tr/README.md) | [الأوكرانية](../uk/README.md) | [الأردية](../ur/README.md) | [الفيتنامية](../vi/README.md)

> **تفضل النسخ محلياً؟**

> يتضمن هذا المستودع أكثر من 50 ترجمة للغات مما يزيد بشكل كبير حجم التنزيل. للنسخ بدون الترجمات، استخدم sparse checkout:
> ```bash
...
- المقدمة
  - [مرحباً بكم في عائلة في](./md/01.Introduction/01/01.PhiFamily.md)
  ...
  - [سلامة الذكاء الاصطناعي لنماذج في](./md/01.Introduction/01/01.AISafety.md)
  - [دعم الأجهزة لنماذج في](./md/01.Introduction/01/01.Hardwaresupport.md)
  - [نماذج في والتوفر عبر المنصات](./md/01.Introduction/01/01.Edgeandcloud.md)
  - [استخدام Guidance-ai و في](./md/01.Introduction/01/01.Guidance.md)
  - [نماذج سوق GitHub](https://github.com/marketplace/models)
  - [كتالوج نماذج Azure AI](https://ai.azure.com)

- استنتاج في في بيئات مختلفة
    ...
    -  [أدوات الذكاء الاصطناعي لـ VSCode (AITK)](./md/01.Introduction/02/05.AITK.md)
    -  [NVIDIA NIM](./md/01.Introduction/02/06.NVIDIA.md)
    -  [Foundry Local](./md/01.Introduction/02/07.FoundryLocal.md)

- استنتاج عائلة في
    - [استنتاج في على iOS](./md/01.Introduction/03/iOS_Inference.md)
    - [استنتاج في على Android](./md/01.Introduction/03/Android_Inference.md)
    - [استنتاج في على Jetson](./md/01.Introduction/03/Jetson_Inference.md)
    - [استنتاج في على AI PC](./md/01.Introduction/03/AIPC_Inference.md)
    - [استنتاج في مع إطار عمل Apple MLX](./md/01.Introduction/03/MLX_Inference.md)
    - [استنتاج في على الخادم المحلي](./md/01.Introduction/03/Local_Server_Inference.md)
    - [استنتاج في على الخادم البعيد باستخدام أدوات الذكاء الاصطناعي](./md/01.Introduction/03/Remote_Interence.md)
    - [استنتاج في مع Rust](./md/01.Introduction/03/Rust_Inference.md)
    - [استنتاج في–الرؤية محلياً](./md/01.Introduction/03/Vision_Inference.md)
    - [استنتاج في مع Kaito AKS، Azure Containers (الدعم الرسمي)](./md/01.Introduction/03/Kaito_Inference.md)
-  [تكميم عائلة في](./md/01.Introduction/04/QuantifyingPhi.md)
    - [تكميم Phi-3.5 / 4 باستخدام llama.cpp](./md/01.Introduction/04/UsingLlamacppQuantifyingPhi.md)
    - [تكميم Phi-3.5 / 4 باستخدام ملحقات الذكاء الاصطناعي التوليدي لـ onnxruntime](./md/01.Introduction/04/UsingORTGenAIQuantifyingPhi.md)
...
- البحث والاسترجاع RAG مع Azure AI Search
...
- عينات تطوير تطبيقات في
  - تطبيقات النص والدردشة
    ...
    - عينات Phi-3 / 3.5
      ...
      - [تحسين النموذج - كيفية تحسين نموذج Phi-3-min لاستخدام ONNX Runtime Web مع Olive](https://github.com/microsoft/Olive/tree/main/examples/phi3)
      - [تطبيق WinUI3 مع Phi-3 mini-4k-instruct-onnx](https://github.com/microsoft/Phi3-Chat-WinUI3-Sample/)
      -[تطبيق ملاحظات متعدد النماذج مدعوم بالذكاء الاصطناعي WinUI3 نموذج](https://github.com/microsoft/ai-powered-notes-winui3-sample)
      - [ضبط وتحسين نماذج Phi-3 المخصصة مع Prompt flow](./md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-FineTuning_PromptFlow_Integration.md)
      - [ضبط وتحسين نماذج Phi-3 المخصصة مع Prompt flow في Azure AI Foundry](./md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-FineTuning_PromptFlow_Integration_AIFoundry.md)
      - [تقييم نموذج Phi-3 / Phi-3.5 المُحسَّن في Azure AI Foundry مع التركيز على مبادئ Microsoft للمسؤولية في الذكاء الاصطناعي](./md/02.Application/01.TextAndChat/Phi3/E2E_Phi-3-Evaluation_AIFoundry.md)
      - [📓] [عينة التنبؤ اللغوي Phi-3.5-mini-instruct (صيني/إنجليزي)](./md/02.Application/01.TextAndChat/Phi3/phi3-instruct-demo.ipynb)
      ...
      - [مثال أسئلة وأجوبة .NET باستخدام نموذج ONNX محلي Phi-3 مع Microsoft.ML.OnnxRuntime](../../md/04.HOL/dotnet/src/LabsPhi301)
      - [تطبيق محادثة Console .NET مع Semantic Kernel و Phi-3](../../md/04.HOL/dotnet/src/LabsPhi302)

  - عينات Azure AI Inference SDK القائمة على الكود
    - عينات Phi-4 🆕
      - [📓] [إنشاء كود المشروع باستخدام Phi-4-multimodal](./md/02.Application/02.Code/Phi4/GenProjectCode/README.md)
    - عينات Phi-3 / 3.5
      - [بناء مساعد المحادثة GitHub Copilot لـ Visual Studio Code الخاص بك مع عائلة Microsoft Phi-3](./md/02.Application/02.Code/Phi3/VSCodeExt/README.md)
      - [إنشاء وكيل دردشة لـ Visual Studio Code مع Phi-3.5 بواسطة نماذج GitHub](/md/02.Application/02.Code/Phi3/CreateVSCodeChatAgentWithGitHubModels.md)
  ...
  - عينات التفكير المتقدم
    - عينات Phi-4 🆕
      ...
      - [📓] [الضبط الدقيق لـ Phi-4-mini-reasoning مع Microsoft Olive](./md/02.Application/03.AdvancedReasoning/Phi4/AdvancedResoningPhi4mini/olive_ft_phi_4_reasoning_with_medicaldata.ipynb)
      - [📓] [الضبط الدقيق لـ Phi-4-mini-reasoning مع Apple MLX](./md/02.Application/03.AdvancedReasoning/Phi4/AdvancedResoningPhi4mini/mlx_ft_phi_4_reasoning_with_medicaldata.ipynb)
  ...
  - عينات الرؤية
    ...
    - عينات Phi-3 / 3.5
      -  [📓][Phi-3-رؤية - تحويل نص الصورة إلى نص](./md/02.Application/04.Vision/Phi3/E2E_Phi-3-vision-image-text-to-text-online-endpoint.ipynb)
      - [Phi-3-رؤية-ONNX](https://onnxruntime.ai/docs/genai/tutorials/phi3-v.html)
      - [📓][Phi-3-رؤية - تضمين CLIP](./md/02.Application/04.Vision/Phi3/E2E_Phi-3-vision-image-text-to-text-online-endpoint.ipynb)
      - [عرض توضيحي: Phi-3 إعادة التدوير](https://github.com/jennifermarsman/PhiRecycling/)
      - [Phi-3-رؤية - مساعد لغة بصري - مع Phi3-Vision و OpenVINO](https://docs.openvino.ai/nightly/notebooks/phi-3-vision-with-output.html)
      - [Phi-3 رؤية Nvidia NIM](./md/02.Application/04.Vision/Phi3/E2E_Nvidia_NIM_Vision.md)
      - [Phi-3 رؤية OpenVino](./md/02.Application/04.Vision/Phi3/E2E_OpenVino_Phi3Vision.md)
      - [📓][عينة رؤية Phi-3.5 متعددة الإطارات أو متعددة الصور](./md/02.Application/04.Vision/Phi3/phi3-vision-demo.ipynb)
  ...
  - عينات الصوت
    - عينات Phi-4 🆕
      - [📓] [استخراج نسخ الصوت باستخدام Phi-4-multimodal](./md/02.Application/05.Audio/Phi4/Transciption/README.md)
      ...
      - [تطبيق Console .NET باستخدام Phi-4-multimodal لتحليل ملف صوتي وتوليد نسخة نصية](../../md/04.HOL/dotnet/src/LabsPhi4-MultiModal-02Audio)

  - عينات MOE
    - عينات Phi-3 / 3.5
      - [📓] [نماذج خلط الخبراء Phi-3.5 (MoEs) عينة الوسائط الاجتماعية](./md/02.Application/06.MoE/Phi3/phi3_moe_demo.ipynb)
      - [📓] [بناء خط أنابيب استدعاء-معزز (RAG) باستخدام NVIDIA NIM Phi-3 MOE ، Azure AI Search ، و LlamaIndex](./md/02.Application/06.MoE/Phi3/azure-ai-search-nvidia-rag.ipynb)
      - 
...
- ضبط نماذج Phi
  ...
  - [الضبط الدقيق لـ Phi-3 باستخدام مجموعة أدوات AI لـ VS Code](./md/03.FineTuning/Finetuning_VSCodeaitoolkit.md)
  - [الضبط الدقيق لـ Phi-3 باستخدام خدمة Azure Machine Learning](./md/03.FineTuning/Introduce_AzureML.md)
  - [الضبط الدقيق لـ Phi-3 مع Lora](./md/03.FineTuning/FineTuning_Lora.md)
  - [الضبط الدقيق لـ Phi-3 مع QLora](./md/03.FineTuning/FineTuning_Qlora.md)
  ...
  - [الضبط الدقيق لرؤية Phi-3 مع Weights and Bias](./md/03.FineTuning/FineTuning_Phi-3-visionWandB.md)
  - [الضبط الدقيق لـ Phi-3 مع إطار عمل Apple MLX](./md/03.FineTuning/FineTuning_MLX.md)
  - [الضبط الدقيق لرؤية Phi-3 (الدعم الرسمي)](./md/03.FineTuning/FineTuning_Vision.md)
...
- مختبرات تدريب عملية
  - [استكشاف النماذج المتطورة: LLMs و SLMs والتطوير المحلي والمزيد](https://github.com/microsoft/aitour-exploring-cutting-edge-models)
  - [فتح إمكانيات معالجة اللغات الطبيعية: الضبط الدقيق مع Microsoft Olive](https://github.com/azure/Ignite_FineTuning_workshop)

- أوراق بحثية ومنشورات أكاديمية
  - [الكتب المدرسية هي كل ما تحتاجه II: تقرير فني عن phi-1.5](https://arxiv.org/abs/2309.05463)
  ...
  - [تقرير فني عن Phi-4-Mini: نماذج لغوية متعددة الوسائط مدمجة لكنها قوية عبر مزيج من LoRAs](https://arxiv.org/abs/2503.01743)
  - [تحسين نماذج اللغة الصغيرة لاستدعاء الوظائف داخل السيارة](https://arxiv.org/abs/2501.02342)
  - [(لماذا PHI) ضبط دقيق لـ PHI-3 للإجابة على أسئلة الاختيار المتعدد: المنهجية والنتائج والتحديات](https://arxiv.org/abs/2501.01588)
  - [تقرير فني عن Phi-4 للريزونيينغ](https://www.microsoft.com/en-us/research/wp-content/uploads/2025/04/phi_4_reasoning.pdf)
  - [تقرير فني عن Phi-4-mini للريزونيينغ](https://huggingface.co/microsoft/Phi-4-mini-reasoning/blob/main/Phi-4-Mini-Reasoning.pdf)

## استخدام نماذج Phi

### Phi على Azure AI Foundry

يمكنك تعلم كيفية استخدام Microsoft Phi وكيفية بناء حلول شاملة في أجهزتك المختلفة. لتجربة Phi بنفسك، ابدأ بالتفاعل مع النماذج وتخصيص Phi لسيناريوهاتك باستخدام [كتالوج نماذج Azure AI Foundry](https://aka.ms/phi3-azure-ai) يمكنك معرفة المزيد في البدء باستخدام [Azure AI Foundry](/md/02.QuickStart/AzureAIFoundry_QuickStart.md)

**ساحة التجارب**  
كل نموذج لديه ساحة تجارب مخصصة لاختبار النموذج [Azure AI Playground](https://aka.ms/try-phi3).

### Phi على نماذج GitHub

يمكنك تعلم كيفية استخدام Microsoft Phi وكيفية بناء حلول شاملة في أجهزتك المختلفة. لتجربة Phi بنفسك، ابدأ بالتفاعل مع النموذج وتخصيص Phi لسيناريوهاتك باستخدام [كتالوج نماذج GitHub](https://github.com/marketplace/models?WT.mc_id=aiml-137032-kinfeylo) يمكنك معرفة المزيد في البدء باستخدام [كتالوج نماذج GitHub](/md/02.QuickStart/GitHubModel_QuickStart.md)

**ساحة التجارب**  
كل نموذج لديه [ساحة تجارب لاختبار النموذج](/md/02.QuickStart/GitHubModel_QuickStart.md).
...
**ساحة التجارب**  
 [ساحة محادثة Hugging Chat](https://huggingface.co/chat/models/microsoft/Phi-3-mini-4k-instruct)
...
### سلسلة Copilot  
[![مساعد برمجة AI مزدوج Copilot](https://img.shields.io/badge/Copilot%20for%20AI%20Paired%20Programming-FACC15?style=for-the-badge&labelColor=E5E7EB&color=FACC15)](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)  
...
تلتزم Microsoft بمساعدة عملائنا على استخدام منتجات الذكاء الاصطناعي لدينا بمسؤولية، ومشاركة ما تعلمناه، وبناء شراكات قائمة على الثقة من خلال أدوات مثل ملاحظات الشفافية وتقييمات الأثر. يمكن العثور على العديد من هذه الموارد على [https://aka.ms/RAI](https://aka.ms/RAI).  
تستند مقاربة Microsoft للذكاء الاصطناعي المسؤول إلى مبادئ الذكاء الاصطناعي من حيث العدالة والموثوقية والسلامة والخصوصية والأمان والشمولية والشفافية والمساءلة.

يمكن أن تتصرف نماذج اللغة والصورة والكلام واسعة النطاق - مثل تلك المستخدمة في هذا المثال - بطرق قد تكون غير عادلة، أو غير موثوقة، أو مسيئة، مما قد يسبب أضرارًا. يرجى الاطلاع على [ملاحظة الشفافية لخدمة Azure OpenAI](https://learn.microsoft.com/legal/cognitive-services/openai/transparency-note?tabs=text) للاطلاع على المخاطر والقيود.

النهج الموصى به للتقليل من هذه المخاطر هو تضمين نظام أمان في المعمارية الخاصة بك يمكنه اكتشاف ومنع السلوك الضار. تقدم [خدمة أمان محتوى Azure AI](https://learn.microsoft.com/azure/ai-services/content-safety/overview) طبقة حماية مستقلة، قادرة على اكتشاف المحتوى الضار الذي ينشئه المستخدم أو الذكاء الاصطناعي في التطبيقات والخدمات. تشمل خدمة أمان محتوى Azure AI واجهات برمجة تطبيقات للنصوص والصور تسمح لك باكتشاف المواد الضارة. داخل Azure AI Foundry، تتيح خدمة أمان المحتوى لك عرض واستكشاف وتجربة رمز نموذجي لاكتشاف المحتوى الضار عبر وسائط مختلفة. توثق [دليل البدء السريع التالي](https://learn.microsoft.com/azure/ai-services/content-safety/quickstart-text?tabs=visual-studio%2Clinux&pivots=programming-language-rest) خطوات تقديم الطلبات إلى الخدمة.

جانب آخر يجب أخذه في الاعتبار هو الأداء العام للتطبيق. مع التطبيقات متعددة الوسائط والمتعددة النماذج، نعتبر الأداء يعني أن النظام يعمل كما تتوقع أنت والمستخدمون لديك، بما في ذلك عدم توليد مخرجات ضارة. من المهم تقييم أداء تطبيقك بالكامل باستخدام [مقاييس الأداء والجودة وتقيم المخاطر والسلامة](https://learn.microsoft.com/azure/ai-studio/concepts/evaluation-metrics-built-in). لديك أيضًا القدرة على إنشاء وتقييم باستخدام [مقيمين مخصصين](https://learn.microsoft.com/azure/ai-studio/how-to/develop/evaluate-sdk#custom-evaluators).
يمكنك تقييم تطبيق الذكاء الاصطناعي الخاص بك في بيئة التطوير الخاصة بك باستخدام [Azure AI Evaluation SDK](https://microsoft.github.io/promptflow/index.html). سواء باستخدام مجموعة بيانات اختبار أو هدف معين، تُقاس الأجيال التي يُنتجها تطبيق الذكاء الاصطناعي التوليدي الخاص بك بشكل كمي باستخدام أدوات التقييم المدمجة أو أدوات التقييم المخصصة التي تختارها. للبدء باستخدام azure ai evaluation sdk لتقييم نظامك، يمكنك اتباع [دليل البدء السريع](https://learn.microsoft.com/azure/ai-studio/how-to/develop/flow-evaluate-sdk). بمجرد تنفيذ تشغيل التقييم، يمكنك [عرض النتائج في Azure AI Foundry](https://learn.microsoft.com/azure/ai-studio/how-to/evaluate-flow-results). 

## العلامات التجارية

قد يحتوي هذا المشروع على علامات تجارية أو شعارات لمشاريع أو منتجات أو خدمات. الاستخدام المصرح به لعلامات أو شعارات Microsoft يخضع و يجب أن يتبع [إرشادات العلامات التجارية والهوية الخاصة بـ Microsoft](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
لا يجوز أن يسبب استخدام علامات أو شعارات Microsoft في نسخ معدلة من هذا المشروع أي لبس أو يوحي برعاية من Microsoft. أي استخدام لعلامات أو شعارات أطراف ثالثة يخضع لسياسات تلك الأطراف الثالثة.
...
إذا كان لديك تعليقات على المنتج أو أخطاء أثناء البناء زُر:
...
**إخلاء المسؤولية**:  
تمت ترجمة هذا المستند باستخدام خدمة الترجمة الآلية [Co-op Translator](https://github.com/Azure/co-op-translator). بينما نسعى لتحقيق الدقة، يرجى مراعاة أن الترجمات الآلية قد تحتوي على أخطاء أو عدم دقة. يجب اعتبار المستند الأصلي بلغته الأصلية المصدر الرسمي والموثوق. للمعلومات الحرجة، يُنصح بالاستعانة بالترجمة المهنية من قبل مترجمين محترفين. نحن غير مسؤولين عن أي سوء فهم أو تفسير خاطئ ناتج عن استخدام هذه الترجمة.
